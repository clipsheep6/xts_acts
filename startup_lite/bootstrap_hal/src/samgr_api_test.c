 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0100, Function | MediumTest | Level0)
{
    printf("[SUB_START_Bootstrap_Samgr_0100:%d]", g_initIndex);
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0200, Function | MediumTest | Level0)
{
    printf("g_coreInit");
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0300, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0400, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0500, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0600, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, SUB_START_Bootstrap_Samgr_0700, Function | MediumTest | Level0)
{
    printf("g_sysRun");
