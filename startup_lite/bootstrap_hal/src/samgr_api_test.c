 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr001, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr002, Function | MediumTest | Level0)
{
    printf("g_coreInit");
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr003, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr004, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr005, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr006, Function | MediumTest | Level0)
{
 ...
 */
LITE_TEST_SUIT(SamgrApiTestSuite, testStartBootstrapSamgr007, Function | MediumTest | Level0)
{
    printf("g_sysRun");
