...
describe('WallpaperJsunitTest', function () {
    ...
    it('testResetPromiseSystem101', 0, async function (done) {
        wallpaper.reset(WALLPAPER_SYSTEM).then((data) => {
            console.info('testResetPromiseSystem101 wallpaperXTS ===> testResetPromiseSystem data----11 : ' + JSON.stringify(data));
            if ((data != undefined) && (data != null) && (data != '')) {
                expect(true).assertTrue();
            }
            done();
        }).catch((err) => {
            console.info('testResetPromiseSystem101 wallpaperXTS ===> testResetPromiseSystem err----11 : ' + JSON.stringify(err));
            expect(true).assertTrue();
            done();
        });
    })
