...
describe('ScreenLockServiceTest', function () {
     ...
     * @tc.name    Register for "beginWakeUp" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_0600", 0, async function () {
        console.log("------------------start ScreenLock_Test_0600-------------------");
        try {
            var eventType = 'beginWakeUp';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_0600: register beginWakeUp  issue successful");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_0600: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_0600-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_0700
     * @tc.name    Register for "endWakeUp" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_0700", 0, async function () {
        console.log("------------------start ScreenLock_Test_0700-------------------");
        try {
            var eventType = 'endWakeUp';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_0700: register endWakeUp  issue successful");
            });
        } catch (error) {
     ...
     * @tc.name    Register for "beginScreenOn" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_0800", 0, async function () {
        console.log("------------------start ScreenLock_Test_0800-------------------");
        try {
            var eventType = 'beginScreenOn';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_0800: register beginScreenOn  issue successful");
            })
        } catch (error) {
            console.log("logMessage ScreenLock_Test_0800: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_0800-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_0900
     * @tc.name    Register for "endScreenOn" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_0900", 0, async function () {
        console.log("------------------start ScreenLock_Test_0900-------------------");
        try {
            var eventType = 'endScreenOn';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_0900: register endScreenOn  issue successful");
            })
        } catch (error) {
            console.log("logMessage ScreenLock_Test_0900: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_0900-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1000
     * @tc.name    Register for "beginScreenOff" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1000", 0, async function () {
        console.log("------------------start ScreenLock_Test_1000-------------------");
        try {
            var eventType = 'beginScreenOff';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_1000: register beginScreenOff  issue successful");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1000: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1000-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1100
     * @tc.name    Register for "endScreenOff" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1100", 0, async function () {
        console.log("------------------start ScreenLock_Test_1100-------------------");
        try {
            var eventType = 'endScreenOff';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_1100: register endScreenOff  issue successful");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1100: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1100-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1200
     * @tc.name    Register for "unlockScreen" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1200", 0, async function () {
        console.log("------------------start ScreenLock_Test_1200-------------------");
        try {
            var eventType = 'unlockScreen';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_1200: register unlockScreen  issue successful");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1200: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1200-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1300
     * @tc.name    Register for "beginExitAnimation" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1300", 0, async function () {
        console.log("------------------start ScreenLock_Test_1300-------------------");
        try {
            var eventType = 'beginExitAnimation';
            screenLock.on(eventType, () => {
                console.log("ScreenLock_Test_1300: register beginExitAnimation  issue successful");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1300: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1300-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1400
     * @tc.name    Register for "beginSleep" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1400", 0, async function () {
        console.log("------------------start ScreenLock_Test_1400-------------------");
        try {
            var eventType = 'beginSleep';
            screenLock.on(eventType, (err, data) => {
                console.log("ScreenLock_Test_1400: register beginSleep  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1400: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1400-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1500
     * @tc.name    Register for "endSleep" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1500", 0, async function () {
        console.log("------------------start ScreenLock_Test_1500-------------------");
        try {
            var eventType = 'endSleep';
            screenLock.on(eventType, (err, data) => {
                console.log("ScreenLock_Test_1500: register endSleep  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1500: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1500-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1600
     * @tc.name    Register for "changeUser" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1600", 0, async function () {
        console.log("------------------start ScreenLock_Test_1600-------------------");
        try {
            var eventType = 'changeUser';
            screenLock.on(eventType, (err, data) => {
                console.log("ScreenLock_Test_1600: register changeUser  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1600: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1600-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1700
     * @tc.name    Register for "screenlockEnabled" event, success
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1700", 0, async function () {
        console.log("------------------start ScreenLock_Test_1700-------------------");
        try {
            var eventType = 'screenlockEnabled';
            screenLock.on(eventType, (err, data) => {
                console.log("ScreenLock_Test_1700: register screenlockEnabled  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1700: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1700-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1800
     * @tc.name    Register wrong "beginWabkeUp" event, registration failed
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1800", 0, async function () {
        console.log("------------------start ScreenLock_Test_1800-------------------");
        try {
            var errorEventType = 'errorbeginWakeUp';
            screenLock.on(errorEventType, () => {
                console.log("ScreenLock_Test_1800: register errorbeginWakeUp issue failed.");
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1800: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1500-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_1900
     * @tc.name    Register wrong "beginSleep" event, registration failed
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_1900", 0, async function () {
        console.log("------------------start ScreenLock_Test_1900-------------------");
        try {
            var errorEventType = 'errorbeginSleep';
            screenLock.on(errorEventType, (err, data) => {
                console.log("ScreenLock_Test_1900: register errorbeginSleep issue failed, result is " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_1900: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_1900-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_2000
     * @tc.name    Register wrong "screenlockEnabled" event, registration failed
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_2000", 0, async function () {
        console.log("------------------start ScreenLock_Test_2000-------------------");
        try {
            var errorEventType = 'errorscreenlockEnabled';
            screenLock.on(errorEventType, (err, data) => {
                console.log("ScreenLock_Test_2000: register screenlockEnabled issue failed., result is " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_2000: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_2000-------------------");
    });
    ...
    /*
     * @tc.number  Screenlock_Test_4800
     * @tc.name    Log out of "beginWakeUp" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_4800", 0, async function () {
        console.log("------------------start Screenlock_Test_4800-------------------");
        try {
            var eventType = 'beginWakeUp';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_4800: Logout beginWakeUp  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_4800: error = " + error);
        }
        console.log("------------------end Screenlock_Test_4800-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_4900
     * @tc.name    Log out of "endWakeUp" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_4900", 0, async function () {
        console.log("------------------start Screenlock_Test_4900-------------------");
        try {
            var eventType = 'endWakeUp';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_4900: Logout endWakeUp  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_4900: error = " + error);
        }
        console.log("------------------end Screenlock_Test_4900-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5000
     * @tc.name    Log out of "beginScreenOn" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5000", 0, async function () {
        console.log("------------------start Screenlock_Test_5000-------------------");
        try {
            var eventType = 'beginScreenOn';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5000: Logout beginScreenOn  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5000: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5000-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5100
     * @tc.name    Log out of "endScreenOn" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5100", 0, async function () {
        console.log("------------------start Screenlock_Test_5100-------------------");
        try {
            var eventType = 'endScreenOn';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5100: Logout endScreenOn  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5100: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5100-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5200
     * @tc.name    Log out of "beginScreenOff" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5200", 0, async function () {
        console.log("------------------start Screenlock_Test_5200-------------------");
        try {
            var eventType = 'beginScreenOff';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5200: Logout beginScreenOff  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5200: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5200-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5300
     * @tc.name    Log out of "endScreenOff" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5300", 0, async function () {
        console.log("------------------start Screenlock_Test_5300-------------------");
        try {
            var eventType = 'endScreenOff';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5300: Logout endScreenOff  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5300: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5300-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5400
     * @tc.name    Log out of "unlockScreen" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5400", 0, async function () {
        console.log("------------------start Screenlock_Test_5400-------------------");
        try {
            var eventType = 'unlockScreen';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5400: Logout unlockScreen  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5400: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5400-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5500
     * @tc.name    Log out of "beginExitAnimation" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5500", 0, async function () {
        console.log("------------------start Screenlock_Test_5500-------------------");
        try {
            var eventType = 'beginExitAnimation';
            screenLock.off(eventType, () => {
                console.log("Screenlock_Test_5500: Logout beginExitAnimation  issue successful");
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5500: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5500-------------------");
    });

    /*
     * @tc.number  ScreenLock_Test_5600
     * @tc.name    Log out of "beginSleep" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("ScreenLock_Test_5600", 0, async function () {
        console.log("------------------start ScreenLock_Test_5600-------------------");
        try {
            var eventType = 'beginSleep';
            screenLock.off(eventType, (err, data) => {
                console.log("ScreenLock_Test_5600: Logout beginSleep  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage ScreenLock_Test_5600: error = " + error);
        }
        console.log("------------------end ScreenLock_Test_5600-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5700
     * @tc.name    Log out of "endSleep" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5400", 0, async function () {
        console.log("------------------start Screenlock_Test_5700-------------------");
        try {
            var eventType = 'endSleep';
            screenLock.off(eventType, (err, data) => {
                console.log("Screenlock_Test_5700: Logout endSleep  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5700: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5700-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5800
     * @tc.name    Log out of "changeUser" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5800", 0, async function () {
        console.log("------------------start Screenlock_Test_5800-------------------");
        try {
            var eventType = 'changeUser';
            screenLock.off(eventType, (err, data) => {
                console.log("Screenlock_Test_5800: Logout changeUser  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5800: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5800-------------------");
    });

    /*
     * @tc.number  Screenlock_Test_5900
     * @tc.name    Log out of "screenlockEnabled" event
     * @tc.desc    Function test
     * @tc.level   0
     */
    it("Screenlock_Test_5900", 0, async function () {
        console.log("------------------start Screenlock_Test_5900-------------------");
        try {
            var eventType = 'screenlockEnabled';
            screenLock.off(eventType, (err, data) => {
                console.log("Screenlock_Test_5900: Logout screenlockEnabled  issue successful, result = " + data);
            });
        } catch (error) {
            console.log("logMessage Screenlock_Test_5900: error = " + error);
        }
        console.log("------------------end Screenlock_Test_5900-------------------");
    });
})