 ...
 */
TEE_TEST(TeeBasicTestFramework, TEE_GetSystemTime, Function | MediumTest | Level0)
{
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, TeeWait, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, GetPersistentTime, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, SetPersistentTime, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, TestPersistentTimeWithException, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, OnlyGetPersistentTime, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, GetReeTime, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, GetReeTimeStr, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, GetSecureRtcTime, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, CreateDestoryExpireRemainTimer, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = TIME_API_UUID;
