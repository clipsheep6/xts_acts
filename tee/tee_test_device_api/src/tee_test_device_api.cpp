 ...
 */
TEE_TEST(TeeBasicTestFramework, Test_SEAPI, Function | MediumTest | Level0)
{
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, Test_SEChannelSelectNext, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = DEVICE_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, Test_SESECURECHANNELOPENCLOSE, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = DEVICE_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, Test_TUIAPI, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = DEVICE_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, Test_RPMBAPI, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = DEVICE_API_UUID;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, Test_HUKAPI, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    uint32_t origin;
    TEEC_UUID testId = DEVICE_API_UUID;
