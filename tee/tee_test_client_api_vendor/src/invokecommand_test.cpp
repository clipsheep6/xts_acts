 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithSessionNotOpen, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithSessionIsClose, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithoutOperation, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithoutOrigin, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithoutSession, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationIsValue, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
    ...
    operation.params[NUM2].value.a = 0x555;
    operation.params[NUM2].value.b = 0x666;
    operation.params[NUM3].value.a = 0x777;
    operation.params[NUM3].value.b = 0x888;
    ...
    ASSERT_EQ(operation.params[NUM2].value.a, 0x555 - 1);
    ASSERT_EQ(operation.params[NUM2].value.b, 0x666 - 1);
    ASSERT_EQ(operation.params[NUM3].value.a, 0x777 - 1);
    ASSERT_EQ(operation.params[NUM3].value.b, 0x888 - 1);
}
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationIsTempMem, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
    ...
    operation.params[NUM2].tmpref.buffer = g_testData2;
    operation.params[NUM2].tmpref.size = TEST_STR_LEN;
    operation.params[NUM3].tmpref.buffer = g_testData3;
    operation.params[NUM3].tmpref.size = TEST_STR_LEN;
    ...
    ASSERT_STREQ(reinterpret_cast<char *>(operation.params[NUM2].tmpref.buffer), g_teeInout);
    ASSERT_EQ(operation.params[NUM2].tmpref.size, g_teeInoutLen);
    ASSERT_STREQ(reinterpret_cast<char *>(operation.params[NUM3].tmpref.buffer), g_teeInout);
    ASSERT_EQ(operation.params[NUM3].tmpref.size, g_teeInoutLen);
}
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationIsPartialMem, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    int rc;
    ...
    ASSERT_EQ(rc, 0);
    rc = memcpy_s(sharedMem[NUM2].buffer, TEST_STR_LEN, g_testData2, TEST_STR_LEN);
    ASSERT_EQ(rc, 0);
    rc = memcpy_s(sharedMem[NUM3].buffer, TEST_STR_LEN, g_testData3, TEST_STR_LEN);
    ASSERT_EQ(rc, 0);
    ...
    operation.params[NUM2].memref.parent = &sharedMem[NUM2];
    operation.params[NUM2].memref.offset = 0;
    operation.params[NUM2].memref.size = sharedMem[NUM2].size;
    operation.params[NUM3].memref.parent = &sharedMem[NUM3];
    operation.params[NUM3].memref.offset = 0;
    operation.params[NUM3].memref.size = sharedMem[NUM3].size;
    ...
    ASSERT_STREQ(reinterpret_cast<char *>(sharedMem[NUM2].buffer), g_teeInout);
    ASSERT_EQ(operation.params[NUM2].memref.size, g_teeInoutLen);
    ASSERT_STREQ(reinterpret_cast<char *>(sharedMem[NUM3].buffer), g_teeInout);
    ASSERT_EQ(operation.params[NUM3].memref.size, g_teeInoutLen);
}
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationIsTempMemIsNULL, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationNotStart, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationTypeTempUsePartial, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationTypePartialUseTemp, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationTypePartialIsNULL, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationTypePartialSizeIsExceed, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationTypePartialSizeIsZero, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefPartialBufferIsWrong, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientShareMemMgr testMem;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithContextIsAlreadyFinalize, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithOperationAllType, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
    ...
    operation.params[NUM2].tmpref.buffer = g_testData0;
    operation.params[NUM2].tmpref.size = TEST_STR_LEN;
    operation.params[NUM3].value.a = 0x123;
    operation.params[NUM3].value.b = 0x987;
    ...
    ASSERT_STREQ(reinterpret_cast<char *>(operation.params[NUM2].tmpref.buffer), g_teeInout);
    ASSERT_EQ(operation.params[NUM2].tmpref.size, g_teeInoutLen);
    ASSERT_EQ(operation.params[NUM3].value.a, 0x123 - 1);
    ASSERT_EQ(operation.params[NUM3].value.b, 0x987 - 1);
    TEEC_ReleaseSharedMemory(&testMem.sharedMem);
}
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefTempInput1024k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefTempOutput1024k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefTempInout1024k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    int rc;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefTempInoutExceed1024k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefWhole2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefWholeExceed2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefPartialInput2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefPartialOutput2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefPartialInout2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_ERROR_OUT_OF_MEMORY
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_WithMemrefPartialInoutExceed2048k, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
 ...
 * [NUM2] size > tee size, [NUM3] size > tee size
 * @testcase.expect    : return TEEC_ERROR_SHORT_BUFFER
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_ReturnLenWithMemrefTempOutput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
    ...
    operation.params[NUM2].tmpref.buffer = testData0 + OFFSET200;
    operation.params[NUM2].tmpref.size = SIZE20;
    operation.params[NUM3].tmpref.buffer = testData0 + OFFSET300;
    operation.params[NUM3].tmpref.size = SIZE20;
    ...
    EXPECT_EQ(operation.params[1].tmpref.size, g_teeOutputLen);
    EXPECT_EQ(operation.params[NUM2].tmpref.size, g_teeOutputLen);
    EXPECT_EQ(operation.params[NUM3].tmpref.size, g_teeOutputLen);
 ...
 * @testcase.expect    : return TEEC_ERROR_SHORT_BUFFER
 */
TEE_TEST(TeeBasicTestFramework, InvokeCommand_ReturnLenWithMemrefTempInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
    ...
    operation.params[NUM2].tmpref.buffer = testData0 + OFFSET200;
    operation.params[NUM2].tmpref.size = SIZE10;
    operation.params[NUM3].tmpref.buffer = testData0 + OFFSET300;
    operation.params[NUM3].tmpref.size = SIZE10;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramWithInitContext, InvokeCommand_5Thread_SameContext_DiffSessionAndAllocSharemem,
    Function | MediumTest | Level0)
{
    DatePacket iInvokeParams[NUM5];
    uint32_t i;
    pthread_t id[NUM5];
