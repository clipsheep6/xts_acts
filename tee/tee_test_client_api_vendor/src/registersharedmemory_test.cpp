 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithNotInitContext, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramWithInitContext, RegisterSharedMemory_WithSharedMemFlagIsInvalid,
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramWithInitContext, RegisterSharedMemory_WithSharedMemBufferIsNull,
    Function | MediumTest | Level0)
{
    TEEC_Result ret;
    char *testData0 = reinterpret_cast<char *>(malloc(TEST_STR_LEN));
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagInput_UseParamTypesOutput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagInput_UseParamTypesInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagInput_UseParamTypesWhole, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagOutput_UseParamTypesInput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagOutput_UseParamTypesInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_WithFlagOutput_UseParamTypesWhole, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
...
static void SetOperationParams(TEEC_Operation *operation, ClientShareMemMgr *testMem)
{
    ...
    operation->params[1].memref.offset = OFFSET100;
    operation->params[1].memref.size = SIZE20 + SIZE10;
    operation->params[NUM2].memref.parent = &testMem->sharedMem;
    operation->params[NUM2].memref.offset = OFFSET200;
    operation->params[NUM2].memref.size = SIZE20 + SIZE10;
    operation->params[NUM3].memref.parent = &testMem->sharedMem;
    operation->params[NUM3].memref.offset = OFFSET300;
    operation->params[NUM3].memref.size = SIZE20;
    return;
}
 ...
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_ReturnLenUseTypesOutput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    int rc;
    uint32_t origin;
    ...
    /* for test , [0] size < tee size, [1] size > tee size, [NUM2] size > tee size, [NUM3] size < tee size */
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_OffsetExceedTest1, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
    ...
    operation.params[NUM2].memref.parent = &testMem.sharedMem;
    operation.params[NUM2].memref.offset = OFFSET200;
    operation.params[NUM2].memref.size = SIZE20;
    operation.params[NUM3].memref.parent = &testMem.sharedMem;
    operation.params[NUM3].memref.offset = TEST_SIZE512 - SIZE10 + 1;
    operation.params[NUM3].memref.size = SIZE10;
    ret = TEEC_InvokeCommand(&sess.session, TEE_TEST_ALLTYPE, &operation, &origin);
    free(testData0);
    ASSERT_EQ(ret, TEEC_ERROR_BAD_PARAMETERS);
    ASSERT_EQ(origin, TEEC_ORIGIN_API);
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, RegisterSharedMemory_OffsetExceedTest2, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
    ...
    operation.params[NUM2].memref.size = SIZE20;
    operation.params[NUM3].memref.parent = &testMem.sharedMem;
    operation.params[NUM3].memref.offset = TEST_SIZE512 + 1;
    operation.params[NUM3].memref.size = SIZE10;
    ret = TEEC_InvokeCommand(&sess.session, TEE_TEST_ALLTYPE, &operation, &origin);
    free(testData0);
    operation.params[NUM3].memref.size = SIZE10;
