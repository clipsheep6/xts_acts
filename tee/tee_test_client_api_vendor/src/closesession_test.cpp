 ...
 */
TEE_TEST(TeeBasicTestFramework, Closesession_WithCreatedSession, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 */
TEE_TEST(TeeBasicTestFramework, Closesession_WithoutSession, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    ClientSessionMgr sess;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
 ...
 * @testcase.expect    : no error occur
 */
TEE_TEST(TeeBasicTestFramework, Closesession_WithNotOpenedSession, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    TEEC_UUID testId = CLIENTAPI_UUID_1;
    ClientSessionMgr sess;
