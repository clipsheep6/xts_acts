 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithNotInitContext, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramWithInitContext, AllocateSharedMemory_WithSharedMemFlagIsInvalid,
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagInput_UseParamTypesOutput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagInput_UseParamTypesInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_SUCCESS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagInput_UseParamTypesWhole, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    TEEC_Operation operation = { 0 };
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagOutput_UseParamTypesInput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagOutput_UseParamTypesInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_WithFlagOutput_UseParamTypesWhole, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_ReturnLenUseTypesOutput, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    int rc;
    ...
    EXPECT_EQ(operation.params[NUM2].memref.size, g_teeOutputLen);
    EXPECT_EQ(operation.params[NUM3].memref.size, g_teeOutputLen);
 ...
 * @testcase.expect    : return TEEC_ERROR_SHORT_BUFFER ,output buffer is correct
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_ReturnLenUseTypesInout, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    int rc;
    ...
    operation.params[NUM2].memref.parent = &testMem.sharedMem;
    operation.params[NUM2].memref.offset = OFFSET200;
    operation.params[NUM2].memref.size = SIZE10;
    operation.params[NUM3].memref.parent = &testMem.sharedMem;
    operation.params[NUM3].memref.offset = OFFSET300;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_OffsetExceedTest1, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
 ...
 * @testcase.expect    : return TEEC_ERROR_BAD_PARAMETERS
 */
TEE_TEST(TeeBasicTestFramework, AllocateSharedMemory_OffsetExceedTest2, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    uint32_t origin;
    ClientSessionMgr sess;
