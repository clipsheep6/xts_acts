 ...
 */
TEE_TEST(TeeBasicTestFramework, InitContext_NameIsNotNULL, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InitContext_ContextIsNULL, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 */
TEE_TEST(TeeBasicTestFramework, InitContext_Use17Context, Function | MediumTest | Level0)
{
    TEEC_Result ret;
