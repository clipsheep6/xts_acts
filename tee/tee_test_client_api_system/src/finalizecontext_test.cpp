 ...
 */
TEE_TEST(TeeBasicTestFramework, Finalizecontext_WithCreatedContext, Function | MediumTest | Level0)
{
    TEEC_Result ret;
 ...
 */
TEE_TEST(TeeBasicTestFramework, Finalizecontext_WithNotCreatedContext, Function | MediumTest | Level0)
{
    ClientSessionMgr sess;
    sess.context = { 0 };
    TEEC_FinalizeContext(&sess.context);
 ...
 * @testcase.expect    : fd is -1
 */
TEE_TEST(TeeBasicTestFramework, Finalizecontext_WithoutContext, Function | MediumTest | Level0)
{
    TEEC_Result ret;
    ClientSessionMgr sess;
    ret = TEEC_InitializeContext(NULL, &sess.context);
