...
TEEC_Result ClientSessionMgr::Start(TEEC_UUID *uuid)
{
    ...
    (void)sprintf_s(str, STR_LEN, "/data/local/tmp/%08x-%04x-%04x-%02x%02x-%02x%02x%02x%02x%02x%02x.sec", uuid->timeLow,
        ...
        uuid->clockSeqAndNode[NUM2], uuid->clockSeqAndNode[NUM3], uuid->clockSeqAndNode[NUM4],
        uuid->clockSeqAndNode[NUM5], uuid->clockSeqAndNode[NUM6], uuid->clockSeqAndNode[NUM7]);
