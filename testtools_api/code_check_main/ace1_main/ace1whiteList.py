...
def sourcs_parse(source_datas=None, white_path='./ace1_main/whiteList.xlsx'):
# def sourcs_parse(source_datas=None, white_path='./whiteList.xlsx'):
    ...
    for item in list(sh.rows)[1:]:
        ...
        api["api_used_count"] = values[6]
        api["api_used"] = values[7]
    ...
    for white_data in white_json_list:
        ...
        if white_data["api_module_name"] == api_module_name(source_datas["api_module_name"]):
            for api_data in source_datas["api"]:
                if api_data["api_class_name"] == white_data["api_class_name"] and api_data["api_method_name"] == white_data["api_method_name"]:
                    api_data["api_used_count"] = 1
                    api_data["api_used"] = "是"
                    api_data["is_white"] = "是"
                    api_data["desc"] = white_data["desc"]
    return source_datas
...
#     sourcs_parse(source_datas=json_str)
    pass
    white_path = r'F:\work\code_check\0330_all\ace1_main\whiteList.xlsx'
