...
describe('SR000GGR3I_TreeSetTest', function () {
    ...
    it('SR000GGR3I_testGetHigherValue008_2', 0, function () {
        console.log("getHigherValue-----002");
        let treeset = new TreeSet()
        try{
            let res = treeset.getHigherValue(3);
        }catch(err){
