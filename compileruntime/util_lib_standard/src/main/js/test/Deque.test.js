...
describe('DequeTest', function () {
    ...
    it('SR000GGR3K_testInsertFront015', 0, function () {
        console.log("insertFront-----005");
        let deque = new Deque();
        deque.insertFront('$');
        console.log("insertFront-----end");
        let res = deque.getFirst();
        console.log(res);
    ...
    it('SR000GGR3K_testInsertEnd020', 0, function () {
        console.log("insertEnd-----4");
        let deque = new Deque();
        deque.insertEnd('$');
        console.log("insertEnd-----end");
        let res = deque.getLast()
        expect(res).assertEqual('$')
    })

    it('SR000GGR3K_testInsertEnd021', 0, function () {
        console.log("insertEnd-----5");
        let deque = new Deque();
        deque.insertEnd(" ");
        console.log("insertEnd-----end");
        let res = deque.getLast()
    ...
    it('SR000GGR3K_testPopFirst026', 0, function () {
        ...
        console.log("res-----" + res);
        expect(res).assertEqual(undefined);
        console.log("popFirst-----end");
    })

    it('SR000GGR3K_testGetFirst027', 0, function () {
        console.log("getFirst-----002");
        let deque = new Deque();
        let res = deque.getFirst();
        console.log("res-----" + res);
        expect(res).assertEqual(undefined)
