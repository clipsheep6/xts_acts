...
describe('LightWeightSetTest', function () {
    ...
    it('SR000GGR43_testAddAll008', 0, function () {
        ...
        lightweightset1.add("g");
        lightweightset1.add("h");
    ...
    it('SR000GGR43_testForEach019', 0, function () {
        console.log("forEach-----001");
        let lightweightset = new LightWeightSet();
        lightweightset.add(1);
        lightweightset.add(2);
    ...
    it('SR000GGR43_testToString020', 0, function () {
    ...
    it('SR000GGR43_testToArray021', 0, function () {
    ...
    it('SR000GGR43_testGetValueAt022', 0, function () {
    ...
    it('SR000GGR43_testIterator023', 0, function () {
    ...
    it('SR000GGR43_testValues024', 0, function () {
