...
describe('LightWeightSetTest', function () {
    ...
    it('SR000GGR43_testAddAll008', 0, function () {
        ...
        console.log(res1);
        for(let i=1; i < 8; i++) {
            console.log("value-----" + lightweightset.has(i));
    ...
    it('SR000GGR43_testAdd025', 0, function () {
        console.log("add value is double");
        let lightweightset = new LightWeightSet();
    ...
    it('SR000GGR43_testHasAll026', 0, function () {
        console.log("lightweightset1 all value is dif in lightweightset");
        let lightweightset = new LightWeightSet();
        lightweightset.add(1);
        lightweightset.add(2);
        lightweightset.add(3);
    ...
    it('SR000GGR43_testHasAll027', 0, function () {
        console.log("lightweightset1 has one dif value with lightweightset");
        let lightweightset = new LightWeightSet();
        lightweightset.add(1);
        lightweightset.add(2);
        lightweightset.add(3);
    ...
    it('SR000GGR43_testRemove028', 0, function () {
        console.log("when lightweightset is empty");
        let lightweightset = new LightWeightSet();
        try{
    ...
    it('SR000GGR43_testIncreaseCapacityTo030', 0, function () {
        console.log("when there is 5 elements int lightweightset, then change Capacity to 3 ");
        let lightweightset = new LightWeightSet();
        lightweightset.add(1);
        lightweightset.add(2);
        lightweightset.add(3);
    ...
    it('SR000GGR43_testIncreaseCapacityTo033', 0, function () {
        console.log("when there is 5 elements int lightweightset, then add index longer then old ");
        let lightweightset = new LightWeightSet();
        lightweightset.add(1);
        lightweightset.add(2);
        lightweightset.add(3);
