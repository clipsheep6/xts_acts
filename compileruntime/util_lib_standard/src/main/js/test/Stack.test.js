...
describe('StackTest', function () {
    ...
    it('SR000GGR49_test_peek028', 0, function () {
        console.log("peek-----002");
        let stack = new Stack();
        try {
            let res = stack.peek();
        } catch (err) {
            console.log("peek002-----" + err);
