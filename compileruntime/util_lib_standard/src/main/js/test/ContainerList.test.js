...
describe('QueueTest', function () {
    ...
    it('SR000GGR4A_testGetSubList035', 0, function () {
        ...
        try {
            ...
            console.log("getSubList003Error-----" + err);
    ...
    it('SR000GGR4A_testGetSubList036', 0, function () {
        ...
        try {
            ...
            expect(err).assertEqual("Error: toIndex cannot be less than or equal to fromIndex")
        }
    })
    ...
    it('SR000GGR4A_testReplaceAllElements058', 0, function () {
        ...
        try {
            ...
            console.log("replaceAllElements-----" + err);
            expect(err).assertEqual("TypeError: Obj is not a valid object")
        }
        expect(num).assertEqual(0);
    })
    ...
    it('SR000GGR4A_testlterator061', 0, function () {
        ...
        for (const iterator of list) {
            ...
            console.log('iterator: ' + iterator + ' num: '+ num)
            num++;
        }
    })
