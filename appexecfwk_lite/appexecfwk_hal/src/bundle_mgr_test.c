 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
LITE_TEST_CASE(BundleMgrTestSuite, testGetBundleSizeWithLegal_0001, Function | MediumTest | Level1)
{
    printf("------start testGetBundleSizeWithLegal_0001------\n");
    char *bundleName = "com.openharmony.testjsdemo";
    uint8_t ret = GetBundleSize(bundleName);
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
LITE_TEST_CASE(BundleMgrTestSuite, testGetBundleSizeWithIllegal_0001, Function | MediumTest | Level2)
{
    printf("------start testGetBundleSizeWithIllegal_0001------\n");
    char *bundleName = "com.openharmony.testjsdemoBundleNameLength128test" \
"jsdemoBundleNameLength128testjsdemoBundleNameLength128testjsdemoBundleNameLengt";
    TEST_ASSERT_TRUE(strlen(bundleName) == 128);
    uint8_t ret = GetBundleSize(bundleName);
    TEST_ASSERT_FALSE(ret);
 ...
 * @tc.name      : GetBundleSize parameter illegal and bundleName NULL test
 * @tc.desc      : [C- SOFTWARE -0200]
 */
LITE_TEST_CASE(BundleMgrTestSuite, testGetBundleSizeWithIllegal_0002, Function | MediumTest | Level2)
{
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
LITE_TEST_CASE(BundleMgrTestSuite, testGetBundleSizeWithIllegal_0003, Function | MediumTest | Level2)
{
    printf("------start testGetBundleSizeWithIllegal_0003------\n");
    char *bundleName = "com.openharmony.nothishap";
    // error bundleName
    uint8_t ret = GetBundleSize(bundleName);
    TEST_ASSERT_FALSE(ret);
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
LITE_TEST_CASE(BundleMgrTestSuite, testGetBundleSizeWithIllegal_0004, Function | MediumTest | Level2)
{
