...
/*
* @tc.name: BUS_CENTER_SDK_GET_LOCAL_NODE_INFO_Test_001 GetLocalNodeDeviceInfo
* @tc.desc: get local info interface test
* @tc.type: FUNC
* @tc.require: AR000FK6J4
*/
LITE_TEST_CASE(BusCenterTestSuite, testGetLocalNodeDeviceInfo, Function | MediumTest | Level0)
{
...
/*
* @tc.name: BUS_CENTER_SDK_GET_NODE_KEY_INFO_Test_001 GetLocalNodeDeviceInfo/GetNodeKeyInfo
* @tc.desc: get node key info interface test
* @tc.type: FUNC
* @tc.require: AR000FK6J4
*/
LITE_TEST_CASE(BusCenterTestSuite, testGetNodeKeyInfo, Function | MediumTest | Level0)
{
    NodeBasicInfo info;
...
/*
* @tc.name: BUS_CENTER_SDK_START_TIME_SYNC_Test_001 StartTimeSync
...
/*
* @tc.name: BUS_CENTER_SDK_START_TIME_SYNC_Test_002 StopTimeSync
* @tc.desc: start time sync interface test
* @tc.type: FUNC
* @tc.require: AR000FN60G
*/
 ...
 * @tc.require:
 */
LITE_TEST_CASE(BusCenterTestSuite, PublishLNNTest001, Function | MediumTest | Level0)
{
 ...
 * @tc.require:
 */
LITE_TEST_CASE(BusCenterTestSuite, PublishLNNTest002, Function | MediumTest | Level0)
{
    int32_t ret;
 ...
 * @tc.require:
 */
LITE_TEST_CASE(BusCenterTestSuite, RefreshLNNTest001, Function | MediumTest | Level0)
{
    int ret;
 ...
 * @tc.require:
 */
LITE_TEST_CASE(BusCenterTestSuite, RefreshLNNTest002, Function | MediumTest | Level0)
{
    int32_t ret;
...
* @tc.require:
*/
LITE_TEST_CASE(BusCenterTestSuite, BUS_CENTER_SDK_META_NODE_Test_001, Function | MediumTest | Level0)
{
...
* @tc.require:
*/
LITE_TEST_CASE(BusCenterTestSuite, BUS_CENTER_SDK_META_NODE_Test_002, Function | MediumTest | Level0)
{
    char udid[] = "0123456789987654321001234567899876543210012345678998765432100123";
    char metaNodeId[NETWORK_ID_BUF_LEN] = {0};
    MetaNodeInfo infos[MAX_META_NODE_NUM];
    ...
    for (i = 0; i < MAX_META_NODE_NUM; ++i) {
        //TEST_ASSERT_TRUE(infos[i].isOnline);
