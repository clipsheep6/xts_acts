 ...
 * @tc.require:
 */
LITE_TEST_CASE(SessionTestSuite, SendStreamTest001, Function | MediumTest | Level0)
{
    int ret;
    int sessionId = 1;
 ...
 * @tc.require:
 */
LITE_TEST_CASE(SessionTestSuite, QosReportTest001, Function | MediumTest | Level0)
{
    int ret;
...
/**
 * @tc.name: TransQosTest001   SetFileSendListener
 * @tc.desc: test the wrong parameter.
 * @tc.type: FUNC
 * @tc.require:
 */
LITE_TEST_CASE(SessionTestSuite, TestSetFileSendListenerTest001, Function | MediumTest | Level0)
{
 ...
 * @tc.require:
 */
LITE_TEST_CASE(SessionTestSuite, SendFileTest001, Function | MediumTest | Level0)
{
 ...
 * @tc.require:
 */
LITE_TEST_CASE(SessionTestSuite, SetFileReceiveListenerTest001, Function | MediumTest | Level0)
{
...
/**
 * @tc.name: TestGetPeerDeviceId001    int GetSessionSide(int sessionId);
 * @tc.desc: extern module active publish, use the wrong parameter.
 * @tc.type: FUNC
 * @tc.require:
 */
