...
extern "C" __attribute__((constructor)) void RegisterEntryModule(void) { napi_module_register(&demoModule); }arkui/ace_ets_web_scheme_handler_three_napis/entry/src/main/cpp/hello.cpp