...
void PluginRender::DispatchTouchEvent(OH_NativeXComponent* component, void* window)
{
    ...
    if (ret == OH_NATIVEXCOMPONENT_RESULT_SUCCESS) {
        ...
        LOGE("xclog DispatchTouchEvent TouchID is %{public}d TouchType is %{public}d, surf_x is %{public}f, surf_y is %{public}f", 
             testTouchEvent_.id, testTouchEvent_.type, testTouchEvent_.x, testTouchEvent_.y);
