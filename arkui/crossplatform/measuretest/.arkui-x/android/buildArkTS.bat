...
set project_path=C:/Users/JIAYI-~1/AppData/Local/Temp/aceProject/measuretest
set ohpm_path=D:\OpenHarmony\ohpm-1.2.4\bin\ohpm
set arkuiXSdkPath=D:\OpenHarmony\DevEco Studio 4.0.0.400 ArkuiX SDK\11\arkui-x
