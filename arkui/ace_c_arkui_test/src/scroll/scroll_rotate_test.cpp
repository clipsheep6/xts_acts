...
/*
 * @tc.number: SUB_ARKUI_CAPI_SCROLL_ROTATE_0300
 * @tc.name: testScrollRotate003
 * @tc.desc: testing Rotate for scroll with abnormal value
 * @tc.size: MediumTest
 * @tc.type: Function
 * @tc.level: Level 1
 */
HWTEST_F(ScrollCapiTest, testScrollRotate003, Function | MediumTest | Level1)
{
    ArkUI_NumberValue value[] = {{.f32 = ABNORMAL_VALUE},
                                 {.f32 = ABNORMAL_VALUE},
                                 {.f32 = ABNORMAL_VALUE},
                                 {.f32 = ABNORMAL_VALUE},
                                 {.f32 = ABNORMAL_VALUE}};
    ...
    ASSERT_NE(nodeAPI->getAttribute(scroll, NODE_ROTATE)->value[PARAM_0].f32, ABNORMAL_VALUE);
    ASSERT_NE(nodeAPI->getAttribute(scroll, NODE_ROTATE)->value[PARAM_1].f32, ABNORMAL_VALUE);
    ASSERT_NE(nodeAPI->getAttribute(scroll, NODE_ROTATE)->value[PARAM_2].f32, ABNORMAL_VALUE);
    ASSERT_NE(nodeAPI->getAttribute(scroll, NODE_ROTATE)->value[PARAM_3].f32, ABNORMAL_VALUE);
    ASSERT_NE(nodeAPI->getAttribute(scroll, NODE_ROTATE)->value[PARAM_4].f32, ABNORMAL_VALUE);
}
