...
HWTEST_F(SwiperCapiTest, testSwiperBackgroundImage005, Function | MediumTest | Level2)
{
    ...
    ASSERT_NE(nodeAPI->getAttribute(swiper, NODE_BACKGROUND_IMAGE)->value->i32, ARKUI_IMAGE_REPEAT_X);
}
 ...
 * @tc.level: Level 2
 */
HWTEST_F(SwiperCapiTest, testSwiperBackgroundImage007, Function | MediumTest | Level2)
{
    int32_t repeatValue = -1;
    const char *imageUrl = "abcdefg";
...
/*
 * @tc.number: SUB_ARKUI_CAPI_SWIPER_BACKGROUNDIMAGE_0800
 * @tc.name: testSwiperBackgroundImage008
 * @tc.desc: testing default values of backgroundImage property of the swiper
 * @tc.size: MediumTest
 * @tc.type: Function
 * @tc.level: Level 1
 */
HWTEST_F(SwiperCapiTest, testSwiperBackgroundImage008, Function | MediumTest | Level1)
{
