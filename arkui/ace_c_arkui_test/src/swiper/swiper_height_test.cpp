 ...
 * @tc.level: Level 1
 */
HWTEST_F(SwiperCapiTest, testSwiperHeight001, Function | MediumTest | Level1)
{
    float height = 300;
 ...
 * @tc.level: Level 2
 */
HWTEST_F(SwiperCapiTest, testSwiperHeight002, Function | MediumTest | Level2)
{
    float height = -100;
 ...
 * @tc.level: Level 1
 */
HWTEST_F(SwiperCapiTest, testSwiperHeight003, Function | MediumTest | Level1)
{
    float height = 10000;
