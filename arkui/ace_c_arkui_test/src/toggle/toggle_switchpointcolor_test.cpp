 ...
 * @tc.level: Level 1
 */
HWTEST_F(ToggleCapiTest, testToggleSwitchPointColor001, Function | MediumTest | Level1)
{
 ...
 * @tc.level: Level 1
 */
HWTEST_F(ToggleCapiTest, testToggleSwitchPointColor002, Function | MediumTest | Level1)
{
 ...
 * @tc.level: Level 1
 */
HWTEST_F(ToggleCapiTest, testToggleSwitchPointColor003, Function | MediumTest | Level1)
{
