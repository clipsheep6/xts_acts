...
OH_NNCore_ReturnCode ConstructTensorDesc(OH_NNCore_TensorDesc** tensorDesc, const int32_t* shape, size_t shapeNum, 
...
HWTEST_F(End2EndTest, end_to_end_test_001, Function | MediumTest | Level1)
{
    ...
    ASSERT_EQ(OH_NNCORE_SUCCESS, ConstructTensorDesc(&tensorDesc, inputDims, 4, 
...
HWTEST_F(End2EndTest, end_to_end_test_003, Function | MediumTest | Level1)
{
    ...
    int32_t inputDims[4] = {1, 2, 2, 3};
    ASSERT_EQ(OH_NNCORE_SUCCESS, ConstructTensorDesc(&tensorDesc1, inputDims, 4, 
                                                  OH_NNCORE_FLOAT32, OH_NNCORE_FORMAT_NONE));
    ...
    inputDims[0] = -1;
    ASSERT_EQ(OH_NNCORE_SUCCESS, ConstructTensorDesc(&tensorDesc2, inputDims, 4, 
                                                  OH_NNCORE_FLOAT32, OH_NNCORE_FORMAT_NONE));
