...
class HdiNNCoreBackend : public testing::Test {};
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdiNNCoreBackend, SUB_AI_NNRt_Core_Func_North_Get_Backend_Number_0100, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdiNNCoreBackend, SUB_AI_NNRt_Core_Func_North_Get_Backend_Number_0200, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdiNNCoreBackend, SUB_AI_NNRt_Core_Func_North_Get_Backend_Name_0100, Function | MediumTest | Level1)
{
    //未注册，数量为0
    size_t backendNum = -1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdiNNCoreBackend, SUB_AI_NNRt_Core_Func_North_Get_Backend_Name_0200, Function | MediumTest | Level1)
{
    TestGetBackendNum();
 ...
 * @tc.type: FUNC
 */
HWTEST_F(HdiNNCoreBackend, SUB_AI_NNRt_Core_Func_North_Get_Backend_Name_0300, Function | MediumTest | Level1)
{
    const char* backendName = nullptr;
