 ...
 * @tc.desc   : [C- SOFTWARE -0200]
 */
HWTEST_F(MemoryTest, SUB_AI_NNRt_Func_North_Executor_Memory_GetMemoryData_0100, Function | MediumTest | Level3)
{
    void* data = nullptr;
    size_t length = 0;
 ...
 * @tc.desc   : [C- SOFTWARE -0200]
 */
HWTEST_F(MemoryTest, SUB_AI_NNRt_Func_North_Executor_Memory_GetMemoryfd_0100, Function | MediumTest | Level3)
{
    int32_t fd = 0;
