...
describe('userauthTest', function () {
        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    console.info('testFace Security_IAM_PIN_AddCred_Func_0102 callback data = ' + JSON.stringify(data));
                    let addcredresult101 = data.addCredresult;
                    console.info("testFace Security_IAM_PIN_AddCred_Func_0102 addcredresult101 = " + addcredresult101);
                    ...
                    publicFC.publicauthUser(UserAuth, userID.User1, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                            ...
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0102 publicdelUser callback success");
                                let deluserresult = data.delUserresult;
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0102 publicdelUser deluserresult = " + deluserresult);
                                expect(ResultCode.SUCCESS).assertEqual(deluserresult);
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info("testFace Security_IAM_PIN_AddCred_Func_0102 publicCloseSession success data = " + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info("testFace  Security_IAM_PIN_AddCred_Func_0102 publicunRegisterInputer success = " + data);
                                        done();
                                    })
                                })
                            }, function (data) {
        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    console.info('testFace Security_IAM_PIN_AddCred_Func_0103 callback data = ' + JSON.stringify(data));
                    let addcredresult101 = data.addCredresult;
                    console.info("testFace Security_IAM_PIN_AddCred_Func_0103 addcredresult101 = " + addcredresult101);
                    expect(ResultCode.SUCCESS).assertEqual(addcredresult101);
                    let token;
                    ...
                    publicFC.publicauthUser(UserAuth, userID.User1, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                            ...
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0103 publicdelUser callback success");
                                let deluserresult = data.delUserresult;
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0103 publicdelUser deluserresult = " + deluserresult);
                                expect(ResultCode.SUCCESS).assertEqual(deluserresult);
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info("testFace Security_IAM_PIN_AddCred_Func_0103 publicCloseSession success data = " + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info("testFace  Security_IAM_PIN_AddCred_Func_0103 publicunRegisterInputer success = " + data);
                                        done();
                                    })
                                })
                            }, function (data) {
        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinmix, function (data) {
                    console.info('testFace Security_IAM_PIN_AddCred_Func_0104 callback data = ' + JSON.stringify(data));
                    let addcredresult101 = data.addCredresult;
                    console.info("testFace Security_IAM_PIN_AddCred_Func_0104 addcredresult101 = " + addcredresult101);
                    expect(ResultCode.SUCCESS).assertEqual(addcredresult101);
                    let token;
                    ...
                    publicFC.publicauthUser(UserAuth, userID.User1, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                            ...
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0104 publicdelUser callback success");
                                let deluserresult = data.delUserresult;
                                console.info("testFace Security_IAM_PIN_AddCred_Func_0104 publicdelUser deluserresult = " + deluserresult);
                                expect(ResultCode.SUCCESS).assertEqual(deluserresult);
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info("testFace Security_IAM_PIN_AddCred_Func_0104 publicCloseSession success data = " + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info("testFace  Security_IAM_PIN_AddCred_Func_0104 publicunRegisterInputer success = " + data);
                                        done();
                                    })
                                })
                            }, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    ...
                    publicFC.publicauth(UserAuth, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            setTimeout(publicFC.publicRegisterInputer(PinAuth, AuthSubType.PIN_MIXED, Inputerdatamixn), 500)
                            await publicFC.publicauth(UserAuth, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                                let authresult = data.authresult
                                expect(ResultCode.Authfail).assertEqual(authresult);
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    ...
                    publicFC.publicauth(UserAuth, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            setTimeout(publicFC.publicRegisterInputer(PinAuth, AuthSubType.PIN_NUMBER, Inputerdatanumn), 500)
                            await publicFC.publicauth(UserAuth, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                                let authresult = data.authresult
                                expect(ResultCode.Authfail).assertEqual(authresult);
                                let deluserresult = publicFC.publicdelUser(UserIDM, token, function (data) {
    ...
    it('Security_IAM_PIN_Auth_Func_0104', 3, async function (done) {
        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    let addcredresult101 = data.addcredresult;
                    publicFC.publicauthUser(UserAuth, userID.User1, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        let auth101 = data
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            await publicFC.publicauthUser(UserAuth, userID.User1, challenge1, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                                let authresult = data.authresult
                                expect(ResultCode.Authfail).assertEqual(authresult);
                                publicFC.publicdelUser(UserIDM, token, function (data) {
                                    let delresult = data.delUserresult
    ...
    //                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
    //                    let addcredresult101 = data.addCredresult;
    //                    console.info("testFace Security_IAM_PIN_Auth_Func_0110 addcredresult101 = " + addcredresult101);
    //                    let result1 = null;
    //                    let contextID1 = null;
    ...
    //                        await sleep(3000);
    //                        let cancelAuthresult = publicFC.publicgecancelAuth(UserAuth, contextID1)
    //                        console.info("testFace Security_IAM_PIN_Auth_Func_0110 cancelAuthresult = " + cancelAuthresult);
    //                        expect(ResultCode.SUCCESS).assertEqual(cancelAuthresult);
    //                        expect(ResultCode.CANCELED).assertEqual(result1);
    //                        publicFC.publicCloseSession(UserIDM, function (data) {
    ...
    //                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
    //                    let addcredresult102 = data.addCredresult;
    //                    console.info("testFace Security_IAM_PIN_Auth_Func_0111 addcredresult102 = " + addcredresult102);
    //                    let result2 = null;
    //                    let contextID2 = null;
    ...
    //                        await sleep(8000);
    //                        let cancelAuthresult = publicFC.publicgecancelAuth(UserAuth, contextID2)
    //                        console.info("testFace Security_IAM_PIN_Auth_Func_0111 cancelAuthresult = " + cancelAuthresult);
    //                        expect(ResultCode.SUCCESS).assertEqual(cancelAuthresult);
    //                        expect(ResultCode.CANCELED).assertEqual(result2);
    //                        publicFC.publicCloseSession(UserIDM, function (data) {
    ...
    //                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
    //                    let addcredresult103 = data.addCredresult;
    //                    console.info("testFace Security_IAM_PIN_Auth_Func_0112 addcredresult103 = " + addcredresult103);
    //                    let result3 = null;
    //                    let contextID3 = null;
    ...
    //                        await sleep(11000);
    //                        let cancelAuthresult = publicFC.publicgecancelAuth(UserAuth, contextID3)
    //                        console.info("testFace Security_IAM_PIN_Auth_Func_0112 cancelAuthresult = " + cancelAuthresult);
    //                        expect(ResultCode.SUCCESS).assertEqual(cancelAuthresult);
    //                        expect(ResultCode.CANCELED).assertEqual(result3);
    //                        publicFC.publicdelUser(UserIDM, token, function (data) {
    //                            let deluserresult = data.delUserresult
    //                            console.info("testFace Security_IAM_PIN_Auth_Func_0112 deluserresult = " + deluserresult);
    //                            publicFC.publicCloseSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    ...
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            await setTimeout(publicFC.publicRegisterInputer(PinAuth, AuthSubType.PIN_NUMBER, Inputerdatanum), 500)
                            CredentialInfopinnum.token = token
                            console.info("Security_IAM_PIN_Update_Func_0101 CredentialInfopinnum.token = " + CredentialInfopinnum.token);
                            await publicFC.publicupdateCred(UserIDM, CredentialInfopinnum, function (data) {
                                ...
                                publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                                    ...
                                    publicFC.publicdelUser(UserIDM, token1, function (data) {
                                        console.info("Security_IAM_PIN_Update_Func_0101 publicdelUser result  = " + data.delUserresult);
                                        publicFC.publicCloseSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    ...
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            await setTimeout(publicFC.publicRegisterInputer(PinAuth, AuthSubType.PIN_MIXED, Inputerdatamix), 500)
                            console.info("Security_IAM_PIN_Update_Func_0102 challenge = " + challenge);
                            CredentialInfopinnum.token = token
                            console.info("Security_IAM_PIN_Update_Func_0102 CredentialInfopinnum.token = " + CredentialInfopinnum.token);
                            await publicFC.publicupdateCred(UserIDM, CredentialInfopinnum, function (data) {
                                let updateresult = data.updateCredresult;
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinnum, function (data) {
                    ...
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicunRegisterInputer(PinAuth, async function (data) {
                            ...
                            console.info("Security_IAM_PIN_Update_Func_0103 challenge = " + challenge);
                            CredentialInfopinnum.token = token
                            console.info("Security_IAM_PIN_Update_Func_0103 CredentialInfopinnum.token = " + CredentialInfopinnum.token);
                            await publicFC.publicupdateCred(UserIDM, CredentialInfopinnum, function (data) {
                                let updateresult = data.updateCredresult;
