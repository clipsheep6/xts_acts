        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM,CredentialInfopinsix, function (onresult) {
                    console.info('Security_IAM_Face_AddCred_Func_0101 addCredential onResult1 = ' + JSON.stringify(onresult));
                    let info101;
                    publicFC.publicauth(UserAuth,challenge,AuthType.PIN,AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicaddCredential(UserIDM,CredentialInfoface2d, function (onresult) {
                            console.info('Security_IAM_Face_AddCred_Func_0101 addCredential onResult2 = ' + JSON.stringify(onresult));
                            ...
                            publicFC.publicauth(UserAuth,challenge,AuthType.FACE,AuthTurstLevel.ATL1, function (data) {
                                console.info('testFace Security_IAM_Face_AddCred_Func_0101 publicauth onResult = ' + JSON.stringify(data));
                                let faceauth101 = data;
                                expect(ResultCode.SUCCESS).assertEqual(faceauth101.authresult);
                                publicFC.publicauthUser(UserAuth,userID.User1,challenge,AuthType.FACE,AuthTurstLevel.ATL1, function (data) {
                                    console.info('testFace Security_IAM_Face_AddCred_Func_0101 publicauth onResult = ' + JSON.stringify(data));
                                    faceauth101 = data;
                                    expect(ResultCode.SUCCESS).assertEqual(faceauth101.authresult);
                                    ...
                                    publicFC.publicdelCred(UserIDM,credentialId,token, function (data) {
                                        console.info('testFace Security_IAM_Face_AddCred_Func_0101 publicdelCred onResult = ' + JSON.stringify(data));
                                        delcredresult = data;
                                        expect(ResultCode.SUCCESS).assertEqual(delcredresult.delCredresult);
                                        publicFC.publicdelUser(UserIDM,token, function (data) {
                                            console.info('Security_IAM_Face_AddCred_Func_0101 delUser onResult = ' + JSON.stringify(data));
                                            publicFC.publicCloseSession(UserIDM, function (data) {
                                                ...
                                                publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                                    console.info('Security_IAM_Face_AddCred_Func_0101 unRegisterInputer');
                                                    done();
                                                })
                                            })
                                        }, function (data) {
                                            console.info('Security_IAM_Face_AddCred_Func_0101 delUser onAcquireInfo = ' + JSON.stringify(data));
                                        })
                                    }, function (onacquireinfo) {
                                        console.info('Security_IAM_Face_AddCred_Func_0101 authface onAcquireInfo2 = ' + JSON.stringify(onacquireinfo))
                                    })
                                }, function (onacquireinfo) {
                                    console.info('Security_IAM_Face_AddCred_Func_0101 authface onAcquireInfo2 = ' + JSON.stringify(onacquireinfo))
                                })
                            ...
                            console.info('Security_IAM_Face_AddCred_Func_0101 addCredential onAcquireInfo2 = ' + JSON.stringify(onacquireinfo))
                        })
                    }, function (data) {
                        console.info('Security_IAM_Face_AddCred_Func_0101 auth onAcquireInfo = ' + JSON.stringify(data));
                    })
                }, function (onacquireinfo) {
                    console.info('Security_IAM_Face_AddCred_Func_0101 addCredential onAcquireInfo1 = ' + JSON.stringify(onacquireinfo))
                })
            })
        } catch (e) {
    ...
    it('Security_IAM_Face_AddCred_Func_0102', 2, async function (done) {
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                challenge = data;
                publicFC.publicaddCredential(UserIDM,CredentialInfopinsix, function (data) {
                    console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicaddCredential onResult = ' + JSON.stringify(data));
                    let info101 ;
                    publicFC.publicauth(UserAuth,challenge,AuthType.PIN,AuthTurstLevel.ATL1, function (data) {
                        console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicauth onResult = ' + JSON.stringify(data));
                        info101 = data;
                        let token = info101.authextr.token;
                        CredentialInfoface2d.token = token;
                        let addfaceresult ;
                        publicFC.publicaddCredential(UserIDM,CredentialInfoface2d, function (data) {
                            ...
                            publicFC.publicdelCred(UserIDM,credentialId,token1, function (data) {
                                console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicdelCred onResult = ' + JSON.stringify(data));
                                delcredresult = data;
                                expect(ResultCode.FAIL).assertEqual(delcredresult.authresult);
                                publicFC.publicdelUser(UserIDM,token, function (data) {
                                    console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicdelUser onResult = ' + JSON.stringify(data));
                                    publicFC.publicCloseSession(UserIDM, function (data) {
                                        console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicCloseSession ');
                                        publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                            console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicunRegisterInputer ');
                                            done();
                                        })
                                    })
                                }, function (data) {
                                    console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicdelUser onAcquireInfo = ' + JSON.stringify(data));
                                })
                            }, function (data) {
                                console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicdelCred onAcquireInfo = ' + JSON.stringify(data));
                            })
                        }, function (data) {
                            console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicaddCredential onAcquireInfo = ' + JSON.stringify(data));
                        })
                    }, function (data) {
                        console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicauth onAcquireInfo = ' + JSON.stringify(data));
                    })
                }, function (data) {
                    console.info('testFace Security_IAM_Face_AddCred_Func_0102 publicaddCredential onAcquireInfo = ' + JSON.stringify(data));
                })
