        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    ...
                    console.info('PIN_AddCred_DFX_0102 addCredential addcredresult101 = ' + addcredresult101);
                    expect(ResultCode.SUCCESS).assertEqual(addcredresult101.addCredresult);
                    publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                        let addcredresult102 = data.addCredresult;
                        console.info('PIN_AddCred_DFX_0102 addCredential addcredresult102 = ' + addcredresult102);
                        ...
                        publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                            ...
                            console.info('PIN_AddCred_DFX_0102 publicauth info101 = ' + info101);
                            let token = info101.extraInfo.token
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                let deluserresult = data.delUserresult;
                                console.info('PIN_AddCred_DFX_0102 publicdelUser deluserresult = ' + deluserresult);
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info('PIN_AddCred_DFX_0102 publicCloseSession data = ' + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info('PIN_AddCred_DFX_0102 publicunRegisterInputer data = ' + data);
                                        done();
                                    })
                                })
                            })
                        }, function (data) {
                            console.info('PIN_AddCred_DFX_0102 publicauth data = ' + data);
                        })
                    })
                })
            })
        ...
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix2, function (data) {
                    let addcredresult101 = data.addCredresult;
                    console.info('PIN_AddCred_DFX_0103 publicaddCredential addcredresult101 = ' + addcredresult101);
                    expect(ResultCode.Fail).assertEqual(addcredresult101.addCredresult);
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        let info101 = data.authresult;
                        console.info('PIN_AddCred_DFX_0103 publicauth info101 = ' + info101);
                        let token = info101.extraInfo.token
                        publicFC.publicdelUser(UserIDM, token, function (data) {
                            let deluserresult = data.delUserresult;
                            console.info('PIN_AddCred_DFX_0103 publicdelUser deluserresult = ' + deluserresult);
                            publicFC.publicCloseSession(UserIDM, function (data) {
                                console.info('PIN_AddCred_DFX_0103 publicCloseSession data = ' + data);
                                publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                    console.info('PIN_AddCred_DFX_0103 publicunRegisterInputer data = ' + data);
                                    done();
                                })
                            })
                        })
    ...
    it('Security_IAM_PIN_Update_DFX_0101', 3, async function (done) {
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    let addcredresult102 = data.addCredresult;
                    console.info('PIN_Update_DFX_0101 publicaddCredential addcredresult102 = ' + addcredresult102);
                    let auth101 = publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1,
                        function (data) {
                        let addcredresult102 = data.authresult;
                        console.info('PIN_Update_DFX_0101 publicauth addcredresult102 = ' + addcredresult102);
                        let token = auth101.extraInfo.token
                        publicFC.publicdelUser(UserIDM, token, function (data) {
                            let deluserresult = data.delUserresult;
                            console.info('PIN_Update_DFX_0101 publicdelUser deluserresult = ' + deluserresult);
                            publicFC.publicupdateCred(UserIDM, CredentialInfopinsix, function (data) {
                                let updateresult = data.updateCredresult;
                                console.info('PIN_Update_DFX_0101 publicupdateCred updateresult = ' + updateresult);
                                expect(ResultCode.Fail).assertEqual(updateresult.updateCredresult);
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info('PIN_Update_DFX_0101 publicCloseSession data = ' + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info('PIN_Update_DFX_0101 publicunRegisterInputer data = ' + data);
                                        done();
                                    })
                                })
                            })
    ...
    it('Security_IAM_PIN_Update_DFX_0103', 3, async function (done) {
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    let addcredresult102 = data.addCredresult;
                    console.info('PIN_Update_DFX_0103 publicaddCredential addcredresult102 = ' + addcredresult102);
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        let auth101 = data.authresult;
                        console.info('Security_IAM_PIN_Update_DFX_0103 publicauth auth101 = ' + auth101);
                        let token = auth101.extraInfo.token;
                        CredentialInfopinsix.token = token;
                        publicFC.publicupdateCred(UserIDM, CredentialInfopinsix, function (data) {
                            let updateresult = data.updateCredresult;
                            console.info('PIN_Update_DFX_0103 publicupdateCred updateresult = ' + updateresult);
                            ...
                            publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1,
                                ...
                                console.info('PIN_Update_DFX_0103 publicauth auth101 = ' + auth101);
                                let token1 = auth101.extraInfo.token
                                publicFC.publicdelUser(UserIDM, token1, function (data) {
                                    let deluserresult = data.delUserresult;
                                    console.info('PIN_Update_DFX_0103 publicdelUser deluserresult= ' + deluserresult);
                                    publicFC.publicCloseSession(UserIDM, function (data) {
                                        console.info('PIN_Update_DFX_0103 publicCloseSession data = ' + data);
                                        publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                            console.info('PIN_Update_DFX_0103 unRegisterInputer data = ' + data);
                                            done();
                                        })
                                    })
                                })
    ...
    it('Security_IAM_PIN_Delet_DFX_0101', 3, async function (done) {
        try {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    let addcredresult101 = data.addCredresult;
                    console.info('PIN_Delet_DFX_0101 publicaddCredential addcredresult101 = ' + addcredresult101);
                    let info101 = publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1,
                        function (data) {
                        let addcredresult101 = data.authresult;
                        console.info('PIN_Delet_DFX_0101 publicauth addcredresult101 = ' + addcredresult101);
                        let token = info101.extraInfo.token
                        publicFC.publicdelUser(UserIDM, token, function (data) {
                            let deluserresult = data.delUserresult;
                            console.info('PIN_Delet_DFX_0101 publicdelUser deluserresult = ' + deluserresult);
                            ...
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                ...
                                publicFC.publicCloseSession(UserIDM, function (data) {
                                    console.info('PIN_Delet_DFX_0101 publicCloseSession data = ' + data);
                                    publicFC.publicunRegisterInputer(PinAuth, function (data) {
                                        console.info('PIN_Delet_DFX_0101 publicunRegisterInputer data = ' + data);
                                        done();
                                    })
                                })
                            })
