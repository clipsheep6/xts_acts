                    ...
                    publicFC.publicauth(UserAuth, challenge, AuthType.PIN, AuthTurstLevel.ATL1, function (data) {
                        ...
                        publicFC.publicdelUser(UserIDM, token, function (data) {
                            ...
                            publicFC.publicaddCredential(UserIDM, CredentialInfoface2d, function (data) {
                                ...
                                console.info("Security_IAM_Face_AddCred_DFX_0103 typeOf.addfaceresult = " + typeof(addfaceresult));
                                console.info("Security_IAM_Face_AddCred_DFX_0103 ResultCode.Authfail = " + ResultCode.Authfail);
                                console.info("Security_IAM_Face_AddCred_DFX_0103 typeOf.ResultCode.Authfail = " + typeof(ResultCode.Authfail));
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (data) {
                    publicFC.publicdelCred(UserIDM, "credentialId", "token", function (data) {
                        ...
                        console.info("testFace Security_IAM_Face_Delet_DFX_0105 ResultCode.FAIL = " + ResultCode.Authfail);
                        ...
                        publicFC.publicauth(UserAuth, challenge, AuthType.FACE, AuthTurstLevel.ATL1, function (data){
                            ...
                            publicFC.publicdelUser(UserIDM, token, function (data) {
                                let deluserresult = data.delUserresult
                                console.info("testFace Security_IAM_Face_Delet_DFX_0105 deluserresult = " + deluserresult)
                                publicFC.publicCloseSession(UserIDM, function (data) {
            ...
            publicFC.publicOpenSession(UserIDM, function (data) {
                ...
                publicFC.publicOpenSession(UserIDM, function (data) {
                    ...
                    publicFC.publicaddCredential(UserIDM, CredentialInfopinsix, function (onresult) {
                        console.info('Security_IAM_Face_AddCred_DFX_0101 addCredential Result1 = ' + JSON.stringify(onresult));
                        let info101;
                        let info102;
                        publicFC.publicauth(UserAuth, challenge2, AuthType.PIN, AuthTurstLevel.ATL1, function (data){
                            ...
                            function (data) {
                                ...
                                publicFC.publicaddCredential(UserIDM, CredentialInfoface2d, function (onresult) {
                                    console.info('Security_IAM_Face_AddCred_DFX_0101 addCredential=' + JSON.stringify(onresult));
                                    console.info('Security_IAM_Face_AddCred_DFX_0101 addCredential.addCredresult=' + onresult.addCredresult);
                                    console.info('Security_IAM_Face_AddCred_DFX_0101 ResultCode.FAIL=' + ResultCode.FAIL);
                                    ...
                                    publicFC.publicdelUser(UserIDM, token2, function (data) {
                                        console.info('Security_IAM_Face_AddCred_DFX_0101 delUser= ' + JSON.stringify(data));
                                        publicFC.publicCloseSession(UserIDM, function (data) {
