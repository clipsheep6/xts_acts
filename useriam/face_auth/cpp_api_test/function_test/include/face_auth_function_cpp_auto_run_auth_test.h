 ...
 */
#ifndef FACE_AUTH_FUNCTION_CPP_AUTO_RUN_AUTH_TEST_H
#define FACE_AUTH_FUNCTION_CPP_AUTO_RUN_AUTH_TEST_H
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthFunctionCppAutoRunAuthTest : public testing::Test {
public:
...
#endif // FACE_AUTH_FUNCTION_CPP_AUTO_RUN_AUTH_TEST_H
