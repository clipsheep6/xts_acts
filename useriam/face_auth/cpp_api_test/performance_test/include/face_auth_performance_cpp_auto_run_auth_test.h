 ...
 */
#ifndef FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_AUTH_TEST_H
#define FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_AUTH_TEST_H
#include <thread>
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthPerformanceCppAutoRunAuthTest : public testing::Test {
public:
};
...
#endif  // FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_AUTH_TEST_H