 ...
 */
#ifndef FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_ENROLL_TEST_H
#define FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_ENROLL_TEST_H
#include <thread>
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthPerformanceCppAutoRunEnrollTest : public testing::Test {
public:
};
...
#endif // FACE_AUTH_PERFORMANCE_CPP_AUTO_RUN_ENROLL_TEST_H