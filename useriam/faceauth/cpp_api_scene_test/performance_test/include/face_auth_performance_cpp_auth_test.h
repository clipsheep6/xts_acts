 ...
 */
#ifndef FACE_AUTH_PERFORMANCE_CPP_AUTH_TEST_H
#define FACE_AUTH_PERFORMANCE_CPP_AUTH_TEST_H
#include <cstdio>
#include <fstream>
#include <sstream>
#include <chrono>
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthPerformanceCppAuthTest : public testing::Test {
public:
...
public:
    ...
    const std::string abilityNameA = "FaceAuthTestServiceAbilityAuth";
    const std::string APP_AUTH_REQ_EVENT_NAME = "req_com_ohos_face_auth_test_app_auth";
};
} // namespace FaceAuth
} // namespace UserIAM
} // namespace OHOS
#endif // FACE_AUTH_PERFORMANCE_CPP_AUTH_TEST_H
