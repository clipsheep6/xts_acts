...
void FaceAuthTestServiceAbilitySecondAuth::TestCallback::OnCallbackEvent(uint64_t reqId, int32_t type, int32_t code,
...
AuthParam FaceAuthTestServiceAbilitySecondAuth::CreateAuthParam(uint64_t _reqId, int32_t _flags, int64_t _challenge,
...
bool FaceAuthTestServiceAbilitySecondAuth::PublishEvent(const std::string &eventName, const int32_t &code,
