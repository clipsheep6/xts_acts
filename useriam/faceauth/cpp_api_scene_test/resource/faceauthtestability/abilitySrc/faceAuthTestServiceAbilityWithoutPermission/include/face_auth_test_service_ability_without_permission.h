...
#ifndef FACE_AUTH_TEST_SERVICE_ABILITY_WITHOUT_PERMISSION_H
#define FACE_AUTH_TEST_SERVICE_ABILITY_WITHOUT_PERMISSION_H
#include <map>
#include <string>
#include <thread>
...
const std::string APP_WITHOUT_PERMISSION_RESP_EVENT_NAME = "resp_com_ohos_face_auth_test_app_without_permission";
const std::string APP_WITHOUT_PERMISSION_REQ_EVENT_NAME = "req_com_ohos_face_auth_test_app_without_permission";
class FaceAuthTestServiceAbilityWithoutPermission : public Ability {
public:
    ~FaceAuthTestServiceAbilityWithoutPermission();
...
private:
    ...
    typedef void (FaceAuthTestServiceAbilityWithoutPermission::*func)();
    void FaceAuth_Init();
    void FaceAuth_Release();
    void FaceAuth_Authenticate();
    void FaceAuth_ResetTimeout();
    void FaceAuth_PreEnroll();
    void FaceAuth_PostEnroll();
    void FaceAuth_Remove();
    void FaceAuth_Remove_Id();
    ...
    public:
            ...
            int32_t resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(APP_WITHOUT_PERMISSION_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int32_t resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(
                    APP_WITHOUT_PERMISSION_RESP_EVENT_NAME, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        FaceAuthTestServiceAbilityWithoutPermission *mainAbility_ = nullptr;
    };
...
#endif // FACE_AUTH_TEST_SERVICE_ABILITY_WITHOUT_PERMISSION_H