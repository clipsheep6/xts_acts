...
#ifndef OHOS_FACE_AUTH_MODULE_TEST_DUMP_UTIL_H
#define OHOS_FACE_AUTH_MODULE_TEST_DUMP_UTIL_H
...
using std::regex;
using std::string;
class ModuleTestDumpUtil {
public:
    virtual ~ModuleTestDumpUtil();
    static std::shared_ptr<ModuleTestDumpUtil> GetInstance();
...
private:
    ...
    static std::shared_ptr<ModuleTestDumpUtil> instance_;
...
#endif // OHOS_FACE_AUTH_MODULE_TEST_DUMP_UTIL_H
