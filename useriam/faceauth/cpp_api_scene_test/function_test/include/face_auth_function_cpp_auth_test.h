 ...
 */
#ifndef FACE_AUTH_FUNCTION_CPP_AUTH_TEST_H
#define FACE_AUTH_FUNCTION_CPP_AUTH_TEST_H
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthFunctionCppAuthTest : public testing::Test {
public:
    ...
    bool IsFindYUVFile();
    void InitForCPPAPI_005();
    void StopAbilityForCPPAPI_005();
    void AuthenticateForCPPAPI_005();
...
#endif  // FACE_AUTH_FUNCTION_CPP_AUTH_TEST_H
