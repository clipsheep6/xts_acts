 ...
 */
#ifndef FACE_AUTH_FUNCTION_CPP_SCENARIO_TEST_H
#define FACE_AUTH_FUNCTION_CPP_SCENARIO_TEST_H
...
namespace UserIAM {
namespace FaceAuth {
class FaceAuthFunctionCppScenarioTest : public testing::Test {
public:
    ...
    void StopAppA();
    void StartAppB(OHOS::STABUtil::MAP_STR_STR &params, std::string &method);
    void StopAppB();
    static bool SubscribeEvent();
    void WriteFile(int32_t caseNum, int32_t codeNum, std::map<int32_t, ResultInfo> resultInfos_);
    static void CreateAuthPermission();
    static void CreateEnrollPermission(std::vector<OHOS::Security::Permission::PermissionDef> permDefList);
...
public:
    ...
    const std::string ABILITY_NAME_AUTH = "FaceAuthTestServiceAbilityAuth";
};
}  // namespace FaceAuth
}  // namespace UserIAM
}  // namespace OHOS
#endif  // FACE_AUTH_FUNCTION_CPP_SCENARIO_TEST_H