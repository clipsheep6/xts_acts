...
export default function enumExecute() {
  describe('enumExecute', function () {
    /*
        ...
        * @tc.level     : Level 0
    */
    it('Security_IAM_userAuthType_Kit_Func_0084', 0, async function (done) {
    ...
    */
    ...
    /*
        ...
        * @tc.level     : Level 0
    */
    it('Security_IAM_userAuthResultCode_Kit_Func_0087', 0, async function (done) {
