...
class ActsFingerprintPinSixFreezeAuthTest : public testing::Test {
public:
...
void ActsFingerprintPinSixFreezeAuthTest::SetUpTestCase(void)
{
}

void ActsFingerprintPinSixFreezeAuthTest::TearDownTestCase(void)
{
}

void ActsFingerprintPinSixFreezeAuthTest::SetUp()
{
}

void ActsFingerprintPinSixFreezeAuthTest::TearDown()
{
}

HWTEST_F(ActsFingerprintPinSixFreezeAuthTest, ActsFingerprintPinSixFreezeAuthTest, TestSize.Level1)
{
    ...
    IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest ShowDialog start");
    int32_t dialogId = -1, width = 0, height = 0;
    GetDisplaySize(width, height);
    IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest ShowDialog width=%{public}d, height=%{public}d", width, height);
    Ace::UIServiceMgrClient::GetInstance()->ShowDialog("authentication_dialog", params,
        ...
        std::bind(&ActsFingerprintPinSixFreezeAuthTest::FingerprintPinAuthCallback, this, std::placeholders::_1,
...
void ActsFingerprintPinSixFreezeAuthTest::FingerprintPinAuthCallback(int32_t id, const std::string &event,
    const std::string &params)
{
    IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback start");
    ...
    switch (eventType) {
        case JsEventType::EVENT_AUTH_TYPE_READY: {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_TYPE_READY");
            HandleEventAuthTypeReady(id, jsonParams);
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL: {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL");
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL_ALL: {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL_ALL");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_ANIMATION_PLAY_END: {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback EVENT_ANIMATION_PLAY_END");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_KEY_DERIVATION_READY: {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest FingerprintPinAuthCallback EVENT_KEY_DERIVATION_READY");
...
void ActsFingerprintPinSixFreezeAuthTest::SendFingerprintAuthResult(int32_t id)
{
    ...
    IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest SendFingerprintAuthResult %{public}s", resultOss.str().c_str());
    Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, resultOss.str());
}

void ActsFingerprintPinSixFreezeAuthTest::HandleEventAuthTypeReady(int32_t id, const Json::Value &jsonParams)
{
    ...
    if (strcmp(jsonParams["payload"]["type"].asCString(), "fingerprint") == 0) {
        ...
        IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest HandleEventAuthTypeReady %{public}s", oss.str().c_str());
        Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, oss.str());
        sendResultTimer.Register(std::bind(&ActsFingerprintPinSixFreezeAuthTest::SendFingerprintAuthResult, this, id),
            sendDelay, true);
...
void ActsFingerprintPinSixFreezeAuthTest::HandleEventKeyDerivationReady(int32_t id, const Json::Value &jsonParams)
{
    if (strcmp(jsonParams["payload"]["result"].asCString(), "success") == 0) {
        ...
        Json::Value resultPayload;
        Json::Value cmdArray;
        IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest HandleEventKeyDerivationReady derivation data %{public}s",
            jsonParams["payload"]["derivation"].asCString());
        if (strcmp(jsonParams["payload"]["derivation"].asCString(), pinSixCode) == 0) {
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest HandleEventKeyDerivationReady pin auth success");
            ...
            timesValue["payload"] = timesPayload;
            IAM_LOGI("ActsFingerprintPinSixFreezeAuthTest HandleEventKeyDerivationReady pin auth failed, times "
                     "left:%{public}d",
                pinTimesLeft);
