...
class ActsFingerprintPinNumberFreezeAuthTest : public testing::Test {
public:
    ...
    const char *pinNumberCode =
        "MAKG+ELv9lzeGhhCdtHCKZFjYRmDbjFqI7heNnh1Mvn4z78IixUezh/8K0w/Jal2jbX+HUsOvj8yQ0TY1HXCqA==";
...
void ActsFingerprintPinNumberFreezeAuthTest::SetUpTestCase(void)
{
}

void ActsFingerprintPinNumberFreezeAuthTest::TearDownTestCase(void)
{
}

void ActsFingerprintPinNumberFreezeAuthTest::SetUp()
{
}

void ActsFingerprintPinNumberFreezeAuthTest::TearDown()
{
}

HWTEST_F(ActsFingerprintPinNumberFreezeAuthTest, ActsFingerprintPinNumberFreezeAuthTest, TestSize.Level1)
{
    ...
    int32_t dialogId = -1;
    IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest ShowDialog start");
    int32_t width = 0, height = 0;
    GetDisplaySize(width, height);
    IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest ShowDialog width=%{public}d, height=%{public}d", width, height);
    Ace::UIServiceMgrClient::GetInstance()->ShowDialog("authentication_dialog", params,
        ...
        std::bind(&ActsFingerprintPinNumberFreezeAuthTest::FingerprintPinAuthCallback, this, std::placeholders::_1,
            std::placeholders::_2, std::placeholders::_3),
        &dialogId);
    EXPECT_TRUE(dialogId >= 0);
    IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest ShowDialog end, dialogId:%{public}d", dialogId);
    while (!isStop) {
        sleep(1);
    }
...
void ActsFingerprintPinNumberFreezeAuthTest::FingerprintPinAuthCallback(int32_t id, const std::string &event,
    const std::string &params)
{
    IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback start");
    ...
    switch (eventType) {
        case JsEventType::EVENT_AUTH_TYPE_READY: {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_TYPE_READY");
            HandleEventAuthTypeReady(id, jsonParams);
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL: {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL");
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL_ALL: {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL_ALL");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_ANIMATION_PLAY_END: {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback EVENT_ANIMATION_PLAY_END");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_KEY_DERIVATION_READY: {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest FingerprintPinAuthCallback EVENT_KEY_DERIVATION_READY");
...
void ActsFingerprintPinNumberFreezeAuthTest::SendFingerprintAuthResult(int32_t id)
{
    ...
    IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest SendFingerprintAuthResult %{public}s", resultOss.str().c_str());
    Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, resultOss.str());
}

void ActsFingerprintPinNumberFreezeAuthTest::HandleEventAuthTypeReady(int32_t id, const Json::Value &jsonParams)
{
    ...
    if (strcmp(jsonParams["payload"]["type"].asCString(), "fingerprint") == 0) {
        ...
        IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest HandleEventAuthTypeReady %{public}s", oss.str().c_str());
        Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, oss.str());
        sendResultTimer.Register(
            std::bind(&ActsFingerprintPinNumberFreezeAuthTest::SendFingerprintAuthResult, this, id), sendDelay, true);
...
void ActsFingerprintPinNumberFreezeAuthTest::HandleEventKeyDerivationReady(int32_t id, const Json::Value &jsonParams)
{
    if (strcmp(jsonParams["payload"]["result"].asCString(), "success") == 0) {
        ...
        Json::Value resultPayload;
        Json::Value cmdArray;
        IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest HandleEventKeyDerivationReady derivation data %{public}s",
            jsonParams["payload"]["derivation"].asCString());
        if (strcmp(jsonParams["payload"]["derivation"].asCString(), pinNumberCode) == 0) {
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest HandleEventKeyDerivationReady pin auth success");
            ...
            timesValue["payload"] = timesPayload;
            IAM_LOGI("ActsFingerprintPinNumberFreezeAuthTest HandleEventKeyDerivationReady pin auth failed, times "
                     "left:%{public}d",
                pinTimesLeft);
