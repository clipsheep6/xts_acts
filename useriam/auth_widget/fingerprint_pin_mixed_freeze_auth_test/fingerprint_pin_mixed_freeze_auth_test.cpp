...
class ActsFingerprintPinMixedFreezeAuthTest : public testing::Test {
public:
    ...
    const int32_t r = 3;
    const int32_t p = 1;
    // test password: qazwsx123456
    const char *pinMixedCode =
        "anxkTqIFT7HUg8JQH0twtKkA6fR2zgA4gHb8OHe59sudErXiV7u6NX/7wbOuS7nDCls8VUsZ5DwJLD/3DJ/jUw==";
...
void ActsFingerprintPinMixedFreezeAuthTest::SetUpTestCase(void)
{
}

void ActsFingerprintPinMixedFreezeAuthTest::TearDownTestCase(void)
{
}

void ActsFingerprintPinMixedFreezeAuthTest::SetUp()
{
}

void ActsFingerprintPinMixedFreezeAuthTest::TearDown()
{
}

HWTEST_F(ActsFingerprintPinMixedFreezeAuthTest, ActsFingerprintPinMixedFreezeAuthTest, TestSize.Level1)
{
    ...
    int32_t dialogId = -1;
    IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest ShowDialog start");
    int32_t width = 0, height = 0;
    GetDisplaySize(width, height);
    IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest ShowDialog width=%{public}d, height=%{public}d", width, height);
    Ace::UIServiceMgrClient::GetInstance()->ShowDialog("authentication_dialog", params,
        ...
        std::bind(&ActsFingerprintPinMixedFreezeAuthTest::FingerprintPinAuthCallback, this, std::placeholders::_1,
            std::placeholders::_2, std::placeholders::_3),
        &dialogId);
    EXPECT_TRUE(dialogId >= 0);
    IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest ShowDialog end, dialogId:%{public}d", dialogId);
    while (!isStop) {
        sleep(1);
    }
...
void ActsFingerprintPinMixedFreezeAuthTest::FingerprintPinAuthCallback(int32_t id, const std::string &event,
    const std::string &params)
{
    IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback start");
    ...
    switch (eventType) {
        case JsEventType::EVENT_AUTH_TYPE_READY: {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_TYPE_READY");
            HandleEventAuthTypeReady(id, jsonParams);
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL: {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL");
            break;
        }
        case JsEventType::EVENT_AUTH_USER_CANCEL_ALL: {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback EVENT_AUTH_USER_CANCEL_ALL");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_ANIMATION_PLAY_END: {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback EVENT_ANIMATION_PLAY_END");
            Ace::UIServiceMgrClient::GetInstance()->CancelDialog(id);
            isStop = true;
            break;
        }
        case JsEventType::EVENT_KEY_DERIVATION_READY: {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest FingerprintPinAuthCallback EVENT_KEY_DERIVATION_READY");
...
void ActsFingerprintPinMixedFreezeAuthTest::SendFingerprintAuthResult(int32_t id)
{
    ...
    IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest SendFingerprintAuthResult %{public}s", resultOss.str().c_str());
    Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, resultOss.str());
}

void ActsFingerprintPinMixedFreezeAuthTest::HandleEventAuthTypeReady(int32_t id, const Json::Value &jsonParams)
{
    ...
    if (strcmp(jsonParams["payload"]["type"].asCString(), "fingerprint") == 0) {
        ...
        IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest HandleEventAuthTypeReady %{public}s", oss.str().c_str());
        Ace::UIServiceMgrClient::GetInstance()->UpdateDialog(id, oss.str());
        sendResultTimer.Register(std::bind(&ActsFingerprintPinMixedFreezeAuthTest::SendFingerprintAuthResult, this, id),
            sendDelay, true);
...
void ActsFingerprintPinMixedFreezeAuthTest::HandleEventKeyDerivationReady(int32_t id, const Json::Value &jsonParams)
{
    if (strcmp(jsonParams["payload"]["result"].asCString(), "success") == 0) {
        ...
        Json::Value resultPayload;
        Json::Value cmdArray;
        IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest HandleEventKeyDerivationReady derivation data %{public}s",
            jsonParams["payload"]["derivation"].asCString());
        if (strcmp(jsonParams["payload"]["derivation"].asCString(), pinMixedCode) == 0) {
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest HandleEventKeyDerivationReady pin auth success");
            ...
            timesValue["payload"] = timesPayload;
            IAM_LOGI("ActsFingerprintPinMixedFreezeAuthTest HandleEventKeyDerivationReady pin auth failed, times "
                     "left:%{public}d",
                pinTimesLeft);
