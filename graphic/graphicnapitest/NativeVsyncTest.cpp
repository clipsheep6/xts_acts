...
{
    EXPECT_EQ(OH_NativeVSync_Create(nullptr, 0), nullptr);
}
...
HWTEST_F(NativeVsyncTest, OH_NativeVSync_Create002, Function | MediumTest | Level2)
{
    ...
    EXPECT_NE(native_vsync, nullptr);
}
...
{
    EXPECT_NE(OH_NativeVSync_RequestFrame(nullptr, nullptr, nullptr), 0);
}
...
{
    EXPECT_NE(OH_NativeVSync_RequestFrame(native_vsync, nullptr, nullptr), 0);
}
...
HWTEST_F(NativeVsyncTest, OH_NativeVSync_RequestFrame003, Function | MediumTest | Level2)
{
    ...
    EXPECT_EQ(OH_NativeVSync_RequestFrame(native_vsync, callback, nullptr), 0);
}
