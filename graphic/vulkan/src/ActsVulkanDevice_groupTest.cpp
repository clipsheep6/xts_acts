...
namespace OHOS {
    ...
    HWTEST_F(ActsVulkanDevice_groupTest, TestVulkanDevice_groupTestCase, Function | MediumTest | Level2)
    {
        ...
        system("cd /data/local/tmp/vulkan/vk-default;/data/local/tmp/vulkan/vk-default/deqp_vk_execute --deqp-caselist-file=/data/local/tmp/vulkan/vk-default/device-group.txt");
        EXPECT_TRUE(true);
