...
namespace OHOS {
    ...
    HWTEST_F(ActsVulkanFragment_shader_interlockTest, TestVulkanFragment_shader_interlockTestCase, Function | MediumTest | Level2)
    {
        ...
        system("cd /data/local/tmp/vulkan/vk-default;/data/local/tmp/vulkan/vk-default/deqp_vk_execute --deqp-caselist-file=/data/local/tmp/vulkan/vk-default/fragment-shader-interlock.txt");
        EXPECT_TRUE(true);
