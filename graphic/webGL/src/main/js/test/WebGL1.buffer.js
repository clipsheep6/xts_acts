...
export default function webgl1_buffer() {
	...
	describe('webgl1_buffer', function () {
        ...
        it('webgl_test_bindBuffer_3', 0, async function (done) {
            ...
            bindBuffer((buffer) => {
                gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, null);//绑定缓冲区
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            }, (isBind) => {
        ...
        it('webgl_test_bindBuffer_4', 0, async function (done) {
            ...
            bindBuffer((buffer) => {
                gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, undefined);//绑定缓冲区
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            }, (isBind) => {
                expect(isBind).assertEqual(false);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
        ...
        it('webgl_test_getRenderbufferParameter_4', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_GREEN_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
        ...
        it('webgl_test_getRenderbufferParameter_5', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_BLUE_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
        ...
        it('webgl_test_getRenderbufferParameter_6', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_RED_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
        ...
        it('webgl_test_getRenderbufferParameter_7', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_ALPHA_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
        ...
        it('webgl_test_getRenderbufferParameter_8', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_DEPTH_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
        ...
        it('webgl_test_getRenderbufferParameter_9', 0, async function (done) {
            ...
            getRenderbufferParameter((buf) => {
                ...
                expect(gl.getRenderbufferParameter(gl.RENDERBUFFER, gl.RENDERBUFFER_STENCIL_SIZE)).assertEqual(0);
                expect(checkError(gl)).assertEqual(gl.NO_ERROR);
            });
            done();
        })
