...
describe('webgl1Test', function() {
	...
	/**
	 * @tc.number GRAPHIC_FUNCTION_JS_WEBGL_TESTWEBGL_0004
	 * @tc.name webgl_test_getSupportedExtensions_1
	 * @tc.desc Test getSupportedExtensions.
	 */
	it('webgl_test_getSupportedExtensions_1', 0, async function(done) {
		//initContext();
		console.info("webgltest into getSupportedExtensions");
		const getSupportedExtensionsValue = gl.getSupportedExtensions();
		console.info("webgltest getSupportedExtensions: " + getSupportedExtensionsValue);
		expect(getSupportedExtensionsValue.toString()).assertContain(
			'EGL_KHR_get_all_proc_addresses,' +
			'EGL_ANDROID_presentation_time,EGL_KHR_swap_buffers_with_damage,EGL_ANDROID_get_native_client_buffer,' +
			...
			'EGL_EXT_gl_colorspace_display_p3,EGL_EXT_gl_colorspace_display_p3_passthrough,' +
			'EGL_EXT_gl_colorspace_bt2020_linear,EGL_EXT_gl_colorspace_bt2020_pq,' +
			'EGL_KHR_image,EGL_KHR_image_base,EGL_EXT_image_gl_colorspace,EGL_KHR_gl_colorspace,' +
			'EGL_KHR_gl_texture_2D_image,EGL_KHR_gl_texture_cubemap_image,' +
			'EGL_KHR_gl_renderbuffer_image,EGL_KHR_fence_sync,EGL_KHR_create_context,EGL_KHR_config_attribs,' +
			'EGL_KHR_surfaceless_context,EGL_EXT_create_context_robustness,EGL_ANDROID_image_native_buffer,' +
			'EGL_KHR_wait_sync,EGL_ANDROID_recordable,EGL_KHR_partial_update,EGL_EXT_pixel_format_float,' +
			'EGL_KHR_mutable_render_buffer,EGL_EX');
		//deleteContext();
		done();
	});
	...
	/**
	 * @tc.number GRAPHIC_FUNCTION_JS_WEBGL_TESTWEBGL_0594
	 * @tc.name webgl_test_getSupportedExtensions_12
	 * @tc.desc Test getSupportedExtensions.
	 */
	it('webgl_test_getSupportedExtensions_12', 0, async function(done) {
		//initContext();
		console.info("webgltest into getSupportedExtensions");
		const getSupportedExtensionsValue = gl.getSupportedExtensions("error");
		console.info("webgltest getSupportedExtensions: " + getSupportedExtensionsValue);
		expect(getSupportedExtensionsValue.toString()).assertContain(
			...
			'EGL_ANDROID_presentation_time,EGL_KHR_swap_buffers_with_damage,EGL_ANDROID_get_native_client_buffer,' +
			'EGL_ANDROID_front_buffer_auto_refresh,EGL_ANDROID_get_frame_timestamps,' +
			'EGL_EXT_surface_SMPTE2086_metadata,EGL_EXT_surface_CTA861_3_metadata,EGL_EXT_gl_colorspace_scrgb,' +
			'EGL_EXT_gl_colorspace_scrgb_linear,EGL_EXT_gl_colorspace_display_p3_linear,' +
			'EGL_EXT_gl_colorspace_display_p3,EGL_EXT_gl_colorspace_display_p3_passthrough,' +
			'EGL_EXT_gl_colorspace_bt2020_linear,EGL_EXT_gl_colorspace_bt2020_pq,EGL_KHR_image,' +
			'EGL_KHR_image_base,EGL_EXT_image_gl_colorspace,EGL_KHR_gl_colorspace,EGL_KHR_gl_texture_2D_image,' +
			'EGL_KHR_gl_texture_cubemap_image,EGL_KHR_gl_renderbuffer_image,EGL_KHR_fence_sync,EGL_KHR_create_context,' +
			'EGL_KHR_config_attribs,EGL_KHR_surfaceless_context,EGL_EXT_create_context_robustness,' +
			'EGL_ANDROID_image_native_buffer,EGL_KHR_wait_sync,EGL_ANDROID_recordable,EGL_KHR_partial_update,' +
			'EGL_EXT_pixel_format_float,EGL_KHR_mutable_render_buffer,EGL_EX');
		//deleteContext();
		done();
	});
