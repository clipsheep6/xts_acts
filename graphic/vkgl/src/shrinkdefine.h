...
#define SHRINK_CODE_METHOD1(RunResult, result, TestCase)     {\
    RunResult.numPassed += result.numPassed;                \
    RunResult.numFailed += result.numFailed;                \
    RunResult.numNotSupported += result.numNotSupported;    \
    RunResult.numWarnings += result.numWarnings;            \
    RunResult.numWaived += result.numWaived;                \
...
#define SHRINK_HWTEST_F(TestSuite, TestCase, VkglCase1, VkglCase2)   \
    static HWTEST_F(TestSuite, TestCase, Function | MediumTest | Level2) \
    {                                                                                               \
