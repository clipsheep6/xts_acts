...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010705, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "cification.random_teximage2d.2d_0",
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010706, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_1",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010707, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010708, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_3",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010709, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010710, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_5",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010711, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_6",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010712, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_7",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010713, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_8",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010714, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spe"
        "cification.random_teximage2d.2d_9",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010715, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "ification.random_teximage2d.cube_0",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010716, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_1",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010717, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010718, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_3",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010719, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010720, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_5",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010721, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_6",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010722, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_7",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010723, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_8",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsDeqpgles20011TestSuite, TestCase_010724, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "dEQP-GLES2.functional.texture.spec"
        "ification.random_teximage2d.cube_9",
        "--deqp-archive-dir=/data/local/tmp/"
    };
