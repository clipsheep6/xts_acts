...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000309, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        ".mask.rgba32f.samples_8.mask_zero",
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000310, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "s.mask.rgba32f.samples_8.mask_0",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000311, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_1",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000312, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000313, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_3",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000314, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000315, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_5",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000316, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_6",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000317, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variable"
        "s.mask.rgba32f.samples_8.mask_7",
        "--deqp-archive-dir=/data/local/tmp/"
    };
