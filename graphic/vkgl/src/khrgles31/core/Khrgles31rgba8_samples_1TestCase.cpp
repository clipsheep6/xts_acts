...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000147, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000148, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "es.mask.rgba8.samples_1.mask_0",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000149, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_1",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000150, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_2",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000151, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_3",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000152, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_4",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000153, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_5",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000154, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_6",
        "--deqp-archive-dir=/data/local/tmp/"
    };
...
static HWTEST_F(ActsKhrgles310001TestSuite, TestCase_000155, Function | MediumTest | Level2)
{
    ...
    const char *argv[3] = {
        ...
        "--deqp-case="
        "KHR-GLES31.core.sample_variabl"
        "es.mask.rgba8.samples_1.mask_7",
        "--deqp-archive-dir=/data/local/tmp/"
    };
