...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018807, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018808, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018809, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018810, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018810 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30019TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018810 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018810 end";
}
