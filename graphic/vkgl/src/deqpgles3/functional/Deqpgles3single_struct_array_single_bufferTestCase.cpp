...
static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035236, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_035236 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_035236 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_035236 end";
}

static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035237, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_035237 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30036TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_035237 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_035237 end";
}

static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035238, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_035238 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30036TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_035238 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_035238 end";
}

static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035239, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035240, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035241, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035242, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30036TestSuite, TestCase_035243, Function | MediumTest | Level2)
{
