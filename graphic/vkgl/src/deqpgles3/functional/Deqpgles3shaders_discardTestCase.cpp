...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005926, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005926 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005926 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005926 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005927, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005927 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30006TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005927 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005927 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005928, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005928 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30006TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005928 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005928 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005929, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005929 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30006TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005929 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005929 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005930, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005930 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30006TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005930 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005930 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005931, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_005931 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30006TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_005931 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_005931 end";
}

static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005932, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005933, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005934, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005935, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005936, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005937, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005938, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005939, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005940, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005941, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005942, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005943, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005944, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005945, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005946, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005947, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005948, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005949, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30006TestSuite, TestCase_005950, Function | MediumTest | Level2)
{
