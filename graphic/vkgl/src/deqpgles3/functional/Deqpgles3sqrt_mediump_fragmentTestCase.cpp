...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018891, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018891 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018891 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018891 end";
}

static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018892, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018893, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018894, Function | MediumTest | Level2)
{
