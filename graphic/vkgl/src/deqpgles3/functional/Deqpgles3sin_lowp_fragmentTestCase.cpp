...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018507, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018507 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018507 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018507 end";
}

static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018508, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018509, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30019TestSuite, TestCase_018510, Function | MediumTest | Level2)
{
