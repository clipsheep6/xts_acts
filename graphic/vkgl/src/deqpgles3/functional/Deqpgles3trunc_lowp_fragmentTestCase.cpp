...
static HWTEST_F(ActsDeqpgles30020TestSuite, TestCase_019003, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30020TestSuite, TestCase_019004, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30020TestSuite, TestCase_019005, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30020TestSuite, TestCase_019006, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_019006 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30020TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_019006 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_019006 end";
}
