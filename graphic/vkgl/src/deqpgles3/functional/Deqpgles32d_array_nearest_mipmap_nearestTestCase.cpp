...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025616, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025616 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025616 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025616 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025617, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025617 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025617 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025617 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025618, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025618 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025618 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025618 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025619, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025619 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025619 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025619 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025620, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025620 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025620 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025620 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025621, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025621 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025621 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025621 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025622, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025622 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025622 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025622 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025623, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025623 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles30026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025623 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025623 end";
}

static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025624, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025625, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025626, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025627, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025628, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025629, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025630, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025631, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025632, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025633, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025634, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025635, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025636, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025637, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025638, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles30026TestSuite, TestCase_025639, Function | MediumTest | Level2)
{
