...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021188, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021188 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021188 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021188 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021189, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021190, Function | MediumTest | Level2)
{
