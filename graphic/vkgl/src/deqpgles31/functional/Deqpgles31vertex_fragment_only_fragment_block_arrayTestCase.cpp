...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021160, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021160 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021160 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021160 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021161, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021161 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021161 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021161 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021162, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021162 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021162 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021162 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024270, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024271, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024272, Function | MediumTest | Level2)
{
