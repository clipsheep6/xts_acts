...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021143, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021143 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021143 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021143 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021144, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021144 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021144 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021144 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021145, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021145 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021145 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021145 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024261, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024262, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024263, Function | MediumTest | Level2)
{
