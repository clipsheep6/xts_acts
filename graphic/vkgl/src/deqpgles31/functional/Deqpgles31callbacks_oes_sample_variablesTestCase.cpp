...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018826, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018826 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018826 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018826 end";
}

static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018827, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018828, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018829, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018830, Function | MediumTest | Level2)
{
