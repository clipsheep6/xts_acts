...
static HWTEST_F(ActsDeqpgles310038TestSuite, TestCase_037831, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310038TestSuite, TestCase_037832, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310038TestSuite, TestCase_037833, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310038TestSuite, TestCase_037834, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_037834 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310038TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_037834 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_037834 end";
}
