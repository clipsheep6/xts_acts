...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021126, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021126 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021126 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021126 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021127, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021127 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021127 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021127 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_021128, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_021128 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310022TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_021128 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_021128 end";
}

static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024252, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024253, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310022TestSuite, TestCase_024254, Function | MediumTest | Level2)
{
