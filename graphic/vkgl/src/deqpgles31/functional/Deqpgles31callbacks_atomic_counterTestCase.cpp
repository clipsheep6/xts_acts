...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018697, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018697 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018697 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018697 end";
}

static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018698, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018698 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310019TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018698 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018698 end";
}

static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018699, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018700, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018701, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018702, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310019TestSuite, TestCase_018703, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_018703 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310019TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_018703 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_018703 end";
}
