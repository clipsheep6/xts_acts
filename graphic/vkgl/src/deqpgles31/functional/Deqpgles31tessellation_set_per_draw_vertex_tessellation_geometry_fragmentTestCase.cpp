...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025000, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025001, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025002, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025003, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025004, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025005, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025040, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025041, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025042, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025043, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025044, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025045, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025080, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025081, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025082, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025083, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025084, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025085, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025120, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025121, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025122, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025123, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025124, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025125, Function | MediumTest | Level2)
{
...
static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025160, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025160 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025160 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025160 end";
}

static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025161, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025161 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025161 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025161 end";
}

static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025162, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025162 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025162 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025162 end";
}

static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025163, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025163 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025163 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025163 end";
}

static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025164, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025164 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025164 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025164 end";
}

static HWTEST_F(ActsDeqpgles310026TestSuite, TestCase_025165, Function | MediumTest | Level2)
{
    GTEST_LOG_(INFO) << "TestCase_025165 start";
    int argc = 3;
    const char *argv[3] = {
        ".",
        "--deqp-case="
    ...
    ActsDeqpgles310026TestSuite::runResult.numWaived += result.numWaived;
    if (result.numNotSupported == 1) {
        GTEST_LOG_(INFO) << "TestCase_025165 notsupport!";
    } else if (result.isComplete) {
        EXPECT_TRUE(result.isComplete);
        EXPECT_TRUE(result.numPassed == 1);
    };
    GTEST_LOG_(INFO) << "TestCase_025165 end";
}
