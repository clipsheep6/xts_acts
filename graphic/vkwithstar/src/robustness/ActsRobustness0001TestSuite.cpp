...
namespace OHOS {
    ...
    void ActsRobustness0001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsRobustness0001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsRobustness0001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsRobustness0001TS::TearDown()
    {
    }
}