...
#include "ActsSynchronization2TestSuite.h"

namespace OHOS {
    using namespace std;
    using namespace testing::ext;

    time_t ActsSynchronization2TS::startTime;
    time_t ActsSynchronization2TS::endTime;
    FuncRunResult ActsSynchronization2TS::runResult;

    // Preset action of the test suite, which is executed before the first test case
    void ActsSynchronization2TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization2TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization2TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization2TS::TearDown()
    {
    }
}