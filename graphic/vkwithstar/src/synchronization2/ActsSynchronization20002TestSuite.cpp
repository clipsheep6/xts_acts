...
#include "ActsSynchronization20002TestSuite.h"

namespace OHOS {
    using namespace std;
    using namespace testing::ext;

    time_t ActsSynchronization20002TS::startTime;
    time_t ActsSynchronization20002TS::endTime;
    FuncRunResult ActsSynchronization20002TS::runResult;

    // Preset action of the test suite, which is executed before the first test case
    void ActsSynchronization20002TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization20002TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization20002TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization20002TS::TearDown()
    {
    }
}