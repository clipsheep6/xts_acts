...
namespace OHOS {
    ...
    time_t ActsSynchronization20001TS::startTime;
    time_t ActsSynchronization20001TS::endTime;
    FuncRunResult ActsSynchronization20001TS::runResult;

    // Preset action of the test suite, which is executed before the first test case
    void ActsSynchronization20001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization20001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization20001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization20001TS::TearDown()
    {
    }
}