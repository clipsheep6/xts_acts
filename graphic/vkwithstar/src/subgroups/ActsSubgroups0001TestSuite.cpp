...
namespace OHOS {
    ...
    void ActsSubgroups0001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0001TS::TearDown()
    {
    }
}