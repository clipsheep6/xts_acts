...
namespace OHOS {
    ...
    void ActsSubgroups0010TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0010TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0010TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0010TS::TearDown()
    {
    }
}