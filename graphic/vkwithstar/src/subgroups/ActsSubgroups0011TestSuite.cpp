...
namespace OHOS {
    ...
    void ActsSubgroups0011TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0011TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0011TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0011TS::TearDown()
    {
    }
}