...
namespace OHOS {
    ...
    void ActsSubgroups0006TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0006TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0006TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0006TS::TearDown()
    {
    }
}