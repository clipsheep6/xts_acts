...
namespace OHOS {
    ...
    void ActsSubgroups0003TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0003TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0003TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0003TS::TearDown()
    {
    }
}