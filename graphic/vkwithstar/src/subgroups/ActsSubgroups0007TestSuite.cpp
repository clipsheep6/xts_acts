...
namespace OHOS {
    ...
    void ActsSubgroups0007TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0007TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0007TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0007TS::TearDown()
    {
    }
}