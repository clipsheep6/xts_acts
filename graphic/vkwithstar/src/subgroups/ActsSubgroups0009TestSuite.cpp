...
namespace OHOS {
    ...
    void ActsSubgroups0009TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0009TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0009TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0009TS::TearDown()
    {
    }
}