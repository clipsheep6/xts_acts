...
namespace OHOS {
    ...
    void ActsSubgroups0008TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0008TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0008TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0008TS::TearDown()
    {
    }
}