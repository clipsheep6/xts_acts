...
namespace OHOS {
    ...
    void ActsSubgroups0005TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0005TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0005TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0005TS::TearDown()
    {
    }
}