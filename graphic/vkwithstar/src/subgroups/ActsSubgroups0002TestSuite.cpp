...
namespace OHOS {
    ...
    void ActsSubgroups0002TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSubgroups0002TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSubgroups0002TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSubgroups0002TS::TearDown()
    {
    }
}