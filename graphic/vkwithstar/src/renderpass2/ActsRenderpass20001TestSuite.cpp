...
namespace OHOS {
    ...
    void ActsRenderpass20001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsRenderpass20001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsRenderpass20001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsRenderpass20001TS::TearDown()
    {
    }
}