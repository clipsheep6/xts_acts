...
namespace OHOS {
    ...
    void ActsSynchronizationTS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronizationTS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronizationTS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronizationTS::TearDown()
    {
    }
}