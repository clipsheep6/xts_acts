...
namespace OHOS {
    ...
    void ActsSynchronization0002TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization0002TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization0002TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization0002TS::TearDown()
    {
    }
}