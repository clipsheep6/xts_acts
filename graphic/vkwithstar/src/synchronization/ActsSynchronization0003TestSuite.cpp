...
namespace OHOS {
    ...
    void ActsSynchronization0003TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization0003TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization0003TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization0003TS::TearDown()
    {
    }
}