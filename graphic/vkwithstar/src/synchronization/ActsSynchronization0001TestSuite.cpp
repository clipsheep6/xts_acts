...
namespace OHOS {
    ...
    void ActsSynchronization0001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsSynchronization0001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsSynchronization0001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsSynchronization0001TS::TearDown()
    {
    }
}