...
namespace OHOS {
    ...
    void ActsRenderpass0001TS::SetUpTestCase(void)
    {
        time(&startTime);
        RegistPackage();
    ...
    void ActsRenderpass0001TS::TearDownTestCase(void)
    {
        time(&endTime);
    ...
    void ActsRenderpass0001TS::SetUp()
    {
    }
    // Cleanup action of the test case
    void ActsRenderpass0001TS::TearDown()
    {
    }
}