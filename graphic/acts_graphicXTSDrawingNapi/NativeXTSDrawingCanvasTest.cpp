...
HWTEST_F(NativeXTSDrawingCanvasTest, OH_Drawing_CanvasDrawShadow, TestSize.Level1) {
  ...
  OH_Drawing_CanvasDrawShadow(canvas, path, p1, p2, 10, 0xFF000000, 0xFF000000, OH_Drawing_CanvasShadowFlags::SHADOW_FLAGS_ALL);
...
HWTEST_F(NativeXTSDrawingCanvasTest, OH_Drawing_CanvasDrawVertices, TestSize.Level1) {
  ...
  OH_Drawing_CanvasDrawVertices(canvas, VERTEX_MODE_TRIANGLES, POINT_PARAMETER, nullptr, texs_vertices, colors, POINT_PARAMETER, indices, BLEND_MODE_COLOR);
  OH_Drawing_CanvasDrawVertices(canvas, VERTEX_MODE_TRIANGLES, POINT_PARAMETER, points_vertices, nullptr, colors, POINT_PARAMETER, indices, BLEND_MODE_COLOR);
  OH_Drawing_CanvasDrawVertices(canvas, VERTEX_MODE_TRIANGLES, POINT_PARAMETER, points_vertices, texs_vertices, nullptr, POINT_PARAMETER, indices, BLEND_MODE_COLOR);
  OH_Drawing_CanvasDrawVertices(canvas, VERTEX_MODE_TRIANGLES, POINT_PARAMETER, points_vertices, texs_vertices, colors, POINT_PARAMETER, nullptr, BLEND_MODE_COLOR);
  ...
  OH_Drawing_CanvasDrawVertices(canvas, VERTEX_MODE_TRIANGLES, POINT_PARAMETER, points_vertices, texs_vertices, colors, POINT_PARAMETER, indices, BLEND_MODE_COLOR);
  OH_Drawing_CanvasDestroy(canvas);
  EXPECT_TRUE(true);
}
