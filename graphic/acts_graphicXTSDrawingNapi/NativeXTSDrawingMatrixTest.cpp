...
HWTEST_F(NativeXTSDrawingMatrixTest, OH_Drawing_MatrixSetRectToRect, TestSize.Level1) {
  ...
  bool isSuccess = OH_Drawing_MatrixSetRectToRect(matrixOne, rectSrcOne, rectDstOne, OH_Drawing_ScaleToFit::SCALE_TO_FIT_FILL);
  EXPECT_EQ(isSuccess, false);
  isSuccess = OH_Drawing_MatrixSetRectToRect(nullptr, rectSrcOne, rectDstOne, OH_Drawing_ScaleToFit::SCALE_TO_FIT_FILL);
  EXPECT_EQ(isSuccess, false);
  isSuccess = OH_Drawing_MatrixSetRectToRect(matrixOne, nullptr, rectDstOne, OH_Drawing_ScaleToFit::SCALE_TO_FIT_FILL);
  EXPECT_EQ(isSuccess, false);
  isSuccess = OH_Drawing_MatrixSetRectToRect(matrixOne, rectSrcOne, nullptr, OH_Drawing_ScaleToFit::SCALE_TO_FIT_FILL);
  EXPECT_EQ(isSuccess, false);
  ...
  bool isSuccessTwo = OH_Drawing_MatrixSetRectToRect(matrixTwo, rectSrcTwo, rectDstTwo, OH_Drawing_ScaleToFit::SCALE_TO_FIT_FILL);
