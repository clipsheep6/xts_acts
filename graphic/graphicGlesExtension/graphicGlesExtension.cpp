...
HWTEST_F(OH_GLES_ExtensionTest, OH_GLES_Extension001, Function | MediumTest | Level2)
{
    ...
    strTest = (char *)glGetString(GL_VERSION); // 返回值strTest中会列出所有的扩展接口，并且用空格分隔开
    ...
    bool isHave1 = strTest2.find("GL_NV_memory_object_sparse") != -1 ? true : false; // 查询是否有某个扩展接口，有则isHave为true，没有则为false
    ...
    bool isHave4 = strTest2.find("GL_MESA_framebuffer_flip_y") != -1 ? true : false;
    bool isHave5 = strTest2.find("GL_MESA_framebuffer_flip_y") != -1 ? true : false;
...
HWTEST_F(OH_GLES_ExtensionTest, OH_GLES_Extension002, Function | MediumTest | Level2)
{
    ...
    bool isHave1 = strTest2.find("GL_NV_timeline_semaphore") != -1 ? true : false;
    ...
    bool isHave4 = strTest2.find("GL_QCOM_shading_rate") != -1 ? true : false;
    bool isHave5 = strTest2.find("GL_QCOM_motion_estimation") != -1 ? true : false;
...
HWTEST_F(OH_GLES_ExtensionTest, OH_GLES_Extension003, Function | MediumTest | Level2)
{
    ...
    bool isHave2 = strTest2.find("GL_NV_memory_object_sparse") != -1 ? true : false;
    bool isHave3 = strTest2.find("GL_EXT_texture_storage_compression") != -1 ? true : false;
    bool isHave4 = strTest2.find("GL_EXT_texture_storage_compression") != -1 ? true : false;
    bool isHave5 = strTest2.find("GL_QCOM_motion_estimation") != -1 ? true : false;
