...
export class KeyboardController {
    ...
    public onCreate(): void {
        ...
        function subscriberCallback(err, data) {
            ...
            switch (data.code) {
                case 1:
                    console.debug(TAG + '====>inputMethodEngine_test_getInputMethodAbility_001 event:' + data.event);
                    that.inputMethodEngine_test_getInputMethodAbility_001();
                    break;
                case 2:
    ...
    private inputMethodEngine_test_getInputMethodAbility_001(): void {
        console.debug(TAG + '====>receive inputMethodEngine_test_getInputMethodAbility_001 data');
        if (typeof (inputMethodEngine) === "object") {
            console.info(TAG + '====>receive inputMethodEngine_test_getInputMethodAbility_001 data');
            var commonEventPublishData = {
                data: "SUCCESS"
            }
        } else {
            console.info(TAG + '====>receive inputMethodEngine_test_getInputMethodAbility_001 failed');
            var commonEventPublishData = {
                data: "FAILED"
            }
        }
        commoneventmanager.publish("inputMethodEngine_test_getInputMethodAbility_001", commonEventPublishData, this.publishCallback);
    }
            ...
            if (TextInputClient == null) {
                ...
                TextInputClient.sendKeyFunction(editorAttribyte.enterKeyType, (err, value) => {
                    if (err != undefined) {
                        ...
                        console.debug(TAG + '====>inputMethodEngine_test_028 TextInputClient sendKeyFunction: ' + JSON.stringify(err));
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_028 TextInputClient sendKeyFunction: ' + JSON.stringify(value));
                        if (value) {
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.deleteForward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodEngine_test_030 deleteForward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_030 deleteForward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.deleteBackward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodEngine_test_032 deleteBackward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_032 deleteBackward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.insertText('test', (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodEngine_test_034 insertText:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_034 insertText:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getForward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodEngine_test_036 getForward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_036 getForward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getEditorAttribute((err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodEngine_test_038 getEditorAttribute:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_038 getEditorAttribute:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
        ...
        inputMethodEngine.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getBackward(1, (err, value) => {
                    if (err){
                        console.debug(TAG + '====>inputMethodEngine_test_042 getBackward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_042 getBackward:' + JSON.stringify(value));
                        commonEventPublishData = {
                            data: "SUCCESS"
                        }
                    }
