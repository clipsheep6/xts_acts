...
export class KeyboardDelegate {
        ...
        function subscriberCallback(err, data){
            ...
            switch(data.code){
                ...
                case 2:
                    ...
                    that.inputMethodAbility_test_getInputMethodDelegate_001();
                    break;
                case 28:
                ...
                case 43:
                    ...
                    break;
                case 45:
                    console.debug(TAG + '====>inputMethodEngine_test_045 event:' + data.event);
                    that.inputMethodEngine_test_045();
                    break;
                case 46:
                    console.debug(TAG + '====>inputMethodEngine_test_046 event:' + data.event);
                    that.inputMethodEngine_test_046();
                    break;
                case 47:
                    console.debug(TAG + '====>inputMethodEngine_test_047 event:' + data.event);
                    that.inputMethodEngine_test_047();
                    break;
                case 48:
                    console.debug(TAG + '====>inputMethodEngine_test_048 event:' + data.event);
                    that.inputMethodEngine_test_048();
                    break;
                case 49:
    ...
    private inputMethodAbility_test_getInputMethodDelegate_001(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_getInputMethodDelegate_001 data');
        if(typeof inputMethodAbility == 'object'){
            console.debug(TAG + '====>inputMethodAbility_test_getInputMethodDelegate_001 success');
            var commonEventPublishData = {
                data: "SUCCESS"
            }
        }else{
            console.debug(TAG + '====>inputMethodAbility_test_getInputMethodDelegate_001 failed');
            var commonEventPublishData = {
                data: "FAILED"
            }
        }
        commoneventmanager.publish("inputMethodAbility_test_getInputMethodDelegate_001", commonEventPublishData, this.publishCallback)
    }
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.sendKeyFunction(editorAttribyte.enterKeyType, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_028 sendKeyFunction:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_028 sendKeyFunction:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_029(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                console.debug(TAG + '====>inputMethodAbility_test_029 sendKeyFunction:' + JSON.stringify(value));
                if (value){
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.deleteForward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_030 deleteForward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_030 deleteForward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_031(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                let value = InputClient.deleteForward(1)
                console.debug(TAG + '====>inputMethodAbility_test_031 deleteForward:' + JSON.stringify(value));
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.deleteBackward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_032 deleteBackward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_032 deleteBackward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_033(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                let value = InputClient.deleteBackward(1)
                console.debug(TAG + '====>inputMethodAbility_test_033 deleteBackward:' + JSON.stringify(value));
                if (value){
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.insertText('test', (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_034 insertText:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_034 insertText:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_035(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                console.debug(TAG + '====>inputMethodAbility_test_035 insertText:' + JSON.stringify(value));
                if (value){
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getForward(1, (err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_036 getForward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_036 getForward:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_037(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                console.debug(TAG + '====>inputMethodAbility_test_037 getForward:' + JSON.stringify(value));
                if (value){
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getEditorAttribute((err, value) => {
                    if (err != undefined){
                        console.debug(TAG + '====>inputMethodAbility_test_038 getEditorAttribute:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_038 getEditorAttribute:' + JSON.stringify(value));
                        if (value){
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
    ...
    private inputMethodAbility_test_039(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                console.debug(TAG + '====>inputMethodAbility_test_039 getEditorAttribute:' + JSON.stringify(value));
                if (value){
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
            ...
            if (InputClient == null) {
                ...
                try{
                    KeyboardDelegate.hideKeyboard((err, value) => {
                        if (err){
                            console.debug(TAG + '====>inputMethodAbility_test_040 hideKeyboard:' + JSON.stringify(err));
                            commonEventPublishData = {
                                data: "FAILED"
                            }
                        } else {
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                try{
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_041 hideKeyboard catch err:');
                }
                commoneventmanager.publish("inputMethodAbility_test_041", commonEventPublishData, this.publishCallback)
            }
        })
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                InputClient.getBackward(1, (err, value) => {
                    if (err){
                        console.debug(TAG + '====>inputMethodAbility_test_042 getBackward:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodAbility_test_042 getBackward:' + JSON.stringify(value));
                        commonEventPublishData = {
                            data: "SUCCESS"
                        }
                    }
    ...
    private inputMethodAbility_test_043(): void{
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                console.debug(TAG + '====>inputMethodAbility_test_043 getBackward:' + JSON.stringify(value));
                commonEventPublishData = {
                    data: "SUCCESS"
                }
                commoneventmanager.publish("inputMethodAbility_test_043", commonEventPublishData, this.publishCallback)
    ...
    private inputMethodEngine_test_045(): void{
        console.debug(TAG + '====>receive inputMethodEngine_test_045 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodEngine_test_045", commonEventPublishData, this.publishCallback)
            } else {
                InputClient.moveCursor(inputMethodEngine.CURSOR_UP, (err, value) => {
                    if (err){
                        console.debug(TAG + '====>inputMethodEngine_test_045 CURSOR_UP:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_045 CURSOR_UP:' + JSON.stringify(value));
                        commonEventPublishData = {
                            data: "SUCCESS"
                        }
                    }
    ...
    private inputMethodEngine_test_046(): void{
        console.debug(TAG + '====>receive inputMethodEngine_test_046 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodEngine_test_046", commonEventPublishData, this.publishCallback)
            } else {
                InputClient.moveCursor(inputMethodEngine.CURSOR_DOWN, (err, value) => {
                    if (err){
                        console.debug(TAG + '====>inputMethodEngine_test_046 CURSOR_DOWN:' + JSON.stringify(err));
                        commonEventPublishData = {
                            data: "FAILED"
                        }
                    } else {
                        console.debug(TAG + '====>inputMethodEngine_test_046 CURSOR_DOWN:' + JSON.stringify(value));
                        commonEventPublishData = {
                            data: "SUCCESS"
                        }
                    }
    ...
    private inputMethodEngine_test_047(): void{
        console.debug(TAG + '====>receive inputMethodEngine_test_047 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodEngine_test_047", commonEventPublishData, this.publishCallback)
            } else {
                await InputClient.moveCursor(inputMethodEngine.CURSOR_LEFT)
                console.debug(TAG + '====>inputMethodEngine_test_047 CURSOR_LEFT success');
                commonEventPublishData = {
                    data: "SUCCESS"
                }
                commoneventmanager.publish("inputMethodEngine_test_047", commonEventPublishData, this.publishCallback)
    ...
    private inputMethodEngine_test_048(): void{
        console.debug(TAG + '====>receive inputMethodEngine_test_048 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodEngine_test_048", commonEventPublishData, this.publishCallback)
            } else {
                await InputClient.moveCursor(inputMethodEngine.CURSOR_RIGHT)
                console.debug(TAG + '====>inputMethodEngine_test_048 CURSOR_RIGHT success');
                commonEventPublishData = {
                    data: "SUCCESS"
                }
                commoneventmanager.publish("inputMethodEngine_test_048", commonEventPublishData, this.publishCallback)
            ...
            if (InputClient == null) {
                ...
                try{
                    KeyboardDelegate.hide((err, value) => {
                        if (err){
                            console.debug(TAG + '====>inputMethodAbility_test_049 hide:' + JSON.stringify(err));
                            commonEventPublishData = {
                                data: "FAILED"
                            }
                        } else {
        ...
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            ...
            if (InputClient == null) {
                ...
                try{
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_050 hideKeyboard catch err:');
                }
                commoneventmanager.publish("inputMethodAbility_test_050", commonEventPublishData, this.publishCallback)
            }
        })
    ...
    private inputMethodAbility_test_0101(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0101 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            ...
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0101", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    InputClient.selectByRange(range, (err, value) => {
                        if (err){
                            console.debug(TAG + '====>inputMethodAbility_test_0101 selectByRange err:' + JSON.stringify(err));
                            commonEventPublishData = {
                                data: "FAILED"
                            }
                        } else {
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0101 selectByRange throw_err:');
                    commoneventmanager.publish("inputMethodAbility_test_0101", commonEventPublishData, this.publishCallback)
                }
            }
        })
    }
    private inputMethodAbility_test_0102(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0102 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            let range = {start: 0, end: 1}
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0102", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    await InputClient.selectByRange(range)
                    console.debug(TAG + '====>inputMethodAbility_test_0102 selectByRange success');
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
                }catch(err){
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0102 selectByRange catch err:');
                }
                commoneventmanager.publish("inputMethodAbility_test_0102", commonEventPublishData, this.publishCallback)
            }
        })
    ...
    private inputMethodAbility_test_0103(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0103 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0103", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    InputClient.getTextIndexAtCursor((err, value) => {
                        if (err){
                            console.debug(TAG + '====>inputMethodAbility_test_0103 getTextIndexAtCursor err:' + JSON.stringify(err));
                            commonEventPublishData = {
                                data: "FAILED"
                            }
                        } else {
                            console.debug(TAG + '====>inputMethodAbility_test_0103 getTextIndexAtCursor success' + JSON.stringify(value));
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0103 getTextIndexAtCursor throw_err:');
                    commoneventmanager.publish("inputMethodAbility_test_0103", commonEventPublishData, this.publishCallback)
                }
            }
        })
    }
    private inputMethodAbility_test_0104(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0104 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0104", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    let value = await InputClient.getTextIndexAtCursor()
                    console.debug(TAG + '====>inputMethodAbility_test_0104 getTextIndexAtCursor value:' + JSON.stringify(value));
                    if(typeof value == 'number'){
                        commonEventPublishData = {
                            data: "SUCCESS"
                        }
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0104 getTextIndexAtCursor catch err:');
                }
                commoneventmanager.publish("inputMethodAbility_test_0104", commonEventPublishData, this.publishCallback)
            }
        })
    ...
    private inputMethodAbility_test_0105(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0105 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            ...
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0105", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    InputClient.selectByMovement(movement, (err, value) => {
                        if (err){
                            console.debug(TAG + '====>inputMethodAbility_test_0105 selectByMovement err:' + JSON.stringify(err));
                            commonEventPublishData = {
                                data: "FAILED"
                            }
                        } else {
                            console.debug(TAG + '====>inputMethodAbility_test_0105 selectByMovement success');
                            commonEventPublishData = {
                                data: "SUCCESS"
                            }
                        }
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0105 selectByMovement throw_err:');
                    commoneventmanager.publish("inputMethodAbility_test_0105", commonEventPublishData, this.publishCallback)
                }
            }
        })
    }
    private inputMethodAbility_test_0106(): void{
        console.debug(TAG + '====>receive inputMethodAbility_test_0106 data');
        inputMethodAbility.on('inputStart', async(KeyboardDelegate, InputClient) =>{
            inputMethodAbility.off('inputStart')
            let commonEventPublishData;
            ...
            if (InputClient == null) {
                ...
                commoneventmanager.publish("inputMethodAbility_test_0106", commonEventPublishData, this.publishCallback)
            } else {
                try{
                    let value = await InputClient.selectByMovement(movement)
                    console.debug(TAG + '====>inputMethodAbility_test_0106 selectByMovement success');
                    commonEventPublishData = {
                        data: "SUCCESS"
                    }
                }catch(err){
                    ...
                    console.debug(TAG + '====>inputMethodAbility_test_0106 getTextIndexAtCursor catch err:');
                }
                commoneventmanager.publish("inputMethodAbility_test_0106", commonEventPublishData, this.publishCallback)
            }
        })
