...
export class KeyboardDelegate {
  ...
  private onInputStop() {
    try {
      this.mContext.destroy((err: BusinessError) => {
  ...
  private publishCallback(err: BusinessError): void {
    if (err) {
  ...
  async inputMethodAbility_test_102() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let range: inputMethodEngine.Range = { start: 1, end: 0 };
    try {
  ...
  async inputMethodAbility_test_105() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let movement: inputMethodEngine.Movement = { direction: inputMethodEngine.CURSOR_DOWN };
    try {
  ...
  async inputMethodAbility_test_106() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let movement: inputMethodEngine.Movement = { direction: inputMethodEngine.CURSOR_RIGHT };
    try {
  ...
  async Sub_Misc_inputMethod_onSelectByRange_0110() {
    ...
    let range: inputMethodEngine.Range = { start: 0, end: 10 };
    try {
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0400() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let range: inputMethodEngine.Range = { start: 99, end: 88 };
    try {
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0500() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let range: inputMethodEngine.Range = { start: 168, end: -66 };
    try {
      this.InputClient.selectByRange(range, (err) => {
        if (err) {
  ...
  async Sub_Misc_Request_InputMethod_selectContext_0600() {
    ...
    let commonEventPublishData: commoneventmanager.CommonEventPublishData;
    let range: inputMethodEngine.Range = { start: 100, end: 2000 };
    try {
      this.InputClient.selectByRange(range, (err) => {
        if (err) {
