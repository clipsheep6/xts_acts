...
describe('resMgrTest', function () {
    ...
    */
    ...
    /**
     * @tc.number SUB_GLOBAL_RESMGR_DRAWABLE_JS_1700
     * @tc.name getDrawableDescriptorByName with not pic
     * @tc.desc test the getDrawableDescriptorByName method return 9001004
     */
    it('getDrawableDescriptor_test_1700', 0, async function (done) {
        resmgr.getResourceManager((error, mgr) => {
            try{
                let value = mgr.getDrawableDescriptorByName('wpp');
                console.log('getDrawableDescriptor_test_1700 ' + value);
                expect(value != null).assertTrue();
            }catch(error){
                console.log('getDrawableDescriptor_test_1700 ' + error.code);
                console.log('getDrawableDescriptor_test_1700 ' + error.message);
