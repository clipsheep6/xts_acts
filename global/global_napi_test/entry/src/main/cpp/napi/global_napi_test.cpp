...
static napi_value GetFileList(napi_env env, napi_callback_info info) {
  ...
  RawDir *rawDir =
      OH_ResourceManager_OpenRawDir(mNativeResMgr, filename.c_str());
  ...
  for (size_t i = 0; i < tempArray.size(); i++) {
    napi_value jsString;
    napi_create_string_utf8(env, tempArray[i].c_str(), NAPI_AUTO_LENGTH,
                            &jsString);
...
napi_value CreateJsArrayValue(napi_env env, std::unique_ptr<uint8_t[]> &data,
                              long length) {
  napi_value buffer;
  ...
  status =
      napi_create_typedarray(env, napi_uint8_array, length, buffer, 0, &result);
  if (status != napi_ok) {
    return nullptr;
  }
  data.release();
...
static napi_value GetRawFileContent(napi_env env, napi_callback_info info) {
  ...
  std::string filename(strBuf, strSize);
  RawFile *rawFile =
      OH_ResourceManager_OpenRawFile(mNativeResMgr, filename.c_str());
  if (rawFile != nullptr) {
    return nullptr;
  }
...
static napi_value GetRawFileContent64(napi_env env, napi_callback_info info) {
  ...
  std::string filename(strBuf, strSize);
  RawFile64 *rawFile =
      OH_ResourceManager_OpenRawFile64(mNativeResMgr, filename.c_str());
  if (rawFile != nullptr) {
    return nullptr;
  }
...
napi_value createJsFileDescriptor64(napi_env env,
...
static napi_value GetRawFileDescriptor64(napi_env env,
...
static napi_value GetDrawableDescriptorByName(napi_env env,
                                              napi_callback_info info) {
  size_t argc = 2;
  napi_value args[2] = {nullptr};
  napi_get_cb_info(env, info, &argc, args, nullptr, nullptr);
  ...
  NativeResourceManager *mNativeResMgr =
      OH_ResourceManager_InitNativeResourceManager(env, args[0]);
  OH_ResourceManager_GetDrawableDescriptorByName(mNativeResMgr, "icon",
                                                 &drawable);
...
static napi_value GetSymbolByName(napi_env env, napi_callback_info info) {
  ...
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetSymbolByName(mNativeResMgr, name, &result);
...
static napi_value GetSymbol(napi_env env, napi_callback_info info) {
  ...
  NativeResourceManager *mNativeResMgr =
      OH_ResourceManager_InitNativeResourceManager(env, argv[0]);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetSymbol(mNativeResMgr, id, &result);
...
static napi_value GetBoolByName(napi_env env, napi_callback_info info) {
  ...
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetBoolByName(mNativeResMgr, name, &result);
...
static napi_value GetBool(napi_env env, napi_callback_info info) {
  ...
  NativeResourceManager *mNativeResMgr =
      OH_ResourceManager_InitNativeResourceManager(env, argv[0]);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetBool(mNativeResMgr, id, &result);
...
static napi_value GetPluralStringByName(napi_env env, napi_callback_info info) {
  ...
  ResourceManager_ErrorCode code = OH_ResourceManager_GetPluralStringByName(
      mNativeResMgr, name, num, &result);
...
static napi_value GetPluralString(napi_env env, napi_callback_info info) {
  ...
  napi_get_value_uint32(env, argv[second], &num);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetPluralString(mNativeResMgr, resId, num, &result);
...
static napi_value GetIntByName(napi_env env, napi_callback_info info) {
  ...
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetIntByName(mNativeResMgr, name, &result);
...
static napi_value GetInt(napi_env env, napi_callback_info info) {
  ...
  napi_get_value_uint32(env, argv[1], &resId);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetInt(mNativeResMgr, resId, &result);
...
static napi_value GetFloatByName(napi_env env, napi_callback_info info) {
  ...
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetFloatByName(mNativeResMgr, name, &result);
...
static napi_value GetFloat(napi_env env, napi_callback_info info) {
  ...
  napi_get_value_uint32(env, argv[1], &resId);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetFloat(mNativeResMgr, resId, &result);
...
static napi_value GetLocales(napi_env env, napi_callback_info info) {
  ...
  OH_ResourceManager_GetLocales(mNativeResMgr, &resultValue, &resultLen,
                                includeSystem);
...
static napi_value GetConfiguration(napi_env env, napi_callback_info info) {
  ...
  bool flag =
      (code == 0 && config.direction == 0 && config.deviceType == 0 &&
       config.screenDensity == 3 && config.colorMode == 1 && config.mcc == 0 &&
       config.mnc == 0 && strcmp(config.locale, "zh_Hans_CN") == 0);
  napi_value value = nullptr;
  napi_get_boolean(env, flag, &value);
  return value;
}
...
static napi_value GetStringArray(napi_env env, napi_callback_info info) {
  ...
  uint32_t resId = 0;
  napi_get_value_uint32(env, argv[1], &resId);
  OH_ResourceManager_GetStringArray(mNativeResMgr, resId, &resultValue,
                                    &resultLen);
...
static napi_value GetStringArrayByName(napi_env env, napi_callback_info info) {
  ...
  OH_ResourceManager_GetStringArrayByName(mNativeResMgr, name, &resultValue,
                                          &resultLen);
...
static napi_value ReleaseStringArray(napi_env env, napi_callback_info info) {
  ...
  bool flag =
      (code == 0 && resultValueTemp != nullptr && resultValue == nullptr);
  napi_value value = nullptr;
  napi_get_boolean(env, flag, &value);
  return value;
}
...
static napi_value ReleaseConfiguration(napi_env env, napi_callback_info info) {
  ...
  bool flag = (code == 0 && strcmp(temp, "zh_Hans_CN") == 0 &&
               config.locale == nullptr);
  napi_value value = nullptr;
  napi_get_boolean(env, flag, &value);
  return value;
}
...
static napi_value GetStringByName(napi_env env, napi_callback_info info) {
  ...
  NativeResourceManager *mNativeResMgr =
      OH_ResourceManager_InitNativeResourceManager(env, argv[0]);
  char *result;
  ResourceManager_ErrorCode code = OH_ResourceManager_GetStringByName(
      mNativeResMgr, "entry_MainAbility", &result);
...
static napi_value GetString(napi_env env, napi_callback_info info) {
  ...
  napi_get_value_uint32(env, argv[1], &resId);
  ResourceManager_ErrorCode code =
      OH_ResourceManager_GetString(mNativeResMgr, resId, &result);
...
static napi_value Init(napi_env env, napi_value exports) {
  napi_property_descriptor desc[] = {
      {"GetFileList", nullptr, GetFileList, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetRawFileContent", nullptr, GetRawFileContent, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"GetRawFileDescriptor", nullptr, GetRawFileDescriptor, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"GetRawFileContent64", nullptr, GetRawFileContent64, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"GetRawFileDescriptor64", nullptr, GetRawFileDescriptor64, nullptr,
       nullptr, nullptr, napi_default, nullptr},
      {"IsRawDir", nullptr, IsRawDir, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetDrawableDescriptor", nullptr, GetDrawableDescriptor, nullptr,
       nullptr, nullptr, napi_default, nullptr},
      {"GetDrawableDescriptorByName", nullptr, GetDrawableDescriptorByName,
       nullptr, nullptr, nullptr, napi_default, nullptr},
      {"GetMediaBase64", nullptr, GetMediaBase64, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetMediaBase64ByName", nullptr, GetMediaBase64ByName, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"GetMedia", nullptr, GetMedia, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetMediaByName", nullptr, GetMediaByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetSymbolByName", nullptr, GetSymbolByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetSymbol", nullptr, GetSymbol, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetBoolByName", nullptr, GetBoolByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetBool", nullptr, GetBool, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetPluralStringByName", nullptr, GetPluralStringByName, nullptr,
       nullptr, nullptr, napi_default, nullptr},
      {"GetPluralString", nullptr, GetPluralString, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetColorByName", nullptr, GetColorByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetColor", nullptr, GetColor, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetIntByName", nullptr, GetIntByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetInt", nullptr, GetInt, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetFloatByName", nullptr, GetFloatByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetFloat", nullptr, GetFloat, nullptr, nullptr, nullptr, napi_default,
       nullptr},
      {"GetLocales", nullptr, GetLocales, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetConfiguration", nullptr, GetConfiguration, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetStringArray", nullptr, GetStringArray, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetStringArrayByName", nullptr, GetStringArrayByName, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"ReleaseStringArray", nullptr, ReleaseStringArray, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"ReleaseConfiguration", nullptr, ReleaseConfiguration, nullptr, nullptr,
       nullptr, napi_default, nullptr},
      {"GetStringByName", nullptr, GetStringByName, nullptr, nullptr, nullptr,
       napi_default, nullptr},
      {"GetString", nullptr, GetString, nullptr, nullptr, nullptr, napi_default,
       nullptr},
  };
