...
export default class MultiAbility extends Ability {
    ...
    onCreate(want, launchParam) {
        ...
        this.context.startAbility({
            abilityName: "com.example.entry2.Entry2MulMainAbility",
            bundleName: "com.example.etsmyapplication",
        }, (error, data) => {
            console.log("Entry2MulMainAbility success, err: " +
            JSON.stringify(error) + ",data: " + JSON.stringify(data));
            commonEvent.publish("Entry2MulMainAbility_Event", () => {
                console.log("Entry2MulMainAbility_Event publish success!")
            });
        });
//
//         setTimeout(()=>{
