...
export default class MainAbility2 extends Ability {
    ...
    onCreate(want, launchParam) {
        ...
        globalThis.abilityName = "com.example.etsmyapplication.MainAbility2";
        ...
        this.context.startAbility({
            ...
            console.log("Entry2MainAbility success, err: " +
            JSON.stringify(error) + ",data: " + JSON.stringify(data));
            commonEvent.publish("Entry2MainAbility_Event", () => {
                console.log("Entry2MainAbility_Event publish success!")
            });
        });
        ...
        this.context.terminateSelfWithResult({
            ...
            commonEvent.publish("mainAbility2WithResult", {
                parameters:{
                    resultCode: resultCodeWithResult,
                    abilityName: abilityNameWithResult,
                    bundleName: bundleNameWithResult
                ...
                console.log("mainAbility2WithResult Publish CallBack success")
            });
        }).catch((error) => {
