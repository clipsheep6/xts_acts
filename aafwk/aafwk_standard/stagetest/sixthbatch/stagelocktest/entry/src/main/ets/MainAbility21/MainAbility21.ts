...
export default class MainAbility21 extends Ability {
    ...
    onCreate(want, launchParam) {
        ...
        console.log("MainAbility2-1 onCreate");
        ...
        setTimeout(()=>{
            this.context.terminateSelf().then((data) => {
                console.log("SUB_AA_OpenHarmony_Lock_0900 terminateSelf data: " + JSON.stringify(data))
            }).catch((error) => {
                console.log("SUB_AA_OpenHarmony_Lock_0900 terminateSelf error: " + JSON.stringify(error))
            })
        }, 1500)
    }
