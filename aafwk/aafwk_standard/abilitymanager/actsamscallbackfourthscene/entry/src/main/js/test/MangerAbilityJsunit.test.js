    ...
    var maxnum = 20,flag = 1;
        abilitymanager.queryRecentAbilityMissionInfos(maxnum, flag, data => {
            ...
            for (var i = 0; i < data.length; i++) {
                if(data[i].baseAbility.bundleName != 'com.example.actsamscallbackfourthscene'&& data[i].topAbility.bundleName != 'com.example.actsamscallbackfourthscene'){
