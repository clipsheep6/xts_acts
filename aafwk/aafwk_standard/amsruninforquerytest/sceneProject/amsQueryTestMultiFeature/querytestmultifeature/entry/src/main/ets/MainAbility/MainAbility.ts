...
function publishCallBack() {
    console.debug("====>querytestmultifeature Publish CallBack ====>");
}
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('querytestmultifeature result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
async function onShowProcess() {
    ...
    console.log("querytestmultifeature abilityWant = " + JSON.stringify(abilityWant));
    if (abilityWant.parameters.nextStep >= abilityWant.parameters.stepNum) {
        ...
        console.log("querytestmultifeature abilityWant==>");
        callBackSeq = "";
    } else {
        commonEvent.publish("MultiInstanceStartNext", commonEventPublishData, () => {
            callBackSeq = "";
            console.log("querytestmultifeature abilityWant Next==>");
...
export default class MainAbility extends Ability {
    onCreate(want, launchParam) {
        ...
        console.log("querytestmultifeature onCreate")
    ...
    onDestroy() {
        ...
        console.log("querytestmultifeature onDestroy")
    }

    onWindowStageCreate(windowStage) {
        // Main window is created, set main page for this ability
        console.log("querytestmultifeature onWindowStageCreate")
        //       callBackSeq += "onWindowStageCreate";
        globalThis.abilityContext = this.context
        windowStage.setUIContent(this.context, "pages/index", null)
        console.log("querytestmultifeature onWindowStageCreate finish")
    }

    onWindowStageDestroy() {
        // Main window is destroyed, release UI related resources
        console.log("querytestmultifeature onWindowStageDestroy")
    }

    onForeground() {
        // Ability has brought to foreground
        console.log("querytestmultifeature onForeground")
    ...
    onBackground() {
        ...
        console.log("querytestmultifeature onBackground")
    }
};
