...
function publishCallBack() {
    console.debug("====>querytesttwo Publish CallBack ====>");
}
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('startAbilityProcess querytesttwo result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
export default class MainAbility extends Ability {
    onCreate(want, launchParam) {
        ...
        console.log("querytesttwo onCreate")
    ...
    onDestroy() {
        ...
        console.log("querytesttwo onDestroy")
    }

    onWindowStageCreate(windowStage) {
        // Main window is created, set main page for this ability
        console.log("querytesttwo onWindowStageCreate")
        //       callBackSeq += "onWindowStageCreate";
        globalThis.abilityContext = this.context
        windowStage.setUIContent(this.context, "pages/index", null)
        console.log("querytesttwo onWindowStageCreate finish")
    }

    onWindowStageDestroy() {
        // Main window is destroyed, release UI related resources
        console.log("querytesttwo onWindowStageDestroy")
    }

    onForeground() {
        // Ability has brought to foreground
        console.log("querytesttwo onForeground")
    ...
    onBackground() {
        ...
        console.log("querytesttwo onBackground")
    }
};
