...
function publishCallBack() {
    console.debug("====>Publish querytestfive CallBack ====>");
}
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('querytestfive result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
async function onShowProcess() {
    ...
    console.log("querytestfive abilityWant = " + JSON.stringify(abilityWant));
    if (abilityWant.parameters.nextStep >= abilityWant.parameters.stepNum) {
        ...
        console.log('querytestfive result MultiInstanceStartFinish:' )
        callBackSeq = "";
    } else {
        commonEvent.publish("MultiInstanceStartNext", commonEventPublishData, () => {
            ...
            console.log('querytestfive result MultiInstanceStartNext:')
        });
    }
}
...
export default class MainAbility extends Ability {
    onCreate(want, launchParam) {
        ...
        console.log("querytestfive onCreate")
    ...
    onDestroy() {
        ...
        console.log("querytestfive onDestroy")
    }
    ...
    onWindowStageCreate(windowStage) {
        ...
        console.log("querytestfive onWindowStageCreate finish")
    }
    ...
    onForeground() {
        ...
        console.log("querytestfive onForeground")
    ...
    onBackground() {
        ...
        console.log("querytestfive onBackground")
    }
};
