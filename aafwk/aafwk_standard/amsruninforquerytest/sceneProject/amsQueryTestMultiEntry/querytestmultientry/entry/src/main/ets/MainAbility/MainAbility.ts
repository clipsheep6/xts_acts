...
function publishCallBack() {
    console.debug("====>querytestmulti Publish CallBack ====>");
}
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('querytestmulti startAbilityProcess result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
async function onShowProcess() {
    ...
    var callBackData = "querytestmulti:"
    ...
    console.log("querytestmulti abilityWant = " + JSON.stringify(abilityWant));
    if (abilityWant.parameters.nextStep >= abilityWant.parameters.stepNum) {
        ...
        console.log("querytestmulti abilityWant ===> " );
        callBackSeq = "";
    } else {
        commonEvent.publish("MultiInstanceStartNext", commonEventPublishData, () => {
            callBackSeq = "";
            console.log("querytestmulti abilityWant Next ===>" );
...
export default class MainAbility extends Ability {
    onCreate(want, launchParam) {
        ...
        console.log("querytestmulti onCreate")
    ...
    onDestroy() {
        ...
        console.log("querytestmulti onDestroy")
    }

    onWindowStageCreate(windowStage) {
        // Main window is created, set main page for this ability
        console.log("querytestmulti onWindowStageCreate")
        //       callBackSeq += "onWindowStageCreate";
        globalThis.abilityContext = this.context
        windowStage.setUIContent(this.context, "pages/index", null)
        console.log("querytestmulti onWindowStageCreate finish")
    }

    onWindowStageDestroy() {
        // Main window is destroyed, release UI related resources
        console.log("querytestmulti onWindowStageDestroy")
    }

    onForeground() {
        // Ability has brought to foreground
        console.log("querytestmulti onForeground")
    ...
    onBackground() {
        ...
        console.log("querytestmulti onBackground")
    }
};
