...
function publishCallBack() {
    console.debug("====>querytestsix Publish CallBack ====>");
}
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('startAbilityProcess querytestsix result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
async function onShowProcess() {
    ...
    console.log("querytestsix abilityWant = " + JSON.stringify(abilityWant));
...
export default class MainAbility extends Ability {
    onCreate(want, launchParam) {
        ...
        console.log("querytestsix onCreate")
    ...
    onDestroy() {
        ...
        console.log("querytestsix onDestroy")
    }

    onWindowStageCreate(windowStage) {
        // Main window is created, set main page for this ability
        console.log("querytestsix onWindowStageCreate")
        //       callBackSeq += "onWindowStageCreate";
        globalThis.abilityContext = this.context
        windowStage.setUIContent(this.context, "pages/index", null)
        console.log("querytestsix onWindowStageCreate finish")
    }

    onWindowStageDestroy() {
        // Main window is destroyed, release UI related resources
        console.log("querytestsix onWindowStageDestroy")
    }

    onForeground() {
        // Ability has brought to foreground
        console.log("querytestsix onForeground")
    ...
    onBackground() {
        ...
        console.log("querytestsix onBackground")
    }
};
