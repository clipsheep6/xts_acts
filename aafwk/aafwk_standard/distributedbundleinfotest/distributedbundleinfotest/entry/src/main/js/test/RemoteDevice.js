...
export default class RemoteDeviceModel {
    ...
    registerDeviceListCallback_(callback) {
        ...
        this.#deviceManager.on('deviceFound', (data) => {
            ...
            console.info('[RemoteDeviceModel] deviceFound self.deviceList=' + self.deviceList);
            console.info('[RemoteDeviceModel] deviceFound self.deviceList.length=' + self.deviceList.length);
            for (var i = 0; i < self.deviceList.length; i++) {
                if (self.deviceList[i].deviceId === data.device.deviceId) {
            ...
            console.info('[RemoteDeviceModel] authenticateDevice ' + JSON.stringify(data.device));
        ...
        this.#deviceManager.on('authResult', (data) => {
            console.info('[RemoteDeviceModel] authResult data=' + JSON.stringify(data));
        });
