...
export default class MyServiceExtension extends ServiceExtension {
    onCreate(want) {
        ...
        this.context.startAbility({
            ...
            console.log('MyServiceExtension2 SUB_AA_Extension_ServiceExtensionContext_0200 -- startAbility(ServiceAbility2): '
    ...
    onRequest(want, startId) {
        ...
        commonEvent.publish('MyApplication_ServiceExtension2_onRequest', () => {
            console.log('[MyApplication] MyServiceExtension2-- onRequest publish event: MyApplication_ServiceExtension2_onRequest ');
        })
        setTimeout(function () {
