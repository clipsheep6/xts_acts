...
export default class MyServiceAbility extends ServiceExtension {
    onCreate(want) {
        ...
        commonEvent.publish('entry_ServiceExtension14_onCreate', () => {
            console.log('[MyApplication] MyServiceExtension14-- onCreate publish event: MyApplication_ServiceExtension14_onCreate ');
        })
    }
    ...
    onRequest(want, startId) {
        ...
        commonEvent.publish('entry_ServiceExtension14_onRequest', () => {
            console.log('[MyApplication] MyServiceExtension14-- onRequest publish event: MyApplication_ServiceExtension14_onRequest ');
        })
    }
}
