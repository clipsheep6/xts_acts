...
export default class MyServiceAbility extends ServiceExtension {
    onCreate(want) {
        ...
        commonEvent.publish('entry_ServiceExtension8_onCreate', () => {
            console.log('[MyApplication] MyServiceExtension8-- onCreate publish event: MyApplication_ServiceExtension8_onCreate ');
        })
    }
    ...
    onRequest(want, startId) {
        ...
        commonEvent.publish('entry_ServiceExtension8_onRequest', () => {
            console.log('[MyApplication] MyServiceExtension8-- onRequest publish event: MyApplication_ServiceExtension8_onRequest ');
        })
    }
}
