...
export default class MyServiceAbility extends ServiceExtension {
    onCreate(want) {
        ...
        commonEvent.publish('entry_ServiceExtension12_onCreate', () => {
            console.log('[MyApplication] MyServiceExtension12-- onCreate publish event: MyApplication_ServiceExtension12_onCreate ');
        })
    }
    ...
    onRequest(want, startId) {
        ...
        commonEvent.publish('entry_ServiceExtension12_onRequest', () => {
            console.log('[MyApplication] MyServiceExtension12-- onRequest publish event: MyApplication_ServiceExtension12_onRequest');
        })
    }
}
