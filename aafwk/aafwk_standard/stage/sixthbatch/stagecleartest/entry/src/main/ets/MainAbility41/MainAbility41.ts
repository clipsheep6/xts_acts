    ...
    onCreate(want, launchParam) {
        ...
        setTimeout(()=>{
            this.context.terminateSelf().then((data) => {
                console.log("SUB_AA_OpenHarmony_Clear_0100-MainAbility41EventTest terminateSelf data: " + JSON.stringify(data))
            }).catch((error) => {
                console.log("SUB_AA_OpenHarmony_Clear_0100-MainAbility41EventTest terminateSelf error: " + JSON.stringify(error))
            })
        }, 1000)
    }
