...
//            .then((data) => {
//                console.info(' AuxgetForegroundApplications successful. Data: ' + JSON.stringify(data))
//            }).catch((error) => {
//            console.error('AuxgetForegroundApplications failed. Cause: ' + JSON.stringify(error));
//
//        })
    }
