...
describe('DistributedTest', function(){
     ...
     */
     it('testContinueAbility0300', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility(undefined, (err, data) => {
            console.log('testContinueAbility0300 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
     ...
     */
     it('testContinueAbility0400', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility("", (err, data) => {
            console.log('testContinueAbility0400 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
        await sleep(timeSleep);
     ...
     */
     it('testContinueAbility0500', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility(options, (err, data) => {
            console.log('testContinueAbility0500 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
        await sleep(timeSleep);
     ...
     */
     it('testContinueAbility0600', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility(options, (err, data) => {
            console.log('testContinueAbility0600 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
        await sleep(timeSleep);
     ...
     */
     it('testContinueAbility0700', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility(options, (err, data) => {
            console.log('testContinueAbility0700 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
        await sleep(timeSleep);
     ...
     */
     it('testContinueAbility0900', 0, async function (done) {
        ...
        ability_featureAbility.continueAbility(options, (err, data) => {
            console.log('testContinueAbility0900 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
        })
        await sleep(timeSleep);
     ...
     */
     it('testContinueAbility1000', 0, async function (done) {
        ...
        for(var i = 0; i < 10; i++) {
            ability_featureAbility.continueAbility(options, (err, data) => {
                console.log('testContinueAbility1000 err is :' + JSON.stringify(err) + ', value is :' + JSON.stringify(data));
            })
        }
        await sleep(timeSleep);
