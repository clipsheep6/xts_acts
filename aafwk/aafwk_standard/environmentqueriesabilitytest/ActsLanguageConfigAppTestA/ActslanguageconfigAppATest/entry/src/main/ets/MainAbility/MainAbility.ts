...
function publishCallBack() {
    console.debug("====>LanguageConfigAppA Publish CallBack ====>");
}
async function onShowProcess() {
    ...
    console.log("LanguageConfigAppA abilityWant = " + JSON.stringify(abilityWant));
...
async function startAbilityProcess(abilityContext, parameters) {
    ...
    abilityContext.startAbility({
        ...
        console.log('AppA main startAbilityProcess result: ' + JSON.stringify(error) + ", " + JSON.stringify(data))
    })
}
...
export default class MainAbility extends Ability {
    ...
    onCreate(want, launchParam) {
        ...
        console.log("LanguageConfigAppA onCreate")
    ...
    onDestroy() {
        ...
        console.log("LanguageConfigAppA onDestroy")
    }

    onWindowStageCreate(windowStage) {
        // Main window is created, set main page for this ability
        console.log("LanguageConfigAppA onWindowStageCreate")
    ...
    onWindowStageDestroy() {
        ...
        console.log("LanguageConfigAppA onWindowStageDestroy")
    }

    onForeground() {
        // Ability has brought to foreground
        console.log("LanguageConfigAppA onForeground")
    ...
    onBackground() {
        ...
        console.log("LanguageConfigAppA onBackground")
    }
