...
describe('AbilityDisableTests', function () {
    ...
    function subscriberCallBack_mainAbility1_Destory(err,data){
        ...
        console.log("subscriberCallBack_mainAbility1_Destory mainAbility1Lists:"+mainAbility1Lists);
    }
    function subscriberCallBack_mainAbility2_Destory(err,data){
        ...
        console.log("subscriberCallBack_mainAbility2_Destory lists:"+mainAbility2Lists);
    };
    function subscriberCallBack_mainAbility3_Destory(err,data){
        console.log("Subscribe3 CallBack data:" + JSON.stringify(data));
        mainAbility3Lists.push(data["event"]);
        console.log("subscriberCallBack_mainAbility3_Destory lists:"+mainAbility3Lists);
    };
    ...
    it('SUB_AA_OpenHarmony_MoveMissionToFront_2900', 0, async function (done) {
        ...
        commonEvent.createSubscriber(ability3LifeEvents).then(async (data)=>{
            ...
            await commonEvent.subscribe(Subscriber3,subscriberCallBack_mainAbility3_Destory)
        });
        setTimeout(()=>{
        ...
        setTimeout(()=>{
            console.log("subscriberCallBack_mainAbility1_Destory lists:"+ mainAbility1Lists);
