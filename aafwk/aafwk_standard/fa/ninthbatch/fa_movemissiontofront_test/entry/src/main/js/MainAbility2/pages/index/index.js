...
export default {
    ...
    onShow() {
        console.log("singletonEntryAbulity2_onShow")
    ...
    onHide(){
        console.log("singletonEntryAbulity2_onHide")
    ...
    onActive(){
        console.log("singletonEntryAbulity2_onActive")
    ...
    onInactive(){
        console.log("singletonEntryAbulity2_onInactive");
