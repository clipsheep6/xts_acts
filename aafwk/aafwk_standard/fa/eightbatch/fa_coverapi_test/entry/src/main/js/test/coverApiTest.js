...
describe('CoverApiTest', function () {
    ...
    it('SUB_AA_OpenHarmony_CoverApi_0400', 0, async function (done) {
        ...
        a.createOsAccount('101', 0, (err, data) => {
            console.info('SUB_AA_OpenHarmony_CoverApi_0400 createOsAccount Data: ' + JSON.stringify(data) + ' err: ' + JSON.stringify(err))
            console.info('SUB_AA_OpenHarmony_CoverApi_0400 createOsAccount localId: ' + JSON.stringify(data.localId));
        ...
        //        a.createOsAccount('101', 0)
        //            .then((data) => {
        //                console.info('SUB_AA_OpenHarmony_CoverApi_0400 createOsAccount successful. data: ' + JSON.stringify(data));
        //                accountId = data.localId;
        //                console.info('SUB_AA_OpenHarmony_CoverApi_0400 createOsAccount successful. accountId: ' + JSON.stringify(accountId));
        //                done();
        //            }).catch((error) => {
        //            console.error('SUB_AA_OpenHarmony_CoverApi_0400 createOsAccount failed. error: ' + JSON.stringify(error));
        //            expect().assertFalse();
        //            done();
        //        })
    })
    ...
    it('SUB_AA_OpenHarmony_CoverApi_0700', 0, async function (done) {
        ...
        //        appManager.clearUpApplicationData('com.example.coverapi', (error) => {
        //            console.log('SUB_AA_OpenHarmony_CoverApi_0700: ' + error);
            ...
            .then((data) => {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    if (data[i].ability.abilityName == 'com.example.coverapi.MainAbility') {
                        console.log("SUB_AA_OpenHarmony_CoverApi_0900 --- ability" + JSON.stringify(data[i].ability));
                        flag = true;
                        expect(data[i].pid > 0).assertTrue();
                        expect(data[i].uid > 0).assertTrue();
                        expect(data[i].processName).assertEquals("com.example.coverapi");
