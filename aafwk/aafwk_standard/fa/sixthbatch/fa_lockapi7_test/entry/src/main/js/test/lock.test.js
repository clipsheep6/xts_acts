    ...
    it("SUB_AA_OpenHarmony_Lock_1300", 0, async function (done) {
        ...
        setTimeout(() => {
            featureAbility.startAbility(
                ...
                console.log('`SUB_AA_OpenHarmony_Lock_1300` - startAbility3: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
            })
        }, 200)
        setTimeout(() => {
            featureAbility.startAbility(
                ...
                console.log('SUB_AA_OpenHarmony_Lock_1300 - startAbility_entry2-2: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
            })
        }, 300)
        setTimeout(() => {
            missionManager.getMissionInfos('', 200, (error, data) => {
                ...
                for (var i = 0; i < missionId2s.length; i ++){
                    missionManager.lockMission(missionId2s[i], (error, data) => {
                        console.log('lockMission_ability2:' + JSON.stringify(data) + 'error :' + JSON.stringify(error));
