...
function fns() {
    ...
    setTimeout(() => {
        console.log("SUB_AA_OpenHarmony_Clear_0600 lockMission1 missionIds[1]+++++123456::::" + missionIds
        + typeof missionIds)
    ...
    setTimeout(() => {
        missionManager.getMissionInfos("", 20, (err, data) => {
            ...
            console.log('SUB_AA_OpenHarmony_Clear_2400 data[i].want["abilityName"]2222' + data[i].want["abilityName"]
            + '::' + data[i]["missionId"]);
