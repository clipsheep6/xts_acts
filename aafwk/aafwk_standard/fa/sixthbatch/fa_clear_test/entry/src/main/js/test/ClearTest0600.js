    ...
    it("SUB_AA_OpenHarmony_Clear_0600", 0, async function (done) {
        ...
        setTimeout(() => {
            missionManager.getMissionInfos("", 10, (err, data) => {
                console.log('SUB_AA_OpenHarmony_Clear_0600 getMissionInfos errCode : ' + JSON.stringify(err) + " data: " + JSON.stringify(data));
                for (var i = 0;i < data.length; i++) {
                    if (data[i].want["abilityName"] == "com.example.abilitydisable.MainAbility" || data[i].want["abilityName"] == "com.example.abilitydisable.MainAbility3"
                    || data[i].want["abilityName"] == "com.example.abilitydisable.MainAbility2") {
                        console.log("SUB_AA_OpenHarmony_Clear_0600 data[i]['lockedState']::::" + data[i]['lockedState']);
        ...
        setTimeout(() => {
            console.log("SUB_AA_OpenHarmony_Clear_0600 lockMission1 missionIds[1]+++++123456::::" + MainAbility2missionId + typeof MainAbility2missionId)
            for (var i = 0;i < MainAbility2missionId.length; i++) {
                missionManager.lockMission(parseInt(MainAbility2missionId[i]), (err, data) => {
                    console.log('SUB_AA_OpenHarmony_Clear_0600 lockMission1 errCode : ' + JSON.stringify(err) + " data: " + JSON.stringify(data));
                });
            };
        }, 1200);
        setTimeout(() => {
            missionManager.getMissionInfos("", 10, (err, data) => {
                console.log('SUB_AA_OpenHarmony_Clear_0600 getMissionInfo33 errCode : ' + JSON.stringify(err) + " data: " + JSON.stringify(data));
                for (var i = 0;i < data.length; i++) {
                    ...
                    if (data[i].want["abilityName"] == "com.example.abilitydisable.MainAbility") {
                        console.log("SUB_AA_OpenHarmony_Clear_0600 data[i]['lockedState']2222223333::::" + data[i]['lockedState']);
                    }
                }
            });
        }, 1600)
        ...
        setTimeout(() => {
            missionManager.getMissionInfos("", 10, (err, data) => {
                console.log('SUB_AA_OpenHarmony_Clear_0600 getMissionInfos4455 errCode : ' + JSON.stringify(err) + " data: " + JSON.stringify(data));
                for (var i = 0;i < data.length; i++) {
                    console.log("SUB_AA_OpenHarmony_Clear_0600 bundleName22222233344444：" + data[i].want["abilityName"]);
                        console.log("SUB_AA_OpenHarmony_Clear_0600 data[i]['lockedState']222222::::" + data[i]['lockedState'] + data[i].want["abilityName"]);
                        if (data[i].want["abilityName"] == "com.example.abilitydisable.MainAbility3") {
                            console.log("SUB_AA_OpenHarmony_Clear_0600 data[i]['lockedState']33333::::" + data[i]['lockedState']);
