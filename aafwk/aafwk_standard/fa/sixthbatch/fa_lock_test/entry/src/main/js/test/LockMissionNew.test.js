...
describe('missionManager', function () {
    ...
    it("SUB_AA_OpenHarmony_Lock_0500", 0, async function (done) {
        ...
        featureAbility.startAbility(
            ...
            console.log('SUB_AA_OpenHarmony_Lock_0500 - startAbility1: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
            setTimeout(() => {
                featureAbility.startAbility(
                    { want: {
                        bundleName: "com.example.lock",
                    ...
                    console.log('SUB_AA_OpenHarmony_Lock_0500 - startAbility2: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
                    setTimeout(() => {
                        featureAbility.startAbility(
                            { want: {
                                bundleName: "com.example.lock",
                            ...
                            console.log('SUB_AA_OpenHarmony_Lock_0500 - startAbility3: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
                            setTimeout(() => {
                                featureAbility.startAbility(
                                    { want: {
                                        bundleName: "com.example.lock",
                                    ...
                                    console.log('SUB_AA_OpenHarmony_Lock_0500 - startAbility4: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
                                    setTimeout(() => {
    ...
    function clearMission(mymissionId1, mymissionId2, done) {
        console.log('===step4====SUB_AA_OpenHarmony_Lock_0500====clearMission====' + JSON.stringify(mymissionId1) + JSON.stringify(mymissionId2));
