...
describe("appManagerTest", function () {
    ...
    it("SUB_AA_OpenHarmony_StateListener_0500", 0, async function (done) {
        ...
        featureAbility.startAbility({
            ...
            console.log('==>SUB-05==>  error1  : ' + JSON.stringify(error) + " data11: " + JSON.stringify(data));
        ...
        appManager.unregisterApplicationStateObserver(vst, (error, data) => {
            console.log('==>error: ' + JSON.stringify(error) + " data111: " + JSON.stringify(data));
        ...
        setTimeout(() => {
            ...
            featureAbility.startAbility({ want }, (error, data) => {
                console.log('==startAbility=>  error1  : ' + JSON.stringify(error) + " ==data: " + JSON.stringify(data));
                setTimeout(() => {
