...
describe("appManagerTest", function () {
    ...
    it("SUB_AA_OpenHarmony_StateListener_1900", 0, async function (done) {
        ...
        featureAbility.startAbility({
            ...
            console.log('==startAbility2=> error1 :' + JSON.stringify(error) + " data: " + JSON.stringify(data));
            setTimeout(() => {
                ...
                featureAbility.startAbility({
                    ...
                    console.log('==startAbility3====> error1 :' + JSON.stringify(error) + " data: " + JSON.stringify(data));
                    setTimeout(() => {
                        ...
                        setTimeout(() => {
                            ...
                            featureAbility.startAbility({
                                ...
                                console.log('==3--2--startAbility2====> error1 :' + JSON.stringify(error) + " data: " + JSON.stringify(data));
                                setTimeout(() => {
