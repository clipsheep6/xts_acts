...
describe('ActsFeatureAbilityTest', function () {
    ...
    it('ACTS_StartAbilityForResult_0400', 0, async function (done) {
        ...
        var result = featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                console.log('featureAbilityTest ACTS_StartAbilityForResult_0400 first asyncCallback errCode : ' + error + " result: " + result)
                checkOnAbilityResult(result);
                done();
            },
            (error, result) => {
                expect(result).assertEqual(0);
                console.log('featureAbilityTest ACTS_StartAbilityForResult_0400 second asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
        );
    })
    ...
    it('ACTS_StartAbilityForResult_0500', 0, async function (done) {
        ...
        var result = featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                checkOnAbilityResult(result);
                console.log('featureAbilityTest ACTS_StartAbilityForResult_0500 asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
            (error, result) => {
                expect(result).assertEqual(0);
    ...
    it('ACTS_StartAbilityForResult_0600', 0, async function (done) {
        ...
        var result = featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                checkOnAbilityResult(result);
                console.log('featureAbilityTest ACTS_StartAbilityForResult_0600 asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
            (error, result) => {
                expect(result).assertEqual(0);
    ...
    it('ACTS_FinishWithResult_0100', 0, async function (done) {
        ...
        var promise = await featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                checkOnAbilityResult(result);
                console.log('featureAbilityTest ACTS_FinishWithResult_0100 asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
        );
        expect(promise).assertEqual(0);
    ...
    it('ACTS_FinishWithResult_0200', 0, async function (done) {
        ...
        var promise = await featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                checkOnAbilityResult(result);
                console.log('featureAbilityTest ACTS_FinishWithResult_0200 asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
        );
        expect(promise).assertEqual(0);
    ...
    it('ACTS_FinishWithResult_0300', 0, async function (done) {
        ...
        var promise = await featureAbility.startAbilityForResult(
            ...
            (error, result) => {
                checkOnAbilityResult(result);
                console.log('featureAbilityTest ACTS_FinishWithResult_0300 asyncCallback errCode : ' + error + " result: " + result)
                done();
            },
        );
        expect(promise).assertEqual(0);
