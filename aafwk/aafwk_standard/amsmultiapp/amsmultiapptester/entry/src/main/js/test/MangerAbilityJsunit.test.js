...
describe('MultiAppTester', function () {
    ...
    */
    it('AMS_MultiApp_2500', 0, async function (done) {
        console.log('AMS_MultiApp_2500====<begin');
        var subscriber;
        let id;
        let connId;
        let events = new Map();
    ...
    /*
    * @tc.number: AMS_MultiApp_2600
    * @tc.name: Connects a service ability, which is used to connect another cloned service ability.
    * @tc.desc: Check the event data of executor service ability publishes
    */
     it('AMS_MultiApp_2600', 0, async function (done) {
        console.log('AMS_MultiApp_2600====<begin');
        var subscriber;
        let id;
        let connId;
        let events = new Map();
    ...
    */
    it('AMS_MultiApp_2100', 0, async function (done) {
        console.log('AMS_MultiApp_2100====<begin');
        ...
        id = setTimeout(timeout, START_ABILITY_TIMEOUT);
        console.log('StartMultiAppTester AMS_MultiApp_2100 ConnectAbility id : ' + id);
        connId = await featureAbility.connectAbility(
            {
                bundleName: bundleName,
                abilityName: abilityName,
        ...
        console.log('StartMultiAppTester AMS_MultiApp_2100 ConnectAbility connId : ' + connId);
    })
})
