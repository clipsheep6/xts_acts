...
describe('ActsDataAbilityHelperTest', function () {
    ...
    */
    it('AMS_MultiApp_0600', 0, async function (done) {
        ...
        console.debug("=AMS_MultiApp_0600 dataAbilityUri====>" + dataAbilityUri)
        var cloneFlag = 0;
        var selfFlag = 0;
        ...
        console.log('AMS_MultiApp_0600====cloneFlag' + cloneFlag);
        console.log('AMS_MultiApp_0600====selfFlag' + selfFlag);
