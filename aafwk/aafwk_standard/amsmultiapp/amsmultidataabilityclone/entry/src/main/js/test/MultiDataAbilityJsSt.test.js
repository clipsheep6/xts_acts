...
describe('ActsDataAbilityHelperTest', function () {
    ...
    /*
    * @tc.number: AMS_MultiApp_1200
    * @tc.name: Page ability start cloned data ability
    * @tc.desc: Check if cloned data ability process exists
    */
    it('AMS_MultiApp_1200', 0, async function (done) {
        console.log('AMS_MultiApp_1200====<begin');
        console.debug("=AMS_MultiApp_1200 dataAbilityUri====>" + dataAbilityUri)
        var cloneFlag = 0;
        var selfFlag = 0;
        ...
        console.log('AMS_MultiApp_1200====cloneFlag' + cloneFlag);
        console.log('AMS_MultiApp_1200====selfFlag' + selfFlag);
