...
describe('getAllFormsInfoTest', function () {
     ...
     * @tc.desc All form configuration information is queried successfully.
     */
     ...
     * @tc.desc When the bundleName is null, the form configuration information query of the specified package fails.
     */
     ...
     * @tc.desc When the bundleName isn't exist, the form configuration information query of the specified package fails.
     */
     ...
     * @tc.desc When the bundleName exist, the form configuration information query of the specified package is queried successfully.
     */
     ...
     * @tc.desc When the bundleName is null,moduleName is exist，the form configuration information query of the specified module fails.
     */
     ...
     * @tc.desc When the bundleName isn't exist, moduleName is exist,the form configuration information query of the specified module fails.
     */
     ...
     * @tc.desc When the bundleName is exist,moduleName is null,the form configuration information query of the specified module fails.
     */
     ...
     * @tc.desc When the bundleName is exist,moduleName is exist,the form configuration information query of the specified module
