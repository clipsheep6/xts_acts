    ...
    for (var i = 0; i < REPEAT_COUNT; i++) {
        ...
        it('FMS_fuzzTestNum_0200_callback', 0, async function (done) {
            ...
            formManager.deleteForm(
                    formId,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0200_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0200_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0200_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_0200_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_01_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_01_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_01_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_01_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_0300_param_01_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_02_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_02_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_02_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_02_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_02_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_03_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_03_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_03_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_03_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_03_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_04_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_04_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_04_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_04_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_04_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_05_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_05_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_05_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_05_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_05_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_06_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_06_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_06_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_06_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_06_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_07_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_07_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_07_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_07_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_07_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_08_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    ...
                    isReleaseCache,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_08_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_08_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_08_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.releaseForm(formId, isReleaseCache));
                console.log("FMS_fuzzTestNum_0300_param_08_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_0300_param_09_callback', 0, async function (done) {
            ...
            try{
                formManager.releaseForm(
                    formId,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_0300_param_09_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_0300_param_09_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_0300_param_09_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_0300_param_09_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1200_callback', 0, async function (done) {
            ...
            try{
                formManager.getAllFormsInfo(
                    testParam,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1200_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1200_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1200_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_1200_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1300_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    bundleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1300_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1300_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1300_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_1300_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_01_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_01_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_01_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_01_promise', 0, async function (done) {
            ...
            try{
                ...
                console.log("FMS_fuzzTestNum_1400_param_01_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_02_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_02_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_02_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_02_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_02_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_03_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_03_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_03_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_03_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_03_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_04_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_04_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_04_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_04_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_04_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_05_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_05_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_05_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_05_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_05_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_06_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_06_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_06_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_06_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_06_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_07_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_07_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_07_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_07_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_07_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
        ...
        it('FMS_fuzzTestNum_1400_param_08_callback', 0, async function (done) {
            ...
            try{
                formManager.getFormsInfo(
                    ...
                    moduleName,
                    (err,data) => {
                        console.log("FMS_fuzzTestNum_1400_param_08_callback async::callbak return!!!")
                        console.log("FMS_fuzzTestNum_1400_param_08_callback async::sucess data:" + data);
        ...
        it('FMS_fuzzTestNum_1400_param_08_promise', 0, async function (done) {
            ...
            try{
                retResult = await Promise.all(await formManager.getFormsInfo(bundleName, moduleName));
                console.log("FMS_fuzzTestNum_1400_param_08_promise async::sucess retResult:" + retResult);
                fail("should not reach here");
                done();
            } catch (e) {
