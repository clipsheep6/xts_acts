...
describe('imageAnimatorPropsJsTest', function () {
    ...
    */
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testimageAnimatorStyleProp
     * @tc.desc      ACEs
     */
    //    it('testimageAnimatorStyleProp', 0, async function (done) {
    //        console.info('testimageAnimatorStyleProp START');
    //        console.info("[imageAnimatorProps] get globalThis.value is: " + JSON.stringify(globalThis.value));
    //
    ...
    //        console.info("[imageAnimatorProps] get style value is: " + JSON.stringify(obj.$attrs.style));
    //
    //        expect(obj.$styles.width).assertEqual(undefined);
    //        console.info("[imageAnimatorProps] get style width value is: " + JSON.stringify(obj.$styles.width));
    //        expect(obj.$styles.height).assertEqual(undefined);
    //        console.info("[imageAnimatorProps] get style height value is: " + JSON.stringify(obj.$styles.height));
    //        expect(obj.$styles.get('background-color')).assertEqual(undefined);
    //        console.info("[imageAnimatorProps] get style background-color value is: " + JSON.stringify(obj.$styles.get('background-color')));
    //        done();
    //    });
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testimageAnimatorIfPropFalse
     * @tc.desc      ACE
     */
    //    it('testimageAnimatorIfPropFalse', 0, async function (done) {
    //        console.info('testimageAnimatorIfPropFalse START');
    //        console.info("[imageAnimatorProps] get globalThis.value is: " + JSON.stringify(globalThis.value));
    //
    ...
    /**
     * @tc.number    SUB_ACE_BASIC_COMPONENT_JS_API_0100
     * @tc.name      testimageAnimatorIfPropNone
     * @tc.desc      ACE
     */
    //    it('testimageAnimatorIfPropNone', 0, async function (done) {
    //        console.info('testimageAnimatorIfPropNone START');
    //        console.info("[imageAnimatorProps] get globalThis.value is: " + JSON.stringify(globalThis.value));
    //
