...
describe('ActsAccountSetGetExtraInfo', function () {
    ...
    it('ActsAccountSetGetExtraInfo_0100', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0100====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0200', 0, async function (done) {
        ...
        appAccountManager.getAccountExtraInfo(notExistBundle, (err, data)=>{
            console.debug("====>getAccountExtraInfo 0200 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            console.debug("====>ActsAccountSetGetExtraInfo_0200 end====>");
            done();
        });
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0200====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0300', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_third", "account_extrainfo_callback_third", (err)=>{
            console.debug("====>add account ActsAccountSetGetExtraInfo_0300 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.deleteAccount("account_name_callback_third", (err)=>{
                ...
                appAccountManager.getAccountExtraInfo("account_name_callback_third", (err, data)=>{
                    ...
                    console.debug("====>getAccountExtraInfo 0300 data:" + JSON.stringify(data));
                    expect(err.code != 0).assertEqual(true);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0300====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0400', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_fourth", (err)=>{
            console.debug("====>add account ActsAccountSetGetExtraInfo_0400 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.getAccountExtraInfo("account_name_callback_fourth", (err, data)=>{
                ...
                console.debug("====>getAccountExtraInfo 0400 data:" + JSON.stringify(data));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0400====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0500', 0, async function (done) {
        ...
        appAccountManager.setAccountExtraInfo(notExtraAccount, "account_extrainfo_fifth", (err)=>{
            console.debug("====>setAccountExtraInfo 0500 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            console.debug("====>ActsAccountSetGetExtraInfo_0500 end====>");
            done();
        });
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0500====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0600', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_sixth", "account_extrainfo_callback_sixth",(err)=>{
            console.debug("====>add account ActsAccountSetGetExtraInfo_0600 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.setAccountExtraInfo("account_name_callback_sixth", "account_extra_sixth_twice", (err)=>{
                console.debug("====>setAccountExtraInfo 0600 err:" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
                appAccountManager.getAccountExtraInfo("account_name_callback_sixth", (err, data)=>{
                    ...
                    console.debug("====>getAccountExtraInfo 0600 data:" + JSON.stringify(data));
                    expect(err.code).assertEqual(0);
                    expect(data).assertEqual("account_extra_sixth_twice");
                    appAccountManager.deleteAccount("account_name_callback_sixth", (err)=>{
                        console.debug("====>delete Account 0600 err:" + JSON.stringify(err));
                        expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0600====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0700', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_seventh",(err)=>{
            ...
            appAccountManager.setAccountExtraInfo("account_name_callback_seventh", "callback_seventh", (err)=>{
                console.debug("====>setAccountExtraInfo 0700 first time err:" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
                appAccountManager.setAccountExtraInfo("account_name_callback_seventh", "call_seventh_twice", (err)=>{
                    console.debug("====>setAccountExtraInfo 0700 second time err:" + JSON.stringify(err));
                    expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0700====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0800', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_eighth",(err)=>{
            console.debug("====>add account ActsAccountSetGetExtraInfo_0800 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.setAccountExtraInfo("account_name_callback_eighth", "extra_callback_eighth", (err)=>{
                ...
                expect(err.code).assertEqual(0);
                appAccountManager.setAccountExtraInfo("account_name_callback_eighth", "extra_callback_eighth", (err)=>{
                    console.debug("====>setAccountExtraInfo 0800 first time err:" + JSON.stringify(err));
                    expect(err.code).assertEqual(0);
                    appAccountManager.getAccountExtraInfo("account_name_callback_eighth", (err, data)=>{
                        console.debug("====>getAccountExtraInfo 0800 err:" + JSON.stringify(err));
                        ...
                        appAccountManager.deleteAccount("account_name_callback_eighth", (err)=>{
                            console.debug("====>delete Account 0800 err:" + JSON.stringify(err));
                        });
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountSetGetExtraInfo_0800====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountSetGetExtraInfo_0900', 0, async function (done) {
        ...
        console.debug("====>creat finish====>");
        console.debug("====>add account ActsAccountSetGetExtraInfo_0900====>");
        try{
            await appAccountManager.addAccount("account_name_promise_first", extraInfoStr);
        }
        catch(err){
            console.debug("====>add account ActsAccountSetGetExtraInfo_0900 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        try{
            ...
            console.error("====>getAccountExtraInfo 0900 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        console.debug("====>getAccountExtraInfo 0900 data:" + JSON.stringify(data));
        expect(data).assertEqual(extraInfoStr);
        console.debug("====>delete account ActsAccountSetGetExtraInfo_0900 start====>");
        try{
            ...
            console.debug("====>delete Account 0900 fail err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
    });
    ...
    it('ActsAccountSetGetExtraInfo_1000', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>getAccountExtraInfo 1000 fail====>");
            expect().assertFail();
            done();
        }
        catch(err){
            console.debug("====>getAccountExtraInfo 1000 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
    ...
    it('ActsAccountSetGetExtraInfo_1100', 0, async function (done) {
        ...
        var appAccountManager = account.createAppAccountManager();
        console.debug("====>creat finish====>");
        console.debug("====>add account ActsAccountSetGetExtraInfo_1100 start====>");
        await appAccountManager.addAccount("account_name_promise_third", "account_extrainfo_promise_third");
        console.debug("====>delete account ActsAccountSetGetExtraInfo_1100 start====>");
        ...
        try{
            ...
            console.error("====>getAccountExtraInfo 1100 fail====>");
            expect().assertFail();
            done();
        }
        catch(err){
    ...
    it('ActsAccountSetGetExtraInfo_1200', 0, async function (done) {
        ...
        console.debug("====>getAccountExtraInfo ActsAccountSetGetExtraInfo_1200 start====>");
        try{
    ...
    it('ActsAccountSetGetExtraInfo_1300', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>setAccountExtraInfo fail ActsAccountSetGetExtraInfo_1300");
            expect().assertFail();
            done();
        }
        catch(err){
            console.debug("====>setAccountExtraInfo 1300 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
    ...
    it('ActsAccountSetGetExtraInfo_1400', 0, async function (done) {
        ...
        var appAccountManager = account.createAppAccountManager();
        console.debug("====>creat finish====>");
        console.debug("====>add account ActsAccountSetGetExtraInfo_1400====>");
        try{
            await appAccountManager.addAccount("account_name_promise_sixth", "account_extra_promise_sixth");
        }
        catch(err){
            console.error("====>add account ActsAccountSetGetExtraInfo_1400 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        console.debug("====>setAccountExtraInfo ActsAccountSetGetExtraInfo_1400 start");
    ...
    it('ActsAccountSetGetExtraInfo_1500', 0, async function (done) {
        ...
        var appAccountManager = account.createAppAccountManager();
        console.debug("====>creat finish====>");
        console.debug("====>add account start ActsAccountSetGetExtraInfo_1500====>");
        try{
            await appAccountManager.addAccount("extrapromise_seventh");
        }
        catch(err){
            console.error("====>add account ActsAccountSetGetExtraInfo_1500 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        console.debug("====>setAccountExtraInfo first time ActsAccountSetGetExtraInfo_1500====>");
        ...
        try{
            ...
            console.error("====>getAccountExtraInfo first time 1500 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        console.debug("====>getAccountExtraInfo 1500 first time data:" + JSON.stringify(data));
        expect(data).assertEqual("extra_promise_seventh");
        console.debug("====>setAccountExtraInfo second time ActsAccountSetGetExtraInfo_1500====>");
        await appAccountManager.setAccountExtraInfo("extrapromise_seventh", "extra_promise_seventh_twice");
        try{
            var data = await appAccountManager.getAccountExtraInfo("extrapromise_seventh");
        }
        catch(err){
            console.error("====>getAccountExtraInfo 1500 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        console.debug("====>getAccountExtraInfo 1500 data:" + JSON.stringify(data));
        expect(data).assertEqual("extra_promise_seventh_twice");
        console.debug("====>delete account ActsAccountSetGetExtraInfo_1500 start====>");
        try{
            await appAccountManager.deleteAccount("extrapromise_seventh");
        }
        catch(err){
            console.error("====>delete Account 1500 fail err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
    ...
    it('ActsAccountSetGetExtraInfo_1600', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>add account ActsAccountSetGetExtraInfo_1600 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
