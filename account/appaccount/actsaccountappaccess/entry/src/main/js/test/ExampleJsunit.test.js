...
describe('ActsAccountAppAccess', function () {
    ...
    it('ActsAccountAppAccess_0100', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_0100====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_0300', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_0300====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_0400', 0, async function (done) {
        ...
        try{
            ...
            expect(err.code != 0).assertEqual(0);
    ...
    it('ActsAccountAppAccess_0500', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_0500====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_0700', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_0700====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_0900', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_0900====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_1100', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_1100====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_1300', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_1300====>");
        }, TIMEOUT);
    });
     ...
     * @tc.desc      : Unauthorize account that is not authorized to other accounts
     */
    it('ActsAccountAppAccess_1500', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAppAccess_1500====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAppAccess_1600', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>disableAppAccess ActsAccountAppAccess_1600 fail err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
