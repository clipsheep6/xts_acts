...
describe('ActsAccountAddAccount', function () {
    ...
    it('ActsAccountAddAccount_0100', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0100====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0200', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_second", "account_extraInfo_callback_second", (err)=>{
            console.debug("====>add account ActsAccountAddAccount_0200 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.deleteAccount("account_name_callback_second", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_0200 err:" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0200====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0300', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_third", "account_extraInfo_callback_third", (err)=>{
            console.debug("====>add account first time ActsAccountAddAccount_0300 err:" + JSON.stringify(err));
            expect(err.code).assertEqual(0);
            appAccountManager.addAccount("account_name_callback_third", "account_extraInfo_callback_third", (err)=>{
                console.debug("====>add account second time ActsAccountAddAccount_0300 err:" + JSON.stringify(err));
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0300====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0400', 0, async function (done) {
        ...
        appAccountManager.addAccount(bigAccountName, "account_extraInfo_callback_fourth", (err)=>{
            console.debug("====>add account ActsAccountAddAccount_0400 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            console.debug("====>ActsAccountAddAccount_0400 end====>");
            done();
        });
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0400====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0500', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_fifth", bigExtraInfo, (err)=>{
            console.debug("====>add account ActsAccountAddAccount_0500 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            console.debug("====>ActsAccountAddAccount_0500 end====>");
            done();
        });
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0500====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0600', 0, async function (done) {
        ...
        appAccountManager.addAccount("", "account_name_callback_sixth", (err)=>{
            console.debug("====>add account ActsAccountAddAccount_0600 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            console.debug("====>ActsAccountAddAccount_0600 end====>");
            done();
        });
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0600====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0700', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_seventh", "", (err)=>{
            ...
            appAccountManager.deleteAccount("account_name_callback_seventh", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_0700 err:" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0700====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0800', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0800====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_0900', 0, async function (done) {
        ...
        appAccountManager.addAccount(specialStr, "account_extraInfo_callback_ninth", (err)=>{
            ...
            appAccountManager.deleteAccount(specialStr, (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_0900 err" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_0900====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_1000', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_name_callback_tenth", specialStr, (err)=>{
            ...
            appAccountManager.deleteAccount("account_name_callback_tenth", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_1000 err" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_1000====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_1100', 0, async function (done) {
        ...
        appAccountManager.addAccount("account_extraInfo_callback_eleventh", specialStr, (err)=>{
            ...
            appAccountManager.deleteAccount("account_extraInfo_callback_eleventh", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_1100 err" + JSON.stringify(err));
                expect(err.code).assertEqual(0);
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_1100====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_1200', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>delete account fail, err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
    });
    ...
    it('ActsAccountAddAccount_1400', 0, async function (done) {
        ...
        var appAccountManager = account.createAppAccountManager();
        console.debug("====>add account for the first time ActsAccountAddAccount_1400====>");
        await appAccountManager.addAccount("account_name_promise_third", "account_extraInfo_promise_third");
        console.error("====>add account for the second time ActsAccountAddAccount_1400 start====>");
        try{
            await appAccountManager.addAccount("account_name_promise_third", "account_extraInfo_promise_third");
        }
        catch(err){
            console.debug("====>add account for the second time ActsAccountAddAccount_1400 err:" + JSON.stringify(err));
            expect(err.code != 0).assertEqual(true);
            appAccountManager.deleteAccount("account_name_promise_third", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_1400 err:" + JSON.stringify(err));
            });
            console.debug("====>ActsAccountAddAccount_1400 end====>");
            done();
        }
    });
    ...
    it('ActsAccountAddAccount_1700', 0, async function (done) {
        ...
        console.debug("====>ActsAccountAddAccount_1700 add account start====>");
        var appAccountManager = account.createAppAccountManager();
        try{
    ...
    it('ActsAccountAddAccount_1800', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>delete account ActsAccountAddAccount_1800 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
    });
    ...
    it('ActsAccountAddAccount_2000', 0, async function (done) {
        ...
        try{
            ...
            console.error("====>delete Account ActsAccountAddAccount_2000 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
    });
    ...
    it('ActsAccountAddAccount_2100', 0, async function (done) {
        ...
        var appAccountManager = account.createAppAccountManager();
        var specialStr = " ";
        console.debug("====>add account ActsAccountAddAccount_2100====>");
        try{
            await appAccountManager.addAccount("account_name_promise_tenth", specialStr);
        }
        catch(err){
            console.error("====>add Account ActsAccountAddAccount_2100 err:" + JSON.stringify(err));
            expect().assertFail();
            done();
        }
        try{
    ...
    it('ActsAccountAddAccount_2300', 0, async function (done) {
        ...
        setTimeout(function(){
            console.debug("====>time out ActsAccountAddAccount_2300====>");
        }, TIMEOUT);
    });
    ...
    it('ActsAccountAddAccount_2400', 0, async function (done) {
        ...
        try{
            ...
            expect(err.code != 0).assertEqual(true);
            appAccountManager.deleteAccount("account_name_promise_third", (err)=>{
                console.debug("====>delete Account ActsAccountAddAccount_2400 err:" + JSON.stringify(err));
            });
