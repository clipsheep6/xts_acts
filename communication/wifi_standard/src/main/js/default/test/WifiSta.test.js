...
function sleep(delay) {
    ...
    for (var start = (new Date()).getTime();
...
describe('ACTS_WifiTest', function() {
    ...
    it('SUB_Communication_WiFi_Sta_Config_0001', 0, async function(done) {
        ...
        await wifi.addDeviceConfig(wifiDeviceConfig1)
            .then(netWorkId => {
                console.info("[wifi_test] wifi add OPEN SecurityType Deviceconfig promise : " + JSON.stringify(netWorkId));
        ...
        wifi.addDeviceConfig(wifiDeviceConfig1,
            (netWorkId) => {
                console.info("[wifi_test] wifi add OPEN SecurityType Deviceconfig callback : " + JSON.stringify(netWorkId));
                expect(true).assertEqual(netWorkId != -1);
                console.info("[wifi_test] check add device configs successfully ");
                var configs = wifi.getDeviceConfigs();
    ...
    it('SUB_Communication_WiFi_Sta_Config_0002', 0, async function(done) {
        ...
        await wifi.addDeviceConfig(wifiDeviceConfig1)
            .then(netWorkId => {
                console.info("[wifi_test] wifi add PSK SecurityType Deviceconfig promise : " + JSON.stringify(netWorkId));
                expect(true).assertEqual(netWorkId != -1);
                console.info("[wifi_test] check add device configs successfully ");
                var configs = wifi.getDeviceConfigs();
                console.info("[wifi_test] wifi getDeviceConfigs result1 : " + JSON.stringify(configs));
    ...
    //  * @tc.desc       Test create a SAE SecurityType wifi device config
    //  */
    ...
    //     console.info("[wifi_test] create a SAE SecurityType wifi device config start.");
    //     var wifiDeviceConfig1 = {
    //         "ssid": "TEST_SAE",
    //         "bssid": "",
    //         "preSharedKey": "12345678",
    ...
    //     await wifi.addDeviceConfig(wifiDeviceConfig1)
    //         .then(netWorkId => {
    //             console.info("[wifi_test] wifi add SAE SecurityType Deviceconfig promise : " + JSON.stringify(netWorkId));
    //             expect(true).assertEqual(netWorkId != -1);
    //             console.info("[wifi_test] check add device configs successfully ");
    //             var configs = wifi.getDeviceConfigs();
    //             console.info("[wifi_test] wifi getDeviceConfigs result1 : " + JSON.stringify(configs));
    ...
    //  * @tc.desc       Test create a WEP valid wifi device config
    //  */
    ...
    //     console.info("[wifi_test] create a WEP SecurityType wifi device config start.");
    //     var wifiDeviceConfig1 = {
    //         "ssid": "TEST_WEP",
    //         "bssid": "",
    ...
    //     await wifi.addDeviceConfig(wifiDeviceConfig1)
    //         .then(netWorkId => {
    //             console.info("[wifi_test] wifi add WEP SecurityType Deviceconfig promise : " + JSON.stringify(netWorkId));
    //             expect(true).assertEqual(netWorkId != -1);
    //             console.info("[wifi_test] check add device configs successfully ");
    //             var configs = wifi.getDeviceConfigs();
    //             console.info("[wifi_test] wifi getDeviceConfigs result1 : " + JSON.stringify(configs));
