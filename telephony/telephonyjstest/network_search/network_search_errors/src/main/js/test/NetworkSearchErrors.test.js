    ...
    describe('ActsNetworkSearchTest', function () {
        ...
        it('Telephony_NetworkSearch_isRadioOn_Async_0200', 0, async function (done) {
            radio.isRadioOn((err, data) => {
                if (err) {
                    console.info('Telephony_NetworkSearch_isRadioOn_Async_0200 ' + JSON.stringify(err));
                    expect(err.code == 1).assertTrue();
                    done();
                    return;
                } else {
                    console.info('Telephony_NetworkSearch_isRadioOn_Async_0200  fail');
                    expect().assertFail();
                    done();
                    return;
                }
        ...
        it('Telephony_NetworkSearch_isRadioOn_Promise_0200', 0, async function (done) {
            try {
                ...
                console.info('Telephony_NetworkSearch_isRadioOn_Promise_0200 fail');
                expect().assertFail();
                done();
                return;
            } catch (err) {
                console.info('Telephony_NetworkSearch_isRadioOn_Promise_0200 finish ' + JSON.stringify(err));
                expect(err.code == 1).assertTrue();
                done();
                return;
            }
         ...
         */
        it('Telephony_NetworkSearch_isRadioOn_Asyc_0300', 0, async function (done) {
            radio.isRadioOn(0, (err, data) => {
                if (err) {
                    console.info('Telephony_NetworkSearch_isRadioOn_Asyc_0300 finish: ' + JSON.stringify(err));
                    expect(err.code == 1).assertTrue();
                    done();
                    return;
                } else {
                    console.info(' Telephony_NetworkSearch_isRadioOn_Asyc_0300 fail');
                    expect().assertFail();
                    done();
                    return;
                }
        ...
        it('Telephony_NetworkSearch_isRadioOn_Promise_0300', 0, async function (done) {
            try {
                ...
                console.info('Telephony_NetworkSearch_isRadioOn_Promise_0300 fail');
                expect().assertFail();
                done();
                return;
            } catch (err) {
                console.info('Telephony_NetworkSearch_isRadioOn_Promise_0300 finish' + JSON.stringify(err));
                expect(err.code == 1).assertTrue();
                done();
                return;
            }
        ...
        it('Telephony_StateRegistry_on_0200', 0, async function (done) {
            try {
                observer.on('networkStateChange', {
                    ...
                    console.info(`Telephony_StateRegistry_on_0200 data: ${JSON.stringify(networkState)}`);
                });
                done();
            } catch (error) {
                expect().assertFail();
