...
describe('NetworkSearchTest', function () {
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0200', 0, async function (done) {
        radio.getNetworkState(SLOT_0, (err, data) => {
            ...
            expect(data.isCaActive === false).assertTrue();
            expect(data.isEmergency === false).assertTrue();
            console.log('Telephony_NetworkSearch_getNetworkState_Async_0200 finish');
            done();
        });
    });
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Async_0400', 0, async function (done) {
        ...
        radio.getSignalInformation(slotId, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getSignalInformation_Async_0400 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getSignalInformation_Async_0400 finish');
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Promise_0400', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0400 finish');
            expect(data === undefined || data.length === 0).assertTrue();
        } catch (err) {
            console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0400 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400', 0, async function (done) {
        ...
        radio.getISOCountryCodeForNetwork(slotId, (err, data) => {
            if (err) {
                console.log(
                    'Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400 fail err: ' + err.message
                );
                expect().assertFail();
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400 finish');
            expect(data === undefined || data.length === 0).assertTrue();
            done();
        });
    });
