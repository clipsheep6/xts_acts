...
describe('NetworkSearchTest', function () {
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0400', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_getNetworkState_Async_0400 finish")
            ...
            radio.getNetworkState((err, data) => {
                ...
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkState_Async_0400 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0600', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_getNetworkState_Async_0600 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.getNetworkState(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkState_Async_0600 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getRadioTech_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_getRadioTech_Async_0300 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.getRadioTech(SLOT_0, (err, { psRadioTech, csRadioTech }) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getRadioTech_Async_0300 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_getSignalInformation_Async_0300 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.getSignalInformation(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getSignalInformation_Async_0300 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkState_Promise_0400')
                expect().assertFail()
                done()
                return
            }
        ...
        console.log('Telephony_NetworkSearch_getNetworkState_Promise_0400 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0600', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkState_Promise_0600 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_getNetworkState_Promise_0600 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_getRadioTech_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getRadioTech_Promise_0300 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_getRadioTech_Promise_0300 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0300 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0300 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_getNetworkSelectionMode_Async_0400', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_getNetworkSelectionMode_Async_0400 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.getNetworkSelectionMode(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkSelectionMode_Async_0400 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getNetworkSelectionMode_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkSelectionMode_Promise_0400 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_getNetworkSelectionMode_Promise_0400 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_1000', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_setNetworkSelectionMode_Async_1000 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.setNetworkSelectionMode(networkSMode, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_1000 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Promise_1000', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Promise_1000 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Promise_1000 finish')
        done()
    })
    /**
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                console.log("Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300 exec done useTime:" + totalTime)
                console.log("Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
            ...
            radio.getISOCountryCodeForNetwork(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0300 fail')
                expect().assertFail()
                done()
                return
            }
        ...
        const endTime = (new Date).getTime()
        expect(endTime - startTime).assertLess(MSEC_5)
        console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0300 finish')
        done()
    })
    ...
    it('Telephony_NetworkSearch_turnOnRadio_Async_0400', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                console.log("Telephony_NetworkSearch_turnOnRadio_Async_0400 finish")
                expect(totalTime).assertLess(timesValue.TIME_SPAN)
                done()
                return
            }
    ...
    it('Telephony_NetworkSearch_turnOnRadio_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_turnOnRadio_Promise_0400 fail')
                expect().assertFail()
                done()
                return
            }
    ...
    it('Telephony_NetworkSearch_turnOffRadio_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_turnOffRadio_Promise_0400 fail')
                expect().assertFail()
                done()
                return
            }
    ...
    it('Telephony_NetworkSearch_isRadioOn_Async_0400', 0, async function (done) {
        function Recursive(n) {
            ...
            radio.isRadioOn(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_isRadioOn_Async_0400 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_isRadioOn_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_isRadioOn_Promise_0400 fail')
                expect().assertFail()
                done()
                return
            }
    ...
    */
    it('Telephony_NetworkSearch_getNetworkSearchInformation_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                console.log("Telephony_NetworkSearch_getNetworkSearchInformation_Async_0300 exec done useTime:" + totalTime)
            ...
            radio.getNetworkSearchInformation(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkSearchInformation_Async_0300 fail')
                    expect().assertFail()
                    done()
                    return
                }
    ...
    it('Telephony_NetworkSearch_getNetworkSearchInformation_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkSearchInformation_Promise_0300 fail')
                expect().assertFail()
                done()
                return
            }
