    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0400', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getNetworkState((err, data) => {
                ...
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkState_Async_0400 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0600', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getNetworkState(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkState_Async_0600 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_getRadioTech_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getRadioTech(SLOT_0, (err, { psRadioTech, csRadioTech }) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_NetworkSearch_getRadioTech_Async_0300 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getSignalInformation(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_NetworkSearch_getSignalInformation_Async_0300 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0600', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkState_Promise_0600 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getRadioTech_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getRadioTech_Promise_0300 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0300 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getNetworkSelectionMode_Async_0400', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getNetworkSelectionMode(SLOT_0, (err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_NetworkSearch_getNetworkSelectionMode_Async_0400 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_getNetworkSelectionMode_Promise_0400', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_getNetworkSelectionMode_Promise_0400 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_1000', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.setNetworkSelectionMode(networkSMode, (err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_1000 fail err: ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Promise_1000', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Promise_1000 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            radio.getISOCountryCodeForNetwork(SLOT_0, (err, data) => {
                ...
                if (err) {
                    console.log(
                        'Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0300 fail err: ' + err.message
                    );
                    expect().assertFail();
                    done();
                    return;
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log(
                    'Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0300 fail err: ' + err.message
                );
                expect().assertFail();
                done();
                return;
