...
describe('NetworkSearchTest', function () {
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0100', 0, async function (done) {
        ...
        await new Promise((resolve, reject) => {
            radio.setNetworkSelectionMode(networkSMode, (err) => {
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0100 finish');
                    resolve();
                }
                reject();
            })
        }).catch(() => {
            console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0100 fail');
            expect().assertFail();
            done();
            return;
        })
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0200', 0, async function (done) {
        ...
        await new Promise((resolve, reject) => {
            radio.setNetworkSelectionMode(networkSMode, (err) => {
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0200 finish');
                    resolve();
                }
                reject();
            })
        }).catch(() => {
            console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0200 fail');
            expect().assertFail();
            done();
            return;
        })
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0300', 0, async function (done) {
        ...
        await new Promise((resolve, reject) => {
            radio.setNetworkSelectionMode(networkSMode, (err) => {
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0300 finish');
                    resolve();
                }
                reject();
            })
        }).catch(() => {
            console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0300 fail');
            expect().assertFail();
            done();
            return;
        })
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0400', 0, async function (done) {
        ...
        await new Promise((resolve, reject) => {
            radio.setNetworkSelectionMode(networkSMode, (err) => {
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0400 finish');
                    resolve();
                }
                reject();
            })
        }).catch(() => {
            console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0400 fail');
            expect().assertFail();
            done();
            return;
        })
    ...
    it('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0700', 0, async function (done) {
        ...
        await new Promise((resolve, reject) => {
            radio.setNetworkSelectionMode(networkSMode, (err) => {
                if (err) {
                    console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0700 finish');
                    resolve();
                }
                reject();
            })
        }).catch(() => {
            console.log('Telephony_NetworkSearch_setNetworkSelectionMode_Async_0700 fail');
            expect().assertFail();
            done();
            return;
        })
