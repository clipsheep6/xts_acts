...
describe('NetworkSearchTest', function () {
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0100', 0, async function (done) {
        radio.getNetworkState((err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getNetworkState_Async_0100 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0200', 0, async function (done) {
        radio.getNetworkState(SLOT_0, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getNetworkState_Async_0200 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Async_0700', 0, async function (done) {
        ...
        radio.getNetworkState(slotId, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getNetworkState_Async_0700 finish err: ' + err.message);
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getNetworkState_Async_0700 fail');
            expect().assertFail();
            done();
        })
    })
    ...
    it('Telephony_NetworkSearch_getRadioTech_Async_0100', 0, async function (done) {
        radio.getRadioTech(SLOT_0, (err, { psRadioTech, csRadioTech }) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getRadioTech_Async_0100 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getRadioTech_Async_0400', 0, async function (done) {
        let slotId = 7;
        radio.getRadioTech(slotId, (err, { psRadioTech, csRadioTech }) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getRadioTech_Async_0400 finish err: ' + err.message);
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getRadioTech_Async_0400 fail');
            expect().assertFail();
            done();
        })
    })
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Async_0100', 0, async function (done) {
        radio.getSignalInformation(SLOT_0, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getSignalInformation_Async_0100 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Async_0400', 0, async function (done) {
        ...
        radio.getSignalInformation(slotId, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getSignalInformation_Async_0400 finish err: ' + err.message);
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getSignalInformation_Async_0400 fail');
            expect().assertFail();
            done();
        })
    })
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0100', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getNetworkState_Promise_0100 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0200', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getNetworkState_Promise_0200 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_getNetworkState_Promise_0700', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getNetworkState_Promise_0700 fail');
            expect().assertFail();
        } catch (err) {
            console.log('Telephony_NetworkSearch_getNetworkState_Promise_0700 finish err: ' + err.message);
            done();
            return;
        }
        done();
    ...
    it('Telephony_NetworkSearch_getRadioTech_Promise_0100', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getRadioTech_Promise_0100 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_getRadioTech_Promise_0400', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getRadioTech_Promise_0400 fail');
            expect().assertFail();
        } catch (err) {
            console.log('Telephony_NetworkSearch_getRadioTech_Promise_0400 finish err: ' + err.message);
            done();
            return;
        }
        done();
    ...
    it('Telephony_NetworkSearch_getSignalInformation_Promise_0100', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0100 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
     ...
     * @tc.name    SlotId parameter input is 8, test getSignalInformation() query function go to the error
     * @tc.desc    Function test
     */
    it('Telephony_NetworkSearch_getSignalInformation_Promise_0400', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0400 fail');
            expect().assertFail();
        } catch (err) {
            console.log('Telephony_NetworkSearch_getSignalInformation_Promise_0400 finish err: ' + err.message);
            done();
            return;
        }
        done();
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0100', 0, async function (done) {
        radio.getISOCountryCodeForNetwork(SLOT_0, (err, data) => {
            if (err) {
                console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0100 fail err: ' + err.message);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0100', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0100 fail err: ' + err.message);
            expect().assertFail();
            done();
            return;
        }
     ...
     * @tc.name    SlotId parameter input is 6, test getISOCountryCodeForNetwork() query function go to the error
     * @tc.desc    Function test
     */
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400', 0, async function (done) {
        ...
        radio.getISOCountryCodeForNetwork(slotId, (err, data) => {
            if (err) {
                console.log(
                    'Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400 finish err: ' + err.message
                );
                done();
                return;
            }
            console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Async_0400 fail');
            expect().assertFail();
            done();
        })
    })
    ...
    it('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0400', 0, async function (done) {
        try {
            ...
            console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0400 finish');
            expect().assertFail();
        } catch (err) {
            console.log('Telephony_NetworkSearch_getISOCountryCodeForNetwork_Promise_0400 fail err: ' + err.message);
            done();
            return;
        }
        done();
