...
describe('NetworkSearchPreferredModeTest', function () {
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Async_0200', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_0200 set success');
        } catch (err) {
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Async_0300', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_0300 set success');
        } catch (err) {
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Async_0400', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_0400 set success');
        } catch (err) {
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Async_0500', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_0500 set success');
        } catch (err) {
     ...
     */
     it('Telephony_NetworkSearch_getPreferredNetwork_Async_1100', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_1100 set success');
        } catch (err) {
        ...
        try {
            ...
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_1100 turnOffRadio success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_getPreferredNetwork_Async_1100 turnOffRadio fail ${err}`);
            expect().assertFail();
            done();
            return;
        }
        radio.getPreferredNetwork(SLOT_0,async (err, data) => {
            ...
            try {
                ...
                console.log('Telephony_NetworkSearch_getPreferredNetwork_Async_1100 turnOnRadio success');
            } catch (err) {
                console.log(`Telephony_NetworkSearch_getPreferredNetwork_Async_1100 turnOnRadio fail ${err}`);
                expect().assertFail();
                done();
                return;
            }
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Promise_0100', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Promise_0100 set success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_getPreferredNetwork_Promise_0100 set fail err: ${err}`);
            expect().assertFail();
            return;
        }
        try {
     ...
     */
     it('Telephony_NetworkSearch_getPreferredNetwork_Promise_1100', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Promise_1100 set success');
        } catch (err) {
        ...
        try {
            await radio.turnOffRadio();
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Promise_1100 turnOffRadio success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_getPreferredNetwork_Promise_1100 turnOffRadio fail ${err}`);
            expect().assertFail();
            done();
            return;
        }
        ...
        try {
            await radio.turnOnRadio();
            console.log('Telephony_NetworkSearch_getPreferredNetwork_Promise_1100 turnOnRadio success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_getPreferredNetwork_Promise_1100 turnOnRadio fail ${err}`);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_setPreferredNetwork_Async_0400', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            let data = await radio.getPreferredNetwork(SLOT_0);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Async_0400 set success');
            expect(data === radio.PREFERRED_NETWORK_MODE_AUTO).assertTrue();
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0400 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Async_0500', 0, async function (done) {
        try {
            await radio.turnOnRadio();
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Async_0500 turnOnRadio success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0500 turnOnRadio fail ${err}`);
            expect().assertFail();
            done();
            return;
        }
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Async_0500 set success');
        } catch (err) {
        ...
        try {
            await radio.turnOffRadio();
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Async_0500 turnOffRadio success');
        } catch (err) {
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Async_0600', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            let data = await radio.getPreferredNetwork(SLOT_0);
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0600 set success}`);
            expect(data === radio.PREFERRED_NETWORK_MODE_AUTO).assertTrue();
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0600 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Async_0700', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            let data = await radio.getPreferredNetwork(SLOT_0);
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0700 set success`);
            expect(data === radio.PREFERRED_NETWORK_MODE_AUTO).assertTrue();
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Async_0700 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
    ...
    it('Telephony_NetworkSearch_setPreferredNetwork_Promise_0100', 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            let data = await radio.getPreferredNetwork(SLOT_0);
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0100 set success `);
            expect(data === radio.PREFERRED_NETWORK_MODE_AUTO).assertTrue();
        } catch (err) {
    ...
    it('Telephony_NetworkSearch_setPreferredNetwork_Promise_0400', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Promise_0400 set success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0400 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
        try {
            await radio.setPreferredNetwork(slotId, radio.PREFERRED_NETWORK_MODE_GSM);
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Promise_0500', 0, async function (done) {
        try {
            await radio.turnOnRadio();
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Promise_0500 turnOnRadio success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0500 turnOnRadio fail ${err}`);
            expect().assertFail();
            done();
            return;
        }
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Promise_0500 set success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0500 set fail err: ${err}`);
            expect().assertFail();
            return;
        }
        try {
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Promise_0600', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Promise_0600 set success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0600 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
     ...
     */
     it('Telephony_NetworkSearch_setPreferredNetwork_Promise_0700', 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_NetworkSearch_setPreferredNetwork_Promise_0700 set success');
        } catch (err) {
            console.log(`Telephony_NetworkSearch_setPreferredNetwork_Promise_0700 set fail err: ${err}`);
            expect().assertFail();
            done();
            return;
        }
