...
describe('SmsMmsDelCdmaTest', function () {
  ...
  beforeAll(async function () {
    try {
      radio.setPreferredNetwork(TRUE_SLOT_ID, radio.PREFERRED_NETWORK_MODE_CDMA);
  ...
  beforeEach(async function (done) {
    try {
      radio.setPreferredNetwork(TRUE_SLOT_ID, radio.PREFERRED_NETWORK_MODE_AUTO);
      console.log('Telephony_NetworkSearch_recoverPreferredMode success');
    } catch (err) {
      console.log(`Telephony_NetworkSearch_recoverPreferredMode fail err: ${err}`);
      expect().assertFail();
