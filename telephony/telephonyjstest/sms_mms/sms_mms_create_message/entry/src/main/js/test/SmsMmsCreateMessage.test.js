...
describe('SmsMmsCreateTest', function () {
  ...
  it('Telephony_SmsMms_createMessage_Async_0100', 0, async function (done) {
    sms.createMessage(rawArray, '3gpp', (err, shortMessage) => {
      ...
      console.log("Telephony_SmsMms_createMessage_Async_0100 visibleMessageBody : " + shortMessage.visibleMessageBody);
      console.log("Telephony_SmsMms_createMessage_Async_0100 visibleRawAddress.length : " +
        shortMessage.visibleRawAddress.length);
      console.log("Telephony_SmsMms_createMessage_Async_0100 messageClass : " + shortMessage.messageClass);
      console.log("Telephony_SmsMms_createMessage_Async_0100 protocolId : " + shortMessage.protocolId);
      console.log("Telephony_SmsMms_createMessage_Async_0100 scAddress.length : " + shortMessage.scAddress.length);
      console.log("Telephony_SmsMms_createMessage_Async_0100 scTimestamp : " + shortMessage.scTimestamp);
      console.log("Telephony_SmsMms_createMessage_Async_0100 isReplaceMessage : " + shortMessage.isReplaceMessage);
      console.log("Telephony_SmsMms_createMessage_Async_0100 hasReplyPath : " + shortMessage.hasReplyPath);
      console.log("Telephony_SmsMms_createMessage_Async_0100 pdu.length : " + shortMessage.pdu.length);
      console.log("Telephony_SmsMms_createMessage_Async_0100 status : " + shortMessage.status);
      console.log("Telephony_SmsMms_createMessage_Async_0100 isSmsStatusReportMessage : " +
  ...
  it('Telephony_SmsMms_createMessage_Async_0500', 0, async function (done) {
    sms.createMessage(pduArray, '3gpp', (err, shortMessage) => {
      if (err) {
        expect().assertFail();
        console.log('Telephony_SmsMms_createMessage_Async_0500 fail');
        done();
        return;
      }
      console.log("Telephony_SmsMms_createMessage_Async_0500 visibleMessageBody : " + shortMessage.visibleMessageBody);
      console.log("Telephony_SmsMms_createMessage_Async_0500 visibleRawAddress.length : " +
        shortMessage.visibleRawAddress.length);
      console.log("Telephony_SmsMms_createMessage_Async_0500 messageClass : " + shortMessage.messageClass);
      console.log("Telephony_SmsMms_createMessage_Async_0500 protocolId : " + shortMessage.protocolId);
      console.log("Telephony_SmsMms_createMessage_Async_0500 scAddress.length : " + shortMessage.scAddress.length);
      console.log("Telephony_SmsMms_createMessage_Async_0500 scTimestamp : " + shortMessage.scTimestamp);
      console.log("Telephony_SmsMms_createMessage_Async_0500 isReplaceMessage : " + shortMessage.isReplaceMessage);
      console.log("Telephony_SmsMms_createMessage_Async_0500 hasReplyPath : " + shortMessage.hasReplyPath);
      console.log("Telephony_SmsMms_createMessage_Async_0500 pdu.length : " + shortMessage.pdu.length);
      console.log("Telephony_SmsMms_createMessage_Async_0500 status : " + shortMessage.status);
      console.log("Telephony_SmsMms_createMessage_Async_0500 isSmsStatusReportMessage : " +
        shortMessage.isSmsStatusReportMessage);
  ...
  it('Telephony_SmsMms_createMessage_Promise_0100', 0, async function (done) {
    try {
      ...
      console.log("Telephony_SmsMms_createMessage_Promise_0100 visibleMessageBody : " + promise.visibleMessageBody);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 visibleRawAddress.length : " +
        promise.visibleRawAddress.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 messageClass : " + promise.messageClass);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 protocolId : " + promise.protocolId);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 scAddress.length : " + promise.scAddress.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 scTimestamp : " + promise.scTimestamp);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 isReplaceMessage : " + promise.isReplaceMessage);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 hasReplyPath : " + promise.hasReplyPath);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 pdu.length : " + promise.pdu.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 status : " + promise.status);
      console.log("Telephony_SmsMms_createMessage_Promise_0100 isSmsStatusReportMessage : " +
        promise.isSmsStatusReportMessage);
  ...
  it('Telephony_SmsMms_createMessage_Promise_0500', 0, async function (done) {
    try {
      ...
      console.log("Telephony_SmsMms_createMessage_Promise_0500 visibleMessageBody : " + promise.visibleMessageBody);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 visibleRawAddress.length : " +
        promise.visibleRawAddress.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 messageClass : " + promise.messageClass);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 protocolId : " + promise.protocolId);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 scAddress.length : " + promise.scAddress.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 scTimestamp : " + promise.scTimestamp);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 isReplaceMessage : " + promise.isReplaceMessage);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 hasReplyPath : " + promise.hasReplyPath);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 pdu.length : " + promise.pdu.length);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 status : " + promise.status);
      console.log("Telephony_SmsMms_createMessage_Promise_0500 isSmsStatusReportMessage : " +
        promise.isSmsStatusReportMessage);
