...
describe('SmsMmsJudgmentTest', function () {
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_0100', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, force7BitCode, (error, result) => {
      if (error) {
        ...
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_0100   encodeCountRemaining " + result.encodeCountRemaining);
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_0500', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, false, (error, result) => {
      if (error) {
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_0500 getSmsSegmentsInfoon error because " + error.message);
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_0600', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, false, (error, result) => {
      if (error) {
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_0600 getSmsSegmentsInfoon error because " + error.message);
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_1000', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, false, (error, result) => {
      if (error) {
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_1000 getSmsSegmentsInfoon error because " + error.message);
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_1200', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, false, (error, result) => {
      if (error) {
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_1200 getSmsSegmentsInfoon error because " + error.message);
  ...
  it('Telephony_SmsMms_getSmsSegmentsInfo_Async_1300', 0, async function (done) {
    ...
    sms.getSmsSegmentsInfo(TRUE_SLOT_ID, message, false, (error, result) => {
      if (error) {
        console.log("Telephony_SmsMms_getSmsSegmentsInfo_Async_1300 getSmsSegmentsInfoon error because " + error.message);
  ...
  /*
   * @tc.number  Telephony_SmsMms_getImsShortMessageFormat_Async_0200
   * @tc.name    In CDMA network system, call the interface to obtain SMS system
   * @tc.desc    Function test
   */
  it('Telephony_SmsMms_getImsShortMessageFormat_Async_0200', 0, async function (done) {
    sms.getImsShortMessageFormat((error, result) => {
      if (error) {
        console.log('Telephony_SmsMms_getImsShortMessageFormat_Async_0200 fail');
        expect().assertFail();
      } else {
        expect(result === '3gpp2').assertTrue();
        console.log('Telephony_SmsMms_getImsShortMessageFormat_Async_0200 finish');
      }
      done();
    });
  });
  ...
  /*
   * @tc.number  Telephony_SmsMms_getImsShortMessageFormat_Promise_0200
   * @tc.name    In CDMA network system, call the interface to obtain SMS system
   * @tc.desc    Function test
   */
  it('Telephony_SmsMms_getImsShortMessageFormat_Promise_0200', 0, async function (done) {
    try {
      let result = await sms.getImsShortMessageFormat();
      expect(result === '3gpp2').assertTrue();
      console.log('Telephony_SmsMms_getImsShortMessageFormat_Promise_0200 finish');
    } catch (err) {
      expect().assertFail();
      console.log('Telephony_SmsMms_getImsShortMessageFormat_Promise_0200 fail');
    }
    done();
  });
   ...
   *             check the average return time. 500 mu s
  ...
  it('Telephony_SmsMms_hasSmsCapability_0300', 0, async function (done) {
    ...
    expect(endTime - startTime).assertLess(5);
    done();
  });
