...
# 配置发送短信的电话号码
config_const_var[0]="const SMS_SEND_DST_NUMBER = '13632862140';"
#配置通话管理自动接听号码
config_const_var[1]="const CALLMANAGER_TEST_PHONY_NUMBER = '10086';"

# 短信测试中使用到的短信中心服务地址
config_const_var[2]="const OTHER_SMSC_NUMBER = '+8613800755500';"
config_const_var[3]="const USABLE_SMSC_NUMBER = '+8613800512500';"

#通话管理用例使用号码
config_const_var[4]="const INVALID_NUMBER = '13800000000';"
