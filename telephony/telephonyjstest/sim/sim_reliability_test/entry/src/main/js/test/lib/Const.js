...
// comment event
export const STK_SESSION_END = 'usual.event.telpnony.STK_SESSION_END';

// common event receiving frequency
export const EVENT_RECEIVING_FREQUENCY = 12;

export const WAITING_AFTER_EVENT_ACTION = 0.5;
