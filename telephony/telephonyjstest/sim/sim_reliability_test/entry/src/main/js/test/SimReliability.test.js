...
describe('SimReliability', function () {
  ...
  it('Telephony_Sim_getIMSI_Async_0400', 0, async function (done) {
    function recursive (n) {
      ...
      sim.getIMSI(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_getIMSI_Promise_0400', 0, async function (done) {
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim.getIMSI(SIM_SLOT_ID.slotId0);
        expect(data !== '' && data !== undefined).assertTrue();
        expect(data.length === IMSI_LENGTH).assertTrue();
      } catch (err) {
  ...
  it('Telephony_Sim_getSimIccId_Async_0400', 0, async function (done) {
    function recursive (n) {
      ...
      sim.getSimIccId(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_getSimIccId_Promise_0400', 0, async function (done) {
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim .getSimIccId(SIM_SLOT_ID.slotId0);
        expect(data !== '' && data !== undefined).assertTrue();
        expect(data.length === ICC_LENGTH).assertTrue();
      } catch (err) {
  ...
  it('Telephony_Sim_getISOCountryCodeForSim_Async_0400', 0, async function (done) {
    ...
    function recursive (n) {
      ...
      sim.getISOCountryCodeForSim(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_getISOCountryCodeForSim_Promise_0400', 0, async function (done) {
    ...
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim.getISOCountryCodeForSim(SIM_SLOT_ID.slotId0);
        // The country code for mainland China is cn.
        expect(data === countryCode).assertTrue();
      } catch (err) {
  ...
  it('Telephony_Sim_getSimOperatorNumeric_Async_0400', 0, async function (done) {
    ...
    function recursive (n) {
      ...
      sim.getSimOperatorNumeric(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_getSimOperatorNumeric_Promise_0400', 0, async function (done) {
    ...
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim.getSimOperatorNumeric(SIM_SLOT_ID.slotId0);
        expect(data !== '' && data !== undefined).assertTrue();
        // The length of operator numeric in mainland China is 5.
        expect(data.length === OPERATOR_NUM_LENGTH).assertTrue();
        // The first three operator numeric in mainland China is '460'.
  ...
  it('Telephony_Sim_getSimSpn_Async_0400', 0, async function (done) {
    ...
    function recursive (n) {
      ...
      sim.getSimSpn(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
        ...
        expect(data !== '' && data !== undefined).assertTrue();
        sim.getSimOperatorNumeric(SIM_SLOT_ID.slotId0, (err, value) => {
          if (err) {
          ...
          if ((value === OPERATOR_CODE.MOBILE_CODE_1) || (value === OPERATOR_CODE.MOBILE_CODE_2) ||
                    (value === OPERATOR_CODE.MOBILE_CODE_3) || (value === OPERATOR_CODE.MOBILE_CODE_4)) {
            expect(data === mobileSpn).assertTrue();
          } else if ((value === OPERATOR_CODE.UNICOM_CODE_1) || (value === OPERATOR_CODE.UNICOM_CODE_2) ||
                    (value === OPERATOR_CODE.UNICOM_CODE_3)) {
            expect(data === unicomSpn).assertTrue();
          } else if ((value === OPERATOR_CODE.TELECOM_CODE_1) || (value === OPERATOR_CODE.TELECOM_CODE_2) ||
                    (value === OPERATOR_CODE.TELECOM_CODE_3)) {
  ...
  it('Telephony_Sim_getSimSpn_Promise_0400', 0, async function (done) {
    ...
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim.getSimSpn(SIM_SLOT_ID.slotId0);
        expect(data !== '' && data !== undefined).assertTrue();
        try {
          let value = await sim.getSimOperatorNumeric(SIM_SLOT_ID.slotId0);
          if ((value === OPERATOR_CODE.MOBILE_CODE_1) || (value === OPERATOR_CODE.MOBILE_CODE_2) ||
                    (value === OPERATOR_CODE.MOBILE_CODE_3) || (value === OPERATOR_CODE.MOBILE_CODE_4)) {
            expect(data === mobileSpn).assertTrue();
          } else if ((value === OPERATOR_CODE.UNICOM_CODE_1) || (value === OPERATOR_CODE.UNICOM_CODE_2) ||
  ...
  it('Telephony_Sim_getSimGid1_Async_0400', 0, async function (done) {
    ...
    function recursive (n) {
      ...
      sim.getSimGid1(SIM_SLOT_ID.slotId0, (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_getSimGid1_Promise_0400', 0, async function (done) {
    ...
    for (let index = 0;index < TIMES_VALUE.TEST_RUN_TIME;index++) {
      try {
        let data = await sim.getSimGid1(SIM_SLOT_ID.slotId0);
        expect(data !== '' && data !== undefined).assertTrue();
        expect((data.length >= minLength)).assertTrue();
      } catch (err) {
    ...
    function recursive(n) {
      ...
      sim.deactivateSim(SIM_SLOT_ID.slotId0, (err) => {
        ...
        sim.getSimAccountInfo(SIM_SLOT_ID.slotId0, (err, info) => {
          ...
          expect(info.showName === CARD_INFO.NEW_CARD_NAME).assertTrue();
          expect(info.showNumber === CARD_INFO.NEW_CARD_NUMBER).assertTrue();
  ...
  it('Telephony_Sim_getSimAccountInfo_Promise_0400', 0, async function (done) {
    try {
      await sim.setShowName(SIM_SLOT_ID.slotId0, CARD_INFO.NEW_CARD_NAME);
      await sim.setShowNumber(SIM_SLOT_ID.slotId0, CARD_INFO.NEW_CARD_NUMBER);
                ...
                if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
                    try {
                        await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0,
                            TYPE_AND_INDEX.type_1, data[i].recordNumber);
  ...
  */
    ...
    it('Telephony_Sim_addIccDiallingNumbers_Async_0900', 0, async function (done) {
        const recursive = function (n) {
            ...
            sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, async (error, data) => {
                if (error) {
                ...
                try {
                    for (let i = 0;i < data.length;i++) {
                        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
                            await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1,
                                data[i].recordNumber);
                ...
                sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, diallingNumbersInfo,
                    function (error) {
                    if (error) {
    ...
    it('Telephony_Sim_updateIccDiallingNumbers_Async_1100', 0, async function (done) {
        ...
        const recursive = async function (n) {
            ...
            sim.updateIccDiallingNumbers(SIM_SLOT_ID.slotId0,
                ...
                TYPE_AND_INDEX.index_1, async function (error) {
                    if (error) {
                        console.log(
