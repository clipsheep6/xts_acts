...
import { describe, it, expect, beforeAll, afterAll, Core } from 'deccjsunit/index';
describe('SimFixedDialManagerFunction', function () {

  const triggerPuk2 = async function () {
    await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2);
    await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2);
    await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2);
  };
  ...
  beforeAll(async function () {
    ...
    console.log(`PIN2 password is correct: ${!pin2Error}, PUK2 password is correct: ${!puk2Error}`);
  });
  ...
  it('Telephony_Sim_unlockPin2_Async_0100', 0, async function (done) {
    ...
    sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN3, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_unlockPin2_Async_0200', 0, async function (done) {
    ...
    sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} unlock pin2 err: ${err.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_unlockPin2_Async_0300', 0, async function (done) {
    ...
    sim.unlockPin2(env.SLOTID_MINUS1, env.INCORRECT_PIN2_REVERSE, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_unlockPin2_Async_0600', 0, async function (done) {
    ...
    sim.unlockPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_unlockPin2_Async_0700', 0, async function (done) {
    ...
    sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_REVERSE, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail err: ${err.message}`);
        expect().assertFail();
        done();
      ...
      // reset remain
      sim.unlockPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, (error, data) => {
        if (error) {
  ...
  it('Telephony_Sim_unlockPin2_Async_0800', 0, async function (done) {
    ...
    const recursiveUnlockPin2 = function (n) {
      if (n === 0) {
        ...
        sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PUK2, (error, data) => {
          if (error) {
   ...
   * @tc.name    Test slotid exception input parameter 3 of unlockPin2 and check the callback
  ...
  it('Telephony_Sim_unlockPin2_Async_0900', 0, async function (done) {
    ...
    sim.unlockPin2(env.SLOTID3, env.INCORRECT_PIN2_REVERSE, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} expect err: ${err.message}`);
        console.log(`${CASE_NAME} finish`);
        done();
  ...
  it('Telephony_Sim_unlockPin2_Async_1000', 0, async function (done) {
    ...
    sim.unlockPin2(env.SLOTID2, env.INCORRECT_PIN2_REVERSE, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} expect err: ${err.message}`);
        console.log(`${CASE_NAME} finish`);
        done();
  ...
  it('Telephony_Sim_unlockPin2_Promise_0100', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN3);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPIN2_STATE_CODE.EXCEPTION).assertTrue();
    } catch (err) {
      console.log(`${CASE_NAME} fail err: ${err.message}`);
  ...
  it('Telephony_Sim_unlockPin2_Promise_0200', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPIN2_STATE_CODE.EXCEPTION).assertTrue();
    } catch (err) {
      console.log(`${CASE_NAME} fail err: ${err.message}`);
  ...
  it('Telephony_Sim_unlockPin2_Promise_0300', 0, async function (done) {
    ...
    try {
      await sim.unlockPin2(env.SLOTID_MINUS1, env.INCORRECT_PIN2_REVERSE);
      expect().assertFail();
    } catch (err) {
      console.log(`${CASE_NAME} expect err: ${err.message}`);
      console.log(`${CASE_NAME} finish`);
  ...
  it('Telephony_Sim_unlockPin2_Promise_0600', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPIN2_STATE_CODE.SUCCESS).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (err) {
  ...
  it('Telephony_Sim_unlockPin2_Promise_0700', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_REVERSE);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPIN2_STATE_CODE.FAILURE && data.remain === 2).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (err) {
  ...
  it('Telephony_Sim_unlockPin2_Promise_0900', 0, async function (done) {
    ...
    try {
      await sim.unlockPin2(env.SLOTID3, env.INCORRECT_PIN2_REVERSE);
      expect().assertFail();
    } catch (err) {
      console.log(`${CASE_NAME} expect err: ${err.message}`);
      console.log(`${CASE_NAME} finish`);
  ...
  it('Telephony_Sim_unlockPin2_Promise_1000', 0, async function (done) {
    ...
    try {
      await sim.unlockPin2(env.SLOTID2, env.INCORRECT_PIN2_REVERSE);
      expect().assertFail();
    } catch (err) {
      console.log(`${CASE_NAME} expect err: ${err.message}`);
      console.log(`${CASE_NAME} finish`);
  ...
  it('Telephony_Sim_unlockPuk2_Async_0100', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2_LEN3, async (err, data) => {
        if (err) {
  ...
  it('Telephony_Sim_unlockPuk2_Async_0200', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN9, async (err, data) => {
        if (err) {
          console.log(`${CASE_NAME}, err: ${err.message}`);
          expect().assertFail();
          done();
  ...
  it('Telephony_Sim_unlockPuk2_Async_0300', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_unlockPuk2_Async_0200';
    sim.unlockPuk2(env.SLOTID_MINUS1, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_unlockPuk2_Async_0400', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9, env.CORRECT_PUK2, async (err, data) => {
        if (err) {
          console.log(`${CASE_NAME}, err: ${err.message}`);
          expect().assertFail();
          done();
  ...
  it('Telephony_Sim_unlockPuk2_Async_0700', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PUK2, async (err, data) => {
        if (err) {
          console.log(`${CASE_NAME}, err: ${err.message}`);
          expect().assertFail();
          done();
  ...
  it('Telephony_Sim_unlockPuk2_Async_0800', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2, async (err, data) => {
        if (err) {
          console.log(`${CASE_NAME}, err: ${err.message}`);
          expect().assertFail();
          done();
  ...
  it('Telephony_Sim_unlockPuk2_Async_0900', 0, async function (done) {
    ...
    sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
   ...
   * @tc.name    Test the slotId exception input parameter 3 of the unlockPuk2 interface and check
  ...
  it('Telephony_Sim_unlockPuk2_Async_1000', 0, async function (done) {
    ...
    sim.unlockPuk2(env.SLOTID3, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} expect err: ${err.message}`);
        console.log(`${CASE_NAME} finish`);
        done();
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0100', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2_LEN3);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.EXCEPTION).assertTrue();
      console.log(`${CASE_NAME} finish`);
      unlockPuk2AndResetPin2();
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0200', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN9);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.EXCEPTION).assertTrue();
      console.log(`${CASE_NAME} finish`);
      unlockPuk2AndResetPin2();
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0300', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPuk2(env.SLOTID_MINUS1, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8);
      console.log(`${CASE_NAME}, data : ${JSON.stringify(data)}`);
      expect().assertFail();
    } catch (error) {
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0400', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9, env.CORRECT_PUK2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.EXCEPTION).assertTrue();
      console.log(`${CASE_NAME} finish`);
      unlockPuk2AndResetPin2();
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0700', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PUK2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.SUCCESS).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0800', 0, async function (done) {
    ...
    try {
      await triggerPuk2();
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.FAILURE && data.remain === 9).assertTrue();
      console.log(`${CASE_NAME} finish`);
      unlockPuk2AndResetPin2();
  ...
  it('Telephony_Sim_unlockPuk2_Promise_0900', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.UNLOCKPUK2_STATE_CODE.EXCEPTION).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
  ...
  it('Telephony_Sim_unlockPuk2_Promise_1000', 0, async function (done) {
    ...
    try {
      const data = await sim.unlockPuk2(env.SLOTID3, env.INCORRECT_PIN2, env.INCORRECT_PUK2_LEN8);
      console.log(`${CASE_NAME}, data: ${JSON.stringify(data)}`);
      expect().assertFail();
    } catch (error) {
  ...
  it('Telephony_Sim_alterPin2_Async_0100', 0, async function (done) {
    ...
    sim.alterPin2(env.SLOTID_MINUS1, env.INCORRECT_PIN2, env.INCORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} finish`);
        done();
        return;
  ...
  it('Telephony_Sim_alterPin2_Async_0400', 0, async function (done) {
    ...
    sim.alterPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_alterPin2_Async_0500', 0, async function (done) {
    ...
    sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN3, env.CORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_alterPin2_Async_0600', 0, async function (done) {
    ...
    sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9, env.CORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_alterPin2_Async_0700', 0, async function (done) {
    ...
    sim.alterPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PIN2_LEN9, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_alterPin2_Async_0800', 0, async function (done) {
    ...
    sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} fail, err${err.message}`);
        expect().assertFail();
        done();
   ...
   * @tc.name    Test alterPin2 interface exception slotId input parameter 3, check the callback value,
  ...
  it('Telephony_Sim_alterPin2_Async_1000', 0, async function (done) {
    ...
    sim.alterPin2(env.SLOTID3, env.INCORRECT_PIN2, env.INCORRECT_PIN2, (err, data) => {
      if (err) {
        console.log(`${CASE_NAME} expect error: ${err.message}`);
        console.log(`${CASE_NAME} finish`);
        done();
  ...
  it('Telephony_Sim_alterPin2_Promise_0100', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.SLOTID_MINUS1, env.INCORRECT_PIN2, env.INCORRECT_PIN2);
      console.log(`${CASE_NAME}, data: ${JSON.stringify(data)}`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_alterPin2_Promise_0400', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.ALTERPIN2_STATE_CODE.SUCCESS).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
  ...
  it('Telephony_Sim_alterPin2_Promise_0500', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN3, env.CORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
      console.log(`${CASE_NAME} fail, err: ${error.message}`);
  ...
  it('Telephony_Sim_alterPin2_Promise_0600', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2_LEN9, env.CORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
      console.log(`${CASE_NAME} fail, err: ${error.message}`);
  ...
  it('Telephony_Sim_alterPin2_Promise_0700', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PIN2_LEN9);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
      console.log(`${CASE_NAME} fail, err: ${error.message}`);
  ...
  it('Telephony_Sim_alterPin2_Promise_0800', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, env.INCORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect(data.result === env.ALTERPIN2_STATE_CODE.FAILURE && data.remain === 2).assertTrue();
      console.log(`${CASE_NAME} finish`);
    } catch (error) {
   ...
   * @tc.name    Test alterPin2 interface exception slotId input parameter 3, check the callback
   *             value, expecting to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_alterPin2_Promise_1000', 0, async function (done) {
    ...
    try {
      const data = await sim.alterPin2(env.SLOTID3, env.INCORRECT_PIN2, env.INCORRECT_PIN2);
      console.log(`${CASE_NAME} data: ${JSON.stringify(data)}`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
