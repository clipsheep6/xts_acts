...
describe('SimsetVoiceMailInfoFunctionTest', function () {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_0100', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN20, error => {
      ...
      sim.getVoiceMailNumber(env.DEFAULT_SLOTID, (error, value) => {
        if (error) {
        ...
        sim.getVoiceMailIdentifier(env.DEFAULT_SLOTID, (error, value) => {
          if (error) {
   ...
   * @tc.name   Test the setVoiceMailInfo async callback interface, slotId is 3, expect enter error.
   * @tc.desc   Function test
   */
  it('Telephony_Sim_setVoiceMailInfo_Async_0300', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_setVoiceMailInfo_Async_0300';
    sim.setVoiceMailInfo(env.SLOTID3, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish`);
      } else {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_0500', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN13, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_0600', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN21, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
        done();
        return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_1000', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_EMPTY, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish`);
      } else {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_1100', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_EMPTY, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish`);
      } else {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_1200', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_CHS_LEN6, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
        done();
        return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_1300', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_CHS_LEN7, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
        done();
        return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_1400', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_CHAR, error => {
      if (error) {
        console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish`);
      } else {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_0100', 0, async function (done) {
    ...
    try {
      const mailNumber = await sim.getVoiceMailNumber(env.DEFAULT_SLOTID);
      ...
      const mailIdentifier = await sim.getVoiceMailIdentifier(env.DEFAULT_SLOTID);
   ...
   * @tc.name   Test the setVoiceMailInfo promise interface, slotId is 3, expect enter error.
   * @tc.desc   Function test
   */
  it('Telephony_Sim_setVoiceMailInfo_Promise_0300', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.SLOTID3, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN20);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_0500', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN13, env.MAIL_NUMBER_LEN20);
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
      done();
      return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_0600', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN21);
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
      done();
      return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_1000', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_EMPTY, env.MAIL_NUMBER_LEN20);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_1100', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_EMPTY);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_1200', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_CHS_LEN6, env.MAIL_NUMBER_LEN20);
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
      done();
      return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_1300', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_CHS_LEN7, env.MAIL_NUMBER_LEN20);
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo error: ${error.message}`);
      done();
      return;
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_1400', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_CHAR);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} setVoiceMailInfo expect error: ${error.message}`);
