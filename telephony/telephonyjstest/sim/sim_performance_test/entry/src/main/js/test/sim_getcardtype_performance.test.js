...
describe('SimGetCardTypePerformanceTest', function () {
   ...
   * @tc.name   Test GetCardType (Async) interface performance
   * @tc.desc   Performance test
   */
  it('Telephony_Sim_GetCardType_Async_0500', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetCardType_Async_0500';
    let startTime = 0;
    let endTime = 0;
    let totalTime = 0;
  ...
  /**
   * @tc.number Telephony_Sim_GetCardType_Promise_0500
   * @tc.name   Test GetCardType (Promise) interface performance
   * @tc.desc   Performance test
   */
  it('Telephony_Sim_GetCardType_Promise_0500', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetCardType_Promise_0500';
    let startTime = 0;
    let endTime = 0;
    let totalTime = 0;
