...
import {simSlotId, OPERATOR_NUM_LENGTH, timesValue, cardName, typeAndIndex} from './lib/Const.js';
...
describe('SimIccDiallingNumbersControllerFunction', function () {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0200', 0, async function (done) {
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0300', 0, async function (done) {
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, async function (error, data) {
      if (error) {
      ...
      for (let i = 0;i < data.length;i++) {
        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
          try {
            await sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, data[i].recordNumber);
      ...
      try {
        await sim.addIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, diallingNumbersInfo);
      ...
      sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, (error, data) => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0400', 0, async function (done) {
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0200', 0, async function (done) {
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1).then(data => {
      if (data.length === 0) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0300', 0, async function (done) {
    try {
      const data = await sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2);
      for (let i = 0;i < data.length;i++) {
        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
          await sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, data[i].recordNumber);
    ...
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2).then(data => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0400', 0, async function (done) {
    sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4).then(function (data) {
      if (data.length === 0) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0200', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, diallingNumbersInfo, function (error) {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0500', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0200', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1, diallingNumbersInfo);
...
*/
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4, diallingNumbersInfo);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0200', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1, newRecordNumber, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_1, noExistIndex, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    try {
      data = await sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2);
    ...
    if (!newRecordNumber) {
      ...
      try {
        const _data = await sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2);
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, newRecordNumber, function (error) {
      if (error) {
      ...
      sim.queryIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, function (error, data) {
        if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4, newRecordNumber, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0200', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_4, typeAndIndex.TYPE_1, newRecordNumber).then(() => {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0300', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_1, noExistIndex).then(() => {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, newRecordNumber);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_4, newRecordNumber).then(() => {
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    sim.updateIccDiallingNumbers(simSlotId.SLOT_ID_0,
      ...
      typeAndIndex.INDEX_1, function (error) {
        if (error) {
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.updateIccDiallingNumbers(simSlotId.SLOT_ID_0, typeAndIndex.TYPE_2, diallingNumbersInfoUpdate,
        typeAndIndex.INDEX_1);
    } catch (error) {
