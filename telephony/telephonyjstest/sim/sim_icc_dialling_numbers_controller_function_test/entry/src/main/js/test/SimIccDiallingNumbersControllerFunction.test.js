...
import { describe, it, expect, beforeAll, Core, afterAll } from 'deccjsunit/index';
...
describe('SimIccDiallingNumbersControllerFunction', function () {
  ...
  const triggerPuk2 = async function () {
    try {
      ...
      await sim.unlockPin2(env.DEFAULT_SLOTID, incorrentPin2);
      await sim.unlockPin2(env.DEFAULT_SLOTID, incorrentPin2);
      await sim.unlockPin2(env.DEFAULT_SLOTID, incorrentPin2);
    } catch (error) {
  ...
  const unlockPuk2 = async function () {
    try {
      if (!puk2IsError) {
        await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PUK2);
      }
    } catch (error) {
  ...
  const wrapperStepForAdd = async function (type, trigPuk2 = false) {
    try {
      await deleteContact(env.DEFAULT_SLOTID, type);
      if (trigPuk2) {
        await triggerPuk2();
      }
    } catch (error) {
  ...
  beforeAll(async function () {
    ...
    try {
      const unlockPin2Resp = await sim.unlockPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2);
      pin2IsError = unlockPin2Resp.result !== LOCK_RESULT_SUCCESS;
      if (!pin2IsError) {
        await triggerPuk2();
        const unlockPuk2Resp = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PUK2);
      ...
      let checkFdn = await sim.setLockState(env.DEFAULT_SLOTID, lockInfo);
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo);
    } catch (error) {
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfo);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1, (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
   ...
   * @tc.name    Test sim.queryIccDiallingNumbers(soltId: 3, type: 1, callback:
   *             AsyncCallback<Array<DiallingNumbersInfo>>), expect return a empty array.
   * @tc.desc    Function test
   */
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0700', 0, async function (done) {
    ...
    sim.queryIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0900', 0, async function (done) {
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_1000', 0, async function (done) {
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_1200', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO, true);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, async (error, data) => {
      if (error) {
        console.log(`${CASE_NAME} query error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_1300', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO, true);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, async (error, data) => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0100', 0, async function (done) {
    ...
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT);
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0300', 0, async function (done) {
    ...
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING);
      console.log(`${CASE_NAME} query result: ${JSON.stringify(contacts)}`);
      expect(contacts.some(item => item.recordNumber === diallingNumbersInfo.recordNumber
        && item.alphaTag === diallingNumbersInfo.alphaTag
        && item.number === diallingNumbersInfo.number
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1);
      expect(contacts.length === 0).assertTrue();
      console.log(`${CASE_NAME} test finish.`);
    } catch (error) {
      console.log(`${CASE_NAME} query error:${error.message}`);
   ...
   * @tc.name    Test sim.queryIccDiallingNumbers(soltId: 3, type: 1):Promise<Array<DiallingNumbersInfo>>
   *             promise interface, expect result is a empty array.
   * @tc.desc    Function test
   */
  it('telephony_Sim_queryIccDiallingNumbers_Promise_0700', 0, async function (done) {
    ...
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT);
      expect(contacts.length === 0).assertTrue();
      console.log(`${CASE_NAME} test finish.`);
    } catch (error) {
      console.log(`${CASE_NAME} query error:${error.message}`);
  ...
  it('telephony_Sim_queryIccDiallingNumbers_Promise_0900', 0, async function (done) {
    ...
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0);
      expect(contacts.length === 0).assertTrue();
      console.log(`${CASE_NAME} test finish.`);
    } catch (error) {
      console.log(`${CASE_NAME} query error:${error.message}`);
  ...
  it('telephony_Sim_queryIccDiallingNumbers_Promise_1000', 0, async function (done) {
    const CASE_NAME = 'telephony_Sim_queryIccDiallingNumbers_Promise_0900';
    try {
      const contacts = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3);
      expect(contacts.length === 0).assertTrue();
      console.log(`${CASE_NAME} test finish.`);
    } catch (error) {
      console.log(`${CASE_NAME} query error:${error.message}`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0200', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID,
      env.NUM_TYPE_MINUS1,
      FIXED_DIALING_INFO,
      error => {
        if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO, error => {
      if (error) {
      ...
      sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo, error => {
        if (error) {
          console.log(`${CASE_NAME} expect error: ${error.message}`);
          console.log(`${CASE_NAME} test finish.`);
        } else {
   ...
   * @tc.name    Test sim.addIccDiallingNumbers(soltId: 3, type: 1, diallingNumbers:
   *             {recordNumber: 1, alphaTag: 'test', number: '12345678', pin2: '123@#ABCD'},
   *             callback: AsyncCallback<void>) async callback interface, expect enter error.
   * @tc.desc    Function test
   */
  it('Telephony_Sim_addIccDiallingNumbers_Async_0800', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1000', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, FIXED_DIALING_INFO, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1100', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, FIXED_DIALING_INFO, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1300', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO, async error => {
      if (error) {
        console.log(`${CASE_NAME} test fail, error: ${error.message}`);
        expect().assertFail();
        await unlockPuk2();
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1400', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO, async error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1500', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, GENERAL_CONTACT_INFO, async error => {
      if (error) {
        console.log(`${CASE_NAME} add error: ${error.message}`);
      }
      sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, async (error, data) => {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1600', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo, async error => {
      if (error) {
        console.log(`${CASE_NAME} test fail, error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_2000', 0, async function (done) {
    ...
    try {
      ...
      await deleteContact(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
      await deleteContact(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo1);
    } catch (error) {
      console.log(`${CASE_NAME} test fail, error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo2, async error => {
      if (error) {
        console.log(`${CASE_NAME} test fail, error: ${error.message}`);
        expect().assertFail();
        done();
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0200', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1, FIXED_DIALING_INFO);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0300', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0800', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1000', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, FIXED_DIALING_INFO);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1100', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, FIXED_DIALING_INFO);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} test finish.`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1300', 0, async function (done) {
    ...
    try {
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1400', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} add`);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO);
      expect().assertFail();
      await unlockPuk2();
      done();
      return;
    ...
    try {
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING);
      expect(numbers.some(record =>
        record.recordNumber === GENERAL_CONTACT_INFO.recordNumber
      )).assertFalse();
      console.log(`${CASE_NAME} test finish.`);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1500', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} add`);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, GENERAL_CONTACT_INFO);
      expect().assertFail();
      done();
      return;
    } catch (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_2000', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo2);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo2);
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    let deleteRecord;
    try {
      deleteRecord = await wrapperStepForDel(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
    } catch (error) {
      expect().assertFail();
      done();
      return;
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo, function (error) {
      if (error) {
      ...
      sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, function (error, data) {
        if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    let recordNumbers = [];
    try {
      const data = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT);
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish.`);
      } else {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    let deleteRecord;
    try {
      deleteRecord = await wrapperStepForDel(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO);
    } catch (error) {
      expect().assertFail();
      done();
      return;
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfo, function (error) {
      if (error) {
        console.log(`${CASE_NAME} delete fail, error:${error.message}`);
        expect().assertFail();
        done();
      ...
      sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, function (error, data) {
        if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish.`);
        done();
   ...
   * @tc.name    Test sim.delIccDiallingNumbers(soltId: 3, type: 1, diallingNumbers: DiallingNumbersInfo,
   *             callback: AsyncCallback<void>) async callback interface, expect enter error.
   * @tc.desc    Function test
   */
  it('Telephony_Sim_delIccDiallingNumbers_Async_0800', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1000', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1100', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} finish.`);
      } else {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1300', 0, async function (done) {
    ...
    let deleteRecord;
    try {
      deleteRecord = await wrapperStepForDel(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO, true);
    } catch (error) {
      expect().assertFail();
      done();
      return;
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo, async error => {
      if (error) {
        console.log(`${CASE_NAME} test fail, error: ${error.message}`);
        expect().assertFail();
        await unlockPuk2();
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1400', 0, async function (done) {
    ...
    let deleteRecord;
    try {
      deleteRecord = await wrapperStepForDel(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO, true);
    } catch (error) {
      expect().assertFail();
      done();
      return;
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfo, async error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfo, error => {
      if (error) {
        console.log(`${CASE_NAME} delete error: ${error.message}`);
      }
      sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, (error, data) => {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0100', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo);
      console.log(`${CASE_NAME} delete`);
    } catch (error) {
      console.log(`${CASE_NAME} delete fail. error: ${error.message}`);
      expect().assertFail();
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfo);
      console.log(`${CASE_NAME} delete`);
    } catch (error) {
      console.log(`${CASE_NAME} delete fail, error:${error.message}`);
      expect().assertFail();
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0500', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0800', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_1000', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_1100', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID,
      sim.GENERAL_CONTACT,
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.FIXED_DIALING, FIXED_DIALING_INFO);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
   ...
   * @tc.name     Test sim.updateIccDiallingNumbers(soltId: 3, type: 1, diallingNumbers:
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_1900', 0, async function (done) {
    ...
    try {
      await wrapperStepForQueryAndUpdate(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, FIXED_DIALING_INFO);
    } catch (error) {
      console.log(`${CASE_NAME} wrapperStepForQueryAndUpdate error: ${error.message}`);
      expect().assertFail();
      done();
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_2300', 0, async function (done) {
    ...
    try {
      await deleteContact(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, GENERAL_CONTACT_INFO);
      await deleteContact(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfo1);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, FIXED_DIALING_INFO);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfoUpdateLower);
    } catch (error) {
      console.log(`${CASE_NAME} test fail, error: ${error.message}`);
      expect().assertFail();
      done();
    ...
    sim.updateIccDiallingNumbers(
      env.DEFAULT_SLOTID,
      sim.GENERAL_CONTACT,
      diallingNumbersInfoUpdateUpper,
      function (error) {
        if (error) {
          console.log(`${CASE_NAME} update fail, error: ${error.message}`);
          expect().assertFail();
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0100', 0, async function (done) {
    ...
    try {
      ...
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} query`);
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT);
      expect(numbers.some(record =>
        record.recordNumber === diallingNumbersInfoUpdate.recordNumber
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0300', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} update`);
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} query`);
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, sim.FIXED_DIALING);
      expect(numbers.some(record =>
        record.recordNumber === diallingNumbersInfoUpdate.recordNumber
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} update`);
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE_MINUS1, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_1100', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} update`);
      await sim.updateIccDiallingNumbers(env.SLOTID3, sim.GENERAL_CONTACT, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_1300', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} update`);
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE0, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_1400', 0, async function (done) {
    ...
    try {
      console.log(`${CASE_NAME} update`);
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE3, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_2300', 0, async function (done) {
    ...
    try {
      ...
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, FIXED_DIALING_INFO);
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfoUpdateLower);
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, sim.GENERAL_CONTACT, diallingNumbersInfoUpdateUpper);
    } catch (error) {
      console.log(`${CASE_NAME} test fail, error: ${error.message}`);
      expect().assertFail();
      done();
