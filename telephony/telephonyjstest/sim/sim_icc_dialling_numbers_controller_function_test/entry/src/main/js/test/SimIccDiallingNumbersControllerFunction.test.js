...
import {SIM_SLOT_ID, OPERATOR_NUM_LENGTH, TIMES_VALUE, CARD_NAME, TYPE_AND_INDEX} from './lib/Const.js';
import {describe, beforeAll, beforeEach, afterEach, afterAll, it, expect} from 'deccjsunit/index';

describe('SimIccDiallingNumbersControllerFunction', function () {
  /**
   * @tc.number Telephony_Sim_renewIccDiallingNumbers_Async_0100
   ...
   *               SlotId =1, type =0, index =1, DiallingNumbersInfo < eFID =0,
   *               recordNumber_=1, alphaTag_=tset_Update,number_=12345678_Update,emails="">
   *            5. Call queryIccDiallingNumbers with slotId parameter 1, type parameter 0,
   *               and expectation 1. Step 4 Return true
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0100', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, async function (error, data) {
      if (error) {
        ...
        for (let i = 0;i < data.length;i++) {
          if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
            try {
              ...
              await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, data[i].recordNumber);
            } catch (error) {
      ...
      try {
        await sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, diallingNumbersInfo);
      ...
      sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, (error, data) => {
        ...
        for (let i = 0;i < data.length;i++) {
          ...
          if (data[i].recordNumber === TYPE_AND_INDEX.index_1) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0200', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0300', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, async function (error, data) {
      if (error) {
      ...
      for (let i = 0;i < data.length;i++) {
        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
          try {
            await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, data[i].recordNumber);
      ...
      const diallingNumbersInfo = {recordNumber: 1, alphaTag: 'test', number: '12345678'};
      try {
        await sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, diallingNumbersInfo);
      ...
      sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, (error, data) => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_0400', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0100', 0, async function (done) {
    try {
      const data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1);
      for (let i = 0;i < data.length;i++) {
        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
          await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, data[i].recordNumber);
    ...
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1).then(data => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0200', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1).then(data => {
      if (data.length === 0) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0300', 0, async function (done) {
    try {
      const data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2);
      for (let i = 0;i < data.length;i++) {
        if (data[i].recordNumber === 1 || data[i].alphaTag === 'test' || data[i].alphaTag === '') {
          await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, data[i].recordNumber);
    ...
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2).then(data => {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_0400', 0, async function (done) {
    sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4).then(function (data) {
      if (data.length === 0) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, diallingNumbersInfo, function (error) {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0200', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, diallingNumbersInfo, function (error) {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_0500', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0200', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1, diallingNumbersInfo);
...
*/
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.addIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4, diallingNumbersInfo);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    let data;
    try {
      data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1);
    ...
    if (!newRecordNumber) {
      ...
      try {
        const _data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1);
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, newRecordNumber, function (error) {
      if (error) {
      ...
      sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, function (error, data) {
        if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0200', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1, newRecordNumber, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0300', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, noExistIndex, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0400', 0, async function (done) {
    ...
    try {
      data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2);
    ...
    if (!newRecordNumber) {
      ...
      try {
        const _data = await sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2);
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, newRecordNumber, function (error) {
      if (error) {
      ...
      sim.queryIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, function (error, data) {
        if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_0500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4, newRecordNumber, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0100', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, newRecordNumber);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0200', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId4, TYPE_AND_INDEX.type_1, newRecordNumber).then(() => {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0300', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, noExistIndex).then(() => {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, newRecordNumber);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_0500', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_4, newRecordNumber).then(() => {
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_0100', 0, async function (done) {
    ...
    sim.updateIccDiallingNumbers(SIM_SLOT_ID.slotId0,
      TYPE_AND_INDEX.type_1,
      diallingNumbersInfoUpdate,
      TYPE_AND_INDEX.index_1, function (error) {
        if (error) {
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0100', 0, async function (done) {
    ...
    try {
      await sim.updateIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_1, diallingNumbersInfoUpdate,
        TYPE_AND_INDEX.index_1);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_0400', 0, async function (done) {
    ...
    try {
      await sim.updateIccDiallingNumbers(SIM_SLOT_ID.slotId0, TYPE_AND_INDEX.type_2, diallingNumbersInfoUpdate,
        TYPE_AND_INDEX.index_1);
    } catch (error) {
