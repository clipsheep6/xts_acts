...
describe('P5_SimNoSimFunctionTest', function () {
  ...
  it('Telephony_Sim_getOperatorConfigs_Async_0500', 0, async function (done) {
    if (hasSimCard) {
      console.error('Test the function without SIM card, but now there is a SIM in the sim slot ');
      done();
      return;
    }
  ...
  it('Telephony_Sim_getOperatorConfigs_Promise_0500', 0, async function (done) {
    ...
    try {
      var data = await sim.getOperatorConfigs(env.DEFAULT_SLOTID);
    } catch (err) {
  ...
  it('Telephony_Sim_hasSimCard_Promise_0700', 0, async function (done) {
    ...
    try {
      var data = await sim.hasSimCard(env.DEFAULT_SLOTID);
      expect(data).assertFalse();
    } catch (err) {
  ...
  it('Telephony_Sim_isSimActive_Async_0800', 0, async function (done) {
    ...
    sim.isSimActive(env.SLOTID_MINUS1, (err, data) => {
      ...
      sim.getSimState(env.DEFAULT_SLOTID, (err, value) => {
        if (err) {
  ...
  it('Telephony_Sim_isSimActive_Promise_0800', 0, async function (done) {
    ...
    try {
      var data = await sim.isSimActive(env.DEFAULT_SLOTID);
      expect(data).assertFalse();
      try {
        var value = await sim.getSimState(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_activateSim_Async_0700', 0, async function (done) {
    ...
    sim.activateSim(env.DEFAULT_SLOTID, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_activateSim_Promise_0700', 0, async function (done) {
    ...
    try {
      var data = await sim.activateSim(env.DEFAULT_SLOTID);
    } catch (err) {
  ...
  it('Telephony_Sim_deactivateSim_Async_0700', 0, async function (done) {
    ...
    sim.deactivateSim(env.DEFAULT_SLOTID, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_getShowName_Async_0800', 0, async function (done) {
    ...
    sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME, (err) => {
      if (err) {
        ...
        sim.getShowName(env.DEFAULT_SLOTID, (geterr, getdata) => {
          if (geterr) {
  ...
  it('Telephony_Sim_getShowName_Promise_0800', 0, async function (done) {
    ...
    try {
      ...
      try {
        await sim.getShowName(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_getShowNumber_Async_0700', 0, async function (done) {
    ...
    sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_getShowNumber_Promise_0700', 0, async function (done) {
    ...
    try {
      await sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME);
      ...
      try {
        await sim.getShowNumber(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_getSimTelephoneNumber_Promise_0700', 0, async function (done) {
    ...
    try {
      var data = await sim.getSimTelephoneNumber(env.DEFAULT_SLOTID);
    } catch (err) {
  ...
  it('Telephony_Sim_getVoiceMailIdentifier_Promise_0700', 0, async function (done) {
    ...
    try {
      var data = await sim.getVoiceMailIdentifier(env.DEFAULT_SLOTID);
    } catch (err) {
  ...
  it('Telephony_Sim_getVoiceMailNumber_Promise_0700', 0, async function (done) {
    ...
    try {
      var data = await sim.getVoiceMailNumber(env.DEFAULT_SLOTID);
    } catch (err) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Async_1100', 0, async function (done) {
    ...
    sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, (error, data) => {
      if (error) {
  ...
  it('Telephony_Sim_queryIccDiallingNumbers_Promise_1100', 0, async function (done) {
    ...
    try {
      const numbers = await sim.queryIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1);
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Async_1200', 0, async function (done) {
    ...
    sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_addIccDiallingNumbers_Promise_1200', 0, async function (done) {
    ...
    const diallingNumbersInfo = { recordNumber: 1, alphaTag: 'test', number: '12345678', pin2: '123@#ABCD' };
    try {
      await sim.addIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} error: ${error.message}`);
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Async_1200', 0, async function (done) {
    ...
    sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfo, error => {
      if (error) {
  ...
  it('Telephony_Sim_delIccDiallingNumbers_Promise_1200', 0, async function (done) {
    ...
    let diallingNumbersInfo = { recordNumber: 1, alphaTag: 'test', number: '12345678', pin2: '123@#ABCD' };
    try {
      await sim.delIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfo);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Async_1500', 0, async function (done) {
    ...
    sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfoUpdate, error => {
      if (error) {
        console.log(`${CASE_NAME} expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish.`);
      } else {
  ...
  it('Telephony_Sim_updateIccDiallingNumbers_Promise_1500', 0, async function (done) {
    ...
    try {
      await sim.updateIccDiallingNumbers(env.DEFAULT_SLOTID, env.NUM_TYPE1, diallingNumbersInfoUpdate);
      console.log(`${CASE_NAME} test fail.`);
      expect().assertFail();
    } catch (error) {
      console.log(`${CASE_NAME} expect error: ${error.message}`);
  ...
  it('Telephony_Sim_unlockPin2_Async_1100', 0, async function (done) {
    ...
    sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2, (err, data) => {
      if (err) {
  ...
  */
  it('Telephony_Sim_unlockPin2_Promise_1100', 0, async function (done) {
    ...
    let data;
    try {
      data = await sim.unlockPin2(env.DEFAULT_SLOTID, env.INCORRECT_PIN2);
    } catch (err) {
  ...
  it('Telephony_Sim_unlockPuk2_Async_1200', 0, async function (done) {
    ...
    sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_unlockPuk2_Promise_1200', 0, async function (done) {
    ...
    let data;
    try {
      data = await sim.unlockPuk2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.INCORRECT_PUK2);
    } catch (err) {
  ...
  it('Telephony_Sim_alterPin2_Promise_1200', 0, async function (done) {
    ...
    let data;
    try {
      data = await sim.alterPin2(env.DEFAULT_SLOTID, env.CORRECT_PIN2, env.CORRECT_PIN2);
    } catch (err) {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Async_0700', 0, function (done) {
    ...
    sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN20, error => {
      if (error) {
  ...
  it('Telephony_Sim_setVoiceMailInfo_Promise_0700', 0, async function (done) {
    ...
    try {
      await sim.setVoiceMailInfo(env.DEFAULT_SLOTID, env.MAIL_NAME_LEN12, env.MAIL_NUMBER_LEN20);
