...
describe('SimGetISOCountryCodeForSimFunctionTest', function () {

  /**
   * @tc.number Telephony_Sim_GetISOCountryCodeForSim_Async_0500
   * @tc.name   CDMA file, test GetISOCountryCodeForSim async callback interface
  ...
  /**
   * @tc.number  Telephony_Sim_GetISOCountryCodeForSim_Async_0600
   * @tc.name    CDMA file, GetISOCountryCodeForSim async callback interface slotId
   *             exception enters parameter -1 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetISOCountryCodeForSim_Async_0600', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_GetISOCountryCodeForSim_Async_0600';
    sim.getISOCountryCodeForSim(env.SLOTID_MINUS1, error => {
      if (error) {
  ...
  /**
   * @tc.number  Telephony_Sim_GetISOCountryCodeForSim_Async_0800
   * @tc.name    CDMA file, GetISOCountryCodeForSim async callback interface slotId
   *             exception enters parameter 2 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetISOCountryCodeForSim_Async_0800', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_GetISOCountryCodeForSim_Async_0800';
    sim.getISOCountryCodeForSim(env.SLOTID2, error => {
      if (error) {
        console.log(`${CASE_NAME} getISOCountryCodeForSim expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish.`);
        done();
  ...
  /**
   * @tc.number Telephony_Sim_GetISOCountryCodeForSim_Promise_0500
   * @tc.name   CDMA file, test GetISOCountryCodeForSim promise interface slotId
  ...
  /**
   * @tc.number  Telephony_Sim_GetISOCountryCodeForSim_Promise_0600
   * @tc.name    CDMA file, GetISOCountryCodeForSim promise interface slotId
   *             exception enters parameter -1 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetISOCountryCodeForSim_Promise_0600', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetISOCountryCodeForSim_Promise_0600';
    try {
      await sim.getISOCountryCodeForSim(env.SLOTID_MINUS1);
      expect().assertFail();
      console.log(`${CASE_NAME} test fail.`);
    } catch (error) {
      console.log(`${CASE_NAME} getISOCountryCodeForSim expect error: ${error.message}`);
  ...
  /**
   * @tc.number  Telephony_Sim_GetISOCountryCodeForSim_Promise_0800
   * @tc.name    CDMA file, GetISOCountryCodeForSim promise interface slotId
   *             exception enters parameter 2 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetISOCountryCodeForSim_Promise_0800', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetISOCountryCodeForSim_Promise_0800';
    try {
      await sim.getISOCountryCodeForSim(env.SLOTID2);
      expect().assertFail();
      console.log(`${CASE_NAME} test fail.`);
    } catch (error) {
      console.log(`${CASE_NAME} getISOCountryCodeForSim expect error: ${error.message}`);
