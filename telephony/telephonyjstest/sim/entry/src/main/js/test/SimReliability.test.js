...
import {simSlotId, timesValue, OTHER_ABNORMAL, OPERATOR_NUM_LENGTH, operatorCode} from '../default/utils/Constant.test.js'
...
describe('SimReliability', function () {
    ...
    it("Telephony_Sim_getSimSpn_Async_0400", 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            sim.getSimSpn(simSlotId.SLOTID_1, (err, data) => {
                ...
                expect(data != "" && data != undefined).assertTrue()
                sim.getSimOperatorNumeric(simSlotId.SLOTID_1, (err, value) => {
                    if (err) {
    ...
    it("Telephony_Sim_getSimSpn_Promise_0400", 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                ...
                expect(data != "" && data != undefined).assertTrue()
                try {
                    var value = await sim.getSimOperatorNumeric(simSlotId.SLOTID_1)
                    console.log("Telephony_Sim_getSimSpn_Promise_0400, value : " + value)
                    if ((value == operatorCode.MOBILE_CODE_1) || (value == operatorCode.MOBILE_CODE_2) ||
                            (value == operatorCode.MOBILE_CODE_3) || (value == operatorCode.MOBILE_CODE_4)) {
                        expect(data == mobileSpn).assertTrue()
                    } else if ((value == operatorCode.UNICOM_CODE_1) || (value == operatorCode.UNICOM_CODE_2) ||
    ...
    /**
     * @tc.number  Telephony_Sim_getSimSubscriptionInfo_Async_0400
     * @tc.name    The test executed the getSimSubscriptionInfo interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it("Telephony_Sim_getSimSubscriptionInfo_Async_0400", 0, async function (done) {
        var diSpname = "simDefaultDisplayName"
        var diSpnum = "simDefaultDisplayNumber"
        function Recursive(n) {
            if(n <= 0) {
                console.log("Telephony_Sim_getSimSubscriptionInfo_Async_0400 finish")
                done()
                return
            }
            sim.getSimSubscriptionInfo(simSlotId.SLOTID_1, (err, data) => {
                if (err) {
                    console.log("Telephony_Sim_getSimSubscriptionInfo_Async_0400 fail, err : " + err.message)
                    expect().assertFail()
                    done()
                    return
                }
    ...
    /**
     * @tc.number  Telephony_Sim_getSimSubscriptionInfo_Promise_0400
     * @tc.name    The test executed the getSimSubscriptionInfo interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it("Telephony_Sim_getSimSubscriptionInfo_Promise_0400", 0, async function (done) {
        var diSpname = "simDefaultDisplayName"
        var diSpnum = "simDefaultDisplayNumber"
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                ...
                console.log("Telephony_Sim_getSimSubscriptionInfo_Promise_0400 fail, err : " + err.message)
                expect().assertFail()
                done()
                return
            }
        }
        console.log("Telephony_Sim_getSimSubscriptionInfo_Promise_0400 finish")
        done()
    })
    ...
    it("Telephony_Sim_getDefaultVoiceSlotId_Async_0400", 0, async function (done) {
        ...
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
                console.log("Telephony_Sim_getDefaultVoiceSlotId_Async_0400 getDefaultVoiceSlotId_fail, err: " + err.message)
                expect().assertFail()
                done()
                return
            }
        ...
        sim.setDefaultVoiceSlotId(simSlotId.SLOTID_1, (err, value) => {
            if (err) {
                console.log("Telephony_Sim_getDefaultVoiceSlotId_Async_0400：setDefaultVoiceSlotId_err")
                expect().assertFail()
                done()
                return
            }
            if (value) {
                function Recursive(n) {
                    if(n <= 0) {
                        sim.setDefaultVoiceSlotId(defaultValue, (err, ret) => {
                            if (err) {
                                console.log("Telephony_Sim_getDefaultVoiceSlotId_Async_0400 setDefaultVoiceSlotId_err: " + err.message)
                                expect().assertFail()
                                done()
                                return
                            }
                ...
                expect().assertFail()
                console.log("Telephony_Sim_getDefaultVoiceSlotId_Async_0400:setDefaultVoiceSlotId_fail")
                done()
            }
        })
    })
    ...
    it("Telephony_Sim_getDefaultVoiceSlotId_Promise_0400", 0, async function (done) {
        ...
        try {
            ...
            console.log("Telephony_Sim_getDefaultVoiceSlotId_Promise_0400:setDefaultVoiceSlotId_err")
            expect().assertFail()
            done()
            return
        }
    ...
    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSlotId_Async_0500
     * @tc.name    The test executed the setDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it("Telephony_Sim_setDefaultVoiceSlotId_Async_0500", 0, async function (done) {
        var defaultValue = 0
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
                console.log("Telephony_Sim_setDefaultVoiceSlotId_Async_0500 getDefaultVoiceSlotId_fail, err: " + err.message)
                expect().assertFail()
                done()
                return
            }
        ...
        function Recursive(n) {
            if(n <= 0) {
                sim.setDefaultVoiceSlotId(defaultValue, (err, ret) => {
                    if (err) {
                        console.log("Telephony_Sim_setDefaultVoiceSlotId_Async_0500 setDefaultVoiceSlotId_err: " + err.message)
                        expect().assertFail()
                        done()
                        return
                    }
                })
                console.log("Telephony_Sim_setDefaultVoiceSlotId_Async_0500 finish")
                done()
                return
            }
            sim.setDefaultVoiceSlotId(simSlotId.SLOTID_1, (err, data) => {
                if (err) {
                    console.log("Telephony_Sim_setDefaultVoiceSlotId_Async_0500 fail, err : " + err.message)
                    expect().assertFail()
                    done()
                    return
                }
    ...
    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSlotId_Promise_0500
     * @tc.name    The test executed the setDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it("Telephony_Sim_setDefaultVoiceSlotId_Promise_0500", 0, async function (done) {
        var defaultValue = 0
        var result = await sim.getDefaultVoiceSlotId()
        defaultValue = result
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                ...
                console.log("Telephony_Sim_setDefaultVoiceSlotId_Promise_0500 fail, err : " + err.message)
                expect().assertFail()
                done()
                return
            }
        ...
        await sim.setDefaultVoiceSlotId(defaultValue)
        console.log("Telephony_Sim_setDefaultVoiceSlotId_Promise_0500 finish")
        done()
    })
    ...
    it("Telephony_Sim_setLockState_Async_0400", 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            sim.setLockState(PIN, OPEN, simSlotId.SLOTID_1, (err, data) => {
                if (err) {
    ...
    it("Telephony_Sim_setLockState_Promise_0400", 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                var data = await sim.setLockState(PIN, OPEN, simSlotId.SLOTID_1)
                expect(data.isNoraml).assertTrue()
                expect(data.result == OTHER_ABNORMAL).assertTrue()
            } catch (err) {
