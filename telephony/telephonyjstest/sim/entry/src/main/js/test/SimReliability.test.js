...
describe('SimReliability', function () {
    ...
    */
    ...
    /**
     * @tc.number  Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400
     * @tc.name    The test executed the getDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400', 0, async function (done) {
        var defaultValue = 0;
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
                console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400 getDefaultVoiceSLOT_ID_fail, err: '
                + err.message);
                expect().assertFail();
                done();
                return;
        ...
        sim.setDefaultVoiceSlotId(simSlotId.SLOT_ID_0, (err) => {
            if (err) {
                console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400：setDefaultVoiceSLOT_ID_err');
                expect().assertFail();
                done();
                return;
            }
            ...
            function Recursive(n) {
                if (n <= 0) {
                    ...
                    console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400 finish');
                    done();
                    return;
                }
                sim.getDefaultVoiceSlotId((err, data) => {
                    if (err) {
                        console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0400 fail, err : ' + err.message);
                        expect().assertFail();
                        done();
                        return;
                    }
    ...
    /**
     * @tc.number  Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0400
     * @tc.name    The test executed the getDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0400', 0, async function (done) {
        var defaultValue = 0;
        ...
        try {
            ...
            for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
                try {
                    ...
                    console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0400 fail, err : ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
            ...
            console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0400 finish');
            done();
            return;
        } catch (err) {
            console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0400 setDefaultVoiceSLOT_ID_err' + err.message);
            expect().assertFail();
            done();
            return;
        }
    ...
    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0300
     * @tc.name    The test executed the setDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0300', 0, async function (done) {
        var defaultValue = 0;
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
        ...
        function Recursive(n) {
            if (n <= 0) {
                sim.setDefaultVoiceSlotId(defaultValue, (err) => {
                    if (err) {
                        console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0300 setDefaultVoiceSLOT_ID_err: '
                        + err.message);
                        expect().assertFail();
                        done();
                        return;
                ...
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0300 finish');
                done();
                return;
            }
            sim.setDefaultVoiceSlotId(simSlotId.SLOT_ID_0, (err) => {
                if (err) {
                    console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0300 fail, err : ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0300
     * @tc.name    The test executed the setDefaultVoiceSlotId interface query function ten times,
     *             expecting to execute successfully each time.
     * @tc.desc    Reliability test
     */
    it('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0300', 0, async function (done) {
        var defaultValue = 0;
        var result = await sim.getDefaultVoiceSlotId();
        defaultValue = result
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0300 fail, err : ' + err.message);
                expect().assertFail();
                done();
                return;
            }
