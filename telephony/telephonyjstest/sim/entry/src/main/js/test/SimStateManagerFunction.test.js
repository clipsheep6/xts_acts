...
describe('SimStateManagerFunction', function () {
    ...
    */
    it('Telephony_Sim_getSimState_Async_0200', 0, async function (done) {
        sim.getSimState(simSlotId.SLOTID_4, (err, data) => {
            if (err) {
    ...
    */
    it('Telephony_Sim_getSimState_Promise_0200', 0, async function (done) {
        try {
            var data = await sim.getSimState(simSlotId.SLOTID_4);
        } catch (err) {
            // Enter the exception ID to enter error.
    ...
    * @tc.name    The status of the card is EX_READYD, the unlockPin interface is tested, and slotId is abnormal.
    * @tc.desc    Function test
    */
    it('Telephony_Sim_unlockPin_Async_0400', 0, async function (done) {
        var PIN = '1234';
        sim.unlockPin(PIN, simSlotId.SLOTID_4, (err, data) => {
            if (err) {
                // Enter the exception ID to enter error.
    ...
    */
    it('Telephony_Sim_unlockPin_Promise_0400', 0, async function (done) {
        var PIN = '1234'
        try {
            await sim.unlockPin(PIN, simSlotId.SLOTID_4);
        } catch (err) {
            // Enter the exception ID to enter error.
    ...
    * @tc.name    The card status is EX_READYD, and the unlockPuk interface is tested. The slotId parameter is abnormal.
    * @tc.desc    Function test
    */
    it('Telephony_Sim_unlockPuk_Async_0400', 0, async function (done) {
        var newPin = '1234';
        var PUK = '12345678';
        sim.unlockPuk(newPin, PUK, simSlotId.SLOTID_4, (err, data) => {
            if (err) {
                // Enter the exception ID to enter error.
    ...
    */
    it('Telephony_Sim_unlockPuk_Promise_0400', 0, async function (done) {
        ...
        var PUK = '12345678';
        try {
            await sim.unlockPuk(newPin, PUK, simSlotId.SLOTID_4);
        } catch (err) {
            // Enter the exception ID to enter error.
    ...
    * @tc.name    The status of the card is EX_READYD, and the alterPin interface is tested. SlotId is abnormal.
    * @tc.desc    Function test
    */
    it('Telephony_Sim_alterPin_Async_0400', 0, async function (done) {
        var oldPin = '9999';
        var newPin = '1234';
        sim.alterPin(oldPin, newPin, simSlotId.SLOTID_4, (err, data) => {
            if (err) {
                // Enter the exception ID to enter error.
    ...
    */
    it('Telephony_Sim_alterPin_Promise_0400', 0, async function (done) {
        ...
        var newPin = '1234';
        try {
            var data = await sim.alterPin(oldPin, newPin, simSlotId.SLOTID_4);
            expect(data.result == OTHER_ABNORMAL).assertTrue();
        } catch (err) {
    ...
    */
    it('Telephony_Sim_setLockState_Async_0200', 0, async function (done) {
        var PIN = '0123456789';
        sim.setLockState(PIN, lockSwitch.CLOSE, simSlotId.SLOTID_0, (err, data) => {
            if (err) {
    ...
    */
    it('Telephony_Sim_setLockState_Async_0500', 0, async function (done) {
        var PIN = '0123456789';
        sim.setLockState(PIN, lockSwitch.OPEN, simSlotId.SLOTID_4, (err, data) => {
            if (err) {
                // Enter the exception ID to enter error.
    ...
    */
    it('Telephony_Sim_setLockState_Promise_0200', 0, async function (done) {
        var PIN = '0123456789';
        try {
            var data = await sim.setLockState(PIN, lockSwitch.CLOSE, simSlotId.SLOTID_0);
            expect(data.result == OTHER_ABNORMAL).assertTrue();
        } catch (err) {
    ...
    */
    it('Telephony_Sim_setLockState_Promise_0500', 0, async function (done) {
        var PIN = '0123456789'
        try {
            await sim.setLockState(PIN, lockSwitch.OPEN, simSlotId.SLOTID_4);
        } catch (err) {
            // Enter the exception ID to enter error.
