...
import {simSlotId, OPERATOR_NUM_LENGTH, operatorCode} from '../default/utils/Constant.test.js'
   ...
   */
   it('Telephony_Sim_getISOCountryCodeForSim_Async_0100', 0, async function (done) {
      ...
      sim.getISOCountryCodeForSim(simSlotId.SLOTID_1, (err, data) => {
         ...
         console.log("Telephony_Sim_getISOCountryCodeForSim_Async_0100 fail, data : " + data)
   ...
   */
   it('Telephony_Sim_getISOCountryCodeForSim_Async_0200', 0, async function (done) {
      sim.getISOCountryCodeForSim(simSlotId.SLOTID_0, (err, data) => {
         if (err) {
            // Expect slotid 0 return err here.
