...
describe('SimTest', function () {
    ...
    it('Telephony_Sim_getIMSI_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getIMSI(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimIccId_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimIccId(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getISOCountryCodeForSim_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getISOCountryCodeForSim(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimOperatorNumeric_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimOperatorNumeric(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimSpn_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimSpn(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimState_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimState(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimGid1_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimGid1(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_getSimAccountInfo_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getSimAccountInfo(simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_setDefaultVoiceSlotId_Async_0200', 0, async function (done) {
        ...
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
                console.log('Telephony_Sim_setDefaultVoiceSlotId_Async_0200 getDefaultVoiceSlotId_fail, err: '
                + err.message);
                expect().assertFail();
                done();
                return;
        ...
        function Recursive(n) {
            if (n <= 0) {
                ...
                sim.setDefaultVoiceSlotId(defaultValue, (err, ret) => {
                    if (err) {
                        console.log('Telephony_Sim_setDefaultVoiceSlotId_Async_0200 setDefaultVoiceSlotId_err: '
                        + err.message);
                        expect().assertFail();
                        done();
                        return;
            ...
            startTime = new Date().getTime();
            sim.setDefaultVoiceSlotId(simSlotId.SLOTID_0, (err, data) => {
                endTime = new Date().getTime();
                totalTime += endTime - startTime;
                if (err) {
    ...
    it('Telephony_Sim_unlockPin_Promise_0200', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.unlockPin(PIN, simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_unlockPuk_Promise_0200', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.unlockPuk(newPin, PUK, simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_alterPin_Promise_0200', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.alterPin(oldPin, newPin, simSlotId.SLOTID_0);
            } catch (err) {
    ...
    it('Telephony_Sim_setLockState_Promise_0300', 0, async function (done) {
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.setLockState(PIN, lockSwitch.OPEN, simSlotId.SLOTID_0);
            } catch (err) {
