...
describe('SimPerformance', function () {
    ...
    it('Telephony_Sim_getIMSI_Async_0300', 0, async function (done) {
        ...
        function Recursive(n) {
            ...
            sim.getIMSI(simSlotId.SLOTID＿0, (err, data) => {
    ...
    /**
     * @tc.number  Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0300
     * @tc.name    Test the getDefaultVoiceSlotId interface query function ten times
     *             and expect a delay of less than timesValue.TIME_SPAN millisecond.
     * @tc.desc    Performance test
     */
    it('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0300', 0, async function (done) {
        var totalTime = 0;
        var startTime = 0;
        var endTime = 0;
        ...
        function Recursive(n) {
            if (n <= 0) {
                expect(totalTime).assertLess(timesValue.TIME_SPAN);
                console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0300 exec done useTime:' + totalTime + 'ms');
                console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0300 finish');
                done();
                return;
            }
            startTime = new Date().getTime();
            sim.getDefaultVoiceSlotId((err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Async_0300 fail, err : ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    /**
     * @tc.number  Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0300
     * @tc.name    Test the getDefaultVoiceSlotId interface query function ten times
     *             and expect a delay of less than timesValue.TIME_SPAN millisecond.
     * @tc.desc    Performance test
     */
    it('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0300', 0, async function (done) {
        const startTime = new Date().getTime();
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                await sim.getDefaultVoiceSlotId();
            } catch (err) {
                console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0300 fail, err : ' + err.message);
                expect().assertFail();
                done();
                return;
            }
        ...
        const endTime = new Date().getTime();
        expect(endTime - startTime).assertLess(timesValue.TIME_SPAN);
        console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0300 : useTime : ' + (endTime - startTime) + 'ms');
        console.log('Telephony_Sim_getDefaultVoiceSLOT_ID_Promise_0300 finish');
        done();
    })

    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200
     * @tc.name    Test the setDefaultVoiceSlotId interface query function ten times
     *             and expect a delay of less than timesValue.TIME_SPAN millisecond.
     * @tc.desc    Performance test
     */
    it('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200', 0, async function (done) {
        var totalTime = 0;
        var startTime = 0;
        var endTime = 0;
        var defaultValue = 0
        sim.getDefaultVoiceSlotId((err, result) => {
            if (err) {
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200 getDefaultVoiceSLOT_ID_fail, err: '
                + err.message);
                expect().assertFail();
                done();
                return;
        ...
        function Recursive(n) {
            if (n <= 0) {
                expect(totalTime).assertLess(timesValue.TIME_SPAN);
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200 exec done useTime:' + totalTime + 'ms');
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200 finish');
                sim.setDefaultVoiceSlotId(defaultValue, (err, ret) => {
                    if (err) {
                        console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200 setDefaultVoiceSLOT_ID_err: '
                        + err.message);
                        expect().assertFail();
                        done();
                        return;
            ...
            sim.setDefaultVoiceSlotId(simSlotId.SLOT_ID_0, (err, data) => {
                ...
                totalTime += endTime - startTime;
                if (err) {
                    console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Async_0200 fail, err : ' + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
    ...
    /**
     * @tc.number  Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0200
     * @tc.name    Test the setDefaultVoiceSlotId interface query function ten times
     *             and expect a delay of less than timesValue.TIME_SPAN millisecond.
     * @tc.desc    Performance test
     */
    it('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0200', 0, async function (done) {
        var defaultValue = 0
        ...
        for (let index = 0; index < timesValue.TEST_RUN_TIME; index++) {
            try {
                ...
                console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0200 fail, err : ' + err.message);
                expect().assertFail();
                done();
                return;
            }
        ...
        const endTime = new Date().getTime();
        expect(endTime - startTime).assertLess(timesValue.TIME_SPAN);
        console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0200 : useTime : ' + (endTime - startTime) + 'ms');
        var ret = await sim.setDefaultVoiceSlotId(defaultValue);
        expect(ret).assertTrue();
        console.log('Telephony_Sim_setDefaultVoiceSLOT_ID_Promise_0200 finish');
        done();
    })
