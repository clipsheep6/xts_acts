...
describe('SimAccountInformationManagerFunction', function () {
  ...
  it('Telephony_Sim_deactivateSim_Async_0500', 0, async function (done) {
    sim.deactivateSim(SIM_SLOT_ID.slotId1, (err) => {
      if (err) {
   ...
   *             value, expect to return 01234567890123456789_ test @#$%ABCDE
   * @tc.desc    Function test
   */
   ...
   * @tc.name    Test SetShowName Interface name enter valid mixed values, check the
   *             callback value, expect to return 01234567890123456789_ test @#$%ABCDE
   * @tc.desc    Function test
   */
  ...
  it('Telephony_Sim_getShowName_Promise_0300', 0, async function (done) {
    try {
      var data = await sim.getShowName(SIM_SLOT_ID.slotId11);
    } catch (err) {
  ...
  it('Telephony_Sim_getShowName_Promise_0600', 0, async function (done) {
    try {
      var data = await sim.getShowName(SIM_SLOT_ID.slotId1);
    } catch (err) {
      console.log('Telephony_Sim_getShowName_Promise_0600 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getShowName_Promise_0600, data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_getShowName_Promise_0700', 0, async function (done) {
    try {
      var data = await sim.getShowName(SIM_SLOT_ID.slotId2);
    } catch (err) {
      console.log('Telephony_Sim_getShowName_Promise_0700 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getShowName_Promise_0700, data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_setShowNumber_Async_0100', 0, async function (done) {
    sim.setShowNumber(SIM_SLOT_ID.slotId11, CARD_NAME.cardNumber, (err, data) => {
      if (err) {
   ...
   * @tc.name    Test setShowNumber slotId exception input parameter 1, check the callback
   *             value, and expect to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowNumber_Async_0600', 0, async function (done) {
    sim.setShowNumber(SIM_SLOT_ID.slotId1, CARD_NAME.cardNumber, (err, data) => {
      if (err) {
        console.log('Telephony_Sim_setShowNumber_Async_0600  finish');
        done();
        return;
      }
      console.log(`Telephony_Sim_setShowNumber_Async_0600  data : ${data}`);
      expect().assertFail();
      done();
    });
  });
  ...
  it('Telephony_Sim_setShowNumber_Async_0700', 0, async function (done) {
    sim.setShowNumber(SIM_SLOT_ID.slotId2, CARD_NAME.cardNumber, (err, data) => {
      if (err) {
        console.log('Telephony_Sim_setShowNumber_Async_0700  finish');
        done();
        return;
      }
      console.log(`Telephony_Sim_setShowNumber_Async_0700  data : ${data}`);
      expect().assertFail();
      done();
    });
  });
   ...
   * @tc.name    Test SetShowNumber interface number Enter mixed valid values, check the return value,
   *             expect a callback value of 01234567890123456789_ test @#$%ABCDE
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowNumber_Async_0800', 0, async function (done) {
    sim.setShowNumber(SIM_SLOT_ID.slotId0, CARD_NAME.cardNameYouXiaoLong, (err) => {
      if (err) {
      ...
      sim.getShowNumber(SIM_SLOT_ID.slotId0, (err, value) => {
        ...
        expect(value === CARD_NAME.cardNameYouXiaoLong).assertTrue();
      });
    });
  });
  ...
  it('Telephony_Sim_setShowNumber_Promise_0100', 0, async function (done) {
    try {
      var data = await sim.setShowNumber(SIM_SLOT_ID.slotId11, CARD_NAME.cardNumber);
    } catch (err) {
  ...
  it('Telephony_Sim_setShowNumber_Promise_0600', 0, async function (done) {
    try {
      var data = await sim.setShowNumber(SIM_SLOT_ID.slotId1, CARD_NAME.cardNumber);
    } catch (err) {
      console.log('Telephony_Sim_setShowNumber_Promise_0600 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_setShowNumber_Promise_0600 setShowNumber , data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_setShowNumber_Promise_0700', 0, async function (done) {
    try {
      var data = await sim.setShowNumber(SIM_SLOT_ID.slotId2, CARD_NAME.cardNumber);
    } catch (err) {
      console.log('Telephony_Sim_setShowNumber_Promise_0700 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_setShowNumber_Promise_0700 setShowNumber , data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_setShowNumber_Promise_0800', 0, async function (done) {
    try {
      var data = await sim.setShowNumber(SIM_SLOT_ID.slotId0, CARD_NAME.cardNameYouXiao);
      try {
        var value = await sim.getShowNumber(SIM_SLOT_ID.slotId0);
        expect(CARD_NAME.cardNameYouXiao === value).assertTrue();
      } catch (err) {
  ...
  it('Telephony_Sim_getShowNumber_Async_0200', 0, async function (done) {
    sim.getShowNumber(SIM_SLOT_ID.slotId11, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
   ...
   * @tc.name    Test getShowNumber slotId exception input parameter 1, check the callback
   *             value, and expect to enter ERR
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getShowNumber_Async_0500', 0, async function (done) {
    sim.getShowNumber(SIM_SLOT_ID.slotId1, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
        console.log('Telephony_Sim_getShowNumber_Async_0500 finish');
        done();
        return;
      }
      console.log(`Telephony_Sim_getShowNumber_Async_0500 , data : ${data}`);
      expect().assertFail();
      done();
    });
  });
   ...
   * @tc.name    Test getShowNumber slotId exception input parameter 2, check the
   *             callback value, and expect to enter ERR
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getShowNumber_Async_0600', 0, async function (done) {
    sim.getShowNumber(SIM_SLOT_ID.slotId2, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
      ...
      console.log(`Telephony_Sim_getShowNumber_Async_0600 , data : ${data}`);
      expect().assertFail();
      done();
    });
  });
  ...
  it('Telephony_Sim_getShowNumber_Promise_0200', 0, async function (done) {
    try {
      var data = await sim.getShowNumber(SIM_SLOT_ID.slotId11);
    } catch (err) {
      console.log('Telephony_Sim_getShowNumber_Promise_0200 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getShowNumber_Promise_0200, data : ${data}`);
    expect().assertFail();
    done();
  });
   ...
   * @tc.name    Test getShowNumber slotId exception input parameter 1, check
  ...
  it('Telephony_Sim_getShowNumber_Promise_0500', 0, async function (done) {
    try {
      var data = await sim.getShowNumber(SIM_SLOT_ID.slotId1);
    } catch (err) {
      console.log('Telephony_Sim_getShowNumber_Promise_0500 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getShowNumber_Promise_0500, data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_getShowNumber_Promise_0600', 0, async function (done) {
    try {
      var data = await sim.getShowNumber(SIM_SLOT_ID.slotId2);
    } catch (err) {
      console.log('Telephony_Sim_getShowNumber_Promise_0600 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getShowNumber_Promise_0600, data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_getOperatorConfigs_Async_0200', 0, async function (done) {
    sim.getOperatorConfigs(SIM_SLOT_ID.slotId11, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
  ...
  it('Telephony_Sim_getOperatorConfigs_Async_0600', 0, async function (done) {
    sim.getOperatorConfigs(SIM_SLOT_ID.slotId3, (err, data) => {
      if (err) {
        console.log('Telephony_Sim_getOperatorConfigs_Async_0600 finish');
        done();
        return;
      }
  ...
  it('Telephony_Sim_getOperatorConfigs_Promise_0200', 0, async function (done) {
    try {
      var data = await sim.getOperatorConfigs(SIM_SLOT_ID.slotId11);
    } catch (err) {
      console.log('Telephony_Sim_getOperatorConfigs_Promise_0200 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getOperatorConfigs_Promise_0200, data : ${data}`);
    expect().assertFail();
    done();
  });
  ...
  it('Telephony_Sim_getOperatorConfigs_Promise_0600', 0, async function (done) {
    try {
      var data = await sim.getOperatorConfigs(SIM_SLOT_ID.slotId3);
    } catch (err) {
      console.log('Telephony_Sim_getOperatorConfigs_Promise_0600 finish');
      done();
      return;
    }
    console.log(`Telephony_Sim_getOperatorConfigs_Promise_0600, data : ${data}`);
    expect().assertFail();
    done();
  });
});