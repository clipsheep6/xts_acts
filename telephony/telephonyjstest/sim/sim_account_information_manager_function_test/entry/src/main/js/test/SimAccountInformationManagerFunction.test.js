...
describe('SimAccountInformationManagerFunction', function () {
  ...
  let defaultName = 'Card0';
  const waitingForNetworkReady = 3;
  ...
  const setShowNameWriteToPromise = function () {
    return new Promise((resolve, reject) => {
      sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME, (err) => {
        if (err) {
  ...
  const setShowNumberWriteToPromise = function () {
    return new Promise((resolve, reject) => {
      sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NUMBER, (err) => {
        if (err) {
  ...
  const getSimIccIdWriteToPromise = function () {
    return new Promise((resolve, reject) => {
      sim.getSimIccId(env.DEFAULT_SLOTID, (err, result) => {
        if (err) {
  ...
  const restoreDefaultShowName = function () {
    return new Promise((resolve, reject) => {
      sim.setShowName(env.DEFAULT_SLOTID, defaultName, (err) => {
        if (err) {
  ...
  beforeAll(async function () {
    ...
    try {
      let isActiveState = await sim.isSimActive(env.DEFAULT_SLOTID);
      if (!isActiveState) {
        await sim.activateSim(env.DEFAULT_SLOTID);
        await sleep(60);
      }
      let operatorName = await radio.getOperatorName(env.DEFAULT_SLOTID);
      if (operatorName !== '') {
  ...
  it('Telephony_Sim_getActiveSimAccountInfoList_Async_0100', 0, async function (done) {
    sim.activateSim(env.DEFAULT_SLOTID, async (err) => {
      if (err) {
      ...
      sim.getActiveSimAccountInfoList(async (err, info) => {
        ...
        expect(info.some(item =>
          item.slotIndex === env.DEFAULT_SLOTID
          && item.isEsim === false
          && item.isActive === true
          && item.iccId === result
  ...
  it('Telephony_Sim_getActiveSimAccountInfoList_Promise_0100', 0, async function (done) {
    try {
      await sim.activateSim(env.DEFAULT_SLOTID);
      await sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME);
      await sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NUMBER);
      var iccResult = await sim.getSimIccId(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_setShowName_Async_0100', 0, async function (done) {
    sim.setShowName(env.SLOTID_MINUS1, env.CARD_NAME, (err) => {
      if (err) {
  ...
  it('Telephony_Sim_setShowName_Async_0200', 0, async function (done) {
    sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_OVERLONG, (err) => {
      if (err) {
  ...
  it('Telephony_Sim_setShowName_Async_0300', 0, async function (done) {
    sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_NULL, (err) => {
      if (err) {
        // Enter the exception ID to enter err.
   ...
   * @tc.name    Test setShowName slotId exception input parameter 3 to check the callback
   *             value, expecting to enter ERR
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowName_Async_0600', 0, async function (done) {
    sim.setShowName(env.SLOTID3, env.CARD_NAME, (err) => {
      if (err) {
  ...
  it('Telephony_Sim_setShowName_Async_0800', 0, async function (done) {
    sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_LEN32, (err) => {
      if (err) {
      ...
      sim.getShowName(env.DEFAULT_SLOTID, async (error, data) => {
        if (error) {
        ...
        expect(data === env.CARD_NAME_LEN32).assertTrue();
        await restoreDefaultShowName().catch(err => {
  ...
  it('Telephony_Sim_setShowName_Promise_0100', 0, async function (done) {
    try {
      await sim.setShowName(env.SLOTID_MINUS1, env.CARD_NAME);
    } catch (err) {
  ...
  it('Telephony_Sim_setShowName_Promise_0200', 0, async function (done) {
    try {
      await sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_OVERLONG);
    } catch (err) {
  ...
  it('Telephony_Sim_setShowName_Promise_0300', 0, async function (done) {
    try {
      await sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_NULL);
    } catch (err) {
   ...
   * @tc.name    Test setShowName promise interface slotId exception into parameter 3, check the return value
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowName_Promise_0600', 0, async function (done) {
    try {
      await sim.setShowName(env.SLOTID3, env.CARD_NAME);
    } catch (err) {
  ...
  it('Telephony_Sim_setShowName_Promise_0800', 0, async function (done) {
    try {
      await sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME_LEN32);
    } catch (err) {
    ...
    try {
      let data = await sim.getShowName(env.DEFAULT_SLOTID);
      expect(data === env.CARD_NAME_LEN32).assertTrue();
      await restoreDefaultShowName();
  ...
  it('Telephony_Sim_getShowName_Async_0100', 0, async function (done) {
    sim.setShowName(env.DEFAULT_SLOTID, env.CARD_NAME, (err) => {
      ...
      sim.getShowName(env.DEFAULT_SLOTID, async (err, value) => {
        if (err) {
  ...
  it('Telephony_Sim_getShowName_Async_0200', 0, async function (done) {
    sim.getShowName(env.DEFAULT_SLOTID, (err, value) => {
      if (err) {
      ...
      expect(defaultName === value).assertTrue();
  ...
  it('Telephony_Sim_getShowName_Async_0300', 0, async function (done) {
    sim.getShowName(env.SLOTID_MINUS1, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_getShowName_Promise_0100', 0, async function (done) {
    ...
    try {
      let value = await sim.getShowName(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_getShowName_Promise_0200', 0, async function (done) {
    try {
      var value = await sim.getShowName(env.DEFAULT_SLOTID);
      console.log(`Telephony_Sim_getShowName_Promise_0200 getShowName data: ${value}`);
      expect(value === defaultName).assertTrue();
  ...
  it('Telephony_Sim_getShowName_Promise_0300', 0, async function (done) {
    try {
      let data = await sim.getShowName(env.SLOTID_MINUS1);
   ...
   * @tc.name    Test the slotId exception input parameter 3 of getShowName and check the
   *             return value, expecting to enter ERR
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getShowName_Promise_0600', 0, async function (done) {
    try {
      let data = await sim.getShowName(env.SLOTID3);
  ...
  it('Telephony_Sim_setShowNumber_Async_0100', 0, async function (done) {
    sim.setShowNumber(env.SLOTID_MINUS1, env.CARD_NUMBER, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_setShowNumber_Async_0200', 0, async function (done) {
    sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME_OVERLONG, (err) => {
      if (err) {
        // Enter the exception ID to enter err.
  ...
  it('Telephony_Sim_setShowNumber_Async_0300', 0, async function (done) {
    sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME_NULL, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
   ...
   * @tc.name    Test setShowNumber async callback interface slotId exception into parameter 3, check the callback value
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowNumber_Async_0600', 0, async function (done) {
    sim.setShowNumber(env.SLOTID3, env.CARD_NUMBER, (err) => {
      if (err) {
  ...
  it('Telephony_Sim_setShowNumber_Async_0800', 0, async function (done) {
    sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NUMBER_LEN32, (err) => {
      if (err) {
      ...
      sim.getShowNumber(env.DEFAULT_SLOTID, (err, value) => {
        if (err) {
        ...
        expect(value === env.CARD_NUMBER_LEN32).assertTrue();
  ...
  it('Telephony_Sim_setShowNumber_Promise_0100', 0, async function (done) {
    try {
      await sim.setShowNumber(env.SLOTID_MINUS1, env.CARD_NUMBER);
  ...
  it('Telephony_Sim_setShowNumber_Promise_0200', 0, async function (done) {
    try {
      await sim.setShowNumber(env.SLOTID_MINUS1, env.CARD_NAME_OVERLONG);
  ...
  it('Telephony_Sim_setShowNumber_Promise_0300', 0, async function (done) {
    try {
      await sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME_NULL);
   ...
   * @tc.name    Test setShowNumber slotId exception input parameter 3 and check the return
   *             value, expecting to enter ERR
   * @tc.desc    Function test
   */
  it('Telephony_Sim_setShowNumber_Promise_0600', 0, async function (done) {
    try {
      await sim.setShowNumber(env.SLOTID3, env.CARD_NUMBER);
  ...
  it('Telephony_Sim_setShowNumber_Promise_0800', 0, async function (done) {
    try {
      await sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NUMBER_LEN32);
    } catch (err) {
    ...
    try {
      let value = await sim.getShowNumber(env.DEFAULT_SLOTID);
      expect(env.CARD_NUMBER_LEN32 === value).assertTrue();
    } catch (err) {
  ...
  it('Telephony_Sim_getShowNumber_Async_0100', 0, async function (done) {
    sim.setShowNumber(env.DEFAULT_SLOTID, env.CARD_NAME, (err) => {
      if (err) {
  ...
  it('Telephony_Sim_getShowNumber_Async_0200', 0, async function (done) {
    sim.getShowNumber(env.SLOTID_MINUS1, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
   ...
   * @tc.name    Test the getShowNumber async callback interface slotId exception into parameter 3,
   *             check the callback value
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getShowNumber_Async_0500', 0, async function (done) {
    sim.getShowNumber(env.SLOTID3, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
  ...
  it('Telephony_Sim_getShowNumber_Promise_0200', 0, async function (done) {
    try {
      let data = await sim.getShowNumber(env.SLOTID_MINUS1);
   ...
   * @tc.name    Test the getShowNumber promise interface slotId exception into parameter 3, check the callback value
   * @tc.desc    Function test
   */

  it('Telephony_Sim_getShowNumber_Promise_0500', 0, async function (done) {
    try {
      let data = await sim.getShowNumber(env.SLOTID3);
  ...
  it('Telephony_Sim_getOperatorConfigs_Async_0200', 0, async function (done) {
    sim.getOperatorConfigs(env.SLOTID_MINUS1, (err, data) => {
      if (err) {
        // Enter the exception ID to enter err.
   ...
   * @tc.name    Test the getOperatorConfigs slotId exception input parameter 3 and check the
   *             callback value, expecting to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getOperatorConfigs_Async_0600', 0, async function (done) {
    sim.getOperatorConfigs(env.SLOTID3, (err, data) => {
      if (err) {
  ...
  it('Telephony_Sim_getOperatorConfigs_Promise_0100', 0, async function (done) {
    try {
      let data = await sim.getOperatorConfigs(env.DEFAULT_SLOTID);
  ...
  it('Telephony_Sim_getOperatorConfigs_Promise_0200', 0, async function (done) {
    try {
      let data = await sim.getOperatorConfigs(env.SLOTID_MINUS1);
   ...
   * @tc.name    Test the getOperatorConfigs slotId exception input parameter 3 and check
   *             the callback value, expecting to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_getOperatorConfigs_Promise_0600', 0, async function (done) {
    try {
      let data = await sim.getOperatorConfigs(env.SLOTID3);
