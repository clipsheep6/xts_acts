...
describe('SimGetSimSpnFunctionTest', function () {

  /**
   * @tc.number Telephony_Sim_GetSimSpn_Async_0500
   * @tc.name   CDMA file, test GetSimSpn async callback interface
  ...
  /**
   * @tc.number  Telephony_Sim_GetSimSpn_Async_0600
   * @tc.name    CDMA file, GetSimSpn async callback interface slotId
   *             exception enters parameter -1 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetSimSpn_Async_0600', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_GetSimSpn_Async_0600';
    sim.getSimSpn(env.SLOTID_MINUS1, error => {
      if (error) {
  ...
  /**
   * @tc.number  Telephony_Sim_GetSimSpn_Async_0800
   * @tc.name    CDMA file, GetSimSpn async callback interface slotId
   *             exception enters parameter 2 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetSimSpn_Async_0800', 0, function (done) {
    const CASE_NAME = 'Telephony_Sim_GetSimSpn_Async_0800';
    sim.getSimSpn(env.SLOTID2, error => {
      if (error) {
        console.log(`${CASE_NAME} getSimSpn expect error: ${error.message}`);
        console.log(`${CASE_NAME} test finish.`);
        done();
  ...
  /**
   * @tc.number Telephony_Sim_GetSimSpn_Promise_0500
   * @tc.name   CDMA file, test GetSimSpn promise interface slotId
  ...
  /**
   * @tc.number  Telephony_Sim_GetSimSpn_Promise_0600
   * @tc.name    CDMA file, GetSimSpn promise interface slotId
   *             exception enters parameter -1 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetSimSpn_Promise_0600', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetSimSpn_Promise_0600';
    try {
      await sim.getSimSpn(env.SLOTID_MINUS1);
      expect().assertFail();
      console.log(`${CASE_NAME} test fail.`);
    } catch (error) {
      console.log(`${CASE_NAME} getSimSpn expect error: ${error.message}`);
  ...
  /**
   * @tc.number  Telephony_Sim_GetSimSpn_Promise_0800
   * @tc.name    CDMA file, GetSimSpn promise interface slotId
   *             exception enters parameter 2 test
   * @tc.desc    Function test
   */
  it('Telephony_Sim_GetSimSpn_Promise_0800', 0, async function (done) {
    const CASE_NAME = 'Telephony_Sim_GetSimSpn_Promise_0800';
    try {
      await sim.getSimSpn(env.SLOTID2);
      expect().assertFail();
      console.log(`${CASE_NAME} test fail.`);
    } catch (error) {
      console.log(`${CASE_NAME} getSimSpn expect error: ${error.message}`);
