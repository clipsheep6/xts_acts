...
describe('RegisterStatusMonitor', function () {
  ...
  it('Telephony_Sim_on_0300', 0, async function (done) {
    ...
    observer.on(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.SLOT_ID_MINUS_ONE}, simStateData => {
  ...
  it('Telephony_Sim_on_0400', 0, async function (done) {
    ...
    observer.on(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.slotId1}, simStateData => {
  ...
  it('Telephony_Sim_on_0500', 0, async function (done) {
    ...
    observer.on(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.slotId2}, simStateData => {
  ...
  it('Telephony_Sim_once_0100', 0, async function (done) {
    ...
    observer.once(GET_SIM_STATE_CHANGE, simStateData => {
      ...
      if (notPresentState) {
        ...
        observer.off(GET_SIM_STATE_CHANGE);
        console.log('Telephony_Sim_once_0100 call observer off');
        done();
      } else {
        console.debug('waiting for state is changed.');
      }
  ...
  it('Telephony_Sim_once_0200', 0, async function (done) {
    ...
    observer.once(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.slotId0}, simStateData => {
      ...
      if (notPresentState) {
        ...
        observer.off(GET_SIM_STATE_CHANGE);
        console.log('Telephony_Sim_once_0200 call observer off');
        done();
      } else {
        console.debug('waiting for state is changed.');
      }
  ...
  it('Telephony_Sim_once_0300', 0, async function (done) {
    ...
    observer.once(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.SLOT_ID_MINUS_ONE}, simStateData => {
    ...
    observer.off(GET_SIM_STATE_CHANGE);
    await sleep(1);
    console.log('Telephony_Sim_once_0300 call observer off');
    done();
  });

  /**
   * @tc.number  Telephony_Sim_once_0400
   * @tc.name    Once (type: 'simStateChange', options: {slotId: number},callback: AsyncCallback
   *             <{state: SimState, reason: String}>):
   *             void interface, expecting to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_once_0400', 0, async function (done) {
    if (!mockInitSuccess) {
      expect().assertFail();
      done();
      return;
    ...
    observer.once(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.slotId1}, simStateData => {
      console.log(`Telephony_Sim_once_0400, data : ${JSON.stringify(simStateData)}`);
      hasMonitor = true;
    });
    ...
    observer.off(GET_SIM_STATE_CHANGE);
    await sleep(1);
    console.log('Telephony_Sim_once_0400 call observer off');
    done();
  });

  /**
   * @tc.number  Telephony_Sim_once_0500
   * @tc.name    Once (type: 'simStateChange', options: {slotId: number},callback: AsyncCallback
   *             <{state: SimState, reason: String}>):
   *             void interface, expecting to enter err
   * @tc.desc    Function test
   */
  it('Telephony_Sim_once_0500', 0, async function (done) {
    if (!mockInitSuccess) {
      expect().assertFail();
      done();
      return;
    ...
    observer.once(GET_SIM_STATE_CHANGE, {slotId: SIM_SLOT_ID.slotId2}, simStateData => {
      console.log(`Telephony_Sim_once_0500, data : ${JSON.stringify(simStateData)}`);
      hasMonitor = true;
    });
    ...
    observer.off(GET_SIM_STATE_CHANGE);
    await sleep(1);
    console.log('Telephony_Sim_once_0500 call observer off');
    done();
  });
