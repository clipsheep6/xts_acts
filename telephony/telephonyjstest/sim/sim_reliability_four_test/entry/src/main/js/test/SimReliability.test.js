...
import {SIM_SLOT_ID, TIMES_VALUE, CARD_NAME, TYPE_AND_INDEX, OTHER_ERRORS} from './lib/Const.js';
  ...
  it('Telephony_Sim_getActiveSimAccountInfoList_Async_0400', 0, async function (done) {
    ...
    it('Telephony_Sim_alterPin2_Async_0300', 0, async function (done) {
      function recursive (n) {
        ...
        sim.alterPin2(SIM_SLOT_ID.slotId11, CARD_NAME.newPinNine, CARD_NAME.oldPin, (err) => {
          if (err) {
    ...
    it('Telephony_Sim_alterPin2_Promise_0300', 0, async function (done) {
        for (let index = 0; index < TIMES_VALUE.testRunTime; index++) {
            try {
                await sim.alterPin2(SIM_SLOT_ID.slotId11, CARD_NAME.newPinNine, CARD_NAME.oldPin);
            } catch (err) {
