 ...
 */
    ...
    describe('performance.test', function () {
        ...
        /**
         * @tc.number  Telephony_NetworkManager_getAllNets_Async_0500
         * @tc.name    The test getAllNets() was executed 1000 times with
         *             an output delay of less than 1000000us.
         * @tc.desc    Function test
         */
        it('Telephony_NetworkManager_getAllNets_Async_0500', 0, async function (done) {
            let caseName = 'Telephony_NetworkManager_getAllNets_Async_0500';
            let startTime = new Date().getTime();
            for (let index = 0; index < TEST_RUN_TIME; index++) {
                connection.getAllNets((err, data) => {
                    if (err) {
        ...
        /**
         * @tc.number  Telephony_NetworkManager_getAllNets_Promise_0500
         * @tc.name    The test getAllNets() was executed 1000 times with
         *             an output delay of less than 1000000us.
         * @tc.desc    Performance test
         */
        it('Telephony_NetworkManager_getAllNets_Promise_0500', 0, async function (done) {
            let caseName = 'Telephony_NetworkManager_getAllNets_Promise_0500';
            let startTime = new Date().getTime();
            for (let index = 0; index < TEST_RUN_TIME; index++) {
                try {
                    let data= await connection.getAllNets();
