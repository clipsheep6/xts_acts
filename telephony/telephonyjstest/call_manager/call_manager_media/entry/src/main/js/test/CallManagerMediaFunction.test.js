...
describe('CallManagementCallMedia', function () {
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function muteRinger by promise,the function return void
     * @tc.desc    Function test
     */
    ...
    it('Telephony_CallManager_setAudioDevice_Async_0100', 0, async function (done) {
        ...
        try {
            ...
            call.setAudioDevice(DEVICE_EARPIECE, (error, data) => {
                if (error) {
                    console.log(`${caseName} error,case failed,device not suport error:${toString(error)}`);
                    hangupCall2(caseName, done, callId);
                    return;
                }
                console.log(`${caseName} success,case success`);
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function setAudioDevice by callback and by arg DEVICE_SPEAKER,
     *             the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function setAudioDevice
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function setAudioDevice by promise and by arg DEVICE_EARPIECE,
     *             the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function setAudioDevice by promise
     *             and by arg DEVICE_WIRED_HEADSET,
     *             the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Calling to AUTO_ACCEPT_NUMBER2,run function setAudioDevice by promise and by arg DEVICE_INVALID4,
     *             the function return error
     * @tc.desc    Function test
     */
