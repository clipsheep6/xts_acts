...
describe('CallManagementRegister', function () {
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_on_Async_0100
   * @tc.name    Telephony_Statemonitoring_on_Async_0100
   * @tc.desc    Dial a call,when the call state is CALL_STATUS_DIALING,
   *             get the state by events callStateChange by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_on_Async_0100', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_on_Async_0100';
    try {
      let data = await scenceInCallingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
        checkState:CALL_STATUS_DIALING
      });
      console.log(`${caseName} data,case ${data.state === CALL_STATE_OFFHOOK && data.number === AUTO_ACCEPT_NUMBER ?
        'success' : 'error'},data:${toString(data)}`);
      expect(data.state === CALL_STATE_OFFHOOK).assertTrue();
      expect(data.number === AUTO_ACCEPT_NUMBER).assertTrue();
      done();
    } catch (error) {
      console.log(`${caseName} success,case failed,data:${toString(error)}`);
      expect().assertFail();
      done();
    }
  });
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_on_Async_0200
   * @tc.name    Telephony_Statemonitoring_on_Async_0200
   * @tc.desc    Dial a call,when the call state is TATUS_ACTIVE,
   *             get the state by events callStateChange  by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_on_Async_0200', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_on_Async_0200';
    try {
      let data = await scenceInCallingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_on_Async_0300
   * @tc.name    Telephony_Statemonitoring_on_Async_0300
   * @tc.desc    Dial a call,when the call state is CALL_STATUS_HOLDING,
   *             get the state by events callStateChange by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_on_Async_0300', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_on_Async_0300';
    try {
      let data = await scenceInCallingHoldingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
        checkState:TATUS_ACTIVE
      });
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_on_Async_0400
   * @tc.name    Telephony_Statemonitoring_on_Async_0400
   * @tc.desc    Dial a call,when the call is unhold,
   *             get the state by events callStateChange  by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_on_Async_0400', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_on_Async_0400';
    try {
      let data = await scenceInCallingNnHoldingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
        checkState:TATUS_ACTIVE
      });
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_on_Async_0500
   * @tc.name    Telephony_Statemonitoring_on_Async_0500
   * @tc.desc    Dial a call,when the call is hunuped,
   *             get the state by events callStateChange by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_on_Async_0500', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_on_Async_0500';
    try {
      let data = await scenceInCallingHangupForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
        checkState:TATUS_ACTIVE
      });
      console.log(`${caseName} data,case ${data.state === CALL_STATE_IDLE
           && data.number === AUTO_ACCEPT_NUMBER ?
        'success' : 'error'},data:${toString(data)}`);
      expect(data.state === CALL_STATE_IDLE).assertTrue();
      expect(data.number === AUTO_ACCEPT_NUMBER).assertTrue();
      done();
    } catch (error) {
      console.log(`${caseName} success,case failed,data:${toString(error)}`);
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_once_Async_0100
   * @tc.name    Telephony_Statemonitoring_once_Async_0100
   * @tc.desc    Dial a call,when the call state is CALL_STATUS_DIALING,
   *             get the state by events callStateChange by once and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_once_Async_0100', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_once_Async_0100';
    try {
      let data = await scenceInCallingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
      ...
      console.log(`${caseName} data,case ${data.count === 1 &&
        data.state === CALL_STATE_OFFHOOK && data.number === AUTO_ACCEPT_NUMBER ?
        'success' : 'error'},data:${toString(data)}`);
      expect(data.state === CALL_STATE_OFFHOOK).assertTrue();
      expect(data.number === AUTO_ACCEPT_NUMBER).assertTrue();
      expect(data.count === 1).assertTrue();
      done();
    } catch (error) {
      console.log(`${caseName} success,case failed,data:${toString(error)}`);
      expect().assertFail();
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_once_Async_0200
   * @tc.name    Telephony_Statemonitoring_once_Async_0200
   * @tc.desc    Dial a call,when the call state is TATUS_ACTIVE,
   *             get the state by events callStateChange  by once and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_once_Async_0200', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_once_Async_0200';
    try {
      let data = await scenceInCallingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_once_Async_0300
   * @tc.name    Telephony_Statemonitoring_once_Async_0300
   * @tc.desc    Dial a call,when the call state is CALL_STATUS_HOLDING,
   *             get the state by events callStateChange by once and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_once_Async_0300', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_once_Async_0300';
    try {
      let data = await scenceInCallingHoldingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_once_Async_0400
   * @tc.name    Telephony_Statemonitoring_once_Async_0400
   * @tc.desc    Dial a call,when the call is unhold,
   *             get the state by events callStateChange  by once and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_once_Async_0400', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_once_Async_0400';
    try {
      let data = await scenceInCallingNnHoldingForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
      ...
      console.log(`${caseName} data,case ${data.count === 1 && data.state === CALL_STATE_OFFHOOK &&
            data.number === AUTO_ACCEPT_NUMBER ? 'success' : 'error'},data:${toString(data)}`);
      expect(data.state === CALL_STATE_OFFHOOK).assertTrue();
      expect(data.number === AUTO_ACCEPT_NUMBER).assertTrue();
      expect(data.count === 1).assertTrue();
      done();
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_once_Async_0500
   * @tc.name    Telephony_Statemonitoring_once_Async_0500
   * @tc.desc    Dial a call,when the call is hunuped,
   *             get the state by events callStateChange by on and compare the state
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_once_Async_0500', 0, async function (done) {
    let caseName = 'Telephony_Statemonitoring_once_Async_0500';
    try {
      let data = await scenceInCallingHangupForRegister({
        caseName:caseName,
        phoneNumber:AUTO_ACCEPT_NUMBER,
      ...
      console.log(`${caseName} data,case ${data.count === 1 && data.state !== CALL_STATE_IDLE &&
           data.number === AUTO_ACCEPT_NUMBER ? 'success' : 'error'},data:${toString(data)}`);
      expect(data.state !== CALL_STATE_IDLE).assertTrue();
      expect(data.number === AUTO_ACCEPT_NUMBER).assertTrue();
      expect(data.count === 1).assertTrue();
  ...
  /**
   * @tc.number  Telephony_Statemonitoring_off_Async_0100
   * @tc.name    Telephony_Statemonitoring_off_Async_0100
   * @tc.desc    Register the events callStateChange by on to save the state of the call
   *             by global variable after accepted the call,
   *             then remove the events callStateChange and Register the events callStateChange
   *             by on to judge the global variable,then hunup the call to trigger the events to compare
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_off_Async_0100', 0, function (done) {
    let offCaseData = null;
    let caseName = 'Telephony_Statemonitoring_off_Async_0100';
    let callId = null;
    let timerHanup = null;
    observer.on('callStateChange', {slotId: REGISTER_SLOT_ID}, function (callStateInfo) {
      console.log(`${caseName} callStateChange,data:${toString(callStateInfo)}`);

      offCaseData = callStateInfo.state;

      if (callStateInfo.state === CALL_STATE_OFFHOOK) {
        observer.off('callStateChange');
        observer.on('callStateChange', {slotId: REGISTER_SLOT_ID}, function (callStateInfo2) {
          console.log(`${caseName} callStateChange2,data:${toString(callStateInfo2)}`);


          if (callStateInfo2.state === CALL_STATE_IDLE) {
            expect(offCaseData === CALL_STATE_OFFHOOK).assertTrue();
            console.log(`${caseName} case ${offCaseData === CALL_STATE_OFFHOOK ?
    ...
    scenceInCalling({
      ...
      .catch((err) => {
        expect().assertFail();
        console.log(`${caseName} scenceInCalling error,case failed,error:${toString(err)}`);
        done();
      });
  });

  /**
   * @tc.number  Telephony_Statemonitoring_off_Async_0200
   * @tc.name    Telephony_Statemonitoring_off_Async_0200
   * @tc.desc    Register the events callStateChange by on to save the state of the call
   *             by global variable when the call state is CALL_STATUS_HOLDING,
   *             then remove the events callStateChange and Register the events callStateChange by on
   *             to judge the global variable,then hunup the call to trigger the events to compare
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_Statemonitoring_off_Async_0200', 0, function (done) {
    let offCaseData = null;
    let caseName = 'Telephony_Statemonitoring_off_Async_0200';
    let callId = null;
    observer.on('callStateChange', {slotId: REGISTER_SLOT_ID}, function (callStateInfo) {
      console.log(`${caseName} callStateChange,data:${toString(callStateInfo)}`);
      offCaseData = callStateInfo.state;
    ...
    scenceInCalling({
      ...
      .then((data) => {
        ...
        console.log(`${caseName} scenceInCalling success,data:${toString(data)}`);
        scenceInHolding({
          caseName:caseName, callId:data.callId
        })
          .then(data => {
   ...
   * @tc.name    Telephony_CallManager_on_0100
   * @tc.desc    Dial a call by number 10086 and after being accepted,
  ...
  it('Telephony_CallManager_on_0100', 0, function (done) {
    ...
    scenceInCalling({
      ...
      .then((data) => {
        ...
        // expect(data.callId===callId).assertTrue()
   ...
   * @tc.name    Telephony_CallManager_on_0200
   * @tc.desc    Dial a call by number 10086 and before  operator feedback,
   *             the callDetailsChange event get the callStateInfo is
   ...
   * @tc.name    Telephony_CallManager_on_0300
   * @tc.desc    Dial a call by number 10086 and before  being accepted,
   *             the callDetailsChange event get the callStateInfo is
   *             {accountNumber：10086,accountId：1,videoState：0,callType：0,callId：（当前callId）,
   ...
   * @tc.name    Telephony_CallManager_on_0400
   * @tc.desc    Dial a call by number 10086 and after  being accepted,
   *             the callDetailsChange event get the callStateInfo is
   *             {accountNumber：10086,accountId：1,videoState：0,callType：0,callId：（当前callId）,
      ...
      .then((data) => {
        ...
        scenceInHolding({caseName:caseName, callId:data.callId})
          .then(data2 => {
            ...
            console.log(`${caseName} success,case ${flag && flag1 ? 'success' : 'failed'},data:${toString(data)}`);
            ...
            // expect(data2.callId===callId).assertTrue()
   ...
   * @tc.name    Telephony_CallManager_on_0500
   * @tc.desc    Dial a call by number 10086 ,after  being accepted ,then hangup the call,
   ...
   * @tc.name    Telephony_CallManager_on_0600
   * @tc.desc    Dial a call by number 10086 , after  being accepted,then hangup the call,
   ...
   * @tc.name    Telephony_CallManager_on_0700
   * @tc.desc    Dial a call by number 10086 and after  being accepted,
  ...
  it('Telephony_CallManager_on_0700', 0, function (done) {
    ...
    call.on('callEventChange', function (err, callEventOptions) {
      console.log(`${caseName} on callEventChange error,error:${toString(err)},data:${toString(callEventOptions)}`);
      if (err) {
   ...
   * @tc.name    Telephony_CallManager_on_0800
   * @tc.desc    Dial a call by number 10086 and after  being accepted,
   ...
   * @tc.name    Telephony_CallManager_off_0100
   * @tc.desc    Register the events callDetailsChange by on to save the state of the call
    ...
    call.on('callDetailsChange', function (err, callStateInfo) {
      ...
      if (callStateInfo.callState === TATUS_ACTIVE) {
        ...
        call.on('callDetailsChange', function (err2, callStateInfo2) {
          console.log(`${caseName} callDetailsChange error:${toString(err2)},data:${toString(callStateInfo2)}`);
          if (err2) {
   ...
   * @tc.name    Telephony_CallManager_off_0200
   * @tc.desc    Register the events callEventChange by on to save the state of the call
  ...
  it('Telephony_CallManager_off_0200', 0, function (done) {
    ...
    callDetailsChangeOn();
    call.on('callEventChange', function (err, callEventOptions) {
      console.log(`${caseName} callEventChange on error,error:${toString(err)},data:${toString(callEventOptions)}`);
      if (err) {
      ...
      if (callEventOptions.eventId === EVENT_START_DTMF_SUCCESS) {
        ...
        call.on('callEventChange', function (err2, callEventOptions2) {
          console.log(`${caseName} next callEventChange,error:${toString(err2)},data:${toString(callEventOptions2)}}`);
          if (err2) {
            console.log(`${caseName} next on error,case failed,error:${toString(err2)}`);
            expect().assertFail();
            hangupCall2(caseName, done, callId);
        ...
        call.startDTMF(callId, '5')
          .then(data => {
            call.stopDTMF(callId)
              .then(data => {
                console.log(`${caseName} startDTMF3 success,data:${toString(data)}`);
              })
              .catch(error => {
                expect().assertFail();
                console.log(`${caseName} startDTMF3 error,case failed,error:${toString(error)}`);
                hangupCall2(caseName, done, callId);
              });
          })
          .catch(error => {
