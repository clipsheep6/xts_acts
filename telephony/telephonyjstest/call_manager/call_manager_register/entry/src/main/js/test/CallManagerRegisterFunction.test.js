...
describe('CallManagementRegister', function () {
     ...
     * @tc.name    Dial a call,when the call state is CALL_STATUS_DIALING,
    ...
    it('Telephony_Statemonitoring_on_Async_0100', 0, async function (done) {
        ...
        try {
            ...
            console.log(`${caseName} data,case ${data.state === CALL_STATE_OFFHOOK &&
     ...
     * @tc.name    Dial a call,when the call state is TATUS_ACTIVE,
     *             get the state by events callStateChange  by on and compare the state
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call,when the call state is CALL_STATUS_HOLDING,
     *             get the state by events callStateChange by on and compare the state
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call,when the call is unhold,
     *             get the state by events callStateChange  by on and compare the state
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call,when the call is hunuped,
     *             get the state by events callStateChange by on and compare the state
     * @tc.desc    Function test
     */
    ...
    /**
     * @tc.number  Telephony_Statemonitoring_on_Async_0600
     * @tc.name    Registe the callStateChange events by method on by arg slotId SLOT_ID_INVALID to save the data,
     *             dial a call by number 10086 and after  being accepted,then cat the data to judge the data.
     * @tc.desc    Function test
     */
    it('Telephony_Statemonitoring_on_Async_0600', 0, function (done) {
        let caseName = 'Telephony_Statemonitoring_on_Async_0600';
        let callId = null;
        let saveData = null;
        observer.on('callStateChange', {slotId: SLOT_ID_INVALID}, (data) => {
        ...
        scenceInCalling({
            ...
            .then((data) => {
                ...
                let time = setTimeout(function () {
                    expect(saveData === null).assertTrue();
                    console.log(`${caseName} case ${saveData === null ? 'success' : 'faild'}`);
                    clearTimeout(time);
    ...
    /**
     * @tc.number  Telephony_Statemonitoring_on_Async_0700
     * @tc.name    Registe the callStateChange events by method on by arg slotId SLOT_ID_INVALID_2 to save the data,
     *             dial a call by number 10086 and after  being accepted,then cat the data to judge the data.
     * @tc.desc    Function test
     */
    it('Telephony_Statemonitoring_on_Async_0700', 0, function (done) {
        let caseName = 'Telephony_Statemonitoring_on_Async_0700';
        let callId = null;
        let saveData = null;
        observer.on('callStateChange', {slotId: SLOT_ID_INVALID_2}, (data) => {
            console.log(`${caseName}  callStateChange,data:${toString(data)}`);
            saveData = data;
        });
        scenceInCalling({
    ...
    /**
     * @tc.number  Telephony_Statemonitoring_once_Async_0600
     * @tc.name    Registe the callStateChange events by method once by arg slotId SLOT_ID_INVALID to save the data,
     *             dial a call by number 10086 and after  being accepted,then cat the data to judge the data.
     * @tc.desc    Function test
     */
    it('Telephony_Statemonitoring_once_Async_0600', 0, function (done) {
        let caseName = 'Telephony_Statemonitoring_once_Async_0600';
        let callId = null;
        let saveData = null;
        observer.once('callStateChange', {slotId: SLOT_ID_INVALID}, (data) => {
            console.log(`${caseName}  callStateChange,data:${toString(data)}`);
            saveData = data;
        });
        scenceInCalling({
    ...
    /**
     * @tc.number  Telephony_Statemonitoring_once_Async_0700
     * @tc.name    Registe the callStateChange events by method once by arg slotId SLOT_ID_INVALID to save the data,
     *             dial a call by number 10086 and after  being accepted,then cat the data to judge the data.
     * @tc.desc    Function test
     */
    it('Telephony_Statemonitoring_once_Async_0700', 0, function (done) {
        let caseName = 'Telephony_Statemonitoring_once_Async_0700';
        let callId = null;
        let saveData = null;
        observer.once('callStateChange', {slotId: SLOT_ID_INVALID}, (data) => {
            console.log(`${caseName}  callStateChange,data:${toString(data)}`);
     ...
     * @tc.name    Register the events callStateChange by on to save the state of the call
