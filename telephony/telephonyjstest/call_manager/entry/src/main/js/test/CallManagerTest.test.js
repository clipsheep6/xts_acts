...
describe('CallManagerTest', function () {
    ...
    it('Telephony_CallManager_dial_Async_0300', 0, async function (done) {
        call.dial('12345678901234567890012345678901', (err, data) => {  //API文档标注说明
            if (err) {
    ...
    it('Telephony_CallManager_dial_Promise_0900', 0, async function (done) {
        try {
            var data = await call.dial('12345678901234567890012345678901')
            expect().assertFail()
     ...
     * {accountId: 1, videoState: 0, dialScene: 0, dialType: 0}. Call dial() in callback mode to capture err
     * @tc.desc    Function test
     */
    ...
    it('Telephony_CallManager_holdCall_Promise_0100', 0, async function (done) {
        try {
            await call.holdCall(ERROR_CALLID_999) //problem data没有用到就不用写
            expect().assertFail()
    ...
    it('Telephony_CallManager_switchCall_Async_0100', 0, async function (done) {
        call.switchCall(ERROR_CALLID_999, (err, data) => {
            if (err) {
    ...
    */
    ...
    it('Telephony_CallManager_startDtmf_Async_1000', 0, async function (done) {
        call.startDtmf(ERROR_CALLID_999, 'C', (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_stopDtmf_Async_0100', 0, async function (done) {
        call.stopDtmf(ERROR_CALLID_999, (err, data) => {
            if (err) {
    ...
    */
    it('Telephony_CallManager_reject_Async_0100', 0, async function (done) {
        call.reject(ERROR_CALLID_999, (err, data) => {
            if (err) {
    ...
    */
    it('Telephony_CallManager_hangup_Async_0100', 0, async function (done) {
        call.hangup(ERROR_CALLID_999, (err, data) => {
            if (err) {
    ...
    */
    it('Telephony_CallManager_answer_Async_0100', 0, async function (done) {
        call.answer(ERROR_CALLID_999, (err, data) => {
            if (err) {
    ...
    */
    ...
    it('Telephony_CallManager_formatPhoneNumber_Async_0500', 0, async function (done) {
        call.formatPhoneNumber('666666999999', { countryCode: 'CN' }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_formatPhoneNumber_Async_0600', 0, async function (done) {
        call.formatPhoneNumber('13888888888', { countryCode: 'abcdefg' }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_formatPhoneNumber_Async_0700', 0, async function (done) {
        call.formatPhoneNumber('13888888888', { countryCode: '' }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_formatPhoneNumberToE164_Async_0500', 0, async function (done) {
        call.formatPhoneNumberToE164('13888888888', 'abcdfg', (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_formatPhoneNumberToE164_Async_0600', 0, async function (done) {
        call.formatPhoneNumberToE164('13888888888', '', (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0100', 0, async function (done) {
        call.isEmergencyPhoneNumber('0+0+0', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0200', 0, async function (done) {
        call.isEmergencyPhoneNumber('13766669999', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0300', 0, async function (done) {
        call.isEmergencyPhoneNumber('000', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0500', 0, async function (done) {
        call.isEmergencyPhoneNumber('911', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0600', 0, async function (done) {
        call.isEmergencyPhoneNumber('08', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0700', 0, async function (done) {
        call.isEmergencyPhoneNumber('118', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0800', 0, async function (done) {
        call.isEmergencyPhoneNumber('999', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_0900', 0, async function (done) {
        call.isEmergencyPhoneNumber('119', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Async_1000', 0, async function (done) {
        call.isEmergencyPhoneNumber('110', { slotId: 1 }, (err, data) => {
            if (err) {
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0100', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('0+0+0', { slotId: 1 })
            expect(data == false).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0200', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('13766669999', { slotId: 1 })
            expect(data == false).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0300', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('000', { slotId: 1 })
            expect(data).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0400', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('112', { slotId: 1 })
            expect(data).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0500', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('911', { slotId: 1 })
            expect(data).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0600', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('08', { slotId: 1 })
            expect(data).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0700', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('118', { slotId: 1 })
            expect(data).assertTrue()
    ...
    it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_0800', 0, async function (done) {
        try {
            var data = await call.isEmergencyPhoneNumber('999', { slotId: 1 })
            expect(data).assertTrue()
    ...
    /*
     * @tc.number  Telephony_CallManager_getCallWaiting_Async_0100
     * @tc.name    Call waiting is enabled, slotId is 1, getCallWaiting() is called to getCallWaiting, and status is 1
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallWaiting_Async_0100', 0, async function (done) {
        setTimeout(function () {
            call.getCallWaiting(SLOT_1, (err, data) => {
                if (err) {
                    console.log('Telephony_CallManager_getCallWaiting_Async_0100 get fail : ' + err.message)
                    expect().assertFail()
                    done()
                    return
                }
                console.log('Telephony_CallManager_getCallWaiting_Async_0100 res.status = ' + data.status)
                expect(data.status == STATUS_ON).assertTrue()
                console.log('Telephony_CallManager_getCallWaiting_Async_0100 finish')
                done()
            })
    ...
    /*
     * @tc.number  Telephony_CallManager_getCallWaiting_Promise_0100
     * @tc.name    When the call wait sate is on test call getCallWaiting() in callback is on
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallWaiting_Promise_0100', 0, async function (done) {
        setTimeout(function () {
            var promise = call.getCallWaiting(SLOT_1)
            promise.then((data) => {
                console.log('Telephony_CallManager_getCallWaiting_Promise_0100 res.status = ' + data.status)
                expect(data.status == STATUS_ON).assertTrue()
                console.log('Telephony_CallManager_getCallWaiting_Promise_0100 finish')
                done()
            }).catch((err) => {
                console.log('Telephony_CallManager_getCallWaiting_Promise_0100 fail : ' + err.message)
                expect().assertFail()
                done()
                return
            })
