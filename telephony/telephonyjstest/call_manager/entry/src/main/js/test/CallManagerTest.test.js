...
describe("CallManagerTest", function () {
    ...
    it("Telephony_CallManager_getCallState_Async_0100", 0, async function (done) {
        call.getCallState((err, data) => {
            ...
            expect(data == CALL_STATE_IDLE).assertTrue();
     ...
     */
        it("Telephony_CallManager_isEmergencyPhoneNumber_Async_1300", 0, async function (done) {
            call.isEmergencyPhoneNumber("110", { slotId: ERR_SLOT_ID }, (err) => {
                if (err) {
                    console.log("Telephony_CallManager_isEmergencyPhoneNumber_Async_1300 finish = " + err.message);
                    expect().assertFail();
                    done();
                    return;
                }
     ...
     */
        it("Telephony_CallManager_isEmergencyPhoneNumber_Promise_1300", 0, async function (done) {
            try {
                ...
                console.log("Telephony_CallManager_isEmergencyPhoneNumber_Promise_1300 finish err = " + err.message);
                done();
                return;
            }
            done();
    ...
    it("Telephony_CallManager_getCallWaiting_Async_0100", 0, async function (done) {
        call.getCallWaiting(SLOT_0, (err, data) => {
            if (err) {
    ...
    it("Telephony_CallManager_getCallWaiting_Promise_0100", 0, async function (done) {
        var promise = call.getCallWaiting(SLOT_0);
        promise.then((data) => {
    ...
    /*
     * @tc.number  Telephony_CallManager_getCallWaiting_Async_0200
     * @tc.name    Call waiting is enabled. SlotId is -1. GetCallWaiting ()
     *             is called to obtain call waiting and err is captured
     * @tc.desc    Function test
     */
    it("Telephony_CallManager_getCallWaiting_Async_0200", 0, async function (done) {
        call.getCallWaiting(ERR_SLOT_ID, (err) => {
            if (err) {
                console.log("Telephony_CallManager_getCallWaiting_Async_0200 get finish : " + err.message);
                done();
                return;
            }
            expect().assertFail();
    ...
    /*
     * @tc.number  Telephony_CallManager_getCallWaiting_Promise_0200
     ...
     * @tc.desc    Function test
     */
    it("Telephony_CallManager_getCallWaiting_Promise_0200", 0, async function (done) {
        var promise = call.getCallWaiting(ERR_SLOT_ID);
        promise.then(() => {
                expect().assertFail();
                console.log("Telephony_CallManager_getCallWaiting_Promise_0200 fail");
                done();
        })
        .catch((err) => {
            console.log("Telephony_CallManager_getCallWaiting_Promise_0200 finish : " + err.message);
            done();
            return;
        })
    })
