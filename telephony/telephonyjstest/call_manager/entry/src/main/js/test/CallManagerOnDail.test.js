...
describe("CallManagerOnDial", function () {
     ...
     *             or calling holdCall() to enable the call hold, with no return value
     * @tc.desc    Function test
     */
            ...
            while (true) {
                if (callState == CALL_STATUS_DIALING) {
                    call.holdCall(callId, (err) => {
                        if (err) {
                            expect().assertFail()
                            console.log('Telephony_CallManager_unholdCall_Async_0400 holdCall fail err = ' + err.message)
                            done()
                            return
                        }
                    ...
                    call.unHoldCall(callId,(err) => {
                        if (err) {
                            expect().assertFail()
                            console.log('Telephony_CallManager_unholdCall_Async_0400 unHoldCall fail err = ' + err.message)
                            done()
                            return
                        }
    ...
    it('Telephony_CallManager_unholdCall_Promise_0400', 0, async function (done) {
        ...
        while (true) {
            if (callState == CALL_STATUS_DIALING) {
                ...
                try {
                    await call.unHoldCall()
                    console.log('Telephony_CallManager_unholdCall_Promise_0400 unHoldCall finish')
                } catch (err) {
                    console.log('Telephony_CallManager_unholdCall_Promise_0400 unHoldCall fail err = ' + err.message)
                    expect().assertFail()
                    done()
                    return
                }
