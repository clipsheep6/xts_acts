...
describe('CallManagerMMI', function () {
    ...
    * @tc.desc    Function test
    */
    it('Telephony_CallManager_MMl_Promise_0400', 0, async function (done) {
        try {
            var data = await call.dial('#31#')
            expect(data).assertTrue()
            console.log('Telephony_CallManager_MMl_Promise_0400 finish data = ' + data)
        } catch (err) {
            expect().assertFail()
            console.log('Telephony_CallManager_MMl_Promise_0400 fail')
            done()
        }
        try {
            var data = await call.dial('*31#')
            console.log('Telephony_CallManager_MMI_Promise_0500 fail')
            expect(data).assertTrue()
            console.log('Telephony_CallManager_MMI_Promise_0500 finish data = ' + data)
        } catch (err) {
            expect().assertFail()
            console.log('Telephony_CallManager_MMI_Promise_0500 fail')
            done()
