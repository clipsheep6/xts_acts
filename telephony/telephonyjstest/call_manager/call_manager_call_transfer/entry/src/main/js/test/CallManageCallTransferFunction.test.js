...
describe('CallManagementCallTransfer', function () {
    ...
    afterAll(function () {
        console.log('Telephony_CallManager all 52 case is over for callmanager CallManagementCallTransfer');
    });
     ...
     *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
     *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_ALWAYS  by callback,
     *             the function return status TRANSFER_ENABLE,number TRAN_PHONE_NUMBER_86459751,
     *             type TRANSFER_TYPE_ALWAYS
     * @tc.desc    Function test
     */
     ...
     *             the function return status TRANSFER_DISABLE,number TRAN_PHONE_NUMBER_86459751,
     *             type TRANSFER_TYPE_ALWAYS
     * @tc.desc    Function test
     */
