...
describe('CallManagementCallTransfer', function () {
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_LONG by callback,the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0300
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum '' by callback,the function return void
   * @tc.type    Function
   * @tc.level   Level3 返回值不支持
   */
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_12599 by callback,the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0500
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 by callback,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0600
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 by callback,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0700
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_86459751 by callback,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
  ...
  it('Telephony_CallManager_setCallTransfer_Async_0700', 0, async function (done) {
    ...
    call.setCallTransfer(DEFAULT_SLOT_ID, {
      ...
      phoneNumber:TRAN_PHONE_NUMBER_86459751
    }, (error, data) => {
      if (error) {
        console.log(`${caseName} error, case failed,error ${error.message}`);
        expect().assertFail();
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0800
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_86459751 by callback,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_0900
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_089899855857 by callback,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3  不支持
   */
  ...
  it('Telephony_CallManager_setCallTransfer_Async_0900', 0, async function (done) {
    ...
    call.setCallTransfer(DEFAULT_SLOT_ID, {
      ...
      phoneNumber:TRAN_PHONE_NUMBER_089899855857
    }, (error, data) => {
      if (error) {
        console.log(`${caseName} error, case failed ${error.message}`);
        expect().assertFail();
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_1000
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_089899855857 by callback,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_1300
   * @tc.desc    Run function setCallTransfer by args slotId SLOT_ID_INVALID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 by callback,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3 返回值不支持
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0300
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum '' by callback,the function return void
   * @tc.type    Function
   * @tc.level   Level3 返回值不支持
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_12599 by callback,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0500
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0600
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRAN_PHONE_NUMBER_00000000000 by promise,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0700
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_86459751 by promise,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0800
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_86459751 by promise,
   *             the function return void
   * @tc.type    Function
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_0900
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_089899855857 by promise,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3 不支持
   */
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_1000
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_1300
   * @tc.desc    Run function setCallTransfer by args slotId SLOT_ID_INVALID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRNS_PHONE_NUMBER_089800000000 by promise,
   *             the function return void
   * @tc.type    Function
  ...
  it('Telephony_CallManager_setCallTransfer_Promise_1300', 0, async function (done) {
    ...
    try {
      ...
      console.log(`${caseName} error,case failed,error:${toString(err)}`);
      expect().assertFail();
    }
    done();
  });
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
  ...
  it('Telephony_CallManager_getCallTransferInfo_Async_0200', 0, async function (done) {
    ...
    try {
      var data = await scenceTransferCalling(caseName, TRANSFER_ENABLE, TRANSFER_TYPE_BUSY, TRAN_PHONE_NUMBER_12599);
      console.log(`${caseName} scenceTransferCalling success`);
      call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_BUSY, (error, data) => {
        if (error) {
          console.log(`${caseName} getCallTransferInfo error, case failed. error:${toString(error)}`);
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0300
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_12599 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
  ...
  it('Telephony_CallManager_getCallTransferInfo_Async_0300', 0, async function (done) {
    ...
    try {
      var data = await scenceTransferCalling(caseName, TRANSFER_DISABLE, TRANSFER_TYPE_BUSY, TRAN_PHONE_NUMBER_12599);
      console.log(`${caseName} scenceTransferCalling success`);
      call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_BUSY, (error, data) => {
        if (error) {
          console.log(`${caseName} getCallTransferInfo error, case failed. error:${toString(error)}`);
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
    ...
    scenceTransferCalling(caseName, TRANSFER_ENABLE, TRANSFER_TYPE_NO_ANSWER, '')
      .then(() => {
        call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_NO_ANSWER, (error, data) => {
          ...
          const flag = data.status === TRANSFER_ENABLE && data.number === '' && data.type === TRANSFER_TYPE_NO_ANSWER;
          console.log(`${caseName} getCallTransferInfo success,case` +
            ` ${flag ? 'success' : 'failed'},data:${toString(data)}`);
          expect(flag).assertTrue();
          done();
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0500
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0600
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0700
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0800
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_089899855857 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_UNREACHABLE  by callback,
   *             the function return status TRANSFER_ENABLE,number TRAN_PHONE_NUMBER_089899855857,
   *             type TRANSFER_TYPE_UNREACHABLE
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_CallManager_getCallTransferInfo_Async_0800', 0, async function (done) {
    ...
    try {
      var data = await scenceTransferCalling(caseName, TRANSFER_ENABLE,
        TRANSFER_TYPE_UNREACHABLE, TRAN_PHONE_NUMBER_089899855857);
      console.log(`${caseName} scenceTransferCalling success`);
      call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_UNREACHABLE, (error, data) => {
        if (error) {
          console.log(`${caseName} getCallTransferInfo error, case failed. error:${toString(error)}`);
        ...
        const flag = data.status === TRANSFER_ENABLE && data.number === TRAN_PHONE_NUMBER_089899855857 &&
          data.type === TRANSFER_TYPE_UNREACHABLE;
        console.log(`${caseName} getCallTransferInfo success,case` +
          ` ${flag ? 'success' : 'failed'},data:${toString(data)}`);
        expect(flag).assertTrue();
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_0900
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_089899855857 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_DISABLE,type TRANSFER_TYPE_UNREACHABLE  by callback,
   *             the function return status TRANSFER_DISABLE,number TRAN_PHONE_NUMBER_089899855857,
   *             type TRANSFER_TYPE_UNREACHABLE
   * @tc.type    Function
   * @tc.level   Level3
   */
  it('Telephony_CallManager_getCallTransferInfo_Async_0900', 0, async function (done) {
    ...
    try {
      ...
      call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_UNREACHABLE, (error, data) => {
        ...
        const flag = data.status === TRANSFER_DISABLE && data.number === TRAN_PHONE_NUMBER_089899855857 &&
          data.type === TRANSFER_TYPE_UNREACHABLE;
        console.log(`${caseName} getCallTransferInfo success,case` +
          ` ${flag ? 'success' : 'failed'},data:${toString(data)}`);
        expect(flag).assertTrue();
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1000
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_86459751 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_ALWAYS  by callback,
   *             the function return status TRANSFER_ENABLE,number TRAN_PHONE_NUMBER_86459751,type TRANSFER_TYPE_ALWAYS
   * @tc.type    Function
   * @tc.level   Level3 不支持
   */
  ...
  it('Telephony_CallManager_getCallTransferInfo_Async_1100', 0, async function (done) {
    ...
    scenceTransferCalling(caseName, TRANSFER_ENABLE, TRANSFER_TYPE_ALWAYS, TRAN_PHONE_NUMBER_86459751)
      .then(() => {
        call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_ALWAYS, (error, data) => {
          if (error) {
            console.log(`${caseName} error,case failed,error:${toString(error)}`);
          ...
          const flag = data.status === TRANSFER_ENABLE && data.number === TRAN_PHONE_NUMBER_86459751 &&
            data.type === TRANSFER_TYPE_ALWAYS;
          console.log(`${caseName} getCallTransferInfo success,case` +
            ` ${flag ? 'success' : 'failed'},data:${toString(data)}`);
          expect(flag).assertTrue();
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_86459751 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_DISABLE,type TRANSFER_TYPE_ALWAYS  by callback,
   *             the function return status TRANSFER_DISABLE,number TRAN_PHONE_NUMBER_86459751,type TRANSFER_TYPE_ALWAYS
   * @tc.type    Function
   * @tc.level   Level3 不支持
   */
  ...
  it('Telephony_CallManager_getCallTransferInfo_Async_1200', 0, async function (done) {
    ...
    scenceTransferCalling(caseName, TRANSFER_DISABLE, TRANSFER_TYPE_ALWAYS, TRAN_PHONE_NUMBER_86459751)
      .then(() => {
        call.getCallTransferInfo(DEFAULT_SLOT_ID, TRANSFER_TYPE_ALWAYS, (error, data) => {
          if (error) {
            console.log(`${caseName} error,case failed,error:${toString(error)}`);
          ...
          const flag = data.status === TRANSFER_DISABLE && data.number === TRAN_PHONE_NUMBER_86459751 &&
            data.type === TRANSFER_TYPE_ALWAYS;
          console.log(`${caseName} getCallTransferInfo success,case` +
            ` ${flag ? 'success' : 'failed'},data:${toString(data)}`);
          expect(flag).assertTrue();
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1500
   * @tc.desc    Run function getCallTransferInfo by args slotId SLOT_ID_INVALID,
   *             settingType TRANSFER_DISABLE,type TRANSFER_TYPE_ALWAYS  by callback,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum '' to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_12599 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_BUSY by promise,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0300
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_BUSY,transferNum TRAN_PHONE_NUMBER_12599 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum '' to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name     Telephony_CallManager_getCallTransferInfo_Promise_0500
   * @tc.desc     Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *              type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 to set,
   *              then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *              settingType TRANSFER_ENABLE,type TRANSFER_TYPE_NO_ANSWER by promise,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0600
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_NO_ANSWER,transferNum TRNS_PHONE_NUMBER_089800000000 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0700
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum '' to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0800
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_089899855857 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_UNREACHABLE by promise,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_0900
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_UNREACHABLE,transferNum TRAN_PHONE_NUMBER_089899855857 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1000
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum '' to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_86459751 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   *             settingType TRANSFER_ENABLE,type TRANSFER_TYPE_ALWAYS by promise,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_86459751 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1500
   * @tc.desc    Run function getCallTransferInfo by args slotId SLOT_ID_INVALID,
   *             settingType TRANSFER_DISABLE,type TRANSFER_TYPE_UNREACHABLE by promise,
   *             the function return error
   * @tc.type    Function
  ...
  it('Telephony_CallManager_getCallTransferInfo_Promise_1500', 0, async function (done) {
    ...
    try {
      ...
      console.log(`${caseName} scenceTransferCalling error, case success. error:${toString(err)}`);
    }
    done();
  ...
  afterAll(function () {
    console.log('Telephony_CallManager all 48 case is over for callmanager CallManagementCallTransfer');
  });
});