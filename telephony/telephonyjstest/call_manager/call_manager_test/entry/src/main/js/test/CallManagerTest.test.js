...
describe('CallManagerTest', function () {
    ...
    * @tc.name    When callId is 999,  and call reject with message REJECT_MESSAGE_NUM by callback,
    *             the function return error
    * @tc.desc    Function test
    */
    it('Telephony_CallManager_reject_Async_0400', 0, async function (done) {
        call.reject(ERROR_CALLID_999, new RejectMessageOptions(REJECT_MESSAGE_NUM), (err, data) => {
            if (err) {
                console.log(`Telephony_CallManager_reject_Async_0400 finish : err=${err}`);
                done();
                return;
            }
            console.log(`Telephony_CallManager_reject_Async_0400 fail : data=${data}`);
            expect().assertFail();
            done();
        });
    });
   ...
   it('Telephony_CallManager_isEmergencyPhoneNumber_Promise_1300', 0, async function (done) {
       try{
            var data = await call.isEmergencyPhoneNumber('120', { slotId: ERR_SLOT_ID })
            expect().assertFail();
   ...
   /*
    ...
    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Async_0100
     * @tc.name    Run function setCallWaiting by args slotId SLOT_0,activate ACTIVATE_TRUE to set by callback,the funciton return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Async_0100', 0, async function (done) {
        call.setCallWaiting(SLOT_0, ACTIVATE_TRUE,(err, data) => {
            if (err) {
                console.log('Telephony_CallManager_setCallWaiting_Async_0100 fail err = ' + err);
                expect().assertFail();
                done();
                return;
            }
            console.log('Telephony_CallManager_setCallWaiting_Async_0100 finish');
            done();
        })
    })

    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Async_0200
     * @tc.name    Run function setCallWaiting by args slotId SLOT_0,activate ACTIVATE_FALSE to set by callback,the funciton return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Async_0200', 0, async function (done) {
        call.setCallWaiting(SLOT_0, ACTIVATE_FALSE,(err, data) => {
            if (err) {
                console.log('Telephony_CallManager_setCallWaiting_Async_0200 fail err = ' + err);
                expect().assertFail();
                done();
                return;
            }
            console.log('Telephony_CallManager_setCallWaiting_Async_0200 finish');
            done();
        })
    })

    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Async_0500
     * @tc.name    Run function setCallWaiting by args slotId ERR_SLOT_ID,activate ACTIVATE_TRUE to set by callback,the funciton return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Async_0500', 0, async function (done) {
        call.setCallWaiting(ERR_SLOT_ID, ACTIVATE_TRUE,(err, data) => {
            if (err) {
                console.log('Telephony_CallManager_setCallWaiting_Async_0500 fail err = ' + err);
                done();
                return;
            }
            expect().assertFail();
            console.log('Telephony_CallManager_setCallWaiting_Async_0500 finish');
            done();
        })
    })

    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Promise_0100
     * @tc.name    Run function setCallWaiting by args slotId SLOT_0,activate ACTIVATE_TRUE to set by promise,the funciton return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Promise_0100', 0, async function (done) {
        try {
            await call.setCallWaiting(SLOT_0, ACTIVATE_TRUE);
            console.log('Telephony_CallManager_setCallWaiting_Promise_0100 finish');
            done();
        } catch (err) {
            expect().assertFail();
            console.log('Telephony_CallManager_setCallWaiting_Promise_0100 fail err =' + err);
            done();
        }
    })

    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Promise_0200
     * @tc.name    Run function setCallWaiting by args slotId SLOT_0,activate ACTIVATE_FALSE to set by promise,the funciton return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Promise_0200', 0, async function (done) {
        try {
            await call.setCallWaiting(SLOT_0, ACTIVATE_FALSE);
            console.log('Telephony_CallManager_setCallWaiting_Promise_0200 finish');
            done();
        } catch (err) {
            expect().assertFail();
            console.log('Telephony_CallManager_setCallWaiting_Promise_0200 fail err =' + err);
            done();
        }
    })

    /*
     * @tc.number  Telephony_CallManager_setCallWaiting_Promise_0500
     * @tc.name    Run function setCallWaiting by args slotId ERR_SLOT_ID,activate ACTIVATE_TRUE to set by promise,the funciton return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallWaiting_Promise_0500', 0, async function (done) {
        try {
            await call.setCallWaiting(ERR_SLOT_ID, ACTIVATE_TRUE);
            expect().assertFail();
            console.log('Telephony_CallManager_setCallWaiting_Promise_0500 finish');
            done();
        } catch (err) {
            console.log('Telephony_CallManager_setCallWaiting_Promise_0500 fail err =' + err);
            done();
        }
    })
})
