...
describe('CallManagerTest', function () {
     ...
     * @tc.name    If the mainCallId is 999, call getMainCallId() to get the call and return error
     * @tc.desc    Function test
     */
    ...
    it('Telephony_CallManager_getCallWaitingStatus_Promise_0400', 0, async function (done) {
        ...
        try {
            ...
            console.log(`Telephony_CallManager_getCallWaitingStatus_Promise_0400 setCallWaiting error = ${error}`);
        }
        done();
    });
     ...
     * @tc.name    Run function setCallWaiting by args slotId ERR_SLOT_ID,activate ACTIVATE_TRUE to set by callback,
     *             the funciton return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallWaiting by args slotId ERR_SLOT_ID,activate ACTIVATE_TRUE to set by promise,
     *             the funciton return error
     * @tc.desc    Function test
     */
