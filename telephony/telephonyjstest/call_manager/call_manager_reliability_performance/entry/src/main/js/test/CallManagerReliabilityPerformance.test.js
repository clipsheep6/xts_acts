...
describe('CallManagementReliablePerformance', function () {
   ...
   * @tc.name    Telephony_CallManager_separateConference_Async_0400
   * @tc.desc    Run 1000 times separateConference by callback
   ...
   * @tc.name    Telephony_CallManager_separateConference_Promise_0400
   * @tc.desc    Run 1000 times separateConference by promise
   *             when callId is any number(such as 1234) that is not exit in calllist,
   *             the function always return error
   * @tc.type    Reliability
   * @tc.level   Level3
   ...
   * @tc.name    Telephony_CallManager_isNewCallAllowed_Async_0400
   * @tc.desc    Run 1000 times isNewCallAllowed by callback,the function always return true
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_isNewCallAllowed_Promise_0400
   * @tc.desc    Run 1000 times isNewCallAllowed by promise,the function always return true
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_isRinging_Async_0400
   * @tc.desc    Run 1000 times isRinging by callback,the function always return false
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_isRinging_Promise_0400
   * @tc.desc    Run 1000 times isRinging by promise,the function always return false
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.desc    Calling to 10086,run function setMuted by callback and by arg true 1000 times,
   ...
   * @tc.desc    Calling to 10086,run function setMuted by promise and by arg true 1000 times,
   *             the function always return void
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Async_0400
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Promise_0400
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.name    Telephony_CallManager_setAudioDevice_Async_0600
   * @tc.desc    Calling to 10086,run function setAudioDevice by callback and by arg DEVICE_SPEAKER 1000 times,
   *             the function always return void
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setAudioDevice_Promise_0600
   * @tc.desc    Calling to 10086,run function setAudioDevice by promise and by arg DEVICE_SPEAKER 1000 times,
   *             the function always return void
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_muteRinger_Async_0300
   * @tc.desc    Unwanted state,run function muteRinger by callback and 1000 times,the function always return void
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_muteRinger_Promise_0300
   * @tc.desc    Unwanted state,run function muteRinger by promise and 1000 times,the function always return void
   * @tc.type    Reliability
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setCallRestriction_Async_1600
   ...
   * @tc.name    Telephony_CallManager_setCallRestriction_Promise_1600
   ...
   * @tc.name    Telephony_CallManager_getCallRestrictionStatus_Async_1100
   * @tc.desc    Set RESTRICTION_TYPE_ROAMING_INCOMING on and run function getCallRestriction
  ...
  it('Telephony_CallManager_getCallRestrictionStatus_Async_1100', 0, async function (done) {
    ...
    try {
      let data = await scenceLimitCalling(caseName, RESTRICTION_TYPE_ROAMING_INCOMING, RESTRICTION_MODE_ACTIVATION);
   ...
   * @tc.name    Telephony_CallManager_getCallRestrictionStatus_Promise_1100
   * @tc.desc    Set RESTRICTION_TYPE_ROAMING_INCOMING on and run function getCallRestrictionStatus
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_1100
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_1100
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_ENABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1300
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1300
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_86459751 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
   ...
   * @tc.name    Telephony_CallManager_separateConference_Async_0500
   * @tc.desc    Run 20 times function separateConference by callback
   *             when callId is any number(such as 1234) that is not exit in calllist,
   ...
   * @tc.name    Telephony_CallManager_separateConference_Promise_0500
   * @tc.desc    Run 20 times function separateConference by promise
   *             when callId is any number(such as 1234) that is not exit in calllist,
   *             the function return error,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   ...
   * @tc.name    Telephony_CallManager_isNewCallAllowed_Async_0500
   * @tc.desc    Run 20 times function isNewCallAllowed by callback ,
   ...
   * @tc.name    Telephony_CallManager_isNewCallAllowed_Promise_0500
   * @tc.desc    Run 20 times function isNewCallAllowed by promise ,
   *             the function always return true,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_isRinging_Async_0500
   * @tc.desc    Run 20 times function isRinging by callback ,
   ...
   * @tc.name    Telephony_CallManager_isRinging_Promise_0500
   * @tc.desc    Run 20 times function isRinging by promise ,
   *             the function always return false,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_setMuted_Async_0500
   * @tc.desc    Calling to 10086,run function setMuted by callback and by arg true for 20times,
   ...
   * @tc.name    Telephony_CallManager_setMuted_Promise_0500
   * @tc.desc    Calling to 10086,run function setMuted by promise and by arg true for 20 times,
   *             the function always return void,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Async_0500
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Promise_0500
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.name    Telephony_CallManager_setAudioDevice_Async_0700
   ...
   * @tc.name    Telephony_CallManager_setAudioDevice_Promise_0700
   ...
   * @tc.name    Telephony_CallManager_muteRinger_Async_0400
   * @tc.desc    Unwanted state,run function muteRinger by callback and 20 times,
   *             the function always return void,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_muteRinger_Promise_0400
   * @tc.desc    Unwanted state,run function muteRinger by callback and 20 times,
   *             the function always return void,and the cost less than 10ms
   * @tc.type    Performance
   * @tc.level   Level3
   ...
   * @tc.name    Telephony_CallManager_setCallRestriction_Async_1700
   ...
   * @tc.name    Telephony_CallManager_setCallRestriction_Promise_1700
   * @tc.desc    Run function setCallRestriction by promise by arg
   *             callid 1 type RESTRICTION_TYPE_ROAMING_INCOMING password 0000
   *             mode RESTRICTION_MODE_DEACTIVATION for 20 times,
   *             the function always return void,and the cost less than 10ms
   * @tc.type    Performance
   ...
   * @tc.name    Telephony_CallManager_getCallRestrictionStatus_Async_1200
   * @tc.desc    Set RESTRICTION_TYPE_ROAMING_INCOMING off and run function getCallRestrictionStatus
   *             by callback by arg slotId 1 CallRestrictionType RESTRICTION_TYPE_ROAMING_INCOMING
  ...
  it('Telephony_CallManager_getCallRestrictionStatus_Async_1200', 0, async function (done) {
    ...
    try {
      let data = await scenceLimitCalling(caseName, RESTRICTION_TYPE_ROAMING_INCOMING, RESTRICTION_MODE_DEACTIVATION);
   ...
   * @tc.name    Telephony_CallManager_getCallRestrictionStatus_Promise_1200
   * @tc.desc    Set RESTRICTION_TYPE_ROAMING_INCOMING off and run function getCallRestrictionStatus
   *             by callback by arg slotId 1 CallRestrictionType RESTRICTION_TYPE_ROAMING_INCOMING
   *             for 20 times,the function always return {status:0},and the cost less than 10ms
   * @tc.type    Performance
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Async_1200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   ...
   * @tc.name    Telephony_CallManager_setCallTransfer_Promise_1200
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Async_1400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
  ...
  it('Telephony_CallManager_getCallTransferInfo_Async_1400', 0, async function (done) {
    try {
      let data = await scenceTransferCalling(caseName, TRANSFER_DISABLE, TRANSFER_TYPE_ALWAYS, TRAN_PHONE_NUMBER_12599);
      console.log(`${caseName} scenceTransferCalling success,data:${toString(data)}`);
      let flag = await apiToPromisePerfomace({
        func: 'getCallTransferInfo',
        caseName: caseName,
   ...
   * @tc.name    Telephony_CallManager_getCallTransferInfo_Promise_1400
   * @tc.desc    Run function setCallTransfer by args slotId DEFAULT_SLOT_ID,settingType TRANSFER_DISABLE,
   *             type TRANSFER_TYPE_ALWAYS,transferNum TRAN_PHONE_NUMBER_12599 to set,
   *             then run function getCallTransferInfo by args slotId DEFAULT_SLOT_ID,
