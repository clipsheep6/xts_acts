...
describe('CallManageImsCall', function () {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0100
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,
     *             value true by callback,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0100', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0100';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, true, (error, data) => {
            if (error) {
                expect().assertFail();
                console.log(`${caseName} setLteEnhanceMode error,case failed,error:${toString(error)}`);
                done();
                return;
            }
            console.log(`${caseName} setLteEnhanceMode success,case success,data:${toString(data)}`);
            done();
        });
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0200
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,
     *             value false by callback,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0200', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0200';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, false, (error, data) => {
            if (error) {
                expect().assertFail();
                console.log(`${caseName} setLteEnhanceMode error,case failed,error:${toString(error)}`);
                done();
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0300
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID1,
     *             value true by callback,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0300', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0300';
        call.setLteEnhanceMode(SLOT_ID1, true, (error, data) => {
            if (error) {
                console.log(`${caseName} setLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
            }
            expect().assertFail();
            console.log(`${caseName} setLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        });
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0400
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID_INVALID,
     *             value true by callback,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0400', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0400';
        call.setLteEnhanceMode(SLOT_ID_INVALID, true, (error, data) => {
            if (error) {
                console.log(`${caseName} setLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0500
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID_INVALID_2,
     *             value true by callback,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0500', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0400';
        call.setLteEnhanceMode(SLOT_ID_INVALID_2, true, (error, data) => {
            if (error) {
                console.log(`${caseName} setLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0100
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,
     *             value true by promise,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0100', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0100';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, true).then(data => {
            console.log(`${caseName} setLteEnhanceMode success,case success,data:${toString(data)}`);
            done();
        }).catch(error => {
            expect().assertFail();
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0200
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value false by promise,
     *             the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0200', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0200';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, false).then(data => {
            console.log(`${caseName} setLteEnhanceMode success,case success,data:${toString(data)}`);
            done();
        }).catch(error => {
            expect().assertFail();
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0300
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID1,value true by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0300', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0300';
        call.setLteEnhanceMode(SLOT_ID1, true).then(data => {
            expect().assertFail();
            console.log(`${caseName} setLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        }).catch(error => {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0400
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID_INVALID,value true by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0400', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0400';
        call.setLteEnhanceMode(SLOT_ID_INVALID, true).then(data => {
            expect().assertFail();
            console.log(`${caseName} setLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        }).catch(error => {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0500
     * @tc.name    Run the function setLteEnhanceMode by args slotId SLOT_ID_INVALID_2,value true by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0500', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0500';
        call.setLteEnhanceMode(SLOT_ID_INVALID_2, true).then(data => {
            expect().assertFail();
            console.log(`${caseName} setLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        }).catch(error => {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0100
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value true,
     *             run the function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by callback,
     *             the function return true
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0100', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0100';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, true, (error, data) => {
            if (error) {
                expect().assertFail();
                console.log(`${caseName} setLteEnhanceMode error,case failed,error:${toString(error)}`);
            ...
            call.getLteEnhanceMode(DEFAULT_SLOT_ID, (error, data) => {
                if (error) {
                    expect().assertFail();
                    console.log(`${caseName} getLteEnhanceMode error,case failed,error:${toString(error)}`);
                    done();
                    return;
                }
                expect(data).assertTrue();
                console.log(`${caseName} setLteEnhanceMode success,case ${data === true ?
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0200
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value false,
     *             run the function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by callback,
     *             the function return false
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0200', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0200';
        call.setLteEnhanceMode(DEFAULT_SLOT_ID, false, (error, data) => {
            if (error) {
                expect().assertFail();
                console.log(`${caseName} setLteEnhanceMode error,case failed,error:${toString(error)}`);
            ...
            call.getLteEnhanceMode(DEFAULT_SLOT_ID, (error, data) => {
                ...
                console.log(`${caseName} setLteEnhanceMode success,case ${data === false ?
                    'success' : 'failed'},data:${toString(data)}`);
                done();
            });
        });
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0300
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID1 by callback,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0300', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0300';
        call.getLteEnhanceMode(SLOT_ID1, (error, data) => {
            if (error) {
                console.log(`${caseName} getLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
            }
            expect().assertFail();
            console.log(`${caseName} getLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        });
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0400
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID_INVALID by callback,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0400', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0400';
        call.getLteEnhanceMode(SLOT_ID_INVALID, (error, data) => {
            if (error) {
                console.log(`${caseName} getLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0500
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID_INVALID_2 by callback,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0500', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0500';
        call.getLteEnhanceMode(SLOT_ID_INVALID_2, (error, data) => {
            if (error) {
                console.log(`${caseName} getLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0100
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value true,
     *             run the function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by promise,
     *             the function return true
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0100', 0, async function () {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0100';
        try {
            await call.setLteEnhanceMode(DEFAULT_SLOT_ID, true);
            console.log(`${caseName} setLteEnhanceMode success`);
            let data = await call.getLteEnhanceMode(DEFAULT_SLOT_ID);
            expect(data).assertTrue();
            console.log(`${caseName} setLteEnhanceMode success,case ${data === true ?
                'success' : 'failed'},data:${toString(data)}`);
        } catch (error) {
            expect().assertFail();
            console.log(`${caseName} setLteEnhanceMode or getLteEnhanceMode error,case failed,error:${
                toString(error)}`);
        }
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0200
     * @tc.name    Run the function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value false,
     *             run the function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by promise,
     *             the function return false
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0200', 0, async function () {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0200';
        try {
            await call.setLteEnhanceMode(DEFAULT_SLOT_ID, false);
            console.log(`${caseName} setLteEnhanceMode success`);
            let data = await call.getLteEnhanceMode(DEFAULT_SLOT_ID);
            expect(data === false).assertTrue();
            console.log(`${caseName} setLteEnhanceMode success,case ${data === false ?
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0300
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID1 by promise,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0300', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0300';
        call.getLteEnhanceMode(SLOT_ID1).then(data => {
            expect().assertFail();
            console.log(`${caseName} getLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        }).catch(error => {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0400
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID_INVALID by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0400', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0400';
        call.getLteEnhanceMode(SLOT_ID_INVALID).then(data => {
            expect().assertFail();
            console.log(`${caseName} getLteEnhanceMode success,case failed,data:${toString(data)}`);
            done();
        }).catch(error => {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0500
     * @tc.name    Run the function getLteEnhanceMode by args slotId SLOT_ID_INVALID_2 by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0500', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0500';
        call.getLteEnhanceMode(SLOT_ID_INVALID_2, (error, data) => {
            if (error) {
                console.log(`${caseName} getLteEnhanceMode error,case success,error:${toString(error)}`);
                done();
    ...
    it('Telephony_CallManager_IMS_updateCallMediaMode_Async_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_updateCallMediaMode_Async_1100';
        call.updateCallMediaMode(CALL_ID_NOT_EXIST, CALL_MODE_SEND_RECEIVE, (error, data) => {
            if (error) {
