...
describe('CallManagementReliablePerformance', function () {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0600
     * @tc.name    Run function setLteEnhanceMode by args
     *             slotId DEFAULT_SLOT_ID,value true by callback for TEST_RELY_NUMBER times,
     *             the callback function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0600', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0600';
        apiToReliability({
            func: 'setLteEnhanceMode',
            caseName: caseName,
            target: call,
            compareFunc: function (error, data) {
                return !error;
        ...
        }, [DEFAULT_SLOT_ID, true, function () {}]);
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0600
     * @tc.name    Run function setLteEnhanceMode by args
     *             slotId DEFAULT_SLOT_ID,value true by promise for TEST_RELY_NUMBER times,
     *             the function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0600', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0600';
        apiToReliability({
            func: 'setLteEnhanceMode',
            caseName: caseName,
            target: call,
        ...
        }, [DEFAULT_SLOT_ID, true]);
    });

    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0600
     * @tc.name    Run function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value true,
     *             run function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by callback for TEST_RELY_NUMBER times,
     *             the callback function always return true
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0600', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0600';
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0600
     * @tc.name    Run function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value true,
     *             run function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID by promise for TEST_RELY_NUMBER times,
     *             the function always return true
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0600', 0, function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0600';
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_updateCallMediaMode_Async_0800
     * @tc.name    Run function updateCallMediaMode by args callId CALL_ID_NOT_EXIST,mod CALL_MODE_SEND_RECEIVE
     *             by callback for TEST_RELY_NUMBER times,the callback function always return error
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_updateCallMediaMode_Async_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_updateCallMediaMode_Async_0800';
        apiToReliability({
            func: 'updateCallMediaMode',
            caseName: caseName,
            target: call,
            compareFunc: function (error, data) {
                return !!error;
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_updateCallMediaMode_Promise_0800
     * @tc.name    Run function updateCallMediaMode by args callId CALL_ID_NOT_EXIST,
     *             mod CALL_MODE_SEND_RECEIVE by promise
     *             for TEST_RELY_NUMBER times,the function always return error
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_updateCallMediaMode_Promise_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_updateCallMediaMode_Promise_0800';
        apiToReliability({
            func: 'updateCallMediaMode',
            caseName: caseName,
            target: call,
