 ...
 */
export const AUTO_ACCEPT_NUMBER = '17160409240';

/* export const AUTO_ACCEPT_NUMBER = '13530163154';
   export const AUTO_ACCEPT_NUMBER = '17615117737';
   export const AUTO_ACCEPT_NUMBER = '10086'; */
export const NOT_ACCEPT_NUMBER = '18968621063';// 18968621063,this should comfirm,in alerting state
export const NULL_PHONE_NUMBER = '';
export const TRAN_PHONE_NUMBER_00000000000 = '00000000000';
export const TRNS_PHONE_NUMBER_089800000000 = '089800000000';
export const TRAN_PHONE_NUMBER_12599 = '12599';
export const TRAN_PHONE_NUMBER_LONG = '999567890999567890999567890123';
export const TRAN_PHONE_NUMBER_86459751 = '86459751';
export const TRAN_PHONE_NUMBER_089899855857 = '089899855857';

export const BOUNDARY_NUMBER_INT = 2147483649;
export const TEST_RELY_NUMBER = 1; // test count for Reliability
export const TEST_PERF_COUNT = 20; // test count for Perfomace
export const PERF_GOAL_TIME = 0.2;
