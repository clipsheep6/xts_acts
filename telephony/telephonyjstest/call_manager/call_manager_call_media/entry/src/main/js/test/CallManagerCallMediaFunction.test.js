...
describe('CallManagementCallMedia', function () {
     ...
     * @tc.name    Calling to 10086,run function setAudioDevice by promise and by arg DEVICE_WIRED_HEADSET,
     *             the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Calling to 10086,run function setAudioDevice by promise and by arg DEVICE_INVALID4,
     *             the function return error
     * @tc.desc    Function test
     */
