...
describe('CallManagementCallMedia', function () {
  ...
  it('Telephony_CallManager_separateConference_Promise_0300', 0, async function (done) {
    ...
    try {
      ...
      call.separateConference(callId)
        .then(data => {
          console.log(`${caseName} success,case ${data === null ? 'success' : 'failded'},data:${toString(data)}`);
          expect(data === null).assertTrue();
          hangupCall2(caseName, done, callId);
        })
        .catch(error => {
   ...
   * @tc.desc    Calling to 10086,run function setAudioDevice by callback and by arg DEVICE_EARPIECE,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.desc    Unwanted state,run function setAudioDevice by callback and by arg DEVICE_EARPIECE,
   ...
   * @tc.desc    Calling to 10086,run function setAudioDevice by promise and by arg DEVICE_EARPIECE,
   *             the function return void
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.desc    Unwanted state,run function setAudioDevice by promise and by arg DEVICE_EARPIECE,
   *             the function return error
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Async_0200
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.desc    Unwanted state,run function setMuted by callback,the function return error
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Async_0300
   * @tc.desc    Unwanted state,run function cancelMuted by callback,the function return error
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Promise_0200
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.desc    Unwanted state,run function setMuted by promise,the function return error
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Promise_0300
   * @tc.desc    Unwanted state,run function cancelMuted by promise,the function return error
   * @tc.type    Function
   * @tc.level   Level3
   */
   ...
   * @tc.desc    Dial a number after the call is dialing,
   *             run function setMuted by callback,
   *             the function return error
   * @tc.type    Function
   * @tc.level   Level3
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Async_0100
   * @tc.desc    Dial a number after the call is accepted,
   ...
   * @tc.name    Telephony_CallManager_cancelMuted_Promise_0100
   * @tc.desc    Dial a number after the call is accepted,
