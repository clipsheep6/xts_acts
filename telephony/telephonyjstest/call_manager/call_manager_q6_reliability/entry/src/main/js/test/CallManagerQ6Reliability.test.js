...
describe('CallManagementReliablePerformance', function () {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_enableVoLTE_Async_0600
     * @tc.name    Run function enableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_RELY_NUMBER times,
     *             the callback function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_enableVoLTE_Async_0600', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_enableVoLTE_Async_0600';
        try {
            apiToReliability({
                func: 'enableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_enableVoLTE_Promise_0600
     * @tc.name    Run function enableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by promise for TEST_RELY_NUMBER times,
     *             the function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_enableVoLTE_Promise_0600', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_enableVoLTE_Promise_0600';
        try {
            apiToReliability({
                func: 'enableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_disableVoLTE_Async_0800
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_RELY_NUMBER times,
     *             the callback function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_disableVoLTE_Async_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_disableVoLTE_Async_0800';
        try {
            apiToReliability({
                func: 'disableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_disableVoLTE_Promise_0800
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by promise for TEST_RELY_NUMBER times,
     *             the function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_disableVoLTE_Promise_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_disableVoLTE_Promise_0800';
        try {
            apiToReliability({
                func: 'disableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_isVoLTEEnabled_Async_0700
     * @tc.name    Run function isVoLTEEnabled by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_RELY_NUMBER times,
     *             the callback function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_isVoLTEEnabled_Async_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_isVoLTEEnabled_Async_0700';
        try {
            apiToReliability({
                func: 'isVoLTEEnabled',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0700
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by promise for TEST_RELY_NUMBER times,
     *             the function always return void
     * @tc.desc    Reliability test
     */
    it('Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0700';
        try {
            apiToReliability({
                func: 'isVoLTEEnabled',
                caseName: caseName,
