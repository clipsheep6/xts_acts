...
describe('CallManagementCallRestriction', function () {
    ...
    afterAll(function () {
        console.log('Telephony_CallManager all 68 case is over for callmanager CallManagementCallRestriction');
    });
     ...
     *             by arg slotId that is SLOT_ID_INVALID type RESTRICTION_TYPE_ROAMING_INCOMING password 0000
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId that is SLOT_ID_INVALID_2 type RESTRICTION_TYPE_ROAMING_INCOMING password 0000
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId that is SLOT_ID_INVALID type RESTRICTION_TYPE_ALL_OUTGOING password 0000
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId that is SLOT_ID_INVALID_2 type RESTRICTION_TYPE_ALL_OUTGOING password 0000
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
