...
describe('CallManagementCallRestriction', function () {
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_ALL_INCOMING password 0001
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_ALL_OUTGOING password 0001
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_INTERNATIONAL password 0001
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_INTERNATIONAL_EXCLUDING_HOME password 0001
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_ROAMING_INCOMING password 0001
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_ANONYMOUS password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_ACTIVATION,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Async_2300', 0, function (done) {
        ...
        call.setCallRestriction(DEFAULT_SLOT_ID, {
            type:RESTRICTION_TYPE_ANONYMOUS,
            password:RIGHT_PASSWORD,
            mode:RESTRICTION_MODE_ACTIVATION
        }, (error, data) => {
            if (error) {
    ...
    /**
     * @tc.number  Telephony_CallManager_setCallRestriction_Async_2600
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_INCOMING_SERVICES password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_ACTIVATION,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Async_2600', 0, function (done) {
        let caseName = 'Telephony_CallManager_setCallRestriction_Async_2600';
        call.setCallRestriction(DEFAULT_SLOT_ID, {
    ...
    /**
     * @tc.number  Telephony_CallManager_setCallRestriction_Async_2700
     * @tc.name    Run function setCallRestriction by callback
     *             by arg slotId DEFAULT_SLOT_ID type RESTRICTION_TYPE_SPECIFIC_INCOMING password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_ACTIVATION,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Async_2700', 0, function (done) {
        let caseName = 'Telephony_CallManager_setCallRestriction_Async_2700';
        call.setCallRestriction(DEFAULT_SLOT_ID, {
            type:RESTRICTION_TYPE_SPECIFIC_INCOMING,
            password:RIGHT_PASSWORD,
            mode:RESTRICTION_MODE_ACTIVATION
        }, (error, data) => {
            if (error) {
     ...
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Promise_2000', 0, function (done) {
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_INVALID10 password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_ACTIVATION,the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Promise_2200', 0, function (done) {
        ...
        call.setCallRestriction(SLOT_ID1, {
            type:RESTRICTION_TYPE_INVALID10,
            password:RIGHT_PASSWORD,
            mode:RESTRICTION_MODE_ACTIVATION
        })
            .then(data => {
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_ANONYMOUS password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_DEACTIVATION,the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_ALL_CALLS password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_DEACTIVATION,the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_OUTGOING_SERVICES password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_DEACTIVATION,the function return void
     * @tc.desc    Function test
     */
    ...
    /**
     * @tc.number  Telephony_CallManager_setCallRestriction_Promise_2600
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_INCOMING_SERVICES password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_DEACTIVATION,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Promise_2600', 0, function (done) {
        let caseName = 'Telephony_CallManager_setCallRestriction_Promise_2600';
        call.setCallRestriction(SLOT_ID1, {
            type:RESTRICTION_TYPE_INCOMING_SERVICES,
            password:RIGHT_PASSWORD,
            mode:RESTRICTION_MODE_DEACTIVATION
    ...
    /**
     * @tc.number  Telephony_CallManager_setCallRestriction_Promise_2700
     * @tc.name    Run function setCallRestriction by promise
     *             by arg slotId SLOT_ID1 type RESTRICTION_TYPE_SPECIFIC_INCOMING password RIGHT_PASSWORD
     *             mode RESTRICTION_MODE_DEACTIVATION,the function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setCallRestriction_Promise_2700', 0, function (done) {
        let caseName = 'Telephony_CallManager_setCallRestriction_Promise_2700';
        call.setCallRestriction(SLOT_ID1, {
            type:RESTRICTION_TYPE_SPECIFIC_INCOMING,
            password:RIGHT_PASSWORD,
            mode:RESTRICTION_MODE_DEACTIVATION
     ...
     *             RESTRICTION_TYPE_ALL_INCOMING ,the function return {status:RESTRICTION_ENABLE}
     * @tc.desc    Function test
     */
     ...
     *             getCallRestrictionStatus by callback by arg slotId DEFAULT_SLOT_ID CallRestrictionType
     *             RESTRICTION_TYPE_ALL_INCOMING ,the function return { status:RESTRICTION_DISABLE}
     * @tc.desc    Function test
     */
     ...
     *             getCallRestrictionStatus by callback by arg slotId DEFAULT_SLOT_ID CallRestrictionType
     *             RESTRICTION_TYPE_ALL_OUTGOING ,the function return {status:RESTRICTION_ENABLE}
     * @tc.desc    Function test
     */
     ...
     *             getCallRestrictionStatus by callback by arg slotId DEFAULT_SLOT_ID CallRestrictionType
     *             RESTRICTION_TYPE_ALL_OUTGOING ,the function return { status:RESTRICTION_DISABLE}
     * @tc.desc    Function test
     */
     ...
     *             getCallRestrictionStatus by callback by arg slotId DEFAULT_SLOT_ID CallRestrictionType
     *             RESTRICTION_TYPE_INTERNATIONAL ,the function return {status:RESTRICTION_ENABLE}
     * @tc.desc    Function test
     */
     ...
     *             getCallRestrictionStatus by callback by arg slotId DEFAULT_SLOT_ID CallRestrictionType
     *             RESTRICTION_TYPE_INTERNATIONAL ,the function return { status:RESTRICTION_DISABLE}
     * @tc.desc    Function test
     */
     ...
     *             the function return {status:RESTRICTION_ENABLE}
     * @tc.desc    Function test
     */
     ...
     *             the function return { status:RESTRICTION_DISABLE}
     * @tc.desc    Function test
     */
     ...
     * @tc.name    run function getCallRestrictionStatus by callback
     *             by arg slotId DEFAULT_SLOT_ID CallRestrictionType RESTRICTION_TYPE_SPECIFIC_INCOMING ,
     *             the function return default status
     * @tc.desc    Function test
     */
     ...
     * @tc.name    run function getCallRestrictionStatus by callback
     *             by arg slotId DEFAULT_SLOT_ID CallRestrictionType RESTRICTION_TYPE_ANONYMOUS ,
     *             the function return default status
     * @tc.desc    Function test
     */
    ...
    /**
     * @tc.number  Telephony_CallManager_getCallRestrictionStatus_Async_2000
     ...
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallRestrictionStatus_Async_2000', 0, function (done) {
        let caseName = 'Telephony_CallManager_getCallRestrictionStatus_Async_2000';
        scenceLimitCalling(caseName, RESTRICTION_TYPE_ROAMING_INCOMING, RESTRICTION_MODE_ACTIVATION, SLOT_ID1)
            .then(() => {
    ...
    /**
     * @tc.number  Telephony_CallManager_getCallRestrictionStatus_Async_2100
     * @tc.name    Run function getCallRestrictionStatus by callback by arg slotId
     *             that is SLOT_ID1 CallRestrictionType RESTRICTION_TYPE_INVALID ,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallRestrictionStatus_Async_2100', 0, function (done) {
        let caseName = 'Telephony_CallManager_getCallRestrictionStatus_Async_2100';
        call.getCallRestrictionStatus(SLOT_ID1, RESTRICTION_TYPE_INVALID, (error, data) => {
            if (error) {
                console.log(`${caseName} error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    /**
     * @tc.number  Telephony_CallManager_getCallRestrictionStatus_Promise_2000
     * @tc.name    Set RESTRICTION_TYPE_ROAMING_INCOMING RESTRICTION_MODE_DEACTIVATION
     *             and run function getCallRestrictionStatus by callback
     *             by arg slotId SLOT_ID1 CallRestrictionType RESTRICTION_TYPE_ROAMING_INCOMING ,
     *             the function return { status:RESTRICTION_DISABLE}
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallRestrictionStatus_Promise_2000', 0, function (done) {
        let caseName = 'Telephony_CallManager_getCallRestrictionStatus_Promise_2000';
        scenceLimitCalling(caseName, RESTRICTION_TYPE_ROAMING_INCOMING, RESTRICTION_MODE_DEACTIVATION, SLOT_ID1)
            .then(() => {
    ...
    /**
     * @tc.number  Telephony_CallManager_getCallRestrictionStatus_Promise_2100
     * @tc.name    Run function getCallRestrictionStatus by promise by arg slotId (that is at DEFAULT_SLOT_ID)
     *             CallRestrictionType RESTRICTION_TYPE_INVALID10 ,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_getCallRestrictionStatus_Promise_2100', 0, function (done) {
        let caseName = 'Telephony_CallManager_getCallRestrictionStatus_Promise_2100';
        call.getCallRestrictionStatus(DEFAULT_SLOT_ID, RESTRICTION_TYPE_INVALID10)
            .then(data => {
                console.log(`${caseName} success,case failed,data:${toString(data)}`);
                expect().assertFail();
                done();
