...
describe('CallManagementReliablePerformance', function () {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_enableVoLTE_Async_0700
     * @tc.name    Run function enableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_PERF_COUNT times,
     *             the callback function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_enableVoLTE_Async_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_enableVoLTE_Async_0700';
        try {
            apiToPerfomace({
                func: 'enableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_enableVoLTE_Promise_0700
     * @tc.name    Run function enableVoLTE by args
     ...
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_enableVoLTE_Promise_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_enableVoLTE_Promise_0700';
        try {
            apiToPerfomace({
                func: 'enableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_disableVoLTE_Async_0900
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_PERF_COUNT times,
     *             the callback function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_disableVoLTE_Async_0900', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_disableVoLTE_Async_0900';
        try {
            apiToPerfomace({
                func: 'disableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_disableVoLTE_Promise_0900
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by promise for TEST_PERF_COUNT times,
     *             the function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_disableVoLTE_Promise_0900', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_disableVoLTE_Promise_0900';
        try {
            apiToPerfomace({
                func: 'disableVoLTE',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_isVoLTEEnabled_Async_0800
     * @tc.name    Run function isVoLTEEnabled by args
     *             slotId DEFAULT_SLOT_ID by callback for TEST_PERF_COUNT times,
     *             the callback function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_isVoLTEEnabled_Async_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_isVoLTEEnabled_Async_0800';
        try {
            apiToPerfomace({
                func: 'isVoLTEEnabled',
                caseName: caseName,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0800
     * @tc.name    Run function disableVoLTE by args
     *             slotId DEFAULT_SLOT_ID by promise for TEST_PERF_COUNT times,
     *             the function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0800', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_isVoLTEEnabled_Promise_0800';
        try {
            apiToPerfomace({
                func: 'isVoLTEEnabled',
                caseName: caseName,
