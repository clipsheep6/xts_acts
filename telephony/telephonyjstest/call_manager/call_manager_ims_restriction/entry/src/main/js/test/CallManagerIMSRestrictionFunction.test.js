...
describe('CallManagementCallRestriction', function () {
    ...
    it('Telephony_CallManager_IMS_setCallRestriction_Async_1400', 0, function (done) {
        ...
        call.setCallRestriction(SLOT_ID1, {
            ...
            if (error) {
                console.log(`${caseName} setCallRestriction error:${toString(error)}`);
            } else {
    ...
    it('Telephony_CallManager_IMS_setCallRestriction_Promise_1400', 0, async function () {
        ...
        try {
            ...
            console.log(`${caseName} setCallRestriction success,case failed`);
            expect().assertFail();
            return;
        } catch (err) {
            console.log(`${caseName} setCallRestriction error,error:${toString(err)}`);
        }
        try {
