...
describe('CallManageImsCall', function () {
    beforeAll(async function () {
        callDetailsChangeOn();
        call.setCallPreferenceMode(0, 0, (data, error) => {
            if (error) {
    ...
    afterAll(function () {
        console.log('Telephony_CallManager all  case is over for callmanager CallManageImsCall');
    });
     ...
     *             {accountId: 0, videoState: 0, dialScene: 1, dialType:1} by callback,
     *             the callback function return true, and call step can reach CALL_STATUS_DIALING
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Async_0300', 0, function (done) {
        ...
        let obj = {accountId: 0, videoState: 0, dialScene: 1, dialType:1};
     ...
     *             {accountId: 0, videoState: 0, dialScene: 1, dialType:0} by callback,
     *             the callback function return true, and call step can reach CALL_STATUS_DIALING
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Async_0400', 0, function (done) {
        ...
        let obj = {accountId: 0, videoState: 0, dialScene: 1, dialType:0};
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: 1, videoState: 0, dialScene: 1, dialType:-1} by callback,
    ...
    it('Telephony_CallManager_IMS_dial_Async_0500', 0, function (done) {
        ...
        let obj = {accountId: 1, videoState: 0, dialScene: 1, dialType:-1};
        call.dial(PHONE_NUMBER_LENGTH_11, obj, (error, data) => {
            if (error) {
                console.log(`${caseName} dial error,error:${toString(error)}`);
                flag = true;
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: -1, videoState: 0, dialScene: 1, dialType:0} by callback,
     *             the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Async_0700', 0, function (done) {
        ...
        let obj = {accountId: -1, videoState: 0, dialScene: 1, dialType:0};
        call.dial(PHONE_NUMBER_LENGTH_11, obj, (error, data) => {
            if (error) {
                console.log(`${caseName} dial error,error:${toString(error)}`);
                flag = true;
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: 0, videoState: -1, dialScene: 1, dialType:0} by callback,
     *             the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Async_0800', 0, function (done) {
        ...
        let obj = {accountId: 0, videoState: -1, dialScene: 1, dialType:0};
        call.dial(PHONE_NUMBER_LENGTH_11, obj, (error, data) => {
            if (error) {
                console.log(`${caseName} dial error,error:${toString(error)}`);
                flag = true;
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: 0, videoState: 0, dialScene: 0, dialType:-1} by callback,
     *             the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Async_1000', 0, function (done) {
        ...
        let obj = {accountId: 0, videoState: 0, dialScene: 0, dialType:-1};
        call.dial(PHONE_NUMBER_LENGTH_11, obj, (error, data) => {
            if (error) {
                console.log(`${caseName} dial error,error:${toString(error)}`);
                flag = true;
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: 0, videoState: 0, dialScene: 0, dialType:0} by callback,
     *             the callback function return true,and call step can reach CALL_STATUS_DIALING
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber EMERGENCY_NUMBER options
     *             {accountId: 0, videoState: 0, dialScene: 1, dialType:0} by promise,
     *             the function return true, and call step can reach CALL_STATUS_DIALING
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId: -1, videoState: 0, dialScene: 1, dialType:0} by promise,
     *             the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId：0，videoState：2，dialScene：1，dialType：0} by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Promise_0700', 0, function (done) {
        ...
        let obj = {accountId:0, videoState:2, dialScene:1, dialType:0};
        call.dial(PHONE_NUMBER_LENGTH_11, obj).then(data => {
            flag = false;
        }).catch(error => {
            console.log(`${caseName} dial error,error:${toString(error)}`);
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId：0，videoState：0，dialScene：3，dialType：0} by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Promise_0800', 0, function (done) {
        ...
        let obj = {accountId:0, videoState:0, dialScene:3, dialType:0};
        call.dial(PHONE_NUMBER_LENGTH_11, obj).then(data => {
            flag = false;
        }).catch(error => {
            console.log(`${caseName} dial error,error:${toString(error)}`);
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId：0，videoState：0，dialScene：1，dialType：3} by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Promise_0900', 0, function (done) {
        ...
        let obj = {accountId:0, videoState:0, dialScene:1, dialType:3};
        call.dial(PHONE_NUMBER_LENGTH_11, obj).then(data => {
            flag = false;
        }).catch(error => {
            console.log(`${caseName} dial error,error:${toString(error)}`);
     ...
     * @tc.name    Dial a call by function dial by args phoneNumber PHONE_NUMBER_LENGTH_11 options
     *             {accountId：0，videoState：0，dialScene：2，dialType：0} by promise,
     *             the function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_IMS_dial_Promise_1300', 0, function (done) {
        ...
        let obj = {accountId:0, videoState:0, dialScene:2, dialType:0};
        call.dial(PHONE_NUMBER_LENGTH_11, obj).then(data => {
            flag = false;
        }).catch(error => {
            console.log(`${caseName} dial error,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Async_1300', 0, function (done) {
        ...
        call.startDTMF(MINUS_VALUE, 'C', (error) => {
            if (error) {
                console.log(`${caseName} error,case success,error:${toString(error)}`);
                done();
                return;
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0100', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '6').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0200', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '7').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0300', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '8').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0400', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '9').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0500', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, 'C').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0600', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, 'D').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0700', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '#').then(data => {
                console.log(`${caseName} case success`);
                hangupCall2(caseName, done, callId);
            }).catch(error => {
                console.log(`${caseName} error,case failed,error:${toString(error)}`);
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_0800', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, 'b').then(data => {
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_1000', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, 'E').then(data => {
                console.log(`${caseName} success,case error,data:${toString(data)}`);
                expect().assertFail();
                hangupCall2(caseName, done, callId);
            }).catch(error => {
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_1200', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            try {
                await call.startDTMF(callId, '10');
                console.log(`${caseName} success,case error,data:${toString(data)}`);
                expect().assertFail();
                hangupCall2(caseName, done, callId);
            } catch (error) {
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_1300', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(BOUNDARY_NUMBER_INT, 'C').then(data => {
                console.log(`${caseName} success,case error,data:${toString(data)}`);
                expect().assertFail();
                hangupCall2(caseName, done, callId);
            }).catch(error => {
    ...
    it('Telephony_CallManager_IMS_startDTMF_Promise_1600', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(CALL_ID_NOT_EXIST, '5').then(data => {
                console.log(`${caseName} success,case error,data:${toString(data)}`);
                expect().assertFail();
                hangupCall2(caseName, done, callId);
            }).catch(error => {
    ...
    it('Telephony_CallManager_IMS_stopDTMF_Async_0200', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.startDTMF(callId, '3', (error, data) => {
                if (error) {
    ...
    it('Telephony_CallManager_IMS_stopDTMF_Promise_0200', 0, async function (done) {
        ...
        try {
            ...
            callId = data.callId;
            data = await call.startDTMF(callId, '3');
            console.log(`${caseName} startDTMF success,data:${toString(data)}`);
