...
describe('CallManagementReliablePerformance', function () {
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Async_0700
     ...
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Async_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Async_0700';
        apiToPerfomace({
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0700
     * @tc.name    Run function setLteEnhanceMode by args slotId DEFAULT_SLOT_ID,value true
     *             by promise for TEST_PERF_COUNT times,
     *             the function always return void,and the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_setLteEnhanceMode_Promise_0700';
        apiToPerfomace({
            func: 'setLteEnhanceMode',
            caseName: caseName,
            target: call,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Async_0700
     * @tc.name    Run function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID,
     *             by callback for TEST_PERF_COUNT times,
     *             the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Async_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Async_0700';
        apiToPerfomace({
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0700
     * @tc.name    Run function getLteEnhanceMode by args slotId DEFAULT_SLOT_ID,
     *             by promise for TEST_PERF_COUNT times,
     *             the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0700', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_getLteEnhanceMode_Promise_0700';
        apiToPerfomace({
            func: 'getLteEnhanceMode',
            caseName: caseName,
            target: call,
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_updateCallMediaMode_Async_0900
     * @tc.name    Run function updateCallMediaMode by args callId CALL_ID_NOT_EXIST,mod CALL_MODE_SEND_RECEIVE
     *             by callback for TEST_PERF_COUNT times,
     *             the callback function always return error,the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_updateCallMediaMode_Async_0900', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_updateCallMediaMode_Async_0900';
        apiToPerfomace({
    ...
    /**
     * @tc.number  Telephony_CallManager_IMS_updateCallMediaMode_Promise_0900
     * @tc.name    Run function updateCallMediaMode by args callId callId CALL_ID_NOT_EXIST,mod CALL_MODE_SEND_RECEIVE
     *             by promise for TEST_PERF_COUNT times,
     *             the function always return error,the cost less than PERF_GOAL_TIME ms
     * @tc.desc    Performance test
     */
    it('Telephony_CallManager_IMS_updateCallMediaMode_Promise_0900', 0, async function (done) {
        let caseName = 'Telephony_CallManager_IMS_updateCallMediaMode_Promise_0900';
        apiToPerfomace({
            func: 'updateCallMediaMode',
            caseName: caseName,
            target: call,
