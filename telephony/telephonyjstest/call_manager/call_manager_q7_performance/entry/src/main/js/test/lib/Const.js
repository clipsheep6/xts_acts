...
export const TEST_RELY_NUMBER = 2; // test count for Reliability
export const TEST_PERF_COUNT = 2; // test count for Perfomace
...
export const CALL_MODE_SEND_RECEIVE = 1;
