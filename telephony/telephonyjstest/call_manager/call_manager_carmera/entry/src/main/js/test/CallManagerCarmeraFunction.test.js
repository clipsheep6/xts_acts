...
describe('CallManageCallCarmer', function () {
    ...
    it('Telephony_CallManager_controlCamera_Async_0100', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            if (!(camera && camera.getCameraIDs)) {
                console.log(`${caseName} getCameraIDs is not support,case failed`);
    ...
    it('Telephony_CallManager_setCameraZoom_Async_0100', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            try {
                new Camera().getSupportedZoomRange;
            } catch (error) {
                console.log(`${caseName} case failed,getSupportedZoomRange is not support`);
                hangupCall2(caseName, done, callId);
                return;
            }
