...
describe('CallManageCallCarmer', function () {
    beforeAll(async function (done) {
        callDetailsChangeOn();
        try {
            await call.setCallPreferenceMode(0, 0);
    ...
    afterAll(function () {
        console.log('Telephony_CallManager all  case 64 is over for callmanager CallManageCallCarmer');
    });
     ...
     *             x 700,y 10,z 1,width 300,height 600 by callback,
     *             the callback function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setPreviewWindow by args
     *             x 700,y 10,z 0,width 300,height 600 by callback,
     *             the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setPreviewWindow_Async_0200', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            let info = {x: 700, y: 10, z: 0, width: 300, height: 600};
            call.setPreviewWindow(info, (error) => {
                if (error) {
                    console.log(`${caseName} error,case failed,error:${toString(error)}`);
                    expect().assertFail();
     ...
     * @tc.name    Dial a call and after answering the call,run function setPreviewWindow by args
     *             x 700,y 10,z 2,width 300,height 600 by callback,
     *             the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setPreviewWindow_Async_0400', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            let info = {x: 700, y: 10, z: 2, width: 300, height: 600};
            call.setPreviewWindow(info, (error) => {
                if (error) {
                    console.log(`${caseName} error,case success,error:${toString(error)}`);
                    hangupCall2(caseName, done, callId);
     ...
     * @tc.name    Dial a call and after answering the call,run function setPreviewWindow by args
     *             x 700,y 10,z 1,width 300,height 600 by promise,
     *             the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setPreviewWindow by args
     *             x 700,y 10,z 0,width 300,height 600 by promise,
     *             the function return void
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setPreviewWindow by args
     *             x 700,y 10,z 2,width 300,height 600 by promise,
     *             the function return error
     * @tc.desc    Function test
     */
     ...
     *             zoomRatio 15.0 by callback,the callback function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio 0.0 by callback,the callback function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio -1.0 by callback,the callback function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio 10.1 by callback,the callback function return error
     * @tc.desc    Function test
     */
    ...
    it('Telephony_CallManager_setCameraZoom_Promise_0100', 0, async function (done) {
        ...
        try {
            ...
            zoomRatio = data && data.length ? data[0] : 5.0;
        } catch (error) {
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio 15.0 by promise,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args zoomRatio 0.0 by promise,
     *             the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio -1.0 by promise,the function return error
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Dial a call and after answering the call,run function setCameraZoom by args
     *             zoomRatio 10.1 by promise,the function return error
     * @tc.desc    Function test
     */
     ...
     *             by args rotation 0 by callback,
     *             the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0100', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(0, (error) => {
                if (error) {
                    console.log(`${caseName} error,case failed,error:${toString(error)}`);
                    expect().assertFail();
                    hangupCall2(caseName, done, callId);
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 90 by callback,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0200', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(90, (error) => {
                if (error) {
                    console.log(`${caseName} error,case failed,error:${toString(error)}`);
                    expect().assertFail();
                    hangupCall2(caseName, done, callId);
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 180 by callback,
     *             the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0300', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(180, (error) => {
                if (error) {
                    console.log(`${caseName} error,case failed,error:${toString(error)}`);
                    expect().assertFail();
                    hangupCall2(caseName, done, callId);
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 270 by callback,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0400', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(270, (error) => {
                if (error) {
                    console.log(`${caseName} error,case failed,error:${toString(error)}`);
                    expect().assertFail();
                    hangupCall2(caseName, done, callId);
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation -1 by callback,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0500', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(-1, (error) => {
                if (error) {
                    console.log(`${caseName} success, case success`);
                    hangupCall2(caseName, done, callId);
                    return;
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 60 by callback,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0600', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(60, (error) => {
                if (error) {
                    console.log(`${caseName} success, case success`);
                    hangupCall2(caseName, done, callId);
                    return;
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 360 by callback,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Async_0700', 0, function (done) {
        ...
        scenceInCalling({
            ...
            callId = data.callId;
            call.setDeviceDirection(360, (error) => {
                if (error) {
                    console.log(`${caseName} success, case success`);
                    hangupCall2(caseName, done, callId);
                    return;
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 0 by promise,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0100', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(0);
            console.log(`${caseName} case success`);
        } catch (error) {
            console.log(`${caseName} error,case error,error:${toString(error)}`);
            expect().assertFail();
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 90 by promise,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0200', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(90);
            console.log(`${caseName} case success`);
        } catch (error) {
            console.log(`${caseName} error,case error,error:${toString(error)}`);
            expect().assertFail();
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 180 by promise,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0300', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(180);
            console.log(`${caseName} case success`);
        } catch (error) {
            console.log(`${caseName} error,case error,error:${toString(error)}`);
            expect().assertFail();
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 270 by promise,the callback function return void
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0400', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(270);
            console.log(`${caseName} case success`);
        } catch (error) {
            console.log(`${caseName} error,case error,error:${toString(error)}`);
            expect().assertFail();
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation -1 by promise,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0500', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(-1);
     ...
     * @tc.name    Dial a call and after answering the call,run function setDeviceDirection
     *             by args rotation 60 by promise,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0600', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(60);
            console.log(`${caseName} success,case error`);
            expect().assertFail();
        } catch (error) {
            console.log(`${caseName} case success,error:${toString(error)}`);
     ...
     *             rotation 360 by promise,the callback function return error
     * @tc.desc    Function test
     */
    it('Telephony_CallManager_setDeviceDirection_Promise_0700', 0, async function (done) {
        ...
        try {
            await call.setDeviceDirection(360);
            console.log(`${caseName} success,case error`);
            expect().assertFail();
        } catch (error) {
            console.log(`${caseName} case success,error:${toString(error)}`);
