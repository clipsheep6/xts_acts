...
export default function ContactMergeTest() {
    describe('ContactMergeTest', function () {
        ...
        async function ContactDataInsert1(DAHelper, rawContactId1) {
            var contactDataValues = {
                "raw_contact_id": rawContactId1, "content_type": "name", "detail_info": "xiaoli"
            };
            try {
        ...
        async function ContactDataInsert2(DAHelper, rawContactId2) {
            var contactDataValues = {
                "raw_contact_id": rawContactId2, "content_type": "name", "detail_info": "xiaoli"
            };
            try {
     ...
     */
        it("contact_autoMerge_and_spilt_test_100", 0, async function (done) {
            ...
            try {
                ...
                sleep(1000);
                console.info("logMessage contact_auto_merge_and_spilt_test_100: rawContactId1 = " + rawContactId1);
            ...
            try {
                ...
                sleep(1000);
                console.info("logMessage contact_auto_merge_and_spilt_test_100: rawContactId2 = " + rawContactId2);
     ...
     */
        ...
        async function manualMergeDataInsertTwo(DAHelper, rawContactId2) {
            var contactDataValues = {
                "raw_contact_id": rawContactId2, "content_type": "name", "detail_info": "xiaoming"
            };
            try {
                var contactDataId = await DAHelper.insert(contactDataUri, contactDataValues);
                sleep(1000);
     ...
     */
        ...
        async function ContactDataBatchInsert(DAHelper, rawContactId1, rawContactId2, rawContactId3) {
            var contactDataValues1 = {
                "raw_contact_id": rawContactId1, "content_type": "name", "detail_info": "xiaoliu"
            };
            var contactDataValues2 = {
                "raw_contact_id": rawContactId2, "content_type": "name", "detail_info": "xiaoliu"
            };
            var contactDataValues3 = {
                "raw_contact_id": rawContactId3, "content_type": "name", "detail_info": "xiaoliu"
            };
            var listAddBluk = [];
     ...
     */
        ...
        async function queryContactDataInsert(DAHelper, rawContactId1) {
            var contactDataValues = {
                "raw_contact_id": rawContactId1, "content_type": "name", "detail_info": "xiaowu"
            };
            try {
                var contactDataId1 = await DAHelper.insert(contactDataUri, contactDataValues);
                sleep(1000);
