...
describe("Telephony_CellularDataPreferredCUCC", function () {
    ...
    it("Telephony_CellularData_activationDeactivation_Async_0300", 0, async function (done) {
        ...
        radio.setPreferredNetwork(SLOT_0, PreferredNetworkMode.PREFERRED_NETWORK_MODE_WCDMA, async function (err) {
            if (err) {
            ...
            cellular.enableCellularData(async function (err) {
                ...
                cellular.getCellularDataState(async function (err, data) {
                    ...
                    radio.setPreferredNetwork(
                        SLOT_0,
                        PreferredNetworkMode.PREFERRED_NETWORK_MODE_LTE,
                        async function (err) {
                            if (err) {
                                console.log(`${CASE_NAME} setPreferredNetwork err: ${err.message}`);
                                expect().assertFail();
        ...
        radio.setPreferredNetwork(SLOT_0, PreferredNetworkMode.PREFERRED_NETWORK_MODE_LTE, async function (err) {
            ...
            cellular.enableCellularData(async function (err) {
                ...
                cellular.getCellularDataState(async function (err, data) {
                    ...
                    radio.setPreferredNetwork(
                        SLOT_0,
                        PreferredNetworkMode.PREFERRED_NETWORK_MODE_WCDMA,
                        async function (err) {
                            if (err) {
                                console.log(`${CASE_NAME} setPreferredNetwork err: ${err.message}`);
                                expect().assertFail();
    ...
    it("Telephony_CellularData_activationDeactivation_Promise_0300", 0, async function (done) {
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, PreferredNetworkMode.PREFERRED_NETWORK_MODE_WCDMA);
            console.log(`${CASE_NAME} setPreferredNetwork finish`);
        } catch (err) {
            console.log(`${CASE_NAME} setPreferredNetwork err: ${err.message}`);
            expect().assertFail();
