...
describe("CellularDataPreferredCUCC", function () {
    ...
    it("Telephony_CellularData_ActivationDeactivation_0500", 0, async function (done) {
        ...
        radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_WCDMA, async(err) => {
            if (err) {
                expect().assertFail();
            ...
            cellular.enableCellularData(async(err) => {
                ...
                cellular.getCellularDataState((err, data) => {
                    ...
                    radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_LTE, (err) => {
                        if (err) {
                            expect().assertFail();
    ...
    it("Telephony_CellularData_ActivationDeactivation_Promise_0500", 0, async function (done) {
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.PREFERRED_NETWORK_MODE_AUTO);
            console.log('Telephony_CellularData_ActivationDeactivation_Promise_0500 set success');
        } catch (err) {
            console.log(`Telephony_CellularData_ActivationDeactivation_Promise_0500 set fail err: ${err}`);
            expect().assertFail();
            return;
        }
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_LTE);
            console.log("Telephony_CellularData_ActivationDeactivation_Promise_0500 set success");
        } catch (err) {
            console.log("Telephony_CellularData_ActivationDeactivation_Promise_0500 set fail ");
            expect().assertFail();
            return;
        }
        await sleep(Time);
        try {
            ...
            expect().assertFail();
            console.log("Telephony_CellularData_ActivationDeactivation_Promise_0500 fail");
            done();
            return;
        }
        await sleep(Time);
        try {
            ...
            console.log("Telephony_CellularData_ActivationDeactivation_Promise_0500 finish");
        ...
        try {
            await radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_WCDMA);
            console.log('Telephony_CellularData_ActivationDeactivation_Promise_0500 set success');
        } catch (err) {
            console.log(`Telephony_CellularData_ActivationDeactivation_Promise_0500 set fail err: ${err}`);
            expect().assertFail();
    ...
    it("Telephony_CellularData_ActivationDeactivation_0500", 0, async function (done) {
        ...
        radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_LTE, async(err) => {
            if (err) {
                expect().assertFail();
                console.log("Telephony_CellularData_ActivationDeactivation_0100 setPreferredNetwork fail");
                done();
            ...
            cellular.enableCellularData(async(err) => {
                ...
                cellular.getCellularDataState((err, data) => {
                    ...
                    console.log(
                        "Telephony_CellularData_ActivationDeactivation_0100 getCellularDataState finish     " + data);
                    radio.setPreferredNetwork(SLOT_0, radio.NETWORK_TYPE_WCDMA, (err) => {
                        if (err) {
                            expect().assertFail();
                            console.log("Telephony_CellularData_ActivationDeactivation_0100 turnOffRadio fail");
                            done();
