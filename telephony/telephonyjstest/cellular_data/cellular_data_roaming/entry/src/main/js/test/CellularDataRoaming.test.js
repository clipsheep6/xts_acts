...
describe("TelephonyCellularDataRoaming", function () {
    ...
    it("Telephony_CellularData_enableCellularDataRoaming_Async_0100", 0, async function (done) {
        cellular.isCellularDataRoamingEnabled(SLOT_ID, (err, data) => {
            ...
            console.log("Telephony_CellularData_enableCellularDataRoaming_Async_0100 finish   " + data);
        })
        ...
        cellular.disableCellularDataRoaming(SLOT_ID, (err) => {
            if (err) {
                expect().assertFail();
                console.log(
                    "Telephony_CellularData_enableCellularDataRoaming_Async_0100 disableCellularDataRoaming fail"
                );
                done();
                return;
            }
            console.log(
                "Telephony_CellularData_enableCellularDataRoaming_Async_0100 disableCellularDataRoaming finish"
            );
            done();
        })
    })
    ...
    it("Telephony_CellularData_disableCellularDataRoaming_Async_0100", 0, async function (done) {
        cellular.isCellularDataRoamingEnabled(SLOT_ID, (err, data) => {
            ...
            expect(data === false).assertTrue();
            console.log("Telephony_CellularData_disableCellularDataRoaming_Async_0100 finish  " + data);
        })
        cellular.disableCellularDataRoaming((err) => {
            if (err) {
                expect().assertFail();
                console.log(
    ...
    it("Telephony_CellularData_disableCellularDataRoaming_Async_0200", 0, async function (done) {
        cellular.disableCellularDataRoaming(ERR_SLOT_ID, (err) => {
            ...
            expect().assertFail();
            console.log("Telephony_CellularData_disableCellularDataRoaming_Async_0200 disableCellularDataRoaming fail");
            done();
            return;
        })
    })
    ...
    it("Telephony_CellularData_isCellularDataRoamingEnabled_Async_0100", 0, async function (done) {
        ...
        cellular.isCellularDataRoamingEnabled(SLOT_ID, (err, data) => {
            ...
            expect(data).assertTrue();
            console.log("Telephony_CellularData_isCellularDataRoamingEnabled_Async_0100 finish " + data);
        })
        cellular.disableCellularDataRoaming(SLOT_ID, (err) => {
            if (err) {
                expect().assertFail();
                console.log(
                    "Telephony_CellularData_isCellularDataRoamingEnabled_Async_0100 disableCellularDataRoaming fail"
                );
                done();
                return;
            }
            console.log(
                "Telephony_CellularData_isCellularDataRoamingEnabled_Async_0100 disableCellularDataRoaming finish"
            );
            done();
        })
    })
    ...
    it("Telephony_CellularData_isCellularDataRoamingEnabled_Async_0300", 0, async function (done) {
        ...
        cellular.isCellularDataRoamingEnabled(SLOT_ID, (err, data) => {
            ...
            expect(data === false).assertTrue();
            console.log("Telephony_CellularData_isCellularDataRoamingEnabled_Async_0300 finish  " + data);
            done();
        })
    })
    ...
    it("Telephony_CellularData_enableCellularDataRoaming_Promise_0100", 0, async function (done) {
        try {
            var data = await cellular.isCellularDataRoamingEnabled(SLOT_ID);
            expect(data === false).assertTrue();
            console.log("Telephony_CellularData_enableCellularDataRoaming_Promise_0100 finish  " + data);
        } catch (err) {
            expect().assertFail();
    ...
    /*
     * @tc.number   Telephony_CellularData_disableCellularDataRoaming_Async_0100
     * @tc.name    Call disableCellularDataRoaming interface, normal into the reference, to check the correction results
     * @tc.desc     Function test
     */
    it("Telephony_CellularData_disableCellularDataRoaming_Async_0100", 0, async function (done) {
        try {
        ...
        try {
            ...
            expect().assertFail();
            console.log("Telephony_CellularData_disableCellularDataRoaming_Async_0100 disableCellularDataRoaming fail");
            done();
            return;
        }
        try {
    ...
    it("Telephony_CellularData_isCellularDataRoamingEnabled_Promise_0300", 0, async function (done) {
        ...
        console.log("Telephony_CellularData_isCellularDataRoamingEnabled_Promise_0300 finish   " + data);
        done();
    })
})
