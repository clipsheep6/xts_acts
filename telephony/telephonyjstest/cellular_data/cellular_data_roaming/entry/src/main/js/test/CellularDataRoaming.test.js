...
describe("TelephonyCellularDataRoaming", function () {
    ...
    it("Telephony_CellularData_disableCellularData_Promise_0200", 0, async function (done) {
        try {
            await cellular.disableCellularDataRoaming(SLOT_ID);
            console.log(
                "Telephony_CellularData_disableCellularData_Promise_0200 disableCellularDataRoaming finish"
            );
        } catch (err) {
            expect().assertFail();
            console.log("Telephony_CellularData_disableCellularData_Promise_0200 disableCellularDataRoaming fail");
            done();
            return;
        }
        try {
    ...
    it("Telephony_CellularData_disableCellularDataRoaming_Async_0300", 0, async function (done) {
        try {
            ...
            expect().assertFail();
            console.log("Telephony_CellularData_disableCellularDataRoaming_Async_0300 fail");
        } catch (err) {
            console.log("Telephony_CellularData_disableCellularDataRoaming_Async_0300 finish");
            done();
            return;
        }
        done();
