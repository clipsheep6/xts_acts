        ...
        async function deletedRawContactQuery(DAHelper, rawContactId) {
            ...
            try {
                ...
                if (resultSet.goToFirstRow()) {
                    ...
                    console.info('logMessage contact_query_test_3800: display_name = ' + resultSet.getString(2));
        ...
        async function queryDelete(DAHelper, rawContactId) {
            ...
            try {
                ...
                if (resultSet.goToFirstRow()) {
                    ...
                    console.info('logMessage contact_delete_test_4400: display_name = ' + resultSet.getString(2));
        ...
        async function DeletedRawContactQuery(DAHelper, rawContactId) {
            ...
            try {
                ...
                if (resultSet.goToFirstRow()) {
                    ...
                    console.info('logMessage contact_delete_test_4800: display_name = ' + resultSet.getString(2));
                ...
                try {
                    ...
                    if (resultSet.goToFirstRow()) {
                        do {
                            ...
                            console.info(
                                'logMessage contact_fuzzyquery_test_500: phonetic_name = ' + resultSet.getString(2));
