...
describe('NetworkManagergetAddressesByNameTest', function () {
    let name666 = "666";
    let nameAAA= "AAA";
    let addressBaidu ="www.baidu.com";
    let addressTaobao ="www.taobao.com";
    let addressCsdn = "www.csdn.net";

    /**
     * @tc.number  Telephony_NetworkManager_getAddressesByName_Async_0100
     * @tc.name    Verify hostName is addressBaidu test getAddressByName() to check the return value and
     ...
     * @tc.name    Verify hostName is addressTaobao test getAddressByName() to check the return value and
 *                 resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Async_0200', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            console.log("handle=" + handle.id);
            handle.getAddressesByName(addressTaobao, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressesByName callback error = " + error);
                    expect().assertFail();
                    done();
     ...
     * @tc.name    TVerify hostName is addressCsdn test getAddressByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Async_0300', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(addressCsdn, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressesByName callback error = " + error);
                    expect().assertFail();
                    done();
     ...
     * @tc.name    TVerify hostName is name666 test getAddressByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Async_0500', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(name666, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressesByName callback error = " + error);
                    expect(error!=0).assertTrue();
                    done();
    ...
    it('Telephony_NetworkManager_getAddressesByName_Async_0500', 0, async function (done) {
        let caseName = 'Telephony_NetworkManager_getAddressesByName_Async_0500';
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(nameAAA, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressesByName callback error = " + error);
                    expect(error!=0).assertTrue();
                    done();
    ...
    it('Telephony_NetworkManager_getAddressByName_Async_0200', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(addressTaobao, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressByName callback error = " + error);
                    expect().assertFail();
                    done();
     ...
     * @tc.name    Verify hostName is addressCsdn test getAddressByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressByName_Async_0300', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(addressCsdn, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressByName callback error = " + error);
                    expect().assertFail();
                    done();
     ...
     * @tc.name    Verify hostName is name666 test getAddressByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressByName_Async_0500', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(name666, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressByName callback error = " + error);
                    expect(error!=0).assertTrue();
                    done();
    ...
    it('Telephony_NetworkManager_getAddressByName_Async_0600', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(nameAAA, (error, value) => {
                if (error) {
                    console.log(`${caseName}`+"getAddressByName callback error = " + error);
                    expect(error!=0).assertTrue();
                    done();
     ...
     * @tc.name    Verify hostName is name2 test bindSocket() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Verify hostName is addressBaidu test getAddressesByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
     ...
     * @tc.name    Verify hostName is addressTaobao test getAddressesByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Promise_0200', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(addressTaobao).then((data) => {
                console.log(`${caseName}`+"getAddressesByName promiss = " + JSON.stringify(data));
                expect(data.length>0).assertTrue();
                done();
            }).catch((error) => {
     ...
     * @tc.name    Verify hostName is addressCsdn test getAddressesByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Promise_0300', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(addressCsdn).then((data) => {
                console.log(`${caseName}`+"getAddressesByName promiss = " + JSON.stringify(data));
                expect(data.length>0).assertTrue();
                done();
            }).catch((error) => {
 ...
 *             resolution result. NET_CONN_SUCCESS is returned with 0
     ...
     * @tc.name    Verify hostName is name666 test getAddressesByName() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_getAddressesByName_Promise_0500', 0, async function (done) {
        let caseName = 'Telephony_NetworkManager_getAddressesByName_Promise_0300';
        connection.getDefaultNet().then((handle) => {
            handle.getAddressesByName(name666).then((data) => {
                console.log(`${caseName}`+"getAddressesByName promiss = " + JSON.stringify(data));
            }).catch((error) => {
                console.log(`${caseName}`+"getAddressesByName promiss error = " + error);
                expect(error!=0).assertTrue();
    ...
    it('Telephony_NetworkManager_getAddressByName_Promise_0200', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(addressTaobao).then((data) => {
                console.log(`${caseName}`+"getAddressByName promiss = " + JSON.stringify(data));
                expect(data.length>0).assertTrue();
                done();
            }).catch((error) => {
    ...
    it('Telephony_NetworkManager_getAddressByName_Promise_0300', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(addressCsdn).then((data) => {
                console.log(`${caseName}`+"getAddressByName promiss = " + JSON.stringify(data));
                expect(data.length>0).assertTrue();
                done();
            }).catch((error) => {
    ...
    it('Telephony_NetworkManager_getAddressByName_Promise_0500', 0, async function (done) {
        ...
        connection.getDefaultNet().then((handle) => {
            handle.getAddressByName(name666).then((data) => {
                console.log(`${caseName}`+"getAddressByName promiss = " + JSON.stringify(data));
            }).catch((error) => {
                console.log(`${caseName}`+"getAddressByName promiss error = " + error);
                expect(error!=0).assertTrue();
    ...
    /**
     * @tc.number  Telephony_NetworkManager_bindSocket_Promise_0600
     * @tc.name    Verify hostName is "-1" test bindSocket() to check the return value and
     *             resolution result. NET_CONN_SUCCESS is returned with 0
     * @tc.desc    Function test
     */
    it('Telephony_NetworkManager_bindSocket_Promise_0600', 0, async function (done) {
        let caseName = 'Telephony_NetworkManager_bindSocket_Async_0600';
        connection.getDefaultNet().then((handle) => {
            handle.bindSocket(-1).then((data) => {
                console.log(`${caseName}`+"bindSocket promiss = " + data);
