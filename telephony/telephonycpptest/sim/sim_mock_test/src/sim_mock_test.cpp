...
HWTEST_F(SimTest, Telephony_Sim_GetSimState_0500, Function | MediumTest | Level3)
{
    ...
    g_proxy.MockSimStateSet((int32_t)OHOS::Telephony::SimState::SIM_STATE_UNKNOWN);
    ...
    g_proxy.MockSimStateSet((int32_t)OHOS::Telephony::SimState::SIM_STATE_READY);
}
...
HWTEST_F(SimTest, Telephony_Sim_GetSimState_0600, Function | MediumTest | Level3)
{
    ...
    g_proxy.MockSimStateSet((int32_t)OHOS::Telephony::SimState::SIM_STATE_NOT_PRESENT);
    int32_t result = g_proxy.GetHandler()->GetSimState(SLOTID_0);
...
HWTEST_F(SimTest, Telephony_Sim_GetSimState_0700, Function | MediumTest | Level3)
{
    ...
    g_proxy.MockSimStateSet((int32_t)OHOS::Telephony::SimState::SIM_STATE_LOCKED);
    int32_t result = g_proxy.GetHandler()->GetSimState(SLOTID_0);
