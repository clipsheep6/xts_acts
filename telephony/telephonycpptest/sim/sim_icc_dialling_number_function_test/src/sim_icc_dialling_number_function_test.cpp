...
HWTEST_F(SimADNContactTest, Telephony_Sim_QueryIccDiallingNumbers_0100, Function | MediumTest | Level2)
{
    ...
    g_simContact->DeleteFDNContact(SimTest::SLOTID_0, contactInfo);
    contactInfo->pin2_ = Str8ToStr16(SimTest::ERROR_FDN_PIN2);
    g_simContact->DeleteADNContact(SimTest::SLOTID_0, contactInfo);
    ...
    bool ret = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_TRUE(ret);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_QueryIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    contactInfo->name_ = Str8ToStr16(contactName);
    contactInfo->number_ = Str8ToStr16(contactNumber);
    bool ret = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(ret);
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> diallingNumbersList =
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0200, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_TRUE(result);
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0800, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0900, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_1000, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_DelIccDiallingNumbers_0100, Function | MediumTest | Level2)
{
    ...
    contactInfo->name_ = Str8ToStr16(contactName);
    contactInfo->number_ = Str8ToStr16(contactNumber);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_TRUE(ret);
...
HWTEST_F(SimTest, Telephony_Sim_DelIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    contactInfo->number_ = Str8ToStr16(SimTest::CONTACT_NUMBER);
    contactInfo->pin2_ = Str8ToStr16(SimTest::ERROR_FDN_PIN2);
    bool result = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_DelIccDiallingNumbers_0400, Function | MediumTest | Level3)
{
    ...
    contactInfo->number_ = Str8ToStr16(SimTest::CONTACT_NUMBER);
    contactInfo->pin2_ = Str8ToStr16(CORRECT_PIN2);
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(ret);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_0500, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, contactInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_DelIccDiallingNumbers_0800, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_DelIccDiallingNumbers_0900, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1000, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, contactInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, contactInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1300, Function | MediumTest | Level2)
{
    ...
    diallingNumbersList = g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN);
    bool findRecordNum = false;
    for (std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>>::iterator iter =
             diallingNumbersList.begin();
         iter != diallingNumbersList.end(); iter++) {
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1400, Function | MediumTest | Level2)
{
    ...
    diallingNumbersList = g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN);
    bool findRecordNum = false;
    for (std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>>::iterator iter =
             diallingNumbersList.begin();
         iter != diallingNumbersList.end(); iter++) {
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0100, Function | MediumTest | Level2)
{
    ...
    bool retUpdate = g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, contactInfo);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    contactInfo->name_ = Str8ToStr16(SimTest::NEW_CONTACT_NAME);
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate = g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, contactInfo);
    ASSERT_TRUE(retUpdate);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0400, Function | MediumTest | Level4)
{
    ...
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, contactInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    contactInfo->name_ = Str8ToStr16(SimTest::NEW_CONTACT_NAME);
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate = g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1200, Function | MediumTest | Level4)
{
    ...
    contactInfo->name_ = Str8ToStr16(SimTest::NEW_CONTACT_NAME);
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate = g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, contactInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1300, Function | MediumTest | Level4)
{
    ...
    contactInfo->name_ = Str8ToStr16(SimTest::NEW_CONTACT_NAME);
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate = g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, contactInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1400, Function | MediumTest | Level4)
{
    ...
    contactInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, contactInfo);
    ASSERT_FALSE(retUpdate);
}
