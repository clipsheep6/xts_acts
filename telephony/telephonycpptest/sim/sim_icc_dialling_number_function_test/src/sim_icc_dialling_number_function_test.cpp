...
HWTEST_F(SimADNContactTest, Telephony_Sim_QueryIccDiallingNumbers_0100, Function | MediumTest | Level2)
{
    ...
    delDiallingInfo->name_ = Str8ToStr16(contactName);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_QueryIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    delDiallingInfo->name_ = Str8ToStr16(contactName);
    delDiallingInfo->number_ = Str8ToStr16(contactNumber);
    bool ret = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(ret);
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN);
    bool findRecordNum = false;
    for (std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>>::iterator iter = vecDialNumInfo.begin();
         iter != vecDialNumInfo.end(); iter++) {
        if ((*iter)->index_ == SimTest::CONTACT_INDEX_1) {
...
{
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS);
    bool result = vecDialNumInfo.empty();
    ASSERT_TRUE(result);
}
...
{
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN);
    bool result = vecDialNumInfo.empty();
    ASSERT_TRUE(result);
}
...
{
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN);
    bool result = vecDialNumInfo.empty();
    ASSERT_TRUE(result);
}
...
{
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO);
    bool result = vecDialNumInfo.empty();
    ASSERT_TRUE(result);
}
...
{
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE);
    bool result = vecDialNumInfo.empty();
    ASSERT_TRUE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0100, Function | MediumTest | Level4)
{
    ...
    bool result =
        g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_MINUS, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0200, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(result);
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0400, Function | MediumTest | Level3)
{
    ...
    ASSERT_TRUE(result);
    delDiallingInfo->pin2_ = Str8ToStr16(CORRECT_PIN2);
    delDiallingInfo->name_ = Str8ToStr16("");
    bool ret = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0800, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_0900, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_1000, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_AddIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, delDiallingInfo);
    ASSERT_FALSE(result);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_1400, Function | MediumTest | Level2)
{
    std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo> delDiallingInfo =
        std::make_shared<OHOS::Telephony::DiallingNumbersInfo>();
    delDiallingInfo->index_ = SimTest::CONTACT_INDEX_1;
 ...
 * @tc.desc     Function test
 */
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_1500, Function | MediumTest | Level2)
{
    std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo> delDiallingInfo =
        std::make_shared<OHOS::Telephony::DiallingNumbersInfo>();
    delDiallingInfo->index_ = SimTest::CONTACT_INDEX_1;
...
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_1600, Function | MediumTest | Level2)
{
    ...
    delDiallingInfo->name_ = Str8ToStr16(contactNameOverlength);
    bool ret = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(ret);
    std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>> vecDialNumInfo =
        g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN);
...
HWTEST_F(SimADNContactTest, Telephony_Sim_AddIccDiallingNumbers_2000, Function | MediumTest | Level2)
{
    std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo> delDiallingInfo =
        std::make_shared<OHOS::Telephony::DiallingNumbersInfo>();
    delDiallingInfo->index_ = SimTest::CONTACT_INDEX_2;
    delDiallingInfo->name_ = Str8ToStr16(SimTest::CONTACT_NAME);
    delDiallingInfo->number_ = Str8ToStr16(SimTest::CONTACT_NUMBER);
    delDiallingInfo->pin2_ = Str8ToStr16(CORRECT_PIN2);
    g_simContact->DeleteFDNContact(SimTest::SLOTID_0, delDiallingInfo);
...
HWTEST_F(SimADNContactTest, Telephony_Sim_DelIccDiallingNumbers_0200, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_MINUS, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimTest, Telephony_Sim_DelIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::CONTACT_NUMBER);
    delDiallingInfo->pin2_ = Str8ToStr16(SimTest::ERROR_FDN_PIN2);
    bool result = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(result);
}
...
HWTEST_F(SimTest, Telephony_Sim_DelIccDiallingNumbers_0400, Function | MediumTest | Level3)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::CONTACT_NUMBER);
    delDiallingInfo->pin2_ = Str8ToStr16(CORRECT_PIN2);
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(ret);

    // After the deletion is successful, check whether it still exists.
    g_simContact->QueryDeletionResult(SimTest::SLOTID_0, SimTest::TYPE_FDN, freeIndex);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_0500, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_DelIccDiallingNumbers_0800, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_DelIccDiallingNumbers_0900, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1000, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    bool result = g_proxy.GetHandler()->AddIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(result);
    bool ret = g_proxy.GetHandler()->DelIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, delDiallingInfo);
    ASSERT_FALSE(ret);
}
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_DelIccDiallingNumbers_1400, Function | MediumTest | Level2)
{
    ...
    vecDialNumInfo = g_proxy.GetHandler()->QueryIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN);
    bool findRecordNum = false;
    for (std::vector<std::shared_ptr<OHOS::Telephony::DiallingNumbersInfo>>::iterator iter = vecDialNumInfo.begin();
         iter != vecDialNumInfo.end(); iter++) {
        if ((*iter)->index_ == freeIndex) {
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0200, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_MINUS, SimTest::TYPE_ADN, delDiallingInfo);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0300, Function | MediumTest | Level3)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_FDN, delDiallingInfo);
    ASSERT_TRUE(retUpdate);
...
HWTEST_F(SimFDNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_0400, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_MINUS, delDiallingInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1100, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_1, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1200, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_2, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1300, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ZERO, delDiallingInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1400, Function | MediumTest | Level4)
{
    ...
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_THREE, delDiallingInfo);
    ASSERT_FALSE(retUpdate);
}
...
HWTEST_F(SimADNContactTest, Telephony_Sim_UpdateIccDiallingNumbers_1900, Function | MediumTest | Level2)
{
    ...
    delDiallingInfo->name_ = Str8ToStr16(newContactNameOverlength);
    delDiallingInfo->number_ = Str8ToStr16(SimTest::NEW_CONTACT_NUMBER);
    bool retUpdate =
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SimTest::SLOTID_0, SimTest::TYPE_ADN, delDiallingInfo);
    ASSERT_TRUE(retUpdate);
