 ...
 * @tc.name     When the card type is DUAL_MODE_TELECOM_LTE_CARD, the GetCardType interface is called to
 *              get the return value.
 * @tc.desc     Function test
 */
HWTEST_F(SimCardTypeMockTest, Telephony_Sim_GetCardType_1200, Function | MediumTest | Level3)
{
    // Call the analog vendor library interface to pre-set the card type to DUAL_MODE_TELECOM_LTE_CARD.
