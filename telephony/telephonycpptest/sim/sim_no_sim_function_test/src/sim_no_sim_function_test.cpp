 ...
 */
HWTEST_F(SimTest, Telephony_Sim_SetPrimarySlotId_0400, Function | MediumTest | Level1)
{
 ...
 * @tc.desc     Function test
 */
HWTEST_F(SimTest, Telephony_Sim_HasOperatorPrivileges_0700, Function | MediumTest | Level1)
{
