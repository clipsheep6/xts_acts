...
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_HoldCall_0200, Function | MediumTest | Level2)
{
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS,
        SLEEP_12000_MS);
...
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_HoldCall_0400, Function | MediumTest | Level2)
{
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING),
        true, SLEEP_50_MS, SLEEP_12000_MS);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE),
        true, SLEEP_50_MS, SLEEP_12000_MS);
    ret = g_clientPtr->GetPtr()->HoldCall(g_newCallId);
    ASSERT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_HOLDING),
        true, SLEEP_50_MS, SLEEP_12000_MS);
}
...
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_SwitchCall_0600, Function | MediumTest | Level2)
{
    ...
    EXPECT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(firstCall, TelCallState::CALL_STATUS_DISCONNECTED), true, SLEEP_50_MS,
        SLEEP_12000_MS);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_SwitchCall_0900, Function | MediumTest | Level2)
{
    sleep(SLEEP_5_SEC);
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_SwitchCall_1000, Function | MediumTest | Level2)
{
    sleep(SLEEP_5_SEC);
    int ret = Dial(Str8ToStr16(UNICOM_OPERATOR_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_IsVoLteEnabled_0100, Function | MediumTest | Level2) // todo
{
