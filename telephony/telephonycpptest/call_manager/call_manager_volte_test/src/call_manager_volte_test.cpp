...
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_HoldCall_0200, Function | MediumTest | Level2)
{
    ...
    LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_HoldCall_0400, Function | MediumTest | Level2)
{
    ...
    if (HasActiveStatus()) {
        ret = g_clientPtr->GetPtr()->HoldCall(g_newCallId);
        ASSERT_EQ(ret, SUCCESSFUL);
        LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_HOLDING), true, SLEEP_50_MS, SLEEP_12000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_HoldCall_0500, Function | MediumTest | Level2)
{
    ...
    if (HasActiveStatus()) {
        ...
        EXPECT_NE(ret, SUCCESSFUL);
        LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_12000_MS);
    }
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_EnableImsSwitch_0100, Function | MediumTest | Level2)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_VOTLE_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
...
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_DisableImsSwitch_1000, Function | MediumTest | Level2)
{
    ...
    int ret = g_clientPtr->GetPtr()->DisableImsSwitch(SLOT_ID);
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_VOTLE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);

    ret = Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateCallType, CallType::TYPE_CS, SLEEP_50_MS, SLEEP_1000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_IsImsSwitchEnabled_0100, Function | MediumTest | Level2)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_VOTLE_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("active"), OPEN, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_IsImsSwitchEnabled_0300, Function | MediumTest | Level2)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_VOTLE_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("active"), OFF, SLEEP_50_MS, SLEEP_1000_MS);
    ret = g_clientPtr->GetPtr()->EnableImsSwitch(SLOT_ID);
    ASSERT_EQ(ret, SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_USSD_DialCall_0100, Function | MediumTest | Level2)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_WAITING_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SET_CALL_WAITING_FIAL, SLEEP_50_MS, SLEEP_12000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_USSD_DialCall_0300, Function | MediumTest | Level2)
{
    ...
    int ret = Dial(Str8ToStr16("*#43#"));
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_WAITING_REPORT_ID, SLEEP_50_MS, SLEEP_30000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_USSD_DialCall_0400, Function | MediumTest | Level2)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_TRANSFER_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), ERROR_VALUES, SLEEP_50_MS, SLEEP_12000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_USSD_DialCall_0600, Function | MediumTest | Level2)
{
    int ret = Dial(Str8ToStr16("**21*10000000001******10#"));
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SEND_USSD_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), OFF, SLEEP_50_MS, SLEEP_1000_MS);
}
