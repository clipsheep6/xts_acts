...
#define CALLMANAGER_SUPPLEMENTARY_SERVICE_TEST
...
{
    char invalidPhoneNumber[BUFSIZ] = "1234567890123456789012345678";
...
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = CallTransferSettingType(CALL_TRANSFER_REGISTRATION);
    setCallTransfer.type = TRANSFER_TYPE_UNCONDITIONAL;
...
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = CALL_TRANSFER_ERASURE;
    setCallTransfer.type = TRANSFER_TYPE_UNCONDITIONAL;
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, OBJECT_PHONY_NUMBER);
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
