...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_DialCall_0300, Function | MediumTest | Level3)
{
    ...
    dialInfo.PutIntValue("dialScene", CALL_PRIVILEGED);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_DialCall_2200, Function | MediumTest | Level3)
{
    ...
    ASSERT_NE(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, (int)TelCallState::CALL_STATUS_IDLE), true, SLEEP_50_MS, SLEEP_30000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_DialCall_2300, Function | MediumTest | Level3)
{
    ...
    dialInfo.PutIntValue("accountId", SLOT_ID);
    dialInfo.PutIntValue("videoState", (int)VideoStateType::TYPE_VOICE);
    dialInfo.PutIntValue("dialScene", CALL_EMERGENCY);
    dialInfo.PutIntValue("dialType", (int)DialType::DIAL_CARRIER_TYPE);
    int ret = g_clientPtr->GetPtr()->DialCall(Str8ToStr16(TARGET_PHONY_NUMBER), dialInfo);
    ASSERT_EQ(ret, SUCCESSFUL);
}
 ...
 * @tc.name     make a CALL_EMERGENCY phone call with DIAL_CARRIER_TYPE, EMERGENCY_PHONY_NUMBER return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     make a normal phone call with card1, EMERGENCY_PHONY_NUMBER, return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import str '0', test StartDtmf(),return non-zero
 *              wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import str '5', test StartDtmf(),return non-zero
 *              wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import str '8', test StartDtmf(),return non-zero
 *              wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import str 'C', test StartDtmf(),return non-zero
 *              wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import callId -100, test StopDtmf(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import cameraId and callingPackage, dial call test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import invalid cameraId and callingPackage, dial call  test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import cameraId and invalid callingPackage, dial call  test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import empty cameraId and callingPackage, dial call test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
 ...
 *              and Import empty cameraId test ControlCamera() close again,return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import coordinateX Y Z and width height, dial call  test SetPreviewWindow(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import coordinateX Y Z and width height, dial call  test SetDisplayWindow(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import file path, dial call test SetPauseImage(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import invalid file path, dial call test SetPauseImage(),return non-zero
 * @tc.desc     Function test
 */
...
{
    std::string invalidPath = "/system/bin/callManager/notexistpath.webp";
    int ret = Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.name     Import emptyPath, dial call test SetPauseImage(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import rotation, dial call test SetDeviceDirection(),return non-zero
 * @tc.desc     Function test
 */
