 ...
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_DialCall_0100, Function | MediumTest | Level3)
{
 ...
 * @tc.name     make a normal phone call with card is 3 and dialType is -1, return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_AnswerCall_1200, Function | MediumTest | Level3)
{
    int ret = CallManagerFunctionTest::Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    if (HasActiveStatus()) {
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_IMS_CallManager_RejectCall_0800, Function | MediumTest | Level3)
{
    u16string textMessage = Str8ToStr16("this is a test message");
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_HangUpCall_1000, Function | MediumTest | Level3)
{
    int ret = CallManagerFunctionTest::Dial(Str8ToStr16(TELEOPERATOR_OPERATOR_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    if (HasActiveStatus()) {
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_StartDtmf_1500, Function | MediumTest | Level3)
{
    char validDtmf = 'B';
 ...
 * @tc.name     Import cameraId is empty, dial call test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import cameraId is invalid, dial call test ControlCamera(),return non-zero
 * @tc.desc     Function test
 */
