...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_SetCallWaiting_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_WAITING_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetCallWaiting_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("status"), OPEN, SLEEP_50_MS, SLEEP_1000_MS);
}
