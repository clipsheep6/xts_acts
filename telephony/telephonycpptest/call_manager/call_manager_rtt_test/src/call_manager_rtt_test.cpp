...
{
    EXPECT_NE(g_clientPtr->GetPtr()->EnableLteEnhanceMode(SLOT_ID_1), SUCCESSFUL);
}
...
{
    EXPECT_NE(g_clientPtr->GetPtr()->DisableLteEnhanceMode(SLOT_ID_1), SUCCESSFUL);
}
...
{
    EXPECT_NE(g_clientPtr->GetPtr()->IsLteEnhanceModeEnabled(SLOT_ID_1), SUCCESSFUL);
}
...
{
    EXPECT_NE(g_clientPtr->GetPtr()->GetImsConfig(SLOT_ID_1, ImsConfigItem::ITEM_VIDEO_QUALITY), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_SetImsConfig_0700, Function | MediumTest | Level3)
{
    std::u16string imsValues = Str8ToStr16(IMS_VALUES_0);
    EXPECT_NE(
        g_clientPtr->GetPtr()->SetImsConfig(SLOT_ID_1, ImsConfigItem::ITEM_IMS_SWITCH_STATUS, imsValues), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetImsFeatureValue_0100, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LOCK_NUM_WHILE_NE(g_updateResult.GetIntValue("value"), static_cast<int>(FeatureType::TYPE_VOICE_OVER_LTE),
        SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetImsFeatureValue_0200, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(
        g_updateReportId, CallResultReportId::GET_IMS_FEATURE_VALUE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LOCK_NUM_WHILE_NE(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LOCK_NUM_WHILE_NE(g_updateResult.GetIntValue("value"), static_cast<int>(FeatureType::TYPE_VIDEO_OVER_LTE),
        SLEEP_50_MS, SLEEP_1000_MS);
}
...
{
    EXPECT_NE(g_clientPtr->GetPtr()->GetImsFeatureValue(SLOT_ID_1, FeatureType::TYPE_VOICE_OVER_LTE), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_SetImsFeatureValue_0700, Function | MediumTest | Level3)
{
    int imsValues = 0;
    EXPECT_NE(
        g_clientPtr->GetPtr()->SetImsFeatureValue(SLOT_ID_1, FeatureType::TYPE_VOICE_OVER_LTE, imsValues), SUCCESSFUL);
}

/****************************************** Test UpdateCallMediaMode() ***************************************/

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0100
 * @tc.name     testing UpdateCallMediaMode,add a active call,input CALL_MODE_SEND_RECEIVE
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0100, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(
        g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_SEND_RECEIVE), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0200
 * @tc.name     testing UpdateCallMediaMode,add a active call,and call UpdateCallMediaMode input CALL_MODE_SEND_RECEIVE
 *              call UpdateCallMediaMode input CALL_MODE_AUDIO_ONLY again
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0200, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(
        g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_SEND_RECEIVE), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    EXPECT_EQ(g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_AUDIO_ONLY), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0700
 * @tc.name     testing UpdateCallMediaMode,input CALL_MODE_SEND_RECEIVE and callId 999
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0700, Function | MediumTest | Level3)
{
    EXPECT_NE(g_clientPtr->GetPtr()->UpdateCallMediaMode(FALSE_CALLID_999, CallMediaMode::CALL_MODE_SEND_RECEIVE),
        SUCCESSFUL);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_1000
 * @tc.name     testing UpdateCallMediaMode,add a active call,input CALL_MODE_SEND_ONLY
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_UpdateCallMediaMode_1000, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(TELEOPERATOR_OPERATOR_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_12000_MS);
    EXPECT_EQ(
        g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_SEND_ONLY), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_1100
 * @tc.name     testing UpdateCallMediaMode,add a active call,input CALL_MODE_RECEIVE_ONLY
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_UpdateCallMediaMode_1100, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(UNICOM_OPERATOR_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_12000_MS);
    EXPECT_EQ(
        g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_RECEIVE_ONLY), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_1200
 * @tc.name     testing UpdateCallMediaMode,add a active call,and call UpdateCallMediaMode input CALL_MODE_SEND_RECEIVE
 *              and call UpdateCallMediaMode input CALL_MODE_VIDEO_PAUSED again
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_UpdateCallMediaMode_1200, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    EXPECT_EQ(
        g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_VIDEO_PAUSED), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
}
...
/**
 * @tc.number   Telephony_CallManager_IMS_RegisterCallBack_0600
 * @tc.name     testing RegisterCallBack,input CALL_MODE_SEND_RECEIVE and callId 999
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerIMSTest, Telephony_CallManager_IMS_RegisterCallBack_0600, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(EMERGENCY_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
    LOCK_NUM_WHILE_NE(g_updateIsEcc, true, SLEEP_50_MS, SLEEP_1000_MS);
}
