...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_EnableLteEnhanceMode_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_LTE_ENHANCE_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    ...
    CallManagerFunctionTest, Telephony_CallManager_IMS_IsLteEnhanceModeEnabled_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_LTE_ENHANCE_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), true, SLEEP_50_MS, SLEEP_1000_MS);
}
    ...
    CallManagerFunctionTest, Telephony_CallManager_IMS_IsLteEnhanceModeEnabled_0200, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_LTE_ENHANCE_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), false, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetImsConfig_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_IMS_CONFIG_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);

    EXPECT_EQ(g_clientPtr->GetPtr()->GetImsConfig(SLOT_ID, ImsConfigItem::ITEM_VIDEO_QUALITY), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_IMS_CONFIG_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), true, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetImsConfig_0800, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_IMS_CONFIG_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), static_cast<int>(ImsConfigItem::ITEM_VIDEO_QUALITY),
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_GetImsConfig_0900, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_IMS_CONFIG_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("value"), static_cast<int>(ImsConfigItem::ITEM_IMS_SWITCH_STATUS),
        SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_SetImsConfig_0300, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(
        g_clientPtr->GetPtr()->SetImsConfig(SLOT_ID, ImsConfigItem::ITEM_IMS_SWITCH_STATUS, imsValues), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_IMS_CONFIG_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_RegisterCallBack_0700, Function | MediumTest | Level3)
{
    ...
    int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
    EXPECT_EQ(hangUpRet, SUCCESSFUL);
    LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_DISCONNECTED), true, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateCause, static_cast<DisconnectedDetails>(SUCCESSFUL), SLEEP_50_MS, SLEEP_30000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IMS_RegisterCallBack_0800, Function | MediumTest | Level3)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    sleep(SLEEP_2_SEC);
    if (g_updateEventId == CallAbilityEventId::EVENT_OTT_FUNCTION_UNSUPPORTED) {
    } else {
        LOG("The OTT service is not started");
    }
}
