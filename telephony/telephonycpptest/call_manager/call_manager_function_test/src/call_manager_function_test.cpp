 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_DialCall_1000, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    if (HasActiveStatus()) {
        LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_30000_MS);
    }
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_HangUpCall_0100, Function | MediumTest | Level3)
{
    int ret = CallManagerFunctionTest::Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LockNumWhiteEq(g_newCallId, FALSE_DEFAULT, SLEEP_50_MS, SLEEP_1000_MS);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_HoldCall_0600, Function | MediumTest | Level2)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    if (HasActiveStatus()) {
        ...
        ret = g_clientPtr->GetPtr()->HoldCall(g_newCallId);
        EXPECT_EQ(ret, SUCCESSFUL);
        LockNumWHhileNe(HasState(g_newCallId, TelCallState::CALL_STATUS_HOLDING), true, SLEEP_50_MS, SLEEP_30000_MS);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_UnHoldCall_0600, Function | MediumTest | Level2)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_HasCall_0800, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_CombineConference_0200, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetMainCallId_0200, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetSubCallIdList_0200, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.name     Import son callId,test GetCallIdListForConference(),return non-zero,Empty and destroy after
 * completion wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallIdListForConference_0200, Function | MediumTest | Level3)
{
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallWaiting_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("status"), OPEN, SLEEP_50_MS, SLEEP_12000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallWaiting_0400, Function | MediumTest | Level3)
{
    ...
    ASSERT_EQ(isRet, SUCCESSFUL);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("status"), OFF, SLEEP_50_MS, SLEEP_12000_MS);
    isRet = g_clientPtr->GetPtr()->GetCallWaiting(SLOT_ID);
    EXPECT_EQ(isRet, SUCCESSFUL);
 ...
 * @tc.name     Import countryCode abcdefg, phoneNumber "01000000000", test FormatPhoneNumberToE164(),return
 * non-zero
 * @tc.desc     Function test
 */
