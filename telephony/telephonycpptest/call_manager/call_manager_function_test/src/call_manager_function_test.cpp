 ...
 * @tc.name     Call one phonynumber, test IsInEmergencyCall(),return non 0
 *              wait for the correct status of the callback to execute correctly
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerDialTest, Telephony_CallManager_IsInEmergencyCall_0100, Function | MediumTest | Level3)
{
    string invalidPhoneNumber = TARGET_PHONY_NUMBER;
 ...
 * @tc.name     Import countryCode CN, phoneNumber 666666999999,test FormatPhoneNumber(),return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import countryCode abcdefg, phoneNumber 2000000000, test FormatPhoneNumber(),return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import phoneNumber 666666999999, countryCode as CN, test FormatPhoneNumberToE164(),return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import countryCode abcdefg, phoneNumber "01000000000", test FormatPhoneNumberToE164(),return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     coming call, send MMI "**21*00000000000*10#" enable the unconditional transfer
 *              and transfer number, return 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_MMI_0900, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16("**21*00000000000*10#"));
    EXPECT_EQ(ret, SUCCESSFUL);
}
