...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_CombineConference_0300, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_INCOMING), true, SLEEP_50_MS, SLEEP_15000_MS);

    ASSERT_EQ(g_clientPtr->GetPtr()->AnswerCall(g_newCallId, (int)VideoStateType::TYPE_VOICE), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_15000_MS);
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_WAITING), true, SLEEP_50_MS, SLEEP_15000_MS);

    ASSERT_EQ(g_clientPtr->GetPtr()->AnswerCall(g_newCallId, (int)VideoStateType::TYPE_VOICE), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(firstCall, TelCallState::CALL_STATUS_HOLDING), true, SLEEP_50_MS, SLEEP_15000_MS);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_15000_MS);
...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_SeparateConference_0400, Function | MediumTest | Level3)
{
    ...
    ASSERT_EQ(g_clientPtr->GetPtr()->AnswerCall(g_newCallId, (int)VideoStateType::TYPE_VOICE), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(secondCall, TelCallState::CALL_STATUS_HOLDING), true, SLEEP_50_MS, SLEEP_15000_MS);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_15000_MS);
...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_JoinConference_0600, Function | MediumTest | Level3)
{
    ...
    std::vector<std::u16string> targetCallNumberList{Str8ToStr16("1234567890123456789012345678901")};
    ASSERT_NE(g_clientPtr->GetPtr()->JoinConference(retMain, targetCallNumberList), SUCCESSFUL);
}

/**
 * @tc.number   Telephony_CallManager_IMS_JoinConference_0700
 * @tc.name     mock_vendor coming two call, input empty callNumber and valid callNumber ,test JoinConference(),return
 *              non-zero
 * @tc.desc     Function test
 */
...
/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0300
 * @tc.name     testing UpdateCallMediaMode,add a active call,and call UpdateCallMediaMode again,return non-zero
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0300, Function | MediumTest | Level3)
{
    ...
    ASSERT_EQ(g_clientPtr->GetPtr()->AnswerCall(g_newCallId, (int)VideoStateType::TYPE_VIDEO), SUCCESSFUL);
...
/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0400
 * @tc.name     testing UpdateCallMediaMode,add a active call,input CALL_MODE_AUDIO_ONLY return non-zero
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0400, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
    ...
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true, SLEEP_50_MS, SLEEP_12000_MS);
    EXPECT_NE(g_clientPtr->GetPtr()->UpdateCallMediaMode(g_newCallId, CallMediaMode::CALL_MODE_AUDIO_ONLY), SUCCESSFUL);
}

/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0500
 * @tc.name     testing UpdateCallMediaMode,add a active call,input CALL_MODE_SEND_RECEIVE return non-zero
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0500, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
...
/**
 * @tc.number   Telephony_CallManager_IMS_UpdateCallMediaMode_0600
 * @tc.name     testing UpdateCallMediaMode,add a active call,and call UpdateCallMediaMode three times,return non-zero
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_UpdateCallMediaMode_0600, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(TARGET_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true, SLEEP_50_MS, SLEEP_12000_MS);
