...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_StartRtt_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::START_RTT_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_StopRtt_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(CallManagerFunctionTest::HasState(g_newCallId, TelCallState::CALL_STATUS_ACTIVE), true,
        SLEEP_50_MS, SLEEP_15000_MS);
    ASSERT_EQ(g_clientPtr->GetPtr()->StopRtt(g_newCallId), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::STOP_RTT_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerMockTest, Telephony_CallManager_IMS_UpdateImsCallMode_0300, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    EXPECT_EQ(g_clientPtr->GetPtr()->UpdateImsCallMode(g_newCallId, ImsCallMode::CALL_MODE_SEND_RECEIVE), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::UPDATE_MEDIA_MODE_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), ERROR_RESULT, SLEEP_50_MS, SLEEP_1000_MS);
}
