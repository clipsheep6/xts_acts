...
static OHOS::AppExecFwk::PacMap g_updateVolteResult;
static OHOS::AppExecFwk::PacMap g_updateRttResult;
...
static OHOS::Telephony::CallResultReportId g_updateVolteReportId;
static OHOS::Telephony::CallResultReportId g_updateRttReportId;
...
public:
    ...
    const int SET_CALL_WAITING_RESULT = 4;
...
// set Map key and value
    ...
    TELEPHONY_LOGI("OnCallDetailsChange on");
    return SUCCESSFUL;
}
...
int32_t CallAbilityCallbackBasic::OnVolteResult(CallResultReportId reportId, AppExecFwk::PacMap &resultInfo)
{
    g_updateVolteReportId = reportId;
    g_updateVolteResult = resultInfo;
    TELEPHONY_LOGI("OnVolteResult on");
    return SUCCESSFUL;
}

int32_t CallAbilityCallbackBasic::OnRttResult(CallResultReportId reportId, AppExecFwk::PacMap &resultInfo)
{
    g_updateRttReportId = reportId;
    g_updateRttResult = resultInfo;
    return SUCCESSFUL;
}
...
// add 2 seconds to prevent blocking by the carrier when dialing too fast
    ...
    g_updateVolteResult.Clear();
    g_updateReportId = static_cast<CallResultReportId>(CallTestEnum::INVALIN_ENUM_VALUE);
    g_updateVolteReportId = static_cast<CallResultReportId>(CallTestEnum::INVALIN_ENUM_VALUE);
    g_updateRttReportId = static_cast<CallResultReportId>(CallTestEnum::INVALIN_ENUM_VALUE);
