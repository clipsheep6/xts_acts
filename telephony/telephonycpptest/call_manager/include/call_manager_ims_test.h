...
public:
    ...
    const int32_t LONG_NEGATIVE_CALLID = -2147483647;
...
void CallManagerIMSTest::TestRegisterCallBack(char phoneNumber[BUFSIZ])
{
    ...
    LOCK_NUM_WHILE_NE(g_updateCallType, (int)CallType::TYPE_IMS, SLEEP_50_MS, SLEEP_12000_MS);
