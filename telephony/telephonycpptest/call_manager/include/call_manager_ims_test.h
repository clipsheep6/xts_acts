...
void CallManagerIMSTest::TestRegisterCallBack(char phoneNumber[BUFSIZ])
{
    ...
    LockStringWhiteNe(updatePhoneNumber.c_str(), phoneNumber, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateSpeaker, true, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateAccountId, ACCOUNT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateVideoState, VideoStateType::TYPE_VOICE, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateIsEcc, false, SLEEP_50_MS, SLEEP_12000_MS);
    LockNumWHhileNe(g_updateCallType, CallType::TYPE_IMS, SLEEP_50_MS, SLEEP_12000_MS);
...
void CallManagerIMSTest::TearDown()
{
    ...
    LockNumWhiteEq(g_newCallId, FALSE_DEFAULT, SLEEP_50_MS, SLEEP_12000_MS);
