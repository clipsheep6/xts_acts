...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0100, Function | MediumTest | Level3)
{
    ...
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_ENABLE);
    setCallTransfer.type = TRANSFER_TYPE_BUSY;
    ...
    TestTransferCallBack(OPEN, TRANSFER_TYPE_BUSY);
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_DISABLE);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0200, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OFF, TRANSFER_TYPE_BUSY);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0300, Function | MediumTest | Level3)
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_ENABLE);
    setCallTransfer.type = TRANSFER_TYPE_NO_REPLY;
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OPEN, TRANSFER_TYPE_NO_REPLY);
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_DISABLE);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0400, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OFF, TRANSFER_TYPE_NO_REPLY);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0500, Function | MediumTest | Level3)
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_ENABLE);
    setCallTransfer.type = TRANSFER_TYPE_NOT_REACHABLE;
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OPEN, TRANSFER_TYPE_NOT_REACHABLE);
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_DISABLE);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0600, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OFF, TRANSFER_TYPE_NOT_REACHABLE);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0700, Function | MediumTest | Level3)
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_ENABLE);
    setCallTransfer.type = TRANSFER_TYPE_UNCONDITIONAL;
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OPEN, TRANSFER_TYPE_UNCONDITIONAL);
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_DISABLE);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_0800, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OFF, TRANSFER_TYPE_UNCONDITIONAL);
}
 ...
 * @tc.name     enable type TRANSFER_TYPE_BUSY, settingType REGISTRATION, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_BUSY, settingType ERASURE, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_NO_REPLY, settingType REGISTRATION, test SetCallTransferInfo(), return 0
 *              Restoring the Initial Environment of ERASURE
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_NO_REPLY, settingType ERASURE, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_NOT_REACHABLE, settingType REGISTRATION, test SetCallTransferInfo(), return 0
 *              Restoring the Initial Environment of ERASURE
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_NOT_REACHABLE, settingType ERASURE, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_UNCONDITIONAL, settingType REGISTRATION, test SetCallTransferInfo(), return 0
 *              Restoring the Initial Environment of ERASURE
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_UNCONDITIONAL, settingType ERASURE, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_BUSY, settingType REGISTRATION, test SetCallTransferInfo(), return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_NO_REPLY, settingType ERASURE, test SetCallTransferInfo(), return non-zero
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallTransferInfo_2100, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OFF, TRANSFER_TYPE_ALWAYS);
}
 ...
 * @tc.name     enable type TRANSFER_TYPE_UNCONDITIONAL, settingType REGISTRATION, test SetCallTransferInfo(),
 ...
 * @tc.name     enable type TRANSFER_TYPE_UNCONDITIONAL, settingType ERASURE, test SetCallTransferInfo(),settingType
