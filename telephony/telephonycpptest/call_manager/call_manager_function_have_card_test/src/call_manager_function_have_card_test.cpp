 ...
 * @tc.name     Import slotId 1, get callwaiting to be on, test GetCallWaiting(),return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     Import slotId 10,set callwaiting to be off,test GetCallWaiting(),return 0
 * @tc.desc     Function test
 */
