...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_RegisterCallBack_0200, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(g_updateReportId, GET_CALL_WAITING_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
...
HWTEST_F(CallManagerDialTest, Telephony_CallManager_RegisterCallBack_0300, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(ret, SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateEventId, EVENT_STOP_DTMF_SUCCESS, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallRestriction_2000, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID_1, setCallRestriction), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallRestriction(SLOT_ID_1, setCallRestriction.fac), SUCCESSFUL);
    TestRestrictionCallBack(OPEN);
    setCallRestriction.mode = RESTRICTION_MODE_DEACTIVATION;
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID_1, setCallRestriction), SUCCESSFUL);
}
...
/**
 * @tc.number   Telephony_CallManager_GetCallRestriction_2100
 * @tc.name     enable fac INVALID_NEGATIVE_CALL_TYPE -1,
 *              test GetCallRestriction(), return non 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallRestriction_2100, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
...
/**
 * @tc.number   Telephony_CallManager_GetCallRestriction_2200
 * @tc.name     enable fac INVALID_RESTRICTION_TYPE 10,
 *              test GetCallRestriction(), return non 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallRestriction_2200, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
 ...
 * @tc.name     enable fac RESTRICTION_TYPE_ALL_INCOMING, mode RESTRICTION_MODE_ACTIVATION,
 *              INVALID_NEGATIVE_SLOT_ID -1, test SetCallRestriction(), return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable fac INVALID_RESTRICTION_TYPE of 10, mode RESTRICTION_MODE_DEACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0, result ACTIVE error
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable fac RESTRICTION_TYPE_ANONYMOUS, mode RESTRICTION_MODE_ACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0,Restoring the Initial Environment of RESTRICTION_MODE_DEACTIVATION
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable fac RESTRICTION_TYPE_ANONYMOUS, mode RESTRICTION_MODE_DEACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0
 * @tc.desc     Function test
 */
...
/**
 * @tc.number   Telephony_CallManager_SetCallRestriction_3800
 * @tc.name     enable fac RESTRICTION_TYPE_INCOMING_SERVICES, mode RESTRICTION_MODE_ACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0,Restoring the Initial Environment of RESTRICTION_MODE_DEACTIVATION
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_3800, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
    setCallRestriction.fac = RESTRICTION_TYPE_INCOMING_SERVICES;
    int ret = strcpy_s(setCallRestriction.password, BUFSIZ, VALID_CALL_PASSWORD.c_str());
...
/**
 * @tc.number   Telephony_CallManager_SetCallRestriction_3900
 * @tc.name     enable fac RESTRICTION_TYPE_INCOMING_SERVICES, mode RESTRICTION_MODE_DEACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_3900, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
    setCallRestriction.fac = RESTRICTION_TYPE_INCOMING_SERVICES;
    int ret = strcpy_s(setCallRestriction.password, BUFSIZ, VALID_CALL_PASSWORD.c_str());
...
/**
 * @tc.number   Telephony_CallManager_SetCallRestriction_4000
 * @tc.name     enable fac RESTRICTION_TYPE_SPECIFIC_INCOMING, mode RESTRICTION_MODE_ACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0,Restoring the Initial Environment of RESTRICTION_MODE_DEACTIVATION
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_4000, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
    setCallRestriction.fac = RESTRICTION_TYPE_SPECIFIC_INCOMING;
    int ret = strcpy_s(setCallRestriction.password, BUFSIZ, VALID_CALL_PASSWORD.c_str());
...
/**
 * @tc.number   Telephony_CallManager_SetCallRestriction_4100
 * @tc.name     enable fac RESTRICTION_TYPE_SPECIFIC_INCOMING, mode RESTRICTION_MODE_DEACTIVATION,SLOT_ID of 0
 *              test SetCallRestriction(), return 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_4100, Function | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
    setCallRestriction.fac = RESTRICTION_TYPE_SPECIFIC_INCOMING;
    int ret = strcpy_s(setCallRestriction.password, BUFSIZ, VALID_CALL_PASSWORD.c_str());
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_1100, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(g_updateResult.GetIntValue("type"), MOBILE_BUSY, SLEEP_50_MS, SLEEP_1000_MS);
}
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType REGISTRATION, test GetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_1400, Function | MediumTest | Level3)
{
    int TRANSFER_TYPE_ALWAYS = 3;
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = REGISTRATION;
    setCallTransfer.type = CallTransferType(TRANSFER_TYPE_ALWAYS);
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID_1, setCallTransfer), SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID_1, setCallTransfer.type), SUCCESSFUL);
    TestTransferCallBack(OPEN, TRANSFER_TYPE_ALWAYS);
}
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType REGISTRATION, test SetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 *              test SetCallTransferInfo(), return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType REGISTRATION, test SetCallTransferInfo(),
 *              settingType ERASURE, test SetCallTransferInfo() again,Whether the transferNumber is incorrect return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType ERASURE, test SetCallTransferInfo(),settingType
 *              REGISTRATION, test SetCallTransferInfo() again,Whether the transferNumber is incorrect return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType CALL_TRANSFER_REGISTER,
 *              test SetCallTransferInfo(), return non 0
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallTransferInfo_2800, Function | MediumTest | Level3)
{
    int CALL_TRANSFER_REGISTER = 2;
    int TRANSFER_TYPE_ALWAYS = 3;
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = CallTransferSettingType(CALL_TRANSFER_REGISTER);
    setCallTransfer.type = CallTransferType(TRANSFER_TYPE_ALWAYS);
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_NE(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
 ...
 * @tc.name     idle status, device INVALID_NEGATIVE_MODE, test SetAudioDevice(),return non 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     idle status, device INVALID_AUDIO_TYPE of 4, test SetAudioDevice(),return non 0
 * @tc.desc     Function test
 */
