 ...
 * @tc.name     enable type MOBILE_BUSY, settingType ERASURE, test GetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type UNCONDITIONAL, test GetCallTransferInfo(), return 0
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type UNCONDITIONAL, test GetCallTransferInfo(), return non-zero
 ...
 * @tc.name     enable type MOBILE_BUSY, settingType REGISTRATION, test SetCallTransferInfo(), return non-zero
 * @tc.desc     Function test
 */
 ...
 * @tc.name     enable type NO_REPLY, settingType ERASURE, test SetCallTransferInfo(), return non-zero
 ...
 * @tc.name     enable type UNCONDITIONAL, settingType REGISTRATION, test SetCallTransferInfo(),
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallTransferInfo_2600, Function | MediumTest | Level3)
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = static_cast<CallTransferSettingType>(CALL_TRANSFER_ENABLE);
    setCallTransfer.type = CallTransferType(UNCONDITIONAL);
    int ret = strcpy_s(setCallTransfer.transferNum, BUFSIZ, VALID_TRANSFER_NUMBER.c_str());
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    LOCK_NUM_WHILE_NE(g_updateReportId, SET_CALL_TRANSFER_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
 ...
 * @tc.name     enable type UNCONDITIONAL, settingType ERASURE, test SetCallTransferInfo(),settingType
