 ...
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_IsNewCallAllowed_0100, Function | MediumTest | Level3)
{
...
HWTEST_F(CallManagerDialTest, Telephony_CallManager_IsNewCallAllowed_0300, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(CallManagerFunctionTest::HasState(g_newCallId, TelCallState::CALL_STATUS_DIALING), true,
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_RegisterCallBack_0100, Function | MediumTest | Level3)
{
    ...
    if (HasActiveStatus()) {
        ...
        CallManagerDialTest::TestRegisterCallBack(phoneNumber);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_RegisterCallBack_0200, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_WAITING_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_RegisterCallBack_0300, Function | MediumTest | Level3)
{
    ...
    if (HasActiveStatus()) {
        ...
        EXPECT_EQ(ret, SUCCESSFUL);
        LockNumWHhileNe(g_updateReportId, CallResultReportId::START_DTMF_REPORT_ID, SLEEP_50_MS, SLEEP_12000_MS);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallRestriction_1400, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallRestriction(SLOT_ID, setCallRestriction.fac), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_RESTRICTION_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_0100, Function | MediumTest | Level3)
{
    ...
    setCallRestriction.mode = CallRestrictionMode::RESTRICTION_MODE_ACTIVATION;
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID, setCallRestriction), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_RESTRICTION_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    setCallRestriction.mode = CallRestrictionMode::RESTRICTION_MODE_DEACTIVATION;
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID, setCallRestriction), SUCCESSFUL);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallRestriction_1300, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID, setCallRestriction), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_RESTRICTION_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), ERROR_VALUES, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_GetCallTransferInfo_1100, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, setCallTransfer.type), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::GET_CALL_TRANSFER_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("status"), OFF, SLEEP_50_MS, SLEEP_1000_MS);
}
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetCallTransferInfo_0200, Function | MediumTest | Level3)
{
    ...
    ASSERT_EQ(ret, SUCCESSFUL);
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
    LockNumWHhileNe(g_updateReportId, CallResultReportId::SET_CALL_TRANSFER_REPORT_ID, SLEEP_50_MS, SLEEP_1000_MS);
    LockNumWHhileNe(g_updateResult.GetIntValue("result"), SUCCESSFUL, SLEEP_50_MS, SLEEP_1000_MS);
    setCallTransfer.settingType = CallTransferSettingType::CALL_TRANSFER_DISABLE;
    EXPECT_EQ(g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, setCallTransfer), SUCCESSFUL);
}
 ...
 * @tc.name     enable type TRANSFER_TYPE_ALWAYS, settingType INVALID_TRANSFER_TYPE of 5,
 *              test SetCallTransferInfo(), return non-zero
 * @tc.desc     Function test
 */
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0100, Function | MediumTest | Level3)
{
    ...
    if (HasActiveStatus()) {
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_EARPIECE, address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0200, Function | MediumTest | Level3)
{
    ...
    std::string address = "0C:D7:46:14:AA:33";
    if (HasActiveStatus()) {
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_SPEAKER, address), SUCCESSFUL);
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_SPEAKER, address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0300, Function | MediumTest | Level3)
{
    ...
    std::string address = "0C:D7:46:14:AA:33";
    if (HasActiveStatus()) {
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_WIRED_HEADSET, address), SUCCESSFUL);
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_SPEAKER, address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0400, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    std::string address = "0C:D7:46:14:AA:33";
    if (HasActiveStatus()) {
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_BLUETOOTH_SCO, address), SUCCESSFUL);
        EXPECT_EQ(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_SPEAKER, address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
...
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0500, Function | MediumTest | Level3)
{
    LockNumWHhileNe(
        g_clientPtr->GetPtr()->GetCallState(), (int)CallStateToApp::CALL_STATE_IDLE, SLEEP_50_MS, SLEEP_1000_MS);
    std::string address = "0C:D7:46:14:AA:33";
    EXPECT_NE(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice::DEVICE_EARPIECE, address), SUCCESSFUL);
}
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0800, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    std::string address = "0C:D7:46:14:AA:33";
    if (HasActiveStatus()) {
        EXPECT_NE(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice(INVALID_NEGATIVE_MODE), address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CallManagerFunctionTest, Telephony_CallManager_SetAudioDevice_0900, Function | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(OPERATOR_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
    ...
    std::string address = "0C:D7:46:14:AA:33";
    if (HasActiveStatus()) {
        EXPECT_NE(g_clientPtr->GetPtr()->SetAudioDevice(AudioDevice(INVALID_AUDIO_TYPE), address), SUCCESSFUL);
    }
    if (g_clientPtr->GetPtr()->GetCallState() == static_cast<int>(CallStateToApp::CALL_STATE_OFFHOOK)) {
        int hangUpRet = g_clientPtr->GetPtr()->HangUpCall(g_newCallId);
        EXPECT_EQ(hangUpRet, SUCCESSFUL);
