...
HWTEST_F(CellularDataTest, Telephony_CellularData_IsCellularDataEnabled_0100, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(g_telephonyService->IsCellularDataEnabled(), (int)DataSwitchCode::CELLULAR_DATA_ENABLED);
}
...
HWTEST_F(CellularDataTest, Telephony_CellularData_IsCellularDataEnabled_0200, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_DISCONNECTED,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    EXPECT_EQ(g_telephonyService->IsCellularDataEnabled(), (int)DataSwitchCode::CELLULAR_DATA_DISABLED);
}
