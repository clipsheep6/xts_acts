...
HWTEST_F(CelluarDataStateTest, Telephony_CellularData_ActivationDeactivation_0300, Function | MediumTest | Level3)
{
    ...
    LOCK_NUM_WHILE_NE(static_cast<RadioTech>(GetProxy_()->GetNetworkState(SLOT_ID)->GetPsRadioTech()) ==
        RadioTech::RADIO_TECHNOLOGY_WCDMA || static_cast<RadioTech>(GetProxy_()->GetNetworkState(SLOT_ID)
        ->GetCsRadioTech()) == RadioTech::RADIO_TECHNOLOGY_WCDMA, true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
