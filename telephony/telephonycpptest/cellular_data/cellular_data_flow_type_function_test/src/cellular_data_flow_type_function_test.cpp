 ...
 */
HWTEST_F(CellularDataFunctionTest, Telephony_CellularData_GetCellularDataFlowType_0100, Function | MediumTest | Level3)
{
 ...
 * @tc.desc     Function test
 */
HWTEST_F(CellularDataFunctionTest, Telephony_CellularData_GetCellularDataFlowType_0300, Function | MediumTest | Level3)
{
