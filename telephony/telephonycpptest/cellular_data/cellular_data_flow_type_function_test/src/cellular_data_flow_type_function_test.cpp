    ...
    Function | MediumTest | Level3)
{
    ...
    ASSERT_TRUE(
        result == (int)CellDataFlowType::DATA_FLOW_TYPE_NONE || result == (int)CellDataFlowType::DATA_FLOW_TYPE_DOWN ||
        result == (int)CellDataFlowType::DATA_FLOW_TYPE_UP || result == (int)CellDataFlowType::DATA_FLOW_TYPE_UP_DOWN);
}
