...
namespace Telephony {
/**
 * @tc.number   Telephony_CellularData_DetectionAndRecovery_0100
    ...
    CellularDataFlowTypeFunctionTest, Telephony_CellularData_DetectionAndRecovery_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_CONNECTING,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_DISCONNECTED,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
...
/**
 * @tc.number   Telephony_CellularData_DetectionAndRecovery_0200
 * @tc.name     When cellular data is turned on, call GetCellularDataFlowType() to obtain the data flow type,
 *              and verify that the return value is within the enumeration value range
 * @tc.desc     Function test
 */
...
/**
 * @tc.number   Telephony_CellularData_DetectionAndRecovery_0300
 * @tc.name     When cellular data is turned on, call GetCellularDataFlowType() to obtain the data flow type,
 *              and verify that the return value is within the enumeration value range
 * @tc.desc     Function test
 */
    ...
    CellularDataFlowTypeFunctionTest, Telephony_CellularData_DetectionAndRecovery_0300, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_CONNECTED,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    g_mockVender.MockLostDataConnect();
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_DISCONNECTED,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(g_telephonyService->GetCellularDataState(), (int)DataConnectionStatus::DATA_STATE_CONNECTED,
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
