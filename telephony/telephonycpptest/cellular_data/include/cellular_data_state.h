...
int32_t CallManager::CallAbilityCallbackBasic::OnReportMmiCodeResult(const MmiCodeInfo &info)
{
...
{
    LockNumWHhileNe(g_telephonyService->EnableCellularData(true), true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
