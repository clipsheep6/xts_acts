...
NetworkStatus *ParseNetworkStats(napi_env env, napi_callback_info info) {
    ...
    networkStats->regStatus = GetIntProperty(env, argv[0], (char *)"regState");
    networkStats->nsaState = GetIntProperty(env, argv[0], (char *)"nsaState");
...
SignalInfo *ParseSignal(napi_env env, napi_callback_info info) {
    ...
    signalInfo->signalType = GetIntProperty(env, argv[0],  (char*)"signalType");
    signalInfo->signalLevel = GetIntProperty(env, argv[0],  (char*)"signalLevel");
