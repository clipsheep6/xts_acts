...
static napi_value MockVendorSet(napi_env env, napi_callback_info info)
{
    ...
    mMockVendor.MockVendorSet((DISPATCHID)funcId, buffer, bufsize);
...
static napi_value MockVendorSetWithDelay(napi_env env, napi_callback_info info)
{
    ...
    mMockVendor.MockVendorSetWithDelay((DISPATCHID)funcId, buffer, bufsize);
...
static napi_value ChangeNetworkStats(napi_env env, napi_callback_info info)
{
    ...
    int mvSetRet = mMockVendor.MockVendorSet(DISPATCHID::NETWORK_SEARCH_CHANGE_STATE,
...
static napi_value ChangeSignal(napi_env env, napi_callback_info info)
{
    ...
    int mvSetRet = mMockVendor.MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_SIGNAL,
        (const char *)signalInfo, sizeof(SignalInfo));
