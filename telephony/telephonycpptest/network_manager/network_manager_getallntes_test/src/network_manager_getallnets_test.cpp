 ...
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetAllNets_0100, Function | MediumTest | Level3)
{
 ...
 * @tc.name    Test GetAllNets () to get all network successfully return value 0, and check that the parameter has netid generated
 * @tc.desc   Function test
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetAllNets_0200, Function | MediumTest | Level3)
{
 ...
 * @tc.name    Verification uint32 netId indicates the presence ID. Test GetConnectionProperties () to check the returned value
 * @tc.desc   Function test
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetConnectionProperties_0100, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps {NET_CAPABILITY_INTERNET};
    std::string ident = "ident";
    uint32_t ressupplierId1;
 ...
 * @tc.name    Verification uint32 netId indicates a non-existent ID. Test GetConnectionProperties () to check the returned value
 * @tc.desc   Function test
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetConnectionProperties_0200, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps {NET_CAPABILITY_INTERNET};
    std::string ident = "ident";
    uint32_t ressupplierId1;
 ...
 * @tc.name    Verification uint32 netId indicates the presence ID. Test GetNetCapabilities() to view the returned value
 * @tc.desc   Function test
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetNetCapabilities_0100, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps {NET_CAPABILITY_INTERNET};
    std::string ident = "ident";
    uint32_t ressupplierId1;
 ...
 * @tc.name    Verification uint32 netId indicates a nonexistent ID. Test GetNetCapabilities() to check the returned value
 * @tc.desc   Function test
 */
HWTEST_F(AllNetsTest, Telephony_NetworkManager_GetNetCapabilities_0200, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps {NET_CAPABILITY_INTERNET};
    std::string ident = "ident";
    uint32_t ressupplierId1;
