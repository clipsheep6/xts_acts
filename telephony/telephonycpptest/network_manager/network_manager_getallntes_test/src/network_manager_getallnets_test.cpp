...
HWTEST_F(NetworkManagerGetAllNetsTest, Telephony_NetworkManager_GetAllNets_0200, Function | MediumTest | Level3)
{
    ...
    DelayedSingleton<NetConnClient>::GetInstance()->RegisterNetSupplier(
        BEARER_CELLULAR, ident, netCaps, ressupplierId1);
 ...
 */
HWTEST_F(
    NetworkManagerGetAllNetsTest, Telephony_NetworkManager_GetConnectionProperties_0100, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps { NET_CAPABILITY_INTERNET };
    std::string ident = "ident";
    uint32_t ressupplierId1;
 ...
 */
HWTEST_F(
    NetworkManagerGetAllNetsTest, Telephony_NetworkManager_GetConnectionProperties_0200, Function | MediumTest | Level3)
{
    std::set<NetCap> netCaps { NET_CAPABILITY_INTERNET };
    std::string ident = "ident";
    uint32_t ressupplierId1;
