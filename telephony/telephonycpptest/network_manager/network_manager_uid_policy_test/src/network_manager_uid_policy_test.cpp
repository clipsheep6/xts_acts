...
#include <vector>
#include <algorithm>
// #include "network_manager_constants.h"
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_1, NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);

    NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_1);
...
{
    NetPolicyResultCode result = DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_2, NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);

    EXPECT_EQ(result, NetPolicyResultCode::ERR_NONE);

    NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_2);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_SetUidPolicy_0300, Function | MediumTest | Level3)
{
    ...
    NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_3);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_SetUidPolicy_0400, Function | MediumTest | Level3)
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_9);
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_3);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_5);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_31);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_33);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_63);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}
...
{
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, (NetUidPolicy)EXCEPT_POLICY_NUM_65);
    EXPECT_EQ(result, NetPolicyResultCode::ERR_INVALID_POLICY);
}

/*
 * @tc.number  Telephony_NetworkManager_SetUidPolicy_1200
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_SetUidPolicy_1200, Function | MediumTest | Level3)
{
    int count;
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_5, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_5);
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_6, NetUidPolicy::NET_POLICY_REJECT_ALL);
    NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_6);
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_1, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_1, NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_2, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_2, (NetUidPolicy)EXCEPT_POLICY_NUM_12);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUidPolicy_0500, Function | MediumTest | Level3)
{
    ...
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_3, NetUidPolicy::NET_POLICY_NONE);
...
/*
 * @tc.number  Telephony_NetworkManager_GetUidPolicy_0700
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUidPolicy_0700, Function | MediumTest | Level3)
{
    int count;
    for (count = 0; count < TEST_COUNTS_1000; ++count) {
        DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        ...
        NetUidPolicy policyResult = DelayedSingleton<NetPolicyManager>::GetInstance()->GetUidPolicy(UID_NUM_5);
        EXPECT_EQ(policyResult, NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);
    }
}
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_1, NetUidPolicy::NET_POLICY_NONE);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_2, NetUidPolicy::NET_POLICY_NONE);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_3, NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);

    std::vector<uint32_t> vect =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_NONE);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUids_0200, Function | MediumTest | Level3)
{
    ...
    std::vector<uint32_t> uids =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUids_0300, Function | MediumTest | Level3)
{
    ...
    std::vector<uint32_t> policyResult =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUids_0400, Function | MediumTest | Level3)
{
    ...
    std::vector<uint32_t> uids =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_REJECT_METERED_BACKGROUND);
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_7, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_8, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_9, NetUidPolicy::NET_POLICY_REJECT_ALL);
    std::vector<uint32_t> result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_ALLOW_ALL);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUids_0600, Function | MediumTest | Level3)
{
    ...
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_9, NetUidPolicy::NET_POLICY_REJECT_ALL);
    std::vector<uint32_t> result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids(NetUidPolicy::NET_POLICY_REJECT_ALL);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUids_0700, Function | MediumTest | Level3)
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_1, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_2, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_3, NetUidPolicy::NET_POLICY_REJECT_ALL);
    std::vector<uint32_t> result =
        DelayedSingleton<NetPolicyManager>::GetInstance()->GetUids((NetUidPolicy)EXCEPT_POLICY_NUM_9);
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_IsUidNetAccess_0100, Function | MediumTest | Level3)
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_1, NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);
    bool ret = DelayedSingleton<NetPolicyManager>::GetInstance()->IsUidNetAccess(UID_NUM_1, true);
    ASSERT_TRUE(ret);
}
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_IsUidNetAccess_0200, Function | MediumTest | Level3)
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_2, NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);
    bool ret = DelayedSingleton<NetPolicyManager>::GetInstance()->IsUidNetAccess(UID_NUM_2, true);
    ASSERT_TRUE(ret);
}
...
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_IsUidNetAccess_0300, Function | MediumTest | Level3)
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(
        UID_NUM_3, NetUidPolicy::NET_POLICY_REJECT_METERED_BACKGROUND);
    bool ret = DelayedSingleton<NetPolicyManager>::GetInstance()->IsUidNetAccess(UID_NUM_3, true);
    EXPECT_FALSE(ret);
}
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_4, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    bool ret = DelayedSingleton<NetPolicyManager>::GetInstance()->IsUidNetAccess(UID_NUM_4, true);
    ASSERT_TRUE(ret);
}
...
{
    DelayedSingleton<NetPolicyManager>::GetInstance()->SetUidPolicy(UID_NUM_5, NetUidPolicy::NET_POLICY_REJECT_ALL);
    bool ret = DelayedSingleton<NetPolicyManager>::GetInstance()->IsUidNetAccess(UID_NUM_5, true);
    EXPECT_FALSE(ret);
}
