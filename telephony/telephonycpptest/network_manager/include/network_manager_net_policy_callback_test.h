...
#ifndef NETWORK_MANAGER_NET_POLICY_CALLBACK_H
#define NETWORK_MANAGER_NET_POLICY_CALLBACK_H
...
enum INET { UNKNOWN = 0X00, IPV4 = 0X01, IPV6 = 0X02 };
...
#endif // NETWORK_MANAGER_NET_POLICY_CALLBACK_H