...
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_GetAddressesByName_0100, Function | MediumTest | Level3)
{
    ...
    int32_t resutl = DelayedSingleton<DnsResolverManager>::GetInstance()->GetAddressesByName(server, addrInfo);
...
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_GetAddressesByName_0200, Function | MediumTest | Level3)
{
    ...
    std::vector<struct INetAddr> addrInfo;
    int32_t resutl = DelayedSingleton<DnsResolverManager>::GetInstance()->GetAddressesByName(server, addrInfo);
    ASSERT_NE(resutl, NETMANAGER_SUCCESS);
}
...
//=================================test IsActivate end===================================
/*
 * @tc.number  Telephony_NetworkManager_IsActivate_0100
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_IsActivate_0100, Function | MediumTest | Level3)
{
    std::string iface = "eth0";
...
/*
 * @tc.number  Telephony_NetworkManager_IsActivate_0200
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_IsActivate_0200, Function | MediumTest | Level3)
{
    std::string iface = "test";
    int32_t result =  DelayedSingleton<EthernetManager>::GetInstance()->IsActivate(iface);
    ASSERT_EQ(result, NETMANAGER_ERROR);
...
/*
 * @tc.number  Telephony_NetworkManager_GetActivateInterfaces_0100
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_GetActivateInterfaces_0100, Function | MediumTest | Level3)
{
    std::vector<std::string> ifaces = DelayedSingleton<EthernetManager>::GetInstance()->GetActivateInterfaces();
    std::string iface = "eth0";
