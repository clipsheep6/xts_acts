 ...
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0100,
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0200,
    Function | MediumTest | Level3)
{
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0300,
    Function | MediumTest | Level3)
{
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0400,
    Function | MediumTest | Level3)
{
    std::string host = " ";
    std::vector<INetAddr> addrList;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0500,
    Function | MediumTest | Level3)
{
    std::string host = "666";
    std::vector<INetAddr> addrList;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0600,
    Function | MediumTest | Level3)
{
    std::string host = "AAA";
    std::vector<INetAddr> addrList;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0100, Function | MediumTest | Level3)
{
    std::string host = "www.baidu.com";
    INetAddr addr;
    uint32_t netId = NETID_100;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0200, Function | MediumTest | Level3)
{
    std::string host = "www.taobao.com";
    INetAddr addr;
    uint32_t netId = NETID_100;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0300, Function | MediumTest | Level3)
{
    std::string host = "www.csdn.net";
    INetAddr addr;
    uint32_t netId = NETID_100;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0400, Function | MediumTest | Level3)
{
    std::string host = "";
    INetAddr addr;
    uint32_t netId = NETID_100;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0500, Function | MediumTest | Level3)
{
    std::string host = "666";
    INetAddr addr;
    uint32_t netId = NETID_100;
 ...
 */
HWTEST_F(
    NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0600, Function | MediumTest | Level3)
{
    std::string host = "AAA";
    std::vector<INetAddr> addrList;
    uint32_t netId = NETID_100;
...
/*
 * @tc.number  Telephony_NetworkManager_BindSocket_0600
 * @tc.name    Set socket_fd is -1 test BindSocket to see the return value. returned with 0
 * @tc.desc   Function test
 */

HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_BindSocket_0600, Function | MediumTest | Level3)
{
    int32_t socket_fd = -FD_ID_1;
    uint32_t netId = NETID_100;
    auto handle = DelayedSingleton<NetHandle>::GetInstance();
