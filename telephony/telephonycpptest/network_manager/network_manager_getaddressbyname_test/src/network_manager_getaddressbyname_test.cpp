 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0100,
    Function | MediumTest | Level3)
{
    std::string host = "www.baidu.com";
    INetAddr addr;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0200,
    Function | MediumTest | Level3)
{
    std::string host = "www.taobao.com";
    INetAddr addr;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0300,
    Function | MediumTest | Level3)
{
    std::string host = "www.csdn.net";
    INetAddr addr;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0400,
    Function | MediumTest | Level3)
{
    std::string host = "";
    INetAddr addr;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0500,
    Function | MediumTest | Level3)
{
    std::string host = "666";
    INetAddr addr;
 ...
 * @tc.desc   Function test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0600,
    Function | MediumTest | Level3)
{
    std::string host = "AAA";
    INetAddr addr;
