...
{
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(uid, NetUidPolicy::NET_POLICY_REJECT_ALL);
...
{
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(uid, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_TRUE(isAllow);
}
...
{
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(uid, NetUidPolicy::NET_POLICY_REJECT_METERED);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_FALSE(isAllow);
}
...
{
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(uid, NetUidPolicy::NET_POLICY_ALLOW_METERED);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_TRUE(isAllow);
}
...
HWTEST_F(TrafficPolicyTest, Telephony_NetworkManager_GetBackgroundPolicyByUid_0500, Function | MediumTest | Level3)
{
    ...
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(
        uid, NetUidPolicy::NET_POLICY_TEMPORARY_ALLOW_METERED);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_TRUE(isAllow);
}
...
HWTEST_F(TrafficPolicyTest, Telephony_NetworkManager_GetBackgroundPolicyByUid_0600, Function | MediumTest | Level3)
{
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(
        uid, NetUidPolicy::NET_POLICY_REJECT_METERED_BACKGROUND);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_FALSE(isAllow);
}
...
HWTEST_F(TrafficPolicyTest, Telephony_NetworkManager_GetBackgroundPolicyByUid_0900, Function | MediumTest | Level3)
{
    ...
    uint32_t uid = 1234;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(
        uid, NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);
    bool isAllow = DelayedSingleton<NetPolicyClient>::GetInstance()->GetBackgroundPolicyByUid(uid);
    EXPECT_TRUE(isAllow);
}
...
HWTEST_F(TrafficPolicyTest, Telephony_NetworkManager_GetCurrentBackgroundPolicy_0400, Function | MediumTest | Level3)
{
    ...
    NetBackgroundPolicy ret = DelayedSingleton<NetPolicyClient>::GetInstance()->GetCurrentBackgroundPolicy();
    EXPECT_EQ(
        static_cast<uint32_t>(ret), static_cast<uint32_t>(NetBackgroundPolicy::NET_BACKGROUND_POLICY_ALLOWLISTED));
}
