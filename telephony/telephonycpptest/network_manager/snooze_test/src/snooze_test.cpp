...
HWTEST_F(SnoozeTest, Telephony_NetworkManager_SetSnoozePolicy_0100, Function | MediumTest | Level3)
{
    ...
    std::string simId_ = "0";
    result = DelayedSingleton<NetPolicyClient>::GetInstance()->SetSnoozePolicy(netType_, simId_);
    ASSERT_EQ(result, NetPolicyResultCode::ERR_NONE);
...
HWTEST_F(SnoozeTest, Telephony_NetworkManager_SetSnoozePolicy_0300, Function | MediumTest | Level3)
{
    ...
    NetPolicyResultCode result = DelayedSingleton<NetPolicyClient>::GetInstance()->SetSnoozePolicy(netType_, simId_);
...
HWTEST_F(SnoozeTest, Telephony_NetworkManager_SetFactoryPolicy_0100, Function | MediumTest | Level3)
{
    ...
    NetPolicyResultCode result =
        DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(uid1, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    std::string simId = "";

    result = DelayedSingleton<NetPolicyClient>::GetInstance()->SetFactoryPolicy(simId);
