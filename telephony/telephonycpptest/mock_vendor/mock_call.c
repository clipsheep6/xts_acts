...
void ReqGetCallList(const ReqDataInfo *requestInfo)
{
    ...
    pthread_mutex_lock(&freeMemMutex);
    ViewCallInfo();
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t*)g_callMockData.pp_calls,
...
void ReqDial(const ReqDataInfo *requestInfo, const HRilDial *data, size_t dataLen)
{
    ...
    RespSuccessWithoutData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport);
    TELEPHONY_LOGD("call_index:%{public}d", g_callMockData.call_index);
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&g_callMockData.clip_result,
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&g_callMockData.clir_result,
...
void ReqGetCallRestriction(const ReqDataInfo* requestInfo, const char* fac)
{
    ...
    result.classCw = 1;
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&result,
        sizeof(HRilCallRestrictionResult));
}
void ReqSetCallRestriction(const ReqDataInfo* requestInfo, CallRestrictionInfo info)
{
    ...
    if (ret != 0) {
        RespErrnoWithoutData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, HRIL_ERR_GENERIC_FAILURE);
        return;
    }
    RespSuccessWithoutData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport);
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&g_callMockData.hrilCallWaitResult,
...
void ReqGetCallTransferInfo(const ReqDataInfo* requestInfo, int reason)
{
    ...
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&g_callMockData.cf_info[reason],
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t*)&g_callMockData.preferredMode,
        sizeof(int));
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t*)&g_callMockData.lteImsSwitchStatus,
        sizeof(int));
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnCallReport, (const uint8_t *)&g_callMockData.UssdCusd,
        sizeof(int));
}