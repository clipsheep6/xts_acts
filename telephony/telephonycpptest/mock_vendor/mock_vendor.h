...
public:
    ...
    bool IsFull() const;
    void SetFull() const;
    int MockVendorSet(int id, const void *data, int dataLen) const;
    int MockVendorSetWithDelay(int id, const void *data, int dataLen) const;
    void MockVendorSetReg(int domain, int reg);
    void MockVendorSetTech(int domain, int tech);
    void MockVendorSetRawReg(int domain, int tech);
