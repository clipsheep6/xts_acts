...
hdc file send ${OpenHarmony_Standard_System}/out/ohos-arm-release/telephonycpptest/mock_vendor/libmock_ril_vendor.z.so /data/mock_vendor/libril_vendor.z.so
...
hdc shell chmod 777 /data/mock_vendor/libril_vendor.z.so
