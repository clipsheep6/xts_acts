...
void NotifySignalChange(void)
{
    ...
    TELEPHONY_LOGD("enter to [%{public}s]: %{public}d signal strength: GSM:  %{public}d  WCDMA: %{public}d"
        "LTE: %{public}d", __func__, __LINE__, g_networkMockData.hrilRssi.gsmRssi.rxlev,
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    g_networkMockData.meid = "863163042380669";
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport,
        (const uint8_t*)&g_networkMockData.csRegStatusInfo, sizeof(HRilRegStatusInfo));
}
...
void ReqGetNetworkSearchInformation(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    ShowCanUseOperInfo();
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo,
...
void ReqSetNetworkSelectionMode(const ReqDataInfo *requestInfo,  const HRilSetNetworkModeInfo *data)
{
    ...
    if (setModeInfo == NULL) {
        RespErrnoFixDataLenEqualOne(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, HRIL_ERR_INVALID_PARAMETER);
        return;
    }
    if (setModeInfo->selectMode != 0) {
        ...
        for (unsigned int i = 0; i < strlen(setModeInfo->oper); i++) {
            if (setModeInfo->oper[i] < '0' || setModeInfo->oper[i] > '9') {
                ...
                RespErrnoFixDataLenEqualOne(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport,
    ...
    RespSuccessWithDataExtend(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, 1);
}

void ReqGetNetworkSelectionMode(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.selectMode,
        sizeof(int));
}

void ReqGetSignalStrength(const ReqDataInfo *requestInfo)
{
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.hrilRssi,
        sizeof(HRilRssi));
}
...
void ReqSetPreferredNetwork(const ReqDataInfo *requestInfo,  const int32_t *data)
{
    ...
    if ((*data) < HRIL_NETWORK_AUTO || (*data) > HRIL_NETWORK_WCDMA_GSM) {
        RespErrnoWithoutData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, HRIL_ERR_INVALID_PARAMETER);
        return;
    }
    ...
    RespSuccessWithoutData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport);
}
...
void ReqGetPreferredNetwork(const ReqDataInfo *requestInfo)
{
    ...
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.netType,
        sizeof(int));
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t*)g_networkMockData.imei,
        strlen(g_networkMockData.imei));
}

void ReqGetMeid(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t*)g_networkMockData.meid,
        strlen(g_networkMockData.meid));
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t*)&g_networkMockData.cellInfoList,
        sizeof(CellInfoList));
}
...
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t*)&cciv,
