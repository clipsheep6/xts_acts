...
void SetSignal(const char *data, int dataLen)
{
    ...
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d mem src data = %{public}d  %{public}d ", __func__, __LINE__,
...
void ReqGetNetworkSearchInformation(const ReqDataInfo *requestInfo)
{
    ...
    ShowCanUseOperInfo();
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)g_networkMockData.pp_OperInfo, g_operCount);
}
...
void ReqGetNetworkSelectionMode(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.selectMode, sizeof(int));
}

void ReqGetSignalStrength(const ReqDataInfo *requestInfo)
{
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.hrilRssi, sizeof(HRilRssi));
}
...
void ReqGetPreferredNetwork(const ReqDataInfo *requestInfo)
{
    ...
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.netType, sizeof(int));
}
...
void ReqGetPsAttachStatus(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&g_networkMockData.psAttachStatus, sizeof(int));
}
...
void ReqGetCurrentCellInfo(const ReqDataInfo *requestInfo)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RespSuccessWithData(
        HRIL_SIM_SLOT_1, requestInfo, OnNetworkReport, (const uint8_t *)&cciv, sizeof(CurrentCellInfoVendor));
}
