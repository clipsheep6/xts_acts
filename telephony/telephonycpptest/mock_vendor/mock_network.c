...
void FillOperatorInformation(void)
{
    FillSubitemOperatorInformation(
        g_networkMockData.longOperator, g_networkMockData.shortOperator, g_networkMockData.plmn, CAN_USE, LTE);

    FillSubitemOperatorInformation("CHINA MOBILE", "CMCC", "46000", CAN_USE, GSM_OR_GPRS);
    FillSubitemOperatorInformation("CHINA MOBILE", "CMCC", "46000", CAN_USE, WCDMA);
    FillSubitemOperatorInformation("CHINA MOBILE", "CMCC", "46000", REGISTERED, LTE);
    FillSubitemOperatorInformation("CHINA Unicom", "CUCC", "46001", FORBIDERN, GSM_OR_GPRS);
    FillSubitemOperatorInformation("CHINA Unicom", "CUCC", "46001", FORBIDERN, WCDMA);
    FillSubitemOperatorInformation("CHINA Unicom", "CUCC", "46001", FORBIDERN, LTE);
    FillSubitemOperatorInformation("CHINA TELECOM", "CTCC", "46003", FORBIDERN, GSM_OR_GPRS);
    FillSubitemOperatorInformation("CHINA TELECOM", "CTCC", "46003", FORBIDERN, WCDMA);
    FillSubitemOperatorInformation("CHINA TELECOM", "CTCC", "46003", FORBIDERN, LTE);
}

void FillSubitemOperatorInformation(char *longName, char *shortName, char *numeric, int status, int rat)
{
    static int item = -1;
    item++;
