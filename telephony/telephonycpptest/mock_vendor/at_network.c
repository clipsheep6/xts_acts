...
void ReqGetCsRegStatus(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
...
void ReqGetPsRegStatus(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
...
void ReqGetOperatorInfo(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
...
void RequestGetNetworksToUse(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    ShowCanUseOperInfo();
...
void RequestQueryNetworkSelectionMode(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RESP_SUCSS_WITH_DATA(OnNetworkReport, &g_networkMockData.selectMode, sizeof(int));
}

void ReqGetSignalStrength(void *requestInfo, void *data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
