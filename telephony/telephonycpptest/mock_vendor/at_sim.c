...
void ReqGetSimIO(void* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
...
void ReqGetSimLockStatus(void* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
...
void ReqSetSimLock(void* requestInfo, void* data, size_t dataLen __unused)
{
    int ret = -1;
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    HRilSimClock* pSimClck = (HRilSimClock*)data;
...
void ReqChangeSimPassword(void* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
