...
void ReqGetCallList(ReqDataInfo* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    RESP_SUCSS_WITH_DATA(OnCallReport, g_callMockData.pp_calls, sizeof(HRilCallInfo*) * g_callMockData.call_index);
}

void ReqDial(ReqDataInfo* requestInfo, void* data, size_t dataLen __unused)
{
...
void ReqHangup(ReqDataInfo* requestInfo, void* data, size_t dataLen __unused)
{
    int* array = (int*)data;
...
void ReqReject(ReqDataInfo* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    g_callMockData.call_index = 0;
    g_callMockData.call_id = 0;
...
void ReqAnswer(ReqDataInfo* requestInfo, void* data, size_t dataLen __unused)
{
    TELEPHONY_LOGD("enter to [%{public}s]:%{public}d", __func__, __LINE__);
    AnswerCall();
    RESP_SUCSS_WITHOUT_DATA(OnCallReport);
