...
void MockVendor::MockVendorSetReg(int domain, int reg)
{
    ...
    MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_REG_STATUS, nbuff_, sizeof(int) * numLen);
}
...
void MockVendor::MockVendorSetPlmnState(int state)
{
    ...
    MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_PLMN_STATE, nbuff_, sizeof(int));
}
...
void MockVendor::MockVendorSetRat(int rat)
{
    ...
    MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_RAT, nbuff_, sizeof(int));
}
...
void MockVendor::MockVendorSetRawReg(int domain, int reg)
{
    ...
    MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_RAW_REG_STATUS, nbuff_, sizeof(int) * numLen);
}
...
void MockVendor::MockVendorSetTech(int domain, int tech)
{
    ...
    MockVendorSet(DISPATCHID::NETWORK_SEARCH_SET_RADIO_TECH, nbuff_, sizeof(int) * numLen);
}
...
void MockVendor::MockVendorSetCardType(int cardType)
{
    ...
    MockVendorSet(DISPATCHID::SIM_SET_CARD_TYPE, nbuff_, sizeof(int));
}
...
void MockVendor::MockDataActiveError(int errType)
{
    ...
    MockVendorSet(DISPATCHID::DATA_SET_ERR_TYPE, nbuff_, sizeof(int));
}

void MockVendor::MockLostDataConnect(void)
{
    MockVendorSet(DISPATCHID::DATA_REPORT_LOST_ACTIVE_EVENT, nullptr, 0);
}
