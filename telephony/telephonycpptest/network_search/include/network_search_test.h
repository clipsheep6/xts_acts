...
public:
    ...
    static void VendorTestCDMA(PreferredNetwork cdmaType);
...
public:
    ...
    static const int TEST_RUN_TIME_1000 = 10;
    ...
    static const int WAIT_RECOVER = 10;
...
void NetworkSearchTest::VendorTestCDMA(PreferredNetwork cdmaType)
{
