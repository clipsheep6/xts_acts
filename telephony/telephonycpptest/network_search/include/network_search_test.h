...
#endif
static enum {
    NETWORK_TEST_CDMA = 200, /* MOCK  MEIG : RADIO_TECHNOLOGY_1XRTT,    CDMA */
    NETWORK_TEST_CDMA_IS95A, /* MOCK  MEIG : RADIO_TECHNOLOGY_IS95A,    CDMA */
    NETWORK_TEST_CDMA_IS95B, /* MOCK  MEIG : RADIO_TECHNOLOGY_IS95B,    CDMA */
    NETWORK_TEST_CDMA_EVDO_0, /* MOCK  MEIG : RADIO_TECHNOLOGY_EVDO_0,    CDMA */
    NETWORK_TEST_CDMA_EVDO_A, /* MOCK  MEIG : RADIO_TECHNOLOGY_EVDO_A,    CDMA */
    NETWORK_TEST_CDMA_EVDO_B, /* MOCK  MEIG : RADIO_TECHNOLOGY_EVDO_B,    CDMA */
    NETWORK_TEST_CDMA_EHRPD, /* MOCK  MEIG : RADIO_TECHNOLOGY_EHRPD,    CDMA */
    NETWORK_TEST_TDSCDMA, /* MOCK  MEIG : RADIO_TECHNOLOGY_TDSCDMA,    TDSCDMA */
} CdmaType;
...
public:
    ...
    static void VendorTestCDMA(int32_t cdmaType);
...
public:
    ...
    const int CELL_INFO_EARFCN_MAX = 41239;
...
{
    bool ret = GetProxy()->SetRadioState(true, g_callback);
    if (ret == false) {
...
void NetworkSearchTest::RecoverPreferredNetwork()
{
    bool ret = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_AUTO), g_callback);
    if (ret == false) {
...
void NetworkSearchTest::VendorTestCDMA(int32_t cdmaType)
{
    bool ret = GetProxy()->SetPreferredNetwork(SLOT_0, cdmaType, g_callback);
    if (ret == false) {
