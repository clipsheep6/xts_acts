 ...
 * @tc.name    Set the preferred network mode CORE_NETWORK_CDMA to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1200, Function | MediumTest | Level3)
{
    bool setPreferredMode =
        GetProxy()->SetPreferredNetwork(SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_CDMA), g_callback);
    ...
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1300
 * @tc.name    Set the preferred network mode CORE_NETWORK_EVDO to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_EVDO
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1300, Function | MediumTest | Level3)
{
    bool setPreferredMode =
        GetProxy()->SetPreferredNetwork(SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_EVDO), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_EVDO));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1400
 * @tc.name    Set the preferred network mode CORE_NETWORK_EVDO_CDMA to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1400, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_EVDO_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1500
 * @tc.name    Set the preferred network mode CORE_NETWORK_WCDMA_GSM_EVDO_CDMA to test the GetPreferredNetwork() return
 *             the preferred network mode is CORE_NETWORK_WCDMA_GSM_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1500, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_WCDMA_GSM_EVDO_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1600
 * @tc.name    Set the preferred network mode CORE_NETWORK_LTE_EVDO_CDMA to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_LTE_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1600, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_EVDO_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1700
 * @tc.name    Set the preferred network mode CORE_NETWORK_LTE_WCDMA_GSM_EVDO_CDMA to test the GetPreferredNetwork()
 *             return the preferred network mode is CORE_NETWORK_LTE_WCDMA_GSM_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1700, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_WCDMA_GSM_EVDO_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1800
 * @tc.name    Set the preferred network mode CORE_NETWORK_TDSCDMA to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_TDSCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1800, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_1900
 * @tc.name    Set the preferred network mode CORE_NETWORK_TDSCDMA_GSM to test the GetPreferredNetwork() return the
 *             preferred network mode is CORE_NETWORK_TDSCDMA_GSM
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1900, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_GSM));
}
 ...
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_TDSCDMA_WCDMA and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_TDSCDMA_WCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1500, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_1600
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_TDSCDMA_WCDMA_GSM and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_TDSCDMA_WCDMA_GSM
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1600, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA_GSM));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_1700
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_LTE_TDSCDMA and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_LTE_TDSCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1700, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_1800
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_LTE_TDSCDMA_GSM and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_LTE_TDSCDMA_GSM
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1800, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_GSM));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_1900
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_LTE_TDSCDMA_WCDMA and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_LTE_TDSCDMA_WCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1900, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_2000
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM and use
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_2000, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_2100
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_TDSCDMA_WCDMA_GSM_EVDO_CDMA and
 *             use GetPreferredNetwork() to test the return the preferred network mode is
 *             CORE_NETWORK_TDSCDMA_WCDMA_GSM_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_2100, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    ...
    ASSERT_EQ(getPreferredNetworkModeResult,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_TDSCDMA_WCDMA_GSM_EVDO_CDMA));
}

/*
 * @tc.number  Telephony_NetworkSearch_SetPreferredNetwork_2200
 * @tc.name    Test the SetPreferredNetwork() to set preferred network mode CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA
 *             and use GetPreferredNetwork() to test the return the preferred network mode is
 *             CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_2200, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA));
}
 ...
 * @tc.name    Use the SetPreferredNetwork() to set preferred network mode NETWORK_TEST_CDMA to test the GetPsRadioTech
 *             interface query function, and return the PS network mode as RADIO_TECHNOLOGY_1XRTT
 * @tc.desc    Function test
 */
 ...
 * @tc.name    Use the SetPreferredNetwork() to set preferred network mode NETWORK_TEST_TDSCDMA to test the
...
{
    VendorTestCDMA(NETWORK_TEST_TDSCDMA);
    RadioTech getPsRadioTech = static_cast<RadioTech>(GetNetworkState()->GetPsRadioTech());
...
{
    VendorTestCDMA(NETWORK_TEST_CDMA_EVDO_0);
    RadioTech getPsRadioTech = static_cast<RadioTech>(GetNetworkState()->GetPsRadioTech());
...
{
    VendorTestCDMA(NETWORK_TEST_CDMA_EHRPD);
    RadioTech getPsRadioTech = static_cast<RadioTech>(GetNetworkState()->GetPsRadioTech());
 ...
 * @tc.name    Use the SetPreferredNetwork() to set preferred network mode NETWORK_TEST_CDMA to test the GetCsRadioTech
 *             interface query function, and return the Cs network mode as RADIO_TECHNOLOGY_1XRTT
 * @tc.desc    Function test
 */
 ...
 * @tc.name    Use the SetPreferredNetwork() to set preferred network mode NETWORK_TEST_CDMA_EVDO_B to test tThe service
 *             status of PS registration is the registration is successful, test the GetNetworkState interface to query
 *             the network registration service status as the registration is successful and IsEmergency is true
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkState_1200, Function | MediumTest | Level3)
{
    VendorTestCDMA(NETWORK_TEST_CDMA_EVDO_B);
    std::string plmnNumeric = GetNetworkState()->GetPlmnNumeric();
    EXPECT_STRNE(plmnNumeric.c_str(), "");
    std::string shortOperatorName = GetNetworkState()->GetShortOperatorName();
    EXPECT_STRNE(shortOperatorName.c_str(), "");
 ...
 * @tc.name    Use the SetPreferredNetwork() to set preferred network mode NETWORK_TEST_CDMA to test the
