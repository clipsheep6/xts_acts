...
{
    VendorTestCDMA(PreferredNetwork::CORE_NETWORK_MODE_LTE_EVDO_CDMA);
    NrMode nrMode = GetProxy()->GetNrOptionMode(SLOT_0);
...
{
    VendorTestCDMA(PreferredNetwork::CORE_NETWORK_MODE_NR);
    NrMode nrMode = GetProxy()->GetNrOptionMode(SLOT_0);
 ...
 * @tc.name    Test the GetPsRadioTech interface query function, and return the PS network mode as
 ...
 * @tc.name    Test the GetPsRadioTech interface query function, and return the PS network mode as NR
 * @tc.desc    Function test
 */
 ...
 * @tc.name    Test the GetCsRadioTech interface query function, and return the CS network mode as
 *             RADIO_TECHNOLOGY_LTE_CA
 * @tc.desc    Function test
 */
 ...
 * @tc.name    Test the GetCsRadioTech interface query function, and return the CS network mode as NR
 * @tc.desc    Function test
 */
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_2000, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR), g_callback);
    ...
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE));
}

/*
 * @tc.number  Telephony_NetworkSearch_GetPreferredNetwork_2200
 * @tc.name    Set the preferred network mode CORE_NETWORK_MODE_NR_LTE_WCDMA to test the GetPreferredNetwork() return
 *             the preferred network mode is CORE_NETWORK_MODE_NR_LTE_WCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_2200, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA_GSM));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_EVDO_CDMA));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    ...
    ASSERT_EQ(getPreferredNetworkModeResult,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_WCDMA_GSM_EVDO_CDMA));
}
 ...
 *             GetPreferredNetwork() to test the return the preferred network mode is CORE_NETWORK_MODE_NR_LTE_TDSCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_2300, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ...
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    EXPECT_TRUE(setPreferredNetworkModeResult);
    EXPECT_EQ(errCodeResult, HRIL_ERR_SUCCESS);
    ...
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_GSM));
}
 ...
 * CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA
 * @tc.desc    Function test
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_2500, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    EXPECT_TRUE(setPreferredNetworkModeResult);
    EXPECT_EQ(errCodeResult, HRIL_ERR_SUCCESS);
    ...
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(
        getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    EXPECT_TRUE(setPreferredNetworkModeResult);
    EXPECT_EQ(errCodeResult, HRIL_ERR_SUCCESS);
    ...
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA_GSM));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(SLOT_0,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    EXPECT_TRUE(setPreferredNetworkModeResult);
    EXPECT_EQ(errCodeResult, HRIL_ERR_SUCCESS);
    ...
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult,
        static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_NR_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA));
}