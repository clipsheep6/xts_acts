...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSelectionMode_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(hasNewData[GET_NETWORK_MODEL], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_0500, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWhiteEq(
        (static_cast<RadioTech>(GetNetworkState()->GetPsRadioTech()) == RadioTech::RADIO_TECHNOLOGY_LTE ||
            static_cast<RadioTech>(GetNetworkState()->GetCsRadioTech()) == RadioTech::RADIO_TECHNOLOGY_LTE),
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSearchInformation_0100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(hasNewData[GET_NETWORK_SEARCH_RESULT], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT_RESULT);
