...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkState_0100, Function | MediumTest | Level3)
{
    ...
    EXPECT_EQ(regState, RegServiceState::REG_STATE_IN_SERVICE);
...
{
    int getPsRadioTech = static_cast<int32_t>(GetNetworkState()->GetPsRadioTech());
    int getCsRadioTech = static_cast<int32_t>(GetNetworkState()->GetCsRadioTech());
    auto signalVec = GetProxy()->GetSignalInfoList(SLOT_0);
    int type;
    bool result = false;
    ASSERT_FALSE(signalVec.empty());
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSelectionMode_0100, Function | MediumTest | Level3)
{
    ...
    bool setSelectModeResult = GetProxy()->SetNetworkSelectionMode(SLOT_0, static_cast<int32_t>(selectionMode),
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetNetworkSelectionMode_0400, Function | MediumTest | Level3)
{
    ...
    bool setSelectModeResult = GetProxy()->SetNetworkSelectionMode(
        SLOT_0, static_cast<int32_t>(selectionMode), networkInfo, false, g_callback);
    ASSERT_TRUE(setSelectModeResult);
    LOCK_NUM_WHILE_NE(hasNewData[SET_NETWORK_MODEL], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_FALSE(setNetworkModeCallbackResult);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_0200, Function | MediumTest | Level3)
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_GSM), g_callback);
    ...
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_GSM));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_WCDMA));
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_0400, Function | MediumTest | Level3)
{
    ...
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_LTE));
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_0600, Function | MediumTest | Level3)
{
    ...
    int slotId = -1;
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        slotId, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_GSM), g_callback);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_0900, Function | MediumTest | Level3)
{
    ...
    int slotId = 1;
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        slotId, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_WCDMA), g_callback);
    EXPECT_FALSE(setPreferredMode);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1000, Function | MediumTest | Level3)
{
    ...
    int slotId = 2;
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        slotId, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_LTE_WCDMA), g_callback);
    EXPECT_FALSE(setPreferredMode);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_LTE_WCDMA), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_LTE_WCDMA));
}
...
{
    bool setPreferredMode = GetProxy()->SetPreferredNetwork(
        SLOT_0, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_WCDMA_GSM), g_callback);
    ASSERT_TRUE(setPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[SET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    bool getPreferredMode = GetProxy()->GetPreferredNetwork(SLOT_0, g_callback);
    ASSERT_TRUE(getPreferredMode);
    LOCK_NUM_WHILE_NE(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    ASSERT_EQ(getPreferredNetworkModeResult, static_cast<int32_t>(PreferredNetwork::CORE_NETWORK_MODE_WCDMA_GSM));
}
