...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSearchInformation_0500, Function | MediumTest | Level3)
{
    ...
    LockNumWhiteEq((int)operatorLongName.size(), NETWORK_WAIT_LOCK_SIZE, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorNumeric.at(0).c_str(), "46000", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorShortName.at(0).c_str(), "CMCC", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorLongName.at(0).c_str(), "CHINA MOBILE", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(networkPlmnState.at(0), static_cast<int>(NetworkPlmnState::NETWORK_PLMN_STATE_AVAILABLE),
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(networkRat.at(0), static_cast<int>(NetworkRat::NETWORK_LTE), LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSearchInformation_0600, Function | MediumTest | Level3)
{
    ...
    ASSERT_TRUE(networkSearchResult);
    LockNumWhiteEq((int)operatorLongName.size(), NETWORK_WAIT_LOCK_SIZE, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorNumeric.at(0).c_str(), "46001", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorShortName.at(0).c_str(), "CU", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorLongName.at(0).c_str(), "China Unicom", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(networkPlmnState.at(0), static_cast<int>(NetworkPlmnState::NETWORK_PLMN_STATE_REGISTERED),
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetNetworkSearchInformation_0700, Function | MediumTest | Level3)
{
    ...
    ASSERT_TRUE(networkSearchResult);
    LockNumWhiteEq((int)operatorLongName.size(), NETWORK_WAIT_LOCK_SIZE, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorNumeric.at(0).c_str(), "46003", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorShortName.at(0).c_str(), "CT", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockStringWhiteNe(operatorLongName.at(0).c_str(), "China Telecom", LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(networkPlmnState.at(0), static_cast<int>(NetworkPlmnState::NETWORK_PLMN_STATE_FORBIDDEN),
        LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
    LockNumWHhileNe(networkRat.at(0), static_cast<int>(NetworkRat::NETWORK_WCDMA), LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
}
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_1100, Function | MediumTest | Level3)
{
    ...
    LockNumWHhileNe(hasNewData[GET_PREFERRED_NETWORK_MODE], true, LOCK_WAIT_SLIP, LOCK_WAIT_TIMEOUT);
