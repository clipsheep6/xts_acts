 ...
 * @tc.desc     Performance test
 */
HWTEST_F(SimTest, Telephony_Sim_GetShowNumber_0400, Function | MediumTest | Level1)
{
    std::u16string cardNumber = Str8ToStr16("1234");
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.name     Test the GetOperatorConfig interface query function 1000 times
 *              and expect an average delay of less than 500μs.
 * @tc.desc     Performance test
 */
HWTEST_F(SimTest, Telephony_Sim_GetOperatorConfig_0300, Function | MediumTest | Level1)
{
    OHOS::Telephony::OperatorConfig poc;
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    for (int32_t timeNumber = 0; timeNumber < LOOP_NUMBER; timeNumber++) {
        g_proxy.GetHandler()->GetOperatorConfig(SLOTID_0, poc);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_NUMBER;
    LOG("The time of each time is : %d us", useTimeUs);
    EXPECT_LE(useTimeUs, SimTest::TIME_USEC);
 ...
 * @tc.name     Test the QueryIccDiallingNumbers interface query function 1000 times
 *              and expect an average delay of less than 500μs.
 * @tc.desc     Performance test
 */
 ...
 * @tc.name     Test the AddIccDiallingNumbers interface query function 1000 times
 *              and expect an average delay of less than 500μs.
 * @tc.desc     Performance test
 */
 ...
 * @tc.name     Test the DelIccDiallingNumbers interface query function 1000 times
 *              and expect an average delay of less than 500μs.
 * @tc.desc     Performance test
 */
 ...
 * @tc.name     Test the UpdateIccDiallingNumbers interface query function 1000 times
 *              and expect an average delay of less than 500μs.
 * @tc.desc     Performance test
 */
HWTEST_F(SimTest, Telephony_Sim_UpdateIccDiallingNumbers_1000, Function | MediumTest | Level1)
{
    ...
    timeHelper.StartCountUs();
    for (int32_t timeNumber = 0; timeNumber < LOOP_NUMBER; timeNumber++) {
        g_proxy.GetHandler()->UpdateIccDiallingNumbers(SLOTID_0, TYPE_ADN, info, INDEX);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_NUMBER;
    LOG("The time of each time is : %d us", useTimeUs);
    EXPECT_LE(useTimeUs, SimTest::TIME_USEC);
