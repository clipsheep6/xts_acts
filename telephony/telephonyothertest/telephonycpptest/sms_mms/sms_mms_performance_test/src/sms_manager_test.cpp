 ...
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SendMessageData_0900, Performance | MediumTest | Level3)
{
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SendMessageText_1300, Performance | MediumTest | Level3)
{
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_UpdateSimMessage_2400, Performance | MediumTest | Level3)
{
...
/**
 * @tc.number   Telephony_SmsMms_AddSimMessage_2300
 * @tc.name     loops Failed to save SMS to SIM LOOP_MULTITUDE_NUMBER,
 *              Determine that the running time is less than TIME_USEC_500
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_AddSimMessage_2300, Performance | MediumTest | Level3)
{
    std::u16string pdu = RECEIVE_SMS_PDU;
    std::u16string smsc = u"";
    TimeCountHelper timeHelper;
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_DelSimMessage_0500, Performance | MediumTest | Level3)
{
    std::vector<std::u16string> beforeSmsRecord = g_smsClientPtr->GetPtr()->GetAllSimMessages(SLOT_ID_1);
    int addIndex[] = {0};
    int index = 0;
    ...
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        ...
        g_smsClientPtr->GetPtr()->DelSimMessage(SLOT_ID_1, tempIndex);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
...
/**
 * @tc.number   Telephony_SmsMms_GetAllSimMessages_0600
 * @tc.name     The loop calls GetAllSimMessages() LOOP_MULTITUDE_NUMBER times,
 *              Determine that the running time is less than TIME_USEC_500
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_GetAllSimMessages_0600, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        g_smsClientPtr->GetPtr()->GetAllSimMessages(SLOT_ID_1);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
...
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SetSmscAddr_1100, Performance | MediumTest | Level3)
{
    ...
    timeHelper.StartCountUs();
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        g_smsClientPtr->GetPtr()->SetSmscAddr(SLOT_ID_1, newSmsc);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
...
HWTEST_F(SmsManagerTest, Telephony_SmsMms_ISmsServiceInterface_GetSmscAddr_0400, Performance | MediumTest | Level3)
{
    ...
    timeHelper.StartCountUs();
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        g_smsClientPtr->GetPtr()->GetSmscAddr(SLOT_ID_1);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SetCBConfig_1300, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        g_smsClientPtr->GetPtr()->SetCBConfig(SLOT_ID_1, true, 0, 1);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
...
/**
 * @tc.number   Telephony_SmsMms_SetCBRangeConfig_1200
 * @tc.name     The loop calls CBRangeConfig() LOOP_MULTITUDE_NUMBER times,
 *              Determine that the running time is less than TIME_USEC_500
 * @tc.desc     Performance test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SetCBRangeConfig_1200, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
        g_smsClientPtr->GetPtr()->SetCBRangeConfig(SLOT_ID_1, true, 0, 0xFFFF - 1, 1);
    }
    int32_t useTimeUs = timeHelper.GetUseTimeUs() / LOOP_MULTITUDE_NUMBER;
    LOGE("use %d us", useTimeUs);
    EXPECT_LE(useTimeUs, TIME_USEC_500);
