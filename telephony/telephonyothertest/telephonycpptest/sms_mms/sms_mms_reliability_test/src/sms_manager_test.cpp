 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(SmsManagerTest, Telephony_SmsMms_SendMessageText_1000, Reliability | MediumTest | Level3)
{
 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(SimSmsManagerTest, Telephony_SmsMms_AddSimMessage_1900, Reliability | MediumTest | Level3)
{
    std::u16string pdu = RECEIVE_SMS_PDU;
    std::u16string smsc = u"";
    for (uint i = 0; i < LOOP_MULTITUDE_NUMBER; ++i) {
