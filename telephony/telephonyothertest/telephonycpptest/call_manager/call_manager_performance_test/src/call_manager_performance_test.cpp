 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IMS_SetCallRestriction_3300,
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IMS_GetCallRestriction_2000,
    Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IMS_SetCallTransferInfo_3000,
    Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IMS_GetCallTransferInfo_1600,
    Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.name     test EnableVoLte() 20 times
 * @tc.desc     Performance test
 */
 ...
 * @tc.name     test DisableVoLte() 20 times
 * @tc.desc     Performance test
 */
 ...
 * @tc.name     test IsVoLteEnabled() 20 times
 * @tc.desc     Performance test
 */
