...
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_DialCall_0600, Performance | MediumTest | Level3)
{
    ...
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
 ...
 * @tc.name     test FormatPhoneNumber() 20 times, phonyNumber as "01085198748", countryCode as "Kr",
...
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_FormatPhoneNumber_9000, Performance | MediumTest | Level3)
{
    ...
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->FormatPhoneNumber(phonyNumber, countryCode, formatNumber);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_EQ(ret, ans);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.name     test FormatPhoneNumberToE164() 20 times, phonyNumber as "01085198748", countryCode as "Kr",
 *              formatNumber as empty
 * @tc.desc     Performance test
 */
        ...
        Performance | MediumTest | Level3)
{
    ...
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->FormatPhoneNumberToE164(phonyNumber, countryCode, formatNumber);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_EQ(ret, ans);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IsNewCallAllowed_0400, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_IsRinging_0400, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_SeparateConference_0600, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_GetCallRestriction_1300, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
    ...
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->GetCallRestriction(SLOT_ID, type.fac);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_EQ(ret, SUCCESSFUL);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_SetCallRestriction_1300, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
    CallRestrictionInfo *info = new CallRestrictionInfo;
    info->fac = RESTRICTION_TYPE_ALL_INCOMING;

    timeHelper.StartCountUs();
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->SetCallRestriction(SLOT_ID, *info);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_NE(ret, SUCCESSFUL);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_GetCallTransferInfo_1600, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
    ...
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->GetCallTransferInfo(SLOT_ID, info.type);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_EQ(ret, SUCCESSFUL);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_SetCallTransferInfo_1500, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
    char phonyNumber[ARRAY_SIZE] = {""};
    CallTransferInfo info;

    info.settingType = DISABLE;
    info.type = MOBILE_BUSY;
    ret = strcpy_s(info.transferNum, strlen(phonyNumber), phonyNumber);
    ASSERT_EQ(ret, SUCCESSFUL);

    timeHelper.StartCountUs();
    for (int i = SUCCESSFUL; i < TEST_RUN_TIME_20; i++)
    {
        ret = g_clientPtr->GetPtr()->SetCallTransferInfo(SLOT_ID, info);
    }
    int useTimeUs = timeHelper.GetUseTimeUs() / TEST_RUN_TIME_20;
    EXPECT_NE(ret, SUCCESSFUL);
    LOG("useTimeUs = %d\n", useTimeUs);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_SetAudioDevice_0500, Performance | MediumTest | Level3)
{
    int ret = Dial(Str8ToStr16(TEST_PHONY_NUMBER));
    ASSERT_EQ(ret, SUCCESSFUL);
 ...
 * @tc.desc     Performance test
 */
HWTEST_F(CallManagerPerformanceTest, Telephony_CallManager_MuteRinger_0500, Performance | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    int ret = FALSE_DEFAULT;
