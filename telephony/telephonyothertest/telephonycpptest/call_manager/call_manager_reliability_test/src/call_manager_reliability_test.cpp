 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(CallManagerReliabilityTest, Telephony_CallManager_IMS_SetCallRestriction_3200,
 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(CallManagerReliabilityTest, Telephony_CallManager_IMS_GetCallRestriction_1900,
    Reliability | MediumTest | Level3)
{
    CallRestrictionInfo setCallRestriction;
    setCallRestriction.fac = CallRestrictionType::RESTRICTION_TYPE_ROAMING_INCOMING;
    ...
    for (int i = 0; i < TEST_RUN_TIME_1000; i++) {
        ASSERT_EQ(g_clientPtr->GetPtr()->GetCallRestriction(SLOT_ID, setCallRestriction.fac),
            SUCCESSFUL);
    }
}
 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(CallManagerReliabilityTest, Telephony_CallManager_IMS_SetCallTransferInfo_2900,
    Reliability | MediumTest | Level3)
{
 ...
 * @tc.desc     Reliability test
 */
HWTEST_F(CallManagerReliabilityTest, Telephony_CallManager_IMS_GetCallTransferInfo_1500,
    Reliability | MediumTest | Level3)
{
    CallTransferInfo setCallTransfer;
    setCallTransfer.settingType = CallTransferSettingType::CALL_TRANSFER_ENABLE;
 ...
 * @tc.name     test EnableVoLte() 1000 times
 * @tc.desc     Reliability test
 */
 ...
 * @tc.name     test DisableVoLte() 1000 times
 * @tc.desc     Reliability test
 */
 ...
 * @tc.name     test IsVoLteEnabled() 1000 times
 * @tc.desc     Reliability test
 */
