 ...
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_GetIfaceStatsDetail_0600, Function | MediumTest | Level3)
{
 ...
 * @tc.desc     Function test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_GetUidStatsDetail_0600, Function | MediumTest | Level3)
{
 ...
 * @tc.desc     Function test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_UpdateIfacesStats_0700, Function | MediumTest | Level3)
{
    std::string  iface =  "eth0";
    NetStatsInfo stats;
    stats.rxBytes_ = 2048;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_SetNetPolicys_1800, Function | MediumTest | Level3)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_GetNetPolicys_0500, Function | MediumTest | Level3)
{
    std::vector<NetPolicyQuotaPolicy> quotaPolicys;
    NetPolicyQuotaPolicy quotaPolicy;
    quotaPolicy.netType_ = static_cast<uint8_t>(NetQuotaPolicyType::NET_POLICY_MOBILE);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_SetCellularPolicys_0100, Function | MediumTest | Level3)
{
    ...
    for (count = 0; count < TEST_COUNTS_1000; count++) {
        NetPolicyResultCode result =
            DelayedSingleton<NetPolicyClient>::GetInstance()->SetCellularPolicys(cellularPolicys);
        ASSERT_EQ(result, NetPolicyResultCode::ERR_NONE);
    }
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_GetCellularPolicys_0500, Function | MediumTest | Level3)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_SnoozePolicy_0700, Function | MediumTest | Level3)
{
    std::vector<NetPolicyQuotaPolicy> quotaPolicys;
    NetPolicyQuotaPolicy quotaPolicy;
    quotaPolicy.netType_ = static_cast<uint8_t>(NetQuotaPolicyType::NET_POLICY_MOBILE);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_SetIdleWhitelist_0400, Function | MediumTest | Level3)
{
    uint8_t uid = 1;
    NetPolicyResultCode result;
    int count;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_GetIdleWhitelist_0400, Function | MediumTest | Level3)
{
    uint8_t uid = 1;
 ...
 * @tc.type: FUNC
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_ResetFactory_1000, Function | MediumTest | Level3)
{
 ...
 * @tc.desc     Function test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_RegisterTetheringEventCallback_0100, Function | MediumTest | Level2)
{
    int count;
    for (count = 0; count < TEST_COUNTS_1000; count++) {
 ...
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_TetherByIface_0500, Function | MediumTest | Level3)
{
 ...
 * @tc.desc     Reliablity test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_UntetherByIface_0400, Function | MediumTest | Level3)
{
    std::string iface = "wlan0";
    for (int32_t timeNumber = 0; timeNumber < TEST_RUN_TIME; ++timeNumber) {
 ...
 * @tc.desc     Reliablity test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_TetherByType_0600, Function | MediumTest | Level3)
{
    std::string iface = "wlan0";
    for (int32_t timeNumber = 0; timeNumber < TEST_RUN_TIME; ++timeNumber) {
        int32_t enableResult =
 ...
 * @tc.desc     Reliablity test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_UntetherByType_0600, Function | MediumTest | Level3)
{
    for (int32_t timeNumber = 0; timeNumber < TEST_RUN_TIME; ++timeNumber) {
        int32_t ret =
            DelayedSingleton<NetTetherClient>::GetInstance()->TetherByType(TetheringType::TETHERING_WIFI);
 ...
 * @tc.desc     Reliablity test
 */
HWTEST_F(StabilityTestPhase7, Telephony_NetworkManager_SetAirplaneMode_0300, Function | MediumTest | Level3)
{
    bool state = true;
    int32_t expect = 0;
    for (int32_t timeNumber = 0; timeNumber < TEST_RUN_TIME; ++timeNumber) {
