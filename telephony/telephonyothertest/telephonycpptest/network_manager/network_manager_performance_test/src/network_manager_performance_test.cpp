 ...
 * @tc.name    Input parameters NetBearType to 0, netCapabilities to 0, call RegisterNetConnCallback() to activate the network 1000 times,
 *             the output delay is less than 1000000us
 * @tc.desc    Reliability test
 */
HWTEST_F(NetworkManagerRegisterNetconnCallbackTest, Telephony_NetworkManager_RegisterNetConnCallback_2800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
 ...
 * @tc.name    RegisterNetConnCallback() is called 1000 times to activate the default network with output delay less than 1000000us
 * @tc.desc    Reliability test
 */
HWTEST_F(NetworkManagerRegisterNetconnCallbackTest, Telephony_NetworkManager_RegisterNetConnCallback_2900, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    sptr<INetConnCallback> callback = (std::make_unique<TestNetConnCallback>()).release();
    int count;
 ...
 * @tc.desc    Reliability test
 */
HWTEST_F(NetworkManagerRegisterNetconnCallbackTest, Telephony_NetworkManager_UnRegisterNetConnCallback_0500, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    sptr<INetConnCallback> callback = (std::make_unique<TestNetConnCallback>()).release();
    int count;
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetHandlerTest, Telephony_NetworkManager_GetAddressesByName_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetHandlerTest, Telephony_NetworkManager_GetAddressByName_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    std::string host = "www.taobao.com";
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetHandlerTest, Telephony_NetworkManager_BindSocket_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    int32_t socket_fd = 1;
 ...
 * @tc.name    The GetAllNets () test is executed 1000 times, and the total time for obtaining 1000 times is less than 1000000us
 * @tc.desc   Performance test
 */
