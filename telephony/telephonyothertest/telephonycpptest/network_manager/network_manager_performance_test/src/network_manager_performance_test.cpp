 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressesByName_0800,
    Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_GetAddressByName_0800,
    Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(NetworkManagerGetAddressByNameTest, Telephony_NetworkManager_BindSocket_0800,
    Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
