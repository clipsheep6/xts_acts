 ...
 * @tc.desc    Performance test
 */
HWTEST_F(GetAddressByName, Telephony_NetworkManager_GetAddressesByName_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(GetAddressByName, Telephony_NetworkManager_GetAddressByName_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    std::string host = "www.taobao.com";
 ...
 * @tc.desc    Performance test
 */
HWTEST_F(GetAddressByName, Telephony_NetworkManager_BindSocket_0800, Function | MediumTest | Level3)
{
    TimeCountHelper timeHelper;
    timeHelper.StartCountUs();
    int32_t socket_fd = 1;
