...
/*
 * @tc.number  Telephony_NetworkManager_SetPolicyByUid_1100
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_SetPolicyByUid_1100, Function | MediumTest | Level3)
{
    int count;
...
/*
 * @tc.number  Telephony_NetworkManager_GetPolicyByUid_0600
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetPolicyByUid_0600, Function | MediumTest | Level3)
{
    int count;
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(5, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    for (count = 0; count < TEST_COUNTS_1000; ++count) {
        NetUidPolicy policyResult = DelayedSingleton<NetPolicyClient>::GetInstance()->GetPolicyByUid(5);
        EXPECT_EQ(policyResult, NetUidPolicy::NET_POLICY_ALLOW_ALL);
    }
}

/*
 * @tc.number  Telephony_NetworkManager_GetUidsByPolicy_0800
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(UidPolicyTest, Telephony_NetworkManager_GetUidsByPolicy_0800, Function | MediumTest | Level3)
{
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetPolicyByUid(
        1, NetUidPolicy::NET_POLICY_ALLOW_METERED_BACKGROUND);
    int count;
    for (count = 0; count < TEST_COUNTS_1000; ++count) {
        std::vector<uint32_t> result = DelayedSingleton<NetPolicyClient>::GetInstance()->GetUidsByPolicy(
...
/*
 * @tc.number  Telephony_NetworkManager_IsIfaceActive_0300
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_IsIfaceActive_0300, Function | MediumTest | Level3)
{
    std::string iface = "eth0";
    int count;
    for (count = 0; count < TEST_COUNTS_1000; ++count) {
...
/*
 * @tc.number  Telephony_NetworkManager_GetAllActiveIfaces_0200
 * @tc.name
 * @tc.desc    Function test
 */
HWTEST_F(NetworkManagerTest, Telephony_NetworkManager_GetAllActiveIfaces_0200, Function | MediumTest | Level3)
{
    std::string iface = "eth0";
    int count;
    bool flag = false;
