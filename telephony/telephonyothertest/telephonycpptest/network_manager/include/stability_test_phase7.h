...
class StabilityTestPhase7 : public testing::Test {
public:
...
void StabilityTestPhase7::SetUpTestCase()
{
    system("date \"2022-01-20 18:30:50\"");
}

void StabilityTestPhase7::TearDownTestCase() {}

void StabilityTestPhase7::SetUp()
{
    DelayedSingleton<NetPolicyClient>::GetInstance()->SetFactoryPolicy("");
}

void StabilityTestPhase7::TearDown() {}
}
}
