 ...
 */
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_GetPreferredNetwork_1200, Performance | MediumTest | Level3)
{
...
HWTEST_F(NetworkSearchTest, Telephony_NetworkSearch_SetPreferredNetwork_0800, Performance | MediumTest | Level3)
{
    ...
    for (int i = 0; i < TEST_RUN_TIME_1000; i++) {
        ...
        GetProxy()->SetPreferredNetwork(SLOT_0, CORE_NETWORK_MODE_LTE, g_callback);
