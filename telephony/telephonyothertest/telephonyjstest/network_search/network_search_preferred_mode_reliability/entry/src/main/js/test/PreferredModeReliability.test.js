...
describe('NetworkSearchPreferredReliabilityTest', function () {
    const SLOT_0 = 0;
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Async_0800', 0, async function (done) {
        function Recursive(n) {
            ...
            radio.getPreferredNetwork(SLOT_0, (err, data) => {
                if (err) {
                    console.log(`Telephony_NetworkSearch_getPreferredNetwork_Async_0800 fail err: ${err}`);
                    expect().assertFail();
                    done();
                    return;
                }
                console.log(`Telephony_NetworkSearch_getPreferredNetwork_Async_0800 data: ${data}`);
    ...
    it('Telephony_NetworkSearch_getPreferredNetwork_Promise_0800', 0, async function (done) {
        for (let index = 0; index < TEST_RUN_TIME; index++) {
            try {
                ...
                console.log(`Telephony_NetworkSearch_getPreferredNetwork_Promise_0800 data: ${data}`);
                expect(data === radio.PREFERRED_NETWORK_MODE_AUTO).assertTrue();
            } catch (err) {
                console.log(`Telephony_NetworkSearch_getPreferredNetwork_Promise_0800 FAIL ${err}`);
                expect().assertFail();
                done();
                return;
            }
