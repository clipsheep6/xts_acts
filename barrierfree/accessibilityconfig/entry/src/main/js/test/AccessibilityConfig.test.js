...
describe('AccessibilityConfigTest', function () {
     ...
     * @tc.desc    Test shortkey_target.set() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncCallback_6700', 0, async function(done) {
        ...
        let value = ''
        config.shortkey_target.set(value, (err, result) => {
            if (err.code != 0) {
     ...
     * @tc.desc    Test shortkey_target.set() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncPromise_6800', 0, async function(done) {
        ...
        let value = 'test'
        config.shortkey_target.set(value).then((result) => {
     ...
     * @tc.desc    Test shortkey_target.get() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_get_asyncCallback_6900', 0, async function(done) {
        ...
        config.shortkey_target.get((err, result) => {
            if (err.code != 0) {
     ...
     * @tc.desc    Test shortkey_target.get() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_get_asyncPromise_7000', 0, async function(done) {
        ...
        config.shortkey_target.get().then((result) => {
     ...
     * @tc.desc    Test shortkey_target.on() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_on_asyncCallback_7100', 0, async function(done) {
        ...
        let ret = config.shortkey_target.on((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
     ...
     * @tc.desc    Test shortkey_target.off() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_off_asyncCallback_7200', 0, async function(done) {
        ...
        let ret = config.shortkey_target.off((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
     ...
     * @tc.desc    Test caption.set() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncCallback_7300', 0, async function(done) {
        ...
        config.caption.set(true, (err, result) => {
            if (err.code != 0) {
     ...
     * @tc.desc    Test caption.set() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncPromise_7400', 0, async function(done) {
        ...
        config.caption.set(false).then((result) => {
     ...
     * @tc.desc    Test caption.get() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
     ...
     * @tc.desc    Test caption.get() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_get_asyncPromise_7600', 0, async function(done) {
        ...
        config.caption.get().then((result) => {
     ...
     * @tc.desc    Test caption.on() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_on_asyncCallback_7700', 0, async function(done) {
        ...
        let ret = config.caption.on((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
     ...
     * @tc.desc    Test caption.off() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_off_asyncCallback_7800', 0, async function(done) {
        ...
        let ret = config.caption.off((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
     ...
     * @tc.desc    Test captionStyle.set() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncCallback_8700', 0, async function(done) {
        ...
        config.captionStyle.set(value, (err, result) => {
            if (err.code != 0) {
     ...
     * @tc.desc    Test captionStyle.set() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_set_asyncPromise_8800', 0, async function(done) {
        ...
        config.captionStyle.set(value).then((result) => {
     ...
     * @tc.desc    Test captionStyle.get() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_get_asyncCallback_8900', 0, async function(done) {
        ...
        config.captionStyle.get((err, result) => {
            if (err.code != 0) {
     ...
     * @tc.desc    Test captionStyle.get() function in promise mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_get_asyncPromise_9000', 0, async function(done) {
        ...
        config.captionStyle.get().then((result) => {
     ...
     * @tc.desc    Test captionStyle.on() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_on_asyncCallback_9100', 0, async function(done) {
        ...
        let ret = config.captionStyle.on((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
     ...
     * @tc.desc    Test captionStyle.off() function in callback mode.
     * @tc.size    SmallTest
     * @tc.type    User
     */
    it('AccessibilityConfigTest_off_asyncCallback_9200', 0, async function(done) {
        ...
        let ret = config.captionStyle.off((data) => {});
        expect(ret).assertEqual(undefined);
        done();
    })
