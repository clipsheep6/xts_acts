 ...
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_001, Level1)
{
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_002, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_003, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_004, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_005, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_006, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_007, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_008, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_009, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_010, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_011, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_012, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_013, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_014, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_015, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_016, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_017, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_018, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_019, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
 ...
 * @tc.desc      : [C- SOFTWARE -0200]
 */
HWTEST_F(PlayerliteTest, player_lite_video_test_020, Level1)
{
    int32_t ret = FileCheck(g_avFileName);
    EXPECT_EQ(HI_SUCCESS, ret);
    ret = CreateAndSetSource();
