...
export default class ServiceExtAbility extends ServiceExtensionAbility {
  onCreate(want) {
    ...
    if (want.action === 'SUB_Ability_AbilityRuntime_terminateProcess_0200') {
      try {
        applicationContext.terminateProcess().catch((err: BusinessError) => {
          console.info('====> [RelyMultipleAbility] 0200 terminateApplication err: ' + JSON.stringify(err));
        });
      } catch (err) {
        console.info('====> [RelyMultipleAbility] 0200 terminateApplication throw err: ' + JSON.stringify(err));
      }
      ...
      this.context.startAbility({
        ...
        console.info('====>[RelyServiceAbility] 0500 startAbility err:' + JSON.stringify(err));
      })
      ...
      try {
        applicationContext.terminateApplication().catch((err: BusinessError) => {
          console.info('====> [RelyMultipleAbility] 0800 terminateApplication err: ' + JSON.stringify(err));
        });
      } catch (err) {
        console.info('====> [RelyMultipleAbility] 0800 terminateApplication throw err: ' + JSON.stringify(err));
      }
      ...
      this.context.startAbility({
        ...
        console.info('====>[RelyServiceAbility] 1100 startAbility err:' + JSON.stringify(err));
      })
    }
  }
