...
async function onShowProcess() {
    ...
    var commonEventPublishData = {
        parameters: {
            instance2Count: globalThis.instance2Count,
        }
    };
...
export default class MainAbility extends Ability {
    ...
    onCreate(want, launchParam) {
        ...
        globalThis.instance2Count++;
        console.log("AbilityMultiInstanceAppA abilityWant = " + JSON.stringify( globalThis.abilityWant2));
    }

    onNewWant(want, launchParam) {
        // Ability is creating, initialize resources for this ability
        console.log("MainAbility2 onNewWant")
        globalThis.abilityWant2 = want;
        console.log("AbilityMultiInstanceAppA new want abilityWant = " + JSON.stringify( globalThis.abilityWant2));
        onShowProcess();
    }
