...
function Acts_AutoStartup_1600() {
...
function Acts_AutoStartup_1700() {
  try {
    AutoStartUpManager.setApplicationAutoStartup({
      bundleName: 'com.acts.autostartupapp',
      abilityName: 'EntryAbility'
...
function Acts_AutoStartup_1800() {
...
function Acts_AutoStartup_1900() {
...
function Acts_AutoStartup_2000() {
...
export default class EntryAbility extends UIAbility {
  onCreate(want, launchParam) {
    ...
    if (want.action === 'Acts_AutoStartup_1600') {
      console.info("if (want.action === 'Acts_AutoStartup_1600')")
      Acts_AutoStartup_1600();
    } else if (want.action === 'Acts_AutoStartup_1700') {
      Acts_AutoStartup_1700();
    } else if (want.action === 'Acts_AutoStartup_1800') {
      console.info("if want (want.action === 'Acts_AutoStartup_1600')")
      Acts_AutoStartup_1800();
    } else if (want.action === 'Acts_AutoStartup_1900') {
      Acts_AutoStartup_1900();
    } else if (want.action === 'Acts_AutoStartup_2000') {
      Acts_AutoStartup_2000();
    }
  }
  ...
  onNewWant(want) {
    if (want.action === 'Acts_AutoStartup_1600') {
      ...
      console.info("if newwant (want.action === 'Acts_AutoStartup_1600')")
      Acts_AutoStartup_1800();
    } else if (want.action === 'Acts_AutoStartup_1900') {
      Acts_AutoStartup_1900();
    } else if (want.action === 'Acts_AutoStartup_2000') {
