    ...
    onConnect(want) {
        ...
        if (want.action == "Seven") {
            extensionContext.connectAbility(
                {
                    bundleName: "com.acts.actsmanyusersabilitytest",
                    abilityName: "com.acts.actsmanyusersabilitytest.ServiceAbility2",
                }, {
        ...
        if (want.action == "Eight") {
            extensionContext.connectAbility(
                {
                    bundleName: "com.acts.actsmanyusersabilitytesta",
                    abilityName: "com.acts.actsmanyusersabilitytest.ServiceAbility3",
                }, {
                    onConnect: onConnectCallback,
                    onDisconnect: onDisconnectCallback,
                    onFailed: onFailedCallback
