...
export default class MainAbility5 extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    AppStorage.setOrCreate<common.ApplicationContext>("ApplicationContext5", this.context.getApplicationContext());
    let callBackId = AppStorage.get<common.ApplicationContext>("ApplicationContext5")!.on("abilityLifecycle", AbilityLifecycleCallback);
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    windowStage.loadContent("MainAbility/pages/MainAbility5_pages", null);
  }
