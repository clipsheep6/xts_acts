...
export default class Hap2MainAbility1 extends Ability {
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    windowStage.loadContent('pages/Hap2MainAbility1_pages', null);
  }
  ...
  onNewWant(want, launchParams) {
    ...
    switch (globalThis.abilityWant1.parameters['number']) {
      case 18: {
        ...
        fs.open(uri, fs.OpenMode.READ_WRITE)
          .then((file) => {
            console.info('file fd: ' + file.fd);
  ...
  onForeground() {
    ...
    switch (globalThis.abilityWant1.parameters['number']) {
      ...
      case 12: {
        ...
        commonEvent.createSubscriber(subscribeInfo)
          .then(async (data) => {
            ...
            await commonEvent.subscribe(subscriber12_1, (err, data) => {
              ...
              commonEvent.unsubscribe(subscriber12_1, () => {
      ...
      case 14: {
        ...
        fs.open(uris[0], fs.OpenMode.READ_WRITE)
          .then((file) => {
            console.info('file fd: ' + file.fd);
        ...
        fs.open(uris[1], fs.OpenMode.READ_WRITE)
          .then((file) => {
            console.info('file fd: ' + file.fd);
