...
export default class MainAbility4 extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    let AbilityLifecycleCallback = {
      onAbilityCreate(ability) {
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityCreate ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityCreate abilityname:" + JSON.stringify(abilityname));
      ...
      onWindowStageCreate(ability, windowStage) {
        console.log("[Demo] AbilityLifecycleCallback4 onWindowStageCreate ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onWindowStageCreate abilityname:" + JSON.stringify(abilityname));
      ...
      onWindowStageDestroy(ability, windowStage) {
        console.log("[Demo] AbilityLifecycleCallback4 onWindowStageDestroy ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onWindowStageDestroy abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityDestroy(ability) {
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityDestroy ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityDestroy abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityForeground(ability) {
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityForeground ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityForeground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityBackground(ability) {
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityBackground ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityBackground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityContinue(ability) {
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityContinue ability:" + JSON.stringify(ability));
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback4 onAbilityContinue abilityname:" + JSON.stringify(abilityname));
    ...
    let lifecycleid = AppStorage.get<common.ApplicationContext>("applicationContext4")!.on("abilityLifecycle", AbilityLifecycleCallback);
    console.log("[Demo] registerAbilityLifecycleCallback4 number: " + JSON.stringify(lifecycleid));
    AppStorage.setOrCreate<number>("callbackid4", lifecycleid);
    setTimeout(() => {
      console.log("[Demo] registerAbilityLifecycleCallback4 listKey : " + JSON.stringify(listKey4));
      AppStorage.setOrCreate<string[]>("list4", listKey4);
    }, 1500);
  }
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    AppStorage.setOrCreate<common.UIAbilityContext>("ability4", this.context);
    windowStage.loadContent("MainAbility/pages/index4", null);
  }
  ...
  onForeground() {
    ...
    setTimeout(() => {
      AppStorage.get<common.UIAbilityContext>("ability4")!.terminateSelf()
        .then((data) => {
