...
export default class MainAbility10 extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    let AbilityLifecycleCallback = {
      onAbilityCreate(ability) {
        ...
        console.log("[Demo] AbilityLifecycleCallback10 onAbilityCreate abilityname:" + JSON.stringify(abilityname));
      ...
      onWindowStageCreate(ability, windowStage) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onWindowStageCreate abilityname:" + JSON.stringify(abilityname));
      ...
      onWindowStageDestroy(ability, windowStage) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onWindowStageDestroy abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityDestroy(ability) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onAbilityDestroy abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityForeground(ability) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onAbilityForeground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityBackground(ability) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onAbilityBackground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityContinue(ability) {
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback10 onAbilityContinue abilityname:" + JSON.stringify(abilityname));
    ...
    AppStorage.setOrCreate<common.ApplicationContext>("applicationContext10", this.context.getApplicationContext());
    let lifecycleid = AppStorage.get<common.ApplicationContext>("applicationContext10")!.on("abilityLifecycle", AbilityLifecycleCallback);
    ...
    setTimeout(() => {
      ...
      AppStorage.setOrCreate<string[]>("list10", listKey10);
      AppStorage.setOrCreate<number>("callbackid10", lifecycleid);
    }, 1500);
  }
  ...
  onWindowStageCreate(windowStage: window.WindowStage) {
    ...
    AppStorage.setOrCreate<common.UIAbilityContext>("ability10", this.context);
    windowStage.loadContent("MainAbility/pages/index10", null);
  }
