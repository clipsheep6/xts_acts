  ...
  onCreate() {
    ...
    let AbilityLifecycleCallback = {
      onAbilityCreate(ability) {
        ...
        console.log("[Demo] AbilityLifecycleCallback onAbilityCreate abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityDestroy(ability) {
        ...
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback onAbilityDestroy abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityForeground(ability) {
        ...
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback onAbilityForeground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityBackground(ability) {
        ...
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback onAbilityBackground abilityname:" + JSON.stringify(abilityname));
      ...
      onAbilityContinue(ability) {
        ...
        let abilityname = ability.context.abilityInfo.name;
        console.log("[Demo] AbilityLifecycleCallback onAbilityContinue abilityname:" + JSON.stringify(abilityname));
    ...
    setTimeout(() => {
      ...
      AppStorage.setOrCreate<string[]>("list", listKey);
