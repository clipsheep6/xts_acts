...
export default class MainAbility3 extends Ability {
  onCreate(want: Want, launchParam: AbilityConstant.LaunchParam) {
    ...
    AppStorage.setOrCreate<string[]>("list3", []);
    let AbilityLifecycleCallback = {
      ...
      onWindowStageCreate(ability, windowStage) {
        ...
        AppStorage.get<string[]>("list3")!.push(abilityname + " onWindowStageCreate");
        console.log("[Demo] 1listKey3:" + JSON.stringify(AppStorage.get<string[]>("list3")!));
      },
      onWindowStageActive(ability, windowStage) {
        ...
        AppStorage.get<string[]>("list3")!.push(abilityname + " onWindowStageActive");
        console.log("[Demo] 2listKey3:" + JSON.stringify(AppStorage.get<string[]>("list3")!));
      },
      onWindowStageInactive(ability, windowStage) {
        ...
        AppStorage.get<string[]>("list3")!.push(abilityname + " onWindowStageInactive");
        console.log("[Demo] 3listKey3:" + JSON.stringify(AppStorage.get<string[]>("list3")!));
      },
      onWindowStageDestroy(ability, windowStage) {
        ...
        AppStorage.get<string[]>("list3")!.push(abilityname + " onWindowStageDestroy");
        console.log("[Demo] 4listKey3:" + JSON.stringify(AppStorage.get<string[]>("list3")!));
      },
