...
let event_case2000 = "call_case2000_test";
let subscribeInfo = {
...
export default class MainAbility extends Ability {
  test2200(data) {
    ...
    AppStorage.get<common.UIAbilityContext>("abilityContext")!.startAbilityByCall(want)
      .then((caller) => {
  ...
  subscribeCallBack(err, data) {
    ...
    switch (data.event) {
      case event_case2000:
        AppStorage.get<common.UIAbilityContext>("abilityContext")!.terminateSelf();
        break;
      default:
