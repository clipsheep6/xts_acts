...
export default class MainAbility extends Ability {
  ...
  onForeground() {
    ...
    if (AppStorage.get<Want>("abilityWant")!.action == 'startHapC') {
      globalThis.hapAAbilityContext.startAbility({
        ...
        console.log('ACTS_NewWant MainAbility onForeground - startAbility start HapA: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
