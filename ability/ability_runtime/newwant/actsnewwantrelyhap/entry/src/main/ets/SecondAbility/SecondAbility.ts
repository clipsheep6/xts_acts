...
export default class SecondAbility extends Ability {
  ...
  onForeground() {
    ...
    if (AppStorage.get<Want>("abilityWant")!.action == 'startSingleton0400') {
      globalThis.hapSecondabilityContext.startAbility({
        ...
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility start standard: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startSingleton0300') {
      globalThis.hapSecondabilityContext.startAbility({
        bundleName: "com.example.newwanthap",
        abilityName: "com.example.newwanthapa.MainAbility",
        action: "restartSingleton"
      }, (error, data) => {
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility restart standard: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startHapA0500') {
      globalThis.hapSecondabilityContext.startAbility({
        bundleName: "com.example.newwanthap",
        abilityName: "com.example.newwanthapb.MainAbility",
        action: "restartHapB"
      }, (error, data) => {
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility restart HapB: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startHapA0600') {
      globalThis.hapSecondabilityContext.startAbility({
        bundleName: "com.example.newwanthapa",
        abilityName: "com.example.newwanthapc.MainAbility",
        action: "restartHapC"
      }, (error, data) => {
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility restart HapC: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startSecondAbility0700') {
      globalThis.hapSecondabilityContext.startAbility(
        {
          bundleName: "com.example.newwanthap",
          abilityName: "com.example.newwanthapa.MainAbility",
        ...
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility startMainAbility0700: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      });
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startSecondAbility0800') {
      globalThis.hapSecondabilityContext.startAbility(
        {
        ...
        console.log('ACTS_NewWant SecondAbility onForeground - startAbility startapi70800: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      });
    }
