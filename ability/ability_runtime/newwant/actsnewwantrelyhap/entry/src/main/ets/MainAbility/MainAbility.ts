...
export default class MainAbility extends Ability {
  ...
  onForeground() {
    ...
    if (AppStorage.get<Want>("abilityWant")!.action == 'startStandard0400') {
      globalThis.hapMainAbilityContext.startAbility({
        ...
        console.log('ACTS_NewWant MainAbility onForeground - startAbility restart singleton: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startStandard0300') {
      globalThis.hapMainAbilityContext.startAbility({
        bundleName: "com.example.newwanthap",
        abilityName: "com.example.newwanthapa.SecondAbility",
    ...
    if (AppStorage.get<Want>("abilityWant")!.action == 'startMainAbility0700') {
      globalThis.hapMainAbilityContext.startAbility({
        bundleName: "com.example.newwanthap",
        abilityName: "com.example.newwanthapa.SecondAbility",
        action: "restartSecondAbility0700"
      }, (error, data) => {
        console.log('ACTS_NewWant MainAbility onForeground - startAbility startServiceAbility: ' + JSON.stringify(error) + ", " + JSON.stringify(data));
      })
    }
    if (AppStorage.get<Want>("abilityWant")!.action == 'startMainAbility0800') {
      globalThis.hapMainAbilityContext.startAbility({
        bundleName: "com.example.newwanthap",
        abilityName: "com.example.newwanthapa.SecondAbility",
