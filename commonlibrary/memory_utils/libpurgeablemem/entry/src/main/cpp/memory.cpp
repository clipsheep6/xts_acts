...
{
    OH_PurgeableMemory *res = OH_PurgeableMemory_Create(DATASIZE, FactorialFunc, &pData);
...
{
    OH_PurgeableMemory *res = OH_PurgeableMemory_Create(DATASIZENULL, FactorialFunc, &pData);
    napi_value result = nullptr;
    napi_create_int32(env, res == nullptr, &result);
    OH_PurgeableMemory_Destroy(res);
    return result;
...
static napi_value DestroyOne(napi_env env, napi_callback_info)
{
    ...
    bool Reset = OH_PurgeableMemory_Destroy(res);
    napi_value result = nullptr;
    napi_create_int32(env, Reset, &result);
    return result;
}
...
static napi_value DestroyTwo(napi_env env, napi_callback_info)
{
    ...
    NAPI_ASSERT(env, res != nullptr, "OH_PurgeAbleMemory_Create failed");
    bool Reset = OH_PurgeableMemory_Destroy(res);
    NAPI_ASSERT(env, Reset == true, "OH_PurgeAbleMemory_Destroy failed");
    napi_value result = nullptr;
    if (res == nullptr) {
...
static napi_value BeginReadOne(napi_env env, napi_callback_info)
{
    OH_PurgeableMemory *res = OH_PurgeableMemory_Create(DATASIZE, FactorialFunc, &pData);
    NAPI_ASSERT(env, res != nullptr, "OH_PurgeAbleMemory_Create failed");
    bool Result = OH_PurgeableMemory_BeginRead(res);
    OH_PurgeableMemory_EndRead(res);
    OH_PurgeableMemory_Destroy(res);
    napi_value result = nullptr;
    napi_create_int32(env, Result, &result);
    return result;
}
...
static napi_value BeginWriteOne(napi_env env, napi_callback_info)
{
    OH_PurgeableMemory *res = OH_PurgeableMemory_Create(DATASIZE, FactorialFunc, &pData);
    NAPI_ASSERT(env, res != nullptr, "OH_PurgeAbleMemory_Create failed");
    bool Result = OH_PurgeableMemory_BeginWrite(res);
    napi_value result = nullptr;
    napi_create_int32(env, Result, &result);
    OH_PurgeableMemory_EndRead(res);
    OH_PurgeableMemory_Destroy(res);
...
static napi_value EndWrite(napi_env env, napi_callback_info)
{
    ...
    bool Result = OH_PurgeableMemory_AppendModify(res, AddFunc, &apData);
    OH_PurgeableMemory_Destroy(res);
    napi_value result = nullptr;
    napi_create_int32(env, Result, &result);
    return result;
