...
describe('SystemParameterTest', function () {
        ...
        try {
            ...
            parameterInfo.then(function (value) {
                ...
                if (sysValue === PROPERTY_MAX_VALUE) {
                    console.info('system_parameter_test_0310 promise  setSynchw_sc.build.os.version failed :' + sysValue);
                } else {
    ...
    */
    ...
    it('system_parameter_test_0500', 0, async function (done) {
        ...
        setTimeout('expect(ret).assertTrue()', '100');
    ...
    it('system_parameter_test_0600', 0, async function (done) {
        ...
        setTimeout('expect(ret).assertTrue()', '1000');
     ...
     */
    it('system_parameter_test_0700', 0, async function (done) {
