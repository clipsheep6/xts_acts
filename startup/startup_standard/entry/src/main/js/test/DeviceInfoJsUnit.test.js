...
describe('DeviceInfoTest', function () {
     ...
     * @tc.desc      Get a string representing the device type which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the manufacture which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the external product family name which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
    it('device_info_test_032', 0, function () {
        console.info('device_info_test_0MAX_CHARACTERS_NUM_ONE start');
        let brandInfo = deviceinfo.brand;
        console.info('the value of the deviceinfo brand is :' + brandInfo);
        ...
        expect(len).assertLess(MAX_CHARACTERS_NUM_ONE)
        console.info('device_info_test_0MAX_CHARACTERS_NUM_ONE ：end')
    })

    /**
     * @tc.number    SUB_STARTUP_JS_DEVCEINFO_0360
     * @tc.name      testGetMarketName02
     * @tc.desc      Get a string representing the product series which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the certified model which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the internal software sub-model which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the hardware version which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the device serial number which has a maximum of 65 characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the version number visible to users which has a maximum of 65 characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the operating system full name which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the different build user of the same baseline code which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the different build host of the same baseline code which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
     ...
     * @tc.desc      Get a string representing the version number visible to users which has a maximum of MAX_CHARACTERS_NUM_ONE characters.
     * @tc.size      : MEDIUM
     * @tc.type      : Function
     * @tc.level     : Level 0
     */
