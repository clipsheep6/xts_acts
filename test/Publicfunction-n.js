...
function publicRegisterInputer(PinAuth,AuthSubType,Inputerdata){
    ...
    try {
        ...
        console.info('testFace publicRegisterInputer PinAuth.registerInputer = ' + PinAuth.registerInputer);
        let registerresult = PinAuth.registerInputer({
            onGetData: (AuthSubType, IInputData) => {
                console.info('faceDemo registerInputer AuthSubType = ');
...
function publicunRegisterInputer(PinAuth,callback){
    ...
    try {
        ...
        console.info('testFace publicunRegisterInputer PinAuth.unregisterInputer = ' + PinAuth.unregisterInputer);
        let unRegist = 1;
...
function publicOpenSession(UserIDM,callback){
    ...
    try {
        ...
        console.info('testFace faceDemo UserIDM.openSession = ' + UserIDM.openSession);
        let challenge = null
...
function publicCloseSession(UserIDM,callback){
    ...
    try {
        ...
        console.info('testFace publicCloseSession UserIDM.closeSession = ' + UserIDM.closeSession);
        let closesession = 0;
...
async function publicaddCredential(UserIDM,CredentialInfo,callback1,callback2){
    ...
    try {
        ...
        console.info('faceTest publicaddCredential UserIDM. addCredential= ' + UserIDM.addCredential);
...
function publicupdateCred(UserIDM,CredentialInfo,callback1,callback2){
    ...
    try {
        ...
        console.info('testFace publicupdateCred UserIDM.updateCredential = ' + UserIDM.updateCredential);
        let onresult = {
        ...
        UserIDM.updateCredential(CredentialInfo, {
            ...
            onAcquireInfo:function (modulea,acquire,extr){
                ...
                console.info('testFace publicupdateCred updateCredential onacquireinfo = ' + JSON.stringify(onacquireinfo));
...
function publiccancel(UserIDM,challenge){
    ...
    try {
        ...
        console.info('testFace publiccancel UserIDM.cancel = ' + UserIDM.cancel);
...
function publicdelUser(UserIDM,token,callback1,callback2){
    ...
    try {
        ...
        console.info('testFace publicdelUser UserIDM.delUser = ' + UserIDM.delUser);
        let onresult = {
            delUserresult: null,
            CredentialId: null,
        }
        ...
        UserIDM.delUser(token, {
            ...
            onAcquireInfo:function (modulea,acquire,extr){
                ...
                console.log("testFace faceDemo delUser module = " + modulea);
...
function publicdelCred(UserIDM,credentialId,token,callback1,callback2){
    ...
    try {
        ...
        console.info('testFace publicdelCred UserIDM.delCred = ' + UserIDM.delCred);
        let onresult = {
            delCredresult: null,
            CredentialId: null,
        }
...
function publicgetAuthInfo(UserIDM,authType,callback){
    ...
    try {
        ...
        console.info('testFace publicgetAuthInfo UserIDM.getAuthInfo = ' + UserIDM.getAuthInfo);
        UserIDM.getAuthInfo(authType, function (AsyncCallback) {
            console.log("testFace faceDemo getAuthInfo AsyncCallback = " + AsyncCallback)
...
function publicgetallAuthInfo(UserIDM,callback){
    ...
    try {
        ...
        console.info('testFace publicgetallAuthInfo UserIDM.getAuthInfo = ' + UserIDM.getAuthInfo);
...
function publicgetAvailabeStatus(UserAuth,authType,authTrustLevel){
    ...
    try {
        ...
        console.info('testFace publicgetAvailabeStatus UserAuth.getAvailabeStatus = ' + UserAuth.getAvailabeStatus);
        let AvailabeStatus = null
        AvailabeStatus = UserAuth.getAvailabeStatus(authType, authTrustLevel);
        console.info('testFace publicgetAvailabeStatus result = ' + AvailabeStatus);
...
function publicgetProperty(UserAuth,GetPropertyRequest,callback){
    ...
    try {
        ...
        console.info('testFace publicgetProperty UserAuth.getProperty = ' + UserAuth.getProperty);
...
function publicsetProperty(UserAuth,SetPropertyRequest,callback){
    ...
    try {
        ...
        console.info('testFace publicsetProperty UserAuth.setProperty = ' + UserAuth.setProperty);
...
function publicauth(UserAuth,challenge,authType,authTrustLevel,callback1,callback2){
    ...
    try {
        ...
        console.info('testFace publicauth UserAuth.auth = ' + UserAuth.auth);
        let onresult = {
            authresult: null,
            authextr: null,
        }
        ...
        contextID1 = UserAuth.auth(challenge, authType,authTrustLevel,{
            ...
            onAcquireInfo:function (modulea,acquire,extr){
                ...
                console.log("testFace faceDemo auth module = " + modulea);
...
function publicauthUser(UserAuth,userID,challenge,authType,authTrustLevel,callback1,callback2){
    ...
    try {
        ...
        console.info('testFace publicauthUser UserAuth.authUser = ' + UserAuth.authUser);
        let onresult = {
            authresult: null,
            authextr: null,
        }
...
function publicgecancelAuth(UserAuth,contextID){
    ...
    try {
        ...
        console.info('testFace publicgecancelAuth UserAuth.cancelAuth = ' + UserAuth.cancelAuth);
