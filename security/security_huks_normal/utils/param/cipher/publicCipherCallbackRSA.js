...
async function publicUpdateFunc(HuksOptions) {
  ...
  console.log(
    `test update HuksOptions inData:${Array.from(inDataArray).length}`
  );
...
async function publicFinishAbortFunc(
  ...
  console.log(`test publicFinishAbortFunc satrt`);
...
async function finish(HuksOptions, isEncrypt) {
  console.log(`test finishCallback satrt`);
