...
private:
    void HuksThreeStageInit() const;
    void HuksThreeStageUpdate() const;
    void HuksThreeStageFinish() const;
    void HuksThreeStageAbort() const;

    const std::function<void()> fuzzApiList_[static_cast<uint32_t>(HuksThreeStageApi::HUKS_API_MAX)] = {
        std::bind(&HuksThreeStageFuzzTest::HuksThreeStageInit, this),
        std::bind(&HuksThreeStageFuzzTest::HuksThreeStageUpdate, this),
        std::bind(&HuksThreeStageFuzzTest::HuksThreeStageFinish, this),
        std::bind(&HuksThreeStageFuzzTest::HuksThreeStageAbort, this),
    };
};
...
void HuksThreeStageFuzzTest::HuksFuzzInit() const
{
    ...
    HksInit(keyAlias, paramSetIn, handle);
...
void HuksThreeStageFuzzTest::HuksFuzzUpdate() const
{
    ...
    HksUpdate(handle, paramSetIn, inData, outData);
...
void HuksThreeStageFuzzTest::HuksFuzzFinish() const
{
    ...
    HksFinish(handle, paramSetIn, inData, outData);
