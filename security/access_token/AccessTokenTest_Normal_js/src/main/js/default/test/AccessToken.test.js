...
describe('AccessTokenTest', function () {
     ...
     * @tc.desc Test atManager.verifyAccessTokenSync, After the installation, user_grant permission is not granted by default.
     */
     ...
     * @tc.desc Test atManager.verifyAccessTokenSync, After the installation, system_grant permission is granted by default.
     */
     ...
     * @tc.desc Test atManager.verifyAccessTokenSync, invalid TokenID(0).
     */
     ...
     * @tc.desc Test atManager.verifyAccessTokenSync, invalid permission(empty).
     */
     ...
     * @tc.desc Test atManager.verifyAccessTokenSync, invalid permission(length exceeds 256).
     */
