...
parentPort.onmessage = function (data) {
  ...
  switch (caseId) {
    case 'Hks_Concurrency_Test_00100':
      hksConcurrencyTest001 ();
      break;
    case 'Hks_Concurrency_Test_00200':
      hksConcurrencyTest002 (0);
      break;
    case 'Hks_Concurrency_Test_00300':
      hksConcurrencyTest003 ();
      break;
    case 'Hks_Concurrency_Test_00400':
      hksConcurrencyTest004 (0);
      break;
    case 'Hks_Concurrency_Test_00500':
      hksConcurrencyTest005 ();
      break;
    case 'Hks_Concurrency_Test_00600':
      hksConcurrencyTest006 (0);
      break;
    case 'Hks_Concurrency_Test_00700':
      hksConcurrencyTest007 ();
      break;
    case 'Hks_Concurrency_Test_00800':
      hksConcurrencyTest008 ();
      break;
    case 'Hks_Concurrency_Test_00900':
      hksConcurrencyTest009 ();
      break;
    case 'Hks_Concurrency_Test_01000':
      hksConcurrencyTest010 ();
      break;
    case 'Hks_Concurrency_Test_01100':
      hksConcurrencyTest011 (0);
      break;
    case 'Hks_Concurrency_Test_01200':
      hksConcurrencyTest012 ();
      break;
    case 'Hks_Concurrency_Test_01300':
      hksConcurrencyTest013 (0);
      break;
    case 'Hks_Concurrency_Test_01400':
      hksConcurrencyTest014 ();
      break;
    case 'Hks_Concurrency_Test_01500':
      hksConcurrencyTest015 (0);
      break;
    case 'Hks_Concurrency_Test_01600':
      hksConcurrencyTest016 ();
      break;
    case 'Hks_Concurrency_Test_01700':
      hksConcurrencyTest017 (0);
      break;
    case 'Hks_Concurrency_Test_01800':
      hksConcurrencyTest018 ();
      break;
    case 'Hks_Concurrency_Test_01900':
      hksConcurrencyTest019 (0);
      break;
    case 'Hks_Concurrency_Test_02000':
      hksConcurrencyTest020 ();
      break;
    case 'Hks_Concurrency_Test_02100':
...
async function hksConcurrencyTest001 () {
  ...
  console.log ('hksConcurrencyTest001 fail detail ######' + successStr);
...
async function hksConcurrencyTest003 () {
  ...
  console.log ('hksConcurrencyTest003 fail detail ######' + successStr);
  parentPort.postMessage (successStr);
};
...
function agreeKeyCallback (index, option, key) {
  hks.agreeKey (aliasB, option, function (err, data) {
    if (data.errorCode == hks.HksErrorCode.HKS_SUCCESS && JSON.stringify (key.outData) == JSON.stringify (data.outData)) {
      if (index < loop) {
        index ++;
