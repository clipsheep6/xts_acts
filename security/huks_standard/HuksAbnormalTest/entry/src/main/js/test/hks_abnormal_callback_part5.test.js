...
describe('Hks_Abnormal_Callback_Part5', function () {
  ...
  it('HUKS_ABNORMAL_CALLBACK_40100', 0, async function (done) {
    await hmacGenerateKey();
    var macOption = hmacInvalidPurposeOption(hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_SIGN, hks.HuksKeyDigest.HUKS_DIGEST_SHA1);
    hks.mac(alias, macOption, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_40400', 0, async function (done) {
    await hmacGenerateKey();
    var macOption = hmacInvalidPurposeOption(hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_WRAP, hks.HuksKeyDigest.HUKS_DIGEST_SHA1);
    hks.mac(alias, macOption, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_40600', 0, async function (done) {
    await hmacGenerateKey();
    var macOption = hmacInvalidPurposeOption(hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_AGREE, hks.HuksKeyDigest.HUKS_DIGEST_SHA1);
    hks.mac(alias, macOption, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_40700', 0, async function (done) {
    await hmacGenerateKey();
    var macOption = hmacInvalidPurposeOption(hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_MAC, hks.HuksKeyDigest.HUKS_DIGEST_NONE);
    hks.mac(alias, macOption, function (err, data) {
  ...
  it('HUKS_ABNORMAL_CALLBACK_40800', 0, async function (done) {
    await hmacGenerateKey();
    var macOption = hmacInvalidPurposeOption(hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_MAC, hks.HuksKeyDigest.HUKS_DIGEST_MD5);
    hks.mac(alias, macOption, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_DIGEST);
      done();
    });
