...
describe('Hks_Abnormal_Callback_Part2', function () {
  ...
  */
  ...
  it('HUKS_ABNORMAL_CALLBACK_12500', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CBC, hks.HuksKeyPadding.HUKS_PADDING_OAEP);
    hks.generateKey(alias, option, function (err, data) {
  ...
  it('HUKS_ABNORMAL_CALLBACK_12800', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CBC, hks.HuksKeyPadding.HUKS_PADDING_PKCS5);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_12900', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CTR, hks.HuksKeyPadding.HUKS_PADDING_OAEP);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_13200', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CTR, hks.HuksKeyPadding.HUKS_PADDING_PKCS5);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_13300', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CTR, hks.HuksKeyPadding.HUKS_PADDING_PKCS7);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_13400', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_ECB, hks.HuksKeyPadding.HUKS_PADDING_OAEP);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_13700', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_ECB, hks.HuksKeyPadding.HUKS_PADDING_PKCS5);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_13800', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_GCM, hks.HuksKeyPadding.HUKS_PADDING_OAEP);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_14200', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_GCM, hks.HuksKeyPadding.HUKS_PADDING_PKCS7);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_14300', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CCM, hks.HuksKeyPadding.HUKS_PADDING_OAEP);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_14600', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CCM, hks.HuksKeyPadding.HUKS_PADDING_PKCS5);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_14700', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_CCM, hks.HuksKeyPadding.HUKS_PADDING_PKCS7);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PADDING);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_14800', 0, async function (done) {
    var option = aesGenerateKeyInvalidModeOption(hks.HuksCipherMode.HUKS_MODE_OFB, hks.HuksKeyPadding.HUKS_PADDING_NONE);
    hks.generateKey(alias, option, function (err, data) {
  ...
  it('HUKS_ABNORMAL_CALLBACK_14900', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_RSA, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
  ...
  it('HUKS_ABNORMAL_CALLBACK_15000', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_ECC, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_15100', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_DSA, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_15200', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_HKDF, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
  ...
  it('HUKS_ABNORMAL_CALLBACK_15300', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_PBKDF2, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_ALGORITHM);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_15400', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_ECDH, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_15500', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_X25519, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_DERIVE);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_16200', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_PBKDF2, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_MAC);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_ALGORITHM);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_16400', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_X25519, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_MAC);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
  ...
  it('HUKS_ABNORMAL_CALLBACK_16500', 0, async function (done) {
    var option = aesGenerateKeyInvalidAlgOption(hks.HuksKeyAlg.HUKS_ALG_ED25519, hks.HuksKeyPurpose.HUKS_KEY_PURPOSE_MAC);
    hks.generateKey(alias, option, function (err, data) {
      expect(data.errorCode).assertEqual(hks.HuksErrorCode.HUKS_ERROR_INVALID_PURPOSE);
      done();
    });
