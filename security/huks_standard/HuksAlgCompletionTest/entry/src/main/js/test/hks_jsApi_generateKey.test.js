...
describe('HuksTest_JSApiTest_GenerateKey', function () {
  ...
  var aes192Option = makeGenerateAESKeyOptions(huks.HksKeySize.HKS_AES_KEY_SIZE_192);
  var aes256Option = makeGenerateAESKeyOptions(huks.HksKeySize.HKS_AES_KEY_SIZE_256);
  var rsa512Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_512);
  var rsa768Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_768);
  var rsa1024Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_1024);
  var rsa2048Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_2048);
  var rsa3072Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_3072);
  var rsa4096Option = makeGenerateRSAKeyOptions(huks.HksKeySize.HKS_RSA_KEY_SIZE_4096);
  var ecc224Option = makeGenerateECCKeyOptions(huks.HksKeySize.HKS_ECC_KEY_SIZE_224);
  var ecc256Option = makeGenerateECCKeyOptions(huks.HksKeySize.HKS_ECC_KEY_SIZE_256);
  var ecc384Option = makeGenerateECCKeyOptions(huks.HksKeySize.HKS_ECC_KEY_SIZE_384);
  var ecc521Option = makeGenerateECCKeyOptions(huks.HksKeySize.HKS_ECC_KEY_SIZE_521);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_00100', 0, async function (done) {
    ...
    expect(aes192Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var aes256Result = await huks.generateKey(defaultAlias, aes256Option);
    expect(aes256Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_00500', 0, async function (done) {
    ...
    expect(rsa768Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var rsa1024Result = await huks.generateKey(defaultAlias, rsa1024Option);
    expect(rsa1024Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var rsa2048Result = await huks.generateKey(defaultAlias, rsa2048Option);
    expect(rsa2048Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var rsa3072Result = await huks.generateKey(defaultAlias, rsa3072Option);
    expect(rsa3072Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var rsa4096Result = await huks.generateKey(defaultAlias, rsa4096Option);
    expect(rsa4096Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_01200', 0, async function (done) {
    ...
    expect(ecc256Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var ecc384Result = await huks.generateKey(defaultAlias, ecc384Option);
    expect(ecc384Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var ecc521Result = await huks.generateKey(defaultAlias, ecc521Option);
    expect(ecc521Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_01700', 0, async function (done) {
    ...
    var hmacSHA224Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 224);
    var hmacSHA256Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 256);
    var hmacSHA384Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 384);
    var hmacSHA512Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 512);
    ...
    expect(hmacSHA224Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var hmacSHA256Result = await huks.generateKey(defaultAlias, hmacSHA256Option);
    expect(hmacSHA256Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var hmacSHA384Result = await huks.generateKey(defaultAlias, hmacSHA384Option);
    expect(hmacSHA384Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
    var hmacSHA512Result = await huks.generateKey(defaultAlias, hmacSHA512Option);
    expect(hmacSHA512Result.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_02500', 0, async function (done) {
    ...
    expect(result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ALGORITHM);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_02600', 0, async function (done) {
    ...
    var result = await huks.generateKey(defaultAlias, option);
    expect(result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_KEY_SIZE);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_02700', 0, async function (done) {
    ...
    var result = await huks.generateKey(defaultAlias, option);
    expect(result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_PURPOSE);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_02800', 0, async function (done) {
    ...
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_PADDING);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03300', 0, async function (done) {
    ...
    var hmacSHA1OptionSize8 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 8);
    var hmacSHA1ResultSize8 = await huks.generateKey(defaultAlias, hmacSHA1OptionSize8);
    expect(hmacSHA1ResultSize8.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA1OptionSize1024 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 1024);
    var hmacSHA1ResultSize1024 = await huks.generateKey(defaultAlias, hmacSHA1OptionSize1024);
    expect(hmacSHA1ResultSize1024.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA224OptionSize8 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 8);
    var hmacSHA224ResultSize8 = await huks.generateKey(defaultAlias, hmacSHA224OptionSize8);
    expect(hmacSHA224ResultSize8.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA224OptionSize1024 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 1024);
    var hmacSHA224ResultSize1024 = await huks.generateKey(defaultAlias, hmacSHA224OptionSize1024);
    expect(hmacSHA224ResultSize1024.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA256OptionSize8 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 8);
    var hmacSHA256ResultSize8 = await huks.generateKey(defaultAlias, hmacSHA256OptionSize8);
    expect(hmacSHA256ResultSize8.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA256OptionSize1024 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 1024);
    var hmacSHA256ResultSize1024 = await huks.generateKey(defaultAlias, hmacSHA256OptionSize1024);
    expect(hmacSHA256ResultSize1024.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA384OptionSize8 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 8);
    var hmacSHA384ResultSize8 = await huks.generateKey(defaultAlias, hmacSHA384OptionSize8);
    expect(hmacSHA384ResultSize8.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA384OptionSize1024 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 1024);
    var hmacSHA384ResultSize1024 = await huks.generateKey(defaultAlias, hmacSHA384OptionSize1024);
    expect(hmacSHA384ResultSize1024.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA512OptionSize8 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 8);
    var hmacSHA512ResultSize8 = await huks.generateKey(defaultAlias, hmacSHA512OptionSize8);
    expect(hmacSHA512ResultSize8.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);

    var hmacSHA512OptionSize1024 = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 1024);
    var hmacSHA512ResultSize1024 = await huks.generateKey(defaultAlias, hmacSHA512OptionSize1024);
    expect(hmacSHA512ResultSize1024.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03400', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 8);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03500', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 1024);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03600', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 8);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03700', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 1024);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03800', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 8);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_03900', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 1024);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
      console.log('HUKS_JSAPI_GenerateKey_Test_03600 end');
      deleteKeyFun(defaultAlias, done);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04000', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 8);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04100', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 1024);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04200', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 8);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04300', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 1024);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_SUCCESS);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04400', 0, async function (done) {
    ...
    var hmacSHA1Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 7);
    var hmacSHA1Result = await huks.generateKey(defaultAlias, hmacSHA1Option);
    expect(hmacSHA1Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    hmacSHA1Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 1025);
    hmacSHA1Result = await huks.generateKey(defaultAlias, hmacSHA1Option);
    expect(hmacSHA1Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    var hmacSHA224Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 7);
    var hmacSHA224Result = await huks.generateKey(defaultAlias, hmacSHA224Option);
    expect(hmacSHA224Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    hmacSHA224Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 1025);
    hmacSHA224Result = await huks.generateKey(defaultAlias, hmacSHA224Option);
    expect(hmacSHA224Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    var hmacSHA256Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 7);
    var hmacSHA256Result = await huks.generateKey(defaultAlias, hmacSHA256Option);
    expect(hmacSHA256Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    hmacSHA256Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 1025);
    hmacSHA256Result = await huks.generateKey(defaultAlias, hmacSHA256Option);
    expect(hmacSHA256Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    var hmacSHA384Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 7);
    var hmacSHA384Result = await huks.generateKey(defaultAlias, hmacSHA384Option);
    expect(hmacSHA384Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    hmacSHA384Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 1025);
    hmacSHA384Result = await huks.generateKey(defaultAlias, hmacSHA384Option);
    expect(hmacSHA384Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    var hmacSHA512Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 7);
    var hmacSHA512Result = await huks.generateKey(defaultAlias, hmacSHA512Option);
    expect(hmacSHA512Result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);

    hmacSHA512Option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 1025);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04500', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 7);
    huks.generateKey(defaultAlias, option, function (err, data) {
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04600', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA1, 1025);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04700', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 7);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04800', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA224, 1025);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_04900', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 7);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05000', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA256, 1025);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05100', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 7);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05200', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA384, 1025);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05300', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 7);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05400', 0, async function (done) {
    ...
    var option = makeGenerateMACKeyOptions(huks.HksKeyDigest.HKS_DIGEST_SHA512, 1025);
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_ARGUMENT);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05500', 0, async function (done) {
    ...
    var result = await huks.generateKey(defaultAlias, option);
    expect(result.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_MODE);
  ...
  it('HUKS_JSAPI_GenerateKey_Test_05600', 0, async function (done) {
    ...
    huks.generateKey(defaultAlias, option, function (err, data) {
      expect(data.errorCode).assertEqual(huks.HksErrorCode.HKS_ERROR_INVALID_MODE);
