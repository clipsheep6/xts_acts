...
require('./hks_xtsTest_algCompletion_aes_encryptAndDecrypt.test.js');

require('./hks_xtsTest_algCompletion_rsa_encryptAndDecrypt.test.js');

require('./hks_xtsTest_algCompletion_signAndVerify.test.js');
