...
describe('HuksTest_JSApiTest_DeriveKey', function () {
  ...
  it('HuksTest_JSApiTest_getKeyProperties_00100', 0, async function (done) {
    ...
    expect(getKeyPropertiesRet.properties[2].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_ENCRYPT | huks.HksKeyPurpose.HKS_KEY_PURPOSE_DECRYPT);
  ...
  it('HuksTest_JSApiTest_getKeyProperties_00200', 0, async function (done) {
    ...
    huks.getKeyProperties(defaultAlias, emptyOption, function (err, data) {
      ...
      expect(data.properties[2].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_ENCRYPT | huks.HksKeyPurpose.HKS_KEY_PURPOSE_DECRYPT);
  ...
  it('HuksTest_JSApiTest_getKeyProperties_00500', 0, async function (done) {
    ...
    expect(getKeyPropertiesRet.properties[2].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_SIGN | huks.HksKeyPurpose.HKS_KEY_PURPOSE_VERIFY);
  ...
  it('HuksTest_JSApiTest_getKeyProperties_00600', 0, async function (done) {
    ...
    huks.getKeyProperties(defaultAlias, emptyOption, function (err, data) {
      ...
      expect(data.properties[2].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_SIGN | huks.HksKeyPurpose.HKS_KEY_PURPOSE_VERIFY);
  ...
  it('HuksTest_JSApiTest_getKeyProperties_00900', 0, async function (done) {
    ...
    if (useLib == 'mbedtls') {
      ...
      expect(getKeyPropertiesRet.properties[1].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_SIGN | huks.HksKeyPurpose.HKS_KEY_PURPOSE_VERIFY);
  ...
  it('HuksTest_JSApiTest_getKeyProperties_01000', 0, async function (done) {
    ...
    if (useLib == 'mbedtls') {
      ...
      huks.getKeyProperties(defaultAlias, emptyOption, function (err, data) {
        ...
        expect(data.properties[1].value).assertEqual(huks.HksKeyPurpose.HKS_KEY_PURPOSE_SIGN | huks.HksKeyPurpose.HKS_KEY_PURPOSE_VERIFY);
