...
describe('SecurityHuksCipherRSACallbackJsunit', function () {
	if (Control.isOpenSSL) {
		it(
			'testCipherRSASize512PADDINGNONESHA256001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize512PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize512PADDINGNONESHA256002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize512PADDINGNONESHA256KeyAlias002'
				const newSrcKeyAlies =
					'testCipherRSASize512PADDINGNONESHA256NewKeyAlias001'
				let HuksOptions = {
					properties: new Array(
		...
		it(
			'testCipherRSASize512PADDINGNONESHA256003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize512PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize512PADDINGNONESHA256004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize512PADDINGNONESHA256KeyAlias002'
	...
	it('testCipherRSASize512PADDINGOAEPSHA1001', 0, async function (done) {
		...
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA1NewKeyAlias001'
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher002.HuksKeyRSABLOCKMODEECB
		...
		genHuksOptions.properties.splice(
			4,
			1,
			HuksCipher002.HuksKeyRSAPADDINGOAEP
		)
		genHuksOptions.properties.splice(
			5,
			1,
	...
	it('testCipherRSASize512PADDINGOAEPSHA256002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA256KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA256NewKeyAlias001'
		let HuksOptions = {
	...
	it('testCipherRSASize512PADDINGOAEPSHA256004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA256KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA256NewKeyAlias001'
		let HuksOptions = {
	...
	it('testCipherRSASize512PADDINGOAEPSHA384002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize512PADDINGOAEPSHA384004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
	...
	it('testCipherRSASize512PADDINGOAEPSHA512002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize512PADDINGOAEPSHA512004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize512PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize512PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
