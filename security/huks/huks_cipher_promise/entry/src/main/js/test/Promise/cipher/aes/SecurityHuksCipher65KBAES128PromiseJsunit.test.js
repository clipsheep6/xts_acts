...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
	...
	it('testCipherAESSize128PADDINGNONEMODECTR001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(3, 1, HuksCipher001.HuksKeyAESSize128)
		genHuksOptions.properties.splice(
			4,
			1,
	...
	if (Control.isOpenSSL) {
		it(
			'testCipherAESSize128PADDINGPKCS7MODEECB001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias001'
				genHuksOptions.properties.splice(
					2,
					1,
					HuksCipher001.HuksKeyAESSize128
		...
		it(
			'testCipherAESSize128PADDINGPKCS7MODEECB002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias002'
				let HuksOptions = {
					properties: new Array(
						HuksCipher001.HuksKeyAlgAES,
						HuksCipher001.HuksKeyPurposeENCRYPT,
		...
		it(
			'testCipherAESSize128PADDINGPKCS7MODEECB003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias001'
		...
		it(
			'testCipherAESSize128PADDINGPKCS7MODEECB004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize128PADDINGPKCS7MODEECBKeyAlias002'
