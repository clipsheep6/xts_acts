...
export default function AsyGetKeySpecBySpecJsunit() {
    describe("AsyGetKeySpecBySpecJsunit", function () {
        ...
        it("Security_CryptoFramework_AsyKeySpec_Func_0200", 0, async function (done) {
            ...
            await asyKeyPairSpec.generateKeyPair().then((keyPair) => {
        ...
        it("Security_CryptoFramework_AsyKeySpec_Func_0400", 0, async function (done) {
            let rsaKeyPairSpec = genRsa2048KeyPairSpec();
            let asyKeyPairSpec = cryptoFramework.createAsyKeyGeneratorBySpec(rsaKeyPairSpec);
            await asyKeyPairSpec.generateKeyPair().then((keyPair) => {
        ...
        it("Security_CryptoFramework_AsyKeySpec_Func_0600", 0, async function (done) {
            ...
            let eccKeyPairSpec = genEccKeyTypeSpec(cryptoFramework.AsyKeySpecType.KEY_PAIR_SPEC);
            let asyKeyPairSpec = cryptoFramework.createAsyKeyGeneratorBySpec(eccKeyPairSpec);
            await asyKeyPairSpec.generateKeyPair().then((keyPair) => {
        ...
        it("Security_CryptoFramework_AsyKeySpec_Func_0900", 0, async function (done) {
            let dsaKeyGeneratorSpec = cryptoFramework.createAsyKeyGenerator("DSA1024");
            var dsaKeyPair;
