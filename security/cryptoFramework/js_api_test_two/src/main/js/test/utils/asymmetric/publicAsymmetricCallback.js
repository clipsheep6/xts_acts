...
async function encryptAndDecryptBySpecProcess(asyKeySpec, cipherAlgoName, state) {
  ...
  return new Promise((resolve, reject) => {
    let rsaGenerator = createAsyKeyGeneratorBySpec(asyKeySpec);
    console.info("encryptAndDecryptBySpecProcess 111");
    expect(rsaGenerator != null).assertTrue();
    console.info("encryptAndDecryptBySpecProcess 222");
    let cipherGeneratorEncrypt = createAsyCipher(cipherAlgoName);
    console.info("encryptAndDecryptBySpecProcess 333");
    expect(cipherGeneratorEncrypt != null).assertTrue();
    ...
    let keyPairPromise = rsaGenerator.generateKeyPair(); // 使用生成器创建ECC密钥对
    keyPairPromise.then((keyPair) => {
      ...
      .then((initData) => {
        console.info("encryptAndDecryptBySpecProcess 444");
        expect(initData === "init success").assertTrue();
...
async function signAndVerifyBySpecProcess(asyKeySpec, signVerifyAlgoName, verifyType, dataType) {
  ...
  return new Promise((resolve, reject) => {
    ...
    console.info("[callback] signAndVerifyBySpecProcess 111");
    let signGenerator = createAsySign(signVerifyAlgoName);
    expect(signGenerator != null).assertTrue();
    console.info("[callback] signAndVerifyBySpecProcess 222");
    let verifyGenerator;
    if (verifyType) {
...
async function keyGenerationBySpecProcess(asyAlgoName) {
  ...
  return new Promise((resolve, reject) => {
    ...
    generateAsyKeyPair(rsaGenerator)
      ...
      .then((convertKeyPair) => {
        expect(convertKeyPair != null).assertTrue();
        console.info("[Callback]: convertKeyEncryptAndDecryptBySpecProcess 11");
        ...
        console.info("[Callback]: convertKeyEncryptAndDecryptBySpecProcess 111");
        generatorBySpec = createAsyKeyGeneratorBySpec(commKeySpec);
        console.info("[Callback]: convertKeyEncryptAndDecryptBySpecProcess 1111");
