...
export default function SecuritySignatureVerificationJsunit() {
    describe("SecuritySignatureVerificationJsunit", function () {
        console.log("##########start SecuritySignatureVerificationJsunit##########");
        beforeAll(function () {
        });
        afterEach(function () {
        });
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0100", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA512|PKCS1|MD5").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0200", 0, async function (done) {
            await asyPromise.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA768|PSS|SHA1|MGF1_SHA1", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifySetAndGetSpecProcess catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0300", 0, async function (done) {
            await asyCallback.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA1024|PSS|SHA224|MGF1_SHA224", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
                32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifySetAndGetSpecProcess catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0400", 0, async function (done) {
            await asyPromise.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA2048|PSS|SHA256|MGF1_SHA256", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
                32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifySetAndGetSpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0500", 0, async function (done) {
            await asyCallback.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA3072|PSS|SHA384|MGF1_SHA384", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
                32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifySetAndGetSpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0600", 0, async function (done) {
            await asyPromise.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA4096|PSS|SHA512|MGF1_SHA512", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
                32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifySetAndGetSpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0700", 0, async function (done) {
            await asyCallback.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA8192|PSS|SHA512|MGF1_SHA512", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
                32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifySetAndGetSpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0800", 0, async function (done) {
            await asyPromise.signAndVerifyBySpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA|PKCS1|MD5").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_0900", 0, async function (done) {
            await asyCallback.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA|PSS|SHA256|MGF1_SHA256", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 32).then((result) => {
                expect(result).assertTrue();
            })
                .catch((err) => {
                    console.error("AsyCallback signAndVerifySetAndGetSpecProcess catch error: " + err);
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_1000", 0, async function (done) {
            await asyPromise.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA|PSS|SHA384|MGF1_SHA384", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 32).then((result) => {
                expect(result).assertTrue();
            }).catch((err) => {
                    console.error("AsyPromise signAndVerifySetAndGetSpecProcess catch error: " + err);
                    expect(null).assertFail();
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_1100", 0, async function (done) {
            await asyCallback.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA|PSS|SHA512|MGF1_SHA512", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("asyCallback signAndVerifySetAndGetSpecProcess catch error: " + err);
                    expect(null).assertFail();
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_1200", 0, async function (done) {
            await asyPromise.signAndVerifySetAndGetSpecProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA|PSS|SHA224|MGF1_SHA224", cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 32).then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifySetAndGetSpecProcess catch error: " + err);
                    expect(null).assertFail();
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_1300", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genEccCommonSpec(),
                "ECC256|SHA256").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
        ...
        it("Security_CryptoFramework_SignatureVerification_Func_1400", 0, async function (done) {
            await asyPromise.signAndVerifyBySpecProcess(asyCommon.genEccCommonSpec(), "ECC|SHA224").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a promise style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_1600", 0, async function (done) {
            await asyPromise.signAndVerifyBySpecProcess(asyCommon.genEccCommonSpec(), "ECC384|SHA224")
                .then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyBySpecProcess catch error: " + err);
         ...
         * and use a callback style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_1700", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genEccCommonSpec(), "ECC521|SHA256")
                .then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
         ...
         * and use a promise style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_1800", 0, async function (done) {
            await asyPromise.signAndVerifyBySpecProcess(asyCommon.genDsa2048CommonSpecBigE(),
                "DSA|SHA1").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a callback style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_1900", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genDsa2048CommonSpecBigE(),
                "DSA|SHA224").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a callback style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2000", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genDsa2048CommonSpecBigE(),
                "DSA1024|SHA224").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a promise style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2100", 0, async function (done) {
            await asyPromise.signAndVerifyBySpecProcess(asyCommon.genDsa2048CommonSpecBigE(),
                "DSA2048|SHA256").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a callback style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2200", 0, async function (done) {
            await asyCallback.signAndVerifyBySpecProcess(asyCommon.genDsa2048CommonSpecBigE(),
                "DSA3072|SHA384").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyCallback signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
         ...
         * and use a promise style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2300", 0, async function (done) {
            await asyPromise.signAndVerifyNormalProcess("DSA1024", "DSA1024|SHA1").then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("AyPromise signAndVerifyBySpecProcess catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         * and use a callback style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2400", 0, async function (done) {
            await asyCallback.signAndVerifyNormalProcess("DSA2048", "DSA2048|SHA256").then((result) => {
         ...
         * and use a promise style interface
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2500", 0, async function (done) {
            await asyPromise.signAndVerifyNormalProcess("DSA3072", "DSA3072|SHA384").then((result) => {
                    expect(result).assertTrue();
                }).catch((err) => {
                    console.error("AsyPromise signAndVerifyNormalProcess catch error: " + err);
         ...
         * @tc.desc Pass in two exception parameters "RSA1024|PKCS1|MD5" and "RSA1024|PKCS1|SHA512"
         * and call them as synchronously
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2600", 0, async function (done) {
            try {
                cryptoFramework.createSign("RSA10000|PKCS1|SHA224");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_2600 1 err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_2600 2 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                cryptoFramework.createSign("RSA1024PKCS1MD5RSA1024PKCS1MD5RSA1024PKCS1MD5");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_2600 3 err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_2600 4 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                cryptoFramework.createSign("RSA1024|PKCS1|MD5", "RSA1024|PKCS1|SHA512");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_2600 5 err" + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
         ...
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2700", 0, async function (done) {
            let specGenerator = cryptoFramework.createAsyKeyGeneratorBySpec(asyCommon.genRsa2048KeyPairSpec());
            ...
            let dsaGenerator = cryptoFramework.createAsyKeyGeneratorBySpec(asyCommon.genDsa2048KeyPairSpecBigE());
            let dsaKeyPair;
            await new Promise((resolve, reject) => {
         ...
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2800", 0, async function (done) {
            await asyPromise.updateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 0).then((data) => {
            ...
            await asyPromise.updateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 1).then((data) => {
            ...
            await asyPromise.updateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 2).then((data) => {
            ...
            await asyPromise.updateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 3).then((data) => {
            ...
            await asyPromise.updateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 4).then((data) => {
         ...
         */
        it("Security_CryptoFramework_SignatureVerification_Func_2900", 0, async function (done) {
            await asyCallback.signAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 0).then((data) => {
                console.log("data 1 : " + data);
                expect(null).assertFail();
                }).catch((err) => {
                    console.error("AsyCallback signAbnormalParameterProcess 1 catch error: " + err);
                    expect(err.code == 401).assertTrue();
                });
            ...
            await asyCallback.signAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                ...
                expect(data != null).assertTrue();
                    ...
                    console.error("AsyCallback signAbnormalParameterProcess 2 catch error: " + err);
            ...
            await asyCallback.signAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                ...
                expect(null).assertFail();
                    ...
                    console.error("AsyCallback signAbnormalParameterProcess 3 catch error: " + err);
                    expect(err.code == 401).assertTrue();
                });
            ...
            await asyCallback.signAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                ...
                expect(null).assertFail();
                    ...
                    console.error("AsyCallback signAbnormalParameterProcess 4 catch error: " + err);
                    expect(err.code == 401).assertTrue();
                });
            done();
        });
         ...
         * @tc.desc Pass in exception parameter mode cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, parameter 6 and 6,
         ...
         * @tc.desc Call it as a synchronously without passing in parameters
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3000", 0, async function (done) {
            let signGenerator = cryptoFramework.createSign("RSA1024|PSS|SHA224|MGF1_SHA224");
            try {
                signGenerator.setSignSpec(1024, 2);
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 1 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                signGenerator.setSignSpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 4294967296);
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 2 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                signGenerator.setSignSpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 6, 6);
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 3 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                signGenerator.setSignSpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM);
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 4 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                signGenerator.setSignSpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, "string");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 5 err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3100 6 err" + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
         ...
         * @tc.desc Call it as a synchronously without passing in parameters
         * @tc.desc Pass in exception parameter mode cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM and
         * cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, and call it synchronously
         * @tc.desc Pass in exception parameter mode 6, and call it synchronously
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3100", 0, async function (done) {
            let signGenerator = cryptoFramework.createSign("RSA1024|PSS|SHA224|MGF1_SHA224");
            ...
            try {
                signGenerator.getSignSpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM,
         ...
         * @tc.desc Pass in two exception parameters "RSA1024|PKCS1|SHA224" and "RSA1024|PKCS1|SHA224"
         * and call them as synchronously
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3200", 0, async function (done) {
            try {
                cryptoFramework.createVerify("RSA10000|SHA224");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 1 catch err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 2 catch err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                cryptoFramework.createVerify("RSA1024PKCS1MD5RSA1024PKCS1MD5RSA1024PKCS1MD5");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 3 catch err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 4 catch err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 5 catch err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                cryptoFramework.createVerify("RSA1024|PKCS1|SHA224", "RSA1024|PKCS1|SHA224");
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3200 6 catch err" + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
         ...
         * @tc.desc Pass in an exception parameter "sroundpriKey" and call it as a async
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3300", 0, async function (done) {
            let specGenerator = cryptoFramework.createAsyKeyGeneratorBySpec(asyCommon.genRsa2048KeyPairSpec());
            let verifyGenerator = cryptoFramework.createVerify("RSA1024|PKCS1|SHA224");
            let verifyKeyPair;
            await new Promise((resolve, reject) => {
                specGenerator.generateKeyPair((err, keyPair) => {
                    if (err) {
         ...
         * was passed in as a promise to be called
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3400", 0, async function (done) {
            await asyPromise.verifyUpdateAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                    "RSA1024|PKCS1|SHA224", 0).then((data) => {
                    console.log("data 1 : " + data);
                    expect(null).assertFail();
                }).catch((err) => {
         ...
         * was passed in as a callback to be called
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3500", 0, async function (done) {
            await asyCallback.verifyAbnormalParameterProcess(asyCommon.genRsa2048KeyPairSpec(),
                "RSA1024|PKCS1|SHA224", 0).then((data) => {
                console.log("data 1 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
         ...
         * @tc.desc Call it as a synchronously without passing in parameters
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3600", 0, async function (done) {
            let verifyGenerator = cryptoFramework.createVerify("RSA1024|PKCS1|SHA224");
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 0);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, -1);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 65535);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, 6, 6);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
            try {
                verifyGenerator.setVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM, "string");
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
         ...
         * @tc.desc Pass in exception parameter mode 6, and call it synchronously
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3700", 0, async function (done) {
            let verifyGenerator = cryptoFramework.createVerify("RSA1024|PKCS1|SHA224");
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3700 1 err" + err);
                expect(err.code == 401).assertTrue();
            }

            try {
                verifyGenerator.getVerifySpec(cryptoFramework.SignSpecItem.PSS_SALT_LEN_NUM);
                expect(null).assertFail();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3700 2 err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3700 3 err" + err);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_SignatureVerification_Func_3700 4 err" + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
         ...
         */
        it("Security_CryptoFramework_SignatureVerification_Func_3800", 0, async function (done) {
            try {
                let signGenerator = cryptoFramework.createSign("RSA1024|PKCS1|SHA512");
                expect(signGenerator.algName == "RSA1024|PKCS1|SHA512").assertTrue();
                let verifyGenerator = cryptoFramework.createVerify("RSA1024|PKCS1|SHA512");
                expect(verifyGenerator.algName == "RSA1024|PKCS1|SHA512").assertTrue();
            } catch (err) {
                console.log("Security_CryptoFramework_SignatureVerification_Func_3800 catch err: " + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
