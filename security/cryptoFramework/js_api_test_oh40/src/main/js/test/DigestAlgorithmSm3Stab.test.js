...
export default function DigestAlgorithmSm3StabJsunit() {
  describe("DigestAlgorithmSm3StabJsunit", function () {
    ...
    /**
     * @tc.number Security_CryptoFramework_MDSM3_Stab_0100
     * @tc.name Summary Calculation stability testing
     * @tc.desc the asyAlgoName is "SM3", Use the Promise Style of Interface
     */
    it("Security_CryptoFramework_MDSM3_Stab_0100", 0, async function (done) {
      try {
        let count;
    ...
    /**
     * @tc.number Security_CryptoFramework_HMACSM3_Stab_0100
     ...
     */
    it("Security_CryptoFramework_HMACSM3_Stab_0100", 0, async function (done) {
      try {
        let count;
        const starttimestamp = Date.parse(new Date());
