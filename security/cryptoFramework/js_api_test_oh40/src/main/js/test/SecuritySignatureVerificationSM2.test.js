...
export default function SecuritySignatureVerificationSM2Jsunit() {
    describe("SecuritySignatureVerificationSM2Jsunit", function () {
        console.log("##########start SecuritySignatureVerificationSM2Jsunit##########");
        var asyKeyPair;
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0100", 0, async function (done) {
            await asyCallback.signAndVerifyNormalProcess("SM2_256", "SM2_256|SM3").then((result) => {
                expect(result).assertTrue();
            }).catch((err) => {
                console.error("Security_CryptoFramework_SignatureVerificationSM2_Func_0100 catch error: " + err);
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0200", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0300", 0, async function (done) {
            try {
         ...
         * @tc.desc the asyAlgoName is "SM2_256|SHA512", Use the async Style of Interface
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0400", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0500", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0600", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0700", 0, async function (done) {
         ...
         * and call it promise
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0800", 0, async function (done) {
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_0900", 0, async function (done) {
            let globalText = "This is a sign test";
            let input = { data: stringTouInt8Array(globalText) };
            let signGenerator = cryptoFramework.createSign("SM2_256|SM3");
            await signGenerator.init(asyKeyPair.priKey);
         ...
         * @tc.desc the asyAlgoName is "SM2_256|NULL", Use the async Style of Interface
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1000", 0, async function (done) {
            try {
         ...
         * @tc.desc Pass in an exception parameter "sroundpriKey" and call it as a async
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1100", 0, async function (done) {
            let specGenerator = cryptoFramework.createAsyKeyGenerator("SM2_256");
            ...
            try {
                await verifyGenerator.init(verifyKeyPair.pubKey, verifyKeyPair.pubKey);
                expect(null).assertFail();
            } catch (err) {
                expect(err.code == 401).assertTrue();
            }
         ...
         * was passed in as a promise to be called
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1200", 0, async function (done) {
            await asyPromise.verifyUpdateAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 0).then((data) => {
                console.log("data 1 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyUpdateAbnormalParameterSM2Process 1 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });

            await asyPromise.verifyUpdateAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 1).then((data) => {
                console.log("data 2 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyUpdateAbnormalParameterSM2Process 2 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });

            await asyPromise.verifyUpdateAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 3).then((data) => {
                console.log("data 3 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyUpdateAbnormalParameterSM2Process 3 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });

            await asyPromise.verifyUpdateAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 4).then((data) => {
                console.log("data 4 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyUpdateAbnormalParameterSM2Process 4 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1300", 0, async function (done) {
            await asyCallback.verifyAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 0).then((data) => {
                console.log("data 1 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyAbnormalParameterSM2Process 1 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });

            await asyCallback.verifyAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 1).then((data) => {
                console.log("data 2 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyAbnormalParameterSM2Process 2 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });

            await asyCallback.verifyAbnormalParameterSM2Process("SM2_256", "SM2_256|SM3", 3).then((data) => {
                console.log("data 3 : " + data);
                expect(null).assertFail();
            }).catch((err) => {
                console.error("VerifyAbnormalParameterSM2Process 3 catch error: " + err);
                expect(err.code == 401).assertTrue();
            });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1400", 0, async function (done) {
            let globalSignBlob;
         ...
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1500", 0, async function (done) {
            try {
         ...
         * @tc.desc Pass in algorithm name "SM2_256|SM3" and call it using the async method
         */
        it("Security_CryptoFramework_SignatureVerificationSM2_Func_1600", 0, async function (done) {
            try {
                let signGenerator = cryptoFramework.createSign("SM2_256|SM3");
                ...
                console.log("Security_CryptoFramework_SignatureVerificationSM2_Func_1600 catch err: " + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
