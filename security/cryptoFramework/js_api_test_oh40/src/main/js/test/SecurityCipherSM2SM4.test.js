...
export default function SecurityCipherSM2SM4Jsunit() {
    describe("SecurityCipherSM2SM4Jsunit", function () {
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0100", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CTR|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0100 catch error: " + err);
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0200", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CTR|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0200 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0300", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CTR|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0300 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0400", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|ECB|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0400 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0500", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|ECB|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0500 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0600", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|ECB|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0600 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0700", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CBC|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0700 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0800", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CBC|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0800 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_0900", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CBC|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_0900 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1000", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|OFB|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1000 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1100", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|OFB|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1100 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1200", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|OFB|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1200 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1300", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1300 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1400", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1400 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1500", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1500 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1600", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB128|NoPadding")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1600 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1700", 0, async function (done) {
            await symCallback.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB128|PKCS5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1700 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1800", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4_128|CFB128|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1800 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_1900", 0, async function (done) {
            await symPromise.encryptAndDecryptNormalSM4Process(symKeyPairSM4, "SM4|ECB|PKCS7")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_1900 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2000", 0, async function (done) {
            await asyCallback.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|C1C3C2|MD5")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2000 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2100", 0, async function (done) {
            await asyPromise.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|SM3")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2100 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2200", 0, async function (done) {
            await asyCallback.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|C1C3C2|SHA1")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2200 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2300", 0, async function (done) {
            await asyPromise.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|SHA224")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2300 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2400", 0, async function (done) {
            await asyCallback.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|C1C3C2|SHA256")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2400 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2500", 0, async function (done) {
            await asyPromise.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|SHA384")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2500 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2600", 0, async function (done) {
            await asyCallback.encryptAndDecryptNormalProcess("SM2_256", "SM2_256|C1C3C2|SHA512")
                .then((result) => {
                    expect(result).assertTrue();
                })
                .catch((err) => {
                    console.error("Security_CryptoFramework_CipherSMX_Func_2600 catch error: " + err);
                    expect(null).assertFail();
                });
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2700", 0, async function (done) {
            try {
         ...
         * @tc.desc Pass in an exception parameter "SM2257|SHA256" and call it as a async
         */
        it("Security_CryptoFramework_CipherSMX_Func_2800", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_2900", 0, async function (done) {
            let cipherGeneratorEncrypt = cryptoFramework.createCipher("SM4_128|CTR|PKCS7");
            ...
            try {
                ...
                console.log("Security_CryptoFramework_CipherSMX_Func_2900 1 catch err" + err.code);
                expect(err.code == 401).assertTrue();
            }
            ...
            try {
                ...
                console.log("Security_CryptoFramework_CipherSMX_Func_2900 2 catch err" + err.code);
                expect(err.code == 401).assertTrue();
            }

            try {
                await cipherGeneratorEncrypt.init(3, symKeyPairSM4, null, symKeyPairSM4);
                expect(null).assertFail();
            } catch(err) {
                console.log("Security_CryptoFramework_CipherSMX_Func_2900 3 catch err" + err.code);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_3000", 0, async function (done) {
            let cipherGenerator = cryptoFramework.createCipher("SM4_128|CTR|NoPadding");
            let encryptMode = cryptoFramework.CryptoMode.ENCRYPT_MODE;
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_3100", 0, async function (done) {
            let cipherGenerator = cryptoFramework.createCipher("SM4_128|CTR|NoPadding");
            let encryptMode = cryptoFramework.CryptoMode.ENCRYPT_MODE;
            let globalText = "This is a cipher test";
            let arr = [];
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_3200", 0, async function (done) {
            try {
         ...
         */
        it("Security_CryptoFramework_CipherSMX_Func_3300", 0, async function (done) {
            try {
                let cipherGenerator = cryptoFramework.createCipher("SM2_256|SM3");
                expect(cipherGenerator.algName == "SM2_256|SM3").assertTrue();
            } catch (err) {
                console.log("Security_CryptoFramework_CipherSMX_Func_3300 catch err: " + err);
                expect(err.code == 401).assertTrue();
            }
            done();
        });
