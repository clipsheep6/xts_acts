...
//        );
        ...
        it(
            ...
            0,
            async function (done) {
//                await certCallback.getX509CrlInfoCallback("pem", "getSignature");
...
//                await certPromise.getX509CrlInfoPromise("pem", "getSubjectAltNames");
                done();
            }
        );
...
//            0,
//            async function (done) {
//                await certPromise.createX509CertChainInstancePromise("PKIX");
////                await certCallback.checkGetRevokedCertsX509CrlCallback("pem");
//                done();
//            }
//        );
