 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0100, TestSize.Level3)
{
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0200, TestSize.Level3)
{
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0300, TestSize.Level3)
{
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0400, TestSize.Level3)
{
