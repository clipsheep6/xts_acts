...
void DpmsDuidTransformMTBFCppTest::TestFountion(std::string deviceId, int32_t ruid, int32_t duid)
{
...
void DpmsDuidTransformMTBFCppTest::ExeAPI(std::string &deviceId, int32_t ruid, int32_t duid)
{
    std::vector<FnPtr> vec;
    StressTestApi::GetDpmsDuidTranstormTestFunction_01(vec);
    for (auto fn : vec) {
