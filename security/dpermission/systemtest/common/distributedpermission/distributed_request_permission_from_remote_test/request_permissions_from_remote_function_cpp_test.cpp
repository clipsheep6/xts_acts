...
void RequestPermissionsFromRemoteFunctionCPPTest::AppEventSubscriber::OnReceiveEvent(const CommonEventData &data)
{
    ...
    auto iter = std::find(RequestPermissionsFromRemoteFunctionCPPTest::eventList_.begin(),
        RequestPermissionsFromRemoteFunctionCPPTest::eventList_.end(), eventName);
 ...
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2200, TestSize.Level2)
{
    ...
    EXPECT_EQ(STAbilityUtil::WaitCompleted(event_, "RequestPermissionsFromRemote", expectation, waitTime70s), 0);
 ...
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2300, TestSize.Level2)
{
 ...
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2400, TestSize.Level2)
{
 ...
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2500, TestSize.Level2)
{
