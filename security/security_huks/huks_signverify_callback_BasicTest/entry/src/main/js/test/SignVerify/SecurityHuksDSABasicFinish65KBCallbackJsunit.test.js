...
describe('SecurityHuksSignVerifyDSACallbackJsunit', function () {
    ...
    /**
     * @tc.name: testSignVerifyDSASIGN103
     * @tc.desc: alg-DSA dig-DIGEST_SHA1  inputdate-65kb  init>update>finish
     * @tc.type: FUNC
     */
    it('testSignVerifyDSA103', 0, async function (done) {
        ...
        HuksOptions = {
            "properties": new Array(HuksSignVerify002.HuksKeyAlgDSA, HuksSignVerify002.HuksKeyDSAPurposeVERIFY, HuksSignVerify002.HuksTagDSADigestSHA1, HuksSignVerify002.HuksKeySIZE1024),
            "inData": srcData65Kb,
        }
