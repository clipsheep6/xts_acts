...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
	it('testCipherAESSize192PADDINGNONEMODECBC001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(2, 1, HuksCipher001.HuksKeyAESSize192)
		...
		let HuksOptions = {
			properties: new Array(
				...
				HuksCipher001.HuksKeyAESSize192,
				HuksCipher001.HuksKeyAESPADDINGNONE,
				HuksCipher001.HuksKeyAESBLOCKMODE,
	...
	it('testCipherAESSize192PADDINGNONEMODECTR001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(3, 1, HuksCipher001.HuksKeyAESSize192)
		genHuksOptions.properties.splice(
			4,
			1,
	...
	if (Control.isOpenSSL) {
		it(
			'testCipherAESSize192PADDINGPKCS7MODEECB001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize192PADDINGPKCS7MODEECBKeyAlias001'
				genHuksOptions.properties.splice(
					2,
					1,
					HuksCipher001.HuksKeyAESSize192
		...
		it(
			'testCipherAESSize192PADDINGPKCS7MODEECB002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize192PADDINGPKCS7MODEECBKeyAlias002'
				let HuksOptions = {
					properties: new Array(
						HuksCipher001.HuksKeyAlgAES,
						HuksCipher001.HuksKeyPurposeENCRYPT,
		...
		it(
			'testCipherAESSize192PADDINGPKCS7MODEECB003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize192PADDINGPKCS7MODEECBKeyAlias001'
		...
		it(
			'testCipherAESSize192PADDINGPKCS7MODEECB004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize192PADDINGPKCS7MODEECBKeyAlias002'
