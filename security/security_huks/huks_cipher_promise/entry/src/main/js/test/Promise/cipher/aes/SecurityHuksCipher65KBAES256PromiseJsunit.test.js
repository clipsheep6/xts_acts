		...
		.then((data) => {
			...
			if (!isEncrypt) {
				if (finishData === uint8ArrayToString(encryptedData)) {
					...
					console.log(
						`test finish Decrypt fail ${uint8ArrayToString(
							encryptedData
						)}`
					)
					console.log(
...
describe('SecurityHuksCipherAESPromiseJsunit', function () {
	it('testCipherAESSize256PADDINGNONEMODECBC001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(2, 1, HuksCipher001.HuksKeyAESSize256)
		...
		let HuksOptions = {
			properties: new Array(
				...
				HuksCipher001.HuksKeyAESSize256,
				HuksCipher001.HuksKeyAESPADDINGNONE,
				HuksCipher001.HuksKeyAESBLOCKMODE,
	...
	it('testCipherAESSize256PADDINGPKCS7MODECBC001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher001.HuksKeyAESPADDINGPKCS7
		)
		genHuksOptions.properties.splice(
			4,
			1,
	...
	it('testCipherAESSize256PADDINGNONEMODECTR001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(3, 1, HuksCipher001.HuksKeyAESSize256)
		genHuksOptions.properties.splice(
			4,
			1,
			HuksCipher001.HuksKeyAESBLOCKMODECTR
		)
		let HuksOptions = {
			properties: new Array(
				HuksCipher001.HuksKeyAlgAES,
	...
	it('testCipherAESSize256PADDINGNONEMODEECB001', 0, async function (done) {
		...
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher001.HuksKeyAESBLOCKMODEECB
		)
		genHuksOptions.properties.splice(
			4,
			1,
	...
	if (Control.isOpenSSL) {
		it(
			'testCipherAESSize256PADDINGPKCS7MODEECB001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize256PADDINGPKCS7MODEECBKeyAlias001'
				genHuksOptions.properties.splice(
					2,
					1,
					HuksCipher001.HuksKeyAESSize256
		...
		it(
			'testCipherAESSize256PADDINGPKCS7MODEECB002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize256PADDINGPKCS7MODEECBKeyAlias002'
				let HuksOptions = {
					properties: new Array(
						HuksCipher001.HuksKeyAlgAES,
						HuksCipher001.HuksKeyPurposeENCRYPT,
		...
		it(
			'testCipherAESSize256PADDINGPKCS7MODEECB003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize256PADDINGPKCS7MODEECBKeyAlias001'
		...
		it(
			'testCipherAESSize256PADDINGPKCS7MODEECB004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherAESSize256PADDINGPKCS7MODEECBKeyAlias002'
