...
let genHuksOptions = {
	properties: new Array(
		...
		HuksCipher002.HuksKeyRSASize1024
	),
...
describe('SecurityHuksCipherRSAPromiseJsunit', function () {
	if (Control.isOpenSSL) {
		it(
			'testCipherRSASize1024PADDINGNONESHA256001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize1024PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize1024PADDINGNONESHA256002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize1024PADDINGNONESHA256KeyAlias002'
				const newSrcKeyAlies =
					'testCipherRSASize1024PADDINGNONESHA256NewKeyAlias001'
				let HuksOptions = {
					properties: new Array(
		...
		it(
			'testCipherRSASize1024PADDINGNONESHA256003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize1024PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize1024PADDINGNONESHA256004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize1024PADDINGNONESHA256KeyAlias002'
	...
	it('testCipherRSASize1024PADDINGOAEPSHA1001', 0, async function (done) {
		...
		const newSrcKeyAlies =
			'testCipherRSASize1024PADDINGOAEPSHA1NewKeyAlias001'
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher002.HuksKeyRSABLOCKMODEECB
	...
	it('testCipherRSASize1024PADDINGOAEPSHA384002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize1024PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize1024PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize1024PADDINGOAEPSHA384004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize1024PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize1024PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
	...
	it('testCipherRSASize1024PADDINGOAEPSHA512002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize1024PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize1024PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize1024PADDINGOAEPSHA512004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize1024PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize1024PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
