...
let genHuksOptions = {
	properties: new Array(
		...
		HuksCipher002.HuksKeyRSASize3072
	),
...
describe('SecurityHuksCipherRSAPromiseJsunit', function () {
	if (Control.isOpenSSL) {
		it(
			'testCipherRSASize3072PADDINGNONESHA256001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize3072PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize3072PADDINGNONESHA256002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize3072PADDINGNONESHA256KeyAlias002'
				const newSrcKeyAlies =
					'testCipherRSASize3072PADDINGNONESHA256NewKeyAlias001'
				let HuksOptions = {
					properties: new Array(
		...
		it(
			'testCipherRSASize3072PADDINGNONESHA256003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize3072PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize3072PADDINGNONESHA256004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize3072PADDINGNONESHA256KeyAlias002'
	...
	it('testCipherRSASize3072PADDINGOAEPSHA1001', 0, async function (done) {
		...
		const newSrcKeyAlies =
			'testCipherRSASize3072PADDINGOAEPSHA1NewKeyAlias001'
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher002.HuksKeyRSABLOCKMODEECB
