...
let genHuksOptions = {
	properties: new Array(
		...
		HuksCipher002.HuksKeyRSASize768
	),
...
describe('SecurityHuksCipherRSAPromiseJsunit', function () {
	if (Control.isOpenSSL) {
		it(
			'testCipherRSASize768PADDINGNONESHA256001',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize768PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize768PADDINGNONESHA256002',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize768PADDINGNONESHA256KeyAlias002'
				const newSrcKeyAlies =
					'testCipherRSASize768PADDINGNONESHA256NewKeyAlias001'
				let HuksOptions = {
					properties: new Array(
		...
		it(
			'testCipherRSASize768PADDINGNONESHA256003',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize768PADDINGNONESHA256KeyAlias001'
		...
		it(
			'testCipherRSASize768PADDINGNONESHA256004',
			0,
			async function (done) {
				const srcKeyAlies =
					'testCipherRSASize768PADDINGNONESHA256KeyAlias002'
	...
	it('testCipherRSASize768PADDINGOAEPSHA1001', 0, async function (done) {
		...
		const newSrcKeyAlies =
			'testCipherRSASize768PADDINGOAEPSHA1NewKeyAlias001'
		genHuksOptions.properties.splice(
			3,
			1,
			HuksCipher002.HuksKeyRSABLOCKMODEECB
	...
	it('testCipherRSASize768PADDINGOAEPSHA384002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize768PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize768PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize768PADDINGOAEPSHA384004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize768PADDINGOAEPSHA384KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize768PADDINGOAEPSHA384NewKeyAlias001'
		let HuksOptions = {
	...
	it('testCipherRSASize768PADDINGOAEPSHA512002', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize768PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize768PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
			properties: new Array(
				HuksCipher002.HuksKeyAlgRSA,
				HuksCipher002.HuksKeyPurposeENCRYPT,
	...
	it('testCipherRSASize768PADDINGOAEPSHA512004', 0, async function (done) {
		const srcKeyAlies = 'testCipherRSASize768PADDINGOAEPSHA512KeyAlias002'
		const newSrcKeyAlies =
			'testCipherRSASize768PADDINGOAEPSHA512NewKeyAlias001'
		let HuksOptions = {
