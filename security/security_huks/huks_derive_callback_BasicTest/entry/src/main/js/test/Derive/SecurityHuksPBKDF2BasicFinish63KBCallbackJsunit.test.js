...
let HuksDerive002 = {
    ...
    HuksKeyAlgPBKDF2: { "tag": HksTag.HKS_TAG_ALGORITHM, "value": HksKeyAlg.HKS_ALG_PBKDF2 },
    HuksKeyAlgAES: { "tag": HksTag.HKS_TAG_ALGORITHM, "value": HksKeyAlg.HKS_ALG_AES },
    HuksKeyPurposePBKDF2: { "tag": HksTag.HKS_TAG_PURPOSE, "value": HksKeyPurpose.HKS_KEY_PURPOSE_DERIVE },
    HuksTagPBKDF2DigestSHA256: { "tag": HksTag.HKS_TAG_DIGEST, "value": HksKeyDigest.HKS_DIGEST_SHA256 },
    HuksTagPBKDF2DigestSHA384: { "tag": HksTag.HKS_TAG_DIGEST, "value": HksKeyDigest.HKS_DIGEST_SHA384 },
    HuksTagPBKDF2DigestSHA512: { "tag": HksTag.HKS_TAG_DIGEST, "value": HksKeyDigest.HKS_DIGEST_SHA512 },
    HuksKeyPBKDF2Size128: { "tag": HksTag.HKS_TAG_KEY_SIZE, "value": HksKeySize.HKS_AES_KEY_SIZE_128 },
    HuksKeyPBKDF2Size192: { "tag": HksTag.HKS_TAG_KEY_SIZE, "value": HksKeySize.HKS_AES_KEY_SIZE_192 },
...
describe('SecurityHuksDerivePBKDF2CallbackJsunit', function () {
	...
	/**
     * @tc.name: testDerivePBKDF2Finish63KB001
