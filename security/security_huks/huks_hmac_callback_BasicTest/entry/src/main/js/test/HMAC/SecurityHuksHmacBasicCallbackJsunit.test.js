...
async function publicHmacGenFunc(srcKeyAlies, HuksOptions, thirdInderfaceName) {
    ...
    console.log("test before generateKey HuksOptions = " + JSON.stringify(HuksOptions));
    ...
    console.log("test before Update HuksOptions = " + JSON.stringify(HuksOptions));
    await publicHmacUpdate(HuksOptions);

    if (thirdInderfaceName == "finish") {
        HuksOptions.inData = new Uint8Array(stringToArray('0'))
        console.log("test before finish HuksOptions = " + JSON.stringify(HuksOptions));
        ...
        console.log("test before abort HuksOptions = " + JSON.stringify(HuksOptions));
