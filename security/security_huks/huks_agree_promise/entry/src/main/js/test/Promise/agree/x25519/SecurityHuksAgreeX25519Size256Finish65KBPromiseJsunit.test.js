...
describe('SecurityHuksAgreeX25519PromiseJsunit', function () {
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree001
	...
	it('testAgreeX25519Size256Finish65KBAgree001', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyBLOCK_MODEECB
			),
			inData: srcData65Kb,
		}
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree002
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree003
	...
	it('testAgreeX25519Size256Finish65KBAgree003', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyPADDINGPKCS7,
				HuksAgree003.HuksKeyBLOCK_MODECBC
			),
			inData: srcData65Kb,
		}
		await publicAgreeFunc(
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree004
	 * @tc.desc: keysize-KEY_SIZE_2048 FLAG-PERSISTENT  ALG-ALG_AES  PURPOSE-PURPOSE_ENCRYPT|PURPOSE_DECRYPT PADDING-PADDING_PKCS7 MODE-MODE_CBC size-2048 inputdate-500kb  init>update>abort
	 * @tc.type: FUNC
	 */
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree005
	...
	it('testAgreeX25519Size256Finish65KBAgree005', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyPADDINGNONE,
				HuksAgree003.HuksKeyBLOCK_MODECCM
			),
			inData: srcData65Kb,
		}
		await publicAgreeFunc(
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree006
	 * @tc.desc: keysize-KEY_SIZE_2048 FLAG-PERSISTENT  ALG-ALG_AES  PURPOSE-PURPOSE_ENCRYPT|PURPOSE_DECRYPT PADDING-PADDING_NONE MODE-MODE_CCM size-2048 inputdate-500kb  init>update>abort
	 * @tc.type: FUNC
	 */
	it('testAgreeX25519Size256Finish65KBAgree006', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyPADDINGNONE,
				HuksAgree003.HuksKeyBLOCK_MODEGCM
			),
			inData: srcData65Kb,
		}
		await publicAgreeFunc(
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree007
	...
	it('testAgreeX25519Size256Finish65KBAgree007', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyPADDINGNONE,
				HuksAgree003.HuksKeyBLOCK_MODECTR
			),
			inData: srcData65Kb,
		}
		await publicAgreeFunc(
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree008
	...
	it('testAgreeX25519Size256Finish65KBAgree008', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeyALGORITHMAES,
				HuksAgree003.HuksKeySIZE256,
				HuksAgree003.HuksKeyPurposeDERIVE,
				HuksAgree003.HuksKeyDIGESTSHA256,
				{
					tag: HksTag.HKS_TAG_KEY_ALIAS,
					value: stringToUint8Array(srcKeyAlies_1),
				},
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree009
	...
	it('testAgreeX25519Size256Finish65KBAgree009', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeySIZE256,
				HuksAgree003.HuksKeyPurposeDERIVE,
				HuksAgree003.HuksKeyDIGESTSHA384,
				{
					tag: HksTag.HKS_TAG_KEY_ALIAS,
					value: stringToUint8Array(srcKeyAlies_1),
				},
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree010
	...
	it('testAgreeX25519Size256Finish65KBAgree010', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeySIZE256,
				HuksAgree003.HuksKeyPurposeDERIVE,
				HuksAgree003.HuksKeyDIGESTSHA512,
				{
					tag: HksTag.HKS_TAG_KEY_ALIAS,
					value: stringToUint8Array(srcKeyAlies_1),
				},
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree011
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree012
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree013
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree014
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree015
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree016
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree017
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree018
	 * @tc.desc: keysize-KEY_SIZE_2048 FLAG-PERSISTENT  ALG-ALG_AES  PURPOSE-PURPOSE_DERIVE/ENCRYPT|DECRYPT DIGEST-DIGEST_SHA256  MODE-MODE_ECB size-2048 inputdate-500kb  init>update>abort
	 * @tc.type: FUNC
	 */
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree019
	 * @tc.desc: keysize-KEY_SIZE_2048 FLAG-PERSISTENT  ALG-ALG_AES  PURPOSE-PURPOSE_DERIVE/ENCRYPT|DECRYPT DIGEST-DIGEST_SHA384  MODE-MODE_ECB size-2048 inputdate-500kb  init>update>abort
	 * @tc.type: FUNC
	 */
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree020
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree021
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree022
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree023
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree024
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree025
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree026
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree027
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree028
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree029
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree030
	...
	it('testAgreeX25519Size256Finish65KBAgree030', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				HuksAgree003.HuksKeySTORAGE,
				HuksAgree003.HuksKeyISKEYALIAS,
				HuksAgree003.HuksKeyALGORITHMHMAC,
				HuksAgree003.HuksKeySIZE256,
				HuksAgree003.HuksKeyPurposeMAC,
				HuksAgree003.HuksKeyDIGESTSHA1,
				{
					tag: HksTag.HKS_TAG_KEY_ALIAS,
					value: stringToUint8Array(srcKeyAlies_1),
				},
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree031
	...
	it('testAgreeX25519Size256Finish65KBAgree031', 0, async function (done) {
		...
		let HuksOptions_Finish = {
			properties: new Array(
				...
				HuksAgree003.HuksKeySIZE256,
				HuksAgree003.HuksKeyPurposeMAC,
				HuksAgree003.HuksKeyDIGESTSHA224,
				{
					tag: HksTag.HKS_TAG_KEY_ALIAS,
					value: stringToUint8Array(srcKeyAlies_1),
				},
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree032
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree033
	...
	/**
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree034
	...
	/*
	 * @tc.name: testAgreeX25519Size256Finish65KBAgree035
