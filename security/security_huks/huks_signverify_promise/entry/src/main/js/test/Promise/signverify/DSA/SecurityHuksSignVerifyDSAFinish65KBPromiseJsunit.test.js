...
describe('SecurityHuksSignVerifyDSAPromiseJsunit', function () {
	...
	/**
	 * @tc.name: testSignVerifyDSASIGNSHA224KeyAlias103
	...
	/**
	 * @tc.name: testSignVerifyDSASIGNSHA256KeyAlias103
	...
	/**
	 * @tc.name: testSignVerifyDSASIGNSHA384KeyAlias103
	...
	/**
	 * @tc.name: testSignVerifyDSASIGNSHA512KeyAlias103
