...
/*
 * Feature: Multi_HandOut_touch_021_D
 * Function: Multi_HandOut_touch_021_D
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(singleWindowUnRegisteredTest, Multi_HandOut_touch_021_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.libinputExpectList = {"500|0|0|100", "502|0|100|100", "502|0|200|100",
                             "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|0|100|", "502|0|100|100|", "502|0|200|100|",
                        "501|0|0|0|"};
    ci.mixedkeyList = {{{""}}, {{""}}, {{""}}, {{""}}};
    ci.dispatcherList = {"", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_021_D");
}

/*
 * Feature: Multi_HandOut_touch_024_D
 * Function: Multi_HandOut_touch_024_D
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(singleWindowUnRegisteredTest, Multi_HandOut_touch_024_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.libinputExpectList = {"500|0|480|100", "502|0|380|100", "502|0|200|100",
                             "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|480|100|", "502|0|380|100|", "502|0|200|100|",
                        "501|0|0|0|"};
    ci.mixedkeyList = {{{""}}, {{""}}, {{""}}, {{""}}};
    ci.dispatcherList = {"", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_024_D");
}
