 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_001_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_002_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000125013712000", "43000125013710000", "43000125013710000", "43000125013710000",
                    "43000125013710000", "42000000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"500|0|125|137", "502|0|125|137", "502|0|125|137",
                             "502|0|125|137", "502|0|125|137", "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/"};
    ci.expectL3Event = {"500|0|125|137|", "502|0|125|137|", "502|0|125|137|",
                        "502|0|125|137|", "502|0|125|137|", "501|0|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", ""};
    AutoTestCommon(ci);
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_003_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000125073710000", "43000125063710000", "43000125053710000", "43000125043710000",
                    "43000125023710000", "42000000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"500|0|125|737", "502|0|125|637", "502|0|125|537",
                             "502|0|125|437", "502|0|125|237", "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/"};
    ci.expectL3Event = {"500|0|125|737|", "502|0|125|637|", "502|0|125|537|",
                        "502|0|125|437|", "502|0|125|237|", "501|0|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", ""};
    AutoTestCommon(ci);
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_004_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000125013710000", "43000125023710000", "43000125033710000", "43000125043710000",
                    "43000125053710000", "42000000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"500|0|125|137", "502|0|125|237", "502|0|125|337",
                             "502|0|125|437", "502|0|125|537", "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/"};
    ci.expectL3Event = {"500|0|125|137|", "502|0|125|237|", "502|0|125|337|",
                        "502|0|125|437|", "502|0|125|537|", "501|0|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", ""};
    AutoTestCommon(ci);
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_005_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000125013712000", "43000125023710000", "43000125033710000", "43000125043710000",
                    "43000125053710000", "42000000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"500|0|125|137", "502|0|125|237", "502|0|125|337",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_006_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010000000", "41010300010010000", "43000100010000000", "43010300010010000",
                    "43000100010000000", "43010300010010000", "42000000000000000", "42010000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|100|100", "500|1|300|100", "502|0|100|100",
                             "502|1|300|100", "502|0|100|100", "502|1|300|100",
                             "501|0|0|0", "501|1|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|100|100|", "500|1|300|100|", "502|0|100|100|",
                        "502|1|300|100|", "502|0|100|100|", "502|1|300|100|",
                        "501|0|0|0|", "501|1|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", ""};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_007_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010002000", "41010300010012000", "43000100010000000", "43010300010010000",
                    "43000100010000000", "43010300010010000", "42000000000000000", "42010000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|100|100", "500|1|300|100", "502|0|100|100",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_008_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010002000", "41010300010012000", "43000100010000000", "43010300010010000",
                    "43000100010000000", "43010300010010000", "42000000000000000", "42010000000010000"};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_009_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010002000", "41010300010012000", "43000100010000000", "43010300010010000",
                    "43000100010000000", "43010300010010000", "42000000000000000", "42010000000010000"};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_010_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010000000", "41010300010010000", "43000100015000000", "43010300015010000",
                    "43000100021000000", "43010300021010000", "42000000000000000", "42010000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|100|100", "500|1|300|100", "502|0|100|150",
                             "502|1|300|150", "502|0|100|210", "502|1|300|210",
                             "501|0|0|0", "501|1|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|100|100|", "500|1|300|100|", "502|0|100|150|",
                        "502|1|300|150|", "502|0|100|210|", "502|1|300|210|",
                        "501|0|0|0|", "501|1|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", ""};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_011_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010002000", "41010300010012000", "43000100020000000", "43010300020010000",
                    "43000100030000000", "43010300030010000", "42000000000000000", "42010000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|100|100", "500|1|300|100", "502|0|100|200",
                             "502|1|300|200", "502|0|100|300", "502|1|300|300",
                             "501|0|0|0", "501|1|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|100|100|", "500|1|300|100|", "502|0|100|200|",
                        "502|1|300|200|", "502|0|100|300|", "502|1|300|300|",
                        "501|0|0|0|", "501|1|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", ""};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_012_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010000000", "41010200010000000", "41020300010010000", "43000100010000000",
                    "43010200010000000", "43020300010010000", "43000100010000000", "43010200010000000",
                    "43020300010010000", "42000000000000000", "42010000000000000", "42020000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|100|100", "500|1|200|100", "500|2|300|100",
                             "502|0|100|100", "502|1|200|100", "502|2|300|100",
                             "502|0|100|100", "502|1|200|100", "502|2|300|100",
                             "501|0|0|0", "501|1|0|0", "501|2|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|100|100|", "500|1|200|100|", "500|2|300|100|",
                        "502|0|100|100|", "502|1|200|100|", "502|2|300|100|",
                        "502|0|100|100|", "502|1|200|100|", "502|2|300|100|",
                        "501|0|0|0|", "501|1|0|0|", "501|2|0|0|"};
    ci.dispatcherList = {"", "", "", "",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_013_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010003000", "41010200010003000", "41020300010013000", "43000100010000000",
                    "43010200010000000", "43020300010010000", "43000100010000000", "43010200010000000",
                    "43020300010010000", "42000000000000000", "42010000000000000", "42020000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_014_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000100010003000", "41010200010003000", "41020300010013000", "43000100010000000",
                    "43010200010000000", "43020300010010000", "43000100010000000", "43010200010000000",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_015_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000200020000000", "41010300020000000", "41020400020000000", "41030400020010000",
                    "42000000000000000", "42010000000000000", "42020000000000000", "42030000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|200|200", "500|1|300|200", "500|2|400|200",
                             "500|3|400|200", "501|0|0|0", "501|1|0|0",
                             "501|2|0|0", "501|3|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.expectL3Event = {"500|0|200|200|", "500|1|300|200|", "500|2|400|200|",
                        "500|3|400|200|", "501|0|0|0|", "501|1|0|0|",
                        "501|2|0|0|", "501|3|0|0|"};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", ""};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_016_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000200020000000", "41010300020000000", "41020400020000000", "41030400020000000",
                    "41040400020010000", "42000000000000000", "42010000000000000", "42020000000000000",
                    "42030000000000000", "42040000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"500|0|200|200", "500|1|300|200", "500|2|400|200",
                             "500|3|400|200", "500|4|400|200", "501|0|0|0",
                             "501|1|0|0", "501|2|0|0", "501|3|0|0",
                             "501|4|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
                             "/", "/"};
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_017_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000200020000000", "41010300020000000", "41020400020000000", "41030400020010000",
                    "43000200025000000", "43010300025000000", "43020400025000000", "43030400025010000",
                    "43000200031000000", "43010300031000000", "43020400031000000", "43030400031010000",
                    "42000000000000000", "42010000000000000", "42020000000000000", "42030000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|200|200", "500|1|300|200", "500|2|400|200",
                             "500|3|400|200", "502|0|200|250", "502|1|300|250",
                             "502|2|400|250", "502|3|400|250", "502|0|200|310",
                             "502|1|300|310", "502|2|400|310", "502|3|400|310",
                             "501|0|0|0", "501|1|0|0", "501|2|0|0",
                             "501|3|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
 ...
 * CaseDescription: set log print level
 */
 AUTO_TEST_FUNC(SingleWindowNoSwitchingTest, Multi_HandOut_touch_018_H, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"41000200020000000", "41010300020000000", "41020400020000000", "41030400020000000",
                    "41040400020010000", "43000200025000000", "43010300025000000", "43020400025000000",
                    "43030400025000000", "43040400025010000", "43000200031000000", "43010300031000000",
                    "43020400031000000", "43030400031000000", "43040400031010000", "42000000000000000",
                    "42010000000000000", "42020000000000000", "42030000000000000", "42040000000010000"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", "", "", "",
                             "", "", "", "",
                             "", "", "", ""};    
    ci.libinputExpectList = {"500|0|200|200", "500|1|300|200", "500|2|400|200",
                             "500|3|400|200", "500|4|400|200", "502|0|200|250",
                             "502|1|300|250", "502|2|400|250", "502|3|400|250",
                             "502|4|400|250", "502|0|200|310", "502|1|300|310",
                             "502|2|400|310", "502|3|400|310", "502|4|400|310",
                             "501|0|0|0", "501|1|0|0", "501|2|0|0",
                             "501|3|0|0", "501|4|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
