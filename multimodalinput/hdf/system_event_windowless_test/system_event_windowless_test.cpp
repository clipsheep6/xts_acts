 ...
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(systemEventWindowlessTest_Test, Multi_HandOut_touch_016_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"41000100010000000", "41010200010000000", "41020300010010000", "43000100015000000",
                    "43010200015000000", "43020300015010000", "43000100031000000", "43010200031000000",
                    "43020300031010000", "42000000000000000", "42010000000000000", "42020000000010000"};
    ci.flagList = {"", "", "", "1", "1", "1", "1", "1", "1", "", "", ""};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", "", "", ""};
    ci.libinputExpectList = {"500|0|100|100", "500|1|200|100", "500|2|300|100",
                             "502|0|100|150", "502|1|200|150", "502|2|300|150",
                             "502|0|100|310", "502|1|200|310", "502|2|300|310",
                             "501|0|0|0", "501|1|0|0", "501|2|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
                             "/", "/", "/", "/"};
    ci.mixedkeyList = {{{""}}, {{""}}, {{""}}, {{"4001","onScreenShot"}}, {{"4001","onScreenShot"}}, {{"4001","onScreenShot"}}, {{"4001","onScreenShot"}}, {{"4001","onScreenShot"}}, {{"4001","onScreenShot"}}, {{""}}, {{""}}, {{""}}};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", "",
                         "", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_016_A");
}
/*
 ...
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(systemEventWindowlessTest_Test, Multi_HandOut_touch_017_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"41000100096000000", "43000100085000000", "43000100070000000", "42000000000000000"};
    ci.flagList = {"", "1", "1", ""};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"500|0|100|960", "502|0|100|850", "502|0|100|700",
                             "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.mixedkeyList = {{{""}}, {{"4005","onGotoDesktop"}}, {{"4005","onGotoDesktop"}}, {{""}}};
    ci.dispatcherList = {"", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_017_A");
}
/*
 ...
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(systemEventWindowlessTest_Test, Multi_HandOut_touch_018_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"41000100096000000", "43000100085000000", "43000100070000000", "42000000000002000"};
    ci.flagList = {"", "1", "1", ""};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"500|0|100|960", "502|0|100|850", "502|0|100|700",
                             "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.mixedkeyList = {{{""}}, {{"&&"},{"4006","onRecentand4005","onGotoDesktop"}}, {{"&&"},{"4006","onRecentand4005","onGotoDesktop"}}, {{""}}};
    ci.dispatcherList = {"", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_018_A");
}
/*
 ...
 * CaseDescription: set log print level
 */
AUTO_TEST_FUNC(systemEventWindowlessTest_Test, Multi_HandOut_touch_019_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"41000100000000000", "43000100010000000", "43000100070000000", "42000000000000000"};
    ci.flagList = {"", "1", "1", ""};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"500|0|100|0", "502|0|100|100", "502|0|100|700",
                             "501|0|0|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.mixedkeyList = {{{""}}, {{"4007","onShowNotification"}}, {{"4007","onShowNotification"}}, {{""}}};
    ci.dispatcherList = {"", "", "", ""};
    AutoTestCommon(ci, "Multi_HandOut_touch_019_A");
}
/*
