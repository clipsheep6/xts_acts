...
{
    GetSTHelper().InJectionEvent("Api_Test_GetOriginEventType_00.json", "");
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetOriginEventType_01.json", "");
    TouchEvent touchEventTest;
    auto retOriginEventType = touchEventTest.GetOriginEventType();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetOriginEventType_02.json", "");
    TouchEvent touchEventTest;
    auto retOriginEventType = touchEventTest.GetOriginEventType();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetOriginEventType_03.json", "");
    TouchEvent touchEventTest;
    auto retOriginEventType = touchEventTest.GetOriginEventType();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_00.json", "");
    TouchEvent touchEventTest;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_01.json", "");
    TouchEvent touchEventTest;
    MultimodalEventPtr deviceEvent = nullptr;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
    EXPECT_EQ(retMultimodalEvent,  deviceEvent);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_02.json", "");
    TouchEvent touchEventTest;
    MultimodalEventPtr deviceEvent = nullptr;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
    EXPECT_EQ(retMultimodalEvent,  deviceEvent);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_03.json", "");
    TouchEvent touchEventTest;
    MultimodalEventPtr deviceEvent = nullptr;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
    EXPECT_EQ(retMultimodalEvent,  deviceEvent);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_04.json", "");
    TouchEvent touchEventTest;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_05.json", "");
    TouchEvent touchEventTest;
    MultimodalEvent multimodalEventTest;
    MultimodalEventPtr deviceEvent = &multimodalEventTest;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_06.json", "");
    TouchEvent touchEventTest;
    MultimodalEvent multimodalEventTest;
    MultimodalEventPtr deviceEvent = &multimodalEventTest;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetMultimodalEvent_07.json", "");
    TouchEvent touchEventTest;
    MultimodalEvent multimodalEventTest;
    MultimodalEventPtr deviceEvent = &multimodalEventTest;
    auto retMultimodalEvent = touchEventTest.GetMultimodalEvent();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_00.json", "");
    TouchEvent touchEventTest;
    int32_t action = 0;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_01.json", "");
    TouchEvent touchEventTest;
    int32_t action = 1;
    auto retAction = touchEventTest.GetAction();
    EXPECT_EQ(retAction, action);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_02.json", "");
    TouchEvent touchEventTest;
    int32_t action = 2;
    auto retAction = touchEventTest.GetAction();
    EXPECT_EQ(retAction, action);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_03.json", "");
    TouchEvent touchEventTest;
    auto retAction = touchEventTest.GetAction();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_04.json", "");
    TouchEvent touchEventTest;
    auto retAction = touchEventTest.GetAction();
    EXPECT_EQ(retAction, 0);
}
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetIndex_00.json", "");
    TouchEvent touchEventTest;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetIndex_01.json", "");
    TouchEvent touchEventTest;
    auto retIndex = touchEventTest.GetIndex();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetIndex_02.json", "");
    TouchEvent touchEventTest;
    auto retIndex = touchEventTest.GetIndex();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetIndex_03.json", "");
    TouchEvent touchEventTest;
    auto retIndex = touchEventTest.GetIndex();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetTapCount_00.json", "");
    TouchEvent touchEventTest;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetTapCount_01.json", "");
    TouchEvent touchEventTest;
    float tapCount = 0.0f;
    auto retTapCount = touchEventTest.GetTapCount();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetTapCount_02.json", "");
    TouchEvent touchEventTest;
    float tapCount = 1.0f;
    auto retTapCount = touchEventTest.GetTapCount();
    EXPECT_FLOAT_EQ(retTapCount, tapCount);
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetTapCount_03.json", "");
    TouchEvent touchEventTest;
    float tapCount = 2.0f;
    auto retTapCount = touchEventTest.GetTapCount();
    EXPECT_FLOAT_EQ(retTapCount, tapCount);
