...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_000.json", "");
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_001_0.json", "");
    StylusEvent stylusEventTest;
    auto retAction = stylusEventTest.GetAction();
    EXPECT_EQ(retAction, 3);
    GetSTHelper().InJectionEvent("Api_Test_GetAction_001_1.json", "");
}
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_002.json", "");
    StylusEvent stylusEventTest;
    auto retAction = stylusEventTest.GetAction();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetAction_003.json", "");
    StylusEvent stylusEventTest;
    auto retAction = stylusEventTest.GetAction();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetButtons_01.json", "");
    StylusEvent stylusEventTest;
    auto retButtons = stylusEventTest.GetButtons();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetButtons_02.json", "");
    StylusEvent stylusEventTest;
    auto retButtons = stylusEventTest.GetButtons();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetActionButton_000.json", "");
    StylusEvent stylusEventTest;
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetActionButton_001.json", "");
    StylusEvent stylusEventTest;
    auto retActionButton = stylusEventTest.GetActionButton();
...
{
    GetSTHelper().InJectionEvent("Api_Test_GetActionButton_002.json", "");
    StylusEvent stylusEventTest;
    auto retActionButton = stylusEventTest.GetActionButton();
    EXPECT_EQ(retActionButton, 0);
}
