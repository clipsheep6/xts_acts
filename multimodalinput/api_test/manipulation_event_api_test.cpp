...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_00, TestSize.Level1)
{
    ...
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_01.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_02, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_02.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_03, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_03.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_04, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_04.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_06, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_06.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetStartTime_07, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetStartTime_07.json", "");
    auto retStartTime =  manipulationEventTest.GetStartTime();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_00, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_00.json", "");
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_01, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_01.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_02, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_02.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_03, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_03.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_04, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_04.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_05, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_05.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_06, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_06.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
HWTEST_F(ManipulationEventsApiTest, Api_Test_GetPhase_07, TestSize.Level1)
{
    ...
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPhase_07.json", "");
    auto retStartTime =  manipulationEventTest.GetPhase();
    EXPECT_EQ(retStartTime, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_01.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_02.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_03.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_04.json", "");
    auto retPointerPosition = manipulationEventTest.GetPointerPosition(0);
    auto retX = retPointerPosition.GetX();
    EXPECT_FLOAT_EQ(retX, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerPosition_05.json", "");
    auto retPointerPosition = manipulationEventTest.GetPointerPosition(0);
    auto retX = retPointerPosition.GetX();
    EXPECT_FLOAT_EQ(retX, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_01.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_02.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_03_0.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_03_1.json", "");
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_04.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_05.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_06.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_07.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_08.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerCount_009.json", "");
    auto retPointerCount = manipulationEventTest.GetPointerCount();
    EXPECT_EQ(retPointerCount, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerId_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetPointerId_01.json", "");
    auto retPointerId = manipulationEventTest.GetPointerId(0);
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_01.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_02.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_03.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_04.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_05.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_06.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetForce_07_0.json", "");
    auto retForce = manipulationEventTest.GetForce(1);
    EXPECT_FLOAT_EQ(retForce, 0);
    GetSTHelper().InJectionEvent("Api_Test_GetForce_07_1.json", "");
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_00.json", "");
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_01.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_02.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_03.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_04.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_05.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_06.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
}
...
{
    ManipulationEvent manipulationEventTest;
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_07_0.json", "");
    auto retRadius = manipulationEventTest.GetRadius(0);
    EXPECT_FLOAT_EQ(retRadius, 0.0);
    GetSTHelper().InJectionEvent("Api_Test_GetRadius_07_1.json", "");
}
