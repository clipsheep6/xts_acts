...
describe('tsApi_play_test', function () {

    it('inputEventClient::multi_input_tsApi_play_001, remoteControl', 0, function () {
        let injectEvent = {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            console.log(`inputEventClient:play: register success`);
            console.log(`inject_play START`);
            let ret = inputEventClient.setInjectFile(WINDOW_ID, injectEvent);
            sleep(1000);
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_play END`);
    ...
    it('inputEventClient::multi_input_tsApi_play_002, aiSensor', 0, function () {
        let injectEvent = {
    ...
    it('inputEventClient::multi_input_tsApi_play_003, not exist call play handler', 0, function () {
        console.log(`inputEventClient::play: start`);
        const registerResult = inputEventClient.on(WINDOW_ID, 'play', 32323);
        expect(registerResult).assertEqual(MMI_STANDARD_EVENT_INVALID_PARAMETER);
        console.log(`registerResult:` + registerResult);
    })
    it('inputEventClient::multi_input_tsApi_play_004, not exist register function', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_play_005, register other ui standard function', 0, function () {
        let injectEvent = {
            eventFileName: aiVoiceEvent,
            jsonEvent: '5004 1'
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_play END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'play', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_play_006, unregister not exist call  play handler', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_play END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'play', 12321);
    ...
    it('inputEventClient::multi_input_tsApi_play_007, unregister not exist register function', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_play END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, '18', eventHandle);
            expect(unregisterResultFirst).assertEqual(MMI_STANDARD_EVENT_NOT_EXIST);
            console.log(`unregisterResultFirst:` + unregisterResultFirst);
            const unregisterResultSecond = inputEventClient.off(WINDOW_ID, 'play', eventHandle);
            expect(unregisterResultSecond).assertEqual(MMI_STANDARD_EVENT_SUCCESS)
    ...
    it('inputEventClient::multi_input_tsApi_play_008, inject space', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_play_009, repeat register', 0, function () {
        ...
        const registerResultFirst = inputEventClient.on(WINDOW_ID, 'play', eventHandle);
        expect(registerResultFirst).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
        if (registerResultFirst == MMI_STANDARD_EVENT_SUCCESS) {
            const registerResultSecond = inputEventClient.on(WINDOW_ID, 'play', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_play_010, repeat unregister', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_play_011, unregister without register', 0, function () {
        const eventHandle = (event) => {
            console.log(`inputEventClient:play_dataVerify`);
            console.log(`event.uuid:` + event.uuid);
            console.log(`event.occurredTime:` + event.occurredTime);
    ...
    it('inputEventClient::multi_input_tsApi_play_012, performance check', 0, function () {

        console.log(`inputEventClient::play_test: start`)
        let injectEvent = {
            eventFileName: traditionalEvent,
            jsonEvent: 'inject_event_remoteControl_key_play.json'
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            const unregisterResult = inputEventClient.off(WINDOW_ID, 'play', eventHandle);
            expect(unregisterResult).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
            console.log(`inputEventClient::play_test: unregister success`);
        }
        registerAverageTimeCheck(inputEventClient.on(WINDOW_ID, 'play', eventHandle), inputEventClient.off(WINDOW_ID, 'play', eventHandle));
        console.log(`inputEventClient::play_test: end`);
    })
})