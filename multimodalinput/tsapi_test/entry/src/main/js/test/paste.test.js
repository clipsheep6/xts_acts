...
describe('tsApi_paste_test', function () {
    it('inputEventClient::multi_input_tsApi_paste_001, keyboard:ctrl+v', 0, function () {

        let injectEvent = {
            eventFileName: traditionalEvent,
            jsonEvent: 'inject_event_keyboard_key_ctrl_v.json'
        }

        const eventHandle = (event) => {

            console.log(`inputEventClient:paste_dataVerify`);
            ...
            expect(event.type).assertEqual(EventCallback.ON_PASTE);
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            console.log(`inputEventClient:paste register success`);
            console.log(`inject_paste START`);
            let ret = inputEventClient.setInjectFile(WINDOW_ID, injectEvent);
            sleep(1000);
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_paste END`);
    ...
    it('inputEventClient::multi_input_tsApi_paste_002, aiSensor', 0, function () {
        let injectEvent = {
    ...
    it('inputEventClient::multi_input_tsApi_paste_003, not exist call back handler', 0, function () {
        console.log(`inputEventClient::paste start`);
        const registerResult = inputEventClient.on(WINDOW_ID, 'paste', 32323);
        expect(registerResult).assertEqual(MMI_STANDARD_EVENT_INVALID_PARAMETER);
        console.log(`registerResult:` + registerResult);
    })
    it('inputEventClient::multi_input_tsApi_paste_004, not exist register function', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_paste_005, register other ui standard function', 0, function () {
        let injectEvent = {
            eventFileName: traditionalEvent,
        ...
        const eventHandle = (event) => {
            ...
            expect(event.sourceDevice).assertEqual('1');
            expect(event.inputDeviceId).assertEqual('4');
            expect(event.type).assertNotEqual(EventCallback.ON_PASTE);
            console.log(`inputEventClient:dataVerify end`);
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'paste', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_paste_006, unregister not exist call back handler', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_paste END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'paste', 12321);
    ...
    it('inputEventClient::multi_input_tsApi_paste_007, unregister not exist register function', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_paste END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, '3', eventHandle);
            expect(unregisterResultFirst).assertEqual(MMI_STANDARD_EVENT_NOT_EXIST);
            console.log(`unregisterResultFirst:` + unregisterResultFirst);
            const unregisterResultSecond = inputEventClient.off(WINDOW_ID, 'paste', eventHandle);
            expect(unregisterResultSecond).assertEqual(MMI_STANDARD_EVENT_SUCCESS)
    ...
    it('inputEventClient::multi_input_tsApi_paste_008, inject space', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_paste_009, repeat register', 0, function () {
        ...
        const registerResultFirst = inputEventClient.on(WINDOW_ID, 'paste', eventHandle);
        expect(registerResultFirst).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
        if (registerResultFirst == MMI_STANDARD_EVENT_SUCCESS) {
            const registerResultSecond = inputEventClient.on(WINDOW_ID, 'paste', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_paste_010, repeat unregister', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_paste_011, unregister without register', 0, function () {
        const eventHandle = (event) => {
            console.log(`inputEventClient:paste_dataVerify`);
            console.log(`event.uuid:` + event.uuid);
            console.log(`event.occurredTime:` + event.occurredTime);
    ...
    it('inputEventClient::multi_input_tsApi_paste_012, performance check', 0, function () {
        ...
        const eventHandle = (event) => {
            ...
            expect(typeof (event.uuid) == 'string').assertEqual(true);
            expect(event.uuid.length == 36).assertEqual('');
            expect(event.occurredTime).assertEqual('0');
            expect(event.sourceDevice).assertEqual('1');
            expect(event.inputDeviceId).assertEqual('4');
            expect(event.type).assertEqual(EventCallback.ON_PASTE);
            ...
            console.log(`inputEventClient:paste dataVerify end`);
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            const unregisterResult = inputEventClient.off(WINDOW_ID, 'paste', eventHandle);
            expect(unregisterResult).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
            console.log(`inputEventClient::paste unregister success`)
        }
        registerAverageTimeCheck(inputEventClient.on(WINDOW_ID, 'paste', eventHandle), inputEventClient.off(WINDOW_ID, 'paste', eventHandle));
    })
})