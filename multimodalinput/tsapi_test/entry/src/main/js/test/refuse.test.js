...
describe('tsApi_refuse_test', function () {
    it('inputEventClient::multi_input_tsApi_refuse_001, aiSensor', 0, function () {
        let injectEvent = {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            console.log(`inputEventClient:refuse register success`);
            console.log(`inject_refuse START`);
            let ret = inputEventClient.setInjectFile(WINDOW_ID, injectEvent);
            sleep(1000);
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_refuse END`);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_002, not exist call back handler', 0, function () {
        console.log(`inputEventClient::refuse start`);
        const registerResult = inputEventClient.on(WINDOW_ID, 'refuse', 32323);
        expect(registerResult).assertEqual(MMI_STANDARD_EVENT_INVALID_PARAMETER);
        console.log(`registerResult:` + registerResult);
    })
    it('inputEventClient::multi_input_tsApi_refuse_003, not exist register function', 0, function () {
        ...
        const eventHandle = (event) => {
            ...
            expect(event.inputDeviceId).assertEqual('31');
            expect(event.type).assertEqual(EventCallback.ON_REFUSE);
            console.log(`inputEventClient:refuse_dataVerify end`);
        }
    ...
    it('inputEventClient::multi_input_tsApi_refuse_004, register other ui standard function', 0, function () {
        let injectEvent = {
        ...
        const eventHandle = (event) => {
            ...
            expect(event.type).assertNotEqual(EventCallback.ON_REFUSE);
            console.log(`inputEventClient:dataVerify end`);
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'refuse', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_005, unregister not exist call back handler', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_refuse END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, 'refuse', 12321);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_006, unregister not exist register function', 0, function () {
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            expect(ret).assertEqual(API_CONFIG_SUCCESS);
            console.log(`inject_refuse END`);
            const unregisterResultFirst = inputEventClient.off(WINDOW_ID, '15', eventHandle);
            expect(unregisterResultFirst).assertEqual(MMI_STANDARD_EVENT_NOT_EXIST);
            console.log(`unregisterResultFirst:` + unregisterResultFirst);
            const unregisterResultSecond = inputEventClient.off(WINDOW_ID, 'refuse', eventHandle);
            expect(unregisterResultSecond).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_007, inject space', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_refuse_008, repeat register', 0, function () {
        let injectEvent = {
            eventFileName: aiVoiceEvent,
            jsonEvent: '5002 1'
        }
        ...
        const registerResultFirst = inputEventClient.on(WINDOW_ID, 'refuse', eventHandle);
        expect(registerResultFirst).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
        if (registerResultFirst == MMI_STANDARD_EVENT_SUCCESS) {
            const registerResultSecond = inputEventClient.on(WINDOW_ID, 'refuse', eventHandle);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_009, repeat unregister', 0, function () {
    ...
    it('inputEventClient::multi_input_tsApi_refuse_010, unregister without register', 0, function () {
        const eventHandle = (event) => {
            console.log(`inputEventClient:refuse_dataVerify`);
            console.log(`event.uuid:` + event.uuid);
            console.log(`event.occurredTime:` + event.occurredTime);
    ...
    it('inputEventClient::multi_input_tsApi_refuse_011, performance check', 0, function () {
        ...
        const eventHandle = (event) => {
            ...
            console.log(`inputEventClient:refuse dataVerify end`);
        }
        ...
        if (registerResult == MMI_STANDARD_EVENT_SUCCESS) {
            ...
            const unregisterResult = inputEventClient.off(WINDOW_ID, 'refuse', eventHandle);
            expect(unregisterResult).assertEqual(MMI_STANDARD_EVENT_SUCCESS);
            console.log(`inputEventClient::refuse unregister success`);
        }
        registerAverageTimeCheck(inputEventClient.on(WINDOW_ID, 'refuse', eventHandle), inputEventClient.off(WINDOW_ID, 'refuse', eventHandle));
    })
})