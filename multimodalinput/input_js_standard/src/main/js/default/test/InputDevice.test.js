...
describe('MultimodalInput_test', function () {
  ...
  it('inputDevice::AxisRange_test-01', 0, function () {
      ...
      expect(  (inputDevice.AxisRange.source== 'keyboard' || 'mouse' || 'touchpad' || 'touchscreen' || 'joystick' || 'trackball')).assertTrue();
  ...
  it('inputDevice::AxisRange_test-02', 0, function () {
      ...
      expect(  (inputDevice.AxisRange.axis=='touchMajor' || 'touchMinor' || 'orientation' || 'x' || 'y' || 'pressure' || 'toolMinor' || 'toolMajor' || 'NULL')).assertTrue();
