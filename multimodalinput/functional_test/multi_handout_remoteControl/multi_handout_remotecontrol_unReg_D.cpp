...
class multiHandoutremotecontrolUnRegDTest : public testing::Test {
public:
...
StClientHelper multiHandoutremotecontrolUnRegDTest::st_client_helper_;

void multiHandoutremotecontrolUnRegDTest::SetUpTestCase()
{
...
void multiHandoutremotecontrolUnRegDTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandoutremotecontrolUnRegDTest::SetUp()
{
}

void multiHandoutremotecontrolUnRegDTest::TearDown()
{
}
 ...
 */
void multiHandoutremotecontrolUnRegDTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandoutremotecontrolUnRegDTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandoutremotecontrolUnRegDTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_002_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_002_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_007_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_007_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_012_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_012_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_017_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_017_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_022_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"|0|1|0,|1|0|0", "|0|1|0,|1|0|0"};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_022_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_027_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"|0|1|0,|1|0|0", "|0|1|0,|1|0|0"};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_027_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_032_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"|0|1|0,|1|0|0", "|0|1|0,|1|0|0"};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_032_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_037_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_037_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutremotecontrolUnRegDTest, Multi_HandOut_RemoteControl_Reg_App_047_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"|0|1|0,|1|0|0", "|0|1|0,|1|0|0"};
    DoCompareAndExpect(ci, "Multi_HandOut_RemoteControl_Reg_App_047_D");
}
}