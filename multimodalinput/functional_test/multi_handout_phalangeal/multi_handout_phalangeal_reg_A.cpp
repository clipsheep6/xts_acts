...
class multiHandoutphalangealRegATest : public testing::Test {
public:
...
StClientHelper multiHandoutphalangealRegATest::st_client_helper_;

void multiHandoutphalangealRegATest::SetUpTestCase()
{
...
void multiHandoutphalangealRegATest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandoutphalangealRegATest::SetUp()
{
}

void multiHandoutphalangealRegATest::TearDown()
{
}
 ...
 */
void multiHandoutphalangealRegATest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                                                   const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandoutphalangealRegATest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandoutphalangealRegATest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegATest, Multi_HandOut_Phalangeal_002_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"4001 1"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_002_A");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegATest, Multi_HandOut_Phalangeal_004_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"4002 1"};
    ci.deviceMsg = {"Phalangeal"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_004_A");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegATest, Multi_HandOut_Phalangeal_006_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"4003 1"};
    ci.deviceMsg = {"Phalangeal"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_006_A");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegATest, Multi_HandOut_Phalangeal_008_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"4004 1"};
    ci.deviceMsg = {"Phalangeal"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_008_A");
}
}