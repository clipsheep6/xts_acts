...
class multiHandoutphalangealRegCTest : public testing::Test {
public:
...
StClientHelper multiHandoutphalangealRegCTest::st_client_helper_;

void multiHandoutphalangealRegCTest::SetUpTestCase()
{
...
void multiHandoutphalangealRegCTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandoutphalangealRegCTest::SetUp()
{
}

void multiHandoutphalangealRegCTest::TearDown()
{
}
 ...
 */
void multiHandoutphalangealRegCTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandoutphalangealRegCTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandoutphalangealRegCTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegCTest, Multi_HandOut_Phalangeal_Unusual_001_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"40011", "40021", "40031", "40041"};
    ...
    ci.expectL3Event = {"|", "|", "|",
                        "|"};
    ci.combKeyList = {{{"4001","OnScreenShot"}}, {{"4002","OnScreenSplit"}}, {{"||"},{"4003","OnStartScreenRecord"}}, {{"||"},{"4004","OnStopScreenRecord"}}};
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_Unusual_001_C");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutphalangealRegCTest, Multi_HandOut_Phalangeal_Unusual_002_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"40011", "40021", "40031", "40041",
                    "40011", "40021", "40031", "40041",
                    "40011", "40021", "40031", "40041",
                    "40011", "40021", "40031", "40041",
                    "40011", "40021", "40031", "40041",
                    "40011", "40021", "40031", "40041",
    ...
    ci.dispatcherList = {"", "", "", "",
                         ...
                         "", "", "", "",
                         "", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Phalangeal_Unusual_002_C");
}
}