...
class multiHandouttouchscreenRegATest : public testing::Test {
public:
...
StClientHelper multiHandouttouchscreenRegATest::st_client_helper_;

void multiHandouttouchscreenRegATest::SetUpTestCase()
{
...
void multiHandouttouchscreenRegATest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttouchscreenRegATest::SetUp()
{
}

void multiHandouttouchscreenRegATest::TearDown()
{
}
 ...
 */
void multiHandouttouchscreenRegATest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttouchscreenRegATest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttouchscreenRegATest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
...
/*
 * Feature: Multi_HandOut_touch_016_A
 * Function: Multi_HandOut_touch_016_A
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttouchscreenRegATest, Multi_HandOut_touch_016_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"Multi_HandOut_touch_016-A_1.json", "Multi_HandOut_touch_016-A_2.json", "Multi_HandOut_touch_016-A_3.json", "Multi_HandOut_touch_016-A_4.json"};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>",
                             "eventTouch|<X>|<Y>"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ci.expectL3Event = {"500|2|<X>|<Y>|", "502|2|<X>|<Y>|", "502|2|<X>|<Y>|",
                        "501|2|<X>|<Y>|"};
    ci.combKeyList = {{{""}}, {{""}}, {{""}}, {{"4001","onScreenShot"}}};
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_touch_016_A");
}

/*
 * Feature: Multi_HandOut_touch_017_A
 * Function: Multi_HandOut_touch_017_A
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttouchscreenRegATest, Multi_HandOut_touch_017_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"Multi_HandOut_touch_017-A_1.json", "Multi_HandOut_touch_017-A_2.json", "Multi_HandOut_touch_017-A_3.json", "Multi_HandOut_touch_017-A_4.json"};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>",
                             "eventTouch|<X>|<Y>"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ...
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_touch_017_A");
}

/*
 * Feature: Multi_HandOut_touch_018_A
 * Function: Multi_HandOut_touch_018_A
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttouchscreenRegATest, Multi_HandOut_touch_018_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"Multi_HandOut_touch_018-A_1.json", "Multi_HandOut_touch_018-A_2.json", "Multi_HandOut_touch_018-A_3.json", "Multi_HandOut_touch_018-A_4.json"};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>",
                             "eventTouch|<X>|<Y>"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ...
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_touch_018_A");
}

/*
 * Feature: Multi_HandOut_touch_019_A
 * Function: Multi_HandOut_touch_019_A
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttouchscreenRegATest, Multi_HandOut_touch_019_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"Multi_HandOut_touch_019-A_1.json", "Multi_HandOut_touch_019-A_2.json", "Multi_HandOut_touch_019-A_3.json", "Multi_HandOut_touch_019-A_4.json"};
    ci.deviceMsg = {"", "", "", ""};
    ci.libinputExpectList = {"eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>", "eventTouch|<X>|<Y>",
                             "eventTouch|<X>|<Y>"};
    ci.standardExpectList = {"/", "/", "/", "/"};
    ...
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_touch_019_A");
}
}