...
class multiHandouttrackballRegCTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackballRegCTest::st_client_helper_;

void multiHandouttrackballRegCTest::SetUpTestCase()
{
...
void multiHandouttrackballRegCTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackballRegCTest::SetUp()
{
}

void multiHandouttrackballRegCTest::TearDown()
{
}
 ...
 */
void multiHandouttrackballRegCTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackballRegCTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballRegCTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballRegCTest, Multi_HandOut_Trackball_Reg_015_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
