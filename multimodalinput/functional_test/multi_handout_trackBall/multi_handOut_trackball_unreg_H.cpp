...
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackball_leftbtn_press.json", "trackball_move2.json", "trackball_leftbtn_release.json"};
    ci.deviceMsg = {"", "", ""};    
...
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackball_leftbtn_longpress.json", "trackball_rightbtn_press.json", "trackball_rightbtn_release.json", "trackball_leftbtn_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
...
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_KEY_CTRL_LEFT_press.json", "trackball_leftbtn_press.json", "trackball_leftbtn_release.json", "keyboard_KEY_CTRL_LEFT_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
...
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_KEY_SHIFT_LEFT_press.json", "trackball_leftbtn_press.json", "trackball_leftbtn_release.json", "keyboard_KEY_SHIFT_LEFT_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
