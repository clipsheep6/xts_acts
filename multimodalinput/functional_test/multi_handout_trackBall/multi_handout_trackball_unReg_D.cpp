...
class multiHandouttrackballUnRegDTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackballUnRegDTest::st_client_helper_;

void multiHandouttrackballUnRegDTest::SetUpTestCase()
{
...
void multiHandouttrackballUnRegDTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackballUnRegDTest::SetUp()
{
}

void multiHandouttrackballUnRegDTest::TearDown()
{
}
 ...
 */
void multiHandouttrackballUnRegDTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackballUnRegDTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballUnRegDTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballUnRegDTest, Multi_HandOut_Trackball_Reg_002_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballUnRegDTest, Multi_HandOut_Trackball_Reg_008_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballUnRegDTest, Multi_HandOut_Trackball_Reg_014_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
