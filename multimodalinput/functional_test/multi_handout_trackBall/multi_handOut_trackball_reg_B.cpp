...
class multiHandouttrackballRegBTest : public testing::Test {
public:
...
void multiHandouttrackballRegBTest::SetUpTestCase()
{
    GetSTHelper().InitClient("Scene_B");
    sleep(1);
}

void multiHandouttrackballRegBTest::SetUp()
{
}

void multiHandouttrackballRegBTest::TearDown()
{
 ...
 */
void multiHandouttrackballRegBTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballRegBTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballRegBTest, Multi_HandOut_Trackball_Reg_001_B, TestSize.Level0)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballRegBTest_Test, Multi_HandOut_Trackball_Reg_007_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballRegBTest_Test, Multi_HandOut_Trackball_Reg_013_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
