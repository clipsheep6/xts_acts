...
class multiHandouttrackpadUnRegDTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackpadUnRegDTest::st_client_helper_;

void multiHandouttrackpadUnRegDTest::SetUpTestCase()
{
...
void multiHandouttrackpadUnRegDTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackpadUnRegDTest::SetUp()
{
}

void multiHandouttrackpadUnRegDTest::TearDown()
{
}
 ...
 */
void multiHandouttrackpadUnRegDTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackpadUnRegDTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackpadUnRegDTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegDTest, Multi_HandOut_TrackPad_Reg_App_022_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegDTest, Multi_HandOut_TrackPad_Reg_App_027_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegDTest, Multi_HandOut_TrackPad_Reg_App_032_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegDTest, Multi_HandOut_TrackPad_Reg_App_037_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegDTest, Multi_HandOut_TrackPad_Reg_App_042_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
