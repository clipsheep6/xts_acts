...
class multiHandouttrackpadUnRegRTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackpadUnRegRTest::st_client_helper_;

void multiHandouttrackpadUnRegRTest::SetUpTestCase()
{
...
void multiHandouttrackpadUnRegRTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackpadUnRegRTest::SetUp()
{
}

void multiHandouttrackpadUnRegRTest::TearDown()
{
}
 ...
 */
std::string multiHandouttrackpadUnRegRTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackpadUnRegRTest::DoCompareAndExpect(const struct CaseInfo &ci)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_077_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {};
    ci.deviceMsg = {};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_078_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {};
    ci.deviceMsg = {};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_079_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "keyboard_Ctrl_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_080_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Shift_press.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "keyboard_Shift_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_081_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "trackpad_singlefinger_press.json",
                    "trackpad_singlefinger_release.json", "keyboard_Ctrl_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
    ci.libinputExpectList = {"eventKeyboard|29|1", "eventPointer|272|1", "eventPointer|272|0",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_084_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_085_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_086_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_left_press.json", "trackpad_btn_left_release.json", "trackpad_btn_left_press.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", "", "",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_087_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_longpress.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|272|0"};
    ci.standardExpectList = {"402|500|272|1|0|0", "402|501|272|0|0|0"};
    ci.expectL3Event = {"eventPointer|1|1|", "eventPointer|1|0|"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_119_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "trackpad_singlefinger_press.json",
                    "trackpad_singlefinger_release.json", "keyboard_Ctrl_release.json"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_120_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "trackpad_singlefinger_press.json",
                    "trackpad_singlefinger_release.json", "trackpad_singlefinger_press.json", "trackpad_singlefinger_release.json", "trackpad_singlefinger_press.json",
                    "trackpad_singlefinger_release.json", "keyboard_Ctrl_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_130_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_singlefinger_right_move.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|35|0", "eventPointer|272|0"};
    ci.standardExpectList = {"402|500|272|1|0|0", "400|502|272|1|35|0", "402|501|272|0|0|0"};
    ci.expectL3Event = {"eventPointer|1|1|", "eventPointer|35|0|", "eventPointer|1|0|"};
    ci.dispatcherList = {"", "", ""};
    DoCompareAndExpect(ci);
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_131_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_singlefinger_down_move.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|0|32", "eventPointer|272|0"};
    ci.standardExpectList = {"402|500|272|1|0|0", "400|502|272|1|0|32", "402|501|272|0|0|0"};
    ci.expectL3Event = {"eventPointer|1|1|", "eventPointer|0|32|", "eventPointer|1|0|"};
    ci.dispatcherList = {"", "", ""};
    DoCompareAndExpect(ci);
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_132_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_singlefinger_left_move.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|-35|0", "eventPointer|272|0"};
    ci.standardExpectList = {"402|500|272|1|0|0", "400|502|272|1|-35|0", "402|501|272|0|0|0"};
    ci.expectL3Event = {"eventPointer|1|1|", "eventPointer|-35|0|", "eventPointer|1|0|"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_133_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_singlefinger_up_move.json", "trackpad_btn_left_release.json"};
    ci.deviceMsg = {"", "", ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|0|-32", "eventPointer|272|0"};
    ci.standardExpectList = {"402|500|272|1|0|0", "400|502|272|1|0|-32", "402|501|272|0|0|0"};
    ci.expectL3Event = {"eventPointer|1|1|", "eventPointer|0|-32|", "eventPointer|1|0|"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_138_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_right_press.json", "trackpad_btn_left_release.json", "trackpad_btn_right_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_139_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_right_press.json", "trackpad_singlefinger_right_move.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_right_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|273|1", "eventPointer|273|0",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_140_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_right_press.json", "trackpad_singlefinger_down_move.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_right_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|273|1", "eventPointer|273|0",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_141_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_right_press.json", "trackpad_singlefinger_left_move.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_right_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|273|1", "eventPointer|273|0",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_142_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"trackpad_btn_left_press.json", "trackpad_btn_right_press.json", "trackpad_singlefinger_up_move.json", "trackpad_btn_left_release.json",
                    "trackpad_btn_right_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             ""};    
    ci.libinputExpectList = {"eventPointer|272|1", "eventPointer|273|1", "eventPointer|273|0",
...
/*
 * Feature: Multi_HandOut_TrackPad_UnReg_Unusual_001_R
 * Function: Multi_HandOut_TrackPad_UnReg_Unusual_001_R
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_UnReg_Unusual_001_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {};
    ci.deviceMsg = {};    
...
/*
 * Feature: Multi_HandOut_TrackPad_UnReg_Unusual_002_R
 * Function: Multi_HandOut_TrackPad_UnReg_Unusual_002_R
 * SubFunction: NA
 * FunctionPoints: NA
 * EnvConditions: NA
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_UnReg_Unusual_002_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {};
    ci.deviceMsg = {};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_214_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_btn_right_press.json", "trackpad_btn_right_release.json", "keyboard_Ctrl_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_215_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Shift_press.json", "trackpad_btn_right_press.json", "trackpad_btn_right_release.json", "keyboard_Shift_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_228_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Ctrl_press.json", "trackpad_twofingers_press.json", "trackpad_twofingers_release.json", "keyboard_Ctrl_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
    ci.libinputExpectList = {"eventKeyboard|29|1", "eventPointer|273|1", "eventPointer|273|0",
                             "eventKeyboard|29|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadUnRegRTest, Multi_HandOut_TrackPad_Reg_216_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"keyboard_Shift_press.json", "trackpad_twofingers_press.json", "trackpad_twofingers_release.json", "keyboard_Shift_release.json"};
    ci.deviceMsg = {"", "", "", ""};    
    ci.libinputExpectList = {"eventKeyboard|42|1", "eventPointer|273|1", "eventPointer|273|0",
                             "eventKeyboard|42|0"};
    ci.standardExpectList = {"/", "/", "/", "/"};
