...
class multiHandoutmouseRegATest : public testing::Test {
public:
...
StClientHelper multiHandoutmouseRegATest::st_client_helper_;

void multiHandoutmouseRegATest::SetUpTestCase()
{
...
void multiHandoutmouseRegATest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandoutmouseRegATest::SetUp()
{
}

void multiHandoutmouseRegATest::TearDown()
{
}
 ...
 */
void multiHandoutmouseRegATest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandoutmouseRegATest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandoutmouseRegATest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegATest, Multi_HandOut_Mouse_Reg_Sys_003_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.expectL3Event = {"eventPointer|4|1|", "eventPointer|4|0|", "eventPointer|4|1|",
                        "eventPointer|4|0|"};
    ci.combKeyList = {{{""}}, {{"1113","OnBack"}}, {{""}}, {{"4006","OnRecent"}}};
    ci.dispatcherList = {"", "", "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_Sys_003_A");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegATest, Multi_HandOut_Mouse_Reg_Sys_004_A, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_Sys_004_A");
}
}