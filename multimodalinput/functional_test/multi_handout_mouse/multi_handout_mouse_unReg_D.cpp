...
class multiHandoutmouseUnRegDTest : public testing::Test {
public:
...
StClientHelper multiHandoutmouseUnRegDTest::st_client_helper_;

void multiHandoutmouseUnRegDTest::SetUpTestCase()
{
...
void multiHandoutmouseUnRegDTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandoutmouseUnRegDTest::SetUp()
{
}

void multiHandoutmouseUnRegDTest::TearDown()
{
}
 ...
 */
void multiHandoutmouseUnRegDTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandoutmouseUnRegDTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandoutmouseUnRegDTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseUnRegDTest, Multi_HandOut_Mouse_Reg_App_002_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_002_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseUnRegDTest, Multi_HandOut_Mouse_Reg_App_008_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_008_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseUnRegDTest, Multi_HandOut_Mouse_Reg_App_014_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}};
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_014_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseUnRegDTest, Multi_HandOut_Mouse_Reg_App_020_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.combKeyList = {{{""}}};
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_020_D");
}
}