...
class multiHandoutmouseRegBTest : public testing::Test {
public:
...
void multiHandoutmouseRegBTest::SetUpTestCase()
{
    GetSTHelper().InitClient("Scene_B");
    sleep(1);
}

void multiHandoutmouseRegBTest::SetUp()
{
}

void multiHandoutmouseRegBTest::TearDown()
{
 ...
 */
void multiHandoutmouseRegBTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
void multiHandoutmouseRegBTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegBTest, Multi_HandOut_Mouse_Reg_App_001_B, TestSize.Level0)
{
    ...
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_001_B");
}
/*
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegBTest_Test, Multi_HandOut_Mouse_Reg_App_007_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_007_B");
}
/*
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegBTest_Test, Multi_HandOut_Mouse_Reg_App_013_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_013_B");
}
/*
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandoutmouseRegBTest_Test, Multi_HandOut_Mouse_Reg_App_019_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Mouse_Reg_App_019_B");
}
}