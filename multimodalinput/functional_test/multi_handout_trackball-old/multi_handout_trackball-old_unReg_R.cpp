...
class multiHandouttrackballoldUnRegRTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackballoldUnRegRTest::st_client_helper_;

void multiHandouttrackballoldUnRegRTest::SetUpTestCase()
{
...
void multiHandouttrackballoldUnRegRTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackballoldUnRegRTest::SetUp()
{
}

void multiHandouttrackballoldUnRegRTest::TearDown()
{
}
 ...
 */
std::string multiHandouttrackballoldUnRegRTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballoldUnRegRTest::DoCompareAndExpect(const struct CaseInfo &ci)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_001_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", ""};
    ci.deviceMsg = {"", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_006_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_011_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_164_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", "", ""};
    ci.deviceMsg = {"", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_169_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", "", ""};
    ci.deviceMsg = {"", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_206_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", ""};
    ci.deviceMsg = {"", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_207_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_258_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", "", "", ""};
    ci.deviceMsg = {"", "", "", ""};    
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldUnRegRTest, Multi_HandOut_Trackball_UnReg_259_R, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"", "", "", ""};
    ci.deviceMsg = {"", "", "", ""};    
