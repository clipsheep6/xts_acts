...
class multiHandouttrackballoldRegBTest : public testing::Test {
public:
...
void multiHandouttrackballoldRegBTest::SetUpTestCase()
{
    GetSTHelper().InitClient("Scene_B");
    sleep(1);
}

void multiHandouttrackballoldRegBTest::SetUp()
{
}

void multiHandouttrackballoldRegBTest::TearDown()
{
 ...
 */
void multiHandouttrackballoldRegBTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballoldRegBTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegBTest, Multi_HandOut_Trackball_Reg_001_B, TestSize.Level0)
{
    ...
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_Trackball_Reg_001_B");
}
/*
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegBTest_Test, Multi_HandOut_Trackball_Reg_007_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.flagList = {"1"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Trackball_Reg_007_B");
}
/*
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegBTest_Test, Multi_HandOut_Trackball_Reg_013_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.flagList = {"1"};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Trackball_Reg_013_B");
}
}