...
class multiHandouttrackballoldRegCTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackballoldRegCTest::st_client_helper_;

void multiHandouttrackballoldRegCTest::SetUpTestCase()
{
...
void multiHandouttrackballoldRegCTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackballoldRegCTest::SetUp()
{
}

void multiHandouttrackballoldRegCTest::TearDown()
{
}
 ...
 */
void multiHandouttrackballoldRegCTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackballoldRegCTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackballoldRegCTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegCTest, Multi_HandOut_Trackball_Reg_003_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", ""};
    ci.deviceMsg = {"", ""};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegCTest, Multi_HandOut_Trackball_Reg_009_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackballoldRegCTest, Multi_HandOut_Trackball_Reg_015_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_Trackball_Reg_015_C");
}
}