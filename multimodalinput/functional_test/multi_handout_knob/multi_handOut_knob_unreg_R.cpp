...
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {""}};
    ci.eventList = {"knob_model2_leftctrl_press.json", "knob_model2_leftalt_press.json", "knob_model2_n_press.json",
                    "knob_model2_leftctrl_release.json","knob_model2_leftalt_release.json", "knob_model2_n_release.json"};
    ci.deviceMsg = {"", "", "", "",
                             "", ""};    
