...
class multiHandouttrackpadoldRegBTest : public testing::Test {
public:
...
void multiHandouttrackpadoldRegBTest::SetUpTestCase()
{
    GetSTHelper().InitClient("Scene_B");
    sleep(1);
}

void multiHandouttrackpadoldRegBTest::SetUp()
{
}

void multiHandouttrackpadoldRegBTest::TearDown()
{
 ...
 */
void multiHandouttrackpadoldRegBTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackpadoldRegBTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegBTest, Multi_HandOut_TrackPad_Reg_App_021_B, TestSize.Level0)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegBTest_Test, Multi_HandOut_TrackPad_Reg_App_026_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.flagList = {"1"};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegBTest_Test, Multi_HandOut_TrackPad_Reg_App_031_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", ""};
    ci.flagList = {"1", ""};
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegBTest_Test, Multi_HandOut_TrackPad_Reg_App_036_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegBTest_Test, Multi_HandOut_TrackPad_Reg_App_041_B, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
