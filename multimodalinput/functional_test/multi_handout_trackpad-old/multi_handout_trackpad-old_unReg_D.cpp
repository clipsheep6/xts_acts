...
class multiHandouttrackpadoldUnRegDTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackpadoldUnRegDTest::st_client_helper_;

void multiHandouttrackpadoldUnRegDTest::SetUpTestCase()
{
...
void multiHandouttrackpadoldUnRegDTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackpadoldUnRegDTest::SetUp()
{
}

void multiHandouttrackpadoldUnRegDTest::TearDown()
{
}
 ...
 */
void multiHandouttrackpadoldUnRegDTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackpadoldUnRegDTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackpadoldUnRegDTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldUnRegDTest, Multi_HandOut_TrackPad_Reg_App_022_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
    ...
    ci.combKeyList = {{{""}}};
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_022_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldUnRegDTest, Multi_HandOut_TrackPad_Reg_App_027_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
    ...
    ci.combKeyList = {{{""}}};
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_027_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldUnRegDTest, Multi_HandOut_TrackPad_Reg_App_032_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", ""};
    ci.deviceMsg = {"", ""};
    ...
    ci.combKeyList = {{{""}}, {{""}}};
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_032_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldUnRegDTest, Multi_HandOut_TrackPad_Reg_App_037_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
    ...
    ci.deviceMsg = {"", "", "", "",
                             "", "", "", "",
                             "", ""};
    ci.libinputExpectList = {"eventPointer|0|30", "eventPointer|0|30", "eventPointer|0|30",
                             "eventPointer|0|30", "eventPointer|0|30", "eventPointer|0|30",
                             "eventPointer|0|30", "eventPointer|0|30", "eventPointer|0|30",
                             "eventPointer|0|30"};
    ci.standardExpectList = {"/", "/", "/", "/",
                             "/", "/", "/", "/",
                             "/", "/"};
    ci.expectL3Event = {"eventPointer|0|30|", "eventPointer|0|30|", "eventPointer|0|30|",
                        "eventPointer|0|30|", "eventPointer|0|30|", "eventPointer|0|30|",
                        "eventPointer|0|30|", "eventPointer|0|30|", "eventPointer|0|30|",
                        "eventPointer|0|30|"};
    ci.combKeyList = {{{""}}, {{""}}, {{""}}, {{""}}, {{""}}, {{""}}, {{""}}, {{""}}, {{""}}, {{""}}};
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", "",
                         "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_037_D");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldUnRegDTest, Multi_HandOut_TrackPad_Reg_App_042_D, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
    ...
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", "",
                         "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_042_D");
}
}