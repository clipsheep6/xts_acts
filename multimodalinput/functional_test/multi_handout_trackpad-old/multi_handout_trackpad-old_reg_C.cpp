...
class multiHandouttrackpadoldRegCTest : public testing::Test {
public:
...
StClientHelper multiHandouttrackpadoldRegCTest::st_client_helper_;

void multiHandouttrackpadoldRegCTest::SetUpTestCase()
{
...
void multiHandouttrackpadoldRegCTest::TearDownTestCase(void)
{
    st_client_helper_.StopStClient();
}

void multiHandouttrackpadoldRegCTest::SetUp()
{
}

void multiHandouttrackpadoldRegCTest::TearDown()
{
}
 ...
 */
void multiHandouttrackpadoldRegCTest::ExpectCombKey(const std::vector<std::vector<std::vector<std::string>>> &combKeyList,
                            const size_t i)
{
 ...
 * CaseDescription: set log print level
 */
std::string multiHandouttrackpadoldRegCTest::ReplaceExpectXY(std::string str,
 ...
 * CaseDescription: set log print level
 */
void multiHandouttrackpadoldRegCTest::DoCompareAndExpect(const struct CaseInfo &ci, std::string caseNum)
{
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegCTest, Multi_HandOut_TrackPad_Reg_App_023_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_023_C");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegCTest, Multi_HandOut_TrackPad_Reg_App_028_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {""};
    ci.deviceMsg = {""};
    ...
    ci.dispatcherList = {""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_028_C");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegCTest, Multi_HandOut_TrackPad_Reg_App_033_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", ""};
    ci.deviceMsg = {"", ""};
    ...
    ci.dispatcherList = {"", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_033_C");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegCTest, Multi_HandOut_TrackPad_Reg_App_038_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
    ...
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", "",
                         "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_038_C");
}
 ...
 * CaseDescription: set log print level
 */
HWTEST_F(multiHandouttrackpadoldRegCTest, Multi_HandOut_TrackPad_Reg_App_043_C, TestSize.Level0)
{
    struct CaseInfo ci = {{""}, {""}, {""}, {""}, {""}, {{{""}}}, {""}};
    ci.eventList = {"", "", "", "",
                    "", "", "", "",
    ...
    ci.dispatcherList = {"", "", "", "",
                         "", "", "", "",
                         "", ""};
    DoCompareAndExpect(ci, "Multi_HandOut_TrackPad_Reg_App_043_C");
}
}