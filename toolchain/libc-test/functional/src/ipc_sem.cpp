...
/**  
* @brief  register a test suit named "IpcSemSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  hello_world
* @param  test suit name is  IpcSemSuite
*/

using namespace std;
using namespace testing::ext;
class IpcSemSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : IpcSemSuite001
 * @tc.desc      : Test IpcSemSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
#if 0
...
HWTEST_F(IpcSemSuite, IpcSemSuite001, Function | MediumTest | Level2)
{
    int p;
	int status;
