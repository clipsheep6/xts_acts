...
/**  
* @brief  register a test suit named "FnmatchSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  hello_world
* @param  test suit name is  FnmatchSuite
*/
...
/**
 * @tc.name      : FnmatchSuite001
 * @tc.desc      : Test FnmatchSuite001 3 items whth async flush
 * @tc.level     : Level 2
 */
...
HWTEST_F(FnmatchSuite, FnmatchSuite001, Function | MediumTest | Level2)
{  
   int i;
