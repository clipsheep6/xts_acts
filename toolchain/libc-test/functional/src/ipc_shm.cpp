...
/**  
* @brief  register a test suit named "IpcShmSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  hello_world
* @param  test suit name is  IpcShmSuite
*/


using namespace std;
using namespace testing::ext;
class IpcShmSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : IpcShmSuite001
 * @tc.desc      : Test IpcShmSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
static void Get()
{
	...
	if (strcmp((const char *)p, "test data") != 0)
...
HWTEST_F(IpcShmSuite, IpcShmSuite001, Function | MediumTest | Level2)
{
    int p;
	int status;
