...
/**  
* @brief  register a test suit named "PthreadMutexPiSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  PthreadMutexPiSuite
*/
...
/**
 * @tc.name      : PthreadMutexPiSuite001
 * @tc.desc      : Test PthreadMutexPiSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(PthreadMutexPiSuite, PthreadMutexPiSuite001, Function | MediumTest | Level2)
{
    int i;
