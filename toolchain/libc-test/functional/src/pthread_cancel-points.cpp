...
/**  
* @brief  register a test suit named "PthreadCancelPointsSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  hello_world
* @param  test suit name is  PthreadCancelPointsSuite
*/
...
/**
 * @tc.name      : PthreadCancelPointsSuite001
 * @tc.desc      : Test PthreadCancelPointsSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(PthreadCancelPointsSuite, PthreadCancelPointsSuite001, Function | MediumTest | Level2)
{
