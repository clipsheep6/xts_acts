...
/**  
* @brief  register a test suit named "FloorlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  FloorlSuite
*/

using namespace std;
using namespace testing::ext;
class FloorlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : FloorlSuite001
 * @tc.desc      : Test FloorlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(FloorlSuite, FloorfTest, Function | MediumTest | Level2)
{
