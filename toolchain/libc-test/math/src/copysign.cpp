...
/**  
* @brief  register a test suit named "CopysignSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  CopysignSuite
*/
...
/**
 * @tc.name      : CopysignSuite001
 * @tc.desc      : Test CopysignSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
