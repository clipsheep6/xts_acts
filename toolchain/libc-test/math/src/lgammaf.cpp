...
/**  
* @brief  register a test suit named "LgammafSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LgammafSuite
*/
...
/**
 * @tc.name      : LgammafSuite001
 * @tc.desc      : Test LgammafSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
