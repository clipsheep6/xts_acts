...
/**  
* @brief  register a test suit named "NextafterfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  NextafterfSuite
*/

using namespace std;
using namespace testing::ext;
class NextafterfSuite: public testing::Test {
protected:
...
HWTEST_F(NextafterfSuite, NextafterfTest, Function | MediumTest | Level2)
{
