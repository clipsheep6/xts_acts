...
/**  
* @brief  register a test suit named "LlroundlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LlroundlSuite
*/

using namespace std;
using namespace testing::ext;
class LlroundlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LlroundlSuite001
 * @tc.desc      : Test LlroundlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_i t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(LlroundlSuite, LlroundlTest, Function | MediumTest | Level2)
{
