...
/**  
* @brief  register a test suit named "NexttowardlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  NexttowardlSuite
*/

using namespace std;
using namespace testing::ext;
class NexttowardlSuite: public testing::Test {
protected:
...
HWTEST_F(NexttowardlSuite, NexttowardlTest, Function | MediumTest | Level2)
{
