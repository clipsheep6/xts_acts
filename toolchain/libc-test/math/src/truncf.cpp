...
/**  
* @brief  register a test suit named "TruncfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  TruncfSuite
*/
...
/**
 * @tc.name      : TruncfSuite001
 * @tc.desc      : Test LTruncfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct f_f t[] = {
