...
/**  
* @brief  register a test suit named "NearbyintlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  NearbyintlSuite
*/

using namespace std;
using namespace testing::ext;
class NearbyintlSuite: public testing::Test {
protected:
...
HWTEST_F(NearbyintlSuite, NearbyintlTest, Function | MediumTest | Level2)
{
