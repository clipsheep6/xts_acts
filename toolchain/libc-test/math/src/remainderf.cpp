...
/**  
* @brief  register a test suit named "RemainderfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  RemainderfSuite
*/

using namespace std;
using namespace testing::ext;
class RemainderfSuite: public testing::Test {
protected:
...
HWTEST_F(RemainderfSuite, RemainderfTest, Function | MediumTest | Level2)
{
