...
/**  
* @brief  register a test suit named "LlrintfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LlrintfSuite
*/
...
/**
 * @tc.name      : LlrintfSuite001
 * @tc.desc      : Test LlrintfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct f_i t[] = {
