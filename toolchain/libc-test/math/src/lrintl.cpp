...
/**  
* @brief  register a test suit named "LrintlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LrintlSuite
*/

using namespace std;
using namespace testing::ext;
class LrintlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LrintlSuite001
 * @tc.desc      : Test LrintlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_i t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(LrintlSuite, LrintlTest, Function | MediumTest | Level2)
{
