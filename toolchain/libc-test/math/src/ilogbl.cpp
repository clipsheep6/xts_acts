...
/**  
* @brief  register a test suit named "IlogblSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  IlogblSuite
*/

using namespace std;
using namespace testing::ext;
class IlogblSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : IlogblSuite001
 * @tc.desc      : Test IlogblSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_i t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(IlogblSuite, IlogblTest, Function | MediumTest | Level2)
{
