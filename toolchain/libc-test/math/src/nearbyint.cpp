...
/**  
* @brief  register a test suit named "NearbyintSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  NearbyintSuite
*/

using namespace std;
using namespace testing::ext;
class NearbyintSuite: public testing::Test {
protected:
...
HWTEST_F(NearbyintSuite, NearbyintTest, Function | MediumTest | Level2)
{
