...
/**  
* @brief  register a test suit named "TruncSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  TruncSuite
*/

using namespace std;
using namespace testing::ext;
class TruncSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : TruncSuite001
 * @tc.desc      : Test LTruncSuite001 3 items whth async flush
 * @tc.level     : Level 2
 */
static struct d_d t[] = {
...
HWTEST_F(TruncSuite, TruncTest, Function | MediumTest | Level2)
{
