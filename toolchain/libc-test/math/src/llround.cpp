...
/**  
* @brief  register a test suit named "LlroundSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LlroundSuite
*/

using namespace std;
using namespace testing::ext;
class LlroundSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LlroundSuite001
 * @tc.desc      : Test LlroundSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct d_i t[] = {
...
HWTEST_F(LlroundSuite, LlroundTest, Function | MediumTest | Level2)
{
