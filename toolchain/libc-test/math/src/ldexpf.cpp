...
/**  
* @brief  register a test suit named "LdexpfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LdexpfSuite
*/

using namespace std;
using namespace testing::ext;
class LdexpfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LdexpfSuite001
 * @tc.desc      : Test LdexpfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(LdexpfSuite, LdexpfTest, Function | MediumTest | Level2)
{
