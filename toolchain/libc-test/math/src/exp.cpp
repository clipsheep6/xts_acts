...
/**  
* @brief  register a test suit named "ExpSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ExpSuite
*/
...
/**
 * @tc.name      : ExpSuite001
 * @tc.desc      : Test ExpSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct d_d t[] = {
...
HWTEST_F(ExpSuite, ExpTest, Function | MediumTest | Level2)
{
