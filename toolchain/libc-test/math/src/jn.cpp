...
/**  
* @brief  register a test suit named "JnSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  JnSuite
*/

using namespace std;
using namespace testing::ext;
class JnSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : JnSuite001
 * @tc.desc      : Test JnSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(JnSuite, JnTest, Function | MediumTest | Level2)
{
