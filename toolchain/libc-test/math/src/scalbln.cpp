...
/**  
* @brief  register a test suit named "ScalblnSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalblnSuite
*/
...
/**
 * @tc.name      : ScalblnSuite001
 * @tc.desc      : Test LScalblnSuite001 3 items whth async flush
 * @tc.level     : Level 2
 */
