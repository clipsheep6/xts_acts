...
/**  
* @brief  register a test suit named "LlroundfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LlroundfSuite
*/

using namespace std;
using namespace testing::ext;
class LlroundfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LlroundfSuite001
 * @tc.desc      : Test LlroundfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct f_i t[] = {
...
HWTEST_F(LlroundfSuite, LlroundfTest, Function | MediumTest | Level2)
{
