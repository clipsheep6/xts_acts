...
/**  
* @brief  register a test suit named "NearbyintfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  NearbyintfSuite
*/

using namespace std;
using namespace testing::ext;
class NearbyintfSuite: public testing::Test {
protected:
...
HWTEST_F(NearbyintfSuite, NearbyintfTest, Function | MediumTest | Level2)
{
