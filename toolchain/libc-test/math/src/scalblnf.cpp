...
/**  
* @brief  register a test suit named "ScalblnfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalblnfSuite
*/

using namespace std;
using namespace testing::ext;
class ScalblnfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : ScalblnfSuite001
 * @tc.desc      : Test LScalblnfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(ScalblnfSuite, ScalblnfTest, Function | MediumTest | Level2)
{
