...
/**  
* @brief  register a test suit named "RoundSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  RoundSuite
*/
...
HWTEST_F(RoundSuite, RoundTest, Function | MediumTest | Level2)
{
