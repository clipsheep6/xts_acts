...
/**  
* @brief  register a test suit named "Exp10lSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  Exp10lSuite
*/
...
/**
 * @tc.name      : Exp10lSuite001
 * @tc.desc      : Test Exp10lSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
