...
/**  
* @brief  register a test suit named "RoundlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  RoundlSuite
*/

using namespace std;
using namespace testing::ext;
class RoundlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : RoundlSuite001
 * @tc.desc      : Test LRoundlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(RoundlSuite, RoundlTest, Function | MediumTest | Level2)
{
