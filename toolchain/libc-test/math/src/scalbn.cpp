...
/**  
* @brief  register a test suit named "ScalbnSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalbnSuite
*/

using namespace std;
using namespace testing::ext;
class ScalbnSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : ScalbnSuite001
 * @tc.desc      : Test LScalbnSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(ScalbnSuite, ScalbnTest, Function | MediumTest | Level2)
{
