...
/**  
* @brief  register a test suit named "FloorSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  FloorSuite
*/

using namespace std;
using namespace testing::ext;
class FloorSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : FloorSuite001
 * @tc.desc      : Test FloorSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct d_d t[] = {
#include "ucb/floor.h"
...
HWTEST_F(FloorSuite, FloorTest, Function | MediumTest | Level2)
{
