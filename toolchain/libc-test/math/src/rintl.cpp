...
/**  
* @brief  register a test suit named "RintlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  RintlSuite
*/

using namespace std;
using namespace testing::ext;
class RintlSuite: public testing::Test {
protected:
...
HWTEST_F(RintlSuite, RintlTest, Function | MediumTest | Level2)
{
