...
/**  
* @brief  register a test suit named "LdexpSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LdexpSuite
*/

using namespace std;
using namespace testing::ext;
class LdexpSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LdexpSuite001
 * @tc.desc      : Test LdexpSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(LdexpSuite, LdexpTest, Function | MediumTest | Level2)
{
