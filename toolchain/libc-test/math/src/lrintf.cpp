...
/**  
* @brief  register a test suit named "LrintfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LrintfSuite
*/

using namespace std;
using namespace testing::ext;
class LrintfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LrintfSuite001
 * @tc.desc      : Test LrintfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct f_i t[] = {
...
HWTEST_F(LrintfSuite, LrintfTest, Function | MediumTest | Level2)
{
