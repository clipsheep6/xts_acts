...
/**  
* @brief  register a test suit named "AsinhfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  AsinhfSuite
*/
...
/**
 * @tc.name      : AsinhfSuite001
 * @tc.desc      : Test AsinhfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct f_f t[] = {
