...
/**  
* @brief  register a test suit named "TrunclSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  TrunclSuite
*/
...
/**
 * @tc.name      : TrunclSuite001
 * @tc.desc      : Test LTrunclSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
