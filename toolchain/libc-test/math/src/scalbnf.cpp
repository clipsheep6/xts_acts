...
/**  
* @brief  register a test suit named "ScalbnfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalbnfSuite
*/

using namespace std;
using namespace testing::ext;
class ScalbnfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : ScalbnfSuite001
 * @tc.desc      : Test LScalbnfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(ScalbnfSuite, ScalbnfTest, Function | MediumTest | Level2)
{
