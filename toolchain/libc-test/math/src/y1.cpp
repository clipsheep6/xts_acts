...
/**  
* @brief  register a test suit named "Y1Suite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  Y1Suite
*/

using namespace std;
using namespace testing::ext;
class Y1Suite: public testing::Test {
protected:
...
/**
 * @tc.name      : Y1Suite001
 * @tc.desc      : Test LY1Suite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct d_d t[] = {
#include "sanity/y1.h"
...
HWTEST_F(Y1Suite, Y1Test, Function | MediumTest | Level2)
{
