...
/**  
* @brief  register a test suit named "CopysignlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  CopysignlSuite
*/

using namespace std;
using namespace testing::ext;
class CopysignlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : CopysignlSuite001
 * @tc.desc      : Test CopysignlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(CopysignlSuite, CopysignlTest, Function | MediumTest | Level2)
{
