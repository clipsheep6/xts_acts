...
/**  
* @brief  register a test suit named "ScalbSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalbSuite
*/
...
/**
 * @tc.name      : ScalbSuite001
 * @tc.desc      : Test LScalbSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
