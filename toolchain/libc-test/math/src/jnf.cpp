...
/**  
* @brief  register a test suit named "JnfSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  JnfSuite
*/

using namespace std;
using namespace testing::ext;
class JnfSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : JnfSuite001
 * @tc.desc      : Test JnfSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(JnfSuite, JnfTest, Function | MediumTest | Level2)
{
