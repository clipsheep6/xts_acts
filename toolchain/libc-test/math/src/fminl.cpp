...
/**  
* @brief  register a test suit named "FminlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  FminlSuite
*/

using namespace std;
using namespace testing::ext;
class FminlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : FminlSuite001
 * @tc.desc      : Test FminlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(FminlSuite, FminlTest, Function | MediumTest | Level2)
{
