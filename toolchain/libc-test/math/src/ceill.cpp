...
/**  
* @brief  register a test suit named "CeillSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  CeillSuite
*/

using namespace std;
using namespace testing::ext;
class CeillSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : CeillSuite001
 * @tc.desc      : Test CeillSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(CeillSuite, CeillTest, Function | MediumTest | Level2)
{
