...
/**  
* @brief  register a test suit named "LlrintSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  LlrintSuite
*/

using namespace std;
using namespace testing::ext;
class LlrintSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : LlrintSuite001
 * @tc.desc      : Test LlrintSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct d_i t[] = {
...
HWTEST_F(LlrintSuite, LlrintTest, Function | MediumTest | Level2)
{
