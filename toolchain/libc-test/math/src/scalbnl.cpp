...
/**  
* @brief  register a test suit named "ScalbnlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  ScalbnlSuite
*/

using namespace std;
using namespace testing::ext;
class ScalbnlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : ScalbnlSuite001
 * @tc.desc      : Test LScalbnlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(ScalbnlSuite, ScalbnlTest, Function | MediumTest | Level2)
{
