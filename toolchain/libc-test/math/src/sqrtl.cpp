...
/**  
* @brief  register a test suit named "SqrtlSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  SqrtlSuite
*/

using namespace std;
using namespace testing::ext;
class SqrtlSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : SqrtlSuite001
 * @tc.desc      : Test LSqrtlSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
static struct l_l t[] = {
#if LDBL_MANT_DIG == 53
...
HWTEST_F(SqrtlSuite, SqrtlTest, Function | MediumTest | Level2)
{
