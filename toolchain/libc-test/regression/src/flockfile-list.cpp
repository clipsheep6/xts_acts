...
/**  
* @brief  register a test suit named "FlockfileListSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  FlockfileListSuite
*/

using namespace std;
using namespace testing::ext;
class FlockfileListSuite: public testing::Test {
protected:
...
/**
 * @tc.name      : FlockfileListSuite001
 * @tc.desc      : Test FlockfileListSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
...
HWTEST_F(FlockfileListSuite, FlockfileListTest, Function | MediumTest | Level2)
{
    FILE *f = tmpfile();
	FILE *g = tmpfile();
	flockfile(g);
