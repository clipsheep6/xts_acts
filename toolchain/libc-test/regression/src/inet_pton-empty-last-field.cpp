...
/**  
* @brief  register a test suit named "InetPtonEmptyLastFieldSuite"  
* @param  test subsystem name is libc 
* @param  example module name is  Functional
* @param  test suit name is  InetPtonEmptyLastFieldSuite
*/
...
/**
 * @tc.name      : InetPtonEmptyLastFieldSuite001
 * @tc.desc      : Test InetPtonEmptyLastFieldSuite001 3 items whth async flush
 * @tc.level     : Level 1
 */
