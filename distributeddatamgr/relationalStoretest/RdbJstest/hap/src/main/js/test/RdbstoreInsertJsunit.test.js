...
const CREATE_TABLE = " (" + "id INTEGER PRIMARY KEY AUTOINCREMENT, " + "name TEXT NOT NULL, " + "age INTEGER, " +
...
export default function rdbstoreInsertTest() {
    describe('rdbstoreInsertTest', function () {
         ...
         */
        it('testRdbStoreInsert0001', 0, async function () {
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreInsert0002', 0, async function () {
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreInsert0003', 0, async function () {
            ...
            try {
                await rdbStore.insert(null, valueBucket);
                expect().assertFail();
            } catch (err) {
                console.log(TAG + `failed, errcode:${JSON.stringify(err)}.`);
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreInsert0004', 0, async function () {
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0001', 0, async function () {
            ...
            try {
                ...
                console.log(TAG + `failed1, errcode:${JSON.stringify(err)}.`);
                expect().assertFail();
            } finally {
                resultSet.close();
            }
            ...
            try {
                ...
                console.log(TAG + `failed2, errcode:${JSON.stringify(err)}.`);
                expect().assertFail();
            } finally {
                resultSet.close();
            }
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0002', 0, async function () {
            ...
            try {
                ...
                await rdbStore.delete(predicates).then((number) => {
                    ...
                    let resultSet = await rdbStore.query(predicates).catch((err) => {
                        console.log(TAG + `failed, errcode:${JSON.stringify(err)}.`);
                        expect().assertFail();
                    })
                    resultSet.close();
                ...
                console.log(TAG + `BatchInsert2, errcode:${JSON.stringify(err)}.`);
                expect().assertFail();
            } finally {
                resultSet.close();
            }
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0003', 0, async function () {
            ...
            try {
                ...
                console.log(TAG + `failed3, errcode:${JSON.stringify(err)}.`);
                expect().assertFail();
            } finally {
                resultSet.close();
            }
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0004', 0, async function () {
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0005', 0, async function () {
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0006', 0, async function () {
            ...
            try {
                ...
                console.log(TAG + `Batch insert data failed, errcode:${JSON.stringify(err)}.`);
                expect(err.code).assertEqual("401")
            }
         ...
         * @tc.desc rdb insert test
         */
        it('testRdbStoreBatchInsertPromise0007', 0, async function () {
        ...
        it('testRdbStoreBatchInsertCallback0001', 0, async function (done) {
            ...
            try {
                ...
                console.log(TAG + `all, errcode:${JSON.stringify(err)}.`);
                expect().assertFail();
            }
        })
                    ...
                    await rdbStore.batchInsert("testCallback5", valueBuckets, async (err, number) => {
                        if (err != null) {
                            ...
                            try {
                                ...
                                const salary = resultSet.getDouble(resultSet.getColumnIndex("salary"))
                                const blobType = resultSet.getBlob(resultSet.getColumnIndex("blobType"))
                                console.info(TAG + " name=" + name + ", age=" + age + ", salary=" + salary
                                + ", blobType=" + blobType);
        ...
        it('testRdbStoreBatchInsertCallback0007', 0, async function (done) {
            ...
            await rdbStore.executeSql(CREATE_TABLE_NAME + "Callback7" + CREATE_TABLE).then(async () => {
                try {
                    rdbStore.batchInsert("testCallback7", (err, data) => {
                        done();
                        expect().assertFail();
                    })
                } catch (err) {
