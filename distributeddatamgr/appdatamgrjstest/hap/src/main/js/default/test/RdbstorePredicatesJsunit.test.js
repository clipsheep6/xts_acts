...
describe('rdbPredicatesTest', function () {
    ...
    async function basicDataTypeTest001(){
        {
            ...
            await predicates.equalTo("booleanValue", true);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("byteValue", -128).or().equalTo("byteValue", 1);
            let result = await rdbStore.query(predicates);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("stringValue", "ABCDEFGHIJKLMN");
            let result = await rdbStore.query(predicates);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("doubleValue", Number.MAX_VALUE);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("shortValue", -32768.0);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("integerValue", 1);
            let result = await rdbStore.query(predicates);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(true).assertEqual(result.goToFirstRow());
            await expect(2).assertEqual(result.getLong(0))
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("floatValue", -0.123);
            let result = await rdbStore.query(predicates);
            await expect(true).assertEqual(result.goToFirstRow());
    ...
    async function basicDataTypeTest002() {
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("booleanValue", true);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("byteValue", -128);
            await predicates.notEqualTo("byteValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("stringValue", "ABCDEFGHIJKLMN");
            let result = await rdbStore.query(predicates);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("doubleValue", Number.MAX_VALUE);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("shortValue", -32768);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("integerValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.notEqualTo("floatValue", -0.123);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testIsNull0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.isNull("primLongValue");
        let result = await rdbStore.query(predicates);
        await expect(3).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testIsNotNull0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.isNotNull("primLongValue");
        let result = await rdbStore.query(predicates);
        await expect(0).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testGreaterThan0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThan("stringValue", "ABC");
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThan("doubleValue", 0.0);
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThan("integerValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThan("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testGreaterThanOrEqualTo0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThanOrEqualTo("stringValue", "ABC");
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThanOrEqualTo("doubleValue", 0.0);
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThanOrEqualTo("integerValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.greaterThanOrEqualTo("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testLessThan0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThan("stringValue", "ABD");
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThan("doubleValue", 0.0);
            let result = await rdbStore.query(predicates);
            await expect(0).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThan("integerValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThan("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testLessThanOrEqualTo0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThanOrEqualTo("stringValue", "ABD");
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThanOrEqualTo("doubleValue", 0.0);
            let result = await rdbStore.query(predicates);
            await expect(0).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThanOrEqualTo("integerValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.lessThanOrEqualTo("longValue", 1);
            let result = await rdbStore.query(predicates);
            await expect(2).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testBetween0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.between("stringValue", "ABB", "ABD");
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.between("doubleValue", 0.0, Number.MAX_VALUE);
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.between("integerValue", 0, 1);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.between("longValue", 0, 2);
            let result = await rdbStore.query(predicates);
            await expect(1).assertEqual(result.rowCount);
            result = null
        }
    ...
    it('testContains0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.contains("stringValue", "DEF");
        let result = await rdbStore.query(predicates);
        await expect(3).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testBeginsWith0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.beginsWith("stringValue", "ABC");
        let result = await rdbStore.query(predicates);
        await expect(3).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testEndsWith0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.endsWith("stringValue", "LMN");
        let result = await rdbStore.query(predicates);
        await expect(3).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testLike0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.like("stringValue", "%LMN%");
        let result = await rdbStore.query(predicates);
        await expect(3).assertEqual(result.rowCount);
        result = null
        done();
    ...
    it('testAnd0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("stringValue", "ABCDEFGHIJKLMN").or().or().equalTo("integerValue", 1);
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("stringValue", "ABCDEFGHIJKLMN").or().and().equalTo("integerValue", 1);
    ...
    it('testOrder0001', 0, async function (done) {
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("stringValue", "ABCDEFGHIJKLMN").orderByAsc("integerValue").distinct();
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            await expect(true).assertEqual(result.goToFirstRow())
        ...
        {
            let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
            await predicates.equalTo("stringValue", "ABCDEFGHIJKLMN").orderByDesc("integerValue").distinct();
            let result = await rdbStore.query(predicates);
            await expect(3).assertEqual(result.rowCount);
            await expect(true).assertEqual(result.goToFirstRow())
            await expect(1).assertEqual(result.getLong(0));
    ...
    it('testLimit0001', 0, async function (done) {
        ...
        let predicates = await new ohos_data_rdb.RdbPredicates("AllDataType");
        await predicates.like("stringValue", "ABCDEFGHIJKLMN");
        await predicates.like("stringValue", "ABCDEFGHIJKLMN").limitAs(1);
        let result = await rdbStore.query(predicates);
        await expect(1).assertEqual(result.rowCount);
        result = null
        done();
