...
describe('RdbStoreQueryTest',function(){
    ...
    afterAll(async function () {
        ...
        rdbStore = null
        await ohos_data_rdb.deleteRdbStore("QueryTest.db");
    })
    // testRdbStoreQuery001
    it('testRdbStoreQuery001',0,async function (done){
        ...
        try{
            ...
            await expect(true).assertEqual(isMemory);
            resultSet = null
        }catch(e){
...
//        resultSet = null;
    ...
    it('testRdbStoreQuery004',0,async function (done){
        ...
        //select
        let predicates = new ohos_data_rdb.RdbPredicates("null");
        let resultSet = await rdbStore.query(predicates, ["id", "name", "age", "salary", "blobType"])
