...
describe("SensorJsTest_sensor_57", function () {
	...
	let errMessage
     ...
     /*
     * @tc.number:SUB_SensorsSystem_newPedometerDetection_JSTest_00
    ...
    it("newPedometerDetection_SensorJsTest001", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
		...
		try {
            ...
            console.info("newPedometerDetection_SensorJsTest001 error:" + error);
    ...
    it("newPedometerDetection_SensorJsTest002", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		try {
            ...
            console.info("newPedometerDetection_SensorJsTest002 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0030
    ...
    it("newPedometerDetection_SensorJsTest003", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest003  on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
        try {
            ...
            console.info("newPedometerDetection_SensorJsTest003 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0040
    ...
    it("newPedometerDetection_SensorJsTest004", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorId.PEDOMETER_DETECTION, callback);
            ...
            console.info("newPedometerDetection_SensorJsTest004 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
			done();
        }
    ...
    /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0050
    ...
    it("newPedometerDetection_SensorJsTest005", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onceSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest005 on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
        try {
            sensor.once(sensor.SensorId.PEDOMETER_DETECTION, onceSensorCallback, 5);
        } catch (error) {
            console.info("newPedometerDetection_SensorJsTest005 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
   ...
   /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0060
    ...
    it("newPedometerDetection_SensorJsTest006", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        try {
			...
			errMessage 
            console.info("newPedometerDetection_SensorJsTest006 error:" + error);
   ...
   /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0070
    ...
    it("newPedometerDetection_SensorJsTest007", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest007  on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
       try {
           ...
           sensor.off(sensor.SensorId.PEDOMETER_DETECTION);
            ...
            console.info("newPedometerDetection_SensorJsTest007 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0080
    ...
    it("newPedometerDetection_SensorJsTest008", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest008  on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
        try {
            sensor.off(1000000, onSensorCallback);
        } catch (error) {
            console.info("newPedometerDetection_SensorJsTest008 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
	 ...
	 /*
     * @tc.number: SUB_SensorsSystem_newPedometerDetection_JSTest_0090
    ...
    it("newPedometerDetection_SensorJsTest009", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest009  on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
        try {
            sensor.off(invalid, onSensorCallback);
        } catch (error) {
            console.info("newPedometerDetection_SensorJsTest009 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometerDetection_SensorJsTest010", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometerDetection_SensorJsTest010  on error');
            expect(typeof (data.scalar)).assertEqual("number");
        }
        try {
            sensor.xxx(sensor.SensorId.PEDOMETER_DETECTION, onSensorCallback);
        } catch (error) {
            console.info("newPedometerDetection_SensorJsTest010 error:" + error);
            errMessage = error.toString();
