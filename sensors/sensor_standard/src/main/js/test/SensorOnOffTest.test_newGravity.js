...
describe("SensorJsTest_sensor_42", function () {
    ...
    it("newGRAVITY_SensorJsTest002", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newGRAVITY_SensorJsTest002 callback in');
            expect(false).assertTrue();
        }
        try {
            sensor.on(invalid, onSensorCallback);
        } catch (error) {
            console.info("newGRAVITY_SensorJsTest002 error:" + error);
    ...
    it("newGRAVITY_SensorJsTest003", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        setTimeout(()=>{
            console.info('---------newGRAVITY_SensorJsTest003 off in--------------');
            sensor.off(sensor.SensorId.GRAVITY);
            console.info('---------newGRAVITY_SensorJsTest003 off end--------------');
            done();
        }, 500);
    })
     ...
     */
    it("newGRAVITY_SensorJsTest004", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        console.info('---------newGRAVITY_SensorJsTest004--------------');
        function onSensorCallback(data) {
            console.info('newGRAVITY_SensorJsTest004  callback in');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        try {
            ...
            console.info("newGRAVITY_SensorJsTest004 error:" +error);
            expect(false).assertTrue();
            done();
        }
        setTimeout(()=>{
    ...
    it("newGRAVITY_SensorJsTest006", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onceSensorCallback(data) {
            console.info('newGRAVITY_SensorJsTest006 callback in');
            expect(false).assertTrue();
            done();
        }
        try {
            ...
            console.info("newGRAVITY_SensorJsTest006 error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newGRAVITY_SensorJsTest007", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        function onceSensorCallback(data) {
            console.info('newGRAVITY_SensorJsTest007  on error');
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
    ...
    it("newGRAVITY_SensorJsTest009", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newGRAVITY_SensorJsTest009 callback in');
            expect(false).assertTrue();
            done();
        }
	...
	/*
     * @tc.number:SUB_SensorsSystem_GRAVITY_JSTest_0010
     * @tc.name: newnewGRAVITY_SensorJsTest010
     * @tc.desc:SensorId1000000 of incoming exception
     */
    it("newnewGRAVITY_SensorJsTest010", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newnewGRAVITY_SensorJsTest010 on error');
            expect(false).assertTrue();
        }
        try {
            sensor.off(1000000, onSensorCallback);
        } catch (error) {
            console.info("newnewGRAVITY_SensorJsTest010 error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE)
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG)
            done();
        }
    ...
    it("newGRAVITY_SensorJsTest011", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        sensor.on(sensor.SensorId.GRAVITY, (data)=>{
            console.info("newGRAVITY_SensorJsTest011 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.on(sensor.SensorId.GRAVITY, (data)=>{
            console.info("newGRAVITY_SensorJsTest011 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newGRAVITY_SensorJsTest011 off in--------------');
            sensor.off(sensor.SensorId.GRAVITY);
            console.info('---------newGRAVITY_SensorJsTest011 off end--------------');
            done();
        }, 1000);
    })
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newGRAVITY_SensorJsTest012", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        try {
            sensor.off(sensor.SensorId.GRAVITY, 5);
        } catch (error) {
            console.info('newGRAVITY_SensorJsTest012 error:'+error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE)
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG)
            done();
        }
