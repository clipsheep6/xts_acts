...
describe("SensorJsTest_sensor_43", function () {
    ...
    it("newGyroScope_SensorJsTest004", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        ...
        try {
            ...
            console.info("newGyroScope_SensorJsTest004 error:" +error);
            expect(false).assertTrue();
            done();
        }
        setTimeout(()=>{
    ...
    it("newGyroScope_SensorJsTest008", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        try {
            ...
            console.info('newGyroScope_SensorJsTest008 error:' +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE)
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG)
            done();
        }
	...
	/*
     * @tc.number:SUB_SensorsSystem_GYROSCOPE_JSTest_0010
     * @tc.name: newnewGyroScope_SensorJsTest010
     * @tc.desc:SensorId1000000 of incoming exception
     */
    it("newnewGyroScope_SensorJsTest010", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        function onSensorCallback(data) {
            console.info('newnewGyroScope_SensorJsTest010 on error');
            expect(false).assertTrue();
        }
        try {
            sensor.off(1000000, onSensorCallback);
        } catch (error) {
            console.info("newnewGyroScope_SensorJsTest010 error:" +error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE)
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG)
            done();
        }
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("newGyroScope_SensorJsTest012", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, function (done) {
        try {
            sensor.off(sensor.SensorId.GYROSCOPE, 5);
        } catch (error) {
            console.info('newGyroScope_SensorJsTest012 error:'+error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE)
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG)
            done();
        }
    ...
    it("newGyroScope_SensorJsTest013", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        sensor.on(sensor.SensorId.GYROSCOPE, (data)=>{
            console.info("newGyroScope_SensorJsTest013 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.once(sensor.SensorId.GYROSCOPE, (data)=>{
            console.info("newGyroScope_SensorJsTest013 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newGyroScope_SensorJsTest013 off in--------------');
            sensor.off(sensor.SensorId.GYROSCOPE);
            console.info('---------newGyroScope_SensorJsTest013 off end--------------');
            done();
        }, 1000);
    })
    ...
    it("newGyroScope_SensorJsTest014", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        sensor.on(sensor.SensorId.GYROSCOPE, (data)=>{
            console.info("newGyroScope_SensorJsTest014 callback: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        sensor.on(sensor.SensorId.GYROSCOPE, (data)=>{
            console.info("newGyroScope_SensorJsTest014 callback2: " + JSON.stringify(data));
            expect(typeof (data.x)).assertEqual("number");
			expect(typeof (data.y)).assertEqual("number");
			expect(typeof (data.z)).assertEqual("number");
			expect(typeof (data.timestamp)).assertEqual("number");
        ...
        setTimeout(()=>{
            console.info('---------newGyroScope_SensorJsTest014 off in--------------');
            sensor.off(sensor.SensorId.GYROSCOPE);
            console.info('---------newGyroScope_SensorJsTest014 off end--------------');
            done();
        }, 1000);
    })
    ...
    it("newGyroScope_SensorJsTest016", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        setTimeout(() => {
            ...
            console.info("newGyroScope_SensorJsTest016 error:" + error);
			}
    ...
    it("newGyroScope_SensorJsTest017", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        setTimeout(() => {
            console.info('----------------------newGyroScope_SensorJsTest017_2 off in--------------');
            sensor.off(sensor.SensorId.GYROSCOPE, callback2);
            console.info('----------------------newGyroScope_SensorJsTest017_2 off end--------------');
            done();
        }, 1000);
    })
})}
