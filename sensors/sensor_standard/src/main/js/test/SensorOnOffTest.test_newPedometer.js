...
describe("SensorJsTest_sensor_56", function () {
	...
	let errMessage
     ...
     /*
     * @tc.number:SUB_SensorsSystem_newPedometer_JSTest_00
    ...
    it("newPedometer_SensorJsTest001", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL0, async function (done) {
		...
		try {
            ...
            console.info("newPedometer_SensorJsTest001 error:" + error);
    ...
    it("newPedometer_SensorJsTest002", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		try {
            ...
            console.info("newPedometer_SensorJsTest002 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest003", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest003  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            ...
            console.info("newPedometer_SensorJsTest003 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest004", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorId.PEDOMETER, callback);
            ...
            console.info("newPedometer_SensorJsTest004 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
			done();
        }
    ...
    it("newPedometer_SensorJsTest005", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onceSensorCallback(data) {
            console.info('newPedometer_SensorJsTest005 on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.once(sensor.SensorId.PEDOMETER, onceSensorCallback, 5);
        } catch (error) {
            console.info("newPedometer_SensorJsTest005 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
   ...
   /*
    ...
    it("newPedometer_SensorJsTest006", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        try {
			...
			errMessage 
            console.info("newPedometer_SensorJsTest006 error:" + error);
   ...
   /*
    ...
    it("newPedometer_SensorJsTest007", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest007  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
       try {
           ...
           sensor.off(sensor.SensorId.PEDOMETER);
            ...
            console.info("newPedometer_SensorJsTest007 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest008", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest008  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.off(1000000, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest008 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest009", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest009  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.off(invalid, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest009 error:" + error);
            expect(error.code).assertEqual(PARAMETER_ERROR_CODE);
            expect(error.message).assertEqual(PARAMETER_ERROR_MSG);
            done();
        }
    ...
    it("newPedometer_SensorJsTest010", TestType.FUNCTION | Size.MEDIUMTEST | Level.LEVEL3, async function (done) {
        ...
        function onSensorCallback(data) {
            console.info('newPedometer_SensorJsTest010  on error');
            expect(typeof (data.steps)).assertEqual("number");
        }
        try {
            sensor.xxx(sensor.SensorId.PEDOMETER, onSensorCallback);
        } catch (error) {
            console.info("newPedometer_SensorJsTest010 error:" + error);
            errMessage = error.toString();
