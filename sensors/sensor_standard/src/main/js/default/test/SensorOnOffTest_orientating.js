...
describe("SensorJsTest", function () {
     ...
     */
    it("orientating_SensorJsTest001", 0, async function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest002", 0, async function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest003", 0, function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest004", 0, async function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest005", 0, function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest006", 0, async function (done) {
        try {
            sensor.off(string, "");
        } catch (error) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest007", 0, async function (done) {
        function onSensorCallback(data) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest008", 0, async function (done) {
        function onSensorCallback(data) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest009", 0, async function (done) {
        sensor.on(sensor.SensorType.SENSOR_TYPE_ID_ORIENTATION, callback);
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest010", 0, async function (done) {
        sensor.on(sensor.SensorType.SENSOR_TYPE_ID_ORIENTATION, callback);
        sensor.on(sensor.SensorType.SENSOR_TYPE_ID_ORIENTATION, callback2);
        setTimeout(()=>{
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest011", 0, async function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest012", 0, async function (done) {
     ...
     * @tc.require: Issue Number
     */
    it("orientating_SensorJsTest013", 0, async function (done) {
