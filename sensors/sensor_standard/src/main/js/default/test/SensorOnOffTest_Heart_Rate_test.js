...
describe("SensorJsTest_sensor_11", function () {
     ...
     */
    it("HeartRate_SensorJsTest001", FUNCTION|MEDIUMTEST|LEVEL0, async function (done) {
		...
		try {
			...
			console.info("HeartRate_SensorJsTest001 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest002", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		try {
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest002 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest003", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest004", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorType.SENSOR_TYPE_ID_HEART_RATE, callback);
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest004 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest005", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest005 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest006", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest006 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest007", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
       ...
       try {
           ...
           sensor.off(sensor.SensorType.SENSOR_TYPE_ID_HEART_RATE);
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest007 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartRate_SensorJsTest008", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("HeartRate_SensorJsTest008 errMessage:" + errMessage);
