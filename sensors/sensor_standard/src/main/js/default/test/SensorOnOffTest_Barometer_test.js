...
describe("SensorJsTest_sensor_8", function () {
     ...
     */
    it("Barometer_SensorJsTest001", FUNCTION|MEDIUMTEST|LEVEL0, async function (done) {
		...
		try {
			...
			console.info("Barometer_SensorJsTest001 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest002", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		try {
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest002 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest003", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest004", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorType.SENSOR_TYPE_ID_BAROMETER, callback);
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest004 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest005", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest005 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest006", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest006 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest007", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
       ...
       try {
           ...
           sensor.off(sensor.SensorType.SENSOR_TYPE_ID_BAROMETER);
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest007 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("Barometer_SensorJsTest008", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("Barometer_SensorJsTest008 errMessage:" + errMessage);
