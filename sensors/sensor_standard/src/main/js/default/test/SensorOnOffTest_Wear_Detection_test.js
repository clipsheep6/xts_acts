...
describe("SensorJsTest_sensor_23", function () {
     ...
     */
    it("WearDetection_SensorJsTest001", FUNCTION|MEDIUMTEST|LEVEL0, async function (done) {
		...
		try {
			...
			console.info("WearDetection_SensorJsTest001 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest002", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		try {
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest002 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest003", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest004", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
		...
		sensor.once(sensor.SensorType.SENSOR_TYPE_ID_WEAR_DETECTION, callback);
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest004 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest005", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest005 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest006", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest006 errMessage:" + errMessage);
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest007", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
       ...
       try {
           ...
           sensor.off(sensor.SensorType.SENSOR_TYPE_ID_WEAR_DETECTION);
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest007 errMessage:" + errMessage);
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("WearDetection_SensorJsTest008", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        ...
        try {
            ...
            errMessage = error.toString();
			console.info("WearDetection_SensorJsTest008 errMessage:" + errMessage);
