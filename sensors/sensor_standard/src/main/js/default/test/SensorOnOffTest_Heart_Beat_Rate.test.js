...
describe("SensorJsTest_sensor_38", function () {
     ...
     */
    it("HeartBeatRate_SensorJsTest001", FUNCTION|MEDIUMTEST|LEVEL0, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest002", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest003", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest004", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest005", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest006", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
   ...
   /*
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest007", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
       ...
       try {
           sensor.off(sensor.SensorType.SENSOR_TYPE_ID_HEART_BEAT_RATE, offSensorCallback);
            } catch (error) {
     ...
     * @tc.desc:Verification results of the incorrect parameters of the test interface
     */
    it("HeartBeatRate_SensorJsTest008", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
