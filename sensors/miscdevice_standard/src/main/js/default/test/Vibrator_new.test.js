...
describe("VibratorJsTest", function () {
    ...
    */
    ...
    /*
     * @tc.name:SubVibratorJsTest0011
     * @tc.desc:verify app info is not null
     * @tc.number:SUB_SensorSystem_Vibrator_JsTest_0290
     */
    it("SubVibratorJsTest0011", FUNCTION|MEDIUMTEST|LEVEL3, async function (done) {
        console.info('----------------------SubVibratorJsTest0011---------------------------');
        try {
            vibrator.vibrate({
                mode: 'short',
                success: function () {
                    console.info("SubVibratorJsTest0011 success");
                    expect(false).assertTrue();
                    done();
                },
            }, function () {
            ...
            errMessage = error.toString().slice(39);
            console.info('SubVibratorJsTest0011 error:' + error);
