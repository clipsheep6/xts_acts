...
#ifndef _CUT_LOG_
#define HKS_TEST_LOG_E(fmt, ...) printf("[ERROR][%s:%d][%s]" fmt "\n", __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#define HKS_TEST_LOG_I(fmt, ...) printf("[INFO][%s:%d][%s]" fmt "\n", __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#define HKS_TEST_LOG_W(fmt, ...) printf("[WARN][%s:%d][%s]" fmt "\n", __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#define HKS_TEST_LOG_D(fmt, ...) printf("[DEBUG][%s:%d][%s]" fmt "\n", __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#else
