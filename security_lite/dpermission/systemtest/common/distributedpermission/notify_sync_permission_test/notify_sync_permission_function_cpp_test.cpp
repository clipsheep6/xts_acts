...
class NotifySyncPermissionFunctionCppTest : public testing::Test {
public:
...
void NotifySyncPermissionFunctionCppTest::SetUpTestCase(void)
{}

void NotifySyncPermissionFunctionCppTest::TearDownTestCase(void)
{}

void NotifySyncPermissionFunctionCppTest::SetUp(void)
{}

void NotifySyncPermissionFunctionCppTest::TearDown(void)
{}
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0100, TestSize.Level1)
{
    // DPMS_GetUidPermission_0100
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0100 start";
    ...
    EXPECT_EQ(result, -3);
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0100 end";
}
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0200, TestSize.Level1)
{
    // DPMS_GetUidPermission_0200
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0200 start";
    int uid = STDistibutePermissionUtil::GetUidByBundleName(THIRD_BUNDLE_NAME);
    ...
    int result = DelayedSingleton<DistributedPermissionManagerService>::GetInstance()->NotifySyncPermission(
        nodeId, uid, packageName);
    EXPECT_EQ(result, -3);
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0200 end";
}
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0300, TestSize.Level1)
{
    // DPMS_GetUidPermission_0300
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0300 start";
    ...
    int result = DelayedSingleton<DistributedPermissionManagerService>::GetInstance()->NotifySyncPermission(
        nodeId, uid, packageName);
    EXPECT_EQ(result, -1);
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0300 end";
}
 ...
 * @tc.level     Level4
 */
HWTEST_F(NotifySyncPermissionFunctionCppTest, DPMS_GetUidPermission_0400, TestSize.Level1)
{
    // DPMS_GetUidPermission_0400
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0400 start";
    DeviceInfoRepository::GetInstance().SaveDeviceInfo(
        "networkId", "universallyUniqueId", "uniqueDisabilityIdSuccess", "deviceName", "deviceType");
    ...
    GTEST_LOG_(INFO) << "NotifySyncPermissionFunctionCppTest DPMS_GetUidPermission_0400 end";
}