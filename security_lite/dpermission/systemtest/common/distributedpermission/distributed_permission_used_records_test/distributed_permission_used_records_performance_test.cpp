...
// find all records
void DistributedPermissionUsedRecordsPerformanceTest::FindDataStorageAll(
 ...
 * @tc.level     Level 3
 */
HWTEST_F(DistributedPermissionUsedRecordsPerformanceTest, DPMS_AddPermissionUsedRecord_0900, TestSize.Level1)
{
 ...
 * @tc.level     Level 3
 */
HWTEST_F(DistributedPermissionUsedRecordsPerformanceTest, DPMS_GetPermissionUsedRecords_1800, TestSize.Level1)
{
    RemoveStorage();
 ...
 * @tc.level     Level 3
 */
HWTEST_F(DistributedPermissionUsedRecordsPerformanceTest, DPMS_GetPermissionUsedRecordsAsync_0100, TestSize.Level1)
{
    RemoveStorage();
    InitVisitorData("bundleName_0");
    InitRecordData();
