...
static constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {
    LOG_CORE, SECURITY_DOMAIN_PERMISSION, "CheckDistributedPermissionStressTest01"};
...
class CheckDistributedPermissionStressTest01 : public testing::Test {
public:
...
void CheckDistributedPermissionStressTest01::SetUpTestCase(void)
{
...
void CheckDistributedPermissionStressTest01::TearDownTestCase(void)
{
...
void CheckDistributedPermissionStressTest01::SetUp(void)
{}

void CheckDistributedPermissionStressTest01::TearDown(void)
{}

void CheckDistributedPermissionStressTest01::TestFountion(std::string deviceId, int32_t ruid)
{
...
void CheckDistributedPermissionStressTest01::ExeAPI(std::string &deviceId, int32_t ruid)
{
    std::vector<FnPtr> vec;
    DistibutePermissionStressTest::GetCheckDistributedTestFunction_01(vec);
    for (auto fn : vec) {
...
void CheckDistributedPermissionStressTest01::StressFountion()
{
 ...
 * @tc.level : Level 3
 */
HWTEST_F(CheckDistributedPermissionStressTest01,
    DPMS_CheckDistributedPermission_CheckDistributedPermissionStressTest01_0100, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "CheckDistributedPermissionStressTest01Test  start";
    auto starTime = std::chrono::system_clock::now();
    CheckDistributedPermissionStressTest01::StressFountion();
    ...
    GTEST_LOG_(INFO) << "CheckDistributedPermissionStressTest01Test  end";
}
