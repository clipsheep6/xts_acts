...
static const std::string SYSTEM_TEST_HAP_NAME_PERMISSION_REMIND_STRESS = "dpmsSystemTestPermissionRemindStressTest";
...
void DistributedPermissionRemindMTBFCppTest::TearDownTestCase(void)
{}

void DistributedPermissionRemindMTBFCppTest::SetUp(void)
{
    auto timeFast = std::chrono::milliseconds(waitTime3000Ms);
    std::this_thread::sleep_for(timeFast);
    STDistibutePermissionUtil::Install(SYSTEM_TEST_HAP_NAME_PERMISSION_REMIND_STRESS);
...
void DistributedPermissionRemindMTBFCppTest::TearDown(void)
{
    GTEST_LOG_(INFO) << "void DistributedPermissionRemindMTBFCppTest::TearDown(void)";
    STDistibutePermissionUtil::Uninstall(SYSTEM_TEST_BUNDLE_NAME_PERMISSION_REMIND_STRESS);
}
...
HWTEST_F(DistributedPermissionRemindMTBFCppTest, DPMS_DistributedPermissionRemind_0100, TestSize.Level3)
{
    ...
    STAbilityUtil::StartAbility2(want, abilityMs_, waitTime3000Ms);
