...
class CheckDistributedPermissionMTBFCPPTest : public testing::Test {
public:
...
void CheckDistributedPermissionMTBFCPPTest::SetUpTestCase(void)
{
...
void CheckDistributedPermissionMTBFCPPTest::TearDownTestCase(void)
{
...
void CheckDistributedPermissionMTBFCPPTest::SetUp(void)
{}

void CheckDistributedPermissionMTBFCPPTest::TearDown(void)
{}

void CheckDistributedPermissionMTBFCPPTest::TestFountion(std::string deviceId, int32_t ruid, int32_t duid)
{
...
void CheckDistributedPermissionMTBFCPPTest::ExeAPI(std::string &deviceId, int32_t ruid, int32_t duid)
{
...
void CheckDistributedPermissionMTBFCPPTest::StressFountion()
{
 ...
 * @tc.number : DPMS_CheckDistributedPermissionMTBFTest_0100
 * @tc.size : MEDIUM
 * @tc.type : Reliability
 * @tc.level : Level 3
 */
HWTEST_F(CheckDistributedPermissionMTBFCPPTest, DPMS_CheckDistributedPermissionMTBFTest_0100, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "DPMS_CheckDistributedPermissionMTBFTest_0100  start";
    auto starTime = std::chrono::system_clock::now();
    CheckDistributedPermissionMTBFCPPTest::StressFountion();
    ...
    GTEST_LOG_(INFO) << "DPMS_CheckDistributedPermissionMTBFTest_0100  end";
}
