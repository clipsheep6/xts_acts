...
static const int32_t permissionLabelId = 9527;
static const int32_t permissionDescriptionId = 9528;
static const string permissionLabel = "test Label";
static const string permissionDescription = "test description";
static const std::string bundleName = THIRD_INCLUDE_USE_BY_lOCAL_BUNDLE_NAME_ADD_V1;
// system grant
...
class CheckPermissionPrepareCPPTest : public testing::Test {
public:
...
void CheckPermissionPrepareCPPTest::SetUpTestCase(void)
{}

void CheckPermissionPrepareCPPTest::TearDownTestCase(void)
{}

void CheckPermissionPrepareCPPTest::SetUp(void)
{}

void CheckPermissionPrepareCPPTest::TearDown(void)
{}

/**
 * @tc.name      CheckPermission's Prepare
 * @tc.number    DPMS_CheckPermission_9900
 * @tc.size      MEDIUM
 * @tc.type      Prepare
 * @tc.level     Level 3
 */
HWTEST_F(CheckPermissionPrepareCPPTest, DPMS_CheckPermission_9900, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "CheckPermissionPrepareCPPTest DPMS_CheckPermission_9900 start";
    STDistibutePermissionUtil::Install(bundleName);
    ...
    EXPECT_GT(uid, 0);
    GTEST_LOG_(INFO) << "CheckPermissionPrepareCPPTest DPMS_CheckPermission_9900 end";
}