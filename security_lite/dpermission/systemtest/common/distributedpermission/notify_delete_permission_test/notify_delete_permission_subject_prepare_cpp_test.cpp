...
class NotifyDeletePermissionSubjectPrepareCppTest : public testing::Test {
public:
...
void NotifyDeletePermissionSubjectPrepareCppTest::SetUpTestCase()
{
...
void NotifyDeletePermissionSubjectPrepareCppTest::TearDownTestCase()
{}

void NotifyDeletePermissionSubjectPrepareCppTest::SetUp()
{}

void NotifyDeletePermissionSubjectPrepareCppTest::TearDown()
{}

/**
 * @tc.name      Notify Delete Permission Subject Prepare
 * @tc.number    NotifyDeletePermissionSubjectPrepareTest_0100
 */
HWTEST_F(NotifyDeletePermissionSubjectPrepareCppTest, NotifyDeletePermissionSubjectPrepareTest_0100, TestSize.Level1)
{
