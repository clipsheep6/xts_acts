...
class NotifyDeletePermissionObjectPrepareCppTest : public testing::Test {
public:
...
void NotifyDeletePermissionObjectPrepareCppTest::SetUpTestCase(void)
{}

void NotifyDeletePermissionObjectPrepareCppTest::TearDownTestCase(void)
{}

void NotifyDeletePermissionObjectPrepareCppTest::SetUp(void)
{}

void NotifyDeletePermissionObjectPrepareCppTest::TearDown(void)
{}

/**
 * @tc.name      Notify Delete Permission Object Prepare third hap install and grant permission
 * @tc.number    DPMS_NotifyDeletePermissionObjectPrepareTest_0100
 */
HWTEST_F(NotifyDeletePermissionObjectPrepareCppTest, DPMS_NotifyDelObjPrep_0100, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "NotifyDeletePermissionObjectPrepareCppTest third hap set start";

    GTEST_LOG_(INFO) << "Install dpmsThirdBundle start.";
    STDistibutePermissionUtil::Install("dpmsThirdBundle");
    GTEST_LOG_(INFO) << "Install dpmsThirdBundle end.";
    ...
    int32_t uid1 = STDistibutePermissionUtil::GetUidByBundleName(THIRD_BUNDLE_NAME2);
    EXPECT_GT(uid1, 0);

    int32_t uid2 = STDistibutePermissionUtil::GetUidByBundleName(THIRD_INCLUDE_USE_BY_lOCAL_BUNDLE_NAME);
    EXPECT_GT(uid2, 0);

    GTEST_LOG_(INFO) << "NotifyDeletePermissionObjectPrepareCppTest third hap set end";
}
