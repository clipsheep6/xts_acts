...
class NotifyDeletePermissionObjectPrepareTest : public testing::Test {
public:
...
void NotifyDeletePermissionObjectPrepareTest::SetUpTestCase(void)
{}

void NotifyDeletePermissionObjectPrepareTest::TearDownTestCase(void)
{}

void NotifyDeletePermissionObjectPrepareTest::SetUp(void)
{}

void NotifyDeletePermissionObjectPrepareTest::TearDown(void)
{}
 ...
 */
HWTEST_F(NotifyDeletePermissionObjectPrepareTest, DPMS_NotifyDeletePermissionObjectPrepareTest_0100, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "NotifyDeletePermissionObjectPrepareTest third hap set start";
    ...
    GTEST_LOG_(INFO) << "NotifyDeletePermissionObjectPrepareTest third hap set end";
}
