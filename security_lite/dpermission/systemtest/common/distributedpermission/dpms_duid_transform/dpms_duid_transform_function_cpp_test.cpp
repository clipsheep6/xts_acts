...
/**
 * @tc.name      permissions more than 1024, the synchronization fails.
...
/**
 * @tc.name      permissions equal 1024, the synchronization is successful.
...
/**
 * @tc.name      Invalid length more than 64 deviceId, AllocateDuid.
...
/**
 * @tc.name      Invalid rUid less than 0 rUid, AllocateDuid.
...
/**
 * @tc.name      Invalid length more than 64 deviceId, QueryDuid.
...
/**
 * @tc.name      Invalid rUid less than 0 rUid, QueryDuid.
