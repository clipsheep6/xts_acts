...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_GROUP_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_GROUP_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_GROUP = "resp_com_ohos_dpmsst_service_distributed_third_group";
const std::string REQ_EVENT_NAME_THIRD_GROUP = "req_com_ohos_dpmsst_service_distributed_third_group";
class DpmsStServiceDistributedThirdGroup : public Ability {
public:
    ~DpmsStServiceDistributedThirdGroup();
...
private:
    ...
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdGroup::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_GROUP, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_GROUP, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdGroup *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_GROUP_