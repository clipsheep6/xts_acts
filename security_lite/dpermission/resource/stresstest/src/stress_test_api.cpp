...
bool StressTestApi::AddPermissionUsedRecord_01(std::string &deviceId, int32_t ruid, int32_t duid)
{
    ...
    std::cout << "Time = " << asctime(t_tm) << std::endl;
    std::cout << "deviceId ：" << deviceId << std::endl;
    std::cout << "ruid ：" << ruid << std::endl;
    std::cout << "duid ：" << duid << std::endl;
    ...
    // std::cout << "visitor size ：" << visitor.size() << std::endl;
    // std::cout << "record  size ：" << record.size() << std::endl;
    // if ((int)visitor.size() != 0 && (int)record.size() != 0) {
    //     return true;
    // } else {
    //     std::cout << "AddPermissionUsedRecord_01 failed" << std::endl;
    //     return false;
    // }
}
...
bool StressTestApi::GetPermissionUsedRecords_01(std::string &deviceId, int32_t ruid, int32_t duid)
{
    ...
    std::cout << "GetPermissionUsedRecords_01 failed" << std::endl;
    return false;
}
...
bool StressTestApi::GetPermissionUsedRecords_02(std::string &deviceId, int32_t ruid, int32_t duid)
{
    time_t now_time = time(NULL);
    tm *t_tm = localtime(&now_time);
    std::cout << "GetPermissionUsedRecords_02 start" << std::endl;
    std::cout << "Time = " << asctime(t_tm) << std::endl;
    ...
    std::cout << "GetPermissionUsedRecords_02 end" << std::endl;
    std::this_thread::sleep_for(std::chrono::seconds(2));
    if (state == 0) {
        return true;
    }
    std::cout << "GetPermissionUsedRecords_02 failed" << std::endl;
    return false;
}
