...
typedef bool (*FnPtr)(std::string &deviceId, int32_t ruid);
class DistibutePermissionStressTest {
public:
    static bool DpmsDuidTranstorm_01(std::string &deviceId, int32_t ruid);
    static bool AllocateDuid_01(std::string &deviceId, int32_t ruid);
    static bool QueryDuid_01(std::string &deviceId, int32_t ruid);
    static bool IsDuid_01(std::string &deviceId, int32_t ruid);
    static bool CheckDPermission_01(std::string &deviceId, int32_t ruid);
    static bool CheckPermission_01(std::string &deviceId, int32_t ruid);
    static bool IsRestrictedPermission_01(std::string &deviceId, int32_t ruid);
    static bool CreateAppIdInfo_01(std::string &deviceId, int32_t ruid);
    static bool CreateAppIdInfo_02(std::string &deviceId, int32_t ruid);
    static bool CreateAppIdInfo_03(std::string &deviceId, int32_t ruid);
    static bool ParseAppIdInfo_01(std::string &deviceId, int32_t ruid);
