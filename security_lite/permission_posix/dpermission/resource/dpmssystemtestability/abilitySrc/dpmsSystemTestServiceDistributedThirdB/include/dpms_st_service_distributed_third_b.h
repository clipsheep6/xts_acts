...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_B_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_B_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_B = "resp_com_ohos_dpmsst_service_distributed_third_b";
const std::string REQ_EVENT_NAME_THIRD_B = "req_com_ohos_dpmsst_service_distributed_third_b";
class DpmsStServiceDistributedThirdB : public Ability {
public:
    ~DpmsStServiceDistributedThirdB();
...
private:
    ...
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdB::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_B, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_B, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdB *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_B_