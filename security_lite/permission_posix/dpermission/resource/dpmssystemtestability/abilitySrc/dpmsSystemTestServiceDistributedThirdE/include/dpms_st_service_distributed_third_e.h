...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_E_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_E_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_E = "resp_com_ohos_dpmsst_service_distributed_third_e";
const std::string REQ_EVENT_NAME_THIRD_E = "req_com_ohos_dpmsst_service_distributed_third_e";
class DpmsStServiceDistributedThirdE : public Ability {
public:
    ~DpmsStServiceDistributedThirdE();
...
private:
    ...
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdE::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_E, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_E, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdE *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_E_