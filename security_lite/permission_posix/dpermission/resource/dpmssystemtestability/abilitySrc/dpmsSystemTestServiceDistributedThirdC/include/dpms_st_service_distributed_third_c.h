...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_C_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_C_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_C = "resp_com_ohos_dpmsst_service_distributed_third_c";
const std::string REQ_EVENT_NAME_THIRD_C = "req_com_ohos_dpmsst_service_distributed_third_c";
class DpmsStServiceDistributedThirdC : public Ability {
public:
    ~DpmsStServiceDistributedThirdC();
...
private:
    ...
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdC::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_C, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_C, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdC *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_C_