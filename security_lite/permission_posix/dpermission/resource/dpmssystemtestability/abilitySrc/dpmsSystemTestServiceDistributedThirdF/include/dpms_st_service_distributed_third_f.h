...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_F_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_F_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_F = "resp_com_ohos_dpmsst_service_distributed_third_f";
const std::string REQ_EVENT_NAME_THIRD_F = "req_com_ohos_dpmsst_service_distributed_third_f";
class DpmsStServiceDistributedThirdF : public Ability {
public:
    ~DpmsStServiceDistributedThirdF();
...
private:
    ...
    void VerifyPermissionFromRemotePerformance();
    void VerifySelfPermissionFromRemotePerformance();
    void RequestPermissionsFromRemotePerformance();
    void CanRequestPermissionFromRemotePerformance();
    string GetAppIdInfo(int32_t pid, int32_t uid);
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdF::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_F, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_F, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdF *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_F_