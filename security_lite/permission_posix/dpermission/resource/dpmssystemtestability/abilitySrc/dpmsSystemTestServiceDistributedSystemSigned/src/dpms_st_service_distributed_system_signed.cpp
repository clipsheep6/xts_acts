...
class DpmsStServiceDistributedSystemSigned::TestCallback : public OnRequestPermissionsResultStub {
public:
...
void DpmsStServiceDistributedSystemSigned::RequestPermissionsFromRemote()
{
    ...
    const int32_t pid = IPCSkeleton::GetCallingPid();
    const int32_t uid = IPCSkeleton::GetCallingUid();
    OHOS::sptr<DpmsStServiceDistributedSystemSigned::TestCallback> callback(
        new DpmsStServiceDistributedSystemSigned::TestCallback());
