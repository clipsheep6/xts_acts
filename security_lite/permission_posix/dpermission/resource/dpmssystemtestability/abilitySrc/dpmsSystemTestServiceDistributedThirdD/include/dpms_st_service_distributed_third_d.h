...
#ifndef DPMS_ST_SERVICE_DISTRIBUTED_THIRD_D_
#define DPMS_ST_SERVICE_DISTRIBUTED_THIRD_D_
#include <string>
#include <map>
...
const std::string RESP_EVENT_NAME_THIRD_D = "resp_com_ohos_dpmsst_service_distributed_third_d";
const std::string REQ_EVENT_NAME_THIRD_D = "req_com_ohos_dpmsst_service_distributed_third_d";
class DpmsStServiceDistributedThirdD : public Ability {
public:
    ~DpmsStServiceDistributedThirdD();
...
private:
    ...
    std::string permName = {};
    typedef void (DpmsStServiceDistributedThirdD::*func)();
    ...
    public:
            ...
            const AppExecFwk::ElementName &element, const sptr<IRemoteObject> &remoteObject, int resultCode) override
        {
            if (resultCode == 0) {
                ...
                PublishEvent(RESP_EVENT_NAME_THIRD_D, onAbilityConnectDoneCount, "OnAbilityConnectDone");
            }
        }
        ...
        void OnAbilityDisconnectDone(const AppExecFwk::ElementName &element, int resultCode) override
        {
            if (resultCode == 0) {
                onAbilityConnectDoneCount--;
                PublishEvent(RESP_EVENT_NAME_THIRD_D, onAbilityConnectDoneCount, "OnAbilityDisconnectDone");
            }
        }
    ...
    public:
        ...
        DpmsStServiceDistributedThirdD *mainAbility_ = nullptr;
    };
};
}  // namespace AppExecFwk
}  // namespace OHOS
#endif  // DPMS_ST_SERVICE_DISTRIBUTED_THIRD_D_