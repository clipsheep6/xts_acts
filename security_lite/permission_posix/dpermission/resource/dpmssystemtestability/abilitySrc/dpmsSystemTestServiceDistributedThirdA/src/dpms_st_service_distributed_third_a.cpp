...
class DpmsStServiceDistributedThirdA::TestCallback : public OnRequestPermissionsResultStub {
public:
...
void DpmsStServiceDistributedThirdA::VerifyPermissionFromRemote()
{
    ...
    APP_LOGI("DpmsStServiceDistributedThirdA::VerifyPermissionFromRemote  pid = %{public}d, uid = "
...
void DpmsStServiceDistributedThirdA::CanRequestPermissionFromRemote()
{
    ...
    APP_LOGI("DpmsStServiceDistributedThirdA::CanRequestPermissionFromRemote  pid = %{public}d, uid = "
             "%{public}d, permission= %{public}s,nodeId= %{public}s ",
        pid,
        uid,
        permission.c_str(),
...
void DpmsStServiceDistributedThirdA::RequestPermissionsFromRemote()
{
    ...
    const int32_t pid = IPCSkeleton::GetCallingPid();
    const int32_t uid = IPCSkeleton::GetCallingUid();
    OHOS::sptr<DpmsStServiceDistributedThirdA::TestCallback> callback(
        new DpmsStServiceDistributedThirdA::TestCallback());
