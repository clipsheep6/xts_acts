...
static constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {
    LOG_CORE, SECURITY_DOMAIN_PERMISSION, "CheckDistributedPermissionStressTest02"};
...
class CheckDistributedPermissionStressTest02 : public testing::Test {
public:
...
void CheckDistributedPermissionStressTest02::SetUpTestCase(void)
{
...
void CheckDistributedPermissionStressTest02::TearDownTestCase(void)
{
...
void CheckDistributedPermissionStressTest02::SetUp(void)
{}

void CheckDistributedPermissionStressTest02::TearDown(void)
{}

void CheckDistributedPermissionStressTest02::TestFountion(std::string deviceId, int32_t ruid)
{
...
void CheckDistributedPermissionStressTest02::ExeAPI(std::string &deviceId, int32_t ruid)
{
    std::vector<FnPtr> vec;
    DistibutePermissionStressTest::GetCheckDistributedTestFunction_02(vec);
    for (auto fn : vec) {
...
void CheckDistributedPermissionStressTest02::StressFountion()
{
 ...
 * @tc.level : Level 3
 */
HWTEST_F(CheckDistributedPermissionStressTest02,
    DPMS_CheckDistributedPermission_CheckDistributedPermissionStressTest02_0200, TestSize.Level3)
{
    GTEST_LOG_(INFO) << "CheckDistributedPermissionStressTest02Test  start";
    auto starTime = std::chrono::system_clock::now();
    CheckDistributedPermissionStressTest02::StressFountion();
    ...
    GTEST_LOG_(INFO) << "CheckDistributedPermissionStressTest02Test  end";
}
