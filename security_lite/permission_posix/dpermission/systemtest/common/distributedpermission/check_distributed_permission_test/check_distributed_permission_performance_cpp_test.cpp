...
/**
 * @tc.name      CreateAppIdInfo(pid, uid) interface performance
...
/**
 * @tc.name      CreateAppIdInfo(pid, uid, deviceID) interface performance
...
/**
 * @tc.name      CreateAppIdInfo(pid, uid, deviceID, bundleName) interface performance
...
/**
 * @tc.name      ParseAppIdInfo(appIdInfo, appIdInfoObj) interface performance
