...
/**
 * @tc.name      If the length of permission name > 256, return: -1.
...
/**
 * @tc.name      Invalid nodeId(the length of nodeId >64), return: -1.
...
/**
 * @tc.name      If the duid is valid, but the length of permission > 256, return: -1.
...
/**
 * @tc.name      If the length of permission name <= 256, and the permission is granted, return: 0.
...
/**
 * @tc.name      If the length of permission name > 256, return: false.
...
/**
 * @tc.name      If the length of permission name <= 256, and the permission is restricted, return true.
...
/**
 * @tc.name      If the length of permission name <= 256, but the permission is not restricted, return false.
