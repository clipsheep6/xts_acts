...
static constexpr OHOS::HiviewDFX::HiLogLabel LABEL = {
    LOG_CORE, SECURITY_DOMAIN_PERMISSION, "DistributedPermissionRemindPerformanceCPPTest"};
...
HWTEST_F(DistributedPermissionRemindPerformanceCPPTest, DPMS_UnregisterUsingPermissionReminder_0300, TestSize.Level3)
{
    ...
    PERMISSION_LOG_DEBUG(
        LABEL, "DPMS_UnregisterUsingPermissionReminder_0300  avg = %{public}f(ms)", averageTime.count());
...
HWTEST_F(DistributedPermissionRemindPerformanceCPPTest, DPMS_CheckCallerPermissionAndStartUsing_0300, TestSize.Level3)
{
    ...
    EXPECT_EQ(
        STAbilityUtil::WaitCompleted(event_, "CheckCallerPermissionAndStartUsing_0300", 0, wait_ability_timeout), 0);

    // stop ability
    STAbilityUtil::StopAbility("req_com_ohos_dpmsst_service_app_a1", 0, "StopSelfAbility");
    STAbilityUtil::WaitCompleted(
        event_, "OnStop", OHOS::AppExecFwk::AbilityLifecycleExecutor::LifecycleState::INITIAL, wait_ability_timeout);
