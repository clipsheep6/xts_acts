 ...
 * @tc.level     Level 4
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_AddPermissionUsedRecord_0100, TestSize.Level1)
{
    RemoveStorage();
...
/**
 * @tc.name      AppIdInfo(deviceId) is null, don't add.
 * @tc.number    DPMS_AddPermissionUsedRecord_0200
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 4
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_AddPermissionUsedRecord_0200, TestSize.Level1)
{
 ...
 * @tc.level     Level 2
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_AddPermissionUsedRecord_1200, TestSize.Level1)
{
    RemoveStorage();
...
/**
 * @tc.name      BeginTimeMillis > endTimeMillis > 0, time conditions are invalid, find faild.
 * @tc.number    DPMS_GetPermissionUsedRecords_0200
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 4
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_GetPermissionUsedRecords_0200, TestSize.Level1)
{
    RemoveStorage();
...
/**
 * @tc.name      BeginTimeMillis < 0, endTimeMillis > 0, time conditions are invalid,find faild.
 * @tc.number    DPMS_GetPermissionUsedRecords_0300
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 4
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_GetPermissionUsedRecords_0300, TestSize.Level1)
{
    RemoveStorage();
    InitVisitorData("bundleName_0");
    InitRecordData();
...
/**
 * @tc.name      EndTimeMillis < 0, time conditions are invalid, find faild.
 * @tc.number    DPMS_GetPermissionUsedRecords_0400
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 4
 */
HWTEST_F(DistributedPermissionUsedRecordsFunctionCPPTest, DPMS_GetPermissionUsedRecords_0400, TestSize.Level1)
{
    RemoveStorage();
    InitVisitorData("bundleName_0");
    InitRecordData();
...
/**
 * @tc.name      BeginTimeMillis = 0, endTimeMillis > 0, time conditions are valid, find the data before endTimeMillis.
...
/**
 * @tc.name      BeginTimeMillis > 0, endTimeMillis = 0, time conditions are valid, find the data after beginTimeMillis.
