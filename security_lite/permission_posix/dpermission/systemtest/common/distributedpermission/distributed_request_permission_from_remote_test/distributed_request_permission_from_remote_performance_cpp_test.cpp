...
public:
    ...
    void OnResult(const std::string nodeId, std::vector<std::string> permissions, std::vector<int32_t> grantResults)
    {
        ...
        PERMISSION_LOG_INFO(
            LABEL, "DistributedRequestPermissionFromRemotePerformanceCPPTest  TestCallback :OnResult  is run!!!");
    }
    void OnCancel(const std::string nodeId, std::vector<std::string> permissions)
    {
        PERMISSION_LOG_INFO(
            LABEL, "DistributedRequestPermissionFromRemotePerformanceCPPTest  TestCallback :OnCancel  is run!!!");
    }
    ...
    const CommonEventData &data)
{
    ...
    auto iter = std::find(DistributedRequestPermissionFromRemotePerformanceCPPTest::eventList_.begin(),
        DistributedRequestPermissionFromRemotePerformanceCPPTest::eventList_.end(),
        eventName);
...
/**
 * @tc.name      Function performance test. Execution time < 1.5ms
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemotePerformanceCPPTest, DPMS_VerifyPermissionFromRemote_2100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
    ...
    EXPECT_EQ(
        STAbilityUtil::WaitCompleted(event_, "VerifyPermissionFromRemotePerformance", expectation, waitTime10s), 0);
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemotePerformanceCPPTest, DPMS_VerifySelfPermissionFromRemote_2100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemotePerformanceCPPTest, DPMS_CanRequestPermissionFromRemote_2000, TestSize.Level1)
{
    GTEST_LOG_(INFO)
    ...
    EXPECT_EQ(STAbilityUtil::WaitCompleted(
                  event_, "CanRequestPermissionFromRemotePerformancePerformance", expectation, waitTime10s),
        0);
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_F, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemotePerformanceCPPTest, DPMS_RequestPermissionsFromRemote_2600, TestSize.Level1)
{
    GTEST_LOG_(INFO)
    ...
    EXPECT_EQ(
        STAbilityUtil::WaitCompleted(event_, "RequestPermissionsFromRemotePerformance", expectation, waitTime10s), 0);
