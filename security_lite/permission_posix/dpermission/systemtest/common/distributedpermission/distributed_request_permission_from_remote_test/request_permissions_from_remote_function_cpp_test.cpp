...
class RequestPermissionsFromRemoteFunctionCPPTest : public testing::Test {
public:
...
public:
    ...
    void OnResult(const std::string nodeId, std::vector<std::string> permissions, std::vector<int32_t> grantResults)
    {
        ...
        PERMISSION_LOG_INFO(LABEL, "RequestPermissionsFromRemoteFunctionCPPTest  TestCallback :OnResult  is run!!!");
    }
    void OnCancel(const std::string nodeId, std::vector<std::string> permissions)
    {
        PERMISSION_LOG_INFO(LABEL, "RequestPermissionsFromRemoteFunctionCPPTest  TestCallback :OnCancel  is run!!!");
    }
    void OnTimeOut(const std::string nodeId, std::vector<std::string> permissions)
    {
        PERMISSION_LOG_INFO(LABEL,
            "RequestPermissionsFromRemoteFunctionCPPTest  TestCallback :OnTimeOut  is run!!! nodeId = "
            "%{public}s",
            nodeId.c_str());
    }
};
string RequestPermissionsFromRemoteFunctionCPPTest::GetAppIdInfo(int32_t pid, int32_t uid)
{
    return DistributedPermissionKit::AppIdInfoHelper::CreateAppIdInfo(pid, uid);
}
std::vector<std::string> RequestPermissionsFromRemoteFunctionCPPTest::eventList_ = {
    "resp_com_ohos_dpmsst_service_distributed_system_signed",
    "resp_com_ohos_dpmsst_service_distributed_third_e",
    "resp_com_ohos_dpmsst_service_distributed_third_f",
    "resp_com_ohos_dpmsst_service_distributed_third_group"};
STtools::Event RequestPermissionsFromRemoteFunctionCPPTest::event_ = STtools::Event();
sptr<OHOS::AppExecFwk::IAppMgr> RequestPermissionsFromRemoteFunctionCPPTest::appMs_ = nullptr;
sptr<OHOS::AAFwk::IAbilityManager> RequestPermissionsFromRemoteFunctionCPPTest::abilityMs_ = nullptr;
std::shared_ptr<RequestPermissionsFromRemoteFunctionCPPTest::AppEventSubscriber>
    RequestPermissionsFromRemoteFunctionCPPTest::subscriber_ = nullptr;
void RequestPermissionsFromRemoteFunctionCPPTest::SetUpTestCase(void)
{
    SubscribeEvent();
...
void RequestPermissionsFromRemoteFunctionCPPTest::TearDownTestCase(void)
{}
void RequestPermissionsFromRemoteFunctionCPPTest::SetSystemBundlePermission()
{
...
bool RequestPermissionsFromRemoteFunctionCPPTest::SubscribeEvent()
{
    MatchingSkills matchingSkills;
    for (const auto &e : RequestPermissionsFromRemoteFunctionCPPTest::eventList_) {
...
void RequestPermissionsFromRemoteFunctionCPPTest::AppEventSubscriber::OnReceiveEvent(const CommonEventData &data)
{
    ...
    auto iter = std::find(RequestPermissionsFromRemoteFunctionCPPTest::eventList_.begin(),
        RequestPermissionsFromRemoteFunctionCPPTest::eventList_.end(),
        eventName);
    if (iter != RequestPermissionsFromRemoteFunctionCPPTest::eventList_.end()) {
        STAbilityUtil::Completed(event_, data.GetData(), data.GetCode());
    }
}
/**
 * @tc.name     If the request permissionName is CAMERA and remote device user agree with authorization. result 0
 * @tc.number    DPMS_RequestPermissionsFromRemote_1800
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 1
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_1800, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_1800 start";
    ...
    std::string bundleName = SYSTEM_TEST_BUNDLE_NAME_DISTRIBUTED_THIRD_E;
    std::string abilityName = SYSTEM_TEST_DISTRIBUTED_THIRD_E_ABILITY;
    ...
    EXPECT_EQ(STAbilityUtil::WaitCompleted(
        ...
        0);
    STAbilityUtil::PublishEvent(REQ_EVENT_NAME_THIRD_E, nomalCode, "RequestPermissionsFromRemote");

    EXPECT_EQ(STAbilityUtil::WaitCompleted(event_, "RequestPermissionsFromRemote", expectation, waitTime10s), 0);

    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_E, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);

    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_1800 end";
}

/**
 * @tc.name       If the request permissionName is READ_HEALTH_DATA and remote device user agree with authorization.
 * @tc.number    DPMS_RequestPermissionsFromRemote_1900
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 1
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_1900, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_1900 start";
    ...
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_1900 end";
}

/**
 * @tc.name      If the request permissionName is LOCATION and remote device user agree with authorization. result 0
 * @tc.number    DPMS_RequestPermissionsFromRemote_2000
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 1
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2000, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2000 start";
    ...
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_E, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2000 end";
}

/**
 * @tc.name      If the request permissionName is MICROPHONE and remote device user agree with authorization. result 0
 * @tc.number    DPMS_RequestPermissionsFromRemote_2100
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 1
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2100, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2100 start";
    ...
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_E, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2100 end";
}
/**
 * @tc.name      If the request permissionName is CAMERA and remote device user disagree with authorization. result -1
 * @tc.number    DPMS_RequestPermissionsFromRemote_2200
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2200, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2200 start";
    string permission = Constant::CAMERA;
    string nodeId = deviceId_;
    string deviceId = deviceId_;
    ...
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2200 end";
}

/**
 * @tc.name      If the request permissionName is READ_HEALTH_DATA and remote device user disagree with authorization.
 * @tc.number    DPMS_RequestPermissionsFromRemote_2300
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2300, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2300 start";
    string permission = Constant::READ_HEALTH_DATA;
    string nodeId = deviceId_;
    string deviceId = deviceId_;
    int32_t expectation = 1;
    ...
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_F, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2300 end";
}

/**
 * @tc.name       If the request permissionName is LOCATION and remote device user disagree with authorization.
 * @tc.number    DPMS_RequestPermissionsFromRemote_2400
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2400, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2400 start";
    string permission = Constant::LOCATION;
    string nodeId = deviceId_;
    string deviceId = deviceId_;
    int32_t expectation = 1;
    ...
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_F, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2400 end";
}

/**
 * @tc.name      If the request permissionName is MICROPHONE and remote device user disagree with authorization.
 * @tc.number    DPMS_RequestPermissionsFromRemote_2500
 * @tc.size      MEDIUM
 * @tc.type      Function
 * @tc.level     Level 2
 */
HWTEST_F(RequestPermissionsFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_2500, TestSize.Level1)
{
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2500 start";
    string permission = Constant::MICROPHONE;
    string nodeId = deviceId_;
    string deviceId = deviceId_;
    int32_t expectation = 1;
    ...
    bool ret = STAbilityUtil::StopAbility(REQ_EVENT_NAME_THIRD_F, nomalCode, "StopSelfAbility");
    EXPECT_TRUE(ret);
    GTEST_LOG_(INFO) << "RequestPermissionsFromRemoteFunctionCPPTest DPMS_RequestPermissionsFromRemote_2500 end";
}
}  // namespace Permission
}  // namespace Security
}  // namespace OHOS