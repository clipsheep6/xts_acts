...
public:
    ...
    void OnResult(const std::string nodeId, std::vector<std::string> permissions, std::vector<int32_t> grantResults)
    {
        ...
        PERMISSION_LOG_INFO(
            LABEL, "DistributedRequestPermissionFromRemoteFunctionCPPTest  TestCallback :OnResult  is run!!!");
    }
    void OnCancel(const std::string nodeId, std::vector<std::string> permissions)
    {
        PERMISSION_LOG_INFO(
            LABEL, "DistributedRequestPermissionFromRemoteFunctionCPPTest  TestCallback :OnCancel  is run!!!");
    }
    ...
    const CommonEventData &data)
{
    ...
    auto iter = std::find(DistributedRequestPermissionFromRemoteFunctionCPPTest::eventList_.begin(),
        DistributedRequestPermissionFromRemoteFunctionCPPTest::eventList_.end(),
        eventName);
...
/**
 * @tc.name    If the nodeId length > 64, verify result is -1. No permission
...
/**
 * @tc.name      If the permissionName length > 256, verify result is -1. No permission
...
/**
 * @tc.name      If the deviceId length > 64, verify result is -1. No permission
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
/**
 * @tc.name       If the self nodeId length > 64, verify result is -1. No permission
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0200, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0300, TestSize.Level1)
{
    GTEST_LOG_(INFO)
        << "DistributedRequestPermissionFromRemoteFunctionCPPTest DPMS_VerifyPermissionFromRemote_0300 start";
    std::unique_ptr<DistributedPermissionKit> service = std::make_unique<DistributedPermissionKit>();
...
/**
 * @tc.name      if  self permissionName length >256，return -1
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0400, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0500, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0600, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
/**
 * @tc.name      If the self deviceId length > 64, verify result is -1. No permission
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_0700, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_1100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_1200, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_1700, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_1800, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_1900, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_VerifySelfPermissionFromRemote_2000, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_0100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
/**
 * @tc.name       If the nodeId length > 64, result false. No permission
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_0200, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_0300, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
/**
 * @tc.name      If the permissionName length > 256, result false. No permission
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_0400, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_0600, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_1100, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_1600, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_1700, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_1800, TestSize.Level1)
{
    GTEST_LOG_(INFO)
 ...
 */
HWTEST_F(
    DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_CanRequestPermissionFromRemote_1900, TestSize.Level1)
{
    GTEST_LOG_(INFO)
...
/**
 * @tc.name       If the nodeId length > 65, end of processing, do not authorization
...
/**
 * @tc.name      If the nodeId length > 64, result -1. Request failure
...
/**
 * @tc.name     If the deviceId length > 64, result -1. Request failure
...
HWTEST_F(DistributedRequestPermissionFromRemoteFunctionCPPTest, DPMS_RequestPermissionsFromRemote_1200, TestSize.Level1)
{
    ...
    Want want = STAbilityUtil::MakeWant(
        deviceId, SYSTEM_TEST_DISTRIBUTED_THIRD_A_ABILITY, SYSTEM_TEST_BUNDLE_NAME_DISTRIBUTED_THIRD_A, params);
    ErrCode eCode = STAbilityUtil::StartAbility(want, abilityMs_, waitTime3000Ms);
    EXPECT_EQ(ERR_OK, eCode);
...
/**
 * @tc.name     If the reasonResId < 0, result -1. Request failure
