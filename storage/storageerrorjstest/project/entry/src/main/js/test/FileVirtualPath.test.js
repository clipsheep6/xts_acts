...
describe('fileVirtualPath', function () {
   ...
   *  create directory and grant 777 permission:/data/accounts/account_0/appdata/ohos.acts.distributeddatamgr.distributedfile
   */
  ...
  it('File_Get_017', 0, async function (done) {
    file.get({
      uri: 'internal://app/../../ohos.acts.distributeddatamgr.distributedfile',
      success: function (data) {
        console.log('File_Get_017 => file list ：');
