...
describe('fileio_mkdir_rmdir', function () {
  ...
  it('fileio_mkdir_sync_rmdir_sync_000', 0, async function () {
    ...
    try {
      ...
      expect(isIntNum(fileio.openSync(dpath))).assertTrue();
    }catch (e) {
      console.info('fileio_mkdir_sync_rmdir_sync_000 has mkdir failed for '+e);
      expect(false).assertTrue();
    }
    try {
      fileio.rmdirSync(dpath);
      fileio.openSync(dpath);
      console.info('fileio_mkdir_sync_rmdir_sync_000 has rmdir failed');
      expect(false).assertTrue();
    }catch (e) {
  ...
  it('fileio_mkdir_async_rmdir_sync_002', 0, async function (done) {
    ...
    try {
      ...
      expect(isIntNum(fileio.openSync(fpath))).assertTrue();
