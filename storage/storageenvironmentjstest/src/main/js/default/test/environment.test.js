...
describe("environment", function () {
   ...
   * @tc.desc Test getStorageData() interfaces.
   * @tc.size MEDIUM
   * @tc.type Function
   * @tc.level Level 0
   * @tc.require
  ...
  it("environment_test_get_storage_data_async_000", 0, async function (done) {
    try {
      environment.getStorageData((err, url) => {
        expect(isString(url)).assertTrue();
        expect(url == "/data").assertTrue();
        console.log("environment_test_get_storage_data_async_000:" + url);
        done();
      });
    } catch (e) {
  ...
  it("environment_test_get_storage_data_async_002", 0, async function (done) {
    try {
      let url = await environment.getStorageData();
      expect(isString(url)).assertTrue();
      expect(url == "/data").assertTrue();
   ...
   * @tc.desc Test getUserData() interfaces.
   * @tc.size MEDIUM
   * @tc.type Function
   * @tc.level Level 0
   * @tc.require
  ...
  it("environment_test_get_user_data_async_000", 0, async function (done) {
    try {
      let url = await environment.getUserData();
      expect(isString(url)).assertTrue();
      expect(url == "/data/storage/0").assertTrue();
  ...
  it("environment_test_get_user_data_async_001", 0, async function (done) {
    try {
      environment.getUserData((err, url) => {
        expect(isString(url)).assertTrue();
        expect(url == "/data/storage/0").assertTrue();
        console.log("environment_test_get_user_data_async_001:" + url);
        done();
      });
    } catch (e) {
