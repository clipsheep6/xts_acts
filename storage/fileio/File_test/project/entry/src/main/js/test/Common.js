...
export const FILE_CONTENT = "仙女星系 （英语: Andromeda Galaxy; M31; NGC 224 ；曾被称为 仙女座大星云 ），位于仙女座方位的拥有巨大盘状结构的 旋涡星系 ， 梅西耶星表 编号为M31， 星云星团新总表 编号位 NGC 224 ，直径22万光年，距离地球有254万光年，是距银河系最近的大星系。"
...
export function differentFileName(testName) {
    const BASE_PATH = "/data/accounts/account_0/appdata/ohos.acts.distributeddatamgr.distributedfile/"
    return BASE_PATH + testName
}
...
export function randomString(len) {
    len = len;
    var $chars = 'aaaabbbbcccc';    /****默认去掉了容易混淆的字符oOLl,9gq,Vv,Uu,I1****/
