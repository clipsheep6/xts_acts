  ...
  it('file_test_000', 0, async function (done) {
    for (let i = 0; i < 10; i++) {
      file.writeText({
        ...
        text: 'Text',
        success: function () {
          console.log('file_test_000 => pass, call writeText success. ' + i)
          done()
        },
    ...
    for (let i = 0; i < 10; i++) {
      file.readText({
        ...
        success: function (data) {
          console.log('file_test_001 => pass, call readText success. data.text: ' + data.text)
          done()
        },
        fail: function (data, code) {
    ...
    for (let i = 0; i < 10; i++) {
      file.copy({
        ...
        success: function (uri) {
          console.log('file_test_002 => pass,call copy success. uri:' + uri)
          done()
        },
        fail: function (data, code) {
  ...
  it('file_test_003', 0, async function (done) {
    for (let i = 0; i < 10; i++) {
      ...
      file.move({
        ...
        success: function (uri) {
          console.log('file_test_003 => pass,call move success. uri:' + uri)
          done()
        },
        fail: function (data, code) {
  ...
  it('file_test_004', 0, async function (done) {
    ...
    for (let i = 0; i < 10; i++) {
      file.readArrayBuffer({
        uri: 'internal://app/file_test_004',
        success: function (data) {
          console.log('file_test_004 => pass,call readArrayBuffer success. data.buffer: ' + data.buffer)
          done()
        },
        fail: function (data, code) {
  ...
  it('file_test_006', 0, async function (done) {
    for (let i = 0; i < 10; i++) {
      ...
      file.readText({
        uri: 'internal://app/file_test_006',
        success: function (data) {
          console.log('file_test_006 => pass,call readText success: ' + data.text);
          done()
        },
        fail: function (data, code) {
  ...
  it('file_test_007', 0, async function (done) {
    ...
    for (let i = 0; i < 10; i++) {
      ...
      file.readArrayBuffer({
        uri: 'internal://app/file_test_007',
        success: function (data) {
          console.log('file_test_007 => pass,call readArrayBuffer success: ' + data.buffer);
          done()
        },
        fail: function (data, code) {
  ...
  it('file_test_008', 0, async function (done) {
    for (let i = 0; i < 10; i++) {
      ...
      file.copy({
        ...
        success: function (uri) {
          console.log('file_test_008 => pass,call copy success. uri:' + uri);
          done()
        },
        fail: function (data, code) {
