...
/*!*************************************************************************************************************************!*\
  !*** ../../../../../../../../Desktop/xts/ace_ets_third_test_ets/entry/src/main/ets/MainAbility/pages/Stepper.ets?entry ***!
  \*************************************************************************************************************************/
class StepperExample extends View {
    ...
    render() {
        ...
        Stepper.onNext((index, pendingIndex) => {
            console.info('pendingIndex:' + pendingIndex);
        });
        Stepper.onPrevious((index, pendingIndex) => {
            console.info('pendingIndex:' + pendingIndex);
        });
