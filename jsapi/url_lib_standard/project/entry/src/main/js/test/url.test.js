...
describe('Url_mxa_jk_Test', function () {
  ...
  //new url  SearchParams
    ...
    it('Url_base_test_012', 0, function () {
    ...
    it('Url_base_test_013', 0, function () {
        let params = new Url.URL('htt1p://www.0902zy.cn/path?abc=123&def=456#yyyy')
        let params1 = new Url.URL('//www.baidu.com/ssaa',params)
        var result = params1.href
    ...
    it('Url_base_test_014', 0, function () {
        let params = new Url.URL('htt1p://www.0902zy.cn/path?abc=123&def=456#yyyy')
    ...
    it('Url_base_test_015', 0, function () {
        let params = new Url.URL('htt1p://www.0902zy.cn/path?abc=123&def=456#yyyy')
        var result = params.searchParams.toString();
        expect(result).assertEqual('abc=123&def=456')
    })

    it('Url_base_test_016', 0, function () {
        let params = new Url.URL('htt1p://www.0902zy.cn/path?abc=123&def=456#yyyy')
        params.searchParams.append('ghr', '789')
        var result = params.searchParams.toString();
        expect(result).assertEqual('abc=123&def=456&ghr=789')
    })
})