...
napi_value ImageSourceNDKTest::GetDelayTime(napi_env env,
    napi_callback_info info)  __attribute__((no_sanitize("cfi")))
{
    napi_value argValue[SIZE_ONE] = {0};
    size_t argCount = SIZE_ONE;
...
napi_value ImageSourceNDKTest::GetSupportedFormats(napi_env env,
    napi_callback_info info)  __attribute__((no_sanitize("cfi")))
{
