...
export default function ImageReceiver() {
    describe('ImageReceiver', function () {
        ...
        const YUV_Y = image.ComponentType.YUV_Y;
        const YUV_U = image.ComponentType.YUV_U;
        const YUV_V = image.ComponentType.YUV_V;
        const JPEG = image.ComponentType.JPEG;
        const WIDTH = 8192;
        const HEIGHT = 8;
        const FORMAT = 4;
        const CAPACITY = 8;
        const YCBCR_422_SP = image.ImageFormat.YCBCR_422_SP;
