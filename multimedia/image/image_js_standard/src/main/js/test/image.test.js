...
describe('Image', function () {
    ...
    */
    ...
    it('TC_021-2', 0, async function (done) {
        ...
        const area = { pixels: new ArrayBuffer(20), offset: 0, stride: 8, region: { size: { height: 1, width: 2 }, x: -1, y: 0 }}
        pixelmap.readPixels(area,() => {
            var bufferArr = new Uint8Array(area.pixels);
            var res = true;
             for (var i = 0; i < bufferArr.length; i++) {
    ...
    */
    ...
    it('TC_021-3', 0, async function (done) {
        ...
        const area = { pixels: new ArrayBuffer(0), offset: 0, stride: 8, region: { size: { height: 1, width: 2 }, x: 0, y: 0 }}
        pixelmap.readPixels(area,() => {
            var bufferArr = new Uint8Array(area.pixels);
            var res = true;
             for (var i = 0; i < bufferArr.length; i++) {
    ...
    */
    ...
    it('TC_021-4', 0, async function (done) {
        ...
        const area = { pixels: new ArrayBuffer(20), offset: 21, stride: 8, region: { size: { height: 1, width: 2 }, x: 0, y: 0 }}
        pixelmap.readPixels(area,() => {
            var bufferArr = new Uint8Array(area.pixels);
            var res = true;
             for (var i = 0; i < bufferArr.length; i++) {
    ...
    */
    ...
    it('TC_021-5', 0, async function (done) {
        ...
        const area = { pixels: new ArrayBuffer(20), offset: 0, stride: 8, region: { size: { height: -1, width:-1}, x: 0, y: 0 }}
        pixelmap.readPixels(area,() => {
            var bufferArr = new Uint8Array(area.pixels);
            var res = true;
             for (var i = 0; i < bufferArr.length; i++) {
    ...
    */
    ...
    it('TC_042-5', 0, async function (done) {
        ...
        imageSourceApi.createPixelMap(decodingOptions, pixelmap => {
            console.info('TC_042-5 createPixelMap ');
            expect(pixelmap == null ).assertTrue();
            done();
            })
        })
