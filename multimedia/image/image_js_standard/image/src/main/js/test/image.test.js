...
export default function imageJsTest() {
    describe('imageJsTest', function () {
        ...
        */
        ...
        it('SUB_MULTIMEDIA_IMAGE_CREATEPIXELMAP_CALLBACK_1000', 0, async function (done) {
            ...
            image.createPixelMap(Color, opts, (err, pixelmap) => {
                globalpixelmap = pixelmap;
                expect(pixelmap == undefined).assertTrue();
                console.info('SUB_MULTIMEDIA_IMAGE_CREATEPIXELMAP_CALLBACK_1000 success');
                done();
            })
        })
       ...
       */
        ...
        /**
         * @tc.number    : SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_SUFFIXFILE_0100
         ...
         * @tc.level     : Level 0
         */
        it('SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_SUFFIXFILE_0100', 0, async function (done) {
            const imageSourceApi = image.createImageSource('file:///data/local/tmp/test.123');
            expect(imageSourceApi == undefined).assertTrue();
            console.info('SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_SUFFIXFILE_0100 success');
            done();
        })

        /**
         * @tc.number    : SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_URI_0100
         ...
         * @tc.level     : Level 0
         */
        it('SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_URI_0100', 0, async function (done) {
            try {
                const imageSourceApi = image.createImageSource('file:///multimedia/test.jpg');
                expect(imageSourceApi == undefined).assertTrue();
                console.info('SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_URI_0100 success');
                done();
            } catch (error) {
                console.info('SUB_MULTIMEDIA_IMAGE_CREATEIMAGESOURCE_URI_WRONG_URI_0100 error: ' + error);
                expect(false).assertTrue();
                done();
            }
        })
