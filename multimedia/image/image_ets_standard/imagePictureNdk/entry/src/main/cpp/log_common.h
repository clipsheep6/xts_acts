...
constexpr const char *APP_LOG_TAG = "DEBUG TEST";
...
#define H_LOGE(format, ...) \
    OH_LOG_Print(LOG_APP, LOG_ERROR, LOG_DOMAIN, APP_LOG_TAG, \
                 "%{public}s:%{public}s:%{public}d: " format, __FILE_NAME__, __FUNCTION__, __LINE__, ##__VA_ARGS__)
