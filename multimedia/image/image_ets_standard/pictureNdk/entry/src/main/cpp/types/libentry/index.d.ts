...
export const createTestPixelmapByImageSource: (pixelFormat: image.PixelMapFormat) => void;
...
export const AuxiliaryPictureInfoSetSizeErrorCode: (size: image.Size) => number;
export const AuxiliaryPictureInfoSetRowStrideErrorCode: (rowStride: number) => number;
export const AuxiliaryPictureInfoSetPixelFormatErrorCode: (pixelFormat: image.PixelMapFormat | number) => number;
