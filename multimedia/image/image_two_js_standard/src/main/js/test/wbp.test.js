...
describe('Image', function () {
    ...
    async function getFd(fileName) {
        ...
        let getFileOp = {
            ...
            selectionArgs: [fileName, 'Pictures/'],
            extendArgs: "",
        }
        let fetchFileResult = await mediaTest.getFileAssets(getFileOp);
        let count = fetchFileResult.getCount();
        console.info('[mediaLibrary]case count' +count);

        fileAsset = await fetchFileResult.getAllObject();
        console.info('[mediaLibrary]case fileAsset' +fileAsset.length);
        
        if (fileAsset.length != undefined) {
            await fileAsset[0].open('rw').then((fd) => {
                if (fd == undefined) {
                    console.info('[mediaLibrary]case open fd undefined');
                } else {
                    fdNumber = fd;
    ...
    async function createPixMap_cb(done, testNum, arg) {
    ...
    async function createPixMap_promise(done, testNum, arg) {
        await getFd("test_large.webp");
        const imageSourceApi = image.createImageSource(fdNumber);
        if (imageSourceApi == undefined) {
            console.info(`${testNum} create image source failed`);
    ...
    async function packing_promise2(done, testNum, arg) {
        ...
        image.createPixelMap(color, opts)
            .then( pixelmap => {
                if (pixelmap == undefined) {
                    ...
                    console.info(`${testNum} debug 222222`);
                    if (imagePackerApi == undefined) {
                        console.info(`${testNum} create image packer failed`);
                        expect(false).assertTrue();
                        done();
                    } else {
                        console.info(`${testNum} debug 333333`);
    ...
    async function packing_cb(done, testNum, arg) {
        console.info(`${testNum} enter`);
        var height = 4
        var width = 6
        var pixelSize = 4
    ...
    async function packing_promiseF(done, testNum, arg) {
        console.info(`${testNum} enter`);
        var height = 4
        var width = 6
        var pixelSize = 4
    ...
    async function packing_cbF(done, testNum, arg) {
        console.info(`${testNum} enter`);
        var height = 4
        var width = 6
        var pixelSize = 4
    ...
    */
    it('wbp_001', 0, async function (done) {
        try {
            ...
            console.info('11111111111 error: ' + error);
            expect(false).assertTrue();
            done();
        }
    ...
    it('wbp_002', 0, async function (done) {
        try {
            await getFd("test_large.webp");
            console.info('1111111111:' + fdNumber);
            const imageSourceApi = image.createImageSource(fdNumber);
            if (imageSourceApi == undefined) {
    ...
    it('wbp_005', 0, async function (done) {
        ...
        createPixMap_cb(done, 'wbp_005', decodingOptions)
    })
    ...
    it('wbp_006', 0, async function (done) {
        ...
        createPixMap_cb(done, 'wbp_006', decodingOptions)
    })
    ...
    it('wbp_007', 0, async function (done) {
        ...
        createPixMap_cb(done, 'wbp_007', decodingOptions)
    })
    ...
    */
    it('wbp_008', 0, async function (done) {
        ...
        createPixMap_cb(done, 'wbp_008', decodingOptions)
    })
    ...
    */
    it('wbp_009', 0, async function (done) {
        ...
        createPixMap_cb(done, 'wbp_009', decodingOptions)
    })
    ...
    */
    it('wbp_010', 0, async function (done) {
        ...
        createPixMap_promise(done, 'wbp_010', decodingOptions)
    })
    ...
    */
    it('wbp_011', 0, async function (done) {
        ...
        createPixMap_promise(done, 'wbp_011', decodingOptions)
    })
    ...
    */
    it('wbp_012', 0, async function (done) {
        ...
        createPixMap_promise(done, 'wbp_012', decodingOptions)
    })
    ...
    */
    it('wbp_013', 0, async function (done) {
        ...
        createPixMap_promise(done, 'wbp_013', decodingOptions)
    })
    ...
    */
    it('wbp_014', 0, async function (done) {
        ...
        createPixMap_promise(done, 'wbp_014', decodingOptions)
    })
    ...
    it('wbp_015', 0, async function (done) {
        ...
        packing_cb(done, 'wbp_015', packOpts)
    })
    ...
    it('wbp_016', 0, async function (done) {
        ...
        packing_promise2(done, 'wbp_016', packOpts)
    })
    ...
    it('wbp_017', 0, async function (done) {
        ...
        packing_promiseF(done, 'wbp_017', packOpts)
    })
    ...
    it('wbp_018', 0, async function (done) {
        ...
        packing_promiseF(done, 'wbp_018', packOpts)
    })
    ...
    it('wbp_019', 0, async function (done) {
        ...
        packing_promiseF(done, 'wbp_019', packOpts)
    })
     ...
     */
     it('wbp_020', 0, async function (done) {
        ...
        packing_promiseF(done, 'wbp_020', packOpts)
    })
    ...
    it('wbp_021', 0, async function (done) {
        ...
        packing_cbF(done, 'wbp_021', packOpts)
    })
    ...
    it('wbp_022', 0, async function (done) {
        ...
        packing_cbF(done, 'wbp_022', packOpts)
    })    
    ...
    it('wbp_023', 0, async function (done) {
        let packOpts = { format: ["image/jpeg"] }
        packing_cbF(done, 'wbp_023', packOpts)
    })   
    ...
    it('wbp_024', 0, async function (done) {
        let packOpts = { quality: 90 }
        packing_cbF(done, 'wbp_024', packOpts)
    })   
})