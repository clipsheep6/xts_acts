...
describe('audioManger', async function () {
    ...
    /* *
        ...
        * @tc.name      : getAudioManger - setVolume 
        * @tc.desc      : setvolume mutimple times with different instance 
        * @tc.size      : MEDIUM
        * @tc.type      : Function
        * @tc.level     : Level 0
    */
    ...
    /* *
        ...
        * @tc.name      : getAudioManger - setVolume 
        * @tc.desc      : setvolume multiple times with different instance
        * @tc.size      : MEDIUM
        * @tc.type      : Function
        * @tc.level     : Level 0
    */
    it('SUB_AUDIO_MANAGER_getAudioManger_002', 0, async function (done) {
        ...
        promise.then(async function () {
            ...
            audioManager2.setVolume(audioMedia,lowVol);
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_017', 0, async function (done) {
        ...
        await audioManager.setVolume(audioMedia,-1).then(() => {                                //Setting negative audio volume for error senario
            console.info('AudioFrameworkTest: Media setVolume Promise:Negetive: FAIL');
            expect(false).assertTrue();
        }).catch((err) => {
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_018', 0, async function (done) {
        audioManager.setVolume(audioMedia,-1, (err) => {                                                  //Setting negative audio volume for error senario
            if (err) {
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_019', 0, async function (done) {
        ...
        await audioManager.setVolume(audioRingtone,-1).then(() => {                                              //Setting negative audio volume for error senario
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_020', 0, async function (done) {
        audioManager.setVolume(audioRingtone,-1, (err) => {                                              //Setting negative audio volume for error senario
            if (err) {
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_004', 0, async function (done) {
        audioManager.setRingerMode(2, (err) => {     //Setting Ringtone Mode to Normal ENUM 2 = RINGER_MODE_NORMAL
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_005', 0, async function (done) {
        audioManager.setRingerMode(0, (err) => {     //Setting Ringtone Mode to Silent ENUM 0 = RINGER_MODE_SILENT
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_006', 0, async function (done) {
        audioManager.setRingerMode(1, (err) => {     //Setting Ringtone Mode to Vibration ENUM 1 = RINGER_MODE_VIBRATE
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_001', 0, async function (done) {
        await audioManager.setDeviceActive(1,false).then(async function (){       //Setting device active ENUM 1 = SPEAKER
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_003', 0, async function (done) {
        await audioManager.setDeviceActive(2,false).then(async function (){       //Setting device active ENUM 2 = WIRED_HEADSET
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_005', 0, async function (done) {
        await audioManager.setDeviceActive(3,false).then(async function (){       //Setting device active ENUM 3 = BLUETOOTH_SCO
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_007', 0, async function (done) {
        await audioManager.setDeviceActive(4,false).then(async function (){       //Setting device active ENUM 4 = BLUETOOTH_A2DP
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_009', 0, async function (done) {
        await audioManager.setDeviceActive(5,false).then(async function (){       //Setting device active ENUM 5 = MIC
