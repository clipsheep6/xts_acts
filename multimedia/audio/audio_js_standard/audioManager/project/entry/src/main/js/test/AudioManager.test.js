...
describe('AudioManager.test.js', async function () {
    console.log('AudioManager: Create AudioManger Object JS Framework');
    ...
    beforeAll(function () {
        console.log('AudioManagerTest: beforeAll： Prerequisites at the test suite level, which are executed before the test suite is executed.');

    })

    beforeEach(function () {
        console.log('AudioManagerTest: beforeEach：Prerequisites at the test case level, which are executed before each test case is executed.');

    })
    afterEach(function () {
        console.log('AudioManagerTest: afterEach： Test case-level clearance conditions, which are executed after each test case is executed.');

    })
    afterAll(function () {
        console.log('AudioManagerTest: afterAll：  Test suite-level cleanup condition, which is executed after the test suite is executed');
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_001', 0, async function (done) {
        ...
        promise.then(async function () {
            console.log('AudioManagerTest: Media setVolume promise: successful');
            audioManager.getVolume(audioMedia).then(async function (data) {
                if(data == lowVol){
                    console.log('AudioManagerTest: Media getVolume Promise: PASS :' + data);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Media getVolume Promise: FAIL :' + data);
                    expect(false).assertTrue();
                }
                });
            });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_004', 0, async function (done) {
        console.log('AudioManagerTest: Media setVolume Promise:Out of range: Setvol 100');
        await audioManager.setVolume(audioMedia,outOfRangeVol).then(() => {
            expect(false).assertTrue();
        }).catch((err) => {
            console.log('AudioManagerTest: Media setVolume Promise:Out of range: PASS :' + err.message);
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_005', 0, async function (done) {
        ...
        audioManager.setVolume(audioMedia,highVol, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: failed to set volume: Callback:  ${err.message}`);
                expect(false).assertTrue();
            }
            console.log(`AudioManagerTest: callback :  Media setVolume successful `);
            audioManager.getVolume(audioMedia, (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: callback : Media: failed to get volume ${err.message}`);
                    expect(false).assertTrue();
                }
                else if(value == highVol){
                    console.log('AudioManagerTest: callback : Media getVolume: PASS :' + value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: callback : Media getVolume: FAIL :' + value);
                    expect(false).assertTrue();
                }
                done();
            }); 
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_008', 0, async function (done) {
        ...
        audioManager.setVolume(audioMedia,outOfRangeVol, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: setVolume: Out of range: Callback: PASS:  ${err.message}`);
                expect(volErrorMesg).assertEqual(err.message);
            }
            else{
                console.log('AudioManagerTest: setVolume: callback : Media Out of range: FAIL :' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_009', 0, async function (done) {
        ...
        promise.then(async function (data) {
            console.log('AudioManagerTest: Ringtone setVolume promise: successful');
            audioManager.getVolume(audioRingtone).then(async function (data) {
                if(data == lowVol){
                    console.log('AudioManagerTest: Ringtone getVolume Promise: PASS :' + data);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Ringtone getVolume Promise: FAIL :' + data);
                    expect(false).assertTrue();
                }
                });
            });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_012', 0, async function (done) {
        console.log('AudioManagerTest: Ringtone setVolume Promise: Out of range: Setvol 30');
        await audioManager.setVolume(audioRingtone,outOfRangeVol).then((data) => {
            console.log('AudioManagerTest: Ringtone setVolume Promise:Out of range: FAIL :' + data);
            expect(false).assertTrue();
        }).catch((err) => {
            console.log('AudioManagerTest: Ringtone setVolume Promise:Out of range: PASS :' + (err.message));
            expect(volErrorMesg).assertEqual(err.message);
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_013', 0, async function (done) {
        ...
        audioManager.setVolume(audioRingtone,highVol, (err, value) => {
            ...
            console.log(`AudioManagerTest: callback :  Ringtone setVolume successful `);
            audioManager.getVolume(audioRingtone, (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: callback : Ringtone: failed to get volume ${err.message}`);
                    expect(false).assertTrue();
                }
                else if(value == highVol){
                    console.log('AudioManagerTest: callback : Ringtone getVolume: PASS :' + value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: callback : Ringtone getVolume: FAIL :' + value);
                    expect(false).assertTrue();
                }
                done();
            }); 
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_016', 0, async function (done) {
        ...
        audioManager.setVolume(audioRingtone,outOfRangeVol, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Out of range Volume: Callback:  ${err.message}`);
                expect(volErrorMesg).assertEqual(err.message);
            }            
            else{
                console.log('AudioManagerTest: Out of range Volume: callback : Ringtone set volume: FAIL :' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_017', 0, async function (done) {
        console.log('AudioManagerTest: Media setVolume promise: Negative Value -1');
        await audioManager.setVolume(audioMedia,-1).then((data) => {                                //Setting negative audio volume for error senario
            console.log('AudioManagerTest: Media setVolume Promise:Negetive: FAIL :' + data);
            expect(false).assertTrue();
        }).catch((err) => {
            console.log('AudioManagerTest: Media setVolume Promise:Negetive: PASS :' + (err.message));
            expect(true).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_018', 0, async function (done) {
        ...
        audioManager.setVolume(audioMedia,-1, (err, value) => {                                                  //Setting negative audio volume for error senario
            if (err) {
                console.error(`AudioManagerTest: setVolume Callback: Negative: PASS: ${err.message}`);
                expect(true).assertTrue();
            }            
            else{
                console.log('AudioManagerTest: setVolume callback : Media Negative: FAIL :' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_019', 0, async function (done) {
        console.log('AudioManagerTest: Ringtone setVolume promise: Negative');
        await audioManager.setVolume(audioRingtone,-1).then((data) => {                                              //Setting negative audio volume for error senario
            console.log('AudioManagerTest: Ringtone setVolume Promise:Negative: FAIL :' + data);
            expect(false).assertTrue();
        }).catch((err) => {
            console.log('AudioManagerTest: Ringtone setVolume Promise:Negative: PASS :' + (err.message));
            expect(volErrorMesg).assertEqual(err.message);
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_020', 0, async function (done) {
        ...
        audioManager.setVolume(audioRingtone,-1, (err, value) => {                                              //Setting negative audio volume for error senario
            if (err) {
                console.error(`AudioManagerTest: setVolume: Negative: Callback:  ${err.message}`);
                expect(volErrorMesg).assertEqual(err.message);
            }            
            else{
                console.log('AudioManagerTest: setVolume: Negative: callback : Ringtone set volume: FAIL :' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_021', 0, async function (done) {
        ...
        promise.then(async function (data) {
            audioManager.getVolume(audio.AudioVolumeType.MEDIA).then(async function (data) {
                if(data == lowVol){
                    console.log('AudioManagerTest: Media getVolume Promise: ENAME : PASS :' + data);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Media getVolume Promise: ENAME : FAIL :' + data);
                    expect(false).assertTrue();
                }
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_022', 0, async function (done) {
        ...
        audioManager.setVolume(audio.AudioVolumeType.MEDIA,highVol, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: failed to set volume: Callback: ENAME :  ${err.message}`);
                expect(false).assertTrue();
            }
            console.log(`AudioManagerTest: callback : ENAME :  Media setVolume successful `);
            audioManager.getVolume(audio.AudioVolumeType.MEDIA, (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: callback : Media: ENAME : failed to get volume ${err.message}`);
                    expect(false).assertTrue();
                }
                else if(value == highVol){
                    console.log('AudioManagerTest: callback : Media getVolume: ENAME : PASS :' + value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: callback : Media getVolume: ENAME : FAIL :' + value);
                    expect(false).assertTrue();
                }
                done();
            }); 
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_023', 0, async function (done) {
        ...
        promise.then(async function (data) {
            console.log('AudioManagerTest: Ringtone setVolume promise: ENAME: successful');

            audioManager.getVolume(audio.AudioVolumeType.RINGTONE).then(async function (data) {
                if(data == highVol){
                    console.log('AudioManagerTest: Ringtone getVolume Promise: ENAME: PASS :' + data);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Ringtone getVolume Promise: ENAME: FAIL :' + data);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_SetVolume_024', 0, async function (done) {
        audioManager.setVolume(audio.AudioVolumeType.RINGTONE,lowVol, (err, value) => {
            ...
            console.log(`AudioManagerTest: callback : ENAME:  Ringtone setVolume successful `);
            audioManager.getVolume(audio.AudioVolumeType.RINGTONE, (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: callback : Ringtone: ENAME: failed to get volume ${err.message}`);
                    expect(false).assertTrue();
                }
                else if(value == lowVol){
                    console.log('AudioManagerTest: callback : Ringtone getVolume: ENAME: PASS :' + value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: callback : Ringtone getVolume: ENAME: FAIL :' + value);
                    expect(false).assertTrue();
                }
                done();
            }); 
    ...
    it('SUB_AUDIO_MANAGER_getMaxVolume_001', 0, async function (done) {
        ...
        promise.then(async function (data) {
            if (data==maxVol){
                console.log('AudioManagerTest: Media getMaxVolume promise : PASS:' + data);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Media getMaxVolume promise : FAIL: ' + data);
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getMaxVolume_002', 0, async function (done) {
        ...
        audioManager.getMaxVolume(audioMedia, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: callback : Media : failed to getMaxVolume ${err.message}`);
                return;
            }
            else if (value=maxVol){
                console.log('AudioManagerTest: callback : Media:  getMaxVolume : PASS:' + value);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: callback : Media:  getMaxVolume : FAIL: ' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getMaxVolume_003', 0, async function (done) {
        ...
        promise.then(async function (data) {
            if (data==maxVol){
                console.log('AudioManagerTest: Ringtone getMaxVolume promise : PASS:' + data);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Ringtone getMaxVolume promise : FAIL: ' + data);
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getMaxVolume_004', 0, async function (done) {
        audioManager.getMaxVolume(audioRingtone, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: callback : Ringtone : failed to getMaxVolume ${err.message}`);
                return;
            }
            else if (value==maxVol){
                console.log('AudioManagerTest: callback : Ringtone:  getMaxVolume : PASS:' + value);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: callback : Ringtone:  getMaxVolume : FAIL: ' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getMinVolume_001', 0, async function (done) {
        ...
        promise.then(async function (data) {
            if (data==minVol){
                console.log('AudioManagerTest: Media getMinVolume promise : PASS:' + data);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Media getMinVolume promise : FAIL: ' + data);
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getMinVolume_002', 0, async function (done) {
        ...
        audioManager.getMinVolume(audioMedia, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: callback : Media : failed to getMinVolume ${err.message}`);
                return;
            }
            else if (value==minVol){
                console.log('AudioManagerTest: callback : Media:  getMinVolume : PASS:' + value);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: callback : Media:  getMinVolume : FAIL: ' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getMinVolume_003', 0, async function (done) {
        ...
        promise.then(async function (data) {
            if (data==minVol){
                console.log('AudioManagerTest: Ringtone getMinVolume promise : PASS:' + data);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Ringtone getMinVolume promise : FAIL: ' + data);
                expect(false).assertTrue();
            }
    ...
    it('SUB_AUDIO_MANAGER_getMinVolume_004', 0, async function (done) {
        ...
        audioManager.getMinVolume(audioRingtone, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: callback : Ringtone : failed to getMinVolume ${err.message}`);
                return;
            }
            else if (value==minVol){
                console.log('AudioManagerTest: callback : Ringtone:  getMinVolume : PASS:' + value);
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: callback : Ringtone:  getMinVolume : FAIL: ' + value);
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getDevices_001', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            console.log('AudioManagerTest: Promise: getDevices OUTPUT_DEVICES_FLAG');
            value.forEach(displayDeviceProp);
            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Promise: getDevices : OUTPUT_DEVICES_FLAG :  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Promise: getDevices : OUTPUT_DEVICES_FLAG :  FAIL');
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getDevices_002', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            console.log('AudioManagerTest: Promise: getDevices INPUT_DEVICES_FLAG');

            console.log('AudioManagerTest: Promise: getDevices INPUT_DEVICES_FLAG');
            value.forEach(displayDeviceProp);

            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Promise: getDevices : INPUT_DEVICES_FLAG :  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Promise: getDevices : INPUT_DEVICES_FLAG :  FAIL');
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getDevices_003', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            console.log('AudioManagerTest: Promise: getDevices ALL_DEVICES_FLAG');

            console.log('AudioManagerTest: Promise: getDevices ALL_DEVICES_FLAG');
            value.forEach(displayDeviceProp);

            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Promise: getDevices : ALL_DEVICES_FLAG :  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Promise: getDevices : ALL_DEVICES_FLAG :  FAIL');
                expect(false).assertTrue();
            }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_getDevices_004', 0, async function (done) {
        ...
        audioManager.getDevices(1, (err, value) => {    //Getting all Output devices Enumb 1 = OUTPUT_DEVICES_FLAG
            ...
            console.log('AudioManagerTest: Callback: getDevices OUTPUT_DEVICES_FLAG');

            if (err) {
                console.error(`AudioManagerTest: Callback: OUTPUT_DEVICES_FLAG: failed to get devices ${err.message}`);
                return;
            }
            ...
            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Callback: getDevices : OUTPUT_DEVICES_FLAG :  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Callback: getDevices : OUTPUT_DEVICES_FLAG :  FAIL');
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getDevices_005', 0, async function (done) {
        ...
        audioManager.getDevices(2, (err, value) => {    //Getting all Input Devices ENUM 2 = INPUT_DEVICES_FLAG
            ...
            console.log('AudioManagerTest: Callback: getDevices INPUT_DEVICES_FLAG');

            if (err) {
                console.error(`AudioManagerTest: Callback: INPUT_DEVICES_FLAG: failed to get devices ${err.message}`);
                return;
            }
            ...
            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Callback: getDevices : INPUT_DEVICES_FLAG:  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Callback: getDevices : INPUT_DEVICES_FLAG:  FAIL');
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_getDevices_006', 0, async function (done) {
        ...
        audioManager.getDevices(3, (err, value) => {        //Getting all devies connected 3 = ALL_DEVICES_FLAG
            ...
            console.log('AudioManagerTest: Callback: getDevices ALL_DEVICES_FLAG');

            if (err) {
                console.error(`AudioManagerTest: Callback: ALL_DEVICES_FLAG: failed to get devices ${err.message}`);
                return;
            }
            ...
            if (deviceTypeValue != null && deviceRoleValue != null){
                console.log('AudioManagerTest: Callback: getDevices : ALL_DEVICES_FLAG:  PASS');
                expect(true).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Callback: getDevices : ALL_DEVICES_FLAG:  FAIL');
                expect(false).assertTrue();
            }
            done();
        });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_001', 0, async function (done) {
        ...
        promise.then(async function (value) {
            console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_NORMAL');
            audioManager.getRingerMode().then(async function (value){
                if(value==2){
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_NORMAL: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_NORMAL: FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_002', 0, async function (done) {
        ...
        promise.then(async function (value){
            console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_SILENT');
            audioManager.getRingerMode().then(async function (value){
                if(value==0){
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_SILENT: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_SILENT: FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_003', 0, async function (done) {
        ...
        promise.then(async function (value){
            console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_VIBRATE');
            audioManager.getRingerMode().then(async function (value){
                if(value==1){
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_VIBRATE: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: setRingerMode​ RINGER_MODE_VIBRATE: FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_004', 0, async function (done) {
        ...
        audioManager.setRingerMode(2, (err, value) => {     //Setting Ringtone Mode to Normal ENUM 2 = RINGER_MODE_NORMAL
            ...
            console.log('AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_NORMAL');

            if (err) {
                console.error(`AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_NORMAL: Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            ...
            audioManager.getRingerMode((err, value) => {
                if (err) {
                    ...
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_NORMAL: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_NORMAL: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_005', 0, async function (done) {
        ...
        audioManager.setRingerMode(0, (err, value) => {     //Setting Ringtone Mode to Silent ENUM 0 = RINGER_MODE_SILENT
            ...
            console.log('AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_SILENT');

            if (err) {
                console.error(`AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_SILENT: Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            ...
            audioManager.getRingerMode((err, value) => {
                ...
                if(value==0){
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_SILENT: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_SILENT: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setRingerMode_006', 0, async function (done) {
        ...
        audioManager.setRingerMode(1, (err, value) => {     //Setting Ringtone Mode to Vibration ENUM 1 = RINGER_MODE_VIBRATE
            ...
            console.log('AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_VIBRATE');

            if (err) {
                console.error(`AudioManagerTest: Callback : setRingerMode​ RINGER_MODE_VIBRATE: Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            ...
            audioManager.getRingerMode((err, value) => {
                ...
                if(value==1){
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_VIBRATE: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: setRingerMode​ RINGER_MODE_VIBRATE: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_mute_001', 0, async function (done) {
        await audioManager.mute(audioMedia,true).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Media: Promise: TRUE');
            audioManager.isMute(audioMedia).then(async function (data) {
                if(data==true){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: TRUE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: TRUE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Media: TRUE: ERROR:' + err.message);
            expect(false).assertTrue();
        }); 
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_006', 0, async function (done) {
        audioManager.mute(audioMedia,false, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Set Stream Mute: Media: Callback: Error :  ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Set Stream Mute: Media: Callback : FALSE');
                audioManager.isMute(audioMedia, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : FALSE: Media : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: FALSE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_002', 0, async function (done) {
        audioManager.mute(audioMedia,true, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Media: Callback : TRUE');
                audioManager.isMute(audioMedia, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : TRUE: Media : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==true){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: TRUE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_005', 0, async function (done) {
        await audioManager.mute(audioMedia,false).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Media: Promise: FALSE');
            audioManager.isMute(audioMedia).then(async function (data) {
                if(data==false){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: FALSE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: FALSE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Media: FALSE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_003', 0, async function (done) {
        await audioManager.mute(audioRingtone,true).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Ringtone: Promise: TRUE');
            audioManager.isMute(audioRingtone).then(async function (data) {
                if(data==true){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: TRUE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: TRUE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: TRUE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_008', 0, async function (done) {
        ...
        audioManager.mute(audioRingtone,false, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Ringtone: Callback : FALSE');
                audioManager.isMute(audioRingtone, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : FALSE: Ringtone : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: FALSE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_004', 0, async function (done) {
        ...
        audioManager.mute(audioRingtone,true, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Ringtone: Callback : TRUE');
                audioManager.isMute(audioRingtone, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : TRUE: Ringtone : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==true){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: TRUE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_007', 0, async function (done) {
        ...
        await audioManager.mute(audioRingtone,false).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Ringtone: Promise: FALSE');
            audioManager.isMute(audioRingtone).then(async function (data) {
                if(data==false){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: FALSE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: FALSE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Rington: FALSE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_009', 0, async function (done) {
        await audioManager.mute(audio.AudioVolumeType.MEDIA,true).then(async function (data) {
            ...
            audioManager.isMute(audio.AudioVolumeType.MEDIA).then(async function (data) {
                if(data==true){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: TRUE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: TRUE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: TRUE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_015', 0, async function (done) {
        audioManager.mute(audio.AudioVolumeType.MEDIA,false, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Media: ENAME: Callback : FALSE');
                audioManager.isMute(audio.AudioVolumeType.MEDIA, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : FALSE: Media : ENAME: failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: ENAME: FALSE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: ENAME: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_010', 0, async function (done) {
        audioManager.mute(audio.AudioVolumeType.MEDIA,true, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Media: ENAME: Callback : TRUE');
                audioManager.isMute(audio.AudioVolumeType.MEDIA, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : TRUE: Media : ENAME: failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==true){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: ENAME: TRUE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: ENAME: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_011', 0, async function (done) {
        await audioManager.mute(audio.AudioVolumeType.MEDIA,false).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Media: ENAME: Promise: FALSE');
            audioManager.isMute(audio.AudioVolumeType.MEDIA).then(async function (data) {
                if(data==false){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: FALSE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: FALSE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Media: ENAME: FALSE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_012', 0, async function (done) {
        await audioManager.mute(audio.AudioVolumeType.RINGTONE,true).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Ringtone: ENAME: Promise: TRUE');
            audioManager.isMute(audio.AudioVolumeType.RINGTONE).then(async function (data) {
                if(data==true){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: ENAME: TRUE: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: ENAME: TRUE: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: ENAME: TRUE: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_016', 0, async function (done) {
        ...
        audioManager.mute(audio.AudioVolumeType.RINGTONE,false, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Ringtone: ENAME: Callback : FALSE');
                audioManager.isMute(audio.AudioVolumeType.RINGTONE, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : FALSE: Ringtone : ENAME: failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: ENAME: FALSE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: ENAME: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_013', 0, async function (done) {
        ...
        audioManager.mute(audio.AudioVolumeType.RINGTONE,true, (err, data) => {
            if (err) {
                ...
                console.log('AudioManagerTest: Set Stream Mute: Ringtone: ENAME: Callback : TRUE');
                audioManager.isMute(audio.AudioVolumeType.RINGTONE, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : TRUE: Ringtone : ENAME: failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==true){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: ENAME: TRUE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: ENAME: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_017', 0, async function (done) {
        await audioManager.mute(audioMedia,true).then(async function (data) {
            ...
            audioManager.isMute(audioMedia).then(async function (data) {
                if(data==false){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: SetVolume: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Media: SetVolume: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Media: SetVolume: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_018', 0, async function (done) {
        audioManager.mute(audioMedia,true, (err, data) => {
			if (err) {
                    console.error(`AudioManagerTest: Callback : SetVolume: Media : failed to set Mute Status ${err.message}`);
                    expect(false).assertTrue();
            }
            else{
                console.log('AudioManagerTest: Set Stream Mute: Media: Callback : TRUE');
                ...
                audioManager.isMute(audioMedia, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : SetVolume: Media : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: SetVolume: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Media: SetVolume: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_mute_019', 0, async function (done) {
        await audioManager.mute(audioRingtone,true).then(async function (data) {
            console.log('AudioManagerTest: Set Stream Mute: Ringtone: Promise: SetVolume');
			audioManager.setVolume(audioRingtone,highVol);
            audioManager.isMute(audioRingtone).then(async function (data) {
                if(data==false){
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: SetVolume: PASS:'+data);
                     expect(true).assertTrue();
                    }
                else{
                     console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: SetVolume: FAIL: '+data);
                     expect(false).assertTrue();
                    }
             });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: Is Stream Mute Ringtone: SetVolume: ERROR:' + err.message);
            expect(false).assertTrue();
        });
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_mute_020', 0, async function (done) {
        ...
        audioManager.mute(audioRingtone,true, (err, data) => {
			if (err) {
                console.error(`AudioManagerTest: Callback : SetVolume: Ringtone : failed to set Mute Status ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Set Stream Mute: Ringtone: Callback : SetVolume');
                audioManager.setVolume(audioRingtone,lowVol);
                audioManager.isMute(audioRingtone, (err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : SetVolume: Ringtone : failed to get Mute Status ${err.message}`);
                        expect(false).assertTrue();
                        return;
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: SetVolume: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : Is Stream Mute Ringtone: SetVolume: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_isActive_001', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Media: NOTE audio plaback as MEDIA needs to be played for the test case to PASS');
        const promise = audioManager.isActive(audioMedia);
        promise.then(async function (data) {
            if(data==true){
                console.log('AudioManagerTest: Promise: isActive: Media: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Promise: isActive: Media: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_isActive_002', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Media: NOTE audio plaback as MEDIA needs to be played for the test case to PASS');
        audioManager.isActive(audioMedia, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Media : isActive: failed  ${err.message}`);
                return;
            }
            else if(data==true){
                console.log('AudioManagerTest: Callback: isActive: Media: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Callback: isActive: Media: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
               done();
        });
    ...
    it('SUB_AUDIO_MANAGER_isActive_003', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Ringtone: NOTE audio plaback as Ringtone needs to be played for the test case to PASS');
        const promise = audioManager.isActive(audioRingtone);
        promise.then(async function (data) {
            if(data==true){
                console.log('AudioManagerTest: Promise: isActive: Ringtone: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Promise: isActive: Ringtone: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_isActive_004', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Ringtone: NOTE audio plaback as Ringtone needs to be played for the test case to PASS');
        audioManager.isActive(audioRingtone, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Ringtone : isActive: failed  ${err.message}`);
                return;
            }
            else if(data==true){
                console.log('AudioManagerTest: Callback: isActive: Ringtone: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Callback: isActive: Ringtone: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
               done();
        });
    ...
    it('SUB_AUDIO_MANAGER_isActive_005', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Media: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        const promise = audioManager.isActive(audioMedia);
        promise.then(async function (data) {
            if(data==false){
                console.log('AudioManagerTest: Promise: isActive: Media: TRUE: PASS:'+data);
    ...
    it('SUB_AUDIO_MANAGER_isActive_006', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Media: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        audioManager.isActive(audioMedia, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Media : isActive: failed  ${err.message}`);
                return;
    ...
    it('SUB_AUDIO_MANAGER_isActive_007', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Ringtone: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        const promise = audioManager.isActive(audioRingtone);
        promise.then(async function (data) {
            if(data==false){
                console.log('AudioManagerTest: Promise: isActive: Ringtone: TRUE: PASS:'+data);
    ...
    it('SUB_AUDIO_MANAGER_isActive_008', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Ringtone: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        audioManager.isActive(audioRingtone, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Ringtone : isActive: failed  ${err.message}`);
                return;
    ...
    it('SUB_AUDIO_MANAGER_isActive_009', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Media: ENAME: NOTE audio plaback as MEDIA needs to be played for the test case to PASS');
        const promise = audioManager.isActive(audio.AudioVolumeType.MEDIA).then(async function (data) {
            if(data==true){
                console.log('AudioManagerTest: Promise: isActive: Media: ENAME: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Promise: isActive: Media: ENAME: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_isActive_010', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Media: ENAME: NOTE audio plaback as MEDIA needs to be played for the test case to PASS');
        audioManager.isActive(audio.AudioVolumeType.MEDIA, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Media : isActive: ENAME: failed  ${err.message}`);
                return;
            }
            else if(data==true){
                console.log('AudioManagerTest: Callback: isActive: Media: ENAME: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Callback: isActive: Media: ENAME: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
               done();
        });
    ...
    it('SUB_AUDIO_MANAGER_isActive_011', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Ringtone: ENAME: NOTE audio plaback as Ringtone needs to be played for the test case to PASS');
        const promise = audioManager.isActive(audio.AudioVolumeType.RINGTONE);
        promise.then(async function (data) {
            if(data==true){
                console.log('AudioManagerTest: Promise: isActive: Ringtone: ENAME: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Promise: isActive: Ringtone: ENAME: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
        });
        await promise;
    ...
    it('SUB_AUDIO_MANAGER_isActive_012', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Ringtone: ENAME: NOTE audio plaback as Ringtone needs to be played for the test case to PASS');
        audioManager.isActive(audio.AudioVolumeType.RINGTONE, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Ringtone : isActive: ENAME: failed  ${err.message}`);
                return;
            }
            else if(data==true){
                console.log('AudioManagerTest: Callback: isActive: Ringtone: ENAME: TRUE: PASS:'+data);
                expect(true).assertTrue();
               }
           else{
                console.log('AudioManagerTest: Callback: isActive: Ringtone: ENAME: TRUE: FAIL: '+data);
                expect(false).assertTrue();
               }
               done();
        });
    ...
    it('SUB_AUDIO_MANAGER_isActive_013', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Media: ENAME: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
    ...
    it('SUB_AUDIO_MANAGER_isActive_014', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Media: ENAME: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        audioManager.isActive(audio.AudioVolumeType.MEDIA, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Media : ENAME: isActive: failed  ${err.message}`);
                return;
            }
            else if(data==false){
                console.log('AudioManagerTest: Callback: isActive: Media: ENAME: TRUE: PASS:'+data);
    ...
    it('SUB_AUDIO_MANAGER_isActive_015', 0, async function (done) {
        console.log('AudioManagerTest: Promise : isActive Ringtone: ENAME: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        const promise = audioManager.isActive(audio.AudioVolumeType.RINGTONE);
        promise.then(async function (data) {
            if(data==false){
                console.log('AudioManagerTest: Promise: isActive: Ringtone: ENAME: TRUE: PASS:'+data);
    ...
    it('SUB_AUDIO_MANAGER_isActive_016', 0, async function (done) {
        console.log('AudioManagerTest: Callback : isActive Ringtone: ENAME: NOTE: audio NOT PLAYING as MEDIA for the test case to PASS');
        audioManager.isActive(audio.AudioVolumeType.RINGTONE, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: Callback : Ringtone : ENAME: isActive: failed  ${err.message}`);
                return;
            }
            else if(data==false){
                console.log('AudioManagerTest: Callback: isActive: Ringtone: ENAME: TRUE: PASS:'+data);
    ...
    it('SUB_AUDIO_MANAGER_setMicrophoneMute_001', 0, async function (done) {
        await audioManager.setMicrophoneMute(true).then(async function (data) {
            console.log('AudioManagerTest: setMicrophoneMute: Promise: TRUE');
            audioManager.isMicrophoneMute().then(async function (data) {
                if(data==true){
                        console.log('AudioManagerTest: Promise: isMicrophoneMute: TRUE: PASS:'+data);
                        expect(true).assertTrue();
                    }
                else{
                        console.log('AudioManagerTest: Promise: isMicrophoneMute: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: setMicrophoneMute: TRUE: FAIL: Error :' + err.message);
            expect(false).assertTrue();
        }); 
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setMicrophoneMute_002', 0, async function (done) {
        await audioManager.setMicrophoneMute(false).then(async function (data) {
            console.log('AudioManagerTest: setMicrophoneMute: Promise: FALSE');
            audioManager.isMicrophoneMute().then(async function (data) {
                if(data==false){
                        console.log('AudioManagerTest: Promise: isMicrophoneMute: FALSE: PASS:'+data);
                        expect(true).assertTrue();
                    }
                else{
                        console.log('AudioManagerTest: Promise: isMicrophoneMute: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                });
        }).catch((err) => {
            console.log('AudioManagerTest: Promise: setMicrophoneMute: FALSE: FAIL: Error :' + err.message);
            expect(false).assertTrue();
        }); 
        done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setMicrophoneMute_003', 0, async function (done) {
        audioManager.setMicrophoneMute(true, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: setMicrophoneMute: Callback : TRUE: Error : ${err.message}`);
                expect(false).assertTrue();
            }
            else {            
                console.log('AudioManagerTest: setMicrophoneMute: Callback : TRUE');
                audioManager.isMicrophoneMute((err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : TRUE: isMicrophoneMute : Error ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(data==true){
                        console.log('AudioManagerTest: Callback : isMicrophoneMute: TRUE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : isMicrophoneMute: TRUE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setMicrophoneMute_004', 0, async function (done) {
        audioManager.setMicrophoneMute(false, (err, data) => {
            if (err) {
                console.error(`AudioManagerTest: setMicrophoneMute: Callback : FALSE: Error : ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: setMicrophoneMute: Callback : FALSE');
                audioManager.isMicrophoneMute((err, data) => {
                    if (err) {
                        console.error(`AudioManagerTest: Callback : FALSE: isMicrophoneMute : Error ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(data==false){
                        console.log('AudioManagerTest: Callback : isMicrophoneMute: FALSE: PASS: '+data);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Callback : isMicrophoneMute: FALSE: FAIL: '+data);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_001', 0, async function (done) {
        await audioManager.setDeviceActive(1,false).then(       //Setting device active ENUM 1 = SPEAKER
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : SPEAKER: Deactivate');
                audioManager.isDeviceActive(audio.DeviceType.SPEAKER).then(async function (value){
                    if(value==false){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Deactivate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_002', 0, async function (done) {
        await audioManager.setDeviceActive(audio.DeviceType.SPEAKER,true).then(
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : SPEAKER: Activate');
                audioManager.isDeviceActive(1).then(async function (value){
                    if(value==true){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Activate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Activate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : SPEAKER: Activate : FAIL :Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_003', 0, async function (done) {
        await audioManager.setDeviceActive(2,false).then(       //Setting device active ENUM 2 = WIRED_HEADSET
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : WIRED_HEADSET: Deactivate');
                audioManager.isDeviceActive(audio.DeviceType.WIRED_HEADSET).then(async function (value){
                    if(value==false){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : WIRED_HEADSET: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : WIRED_HEADSET: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  WIRED_HEADSET: Deactivate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_004', 0, async function (done) {
        await audioManager.setDeviceActive(audio.DeviceType.WIRED_HEADSET,true).then(
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : WIRED_HEADSET: Activate');
                audioManager.isDeviceActive(2).then(async function (value){
                    if(value==true){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : WIRED_HEADSET: Activate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : WIRED_HEADSET: Activate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  WIRED_HEADSET: Activate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_005', 0, async function (done) {
        await audioManager.setDeviceActive(3,false).then(       //Setting device active ENUM 3 = BLUETOOTH_SCO
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : BLUETOOTH_SCO: Deactivate');
                audioManager.isDeviceActive(audio.DeviceType.BLUETOOTH_SCO).then(async function (value){
                    if(value==false){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_SCO: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_SCO: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  BLUETOOTH_SCO: Deactivate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_006', 0, async function (done) {
        await audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_SCO,true).then(
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : BLUETOOTH_SCO: Activate');
                audioManager.isDeviceActive(3).then(async function (value){
                    if(value==true){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_SCO: Activate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_SCO: Activate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  BLUETOOTH_SCO: Activate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_007', 0, async function (done) {
        await audioManager.setDeviceActive(4,false).then(       //Setting device active ENUM 4 = BLUETOOTH_A2DP
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : BLUETOOTH_A2DP: Deactivate');
                audioManager.isDeviceActive(audio.DeviceType.BLUETOOTH_A2DP).then(async function (value){
                    if(value==false){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_A2DP: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_A2DP: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  BLUETOOTH_A2DP: Deactivate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_008', 0, async function (done) {
        await audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_A2DP,true).then(
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : BLUETOOTH_A2DP: Activate');
                audioManager.isDeviceActive(4).then(async function (value){
                    if(value==true){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_A2DP: Activate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : BLUETOOTH_A2DP: Activate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  BLUETOOTH_A2DP: Activate : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_009', 0, async function (done) {
        await audioManager.setDeviceActive(5,false).then(       //Setting device active ENUM 5 = MIC
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : MIC: Deactivate');
                audioManager.isDeviceActive(audio.DeviceType.MIC).then(async function (value){
                    if(value==false){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : MIC: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : MIC: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  MIC: Deactivate  : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_010', 0, async function (done) {
        await audioManager.setDeviceActive(audio.DeviceType.MIC,true).then(
            async function (value){
                console.log('AudioManagerTest: Device Test: Promise : setDeviceActive : MIC: Activate');
                audioManager.isDeviceActive(5).then(async function (value){
                    if(value==true){
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : MIC: Activate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Promise : isDeviceActive : MIC: Activate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                });
            }).catch((err) => {
                console.log('AudioManagerTest: Device Test: Promise : isDeviceActive :  MIC: Activate  : FAIL : Error :' + err.message);
                expect(false).assertTrue();
            });
            done();
    })
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_011', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.SPEAKER,false, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : SPEAKER: Deactivate: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : SPEAKER: Active');
                audioManager.isDeviceActive(1,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Deactivate: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==false){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_012', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.SPEAKER,true, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : SPEAKER: Active: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : SPEAKER: Active');
                audioManager.isDeviceActive(1,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Active: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==true){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Active : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : SPEAKER: Active : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_013', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.WIRED_HEADSET,false, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : WIRED_HEADSET: Deactivate: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : WIRED_HEADSET: Active');
                audioManager.isDeviceActive(2,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Deactivate: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==false){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_014', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.WIRED_HEADSET,true, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : WIRED_HEADSET: Active: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : WIRED_HEADSET: Active');
                audioManager.isDeviceActive(2,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Active: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==true){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Active : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : WIRED_HEADSET: Active : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_015', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_SCO,false, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_SCO: Deactivate: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_SCO: Active');
                audioManager.isDeviceActive(3,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Deactivate: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==false){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_016', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_SCO,true, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_SCO: Active: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_SCO: Active');
                audioManager.isDeviceActive(3,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Active: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==true){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Active : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_SCO: Active : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_017', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_A2DP,false, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_A2DP: Deactivate: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_A2DP: Active');
                audioManager.isDeviceActive(4,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Deactivate: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==false){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_018', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.BLUETOOTH_A2DP,true, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_A2DP: Active: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : BLUETOOTH_A2DP: Active');
                audioManager.isDeviceActive(4,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Active: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==true){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Active : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : BLUETOOTH_A2DP: Active : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_019', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.MIC,false, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : MIC: Deactivate: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : MIC: Active');
                audioManager.isDeviceActive(5,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Deactivate: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==false){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Deactivate : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Deactivate : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setDeviceActive_020', 0, async function (done) {
        audioManager.setDeviceActive(audio.DeviceType.MIC,true, (err, value) => {
            if (err) {
                console.error(`AudioManagerTest: Device Test: Callback : setDeviceActive : MIC: Active: Error: ${err.message}`);
                expect(false).assertTrue();
            }
            else {
                console.log('AudioManagerTest: Device Test: Callback : setDeviceActive : MIC: Active');
                audioManager.isDeviceActive(5,(err, value) => {
                    if (err) {
                        console.error(`AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Active: Error: ${err.message}`);
                        expect(false).assertTrue();
                    }
                    else if(value==true){
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Active : PASS :' +value);
                        expect(true).assertTrue();
                    }
                    else{
                        console.log('AudioManagerTest: Device Test: Callback : isDeviceActive : MIC: Active : FAIL :' +value);
                        expect(false).assertTrue();
                    }
                    done();
                });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_001', 0, async function (done) {
        ...
        promise.then(async function (value) {
            console.log('AudioManagerTest: Audio Parameter Test: Promise : setAudioParameter');
            audioManager.getAudioParameter('PBits per sample').then(async function (value){
                if(value=='8 bit'){
                    console.log('AudioManagerTest: Promise: getAudioParameter: Bits per sample : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : Bits per sample : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_002', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            audioManager.getAudioParameter('PNumber').then(async function (value){
                if(value=='4800'){
                    console.log('AudioManagerTest: Promise: getAudioParameter: PNumber : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : PNumber : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
        ...
        promise.then(async function (value) {
            ...
            audioManager.getAudioParameter('PLNumber').then(async function (value){
                if(value==''){
                    console.log('AudioManagerTest: Promise: getAudioParameter: PLNumber : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : PLNumber : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
        ...
        promise.then(async function (value) {
            ...
            audioManager.getAudioParameter('PDecimal').then(async function (value){
                if(value=='10.000000234324324324'){
                    console.log('AudioManagerTest: Promise: getAudioParameter: PDecimal : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : PDecimal : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
     ...
     it('SUB_AUDIO_MANAGER_setAudioParameter_005', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            audioManager.getAudioParameter('1212').then(async function (value){
                if(value=='PPNumber'){
                    console.log('AudioManagerTest: Promise: getAudioParameter: 1212 : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : 1212 : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_006', 0, async function (done) {
        ...
        promise.then(async function (value) {
            ...
            audioManager.getAudioParameter('PSpecial').then(async function (value){
                if(value=='[]\:";<>?,./~!@#$%^*()_+-={}|'){
                    console.log('AudioManagerTest: Promise: getAudioParameter: PSpecial : PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Promise: getAudioParameter : PSpecial : FAIL :' +value);
                    expect(false).assertTrue();
                }
            });
        });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_007', 0, async function (done) {
        audioManager.setAudioParameter('CBSample Rate', '16 bit', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: CBSample Rate : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('CBSample Rate', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: CBSample Rate: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                else if(value=='16 bit'){
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBSample Rate: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBSample Rate: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_008', 0, async function (done) {
        audioManager.setAudioParameter('Special', '~!@#$%^*()_+-={}|[]\:";<>?,./', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: Special : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('Special', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: Special: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                else if(value=='~!@#$%^*()_+-={}|[]\:";<>?,./'){
                    console.log('AudioManagerTest: Callback: getAudioParameter: Special: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: Special: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_009', 0, async function (done) {
        audioManager.setAudioParameter('CBDecimal', '10000.21321432432432', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: CBDecimal : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('CBDecimal', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: CBDecimal: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                else if(value=='10000.21321432432432'){
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBDecimal: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBDecimal: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_010', 0, async function (done) {
        audioManager.setAudioParameter('CBNumber', '5454', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback :CBNumber : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: CBNumber : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('CBNumber', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: CBNumber: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                else if(value=='5454'){
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBNumber: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBNumber: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_011', 0, async function (done) {
        audioManager.setAudioParameter('CBLNumber', '', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback :CBLNumber : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: CBLNumber : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('CBLNumber', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: CBLNumber: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                    ...
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBLNumber: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: CBLNumber: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    it('SUB_AUDIO_MANAGER_setAudioParameter_012', 0, async function (done) {
        audioManager.setAudioParameter('345667', 'xyza', (err, value) => {
            console.log('AudioManagerTest: Audio Parameter Test: Callback :345667 : setAudioParameter');
            if (err) {
                console.error(`AudioManagerTest: Callback : setAudioParameter: 345667 : Error: ${err.message}`);
                expect(false).assertTrue();
                return;
            }        
            audioManager.getAudioParameter('345667', (err, value) => {
                if (err) {
                    console.error(`AudioManagerTest: Callback : getAudioParameter: 345667: Error: ${err.message}`);
                    expect(false).assertTrue();
                    return;
                }
                else if(value=='xyza'){
                    console.log('AudioManagerTest: Callback: getAudioParameter: 345667: PASS :' +value);
                    expect(true).assertTrue();
                }
                else{
                    console.log('AudioManagerTest: Callback: getAudioParameter: 345667: FAIL :' +value);
                    expect(false).assertTrue();
                }
                done();
            });
    ...
    function displayDeviceProp(value, index, array) {
        ...
        console.log(`AudioManagerTest: device role: ${devRoleName}`);
        deviceRoleValue = value.deviceRole;
        console.log(`AudioManagerTest: device type: ${devTypeName}`);
