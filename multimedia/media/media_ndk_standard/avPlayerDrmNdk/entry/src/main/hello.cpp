...
int getHttp(std::string url, unsigned char *request, uint32_t requestLen, unsigned char *response, int32_t *responseLen,
            uint32_t timeout) {
    int ret = -1;
...
static int getLicense(MediaKeySession *mediaKeySession, char isOnline, uint8_t *keydata, int32_t *keylen) {
    ...
    if (strcmp(judge_uuid(), BLUE_AREA) == 0) {
        ...
        int ret3 = getHttp(LICENSE_SERVICE_IP, requestData.data, (uint32_t)requestData.dataLen, response, &responseLen,
                           HTTP_TIMEOUT);
...
static napi_value Init(napi_env env, napi_value exports) {
    napi_property_descriptor desc[] = {
        ...
        { "TestAVDemuxer_SetMediaKeySystemInfoCallback", nullptr, TestAVDemuxer_SetMediaKeySystemInfoCallback, nullptr, 
         nullptr, nullptr, napi_default, nullptr },
        { "TestAVDemuxer_SetDemuxerMediaKeySystemInfoCallback", nullptr, TestAVDemuxer_SetDemuxerMediaKeySystemInfoCallback,
         nullptr, nullptr, nullptr, napi_default, nullptr },
        { "TestAVDemuxer_GetMediaKeySystemInfo", nullptr, TestAVDemuxer_GetMediaKeySystemInfo, nullptr, nullptr, 
         nullptr, napi_default, nullptr },    
    };
