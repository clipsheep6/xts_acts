...
namespace {
class ActsAudioDecEncAvBufferTest : public testing::Test {
public:
...
void ActsAudioDecEncAvBufferTest::SetUpTestCase() {}
void ActsAudioDecEncAvBufferTest::TearDownTestCase() {}
void ActsAudioDecEncAvBufferTest::SetUp() {}
void ActsAudioDecEncAvBufferTest::TearDown() {}
...
bool CanUseAudioCodec()
{
    return canIUse("SystemCapability.Multimedia.Media.CodecBase") &&
        canIUse("SystemCapability.Multimedia.Media.AudioCodec");
}
}
 ...
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0100, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
        cout << "codec not support, ignore SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0100 ignore" <<endl;
        return;
    }
    ADecEncAvBufferSample *aDecEncSample = new ADecEncAvBufferSample();
    ...
    OH_AVFormat *OutDescDec = OH_AudioCodec_GetOutputDescription(audDec);
    ...
    OH_AVFormat *OutDescEnc = OH_AudioCodec_GetOutputDescription(audEnc);
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0200, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0300, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0400, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0500, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0600, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
 ...
 * @tc.desc      : Basic function test
 */
HWTEST_F(ActsAudioDecEncAvBufferTest, SUB_MULTIMEDIA_MEDIA_AUDIO_DEC_ENC_FUNCTION_0700, TestSize.Level1)
{
    if (!CanUseAudioCodec()) {
