...
#ifndef AUDIODECENC_AVBUFFER_SAMPLE_H
#define AUDIODECENC_AVBUFFER_SAMPLE_H
...
public:
    ...
    std::queue<OH_AVBuffer *> inBufferQueueDec_;
    std::queue<OH_AVBuffer *> outBufferQueueDec_;
    ...
    std::queue<OH_AVBuffer *> inBufferQueueEnc_;
    std::queue<OH_AVBuffer *> outBufferQueueEnc_;
    int32_t errorNum_ = 0;
    std::atomic<bool> isFlushing_ = false;
};

class ADecEncAvBufferSample : public NoCopyable {
public:
    ADecEncAvBufferSample() = default;
    ~ADecEncAvBufferSample();
    ...
    ADecEncAvBufferSignal* acodecSignal_ = nullptr;
...
private:
    ...
    struct OH_AVCodecCallback cbDec_;
    ...
    struct OH_AVCodecCallback cbEnc_;
...
#endif // AUDIODECENC_AVBUFFER_SAMPLE_H
