...
export const AUDIO_VIDEO_ALTERNATE_WRITING = {
    audioDescription: AUDIODESCRIPTION_AAC,
    videoDescription: VIDEODESCRIPTION_H264,
    audioInputFileName: INPUT_AAC,
    videoInputFileName: INPUT_H264,
...
export const VIDEO_AUDIO_ALTERNATE_WRITING = {
    audioDescription: AUDIODESCRIPTION_AAC,
    videoDescription: VIDEODESCRIPTION_H264,
    audioInputFileName: INPUT_AAC,
    videoInputFileName: INPUT_H264,
...
export const SET_LONGITUDE_50_LATITUDE_90 = {
    videoDescription: VIDEODESCRIPTION_MPEG4,
    videoInputFileName: INPUT_MPEG4,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
...
export const TWO_TRACKS_ONLY_USE_ONE_TRACK = {
    audioDescription: AUDIODESCRIPTION_AAC,
    videoDescription: VIDEODESCRIPTION_H264,
    audioInputFileName: INPUT_AAC,
    videoInputFileName: INPUT_H264,
...
export const WRITE_DATA_ONLY_1_FRAME = {
    videoDescription: VIDEODESCRIPTION_MPEG4,
    videoInputFileName: INPUT_MPEG4,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
    writeType: VIDEO,
    videoFrameSize: [40288, 32946, 500]
}

export const SET_ROTATION_60 = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    rotation: 60,
...
export const SET_LONGITUDE_NEGATIVE_200_LATITUDE_50 = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
    writeType: VIDEO,
    location: { longitude: -200, latitude: 50 },
    videoFrameSize: H264_FRAME_SIZE,
    videoFrameFlag: H264_FRAME_FLAG
}

export const SET_LONGITUDE_45_LATITUDE_200 = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
    writeType: VIDEO,
    location: { longitude: 45, latitude: 200 },
    videoFrameSize: H264_FRAME_SIZE,
    videoFrameFlag: H264_FRAME_FLAG
}

export const SET_LONGITUDE_NEGATIVE_200_LATITUDE_100 = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
...
export const AUDIODESCRIPTION_NONE_CODEC_MIME = {
...
export const AUDIODESCRIPTION_NONE_SAMPLE_RATE = {
...
export const AUDIODESCRIPTION_NONE_CHANNEL_COUNT = {
...
export const VIDEODESCRIPTION_NONE_WIDTH = {
...
export const VIDEODESCRIPTION_NONE_HEIGHT = {
...
export const VIDEODESCRIPTION_NONE_FRAME_RATE = {
...
export const VIDEODESCRIPTION_NONE_CODEC_MIME = {
...
export const AUDIO_AND_VIDEO_AUDIODESCRIPTION_NONE_SAMPLE_RATE = {
    audioDescription: AUDIODESCRIPTION_AAC_NONESAMPLE_RATE,
    videoDescription: VIDEODESCRIPTION_H264,
    audioInputFileName: INPUT_AAC,
    videoInputFileName: INPUT_H264,
...
export const AUDIO_AND_VIDEO_VIDEODESCRIPTION_NONE_FRAME_RATE = {
    audioDescription: AUDIODESCRIPTION_MP3,
    videoDescription: VIDEODESCRIPTION_MPEG4_NONEFRAME_RATE,
    audioInputFileName: INPUT_MP3,
    videoInputFileName: INPUT_MPEG4,
...
export const SAMPLEINFO_NONE_TIMEMS = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
...
export const SAMPLEINFO_NONE_OFFSET = {
    videoDescription: VIDEODESCRIPTION_H264,
    videoInputFileName: INPUT_H264,
    outputFormat: MP4,
    mediaType: ONLYVIDEO,
...
export const SAMPLEINFO_NONE_FLAGS = {
    audioDescription: AUDIODESCRIPTION_AAC,
    audioInputFileName: INPUT_AAC,
    outputFormat: M4A,
    mediaType: ONLYAUDIO,
...
export function playAudio(outputFileFdPath,done){
    console.info('start play audio');
    audioPlayer = media.createAudioPlayer();
    audioPlayer.src = outputFileFdPath;
...
export async function playVideo(surfaceID, outputFileFdPath, done) {
    await media.createVideoPlayer().then((video) => {
        if (typeof (video) != 'undefined') {
            videoPlayer = video;
            console.info('createVideoPlayer is success, data: ' + videoPlayer);
        } else {
    ...
    videoPlayer.url = outputFileFdPath;
    ...
    await videoPlayer.on('playbackCompleted', () => {
        console.info('playbackCompleted success!');
        videoPlayer.release().then(() => {
            done();
            console.info('afterEach videoPlayer release success');
        }, (err) => {
            mediaTestBase.printError(err, done);
        })
    });
