...
describe('AvMuxerReliabilityCallBack', function () {
    ...
    eventEmitter.on(videoWriteTrackSample_event, (testAVMuxer, steps, done) => {
        ...
        testAVMuxer.writeTrackSample(data, videoInfo,(err,data) => {
            ...
            if(err!=undefined){
                console.info('writeTrackSample fail , err is : ' + err );
                expect(true).assertTrue;
                done();
            }
            videoFrameCount++;
    ...
    eventEmitter.on(audioWriteTrackSample_err_event_first, (testAVMuxer, steps, done) => {
        ...
        audioOffset = audioOffset + parameters.audioFrameSize[audioFrameCount];
        testAVMuxer.writeTrackSample(data, audioInfo, (err, data) => {
            console.info('data is : ' + data + ', sampleInfo is : ' + JSON.stringify(audioInfo))
            console.info('audioFrameCount: ' + audioFrameCount + ' audio_frame_size.length: '
            + parameters.audioFrameSize.length);
            audioFrameCount++;
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0100
       * @tc.name      : Does not support mp3 format encapsulation as m4a
       * @tc.desc      : test video muxer
       * @tc.size      : MediumTest
       * @tc.type      : Reliability test
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0100');
        ...
        await entrance(AvMuxerTestBase.AUDIO_MP3, 'RELIABILITY_CALLBACK_0100.m4a', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0200
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0200');
        ...
        await entrance(AvMuxerTestBase.VIDEO_MPEG2, 'RELIABILITY_CALLBACK_0200.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0300
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0300');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, videoAddTrack_event];
        await entrance(AvMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_0300.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0400
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0400');
        ...
        audioAddTrack_event, audioAddTrack_event, audioAddTrack_event, audioAddTrack_event, audioAddTrack_event,
        audioAddTrack_event, audioAddTrack_event, audioAddTrack_event, audioAddTrack_event, audioAddTrack_event];
        await entrance(AvMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_0400.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0500
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0500');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        AudioAndVideoDataExchange_event, audioWriteTrackSample_event,stop_event,release_event];
        await entrance(AvMuxerTestBase.AAC_H264, 'RELIABILITY_CALLBACK_0500.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0600
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0600');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        VideoAndAudioDataExchange_event, videoWriteTrackSample_event,stop_event,release_event];
        await entrance(AvMuxerTestBase.AAC_H264, 'RELIABILITY_CALLBACK_0600.mp4', steps, done);
    })

//    /* *
//       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0700
...
//       * @tc.level     : Level1
//    */
//    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0700', 0, async function (done) {
//        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0700');
//        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event,videoAddTrack_event, start_event,
//        videoWriteTrackSample_event,stop_event,release_event];
//        await entrance(AvMuxerTestBase.RELIABILITY_0700, 'RELIABILITY_CALLBACK_0700.mp4', steps, done);
//    })

    /* *
    * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0800
    ...
    * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0800');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, updateTrack_event,
        start_event, audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_0800.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0900
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0900', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_0900');
        toGetAudioTimeStampFromMiddle(AvMuxerTestBase.AUDIO_AAC);
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        audioWriteTrackSample_err_event_first, clear_event, audioWriteTrackSample_err_event_second,
        stop_event, release_event];
        await entrance(AvMuxerTestBase.AUDIO_AAC, 'RELIABILITY_CALLBACK_0900.m4a', steps, done)
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1000
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1000', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1000');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_err_event, jump_event, videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_MPEG4, 'RELIABILITY_CALLBACK_1000.mp4', steps, done)
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1100
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1100');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_1100, 'RELIABILITY_CALLBACK_1100.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1200
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1200');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event, setOutput_event];
        await entrance(AvMuxerTestBase.AAC_H264, 'RELIABILITY_CALLBACK_1200.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1300
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1300');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event, videoAddTrack_event];
        await entrance(AvMuxerTestBase.AAC_H264, 'RELIABILITY_CALLBACK_1300.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1400
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1400');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, audioAddTrack_event, release_event];
        await entrance(AvMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_1400.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1500
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1500');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, videoWriteTrackSample_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_1500.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1600
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1600');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_1600.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1700
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1700');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_1700, 'RELIABILITY_CALLBACK_1700.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1800
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1800');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_1800.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1900
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1900', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_1900');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_1900, 'RELIABILITY_CALLBACK_1900.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2000
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2000', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2000');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2000, 'RELIABILITY_CALLBACK_2000.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2100
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2100');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2100, 'RELIABILITY_CALLBACK_2100.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2200
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2200');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_2200.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2300
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2300');
        ...
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_2300.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2400
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2400');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, videoWriteTrackSample_event, release_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_2400.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2500
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2500');
        ...
        await entrance(AvMuxerTestBase.VIDEO_H264, 'RELIABILITY_CALLBACK_2500.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2600
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2600');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        audioWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2600, 'RELIABILITY_CALLBACK_2600.m4a', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2700
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2700');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        audioWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2700, 'RELIABILITY_CALLBACK_2700.m4a', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2800
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2800');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        audioWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2800, 'RELIABILITY_CALLBACK_2800.m4a', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2900
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2900', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_2900');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_2900, 'RELIABILITY_CALLBACK_2900.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3000
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3000', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3000');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3000, 'RELIABILITY_CALLBACK_3000.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3100
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3100');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3100, 'RELIABILITY_CALLBACK_3100.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3200
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3200');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3200, 'RELIABILITY_CALLBACK_3200.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3300
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3300');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3300, 'RELIABILITY_CALLBACK_3300.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3400
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3400');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3400, 'RELIABILITY_CALLBACK_3400.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3500
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3500');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3500, 'RELIABILITY_CALLBACK_3500.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3600
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3600');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3600, 'RELIABILITY_CALLBACK_3600.mp4', steps, done);
    })

    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3700
       ...
       * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_RELIABILITY_CALLBACK_3700');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, start_event,
        audioWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.RELIABILITY_3700, 'RELIABILITY_CALLBACK_3700.m4a', steps, done);
    })
