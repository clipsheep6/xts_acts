...
describe('AvMuxerFunctionTestPromise', function () {
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0100
        * @tc.name      : AVMuxer (promise) for audio, format is aac
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0100');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0200
        * @tc.name      : AVMuxer (promise) for video, format is h264
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0200');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0300
        * @tc.name      : AVMuxer (promise) for video, format is mpeg4
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0300');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0400
        * @tc.name      : AVMuxer (promise) for video and audio, format is h264+acc
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0400');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0500
        * @tc.name      : AVMuxer (promise) for video and audio, format is mpeg4+acc
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0500');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0600
        * @tc.name      : AVMuxer (promise) for video and audio, format is h264+mp3
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0600');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0700
        * @tc.name      : AVMuxer (promise) for video and audio, format is mpeg4+mp3
        * @tc.desc      : test media muxer
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0700');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0800
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0800');
        let steps = [createAVMuxer_event];
        await eventEmitter.emit(steps[0], steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0900
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0900', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_0900');
        await toGetAVMuxerFormatList();
        done();
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1000
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1000', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1000');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_1000, 'FUNCTION_PROMISE_1000.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1100');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1200
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1200');
        ...
        await entrance(AvMuxerTestBase.MP3_MPEG4, 'FUNCTION_PROMISE_1200.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1300
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1300');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, audioAddTrack_event,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1400
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1400');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1500
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1500');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1600
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1600');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_1600, 'FUNCTION_PROMISE_1600.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1700
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1700');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_1700, 'FUNCTION_PROMISE_1700.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1800
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1800');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1900
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1900', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_1900');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_1900, 'FUNCTION_PROMISE_1900.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2000
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2000', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2000');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_2000, 'FUNCTION_PROMISE_2000.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2100', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2100');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_2100, 'FUNCTION_PROMISE_2100.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2200
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2200', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2200');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_2200, 'FUNCTION_PROMISE_2200.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2300
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2300', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2300');
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, stop_event, release_event];
        await entrance(AvMuxerTestBase.FUNCTION_2300, 'FUNCTION_PROMISE_2300.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2400
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2400', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2400');
        let steps = [createAVMuxer_event];
        await entrance(AvMuxerTestBase.VIDEO_H264, 'FUNCTION_PROMISE_2400.mp4', steps, done);
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2500
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2500', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2500');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2600
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2600', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2600');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2700
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2700', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2700');
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_event, videoAddTrack_event, start_event,
        audioWriteTrackSample_event, videoWriteTrackSample_event, stop_event, release_event];
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2800
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2800', 0, async function (done) {
        console.info('case SUB_MEDIA_VIDEO_AVMUXER_FUNCTION_PROMISE_2800');
