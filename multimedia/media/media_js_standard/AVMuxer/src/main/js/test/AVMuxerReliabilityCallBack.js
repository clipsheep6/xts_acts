...
describe('AVMuxerReliabilityCallBack', function () {
    ...
    eventEmitter.on(delay_event, (testAVMuxer, steps, done) => {
        sleep(TIME_3000);
        steps.shift();
        toNextStep(testAVMuxer, steps, done);
    });
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_0500', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_0500.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_0600', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.AAC_MPEG4, 'RELIABILITY_CALLBACK_0600.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_1100', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_event, start_event,
        videoWriteTrackSample_event, delay_event, stop_event, release_event, videoPlay_event];
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_2500', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_err_event];
        await entrance(AVMuxerTestBase.AUDIODESCRIPTION_NONE_CODEC_MIME, 'RELIABILITY_CALLBACK_2500.m4a', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_2600', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_err_event];
        await entrance(AVMuxerTestBase.AUDIODESCRIPTION_NONE_SAMPLE_RATE, 'RELIABILITY_CALLBACK_2600.m4a', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_2700', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, audioAddTrack_err_event];
        await entrance(AVMuxerTestBase.AUDIODESCRIPTION_NONE_CHANNEL_COUNT, 'RELIABILITY_CALLBACK_2700.m4a', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_2800', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_err_event];
        await entrance(AVMuxerTestBase.VIDEODESCRIPTION_NONE_WIDTH, 'RELIABILITY_CALLBACK_2800.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_2900', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_err_event];
        await entrance(AVMuxerTestBase.VIDEODESCRIPTION_NONE_HEIGHT, 'RELIABILITY_CALLBACK_2900.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3000', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_err_event];
        await entrance(AVMuxerTestBase.VIDEODESCRIPTION_NONE_FRAME_RATE, 'RELIABILITY_CALLBACK_3000.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3100', 0, async function (done) {
        ...
        let steps = [createAVMuxer_event, setOutput_event, videoAddTrack_err_event];
        await entrance(AVMuxerTestBase.VIDEODESCRIPTION_NONE_CODEC_MIME, 'RELIABILITY_CALLBACK_3100.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3200', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.AUDIO_AND_VIDEO_AUDIODESCRIPTION_NONE_SAMPLE_RATE,
            'RELIABILITY_CALLBACK_3200.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3400', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.SAMPLEINFO_NONE_TIMEMS, 'RELIABILITY_CALLBACK_3400.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3500', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.SAMPLEINFO_NONE_OFFSET, 'RELIABILITY_CALLBACK_3500.mp4', steps, done);
    })
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_3600', 0, async function (done) {
        ...
        await entrance(AVMuxerTestBase.SAMPLEINFO_NONE_FLAGS, 'RELIABILITY_CALLBACK_3600.m4a', steps, done);
    })
