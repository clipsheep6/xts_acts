...
describe('AVMuxerReliabilityCallBack', function () {
    ...
    let audioWriteTrackSampleErrEventFirst = 'audioWriteTrackSampleErrFirst';
    let audioWriteTrackSampleErrEventSecond = 'audioWriteTrackSampleErrSecond';
    let clearEvent = 'clear';
    let jumpEvent ='jump';
    ...
    */
    it('SUB_MEDIA_AVMUXER_RELIABILITY_CALLBACK_1600', 0, async function (done) {
        ...
        let steps = [createAvMuxerEvent, setOutputEvent, videoAddTrackEvent, startEvent, stopEvent, releaseEvent];
