...
describe('audioPlayerDataSrcTestAPI', function () {
    ...
    let AUDIO_SRC_SOURCE = '01.m4a';
    const PLAY_TIME = 3000;
    const DURATION_TIME = 219600;
    const DURATION_TIME2 = 219575;
    ...
    beforeEach(async function () {
        isPrepared = false;
        await mediaTestBase.getFileDescriptor(AUDIO_SRC_SOURCE).then((res) => {
            fileDescriptor = res;
        });
    ...
    afterEach(async function () {
        ...
        removeTimeoutTimer();
        await mediaTestBase.closeFileDescriptor(AUDIO_SRC_SOURCE);
    ...
    */
    it('SUB_MEDIA_PLAYER_DATASRC_AUDIOPLAYER_TIME_API_2600', 0, async function (done) {
        ...
        expect(audioPlayer.currentTime).assertEqual(0);
        expect(audioPlayer.duration).assertEqual(DURATION_TIME2);
        expect(audioPlayer.state).assertEqual('paused');
        expect(audioPlayer.loop).assertEqual(false);
        done();
    })
