...
describe('VideoRecorderSpliterCallbackTest', function () {
    ...
    const FILE_SUFFIX = 'ac.mp4';
    const VIDEO_PER_STR = 'VideoSpliterAbnormalCallback';
    ...
    */
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_ABNORMAL_TEST_1400
        * @tc.name      : maxsize larger than max
        * @tc.desc      : set max size failed
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_ABNORMAL_TEST_1400', 0, async function (done) {
        console.info('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_ABNORMAL_TEST_1400 start');
