...
describe('PlayerDataSrcFUNC', function () {
    let dataSrc = null;
    ...
    */
    it('SUB_MEDIA_PLAYER_DATA_SOURCE_AUDIO_FUNCTION_3000', 0, async function (done) {
        mySteps = [SRC_STATE, PLAY_STATE, SEEK_STATE, DURATION_TIME / RAND_NUM, END_STATE];
        await actFun(done);
    })
    ...
    */
    it('SUB_MEDIA_PLAYER_DATA_SOURCE_AUDIO_FUNCTION_3200', 0, async function (done) {
        mySteps = [SRC_STATE, PLAY_STATE, PAUSE_STATE, SEEK_STATE, DURATION_TIME, PLAY_STATE,
    ...
    */
    it('SUB_MEDIA_PLAYER_DATA_SOURCE_AUDIO_FUNCTION_3300', 0, async function (done) {
        mySteps = [SRC_STATE, PLAY_STATE, PAUSE_STATE, SEEK_STATE, DURATION_TIME + DELTA_TIME, PLAY_STATE,
        FINISH_STATE, RESET_STATE, END_STATE];
        await actFun(done);
    })
