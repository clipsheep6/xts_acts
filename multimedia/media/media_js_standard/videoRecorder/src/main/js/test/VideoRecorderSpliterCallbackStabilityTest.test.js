...
describe('VideoRecorderSpliterCallbackStabilityTest', function () {
    let fdPath;
    let fileAsset;
    let fdNumber = null;
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0100
       ...
       * @tc.level     : Level0
       */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0100', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0100 start");
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0200
       ...
       * @tc.level     : Level0
       */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0200', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0200 start");
        videoConfig.maxSize = SIZE_UPPER_LIMIT;
        frameCount = getFrameCount();
        mySteps = [CREATE_STATE, PREPARE_STATE, START_STATE];
        await toIniFdData('32.mp4', done);
        videoConfig.url = fdPath;
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0300
       ...
       * @tc.level     : Level0
       */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0300', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_STABILITY_0300 start");
        videoConfig.maxSize = 50 * 1024 * 1024;
        frameCount = getFrameCount();
        mySteps = [
            CREATE_STATE, PREPARE_STATE, START_STATE, WAIT_STATE,
