...
describe('VideoRecorderSpliterCompatibilityCallbackTest', function () {
    let fdPath;
    let fileAsset;
    let fdNumber = null;
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3100
       ...
       * @tc.level     : Level0
      */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3100', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3100 start");
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3200
       ...
       * @tc.level     : Level0
      */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3200', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3200 start");
    ...
    /* *
       * @tc.number    : SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3300
       ...
       * @tc.level     : Level0
      */
    it('SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3300', 0, async function (done) {
        console.info("SUB_MEDIA_VIDEO_RECORDER_SPLITER_CALLBACK_TEST_COMPATIBILITY_3300 start");
        videoConfig.maxSize = 50 * 1024 * 1024;
        frameCount = getFrameCount();
        mySteps = [
            CREATE_STATE, PREPARE_STATE, START_STATE, WAIT_STATE,
