...
export const AvPlayerSetAudioRendererInfo: (a:number) => number;
export const AvPlayerSetAudioInterruptMode: (a:number) => number;
export const AvPlayerSetAudioEffectMode: (a:number) => number;
