...
describe('ProfileFuncPromiseTest', function () {
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 001.isAudioRecoderConfigSupported false
    ...
    */
    ...
    /* *
        * @tc.number    : SUB_PROFILE_ABNORMALPROMISE_0200
        * @tc.name      : 002.test isAudioRecoderConfigSupported false
        * @tc.desc      : FormatType  is wrong
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0200', 0, async function (done) {
        console.info("test getAudioRecorderCaps");
        promiseAbnormalAudioRecoderConfigSupported(base.audioRecorderAbnormalFormatType, done);
    })

    /* *
        * @tc.number    : SUB_PROFILE_ABNORMALPROMISE_0300
        * @tc.name      : 003.test isAudioRecoderConfigSupported
        * @tc.desc      : CodecMimeType is wrong
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0300', 0, async function (done) {
        console.info("test getAudioRecorderCaps");
        promiseAbnormalAudioRecoderConfigSupported(base.audioRecorderAbnormalCodecMimeType, done);
    })

    /* *
        * @tc.number    : SUB_PROFILE_ABNORMALPROMISE_0400
        * @tc.name      : 004.test isAudioRecoderConfigSupported
        * @tc.desc      : bitrate is wrong
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0400', 0, async function (done) {
        console.info("test getAudioRecorderCaps");
        promiseAbnormalAudioRecoderConfigSupported(base.audioRecorderAbnormalBitrate, done);
    })

    /* *
        * @tc.number    : SUB_PROFILE_ABNORMALPROMISE_0500
        * @tc.name      : 005.test isAudioRecoderConfigSupported
        * @tc.desc      : sampleRate is wrong
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0500', 0, async function (done) {
        console.info("test getAudioRecorderCaps");
        promiseAbnormalAudioRecoderConfigSupported(base.audioRecorderAbnormalSampleRate, done);
    })

    /* *
        * @tc.number    : SUB_PROFILE_ABNORMALPROMISE_0600
        * @tc.name      : 006.test isAudioRecoderConfigSupported
        * @tc.desc      : channel is wrong
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0600', 0, async function (done) {
        console.info("test getAudioRecorderCaps");
        promiseAbnormalAudioRecoderConfigSupported(base.audioRecorderAbnormalSampleChannel, done);
    })

    /* *
        * @tc.number  : SUB_PROFILE_ABNORMALPROMISE_0700
        * @tc.name    : 007.test hasVideoRecorderProfile
        * @tc.desc    : sourceId 1 qualityLevel 0
        * @tc.size    : MediumTest
        * @tc.type    : Function test
        * @tc.level   : Level2
    */
    it('SUB_PROFILE_ABNORMALPROMISE_0700', 0, async function (done) {
        console.info('test hasVideoRecorderProfile');
    ...
    /* *
        ...
        * @tc.name      : 008.test hasVideoRecorderProfile sourceId -1
        * @tc.desc      : sourceId -1 qualityLevel 0
        * @tc.size      : MediumTest
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 009.test hasVideoRecorderProfile qualityLevel -1
        * @tc.desc      : sourceId 0 qualityLevel -1
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 010.test hasVideoRecorderProfile sourceId 65536
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 011.test hasVideoRecorderProfile sourceId 65536
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 012.test hasVideoRecorderProfile qualityLevel 65536
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 013.test hasVideoRecorderProfile qualityLevel 65536
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : 014.test getVideoRecorderProfile sourceId -1
        * @tc.desc      : sourceId -1 qualityLevel 0
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 015.test getVideoRecorderProfile qualityLevel -1
        * @tc.desc      : sourceId 0 qualityLevel -1
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 016.test getVideoRecorderProfile sourceId 65535
        * @tc.desc      : sourceId 65535 qualityLevel 0
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 017.test getVideoRecorderProfile sourceId 65536
        * @tc.desc      : sourceId 65536 qualityLevel 0
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 018.test getVideoRecorderProfile qualityLevel 65535
        * @tc.desc      : sourceId 0 qualityLevel 65535
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
    */
    ...
    /* *
        ...
        * @tc.name      : 019.test getVideoRecorderProfile qualityLevel 65536
        * @tc.desc      : sourceId 0 qualityLevel 65536
        * @tc.size      : MediumTest
        * @tc.type      : Abnormal test
        * @tc.level     : Level2
