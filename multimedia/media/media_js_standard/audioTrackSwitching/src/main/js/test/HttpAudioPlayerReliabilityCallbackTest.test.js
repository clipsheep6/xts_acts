...
describe('HttpAudioPlayerReliabilityCallbackTest', function () {
    console.info('HttpAudioPlayerReliabilityCallbackTest start');
    const END_STATE = 0;
    const SRC_STATE = 1;
    const PLAY_STATE = 2;
    const PAUSE_STATE = 3;
    ...
    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100 is start---------')
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200 is start---------')
        audioSource = AAC_3TRK_MKV;
        mySteps = [SRC_STATE, PLAY_STATE, RESET_STATE, GET_TD_STATE, ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300 is start---------')
        audioSource = AAC_3TRK_MKV;
        mySteps = [SRC_STATE, PLAY_STATE, RELEASE_STATE, GET_TD_STATE, ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400 is start---------')
        audioSource = AAC_3TRK_MKV;
        audioExpect = audioBase.AAC_3TRK_MKV_SOURCE;
        ...
        END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500 is start---------')
        audioSource = AAC_3TRK_TS;
        mySteps = [SRC_STATE, PLAY_STATE, RESET_STATE, GET_ST_STATE, ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600 is start---------')
        audioSource = AAC_3TRK_TS;
        mySteps = [SRC_STATE, PLAY_STATE, RELEASE_STATE, GET_ST_STATE, ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700 is start---------')
        audioSource = AAC_3TRK_TS;
        ...
        END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800 is start---------')
        ...
        ST_STATE, differentTracks[0],
        ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900 is start---------')
        audioSource = MP3_3TRK_MKV;
        audioExpect = audioBase.MP3_3TRK_MKV_SOURCE;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000 is start---------')
        audioSource = MP3_3TRK_MKV;
        audioExpect = audioBase.MP3_3TRK_MKV_SOURCE;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100 is start---------')
        audioSource = MP3_3TRK_MKV;
        audioExpect = audioBase.MP3_3TRK_MKV_SOURCE;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200 is start---------')
        audioSource = MP3_3TRK_MKV;
        audioExpect = audioBase.MP3_3TRK_MKV_SOURCE;
        mySteps = [SRC_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE, NORMAL_STEP, PLAY_STATE, ST_STATE,
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300 is start---------')
        audioSource = MP3_3TRK_TS;
        mySteps = [GET_TD_STATE, ABNORMAL_STEP, SRC_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400 is start---------')
        audioSource = MP3_3TRK_TS;
        mySteps = [GET_ST_STATE, ABNORMAL_STEP, SRC_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400 is end---------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500 is start---------')
        audioSource = MP3_3TRK_TS;
        mySteps = [ST_STATE, 0, ABNORMAL_STEP, SRC_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_AUDIO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500 is end---------')
    })
