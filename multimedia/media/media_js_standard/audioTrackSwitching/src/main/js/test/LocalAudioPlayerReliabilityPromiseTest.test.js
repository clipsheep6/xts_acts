...
describe('LocalAudioPlayerReliabilityPromiseTest', function () {
    ...
    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0100
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0100', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0100 is start--------------')
        ...
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0100 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0200
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0200', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0200 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getDescriptionAfterPlaying(audioPlayer, 'RESET', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0200 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0300
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0300', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0300 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getDescriptionAfterPlaying(audioPlayer, 'RELEASE', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0300 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0400
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0400', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0400 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getDescriptionAfterPlaying(audioPlayer, 'COMBINATION', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0400 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0500
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0500', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0500 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getSelectedTracksAfterPlaying(audioPlayer, 'RESET', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0500 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0600
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0600', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0600 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getSelectedTracksAfterPlaying(audioPlayer, 'RELEASE', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0600 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0700
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0700', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0700 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getSelectedTracksAfterPlaying(audioPlayer, 'COMBINATION', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0700 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0800
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0800', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0800 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksAfterPlaying(audioPlayer, 'STOP_DIFFERENT_TRACKS', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0800 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0900
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0900', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0900 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksAfterPlaying(audioPlayer, 'RESET_DIFFERENT_TRACKS', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_0900 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1000
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1000', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1000 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksAfterPlaying(audioPlayer, 'RELEASE_DIFFERENT_TRACKS', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1000 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1100
       * @tc.name      : Pause the playback after the audio playback, stop the playback, reset the audio, release the
       ...
       * @tc.level     : Level2
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1100', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1100 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksAfterPlaying(audioPlayer, 'COMBINATION_DIFFERENT_TRACKS', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1100 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1200
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1200', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1200 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksAfterPlaying(audioPlayer, 'BOUNDARY_DIFFERENT_TRACKS', done);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1200 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1300
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1300', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1300 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getDescriptionBeforeGetSource(audioPlayer);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        done();
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1300 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1400
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1400', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1400 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        getSelectedTrackBeforeGetSource(audioPlayer);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        done();
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1400 is end--------------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1500
       ...
       * @tc.level     : Level3
    */
    it('SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1500', 0, async function (done) {
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1500 is start--------------')
        audioPlayer = await trackSwitchingBase.initAudioPlayer();
        selectedTracksBeforeGetSource(audioPlayer);
        await trackSwitchingBase.getInputFilesFd(audioPlayer, trackSwitchingBase.AAC_3TRK_MKV);
        done();
        console.info('-----------SUB_MEDIA_LOCAL_AUDIO_PLAYER_RELIABILITY_PROMISE_1500 is end--------------')
    })
})
