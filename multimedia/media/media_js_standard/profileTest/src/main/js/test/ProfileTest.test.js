                ...
                mediaCaps.getAudioRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].outputFormat: ' + audioCapsArray[i].outputFormat);
            ...
            media.getMediaCapability((err, mediaCaps) => {
                ...
                if (typeof (mediaCaps) != 'undefined') {
                    mediaCaps.getAudioRecorderCaps((err, audioCapsArray) => {
                        ...
                        if (typeof (audioCapsArray) != 'undefined') {
                            for (var i=0; i<audioCapsArray.length; i++) { 
                                console.info('audioCapsArray['+ i +'].audioEncoderMime: ' + audioCapsArray[i].audioEncoderMime);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getAudioRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].sampleRates: ' + audioCapsArray[i].sampleRates);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getAudioRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].bitrateRange.min: ' + audioCapsArray[i].bitrateRange.min);
                            console.info('audioCapsArray['+ i +'].bitrateRange.max: ' + audioCapsArray[i].bitrateRange.max);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getAudioRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].channelRange.min: ' + audioCapsArray[i].channelRange.min);
                            console.info('audioCapsArray['+ i +'].channelRange.max: ' + audioCapsArray[i].channelRange.max);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].videoEncoderMime: ' + audioCapsArray[i].videoEncoderMime);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].audioBitrateRange.min: ' + audioCapsArray[i].audioBitrateRange.min);
                            console.info('audioCapsArray['+ i +'].audioBitrateRange.max: ' + audioCapsArray[i].audioBitrateRange.max);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].audioChannelRange.min: ' + audioCapsArray[i].audioChannelRange.min);
                            console.info('audioCapsArray['+ i +'].audioChannelRange.max: ' + audioCapsArray[i].audioChannelRange.max);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].videoBitrateRange.min: ' + audioCapsArray[i].videoBitrateRange.min);
                            console.info('audioCapsArray['+ i +'].videoBitrateRange.max: ' + audioCapsArray[i].videoBitrateRange.max);
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].videoFramerateRange.min: ' + audioCapsArray[i].videoFramerateRange.min);
                            console.info('audioCapsArray['+ i +'].videoFramerateRange.max: ' + audioCapsArray[i].videoFramerateRange.max);
                            expect(audioCapsArray[i].videoFramerateRange.min).assertEqual(expectVideoFramerateRangeMin[i]);
                            expect(audioCapsArray[i].videoFramerateRange.max).assertEqual(expectVideoFramerateRangeMin[i]);
                        }
                    } else {
                        console.info('audioCaps is not defined');
                    }
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].videoWidthRange.min: ' + audioCapsArray[i].videoWidthRange.min);
                            console.info('audioCapsArray['+ i +'].videoWidthRange.max: ' + audioCapsArray[i].videoWidthRange.max);
                            expect(audioCapsArray[i].videoWidthRange.min).assertEqual(expectVideoWidthRangeMin[i]);
                            expect(audioCapsArray[i].videoWidthRange.max).assertEqual(expectVideoWidthRangeMax[i]);
                        }
                    } else {
                        console.info('audioCaps is not defined');
                    }
        ...
        media.getMediaCapability((err, mediaCaps) => {
            ...
            if (typeof (mediaCaps) != 'undefined') {
                mediaCaps.getVideoRecorderCaps((err, audioCapsArray) => {
                    ...
                    if (typeof (audioCapsArray) != 'undefined') {
                        for (var i=0; i<audioCapsArray.length; i++) { 
                            console.info('audioCapsArray['+ i +'].videoHeightRange.min: ' + audioCapsArray[i].videoHeightRange.min);
                            console.info('audioCapsArray['+ i +'].videoHeightRange.max: ' + audioCapsArray[i].videoHeightRange.max);
                            expect(audioCapsArray[i].videoHeightRange.min).assertEqual(expectVideoHeightRangeMin[i]);
                            expect(audioCapsArray[i].videoHeightRange.max).assertEqual(expectVideoHeightRangeMax[i]);
                        }
                    } else {
                        console.info('audioCaps is not defined');
                    }
