    ...
    describe('avVideoRecorderTestOne', function () {
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0300', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise3(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0400', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise4(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0500', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise5(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0600', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise6(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0800', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise8(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESET_PROMISE_0300', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResetPromise3(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESET_PROMISE_0400', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResetPromise4(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESET_PROMISE_0500', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResetPromise5(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESET_PROMISE_0600', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResetPromise6(avConfig, avRecorder, recorderTime, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESET_PROMISE_0800', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResetPromise8(avConfig, avRecorder, recorderTime, done);
