    ...
    describe('avVideoRecorderTestOne', function () {
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_FUNCTION_PROMISE_MPEG4_0100', 0, async function (done) {
            ...
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderWithPromise(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_CALLBACK_0100', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumeCallBack1(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_CALLBACK_0200', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumeCallBack2(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_CALLBACK_0300', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumeCallBack3(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_CALLBACK_0400', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumeCallBack4(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0100', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise1(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0200', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise2(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0300', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise3(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0400', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise4(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0500', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise5(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0600', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise6(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0700', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise7(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_RESUME_PROMISE_0800', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderResumePromise8(avConfig, avRecorder, RECORDER_TIME, done);
...
//            fdPath = "fd://" + fdObject.fdNumber;
//            avConfig.url = fdPath;
//            avVideoRecorderTestBase.avRecorderStopPromise1(avConfig, avRecorder, RECORDER_TIME, done);
...
//            fdPath = "fd://" + fdObject.fdNumber;
//            avConfig.url = fdPath;
//            avVideoRecorderTestBase.avRecorderStopPromise2(avConfig, avRecorder, RECORDER_TIME, done);
...
//        })
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0300', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise3(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0400', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise4(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0500', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise5(avConfig, avRecorder, RECORDER_TIME, done);
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0600', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise6(avConfig, avRecorder, RECORDER_TIME, done);
...
//            fdPath = "fd://" + fdObject.fdNumber;
//            avConfig.url = fdPath;
//            avVideoRecorderTestBase.avRecorderStopPromise7(avConfig, avRecorder, RECORDER_TIME, done);
...
//        })
        ...
        */
        it('SUB_MULTIMEDIA_AVRECORDER_VIDEO_STOP_PROMISE_0800', 0, async function (done) {
            ...
            fdPath = "fd://" + fdObject.fdNumber;
            avConfig.url = fdPath;
            avVideoRecorderTestBase.avRecorderStopPromise8(avConfig, avRecorder, RECORDER_TIME, done);
