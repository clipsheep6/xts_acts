...
describe('VideoSoftwareDecoderSoftwareReliCallbackTest', function () {
    ...
    let surfaceID = '';
    let temp = 0;
    const BASIC_PATH = '/data/accounts/account_0/appdata/ohos.acts.multimedia.video.videosoftwaredecoder/';
