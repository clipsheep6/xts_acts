...
describe('VideoPlayerFuncCallbackTest', function () {
    ...
    */
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_CALLBACK_0500
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_CALLBACK_0500', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let frameCount = -1;
