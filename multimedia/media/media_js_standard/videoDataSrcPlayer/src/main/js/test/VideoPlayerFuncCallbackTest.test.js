...
describe('VideoPlayerFuncCallback', function () {
    ...
    function setDataSrcSeekAble(VIDEO_SOURCE) {
        var context = featureAbility.getContext();
        context.getOrCreateLocalDir((err, data) => {
            console.info("data=" + data);
            let publicPath = data + VIDEO_SOURCE;
            readFile(publicPath);
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_PROMISE_SETSOURCE_0100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_PROMISE_SETSOURCE_0100', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let fdPath = '';
        let VIDEO_SOURCE = '/files/h264_320x240_60.ts'
        setDataSrcSeekAble(VIDEO_SOURCE);
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SETVOLUME_0200
        * @tc.name      : 002.test SetVolume 0/0.5/1 (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SETVOLUME_0200', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SETSPEED_0300
        * @tc.name      : 003.test SetSpeed 0.75/1/1.25/1.75/2 (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SETSPEED_0300', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let mySteps = new Array(CREATE_EVENT, SETFDSOURCE_EVENT, fileDescriptor, SETSURFACE_EVENT,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SEEKMODE_0400
        * @tc.name      : 004.test seek mode SEEK_PREV_SYNC/SEEK_NEXT_SYNC (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_SEEKMODE_0400', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let mySteps = new Array(CREATE_EVENT, SETFDSOURCE_EVENT, fileDescriptor, SETSURFACE_EVENT,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_0500
        * @tc.name      : 005.test callback bufferingUpdate/videoSizeChanged/startRenderFrame/playbackCompleted
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_0500', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let frameCount = -1;
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_GETTRECKDESCRIPTION_0600
        * @tc.name      : 006.test getTrackDescription (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_GETTRECKDESCRIPTION_0600', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let mySteps = new Array(CREATE_EVENT, SETFDSOURCE_EVENT, fileDescriptor, SETSURFACE_EVENT,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_LOOP_0700
        * @tc.name      : 007.test LOOP (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_LOOP_0700', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
        let mySteps = new Array(CREATE_EVENT, SETFDSOURCE_EVENT, fileDescriptor, SETSURFACE_EVENT,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_BASE_0800
        * @tc.name      : 008.test video playe (callback)
        * @tc.desc      : Video playback control test
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_DATASRC_FUNCTION_CALLBACK_BASE_0800', 0, async function (done) {
        //mediaTestBase.isFileOpen(fileDescriptor, done);
        let videoPlayer = null;
