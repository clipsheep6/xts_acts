...
describe('HttpVideoPlayerReliabilityCallbackTest', function () {
    ...
    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100 is start------')
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0100 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200 is start------')
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0200 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300 is start------')
        videoSource = H263_AAC_3TRK_MKV;
        videoExpect = videoBase.H263_AAC_3TRK_MKV_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, PLAY_STATE, RESET_STATE, GET_TD_STATE,
        ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0300 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400 is start------')
        videoSource = H263_AAC_3TRK_MKV;
        videoExpect = videoBase.H263_AAC_3TRK_MKV_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, PLAY_STATE, RELEASE_STATE, GET_TD_STATE,
        ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0400 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500 is start------')
        videoSource = H263_AAC_3TRK_MKV;
        videoExpect = videoBase.H263_AAC_3TRK_MKV_SOURCE;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0500 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, PLAY_STATE, RESET_STATE, GET_ST_STATE,
        ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0600 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, PLAY_STATE, RELEASE_STATE, GET_ST_STATE,
        ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0700 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0800 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        videoExpect = videoBase.MPEG4_AAC_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE, NORMAL_STEP,
        PLAY_STATE, STOP_STATE, ST_STATE, differentTracks[0], ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_0900 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        videoExpect = videoBase.MPEG4_AAC_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE, NORMAL_STEP,
        PLAY_STATE, RESET_STATE, ST_STATE, differentTracks[0], ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1000 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100 is start------')
        videoSource = MPEG4_AAC_3TRK_TS;
        videoExpect = videoBase.MPEG4_AAC_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE, NORMAL_STEP,
        PLAY_STATE, RELEASE_STATE, ST_STATE, differentTracks[0], ABNORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1100 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200 is start------')
        videoSource = MPEG2_MP3_3TRK_MKV;
        videoExpect = videoBase.MPEG2_MP3_3TRK_MKV_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE, NORMAL_STEP,
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1200 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300 is start------')
        videoSource = MPEG2_MP3_3TRK_MKV;
        videoExpect = videoBase.MPEG2_MP3_3TRK_MKV_SOURCE;
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1300 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400 is start------')
        videoSource = MPEG2_MP3_3TRK_MKV;
        videoExpect = videoBase.MPEG2_MP3_3TRK_MKV_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, PREPARE_STATE, PLAY_STATE, GET_TD_STATE, NORMAL_STEP, GET_ST_STATE,
        NORMAL_STEP, ST_STATE, currentDescriptionIndex, NORMAL_STEP, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1400 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500 is start------')
        ...
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1500 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1600
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1600', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1600 is start------')
        videoSource = H264_MP3_3TRK_TS;
        mySteps = [GET_ST_STATE, ABNORMAL_STEP, SRC_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1600 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1700
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1700', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1700 is start------')
        videoSource = H264_MP3_3TRK_TS;
        mySteps = [ST_STATE, 0, ABNORMAL_STEP, SRC_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1700 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1800
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1800', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1800 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, GET_TD_STATE, ABNORMAL_STEP, SET_DS_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1800 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1900
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1900', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1900 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, GET_ST_STATE, ABNORMAL_STEP, SET_DS_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_1900 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2000
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2000', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2000 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, ST_STATE, 0, ABNORMAL_STEP, SET_DS_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2000 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2100
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2100', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2100 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, GET_TD_STATE, ABNORMAL_STEP, PREPARE_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2100 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2200
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2200', 0, async function (done) {
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2200 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, GET_ST_STATE, ABNORMAL_STEP, PREPARE_STATE, END_STATE];
        await actFun(done);
        console.info('------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2200 is end------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2300
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2300', 0, async function (done) {
        console.info('--------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2300 is start------')
        videoSource = H264_MP3_3TRK_TS;
        videoExpect = videoBase.H264_MP3_3TRK_TS_SOURCE;
        mySteps = [SRC_STATE, SET_DS_STATE, ST_STATE, 0, ABNORMAL_STEP, PREPARE_STATE, END_STATE];
        await actFun(done);
        console.info('--------SUB_MEDIA_HTTP_VIDEO_PLAYER_TRACK_SWITCH_RELIABILITY_CALLBACK_2300 is end------')
    })
