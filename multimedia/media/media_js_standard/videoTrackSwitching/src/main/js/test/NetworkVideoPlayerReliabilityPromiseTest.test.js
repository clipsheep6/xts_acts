...
describe('NetworkVideoPlayerReliabilityPromiseTest', function () {
    ...
    async function selectedTracksBeforeGetSource(videoPlayer) {
        videoPlayer.selectTrack(selectTrackIndex).then((data) => {
            selectTrackData = data;
            console.info('Same track switching succeeded, selectTrackData: ' + selectTrackData);
            expect().assertFail();
        }).catch((err) => {
    ...
    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0100
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0100', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0100 is start-----------')
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0100 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0200
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0200', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0200 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksBeforePlaying(videoPlayer, 'BOUNDARY_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0200 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0300
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0300', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0300 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getDescriptionAfterPlaying(videoPlayer, 'RESET', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0300 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0400
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0400', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0400 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getDescriptionAfterPlaying(videoPlayer, 'RELEASE', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0400 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0500
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0500', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0500 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getDescriptionAfterPlaying(videoPlayer, 'COMBINATION', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0500 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0600
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0600', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0600 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getSelectedTracksAfterPlaying(videoPlayer, 'RESET', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0600 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0700
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0700', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0700 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getSelectedTracksAfterPlaying(videoPlayer, 'RELEASE', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0700 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0800
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0800', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0800 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        getSelectedTracksAfterPlaying(videoPlayer, 'COMBINATION', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0800 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0900
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0900', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0900 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'STOP_DIFFERENT_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_0900 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1000
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1000', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1000 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'RESET_DIFFERENT_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1000 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1100
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1100', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1100 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'RELEASE_DIFFERENT_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1100 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1200
       * @tc.name      : Pause playback after audio and video playback, reset audio and video, replay, stop playback,
                         release audio and video, and obtain all track information
       * @tc.desc      : Audio and video track switching
       * @tc.size      : MediumTest
       ...
       * @tc.level     : Level2
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1200', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1200 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'COMBINATION_DIFFERENT_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1200 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1300
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1300', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1300 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'BOUNDARY_DIFFERENT_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1300 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1400
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1400', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1400 is start-----------')
        videoPlayer = await trackSwitchingBase.initHttpVideoPlayer
        (trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV, trackSwitchingBase.surfaceID);
        selectedTracksAfterPlaying(videoPlayer, 'VIDEO_TRACKS', done);
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1400 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1500
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1500', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1500 is start-----------')
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1500 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1600
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1600', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1600 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1600 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1700
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1700', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1700 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1700 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1800
       * @tc.name      : Switch tracks before setting the source
       * @tc.desc      : Audio and video track switching
       * @tc.size      : MediumTest
       * @tc.type      : Reliability test
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1800', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1800 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV);
        await getDescriptionBeforeGetSource(videoPlayer);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1800 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1900
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1900', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1900 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV);
        await getSelectedTrackBeforeGetSource(videoPlayer);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_1900 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2000
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2000', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2000 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV);
        await selectedTracksBeforeGetSource(videoPlayer);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2000 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2100
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2100', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2100 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV)
        await trackSwitchingBase.setSurface(videoPlayer, trackSwitchingBase.surfaceID);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2100 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2200
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2200', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2200 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV);
        await trackSwitchingBase.setSurface(videoPlayer, trackSwitchingBase.surfaceID);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2200 is end-----------')
    })

    /* *
       * @tc.number    : SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2300
       ...
       * @tc.level     : Level3
     */
    it('SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2300', 0, async function (done) {
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2300 is start-----------')
        videoPlayer = await trackSwitchingBase.createVideoPlayer();
        await trackSwitchingBase.setVideoHttpSource
        (videoPlayer, trackSwitchingBase.VIDEO_HTTP_PATH + trackSwitchingBase.H263_MP3_3TRK_MKV);
        await trackSwitchingBase.setSurface(videoPlayer, trackSwitchingBase.surfaceID);
        ...
        console.info('--------SUB_MEDIA_NETWORK_AUDIO_AND_VIDEO_PLAYER_RELIABILITY_PROMISE_2300 is end-----------')
    })
})
