...
describe('videoPlayerCacheLimitFunTest', function () {
    ...
    async function videoPrepare() {
        await videoPlayer.prepare().then(() => {
            console.info('prepare is success');
        }).catch((err) => {
            console.info('prepare is fail, err:  ' + JSON.stringify(err));
        })
    }

    async function videoPlay(caseid, type1, type2, type1value, type2value) {
        await videoPlayer.play().then(() => {
            console.info('play is success');
            if (type1 == 'sizeUpperLimit' && type2 == null) {
                ...
                console.info('case ' + caseid + ' get durationUpperLimit is success: ' +
                videoPlayer.cacheLimit.durationUpperLimit);
                ...
                console.info('case ' + caseid + ' get durationUpperLimit is success: ' +
                videoPlayer.cacheLimit.durationUpperLimit);
                console.info('case ' + caseid + ' get sizeUpperLimit is success : ' +
                videoPlayer.cacheLimit.sizeUpperLimit);
                expect(videoPlayer.cacheLimit.durationUpperLimit == type2value).assertTrue();
                expect(videoPlayer.cacheLimit.sizeUpperLimit == type1value).assertTrue();
            }
        }).catch((err) => {
    ...
    async function videoPlaySigle(caseid, type, value) {
        videoPlayer.play().then(() => {
            console.info('play is success');
            if (type == 'sizeUpperLimit') {
                console.info('case ' + caseid + ' get sizeUpperLimit is success : ' +
                videoPlayer.cacheLimit.sizeUpperLimit);
                expect(videoPlayer.cacheLimit.sizeUpperLimit == value).assertTrue();
            }
            else if (type == 'durationUpperLimit') {
                console.info('case ' + caseid + ' get durationUpperLimit is success: ' +
                videoPlayer.cacheLimit.durationUpperLimit);
                expect(videoPlayer.cacheLimit.durationUpperLimit == value).assertTrue();
            }
        }).catch((err) => {
            console.info('play is fail, err: ' + err);
        });
    ...
    async function videoPlayBoth(caseid, value1, value2) {
        videoPlayer.play().then((data) => {
            ...
            console.info('case ' + caseid + ' get sizeUpperLimit is success : ' +
            videoPlayer.cacheLimit.sizeUpperLimit);
            expect(videoPlayer.cacheLimit.durationUpperLimit == value2).assertTrue();
            expect(videoPlayer.cacheLimit.sizeUpperLimit == value1).assertTrue();
        }).catch((err) => {
            console.info('play is fail, err: ' + err);
        });
    }
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set sizeUpperLimit before prepare--100M
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_0100', 0, async function (done) {
        ...
        console.info('case 0100 getnetworkfd videoPlayer.url:' + videoPlayer.url);
        ...
        await videoPrepare();
        await sleep(sleepTime);
        await videoPlay(caseid, 'sizeUpperLimit', null, SIZE_UPPER_LIMIT_100M, null);
        await sleep(sleepTime);
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set sizeUpperLimit after prepare--100M
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_0200', 0, async function (done) {
        ...
        await videoPlaySigle(caseid, 'sizeUpperLimit', SIZE_UPPER_LIMIT_100M);
        await sleep(sleepTime);
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_0300', 0, async function (done) {
        ...
        await videoPrepare();
        await sleep(sleepTime);
        await videoPlay(caseid, null, 'durationUpperLimit', null, DURATION_UPPER_LIMIT_15S);
        await sleep(sleepTime);
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set durationUpperLimit before prepare--60s
        * @tc.desc      : set durationUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_0400', 0, async function (done) {
        ...
        console.info('durationUpperLimit is : ' + videoPlayer.cacheLimit.durationUpperLimit);
        await sleep(sleepTime);
        await videoPlay(caseid,  null, 'durationUpperLimit', null, DURATION_UPPER_LIMIT_60S);
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set durationUpperLimit after prepare--60s
        * @tc.desc      : set durationUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_0700', 0, async function (done) {
        ...
        await videoPrepare();
        await sleep(sleepTime);
        await videoPlay(caseid, 'sizeUpperLimit', 'durationUpperLimit',
    ...
    /* *
        ...
        * @tc.name      : http play mpeg-ts  set sizeUpperLimit before prepare
        * @tc.desc      : set sizeUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play mpeg-ts  set sizeUpperLimit after prepare
        * @tc.desc      : set sizeUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play mpeg-ts set durationUpperLimit before prepare
        * @tc.desc      : set durationUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play mpeg-ts set durationUpperLimit  after prepare
        * @tc.desc      : set durationUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play webm set sizeUpperLimit before prepare
        * @tc.desc      : set sizeUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play webm set sizeUpperLimit after prepare
        * @tc.desc      : set sizeUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_1300', 0, async function (done) {
        ...
        console.info('sizeUpperLimit is : ' + videoPlayer.cacheLimit.sizeUpperLimit);
        await sleep(sleepTime);
        await videoPlay(caseid, 'sizeUpperLimit', null, SIZE_UPPER_LIMIT_500M, null);
        await sleep(sleepTime);
    ...
    /* *
        ...
        * @tc.name      : http play webm set durationUpperLimit before prepare
        * @tc.desc      : set durationUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play webm set durationUpperLimit  after prepare
        * @tc.desc      : set durationUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set sizeUpperLimit before prepare--500M
        * @tc.desc      : set sizeUpperLimit before prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    ...
    /* *
        ...
        * @tc.name      : http play mp4 set sizeUpperLimit after prepare--500M
        * @tc.desc      : set sizeUpperLimit after prepare
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_FUNCTION_1800', 0, async function (done) {
        ...
        await videoPrepare();
        await sleep(sleepTime);
        await videoPlayBoth(caseid, 'sizeUpperLimit', 'durationUpperLimit',
