...
const ENCODE_STEP = {
    ...
    SET_PARAMETER: 'encode:setParameter',
    GET_INPUT_SURFACE: 'encode:getSurface',
...
describe('VideoEncoderParameterCallback', function () {
    ...
    let mediaDescription = {
        ...
        'pixel_format': 3,
        'frame_rate': 30,
        "codec_profile": media.VideoEncodeBitrateMode.AVC_PROFILE_HIGH,
        "video_encode_birate_mode": media.AVCProfile.VBR,
    }
    beforeAll(function () {
    ...
    function toSetParameter(mySteps, done, expectFail) {
        videoEncodeProcessor.setParameter(mediaDescription, (err) => {
            console.info(`case setParameter callback`);
            printError(err, expectFail);
            toNextStep(mySteps, done);
        })
    }
    ...
    function toNextStep(mySteps, done) {
        ...
        switch (mySteps[0]) {
            case ENCODE_STEP.CONFIGURE:
                ...
                break;
            case ENCODE_STEP.SET_PARAMETER:
                mySteps.shift();
                runCase(mySteps, toSetParameter, done);
                break;
            ...
            case STREAM_STEP.STOP:
                ...
                break;
            case ENCODE_STEP.GET_INPUT_SURFACE:
                mySteps.shift();
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0100', 0, async function (done) {
        ...
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS,
            ENCODE_STEP.CONFIGURE, ENCODE_STEP.ERROR, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET,
            STREAM_STEP.STOP, ENCODE_STEP.CONFIGURE, STREAM_STEP.SET_PARAM, STREAM_STEP.SET_EOS_FRAME,
            ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.CONFIGURE,
            ENCODE_STEP.ERROR, ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0900', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, STREAM_STEP.STOP, ENCODE_STEP.CONFIGURE,
            STREAM_STEP.SET_PARAM, STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    ...
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.PREPARE, ENCODE_STEP.ERROR, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.START, ENCODE_STEP.PREPARE, ENCODE_STEP.ERROR, ENCODE_STEP.SET_PARAMETER,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.ERROR, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.RESET, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.ERROR, ENCODE_STEP.SET_PARAMETER, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.START,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.START, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.START,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.START,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.START,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.FLUSH, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.FLUSH, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.FLUSH,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.FLUSH,
            ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.STOP, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.STOP,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.STOP, ENCODE_STEP.ERROR,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.STOP,
            ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.STOP, ENCODE_STEP.ERROR,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE,
            ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUT_SURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SET_PARAMETER, ENCODE_STEP.START,
    ...
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START-STOP_PAR_CALLBACK_0100', 0, async function (done) {
        ...
        eventEmitter.on('prepare', () => {
            videoEncodeProcessor.prepare((err) => {
                ...
                eventEmitter.emit('setParameter', mediaDescription);
            });
        });
        eventEmitter.on('setParameter', (mediaDescription) => {
            videoEncodeProcessor.setParameter(mediaDescription, (err) => {
                expect(err).assertUndefined();
                console.info(`case setParameter 1`);
