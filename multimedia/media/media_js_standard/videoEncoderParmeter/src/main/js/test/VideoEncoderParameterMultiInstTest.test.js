...
describe('videoEncoderParameterMultiInstTest', function () {
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_PAR_MULTIINSTANCE_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_PAR_MULTIINSTANCE_0100', 0, async function (done) {
