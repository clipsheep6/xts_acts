...
const ENCODE_STEP = {
    ...
    SETPARAMETER: 'encode:setParameter',
...
describe('VideoEncoderSoftwareReliabilityParmeterCallbackTest', function () {
    ...
    const AVC_PROFILE_BASELINE=0;
    const AVC_PROFILE_HIGH =4;
    const AVC_PROFILE_MAIN=8;
    const CBR=0;
    const VBR=1;
    ...
    let mediaDescription = {
        ...
        'pixel_format': 3,
        'frame_rate': 30,
        "codec_profile": AVC_PROFILE_HIGH ,
        "video_encode_birate_mode": VBR,
    }
    beforeAll(function () {
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START, ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_CONFIGURE_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.ERROR, ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0200', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    ...
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.PREPARE,  ENCODE_STEP.ERROR,ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE,  ENCODE_STEP.START, ENCODE_STEP.PREPARE,  ENCODE_STEP.ERROR,ENCODE_STEP.SETPARAMETER,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.ERROR,ENCODE_STEP.SETPARAMETER, ENCODE_STEP.RESET, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_PREPARE_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            ...
            ENCODE_STEP.ERROR,ENCODE_STEP.SETPARAMETER, STREAM_STEP.STOP, ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.START, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.START, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.START,
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_START_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.START,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.FLUSH, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.FLUSH, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.FLUSH,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.FLUSH,
            ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_FLUSH_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.FLUSH,
            ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.STOP, ENCODE_STEP.ERROR, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.STOP,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.STOP, ENCODE_STEP.ERROR,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.STOP,
            ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_STOP_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.STOP, ENCODE_STEP.ERROR,
            ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0400', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0500', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.FLUSH, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0600', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.STOP, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0700', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        frameTotal = 50;
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_RESET_PAR_CALLBACK_0800', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.RESET, ENCODE_STEP.RESET, ENCODE_STEP.RELEASE);
        toCreateVideoEncoderByName('openh264enc', path, mySteps, done);
    })
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_EOS_PAR_CALLBACK_0300', 0, async function (done) {
        ...
        let mySteps = new Array(ENCODE_STEP.CONFIGURE, STREAM_STEP.CREATE, STREAM_STEP.SET_PARAM,
            STREAM_STEP.SET_EOS_FRAME, ENCODE_STEP.GET_INPUTSURFACE, STREAM_STEP.START,
            ENCODE_STEP.PREPARE, ENCODE_STEP.SETPARAMETER, ENCODE_STEP.START, ENCODE_STEP.WAIT_FOR_EOS, ENCODE_STEP.RESET,
    ...
    */
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_TOTALLOOP_PAR_CALLBACK_0100
        ...
        * @tc.level     : Level2
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_API_TOTALLOOP_PAR_CALLBACK_0100', 0, async function (done) {
        let name = 'openh264enc';
        let events = require('events');
        let eventEmitter = new events.EventEmitter();
        let loopCnt = 0;
