...
describe('videoEncoderFuncParmeterPromise', function () {
    ...
    async function toSetParameter(mediaDescription) {
        await videoEncodeProcessor.setParameter(mediaDescription).then(() => {
            console.info("case setParameter success");
        }, failCallback).catch(failCatch);
    }
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_00_0100
        * @tc.name      : 000.test stop after last frame and reset
        * @tc.desc      : Configure diff from SetParameter (入参不一致)
        * @tc.size      : MediumTest
        * @tc.type      : Function test
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_00_0100', 0, async function (done) {
        console.info("case test stop after last frame");
        let savepath = BASIC_PATH + '0000.h264';
        ...
        await toPrepare();
        await toSetParameter(mediaDescription2);
        toStartStream();
        await toStart();
    })

    /* *
    * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0200
    * @tc.name      : 001.test stop at runnning state and reset
    * @tc.desc      : basic encode function（SetParameter放到start之后调用）
    * @tc.size      : MediumTest
    * @tc.type      : Function test
    * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0200', 0, async function (done) {
    ...
    /* *
    * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0300
    ...
    * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0300', 0, async function (done) {
        ...
        toStartStream();
        await toStart();
        await toSetParameter(mediaDescription);
        await sleep(5000);
        resetParam();
        toSetStreamParam(width, height, framerate, frameTotal);
        await toStart();
    ...
    /* *
    * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0400
    ...
    * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0400', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0500
        ...
        * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0500', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0600
        ...
        * @tc.level     : Level1
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0600', 0, async function (done) {
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0700
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0700', 0, async function (done) {
        ...
        let mediaDescription3 = {
            "codec_profile": 33,
            "video_encode_birate_mode": '',
        }
        let savepath2 = BASIC_PATH + '0601.h264';
        toSetStreamParam(width, height, framerate, frameTotal);
        await toConfigure(mediaDescription2, savepath2);
        setCallback(done);
        await toGetInputSurface();
        await toPrepare();
        await toSetParameter(mediaDescription3);
        toStartStream();
        await toStart();
    })

    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0800
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_PROMISE_01_0800', 0, async function (done) {
