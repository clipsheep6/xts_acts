...
describe('VideoEncoderFuncParmeterCallback', function () {
    ...
    eventEmitter.on('prepare', (mediaDescription,done) => {
        videoEncodeProcessor.prepare((err) => {
            ...
            toStartStream();
            eventEmitter.emit('setParameter', mediaDescription,done);
        });
    });

    eventEmitter.on('setParameter', (mediaDescription,done) => {
        console.info('in case : setParameter in');
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_00_0100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_00_0100', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_00_0100.h264';
        let mime = 'video/avc';
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0100
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0100', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0100.h264';
        ...
        let mediaDescription = {
            ...
            'pixel_format': 3,
            'frame_rate': 30.00,
            "codec_profile": media.VideoEncodeBitrateMode.AVC_PROFILE_BASELINE ,
            "video_encode_birate_mode": media.AVCProfile.VBR,
        }
        finalFrameId = 50;
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0200
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0200', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0200.h264';
        let name = 'openh264enc';
        let mediaDescription = {
            'width': 320,
            'height': 240,
            ...
            'frame_rate': 30.00,
            "codec_profile": media.VideoEncodeBitrateMode.AVC_PROFILE_HIGH ,
            "video_encode_birate_mode": media.AVCProfile.CBR,
        }
        reStart = true;
        media.createVideoEncoderByName(name, (err, processor) => {
            expect(err).assertUndefined();
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0300
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0300', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0300.h264';
        let name = 'openh264enc';
        let mediaDescription = {
            'width': 320,
            'height': 240,
            'pixel_format': 3,
            'frame_rate': 30.00,
            "codec_profile": media.VideoEncodeBitrateMode.AVC_PROFILE_MAIN ,
            "video_encode_birate_mode": media.AVCProfile.CBR,
        }
        finalFrameId = 50;
        reStart = true;
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0400
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0400', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0400.h264';
        let name = 'openh264enc';
        let mediaDescription = {
            'width': 320,
            'height': 240,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0500
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0500', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0500.h264';
        let name = 'openh264enc';
        let mediaDescription = {
            'width': 320,
            'height': 240,
    ...
    /* *
        * @tc.number    : SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0600
        ...
        * @tc.level     : Level0
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0600', 0, async function (done) {
        let decPath = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0600.h264';
        let name = 'openh264enc';
        let mediaDescription = {
            'width': 320,
            'height': 240,
        ...
        let decPath2 = 'SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_CALLBACK_01_0600_2.h264';
