...
describe('VideoEncoderSoftwareFuncParmeterCallbackTest', function () {
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0100', 0, async function (done) {
        ...
        let mediaDescription = {
            ...
            'pixel_format': 3,
            'frame_rate': 30.00,
            "codec_profile": AVC_PROFILE_BASELINE ,
            "video_encode_birate_mode": VBR,
        }
        finalFrameId = 50;
    ...
    */
    it('SUB_MEDIA_VIDEO_SOFTWARE_ENCODER_FUNCTION_PAR_CALLBACK_01_0300', 0, async function (done) {
        ...
        let mediaDescription = {
            ...
            'pixel_format': 3,
            'frame_rate': 30.00,
            "codec_profile": AVC_PROFILE_MAIN ,
            "video_encode_birate_mode": CBR,
        }
        finalFrameId = 50;
        reStart = true;
