...
describe('VideoPlayerHLSTest', function () {
    ...
    // it('SUB_MEDIA_VIDEO_PLAYER_H264_AAC', 0, async function (done) {
    //     let fileDescriptor = null;
    //     await mediaTestBase.getFileDescriptor('H264_AAC.mp4').then((res) => {
    //         fileDescriptor = res;
    //     });
    //     mediaTestBase.isFileOpen(fileDescriptor, done);
    //     await playVideoSource('fd://' + fileDescriptor.fd, 720, 480, 10033, PLAY_TIME, done);
    //     await mediaTestBase.closeFileDescriptor('H264_AAC.mp4');
    //     done();
    // })
