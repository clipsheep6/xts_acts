...
describe('videoPlayerCacheLimitReliabilityTest', function () {
    ...
    const LOCAL_SOURCE_MP4 = 'H264_MP3.mp4';
    //    const LOCAL_SOURCE_MPEG_TS = './mpeg2_mp3.ts';
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_RELIABILITY_0500', 0, async function (done) {
        ...
        console.info('caee 0500 durationUpperLimit is : ' + videoPlayer.cacheLimit.durationUpperLimit);
        getNetworkFd(HTTP_SOURCE_MP4)
        await setSurface(surfaceID);
        await  videoPrepare();
    ...
    */
    it('SUB_MEDIA_VIDEO_PLAYER_CACHELIMIT_RELIABILITY_0700', 0, async function (done) {
        ...
        console.info('case 0700 get durationUpperLimit is sucess : ' + videoPlayer.cacheLimit.durationUpperLimit);
    ...
    */
    ...
    /* *
        ...
        * @tc.name      : http paly webm set sizeUpperLimit after prepare , get default value
