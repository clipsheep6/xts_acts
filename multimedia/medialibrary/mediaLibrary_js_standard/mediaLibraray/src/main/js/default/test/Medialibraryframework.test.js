...
it(' GETMEDIA_ASYNC_WITHOUT_FETCH_01', 0,async function (done) {
	console.info("MLTFW: starting getmediaassets async without fetch test case 001");
	media.getMediaAssets((error, value)=> {
		console.info("MLTFW: before undefined");
		if (value != undefined){
			console.info("MLTFW: inside undefined");
			value.forEach(getMediaData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETMEDIA_ASYNC_WITHOUT_FETCH_01: PASS');
		} else if (value == undefined){
			expect(false).assertTrue();
			console.info('MLTFW: There are no  files under /data/media folder');
			console.info('MLTFW:  GETMEDIA_ASYNC_WITHOUT_FETCH_01: FAIL');
		}
		done();
	});
	done();
...
it(' GETMEDIA_ASYNC_WITH_FETCH_02', 0, async function (done) {
	media.getMediaAssets(mediapath, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no  files under' + mediapath  );
			expect(false).assertTrue();
			console.info('MLTFW:  GETMEDIA_ASYNC_WITH_FETCH_02: FAIL');
		} else if (value != undefined){
			console.info("MLTFW: mediapath after is :" + mediapath);
			value.forEach(getMediaData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETMEDIA_ASYNC_WITH_FETCH_02: PASS');
		}
		done();
	});
	done();
...
it(' GETMEDIA_ASYNC_NONEXISTANT_FETCH_OPTIONS_05', 0, async function (done) {
	media.getMediaAssets( nonexistantpath, (error, value)=> {
		console.info('MLTFW: getMediaAssets returned value' + value);
		if (value == undefined){
			console.info('MLTFW: getMediaAssets returned undefiened' + value);
			console.info('MLTFW: There are no  files under' + nonexistantpath  );
			expect(true).assertTrue();
			console.info('MLTFW: GETMEDIA_ASYNC_NONEXISTANT_FETCH_OPTIONS_05: PASS')
		} else if (value != undefined){
			console.info("MLTFW: mediapath after is :" + nonexistantpath);
			console.info('MLTFW: GETMEDIA_ASYNC_NONEXISTANT_FETCH_OPTIONS_05: FAIL');
			expect(false).assertTrue();
		}
		done();
	});
...
it('GETMEDIA_ASYNC_EMPTY_FETCH_OPTIONS_07', 0, async function (done) {
	console.info("MLTFW:  GETMEDIA_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07");
	media.getMediaAssets(EMPTYPATH, (error, value)=> {
		console.info('MLTFW: getMediaAssets returned an value' + value);
		if (value == undefined){
			console.info('MLTFW: getMediaAssets returned undefined' + value);
			console.info('MLTFW: There are no  files under' + mediapath  );
			expect(true).assertTrue();
			console.info('MLTFW: GETMEDIA_ASYNC_EMPTY_FETCH_OPTIONS_07: PASS');
		} else if (value != undefined){
			console.info("MLTFW: mediapath after is :" + mediapath);
			value.forEach(getMediaData);
			expect(false).assertTrue();
			console.info('MLTFW: GETMEDIA_ASYNC_EMPTY_FETCH_OPTIONS_07: FAIL');
		}
		done();
	});
	done();
...
it(' GETMEDIA_PROMISE_WITHOUT_FETCH_03', 0, async function (done) {
	...
	promise.then(async function(data){
		console.info('MLTFW: Promise successful: getMediaAssets3 returns '+ data.length);
		if (data == undefined) {
			console.info('MLTFW: There are no Media files in' + '/data/media'  );
			expect(false).assertTrue();
		} else if (data != undefined){
			data.forEach(getMediaData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETMEDIA_PROMISE_WITHOUT_FETCH_03:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETMEDIA_PROMISE_WITH_FETCH_04', 0, async function (done) {
	...
	promise.then(async function(data){
		if (data == undefined) {
		console.info('MLTFW: There are no Media files in' + mediapath  );
		expect(false).assertTrue();
		console.info('MLTFW:  GETMEDIA_PROMISE_WITH_FETCH_04:  FAIL');
	} else if (data != undefined){
		console.info("MLTFW: mediapath after is :" + mediapath);
		data.forEach(getMediaData);
		console.info('MLTFW:  GETMEDIA_PROMISE_WITH_FETCH_04:  PASS');
	}
	});
	await promise;
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_01', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect(false).assertTrue();
		} else if (value != undefined){
			value.forEach(getImageData);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_01: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_BMP_01', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_BMP_01: FAIL');
		} else if (value != undefined){
			console.info(' MLTFW:value is :' + value);
			value.forEach(getImageDataBmp);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_BMP_01: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_GIF_02', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_GIF_02: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataGif);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_GIF_02: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_JPG_03', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_JPG_03: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataJpg);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_JPG_03: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_PNG_04', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_PNG_04: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataPng);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_PNG_04: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_RAW_05', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_RAW_05: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataRaw);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_RAW_05: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_HEIF_06', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_HEIF_06: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataHeif);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_HEIF_06: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_SVG_07', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_SVG_07: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataSvg);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_SVG_07: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITHOUT_FETCH_WEBP_08', 0, async function (done) {
	media.getImageAssets((error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images under /data/media folder');
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_WEBP_08: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataWebp);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITHOUT_FETCH_WEBP_08: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_02', 0, async function (done) {
	media.getImageAssets(imagespath,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + imagespath.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_02: FAIL');
		}
		else if (value != undefined){
			value.forEach(getImageData);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_02: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_BMP_01', 0, async function (done) {
	media.getImageAssets(BMP,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + BMP.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_BMP_01: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataBmp);
			console.info(' MLTFW: There are BMP images in' + BMP.selections);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_BMP_01: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_GIF_02', 0, async function (done) {
	media.getImageAssets(GIF,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + GIF.selections);
			expect().assertFail();
		} else if (value != undefined){
			value.forEach(getImageDataGif);
			expect(true).assertTrue();
			console.info(' MLTFW: There are GIF images in' + GIF.selections);
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_GIF_02: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_JPG_03', 0, async function (done) {
	media.getImageAssets(JPG,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + JPG.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_JPG_03: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataJpg);
			console.info(' MLTFW: There are JPG images in' + JPG.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_JPG_03: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_PNG_04', 0, async function (done) {
	media.getImageAssets(PNG,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + PNG.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_PNG_04: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataPng);
			console.info(' MLTFW: There are PNG images in' + PNG.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_PNG_04: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_RAW_05', 0, async function (done) {
	media.getImageAssets(RAW,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + RAW.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_RAW_05: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataRaw);
			console.info(' MLTFW: There are RAW images in' + RAW.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_RAW_05: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_HEIF_06', 0, async function (done) {
	media.getImageAssets(HEIF,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + HEIF.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_HEIF_06: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataHeif);
			console.info(' MLTFW: There are HEIF images in' + HEIF.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_HEIF_06: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_SVG_07', 0, async function (done) {
	media.getImageAssets(SVG,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + SVG.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_SVG_07: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataSvg);
			console.info(' MLTFW: There are SVG images in' + SVG.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_SVG_07: PASS');
		}
		done();
	});
	done();
...
it(' GETIMAGE_ASYNC_WITH_FETCH_WEBP_08', 0, async function (done) {
	media.getImageAssets(WEBP,(error, value)=> {
		if (value == undefined){
			console.info(' MLTFW: There are no images in' + WEBP.selections  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_WEBP_08: FAIL');
		} else if (value != undefined){
			value.forEach(getImageDataWebp);
			console.info(' MLTFW: There are WEBP images in' + WEBP.selections  );
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_ASYNC_WITH_FETCH_WEBP_08: PASS');
		}
	done();
	});
	done();
...
it(' GETIMAGE_PROMISE_WITH_FETCH_03', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + mediapath.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITH_FETCH_03:  PASS');
		} else if (data != undefined){
			console.info(' MLTFW: There are images in' + mediapath.selections  );
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_04', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_04:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageData);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_04:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_BMP_01', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_BMP_01:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataBmp);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_BMP_01:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_GIF_02', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_GIF_02:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataGif);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_GIF_02:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_JPG_03', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_JPG_03:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataJpg);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_JPG_03:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_PNG_04', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_PNG_04:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataPng);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_PNG_04:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_RAW_05', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_RAW_05:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataRaw);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_RAW_05:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_HEIF_06', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_HEIF_06:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataHeif);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_HEIF_06:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_SVG_07', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_SVG_07:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataSvg);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_SVG_07:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_WITHOUT_FETCH_WEBP_08', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + '/data/media'  );
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_WEBP_08:  FAIL');
		} else if (data != undefined){
			data.forEach(getImageDataWebp);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_WITHOUT_FETCH_WEBP_08:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_PROMISE_IN_EMPTYPATH_05', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info(' MLTFW: There are no images in' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETIMAGE_PROMISE_IN_EMPTYPATH_05:  PASS');
		} else if (data != undefined){
			console.info(' MLTFW: Promise successful: DATA VALUE IS '+ data);
			console.info(' MLTFW: There are images in' + EMPTYPATH.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETIMAGE_PROMISE_IN_EMPTYPATH_05:  FAIL');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_IMAGE_WITHFETCH_01', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + imagespath.selections);
			expect().assertFail();
			console.info('MLTFW: GETIMAGE_CHECK_MIME_MEDIA_TYPE_IMAGE_WITHFETCH_01:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW: GETIMAGE_CHECK_MIME_MEDIA_TYPE_IMAGE_WITHFETCH_01:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_BMP_02', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + BMP.selections );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_BMP_02:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getBMPImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_BMP_02:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_GIF_03', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + GIF.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_GIF_03:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getGIFImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_GIF_03:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_JPG_04', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + JPG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_JPG_04:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getJPGImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_JPG_04:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_PNG_05', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + PNG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_PNG_05:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getPNGImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_PNG_05:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_RAW_06', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + RAW.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_RAW_06:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getRawImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_RAW_06:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_HEIF_07', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + HEIF.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_HEIF_07:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getHeifImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_HEIF_07:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_SVG_08', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + SVG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_SVG_08:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getSvgImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_SVG_08:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETIMAGE_CHECK_MIME_MEDIA_TYPE_WEBP_09', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no image files in' + WEBP.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_WEBP_09:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getImageAssets3 returns '+ data.length);
			data.forEach(getWebpImageDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGE_CHECK_MIME_MEDIA_TYPE_WEBP_09:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_01', 0, async function (done) {
	...
	if (value1 == undefined){
		console.info('MLTFW: There are no audio files under /data/media folder');
		expect().assertFail();
		console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_01: FAIL');
	} else if (value1 != undefined){
		console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
		value1.forEach(getAudioData);
		expect(true).assertTrue();
		console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_01: PASS');
	}
	done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_WAV_01', 0, async function (done) {
	media.getAudioAssets((error, value1)=> {
		if (value1 == undefined){
			console.info('MLTFW: There are no audio files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_WAV_01: FAIL');
		} else if (value1 != undefined){
			console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
			value1.forEach(getAudioDatawav);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_WAV_01: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_AAC_02', 0, async function (done) {
	media.getAudioAssets((error, value1)=> {
		if (value1 == undefined){
			console.info('MLTFW: There are no audio files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_AAC_02: FAIL');
		} else if (value1 != undefined){
			console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
			value1.forEach(getAudioDataAac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_AAC_02: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_FLAC_04', 0, async function (done) {
	media.getAudioAssets((error, value1)=> {
		if (value1 == undefined){
			console.info('MLTFW: There are no audio files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_FLAC_04: FAIL');
		} else if (value1 != undefined){
			console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
			value1.forEach(getAudioDataFlac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_FLAC_04: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_MP3_03', 0, async function (done) {
	media.getAudioAssets((error, value1)=> {
		if (value1 == undefined){
			console.info('MLTFW: There are no audio files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_MP3_03: FAIL');
		} else if (value1 != undefined){
			console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
			value1.forEach(getAudioDataMp3);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_MP3_03: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITHOUT_FETCH_0GG_05', 0, async function (done) {
	media.getAudioAssets((error, value1)=> {
		if (value1 == undefined){
			console.info('MLTFW: There are no audio files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_OGG_05: FAIL');
		} else if (value1 != undefined){
			console.info('MLTFW: getAudioAssets1 returns '+ value1.length);
			value1.forEach(getAudioDataOGG);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITHOUT_FETCH_OGG_05: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITH_FETCH_02', 0, async function (done) {
	media.getAudioAssets(audiopath, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + audiopath.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_02: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_02: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYC_FETCH_WAV_01', 0, async function (done) {
	media.getAudioAssets(WAV, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + WAV.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYC_FETCH_WAV_01: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioDatawav);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYC_FETCH_WAV_01: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITH_FETCH_AAC_02', 0, async function (done) {
	media.getAudioAssets(AAC, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + AAC.selections);
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_AAC_02: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioDataAac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_AAC_02: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITH_FETCH_MP3_03', 0, async function (done) {
	media.getAudioAssets(MP3, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + MP3.selections);
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_MP3_03: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioDataMp3);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_MP3_03: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITH_FETCH_FLAC_04', 0, async function (done) {
	media.getAudioAssets(FLAC, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + FLAC.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_FLAC_04: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioDataFlac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_FLAC_04: PASS');
		}
		done();
	});
	done();
...
it(' GETAUDIO_ASYNC_WITH_FETCH_0GG_05', 0, async function (done) {
	media.getAudioAssets(OGG, (error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no audio files under' + OGG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_0GG_05: FAIL');
		} else if (value != undefined){
			console.info('MLTFW: getAudioAssets2 returns '+ value.length);
			value.forEach(getAudioDataOGG);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_ASYNC_WITH_FETCH_0GG_05: PASS');
		}
		done();
	});
	done();
...
it(' GET_AUDIO_ASSETS_WITH_FETCH_03', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + audiopath.selections);
			expect().assertFail();
			console.info('MLTFW:  GET_AUDIO_ASSETS_WITH_FETCH_03:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioData);
			expect(true).assertTrue();
			console.info('MLTFW:  GET_AUDIO_ASSETS_WITH_FETCH_03:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_WITHFETCH_WAV_01', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + WAV.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_WAV_01:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDatawav);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_WAV_01:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_WITHFETCH_AAC_02', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + AAC.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_AAC_02:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataAac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_AAC_02:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_WITHFETCH_MP3_03', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + MP3.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_MP3_03:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataMp3);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_MP3_03:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_WITHFETCH_FLAC_04', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + FLAC.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_FLAC_04:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataFlac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_FLAC_04:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_WITHFETCH_OGG_05', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + OGG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_OGG_05:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataFlac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_WITHFETCH_OGG_05:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_04', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GET_AUDIO_ASSETS_WITHOUT_FETCH_04:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioData);
			expect(true).assertTrue();
			console.info('MLTFW:  GET_AUDIO_ASSETS_WITHOUT_FETCH_04:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_OUT_FETCH_WAV_01', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_WAV_01:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioDatawav);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_WAV_01:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_OUT_FETCH_AAC_02', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_AAC_02:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioDataAac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_AAC_02:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_OUT_FETCH_MP3_03', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_MP3_03:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioDataMp3);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_MP3_03:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_OUT_FETCH_FLAC_04', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_FLAC_04:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioDataFlac);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_FLAC_04:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_PROMISE_OUT_FETCH_OGG_05', 0, async function (done) {
	...
	promise.then(function(data1){
		if (data1 == undefined) {
			console.info('MLTFW: There are no audio files in' + '/data/media'  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_OGG_05:  FAIL');
		} else if (data1 != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets4 returns '+ data1.length);
			data1.forEach(getAudioDataOGG);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_PROMISE_OUT_FETCH_OGG_05:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETAUDIO_05', 0, async function (done) {
	...
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + nonexistantpath.selections  );
			expect(true).assertTrue();
			console.info('MLTFW:  GET_AUDIO_ASSETS_NONEXISTANT_PATH_05:  PASS');
		} else if (data != undefined){
			expect().assertFail();
			console.info('MLTFW:  GET_AUDIO_ASSETS_NONEXISTANT_PATH_05:  FAIL');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_AUDIO_01
...
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_AUDIO_01', 0, async function (done) {
	const promise = media.getAudioAssets(audiopath);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + audiopath.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_AUDIO_01:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_AUDIO_01:  PASS');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_WAV_02
* @tc.name     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.desc     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_WAV_02', 0, async function (done) {
	const promise = media.getAudioAssets(WAV);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + WAV.selections  );
			expect().assertFail();
			console.info('MLTFW: testcase_S GETAUDIO_CHECK_MIME_MEDIA_TYPE_WAV_02:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDatawavCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_WAV_02:  PASS');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_AAC_03
* @tc.name     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.desc     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_AAC_03', 0, async function (done) {
	const promise = media.getAudioAssets(AAC);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + AAC.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_AAC_03:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataAacCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_AAC_03:  PASS');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_MP3_04
* @tc.name     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.desc     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_MP3_04', 0, async function (done) {
	const promise = media.getAudioAssets(MP3);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + MP3.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_MP3_04:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataMp3CheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_MP3_04:  PASS');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_FLAC_05
* @tc.name     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.desc     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_FLAC_05', 0, async function (done) {
	const promise = media.getAudioAssets(FLAC);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + FLAC.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_FLAC_05:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataFlacCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_FLAC_05:  PASS');
		}
	});
	await promise;
	done ();
...
/* *
* @tc.number   : GETAUDIO_CHECK_MIME_MEDIA_TYPE_OGG_06
* @tc.name     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.desc     :Get all Audio asset details in audio directory and check for mimetype and media type
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETAUDIO_CHECK_MIME_MEDIA_TYPE_OGG_06', 0, async function (done) {
	const promise = media.getAudioAssets(OGG);
	promise.then(function(data){
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + OGG.selections  );
			expect().assertFail();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_OGG_06:  FAIL');
		} else if (data != undefined){
			console.info('MLTFW: Promise successful: getAudioAssets3 returns '+ data.length);
			data.forEach(getAudioDataFlacCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETAUDIO_CHECK_MIME_MEDIA_TYPE_OGG_06:  PASS');
		}
	});
	await promise;
	done ();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_01', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_01:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_01:PASS');
		}
	done();
	});
	done();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_3PG_01', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_3PG_01:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoData3gp);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_3PG_01:PASS');
		}
		done();
	});
	done();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_MOV_02', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MOV_02:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoDataMov);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MOV_02:PASS');
		}
		done();
	});
	done();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_MP4_03', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MP4_03:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MP4_03:PASS');
		}
	done();
	});
	done();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_MPG_04', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MPG_04:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoDataMpg);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_MPG_04:PASS');
		}
	done();
	});
	done();
...
it(' GETVIDEO_ASYNC_WITHOUT_FETCH_WEBM_05', 0, async function (done) {
	media.getVideoAssets((error, value)=> {
		if (value == undefined){
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_WEBM_05:FAIL');
		} else if (value != undefined){
			value.forEach(getVideoDataWebm);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_WITHOUT_FETCH_WEBM_05:PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_02
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_02', 0, async function (done) {
	media.getVideoAssets(videopath, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files under ' + videopath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_02: FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_02: PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_3PG_01
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check 3gp file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check 3gp file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_3PG_01', 0, async function (done) {
	media.getVideoAssets(V3GP, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files under' + V3GP.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_3PG_01:FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoData3gp);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_3PG_01:PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_MOV_02
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check MOV file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check MOV file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_MOV_02', 0, async function (done) {
	media.getVideoAssets(MOV, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MOV_02:FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoDataMov);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MOV_02:PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_MP4_03
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check MP4 file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check MP4 file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_MP4_03', 0, async function (done) {
	media.getVideoAssets(MP4, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MP4_03:FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MP4_03:PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_MPG_04
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check MPG file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check MPG file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_MPG_04', 0, async function (done) {
	media.getVideoAssets(MPG, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files under /data/media folder');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MPG_04:FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoDataMpg);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_FETCH_MPG_04:PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_ASYNC_FETCH_WEBM_05
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check WEBM file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check WEBM file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_FETCH_WEBM_05', 0, async function (done) {
	media.getVideoAssets(WEBM, (error, value) => {
		if (value == undefined) {
			console.info('MediaibraryTest: There are no video files in' + WEBM.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_WEBM_05:  FAIL');
		} else if (value != undefined) {
			value.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_WEBM_05:  PASS');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_03
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_03', 0, async function (done) {
	const promise = media.getVideoAssets(videopath);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + videopath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_03:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_03:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_3PG_01
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_3PG_01', 0, async function (done) {
	const promise = media.getVideoAssets(V3GP);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + V3GP.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_3PG_01:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoData3gp);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_3PG_01:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_MOV_02
* @tc.name     :Get all VIDEO asset from /data/media using async callback and check MOV file metadata
* @tc.desc     :Get all VIDEO asset from /data/media using async callback and check MOV file metadata
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_MOV_02', 0, async function (done) {
	const promise = media.getVideoAssets(MOV);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + MOV.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MOV_02:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMov);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MOV_02:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_MP4_03
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_MP4_03', 0, async function (done) {
	const promise = media.getVideoAssets(MP4);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + MP4.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MP4_03:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MP4_03:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_MPG_04
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_MPG_04', 0, async function (done) {
	const promise = media.getVideoAssets(MPG);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + MPG.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MPG_04:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_FETCH_MPG_04:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_FETCH_WEBM_05
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_FETCH_WEBM_05', 0, async function (done) {
...
it(' GETVIDEO_PROMISE_OUT_FETCH_04', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_04:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoData);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_04:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETVIDEO_PROMISE_OUT_FETCH_3PG_01', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_3PG_01:  FAIL')
		} else if (data != undefined) {
			data.forEach(getVideoData3gp);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_3PG_01:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETVIDEO_PROMISE_OUT_FETCH_MOV_02', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MOV_02:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMov);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MOV_02:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETVIDEO_PROMISE_OUT_FETCH_MP4_03', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MP4_03:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MP4_03:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETVIDEO_PROMISE_OUT_FETCH_MPG_04', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MPG_04:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_MPG_04:  PASS');
		}
	});
	await promise;
	done();
...
it(' GETVIDEO_PROMISE_FETCH_WEBM_05', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in' + '/data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_WEBM_04:  FAIL');
		} else if (data != undefined) {
			data.forEach(getVideoDataMP4);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_PROMISE_OUT_FETCH_WEBM_04:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_VIDEO_01
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_VIDEO_01', 0, async function (done) {
	const promise = media.getVideoAssets(videopath);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + videopath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_VIDEO_01:  FAIL');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
			data.forEach(getVideoDataCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_VIDEO_01:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_3GP_02
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_3GP_02', 0, async function (done) {
	const promise = media.getVideoAssets(V3GP);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + V3GP.selectsions);
			expect().assertFail();
			onsole.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_3GP_02:  FAIL');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
			data.forEach(getAudioData3gpCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_3GP_02:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_MOV_03
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_MOV_03', 0, async function (done) {
	const promise = media.getVideoAssets(MOV);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + MOV.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MOV_03:  FAIL');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
			data.forEach(getAudioDataMOVCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MOV_03:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_MP4_04
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_MP4_04', 0, async function (done) {
	const promise = media.getVideoAssets(MP4);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + MP4.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MP4_04:  FAIL');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
			data.forEach(getAudioDataMP4CheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MP4_04:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_MPG_05
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_MPG_05', 0, async function (done) {
	const promise = media.getVideoAssets(MPG);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + MPG.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MPG_05:  PASS');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
...
/* *
* @tc.number   : GETVIDEO_CHECK_MIME_MEDIA_TYPE_WEBM_06
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_CHECK_MIME_MEDIA_TYPE_WEBM_06', 0, async function (done) {
	const promise = media.getVideoAssets(WEBM);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no audio files in' + WEBM.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MPG_06:  FAIL');
		} else if (data != undefined) {
			console.info('MLTFW: Promise successful: getAudioAssets3 returns ' + data.length);
			data.forEach(getAudioDataWEBMCheckMimeMediaType);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_CHECK_MIME_MEDIA_TYPE_MPG_06:  PASS');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETMEDIA_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07', 0, async function (done) {
	console.info("MLTFW:  GETVIDEO_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07");
	media.getVideoAssets(EMPTYPATH, (error, value) => {
		console.info('MLTFW: getMediaAssets2 returns ' + value.length);
		if (value == undefined) {
			console.info('MLTFW: getVideoAssets returned undefined' + value);
			console.info('MLTFW: There are no  files under' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07: PASS');
		} else if (value != undefined) {
			console.info("MLTFW: mediapath after is :" + EMPTYPATH.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_EMPTY_FETCH_OPTIONS_PROVIDED_07: FAIL');
		}
		done();
	});
	done();
...
* @tc.level    :Level 0
*/
it(' GETVIDEO_ASYNC_NONEXISTANT_FETCH_OPTIONS_PROVIDED_08', 0, async function (done) {
	console.info("MLTFW:  GETVIDEO_ASYNC_NONEXISTANT_FETCH_OPTIONS_PROVIDED_08");
	media.getVideoAssets(nonexistantpath, (error, value) => {
		console.info('MLTFW: getMediaAssets2 returns ' + value.length);
		if (value == undefined) {
			console.info('MLTFW: getVideoAssets returned undefined' + value);
			console.info('MLTFW: There are no  files under' + nonexistantpath.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEO_ASYNC_NONEXISTANT_FETCH_OPTIONS_PROVIDED_08: PASS');
		} else if (value != undefined) {
			console.info("MLTFW: mediapath after is :" + nonexistantpath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEO_ASYNC_NONEXISTANT_FETCH_OPTIONS_PROVIDED_08: FAIL');
		}
		done();
	});
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_EMPTY_05
* @tc.name     :Get all Image asset details from system with Promise and media fetch options
* @tc.desc     :Get image asset details from system
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_EMPTY_05', 0, async function (done) {
	const promise = media.getVideoAssets(EMPTYPATH);
	promise.then(function (data) {
		if (data == undefined) {
			console.info(' MLTFW: There are no videos in' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETVIDEO_PROMISE_EMPTY_05:  PASS');
		} else if (data != undefined) {
			console.info(' MLTFW: Promise successful: DATA VALUE IS ' + data);
			console.info(' MLTFW: There are videos in' + EMPTYPATH.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETVIDEO_PROMISE_EMPTY_05:  FAIL');
		}
	});
	await promise;
	done();
...
/* *
* @tc.number   : GETVIDEO_PROMISE_NONEXISTANT_06
* @tc.name     :Get all Image asset details from system with Promise and media fetch options
* @tc.desc     :Get image asset details from system
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEO_PROMISE_NONEXISTANT_06', 0, async function (done) {
	const promise = media.getVideoAssets(nonexistantpath);
	promise.then(function (data) {
		if (data == undefined) {
			console.info(' MLTFW: There are no videos in' + nonexistantpath.selections);
			expect(true).assertTrue();
			console.info(' MLTFW:  GETVIDEO_PROMISE_NONEXISTANT_06:  PASS');
		} else if (data != undefined) {
			console.info(' MLTFW: Promise successful: DATA VALUE IS ' + data);
			console.info(' MLTFW: There are videos in' + nonexistantpath.selections);
			expect().assertFail();
			console.info(' MLTFW:  GETVIDEO_PROMISE_NONEXISTANT_06:  FAIL');
		}
	});
	await promise;
	done();
...
it(' GETVIDEOALBUM_ASYNC_WITH_FETCH_01', 0, async function (done) {
	media.getVideoAlbums(videoalbumpath, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files in ' + videoalbumpath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEOALBUM_ASYNC_WITH_FETCH_01:FAIL ')
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for videoAlbums1  :' + albumName);
				albumId = value[i].albumId;
				console.info('MLTFW: albumId for videoAlbums1 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETVIDEOALBUM_ASYNC_WITH_FETCH_01:PASS ')
			}
		}
	done();
	});
...
it(' GETVIDEOALBUM_ASYNC_WITHOUT_FETCH_01', 0, async function (done) {
	media.getVideoAlbums((error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files in ' + 'data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEOALBUM_ASYNC_WITHOUT_FETCH_01:FAIL ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for videoAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for videoAlbums1 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETVIDEOALBUM_ASYNC_WITHOUT_FETCH_01:PASS ');
			}
		}
		done();
	});
...
it(' GET_IMAGEALBUM_ASYNC_WITH_FETCH_01', 0, async function (done) {
	media.getImageAlbums(imagealbumpath, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files in ' + imagealbumpath.selections);
			expect().assertFail();
			console.info('MLTFW:  GET_IMAGEALBUM_ASYNC_WITH_FETCH_01:FAIL ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for IMAGEAlbums1  :' + albumName);
				albumId = value[i].albumId;
				console.info('MLTFW: albumId for IMAGEAlbums1 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GET_IMAGEALBUM_ASYNC_WITH_FETCH_01:PASS ');
			}
		}
		done();
	});
...
it(' GETIMAGEALBUM_ASYNC_WITHOUT_FETCH_01', 0, async function (done) {
	media.getImageAlbums((error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no image files in ' + 'data/media');
			expect().assertFail();
			onsole.info('MLTFW:  GETIMAGEALBUM_ASYNC_WITHOUT_FETCH_01:FAIL ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for imageAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums1 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETIMAGEALBUM_ASYNC_WITHOUT_FETCH_01:PASS ');
		}
	}
	done();
	});
...
it(' GETVIDEOALBUM_ASYNC_WITH_FETCH_EMPTYPATH_01', 0, async function (done) {
	media.getVideoAlbums(EMPTYPATH, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files in ' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEOALBUM_ASYNC_FETCH_EMPTYPATH_01:PASS ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for videoAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for videoAlbums1 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETVIDEOALBUM_ASYNC_WITH_FETCH_EMPTYPATH_01:FAIL ');
		}
	}
	done();
	});
...
/* *
* @tc.number   : GETVIDEOALBUM_ASYNC_FETCH_NONEXISTANTPATH_01
* @tc.name     :Get all details of video album using async callback + get album name and album id
* @tc.desc     :Get all details of video album using async callback + get album name and album id
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEOALBUM_ASYNC_FETCH_NONEXISTANTPATH_01', 0, async function (done) {
	media.getVideoAlbums(nonexistantpath, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no video files in ' + nonexistantpath.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEOALBUM_ASYNC_FETCH_NONEXISTANTPATH_01:PASS ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for videoAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for videoAlbums1 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETVIDEOALBUM_ASYNC_FETCH_NONEXISTANTPATH_01:FAIL ');
			}
		}
		done();
	});
...
/* *
* @tc.number   : GETIMAGEALBUM_ASYNC_FETCH_EMPTYPATH_01
* @tc.name     :Get all details of image album using async callback + get album name and album id
* @tc.desc     :Get all details of image album using async callback + get album name and album id
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETIMAGEALBUM_ASYNC_FETCH_EMPTYPATH_01', 0, async function (done) {
	media.getImageAlbums(EMPTYPATH, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no image files in ' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGEALBUM_ASYNC_FETCH_EMPTYPATH_01:PASS ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for imageAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums1 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETIMAGEALBUM_ASYNC_FETCH_EMPTYPATH_01:FAIL ');
			}
		}
		done();
	});
...
/* *
* @tc.number   : GETIMAGEALBUM_ASYNC_FETCH_NONEXISTANTPATH_01
* @tc.name     :Get all details of image album using async callback + get album name and album id
* @tc.desc     :Get all details of image album using async callback + get album name and album id
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETIMAGEALBUM_ASYNC_FETCH_NONEXISTANTPATH_01', 0, async function (done) {
	media.getImageAlbums(nonexistantpath, (error, value) => {
		if (value == undefined) {
			console.info('MLTFW: There are no image files in ' + nonexistantpath.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGEALBUM_ASYNC_FETCH_NONEXISTANTPATH_01:PASS ');
		} else if (value != undefined) {
			for (i = 0; i < value.length; i++) {
				albumName = value[i].albumName;
				console.info('MLTFW: albumName for imageAlbums1  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums1 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETIMAGEALBUM_ASYNC_FETCH_NONEXISTANTPATH_01:FAIL ');
			}
		}
		done();
	});
...
/* *
* @tc.number   : GETIMAGEALBUM_PROMISE_FETCH_01
...
it(' GETIMAGEALBUM_PROMISE_WITH_FETCH_01', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no image files in ' + imagealbumpath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_01:FAIL ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for imageAlbums2  :' + albumName);
				albumId = data[i].albumId;
				console.info('MLTFW: albumId for imageAlbums2 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_01:PASS ');
			}
		}
	});
	await promise;
...
it(' GETIMAGEALBUM_PROMISE_WITHOUT_FETCH_01', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no image files in ' + 'data/media');
			expect().assertFail();
			console.info('MLTFW:  GETIMAGEALBUM_PROMISE_WITHOUT_FETCH_01:FAIL ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for imageAlbums2  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums2 :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETIMAGEALBUM_PROMISE_WITHOUT_FETCH_01:PASS ');
			}
		}
	});
	await promise;
...
/* *
* @tc.number   : GETIMAGEALBUM_PROMISE_FETCH_EMPTYPATH_01
* @tc.name     :Get all Album details from /data/media/imagealbum using promise + check album id and album name
* @tc.desc     :Get all Album details from /data/media/imagealbum using promise + check album id and album name
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETIMAGEALBUM_PROMISE_FETCH_EMPTYPATH_01', 0, async function (done) {
	const promise = media.getImageAlbums(EMPTYPATH);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no image files in ' + EMPTYPATH.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_EMPTYPATH_01:PASS ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for imageAlbums2  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums2 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_EMPTYPATH_01:FAIL ');
			}
		}
	});
	await promise;
...
/* *
* @tc.number   : GETIMAGEALBUM_PROMISE_FETCH_NONEXISTANT_01
* @tc.name     :Get all Album details from /data/media/imagealbum using promise + check album id and album name
* @tc.desc     :Get all Album details from /data/media/imagealbum using promise + check album id and album name
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETIMAGEALBUM_PROMISE_FETCH_NONEXISTANT_01', 0, async function (done) {
	const promise = media.getImageAlbums(nonexistantpath);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no image files in ' + nonexistantpath.selections);
			expect(true).assertTrue();
			console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_NONEXISTANT_01:PASS ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for imageAlbums2  :' + albumName);
				...
				console.info('MLTFW: albumId for imageAlbums2 :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETIMAGEALBUM_PROMISE_FETCH_NONEXISTANT_01:FAIL ');
			}
		}
	});
	await promise;
...
it(' GETVIDEOALBUM_PROMISE_WITH_FETCH_01', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in ' + videoalbumpath.selections);
			expect().assertFail();
			console.info('MLTFW:  GETVIDEOALBUM_PROMISE_WITH_FETCH_01:FATL ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for videoalbum  :' + albumName);
				albumId = data[i].albumId;
				console.info('MLTFW: albumId for videoalbum :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETVIDEOALBUM_PROMISE_WITH_FETCH_01:PASS ');
			}
		}
	});
	await promise;
...
it(' GETVIDEOALBUM_PROMISE_WITHOUT_FETCH_01', 0, async function (done) {
	...
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in ' + 'data/media');
			expect().assertFail();
			console.info('MLTFW:  GETVIDEOALBUM_PROMISE_WITHOUT_FETCH_01:FAIL ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for videoalbum  :' + albumName);
				...
				console.info('MLTFW: albumId for videoalbum :' + albumId);
				expect(true).assertTrue();
				console.info('MLTFW:  GETVIDEOALBUM_PROMISE_WITHOUT_FETCH_01:PASS ');
			}
		}
	});
	await promise;
...
/* *
* @tc.number   : GETVIDEOALBUM_PROMISE_FETCH_EMPTYPATH_01
* @tc.name     :Get all Album details from /data/media/videoalbum using promise + check album id and album name
* @tc.desc     :Get all Album details from /data/media/videoalbum using promise + check album id and album name
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEOALBUM_PROMISE_FETCH_EMPTYPATH_01', 0, async function (done) {
	const promise = media.getVideoAlbums(EMPTYPATH);
	promise.then(function (data) {
		if (data == undefined) {
			console.info('MLTFW: There are no video files in ' + 'EMPTYPATH.selections');
			expect(true).assertTrue();
			console.info('MLTFW:  GETVIDEOALBUM_PROMISE_FETCH_EMPTYPATH_01:PASS ');
		} else if (data != undefined) {
			for (i = 0; i < data.length; i++) {
				albumName = data[i].albumName;
				console.info('MLTFW: albumName for videoalbum  :' + albumName);
				...
				console.info('MLTFW: albumId for videoalbum :' + albumId);
				expect().assertFail();
				console.info('MLTFW:  GETVIDEOALBUM_PROMISE_FETCH_EMPTYPATH_01:FAIL ');
			}
		}
	});
	await promise;
...
/* *
* @tc.number   : GETVIDEOALBUM_PROMISE_FETCH_NONEXISTANT_01
* @tc.name     :Get all Album details from /data/media/videoalbum using promise + check album id and album name
* @tc.desc     :Get all Album details from /data/media/videoalbum using promise + check album id and album name
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' GETVIDEOALBUM_PROMISE_FETCH_NONEXISTANT_01', 0, async function (done) {
	const promise = media.getVideoAlbums(nonexistantpath);
		promise.then(function (data) {
			if (data == undefined) {
				console.info('MLTFW: There are no video files in ' + 'nonexistantpath.selections');
				expect(true).assertTrue();
				console.info('MLTFW:  GETVIDEOALBUM_PROMISE_FETCH_NONEXISTANT_01:PASS ');
			} else if (data != undefined) {
				for (i = 0; i < data.length; i++) {
					albumName = data[i].albumName;
					console.info('MLTFW: albumName for videoalbum  :' + albumName);
					...
					console.info('MLTFW: albumId for videoalbum :' + albumId);
					expect().assertFail();
					console.info('MLTFW:  GETVIDEOALBUM_PROMISE_FETCH_NONEXISTANT_01:FAIL ');
				}
			}
		});
		await promise;
...
it(' CREATE_ASYNC_AUDIOFILE_mp3_01', 0, async function (done) {
	media.createAudioAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					console.info('MLTFW: startCreate returns true');
					value.albumName = createaudioasyncmp3path.selections;
					value.name = 'newaudiofromasync.mp3';
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_mp3_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_mp3_01:FAIL');
						}
					});
				console.info('MLTFW: End of createAudioAsset 1. Now waiting for result');
				} else {
					console.info('MLTFW: startCreate 1 returns false');
				}
			});
			done();
		}
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_aac_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_aac_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 1. Now waiting for result');
				} else {
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_flac_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_flac_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 1. Now waiting for result');
				} else {
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_ogg_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_ogg_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 1. Now waiting for result');
				} else {
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_wav_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_wav_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 1. Now waiting for result');
				} else {
...
/* *
* @tc.number    :CREATE_ASYNC_AUDIOFILE_WAV_NO_NAME_01
* @tc.name     :Create an audio file in the device as per the album value  [ASYNC]
* @tc.desc     :Create an audio file in the device as per the album value [/data/media/onelevel/createaudio]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_ASYNC_AUDIOFILE_WAV_NO_NAME_01', 0, async function (done) {
	media.createAudioAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							...
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_NO_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_NO_NAME_01:FAIL');
						}
						done();
					});
					done();
...
/* *
* @tc.number    :CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_01
* @tc.name     :Create an audio file in the device as per the album value  [ASYNC]
* @tc.desc     :Create an audio file in the device as per the album value [/data/media/onelevel/createaudio]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_01', 0, async function (done) {
	media.createAudioAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_01:FAIL');
						}
						done();
					});
					done();
...
/* *
* @tc.number    :CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_02
* @tc.name     :Create an audio file in the device as per the album value  [ASYNC]
* @tc.desc     :Create an audio file in the device as per the album value [/data/media/onelevel/createaudio]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_02', 0, async function (done) {
	media.createAudioAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_02:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_WAV_INCORRECT_NAME_02:FAIL');
						}
						done();
					});
					done();
...
/* *
* @tc.number    :CREATE_ASYNC_AUDIOFILE_WAV_INVALIDCHARACTERS_NAME_01
* @tc.name     :Create an audio file in the device as per the album value  [ASYNC]
* @tc.desc     :Create an audio file in the device as per the album value [/data/media/onelevel/createaudio]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_ASYNC_AUDIOFILE_WAV_INVALIDCHARACTERS_NAME_01', 0, async function (done) {
	media.createAudioAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_INVALIDCHARACTERS_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_AUDIOFILE_INVALIDCHARACTERS_NAME_01:FAIL');
						}
						done();
					});
					done();
	...
	promise.then(function (value) {
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					console.info('MLTFW: startCreateAudioPromise returns true');
					value.albumName = createaudiopromiseaacpath.selections;
					console.info('MLTFW: startCreateAudioPromise true' + createaudiopromiseaacpath);
					value.name = 'newaudiofrompromise.aac'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_AUDIOaacFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOaacFILE_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
					console.info('MLTFW: startCreate 3 returns false');
				}
			});
		}
	});
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateAudioPromise true' + createaudiopromiseflacpath);
					value.name = 'newaudiofrompromise.flac'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_AUDIOflacFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOflacFILE_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateAudioPromise true' + createaudiopromisemp3path);
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_AUDIOMP3FILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOMP3FILE_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
	...
	promise.then(function (value) {
		...
		value.startCreate().then(function (value1) {
			if (value1 == true) {
				...
				console.info('MLTFW: startCreateAudioPromise returns true' + createaudiopromisewavpath);
				value.name = 'newaudiofrompromise.wav'
				value.commitCreate().then(function (data) {
					if (data == true) {
						console.info('MLTFW: commitCreate with album name returns' + data);
						expect(true).assertTrue();
						console.info('MLTFW:CREATE_PROMISE_AUDIOwavFILE_01:PASS');
					} else {
						console.info('MLTFW: commitCreate with album name returns' + data);
						expect().assertFail();
						console.info('MLTFW:CREATE_PROMISE_AUDIOwavFILE_01:FAIL');
					}
				});
				console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
			} else {
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					console.info('MLTFW: startCreateAudioPromise returns true');
					value.albumName = createaudiopromiseWAVpath.selections;
					console.info('MLTFW: startCreateAudioPromise  true' + createaudiopromiseWAVpath);
					value.name = 'newaudiofrompromise.WAV'
						value.commitCreate().then(function (data) {
							if (data == true) {
								console.info('MLTFW: commitCreate with album name returns' + data);
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateAudioPromise true' + createaudiopromiseoggpath);
					value.name = 'newaudiofrompromise.ogg'
						value.commitCreate().then(function (data) {
							if (data == true) {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect(true).assertTrue();
								console.info('MLTFW:CREATE_PROMISE_AUDIOoggFILE_01:PASS');
							} else {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect().assertFail();
								console.info('MLTFW:CREATE_PROMISE_AUDIOoggFILE_01:FAIL');
							}
						});
						console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
...
/* *
* @tc.number    :CREATE_PROMISE_AUDIOFILE_NO_ALBUM_NAME_01
* @tc.name     :Create an audio file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an audio file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_AUDIOFILE_NO_ALBUM_NAME_01', 0, async function (done) {
	const promise = media.createAudioAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
						...
						value.name = 'newaudiofrompromise.mp3'
							value.commitCreate().then(function (data) {
								if (data == true) {
									console.info('MLTFW: commitCreate with album name returns' + data);
									expect(true).assertTrue();
									console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_NO_ALBUM_NAME_01:PASS');
								} else {
									console.info('MLTFW: commitCreate with album name returns' + data);
									expect().assertFail();
									console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_NO_ALBUM_NAME_01:FAIL');
								}
							});
							console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
					} else {
...
/* *
* @tc.number    :CREATE_PROMISE_AUDIOFILE_NO_AUDIOFILE_NAME_01
* @tc.name     :Create an audio file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an audio file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_AUDIOFILE_NO_AUDIOFILE_NAME_01', 0, async function (done) {
	const promise = media.createAudioAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
...
/* *
* @tc.number    :CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_01
* @tc.name     :Create an audio file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an audio file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_01', 0, async function (done) {
	const promise = media.createAudioAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_01:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
...
/* *
* @tc.number    :CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_02
* @tc.name     :Create an audio file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an audio file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_02', 0, async function (done) {
	const promise = media.createAudioAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_02:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INCORRECT_AUDIOFILE_NAME_02:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
...
/* *
* @tc.number    :CREATE_PROMISE_AUDIOFILE_INVALIDCHARACTERS_AUDIOFILE_NAME_02
* @tc.name     :Create an audio file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an audio file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_AUDIOFILE_INVALIDCHARACTERS_AUDIOFILE_NAME_02', 0, async function (done) {
	const promise = media.createAudioAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateAudio returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INVALIDCHARACTERS_AUDIOFILE_NAME_02:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_AUDIOFILE_INVALIDCHARACTERS_AUDIOFILE_NAME_02:FAIL');
						}
					});
					console.info('MLTFW: End of createAudioAsset 3. Now waiting for result');
				} else {
...
it(' CREATE_ASYNC_IMAGEFILE_bmp_01', 0, async function (done) {
	media.createImageAsset((error, value) => {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					console.info('MLTFW: startCreate returns true');
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_bmp_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_bmp_01:FAIL');
						}
					});
					console.info('MLTFW: End of createImageAsset 1. Now waiting for result');
				} else {
					console.info('MLTFW: startCreate 1 returns false');
				}
			});
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_jpg_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_jpg_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_png_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_png_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_gif_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_gif_01:FAIL');
						}
						done();
					});
					done();
					...
					if (value1 == true) {
						...
						value.commitCreate((error, data) => {
							if (data == true) {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect(true).assertTrue();
								console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_raw_01:PASS');
							} else {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect().assertFail();
								console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_raw_01:FAIL');
							}
							done();
						});
						done();
				...
				value.name = 'newimagefromasync.heif';
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_heif_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_heif_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_webp_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_webp_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_svg_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_svg_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_NO_IMGAE_FILE_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_NO_IMGAE_FILE_NAME_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INCORRECT_FILE_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INCORRECT_FILE_NAME_01:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INCORRECT_NAME_02:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INCORRECT_NAME_02:FAIL');
						}
						done();
					});
					done();
				...
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INVALID_CHARACTERS_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_IMAGEFILE_INVALID_CHARACTERS_NAME_01:FAIL');
						}
						done();
					});
					done();
	...
	const promise = media.createImageAsset();
		promise.then(function (value) {
			if (value != undefined) {
				...
				value.startCreate().then(function (value1) {
					if (value1 == true) {
						console.info('MLTFW: startCreateImagePromise returns true');
						value.albumName = createimagepromisebmppath.selections;
						console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisebmppath);
						value.name = 'newimagefrompromise.bmp'
						value.commitCreate().then(function (data) {
							if (data == true) {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect(true).assertTrue();
								console.info('MLTFW:CREATE_PROMISE_IMAGEbmpFILE_01:PASS');
							} else {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect().assertFail();
								console.info('MLTFW:CREATE_PROMISE_IMAGEbmpFILE_01:FAIL');
							}
							done();
						});
						console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
					} else {
						console.info('MLTFW: startCreate 3 returns false');
					}
				});
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromiseBPMpath);
					value.name = 'newimagefrompromise.BMP'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisejpgpath);
					value.name = 'newimagefrompromise.jpg'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEjpgFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEjpgFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisepngpath);
					value.name = 'newimagefrompromise.png'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEpngFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEpngFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisegifpath);
					value.name = 'newimagefrompromise.gif'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEgifFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEgifFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromiserawpath);
					value.name = 'newimagefrompromise.raw'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGErawFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGErawFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
			...
			if (value != undefined) {
				...
				value.startCreate().then(function (value1) {
					if (value1 == true) {
						...
						console.info('MLTFW: startCreateImagePromise returns true' + createimagepromiseheifpath);
						value.name = 'newimagefrompromise.heif'
						value.commitCreate().then(function (data) {
							if (data == true) {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect(true).assertTrue();
								console.info('MLTFW:CREATE_PROMISE_IMAGEheifFILE_01:PASS');
							} else {
								console.info('MLTFW: commitCreate with album name returns' + data);
								expect().assertFail();
								console.info('MLTFW:CREATE_PROMISE_IMAGEheifFILE_01:FAIL');
							}
							done();
						});
						console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisewebppath);
					value.name = 'newimagefrompromise.webp'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEwebpFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEwebpFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
		...
		if (value != undefined) {
			...
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					console.info('MLTFW: startCreateImagePromise returns true' + createimagepromisesvgpath);
					value.name = 'newimagefrompromise.svg'
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEsvgFILE_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEsvgFILE_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
/* *
* @tc.number    :CREATE_PROMISE_IMAGEFILE_NO_ALBUM_NAME_01
* @tc.name     :Create an image file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an image file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_IMAGEFILE_NO_ALBUM_NAME_01', 0, async function (done) {
	const promise = media.createImageAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_NO_ALBUM_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_NO_ALBUM_NAME_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
/* *
* @tc.number    :CREATE_PROMISE_IMAGEFILE_NO_IMAGE_NAME_01
* @tc.name     :Create an image file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an image file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_IMAGEFILE_NO_IMAGE_NAME_01', 0, async function (done) {
	const promise = media.createImageAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_NO_IMAGE_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_NO_IMAGE_NAME_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
/* *
* @tc.number    :CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_01
* @tc.name     :Create an image file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an image file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_01', 0, async function (done) {
	const promise = media.createImageAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
			value.startCreate().then(function (value1) {
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						...
						console.info('MLTFW: commitCreate with album name returns' + data);
						expect(false).assertFalse();
						console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_01:PASS');
						} else {
						console.info('MLTFW: commitCreate with album name returns' + data);
						expect().assertFail();
						console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
/* *
* @tc.number    :CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_02
* @tc.name     :Create an image file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an image file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_02', 0, async function (done) {
	const promise = media.createImageAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_02:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INCORRECT_IMAGE_NAME_02:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
/* *
* @tc.number    :CREATE_PROMISE_IMAGEFILE_INVALIDCHARACTERS_IMAGE_NAME_01
* @tc.name     :Create an image file in the device with empty folder name [PROMISE]
* @tc.desc     :Create an image file in the device as per the album value [PROMISE]
* @tc.size     :MEDIUM
* @tc.type     :Function
* @tc.level    :Level 0
*/
it(' CREATE_PROMISE_IMAGEFILE_INVALIDCHARACTERS_IMAGE_NAME_01', 0, async function (done) {
	const promise = media.createImageAsset();
	promise.then(function (value) {
		if (value != undefined) {
			console.info('MLTFW: CreateImage returns successful data');
				...
				if (value1 == true) {
					...
					value.commitCreate().then(function (data) {
						if (data == false) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(false).assertFalse();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INVALIDCHARACTERS_IMAGE_NAME_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_PROMISE_IMAGEFILE_INVALIDCHARACTERS_IMAGE_NAME_01:FAIL');
						}
						done();
					});
					console.info('MLTFW: End of createImageAsset 3. Now waiting for result');
...
it(' CREATE_ASYNC_VIDEOFILE_3gp_01', 0, async function (done) {
	media.createVideoAsset((error, value) => {
		if (value == undefined) {
			console.info('MLTFW: createVideoAsset returned ' + value);
			console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_3gp_01:FAIL');
		} else if (value != undefined) {
			console.info('MLTFW: createVideoAsset returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					console.info('MLTFW: startCreate returns true');
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_3gp_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_3gp_01:FAIL');
		...
		console.info('MLTFW: End of createVideoAsset 1. Now waiting for result');
	});
})
/* *
* @tc.number    :CREATE_ASYNC_VIDEOFILE_3GP_01
		...
		if (value == undefined) {
			...
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					console.info('MMLTFW: startCreate returns false');
				}
				done();
			});
			done();
...
it(' CREATE_ASYNC_VIDEOFILE_mov_01', 0, async function (done) {
	media.createVideoAsset((error, value) => {
		if (value == undefined) {
			console.info('MLTFW: createVideoAsset returned ' + value);
			console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mov_01:FAIL');
		} else if (value != undefined) {
			console.info('MLTFW: createVideoAsset returns successful data');
			value.startCreate((error, value1) => {
				if (value1 == true) {
					...
					value.commitCreate((error, data) => {
						if (data == true) {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect(true).assertTrue();
							console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mov_01:PASS');
						} else {
							console.info('MLTFW: commitCreate with album name returns' + data);
							expect().assertFail();
							console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mov_01:FAIL');
...
it(' CREATE_ASYNC_VIDEOFILE_mpg_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mpg_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mpg_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mpg_01:FAIL');
...
it(' CREATE_ASYNC_VIDEOFILE_mp4_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mp4_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mp4_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mp4_01:FAIL');
...
it(' CREATE_ASYNC_VIDEOFILE_webm_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_webm_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_webm_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_webm_01:FAIL');
...
it(' CREATE_ASYNC_VIDEOFILE_mkv_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mkv_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mkv_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_mkv_01:FAIL');
...
it(' CREATE_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01:FAIL');
...
/* *
        * @tc.number    :CREATE_ASYNC_VIDEOFILE_NO_FILE_NAME_01 createaudiononamepath.selections
        * @tc.name     :Create an video file in the device as per the album value   [ASYNC]
        * @tc.desc     :Create an video file in the device as per the album value  
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
    */
it(' CREATE_ASYNC_VIDEOFILE_NO_FILE_NAME_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_FILE_NAME_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_FILE_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_NO_FILE_NAME_01:FAIL');
...
/* *
        * @tc.number    :CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_01
        * @tc.name     :Create an video file in the device as per the album value   [ASYNC]
        * @tc.desc     :Create an video file in the device as per the album value  
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
    */
it(' CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_01:FAIL');
...
/* *
        * @tc.number    :CREATE_ASYNC_VIDEOFILE_INVALID_CHARACTERS_FILE_NAME_01 ?:\"*|/\\<>".mp4
        * @tc.name     :Create an video file in the device as per the album value   [ASYNC]
        * @tc.desc     :Create an video file in the device as per the album value  
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
    */
it(' CREATE_ASYNC_VIDEOFILE_INVALID_CHARACTERS_FILE_NAME_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value == undefined) {
            console.info('MLTFW: createVideoAsset returned ' + value);
            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INVALID_CHARACTERS_FILE_NAME_01:FAIL');
        }
        else if (value != undefined) {
            console.info('MLTFW: createVideoAsset returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    ...
                    value.commitCreate((error, data) => {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INVALID_CHARACTERS_FILE_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INVALID_CHARACTERS_FILE_NAME_01:FAIL');
        ...
        if (value != undefined) {
            ...
            value.startCreate().then(function (value1) {
                if (value1 == true) {
                    ...
                    console.info('MLTFW: startCreateImagePromise returns true' + createvideopromise3gppath);
                    value.name = 'newvideofrompromise.3gp';
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEO3gpFILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEO3gpFILE_01:FAIL');
                        }
                        done();
                    });
                }
            });
            console.info('MLTFW: End of createVideoAsset 3. Now waiting for result');
        } else if (value == undefined) {
            expect().assertFail();
            console.info('MLTFW: startCreate 3 returns false');
            console.info('MLTFW:CREATE_PROMISE_VIDEO3gpFILE_01:FAIL');
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmovFILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmovFILE_01:FAIL');
                        }
                        done();
                    });
                }
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmpgFILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmpgFILE_01:FAIL');
                        }
                        done();
                    });
                }
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmp4FILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmp4FILE_01:FAIL');
                        }
                        done();
                    });
                }
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOwebmFILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOwebmFILE_01:FAIL');
                        }
                        done();
                    });
                }
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmkvFILE_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOmkvFILE_01:FAIL');
                        }
                        done();
                    });
                }
...
/* *
        * @tc.number    :CREATE_PROMISE_VIDEOFILE_NO_ALBUM_NAME_01
        * @tc.name     :Create an Video file in the device with empty folder name [PROMISE]
        * @tc.desc     :Create an Video file in the device as per the album value [PROMISE]
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
   */
it(' CREATE_PROMISE_VIDEOFILE_NO_ALBUM_NAME_01', 0, async function (done) {
    const promise = media.createVideoAsset();
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW: CreateImage returns successful data');
            value.startCreate().then(function (value1) {
                if (value1 == true) {
                    console.info('MLTFW: startCreateImagePromise returns true');
                    value.albumName = '';
                    console.info('MLTFW: startCreateImagePromise returns true' + value1);
                    value.name = 'newvideofrompromise.3GP';
                    value.commitCreate().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_NO_ALBUM_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_NO_ALBUM_NAME_01:FAIL');
                        }
                        done();
                    });
                }
...
/* *
        * @tc.number    :CREATE_PROMISE_VIDEOFILE_NO_VIDEO_FILE_NAME_01
        * @tc.name     :Create an Video file in the device with empty folder name [PROMISE]
        * @tc.desc     :Create an Video file in the device as per the album value [PROMISE]
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
   */
it(' CREATE_PROMISE_VIDEOFILE_NO_VIDEO_FILE_NAME_01', 0, async function (done) {
    const promise = media.createVideoAsset();
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW: CreateImage returns successful data');
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_NO_VIDEO_FILE_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_NO_VIDEO_FILE_NAME_01:FAIL');
                        }
                        done();
                    });
                }
...
/* *
        * @tc.number    :CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_01
        * @tc.name     :Create an Video file in the device with empty folder name [PROMISE]
        * @tc.desc     :Create an Video file in the device as per the album value [PROMISE]
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
   */
it(' CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_01', 0, async function (done) {
    const promise = media.createVideoAsset();
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW: CreateImage returns successful data');
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_01:FAIL');
                        }
                        done();
                    });
                }
...
/* *
        * @tc.number    :CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_02
        * @tc.name     :Create an Video file in the device with empty folder name [PROMISE]
        * @tc.desc     :Create an Video file in the device as per the album value [PROMISE]
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
   */
it(' CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_02', 0, async function (done) {
    const promise = media.createVideoAsset();
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW: CreateImage returns successful data');
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_02:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_VIDEO_FILE_NAME_02:FAIL');
                        }
                        done();
                    });
                }
...
/* *
        * @tc.number    :CREATE_PROMISE_VIDEOFILE_INVALID_CHARACTERS_VIDEO_FILE_NAME_01
        * @tc.name     :Create an Video file in the device with empty folder name [PROMISE]
        * @tc.desc     :Create an Video file in the device as per the album value [PROMISE]
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
   */
it(' CREATE_PROMISE_VIDEOFILE_INVALID_CHARACTERS_VIDEO_FILE_NAME_01', 0, async function (done) {
    const promise = media.createVideoAsset();
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW: CreateImage returns successful data');
                ...
                if (value1 == true) {
                    ...
                    value.commitCreate().then(function (data) {
                        if (data == false) {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect(false).assertFalse();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_CHARACTERS_01:PASS');
                        } else {
                            console.info('MLTFW: commitCreate with album name returns' + data);
                            expect().assertFail();
                            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_CHARACTERS_01:FAIL');
                        }
                        done();
                    });
                }
            ...
            expect().assertFail();
            console.info('MLTFW: startCreate 3 returns false');
            console.info('MLTFW:CREATE_PROMISE_VIDEOFILE_INVALID_CHARACTERS_VIDEO_FILE_NAME_01:FAIL');
        }
    });
    await promise;
    done();
...
it(' CREATE_ASYNC_VIDEOASSET_01', 0, async function (done) {
    media.createVideoAsset((error, value) => {
        if (value != undefined) {
            console.info('MLTFW: CreateVideoAssets returns successful data');
            expect(true).assertTrue();
            console.info('MLTFW:CREATE_ASYNC_VIDEOASSET_01:PASS');
        } else {
            console.info(value.name + 'file is not created');
            expect().assertFail();
            console.info('MLTFW:CREATE_ASYNC_VIDEOASSET_01:FAIL');
        }
        done();
    });
})
    ...
    media.createVideoAsset((error, value) => {
        if (value != undefined) {
            ...
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_02:PASS');
                } else {
                    console.info(value.name + 'file is not created');
                    expect().assertFail();
                    console.info('MLTFW:CREATE_ASYNC_VIDEOFILE_INCORRECT_FILE_NAME_02:FAIL');
                }
                done();
            });
            done();
...
it(' CREATE_ASYNC_AUDIOASSET_01', 0, async function (done) {
    media.createAudioAsset((error, value)=> {
        if (value != undefined){
            console.info('MLTFW: CreateAudioAsset returns successful data');
            expect(true).assertTrue();
        console.info('MLTFW:CREATE_ASYNC_AUDIOASSET_01:PASS');
        }else{
            console.info(value.name + 'file is not created');
            expect().assertFail();
            console.info('MLTFW:CREATE_ASYNC_AUDIOASSET_01:FAIL');
        }
        done();
    });
    done();
    ...
    media.createAudioAsset((error, value)=> {
        ...
        console.info('MLTFW: CreateAudioAsset returns successful data');
            value.startCreate((error, value1)=>{
                if (value1 == true) {
                    expect(true).assertTrue();
                console.info('MLTFW:CREATE_START_AUDIO_ASSET_01:PASS');
                } else {
                    console.info(value.name + 'file is not created');
                    expect().assertFail();
                console.info('MLTFW:CREATE_START_AUDIO_ASSET_01:FAIL');
                }
                done();
            });
            done();
...
it(' CREATE_ASYNC_IMAGEASSET_01', 0, async function (done) {
    media.createImageAsset((error, value)=> {
        if (value != undefined){
            console.info('MLTFW: CreateImageAsset returns successful data');
            expect(true).assertTrue();
        console.info('MLTFW:CREATE_ASYNC_IMAGEASSET_01:PASS');
        }else{
            console.info(value.name + 'file is not created');
            expect().assertFail();
        console.info('MLTFW:CREATE_ASYNC_IMAGEASSET_01:FAIL');
        }
        done();
    });
    done();
    ...
    media.createImageAsset((error, value)=> {
        ...
        console.info('MLTFW: CreateImageAsset returns successful data');
            value.startCreate((error, value1)=>{
                if (value1 == true) {
                    expect(true).assertTrue();
                console.info('MLTFW:CREATE_START_IMAGE_ASSET_01:PASS');
                } else {
                    console.info(value.name + 'file is not created');
                    expect().assertFail();
                console.info('MLTFW:CREATE_START_IMAGE_ASSET_01:FAIL');
                }
                done();
            });
            done();
...
/* *
        * @tc.number    :CREATE_ALBUM_SYNC_EXISTING_01
        ...
        * @tc.level    :Level 0
    */
it(' CREATE_ALBUM_ASYNC_EXISTING_01', 0, async function (done) {
    media.createAlbum((error, value)=> {
        if (value != undefined){
            value.albumName = 'new_album_async';
        console.info('MLTFW: Folder new_album has to be created under /data/media');
            value.commitCreate((error, value1)=>{
                if (value1 == true){
                console.info('MLTFW: commitCreate1 returns ' + value1);
                    expect(true).assertTrue();
                console.info('MLTFW: New folder is created as ' + value.albumName + ' in /data/media');
                console.info('MLTFW:CREATE_ALBUM_SYNC_EXISTING_01:PASS');
                } else {
                    expect().assertFail();
                console.info('MLTFW:CREATE_ALBUM_SYNC_EXISTING_01:FAIL');
                }
                done();
            });
            done();
...
/* *
        * @tc.number    :CREATE_ALBUM_PROMISE_EXISTING_02
        * @tc.name     :Create an album in the device
        * @tc.desc     :Create an album in the device as per the album value
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
    */
it(' CREATE_ALBUM_PROMISE_EXISTING_02', 0, async function (done) {
    const promise = media.createAlbum();
    promise.then(function(value){
        if (value != undefined){
            value.albumName = 'new_album_promise';
        console.info('MLTFW: Folder new_album1 has to be created under /data/media/');
            value.commitCreate().then(function(value1){
                if (value1 == true){
                console.info('MLTFW: commitCreate 2 returns ' + value1);
                    expect(true).assertTrue();
                console.info('MLTFW:is created as ' + value.albumName + ' in /data/media/new_album1');
                console.info('MLTFW:CREATE_ALBUM_PROMISE_EXISTING_02:PASS');
                } else {
                    expect().assertFail();
                console.info('MLTFW:CREATE_ALBUM_PROMISE_EXISTING_02 :FAIL');
                }
            });
        }
    });
    ...
    promise.then(function(value){
        ...
        console.info('MLTFW: Folder new_album1 has to be created under /data/media/');
            value.commitCreate().then(function(value1){
                ...
                console.info('MLTFW: commitCreate 2 returns ' + value1);
                    expect(true).assertTrue();
                console.info('MLTFW: New folder is not created as ' + value.albumName + ' in /data/media');
                console.info('MLTFW:CREATE_ALBUM_PROMISE_OUT_NAME_01:PASS');
                } else {
                    expect().assertFail();
                console.info('MLTFW:CREATE_ALBUM_PROMISE_OUT_NAME_01 :FAIL');
                }
            });
        }
    });
...
/* *
        * @tc.number    :CREATE_ALBUM_PROMISE_INVALID_CHARACTERS_NAME_01
        * @tc.name     :Create an album in the device
        * @tc.desc     :Create an album in the device as per the album value
        * @tc.size     :MEDIUM
        * @tc.type     :Function
        * @tc.level    :Level 0
    */
it(' CREATE_ALBUM_PROMISE_INVALID_CHARACTERS_NAME_01', 0, async function (done) {
    const promise = media.createAlbum();
    promise.then(function(value){
        if (value != undefined){
            value.albumName = '?:*|/<>"';
        console.info('MLTFW: Folder new_album1 has to be created under /data/media/');
            value.commitCreate().then(function(value1){
                if (value1 == false){
                console.info('MLTFW: commitCreate ALBUM NAME INVALID_CHARACTERS 2 returns ' + value1);
                    expect(true).assertTrue();
                console.info('MLTFW: New folder is not created as ' + value.albumName + ' in /data/media');
                console.info('MLTFW:CREATE_ALBUM_PROMISE_INVALID_CHARACTERS_NAME_01:PASS');
                } else {
                    expect().assertFail();
                console.info('MLTFW:CREATE_ALBUM_PROMISE_INVALID_CHARACTERS_NAME_01 :FAIL');
                }
            });
        }
    });
...
it(' START_COMMIT_ASYNC_MODIFY_AUDIOFILE_01', 0, async function (done) {
    media.getAudioAssets(modifyaudioasyncpath, (error, value) => {
        if (value != undefined) {
            ...
            console.info('MLTFW:file to be modified is: ' + fileAsset);
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startModify 1 returns true');
                    value[0].name = 'newaudioasync_modify.mp3'
                    value[0].commitModify((error, data) => {
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_AUDIOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_AUDIOFILE_01:FAIL');
                        }
                        done();
                    });
                    done();
                    console.info('MLTFW:End of modify audio 1. Now waiting for result');
                } else {
                    console.info('MLTFW:startModify 1 returns false');
                }
                done();
            });
            done();
            ...
            value[1].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[1].commitModify((error, data) => {
                        console.info('MLTFW:commitModify 1 returns' + data);
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_AUDIOFILE_01:PASS');
                        } else {
    ...
    media.getAudioAssets(modifyaudioasyncpath, (error, value) => {
        if (value != undefined) {
            ...
            value[2].startModify((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startModify 2 returns true');
                    value[2].name = '.mp3'
                    value[2].commitModify((error, data) => {
                        console.info('MLTFW:commitModify 2 returns' + data);
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_02:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_02:FAIL');
                        }
                        done();
                    });
                    done();
                    console.info('MLTFW:End of modify audio 2. Now waiting for result');
                } else {
                    console.info('MLTFW:startModify 2 returns false');
                }
                done();
            });
            done();
            ...
            value[3].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[3].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_03:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_03:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[4].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[4].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_04:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INCORRECT_AUDIOFILE_04:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_IMAGEFILE_01:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[1].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[1].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_01:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[2].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[2].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_02:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_02:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[3].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_03:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_03:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[4].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_04:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_IMAGEFILE_04:FAIL');
                        }
                        done();
                    });
                    done();
...
it(' MODIFY_START_PROMISE_COMMIT_PROMISE_IMAGEFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:file to be modified is: ' + value[0].name);
            value[0].startModify().then(function (value1) {
                if (value1 == true) {
                    console.info('MLTFW:startModify returns true');
                    value[0].name = 'newimagepromise_modify.png'
                    value[0].commitModify().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW:commitModify returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:' + '  MODIFY_START_PROMISE_COMMIT_PROMISE_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW:' + '  MODIFY_START_PROMISE_COMMIT_PROMISE_IMAGEFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of modify image. Now waiting for result');
                } else {
                    console.info('MLTFW:startModify image returns false');
                }
            });
        }
    });
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_VIDEOFILE_01:FAIL');
                        }
                        done();
                    });
                    done();
                    console.info('MLTFW:End of modify video 1. Now waiting for result');
                } else {
                    console.info('MLTFW:startModify 1 returns false');
                }
                done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_01:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_02:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_02:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_03:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_03:FAIL');
                        }
                        done();
                    });
                    done();
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].commitModify((error, data) => {
                        ...
                        if (data == false) {
                            expect(false).assertFalse();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_04:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: START_COMMIT_ASYNC_MODIFY_INVALID_VIDEOFILE_04:FAIL');
                        }
                        done();
                    });
                    done();
                ...
                if (value1 == true) {
                    ...
                    value[0].commitModify().then(function (data) {
                        if (data == true) {
                            console.info('MLTFW:commitModify returns' + data);
                            expect(true).assertTrue();
                            console.info('MLTFW:' + '  MODIFY_START_PROMISE_COMMIT_PROMISE_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW:' + '  MODIFY_START_PROMISE_COMMIT_PROMISE_VIDEOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of modify image. Now waiting for result');
                } else {
...
it(' COPY_ASYNC_AUDIOFILE_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_AUDIOFILE_01');
    media.getAudioAssets(MP3, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createAudioAsset((error, value) => {
                if (value != undefined) {
                    console.info('MLTFW: createAudioAsset returned an value' + value);
                    value.startCreate((error, value2) => {
                        if (value2 == true) {
                            console.info('MLTFW: startCreate returned an value' + value2);
                            value.albumName = 'onelevel/copyaudio/async/TOMP3';
                            console.info('MLTFW:  Album is yet to create :' + value.albumName);
                            value1[0].commitCopy(value, (error, data) => {
                                console.info('MLTFW: commitCopy returns ' + data);
                                console.info('MLTFW:  Album is created :' + value.albumName);
                                if (data == true) {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    expect(true).assertTrue();
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_AUDIOFILE_NO_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_AUDIOFILE_NO_ALBUM_NAME_01');
    media.getAudioAssets(MP3, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createAudioAsset((error, value) => {
                        ...
                        if (value2 == true) {
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == false) {
                                    ...
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    expect(false).assertFalse();
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_NO_ALBUM_NAME_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_NO_ALBUM_NAME_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_AUDIOFILE_INVALID_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_AUDIOFILE_INVALID_ALBUM_NAME_01');
    media.getAudioAssets(MP3, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createAudioAsset((error, value) => {
                        ...
                        if (value2 == true) {
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == false) {
                                    ...
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_INVALID_ALBUM_NAME_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_AUDIOFILE_INVALID_ALBUM_NAME_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_PROMISE_AUDIOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value1) {
        if (value1 != undefined) {
            console.info('MLTFW: File to be copied for case 1 is :' + value1[0].name);
            media.createAudioAsset((error, value) => {
                if (value != undefined) {
                    console.info('MLTFW: CreateAudioAsset returned successfully');
                    value.startCreate((error, value2) => {
                        if (value2 == true) {
                            console.info('MLTFW: startCreate returns true');
                            value.albumName = 'onelevel/copyaudio/promise/TOMP3';
                            value1[0].commitCopy(value).then(function (data) {
                                console.info('MLTFW: commitCopy case 1 returns :' + data);
                                if (data == true) {
                                    expect(true).assertTrue();
                                    console.info('MLTFW: ' +
                                        ' COPY_PROMISE_AUDIOFILE_01:PASS');
                                } else {
                                    console.info('MLTFW: File' + value1[0].name +
...
it(' COPY_ASYNC_IMAGEFILE_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_IMAGEFILE_01');
    media.getImageAssets(PNG, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createImageAsset((error, value) => {
                if (value != undefined) {
                    console.info('MLTFW: createImageAsset returned an value' + value);
                    value.startCreate((error, value2) => {
                        if (value2 == true) {
                            console.info('MLTFW: startCreate returned an value' + value2);
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == true) {
                                    expect(true).assertTrue();
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to PNG');
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to PNG');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01');
    media.getImageAssets(PNG, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createImageAsset((error, value) => {
                        ...
                        if (value2 == true) {
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == false) {
                                    ...
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_NO_ALBUM_NAME_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_IMAGEFILE_INVALID_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_IMAGEFILE_INVALID_ALBUM_NAME_01');
                        ...
                        if (value2 == true) {
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == false) {
                                    ...
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    expect(false).assertFalse();
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_INVALID_ALBUM_NAME_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_IMAGEFILE_INVALID_ALBUM_NAME_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_PROMISE_IMAGEFILE_01', 0, async function (done) {
    ...
    promise.then(function (value1) {
        if (value1 != undefined) {
            ...
            media.createImageAsset((error, value) => {
                if (value != undefined) {
                    console.info('MLTFW: createImageAsset returned successfully');
                    value.startCreate((error, value2) => {
                        if (value2 == true) {
                            console.info('MLTFW: startCreate returns true');
...
it(' COPY_ASYNC_VIDEOFILE_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_VIDEOFILE_01');
    media.getVideoAssets(MP4, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createVideoAsset((error, value) => {
                if (value != undefined) {
                    console.info('MLTFW: createVideoAsset returned an value' + value);
                    value.startCreate((error, value2) => {
                        if (value2 == true) {
                            console.info('MLTFW: startCreate returned an value' + value2);
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == true) {
                                    ...
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to PNG');
                                    expect(true).assertTrue();
                                    console.info('MLTFW:  COPY_ASYNC_VIDEOFILE_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to PNG');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_VIDEOFILE_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01');
    media.getVideoAssets(MP4, (error, value1) => {
        if (value1 != undefined) {
            console.info('MLTFW:  2nd File to be copied is :' + value1[0].name);
            media.createVideoAsset((error, value) => {
                        ...
                        if (value2 == true) {
                            ...
                            value1[0].commitCopy(value, (error, data) => {
                                ...
                                if (data == false) {
                                    ...
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is copied to MP3');
                                    expect(false).assertFalse();
                                    console.info('MLTFW:  COPY_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01:PASS');
                                } else {
                                    console.info('MLTFW: commitCopy 2 returns ' + data);
                                    console.info('MLTFW: ' + 'File' + value1[0].name + ' is not copied to MP3');
                                    expect().assertFail();
                                    console.info('MLTFW:  COPY_ASYNC_VIDEOFILE_NO_ALBUM_NAME_01:FAIL');
                                }
                                done();
                            });
                            done();
...
it(' COPY_ASYNC_VIDEOFILE_INVALID_ALBUM_NAME_01', 0, async function (done) {
    console.info('MLTFW:  testing  COPY_ASYNC_VIDEOFILE_INVALID_ALBUM_NAME_01');
...
it(' DELETE_ASYNC_IMAGEFILE_01', 0, async function (done) {
    media.getImageAssets(deleteimageasyncpath, (error, value) => {
        if (value != undefined) {
            ...
            console.info('MLTFW: file selected is:' + 'data/media/' +
                deleteimageasyncpath.selections + '/' + fileAsset);
            value[0].commitDelete((error, value1) => {
                console.info('MLTFW: commitDelete 1 returns ' + value1);
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_IMAGEFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_IMAGEFILE_01:FAIL');
                }
                done();
            });
            done();
    ...
    media.getAudioAssets(deleteaudioasyncpath, (error, value) => {
        if (value != undefined) {
            ...
            value[0].commitDelete((error, value1) => {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_AUDIOFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_AUDIOFILE_01:FAIL');
                }
                done();
            });
            done();
    ...
    media.getVideoAssets(deletevideoasyncpath, (error, value) => {
        if (value != undefined) {
            ...
            value[0].commitDelete((error, value1) => {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_VIDEOFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW: ' + ' DELETE_ASYNC_VIDEOFILE_01:FAIL');
                }
                done();
            });
            done();
    ...
    promise.then(function (value) {
        ...
        if (value != undefined) {
            ...
            value[0].commitDelete().then(function (value1) {
                console.info('MLTFW:commitDelete 2 returns ' + value1);
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  DELETE_PROMISE_AUDIOFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  DELETE_PROMISE_AUDIOFILE_01:FAIL');
                }
            });
        }
    });
    ...
    promise.then(function (value) {
        ...
        if (value != undefined) {
            ...
            value[0].commitDelete().then(function (value1) {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  DELETE_PROMISE_IMAGEFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  DELETE_PROMISE_IMAGEFILE_01:FAIL');
                }
            });
        }
    });
    ...
    promise.then(function (value) {
        ...
        if (value != undefined) {
            ...
            value[0].commitDelete().then(function (value1) {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  DELETE_PROMISE_VIDEOFILE_01:PASS');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  DELETE_PROMISE_VIDEOFILE_01:FAIL');
                }
            });
        }
    });
...
it(' CANCEL_ASYNC_AUDIOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateAudio 2 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 2 returns true');
                    value.albumName = 'onelevel/createcancelaudioasync';
                    value.name = 'cancel_newaudio1.aac'
                    value.cancelCreate((error, data) => {
                        console.info('MLTFW:cancelCreate returns' + data);
                        console.info('MLTFW:Check if file 2 is cancelled or not:' + value);
                        expect(data).assertTrue();
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_ASYNC_AUDIOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_ASYNC_AUDIOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createAudioAsset 2. Now waiting for result');
                } else {
                    console.info('MLTFW:startCreate 2 returns false');
                }
            });
        }
    });
...
it(' CANCEL_ASYNC_IMAGEFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateImage 2 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 2 returns true');
                    ...
                    value.cancelCreate((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_ASYNC_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_ASYNC_IMAGEFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createImageAsset 2. Now waiting for result');
                } else {
                    console.info('MLTFW:startCreate 2 returns false');
                }
            });
...
it(' CANCEL_ASYNC_VIDEOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateVideo 2 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 2 returns true');
                    ...
                    value.cancelCreate((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_ASYNC_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_ASYNC_VIDEOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createImageAsset 2. Now waiting for result');
                } else {
...
it(' CANCEL_PROMISE_AUDIOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateAudio 1 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 1 returns true');
                    value.albumName = 'onelevel/CreateCancelAudioPromise';
                    value.name = 'cancel_newaudio.aac'
                    value.cancelCreate().then(function (data) {
                        console.info('MLTFW:cancelCreate returns' + data);
                        console.info('MLTFW:Check if file 1 is cancelled or not:' + value);
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_PROMISE_AUDIOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_PROMISE_AUDIOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createAudioAsset 1. Now waiting for result');
                } else {
...
it(' CANCEL_PROMISE_IMAGEFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateImage 1 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 1 returns true');
                    ...
                    value.cancelCreate().then(function (data) {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_PROMISE_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_PROMISE_IMAGEFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createImageAsset 1. Now waiting for result');
                } else {
...
it(' CANCEL_PROMISE_VIDEOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            console.info('MLTFW:CreateVideo 1 returns successful data');
            value.startCreate((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW:startCreate 1 returns true');
                    ...
                    value.cancelCreate().then(function (data) {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: CANCEL_PROMISE_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: CANCEL_PROMISE_VIDEOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW:End of createVideoAsset 1. Now waiting for result');
                } else {
...
it(' MODIFYCANCEL_ASYNC_AUDIOFILE_01', 0, async function (done) {
    ...
    promise.then(function (value) {
        if (value != undefined) {
            ...
            console.info('MLTFW: File name to be modified is:' + file_name);
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    console.info('MLTFW: startModify 1 returns true');
                    value[0].name = 'newaudio10_modify.mp3';
                    value[0].cancelModify((error, data) => {
                        console.info('MLTFW: cancelModify returns' + data);
                        console.info('MLTFW: File name after cancelModify is:' + value[0].name);
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_AUDIOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_AUDIOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel audio 1. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 1 returns false');
                }
            });
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].cancelModify((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_IMAGEFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel image 1. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 1 returns false');
                }
            });
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].cancelModify((error, data) => {
                        ...
                        if (data == true) {
                            expect(true).assertTrue();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW: MODIFYCANCEL_ASYNC_VIDEOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel video 1. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 1 returns false');
                }
            });
            ...
            value[0].startModify((error, value1) => {
                if (value1 == true) {
                    ...
                    value[0].cancelModify().then(function (data) {
                        console.info('MLTFW: cancelModify returns' + data);
                        if (data == true) {
                            console.info('MLTFW: File name is:' + value[0].name);
                            expect(true).assertTrue();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_AUDIOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_AUDIOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel audio 2. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 2 returns false');
                }
            });
                ...
                if (value1 == true) {
                    ...
                    value[0].cancelModify().then(function (data) {
                        ...
                        if (data == true) {
                            console.info('MLTFW: File name is:' + value[0].name);
                            expect(true).assertTrue();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_IMAGEFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_IMAGEFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel image 2. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 2 returns false');
                }
            });
                ...
                if (value1 == true) {
                    ...
                    value[0].cancelModify().then(function (data) {
                        ...
                        if (data == true) {
                            console.info('MLTFW: File name is:' + value[0].name);
                            expect(true).assertTrue();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_VIDEOFILE_01:PASS');
                        } else {
                            expect().assertFail();
                            console.info('MLTFW:  MODIFYCANCEL_PROMISE_VIDEOFILE_01:FAIL');
                        }
                    });
                    console.info('MLTFW: End of modify cancel video 2. Now waiting for result');
                } else {
                    console.info('MLTFW: startModify 2 returns false');
                }
            });
...
/* *
        * @tc.number   : MODIFYIMAGEALBUM_ASYNC_FETCH_01
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYIMAGEALBUM_ASYNC_FETCH_01', 0, function () {
    console.info('MLTFW: path for image is' + modifyimagealbumasyncpath.selections);
    const promise = media.getImageAlbums(modifyimagealbumasyncpath);
    promise.then(function (data) {
        if ((data == undefined) || (data != undefined)) {
            console.info('MLTFW: There are no image files in ' + modifyimagealbumasyncpath.selections);
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_FETCH_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_FETCH_01:FAIL ');
                }
            });
        }
    });
...
/* *
        * @tc.number   : MODIFYIMAGEALBUM_ASYNC_NONAME_01
        * @tc.name     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYIMAGEALBUM_ASYNC_NONAME_01', 0, function () {
    console.info('MLTFW: path for image is' + modifyimagealbumasyncpath.selections);
    const promise = media.getImageAlbums(modifyimagealbumasyncpath);
    promise.then(function (data) {
        if ((data == undefined) || (data != undefined)) {
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == false) {
                    expect(false).assertFalse();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_NONAME_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_NONAME_01:FAIL ');
                }
            });
        }
    });
...
/* *
        * @tc.number   : MODIFYIMAGEALBUM_ASYNC_INVALID_CHARACTERS_01
        * @tc.name     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYIMAGEALBUM_ASYNC_INVALID_CHARACTERS_01', 0, function () {
    console.info('MLTFW: path for image is' + modifyimagealbumasyncpath.selections);
    const promise = media.getImageAlbums(modifyimagealbumasyncpath);
    promise.then(function (data) {
        if ((data == undefined) || (data != undefined)) {
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == false) {
                    expect(false).assertFalse();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_INVALID_CHARACTERS_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_ASYNC_INVALID_CHARACTERS_01:FAIL ');
                }
            });
        }
    });
...
/* *
        * @tc.number   : MODIFYVIDEOALBUM_ASYNC_FETCH_01
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYVIDEOALBUM_ASYNC_FETCH_01', 0, async function (done) {
    console.info('MLTFW: path for image is' + modifyvideoalbumasyncpath.selections);
    const promise = media.getVideoAlbums(modifyvideoalbumasyncpath);
    promise.then(function (data) {
        if (data == undefined) {
            console.info('MLTFW: There are no video files in ' + modifyvideoalbumasyncpath.selections);
        } else if (data != undefined) {
            console.info("orginal value of album is :" + data[0].albumName);
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_FETCH_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_FETCH_01:FAIL ');
                }
            });
        } else {
...
/* *
        * @tc.number   : MODIFYVIDEOALBUM_ASYNC_NO_NAME_01
        * @tc.name     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYVIDEOALBUM_ASYNC_NO_NAME_01', 0, async function (done) {
    console.info('MLTFW: path for image is' + modifyvideoalbumasyncpath.selections);
    const promise = media.getVideoAlbums(modifyvideoalbumasyncpath);
    promise.then(function (data) {
        if (data == undefined) {
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == false) {
                    expect(false).assertFalse();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_NO_NAME_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_NO_NAME_01:FAIL ');
                }
            });
        } else {
            console.info("MOdify album is not defined / undefined");
...
/* *
        * @tc.number   : MODIFYVIDEOALBUM_ASYNC_INVALID_CHARACTERS_01
        * @tc.name     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYVIDEOALBUM_ASYNC_INVALID_CHARACTERS_01', 0, async function (done) {
    console.info('MLTFW: path for image is' + modifyvideoalbumasyncpath.selections);
    const promise = media.getVideoAlbums(modifyvideoalbumasyncpath);
    promise.then(function (data) {
        if (data == undefined) {
            ...
            data[0].commitModify((error, value1) => {
                ...
                if (value1 == false) {
                    expect(false).assertFalse();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_INVALID_CHARACTERS_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_ASYNC_INVALID_CHARACTERS_01:FAIL ');
                }
            });
        } else {
            console.info("MOdify album is not defined / undefined");
...
/* *
        * @tc.number   : MODIFYVIDEOALBUM_PROMISE_FETCH_01
        * @tc.name     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/videoalbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYVIDEOALBUM_PROMISE_FETCH_01', 0, async function (done) {
    console.info('MLTFW: path for image is' + modifyvideoalbumpromisepath.selections);
    const promise = media.getVideoAlbums(modifyvideoalbumpromisepath);
    promise.then(function (data) {
        if (data == undefined) {
            console.info('MLTFW: There are no video files in ' + modifyvideoalbumpromisepath.selections);
        } else if (data != undefined) {
            console.info("orginal value of album is :" + data[0].albumName);
            data[0].albumName = 'modify_videoalbum';
            data[0].commitModify().then(function (value1) {
                ...
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_PROMISE_FETCH_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYVIDEOALBUM_PROMISE_FETCH_01:FAIL ');
                }
            });
        } else {
            console.info('MOdify album is not defined / undefined');
...
/* *
        * @tc.number   : MODIFYIMAGEALBUM_PROMISE_FETCH_01
        * @tc.name     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        * @tc.desc     :Get all Album details from /data/media/imagealbum using promise + 
        check album id and album name
        ...
        * @tc.level    :Level 0
    */
it(' MODIFYIMAGEALBUM_PROMISE_FETCH_01', 0, async function (done) {
    console.info('MLTFW: path for image is' + modifyimagealbumpromisepath.selections);
    const promise = media.getImageAlbums(modifyimagealbumpromisepath);
    promise.then(function (data) {
        if ((data == undefined) || (data != undefined)) {
            console.info('MLTFW: There are no image files in ' + modifyimagealbumpromisepath.selections);
            console.info("orginal value of album is :" + data[0].albumName);
            data[0].albumName = 'modify_imagealbum';
            data[0].commitModify().then(function (value1) {
                console.info("value is :" + value1);
                if (value1 == true) {
                    expect(true).assertTrue();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_PROMISE_FETCH_01:PASS ');
                } else {
                    expect().assertFail();
                    console.info('MLTFW:  MODIFYIMAGEALBUM_PROMISE_FETCH_01:FAIL ');
                }
            });
        }
    });
...
console.info('MLTFW: Media assets data of id:' + value.id + ':' + result1);
}
...
console.log('MLTFW:given directory has a BMP file'+result1);
console.log('MLTFW:given directory has a BMP file'+result1[0]+result1[1]+result1[2]);
console.info('MLTFW: Image data of id:'+ value.id + ':' + value.name + ':' +
value.mimeType + ':'+value.mediaType);
console.log('MLTFW:given directory has a media file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') &&  (result1[1].slice(-1) == '3')){
console.info('MLTFW: Audio data of id:'+ value.id + ':' + 'IS A IMAGE FILE');
}else {
console.info('MLTFW: Audio data of id:'+ value.id + ':' + 'IS NOT A IMAGE FILE');
}
}
...
console.info(' MLTFW: Image data of id:'+ value.id + ':' + result1);
}
}
...
console.log('MLTFW:given directory has a BMP file'+value.name);
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a BMP file'+result1);
console.log('MLTFW:given directory has a BMP file'+ result1[0]+ result1[1]+ result1[2]);
var Bmpname = result1[2].slice(-3);
console.log('MLTFW:given directory has a BMP file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') && (result1[1].slice(-1) == '3')){
if (Bmpname == "bmp" || Bmpname == "BMP"){
console.log('given directory has a BMP file')
console.info('MLTFW: Audio data of id:'+ value.id + ':' + value.name + ':' +
'BMP IS A IMAGE FILE');
}
}else {
console.info('MLTFW: Audio data of id:'+ value.id + ':' + value.name + ':' +
...
console.info('MLTFW: Audio data of id:'+ value.id + ':' + value.name + ':' + result1);
console.info('MLTFW: Audio data of id:'+ value.id + ':' + 'IS A AUDIO FILE');
}else {
console.info('MLTFW: Audio data of id:'+ value.id + ':' + 'IS NOT A AUDIO FILE');
}
}
...
'name:' + value.name,' size:' + value.size, 'dateAdded:' + value.dateAdded,
'dateModified:' + value.dateModified);
console.info('MLTFW: Audio data of id:'+ value.id + ':' + result1[9].slice(-3));
var wavname = result1[9].slice(-3);
if (wavname == "wav" || wavname == "WAV"){
console.log('given directory has a wav file')
}
console.info('MLTFW: Audio data of id:'+ value.id + ':' + result1);
}
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a OOG file'+result1);
console.log('MLTFW:given directory has a OOG file'+ result1[0]+ result1[1]+ result1[2]);
var OOGname = result1[2].slice(-3);
console.log('MLTFW:given directory has a OOG file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'audio/*') && (result1[1].slice(-1) == '5')){
...
console.info(' MLTFW: video data of id:'+ value.id + ':' + result1);
}
}
...
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' + result1);
console.info('MLTFW: Video data of id:'+ value.id + ':' + 'IS A VIDEO FILE');
}else {
console.info('MLTFW: Video data of id:'+ value.id + ':' + 'IS NOT A VIDEO FILE');
}
}
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a 3GP file'+result1);
console.log('MLTFW:given directory has a 3GP file'+ result1[0]+ result1[1]+ result1[2]);
var name3gp = result1[2].slice(-3);
console.log('MLTFW:given directory has a 3GP file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'video/*') && (result1[1].slice(-1) == '4')){
if (name3gp == "3gp" || name3gp == "3GP"){
console.log('given directory has a 3gp file')
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
'3GP IS A VIDEO FILE');
}
}else {
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a MOV file'+result1);
console.log('MLTFW:given directory has a MOV file'+ result1[0]+ result1[1]+ result1[2]);
var nameMov = result1[2].slice(-3);
console.log('MLTFW:given directory has a MOV file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'video/*') && (result1[1].slice(-1) == '4')){
if (nameMov == "mov" || nameMov == "MOV"){
console.log('given directory has a MOV file')
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a MP4 file'+result1);
console.log('MLTFW:given directory has a MP4 file'+ result1[0]+ result1[1]+ result1[2]);
var nameMp4 = result1[2].slice(-3);
console.log('MLTFW:given directory has a MP4 file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'video/*') && (result1[1].slice(-1) == '4')){
if (nameMp4 == "mp4" || nameMp4 == "MP4"){
console.log('given directory has a MP4 file')
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a MPG file'+result1);
console.log('MLTFW:given directory has a MPG file'+ result1[0]+ result1[1]+ result1[2]);
var nameMpg = result1[2].slice(-3);
console.log('MLTFW:given directory has a MPG file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'video/*') && (result1[1].slice(-1) == '4')){
if (nameMpg == "mpg" || nameMpg == "MPG"){
console.log('given directory has a MPG file')
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
...
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a WEBM file'+result1);
console.log('MLTFW:given directory has a WEBM file'+ result1[0]+ result1[1]+ result1[2]);
var nameWebm = result1[2].slice(-4);
console.log('MLTFW:given directory has a WEBM file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'video/*') && (result1[1].slice(-1) == '4')){
if (nameWebm == "webm" || nameWebm == "WEBM"){
console.log('given directory has a WEBM file')
console.info('MLTFW: Video data of id:'+ value.id + ':' + value.name + ':' +
...
console.log('MLTFW:given directory has a RAW file'+value.name);
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a RAW file'+result1);
console.log('MLTFW:given directory has a RAW file'+ result1[0]+ result1[1]+ result1[2]);
var nameRaw = result1[2].slice(-3);
console.log('MLTFW:given directory has a RAW file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') && (result1[1].slice(-1) == '3')){
if (nameRaw == "raw" || nameRaw == "RAW"){
console.log('given directory has a RAW file')
console.info('MLTFW: Image data of id:'+ value.id + ':' + value.name + ':' +
...
console.log('MLTFW:given directory has a HEIF file'+value.name);
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a HEIF file'+result1);
console.log('MLTFW:given directory has a HEIF file'+ result1[0]+ result1[1]+ result1[2]);
var nameHeif = result1[2].slice(-4);
console.log('MLTFW:given directory has a HEIF file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') && (result1[1].slice(-1) == '3')){
if (nameHeif == "heif" || nameHeif == "HEIF"){
console.log('given directory has a HEIF file')
console.info('MLTFW: Image data of id:'+ value.id + ':' + value.name + ':' +
...
console.log('MLTFW:given directory has a SVG file'+value.name);
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a SVG file'+result1);
console.log('MLTFW:given directory has a SVG file'+ result1[0]+ result1[1]+ result1[2]);
var nameSvg = result1[2].slice(-3);
console.log('MLTFW:given directory has a SVG file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') && (result1[1].slice(-1) == '3')){
if (nameSvg == "svg" || nameSvg == "SVG"){
console.log('given directory has a SVG file')
console.info('MLTFW: Image data of id:'+ value.id + ':' + value.name + ':' +
...
console.log('MLTFW:given directory has a Webp file'+value.name);
var result1 = [];
result1.push('mimeType:' + value.mimeType,'mediaType:' + value.mediaType,'name:' + value.name);
console.log('MLTFW:given directory has a Webp file'+result1);
console.log('MLTFW:given directory has a Webp file'+ result1[0]+ result1[1]+ result1[2]);
var nameWebp = result1[2].slice(-4);
console.log('MLTFW:given directory has a Webp file'+result1[0].slice(-7)+result1[1].slice(-1));
if ((result1[0].slice(-7) == 'image/*') && (result1[1].slice(-1) == '3')){
if (nameWebp == "webp" || nameWebp == "WEBP"){
console.log('given directory has a Webp file')
console.info('MLTFW: Image data of id:'+ value.id + ':' + value.name + ':' +
