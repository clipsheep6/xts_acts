...
describe('file.promise.test.js', function () {
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_01', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            ...
            if (isFavorite) {
                ...
                if (isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_01 fail');
            ...
            isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_01 success');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_01 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_02', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[1];
            let isFavorite = await asset.isFavorite();
            if (!isFavorite) {
                await asset.favorite(true);
                isFavorite = await asset.isFavorite();
                if (!isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_02 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (!isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_02 pass');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_02 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_02 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_03', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[2];
            await asset.favorite('true');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_03 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_03 pass');
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_04', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[3];
            await asset.favorite('false');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_04 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_04 pass');
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_05', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[4];
            await asset.favorite('fav');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_05 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_05 pass');
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_06', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[5];
            await asset.favorite(666);
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_06 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_06 pass');
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_07', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[6];
            await asset.favorite();
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_07 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_07 pass');
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_08', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[7];
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_08 fail');
                expect(false).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_08 pass');
                expect(true).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_08 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_001_09', 0, async function (done) {
        try {
            const dataList = await media.getFileAssets(fileFetchOp);
            const asset = dataList[8];
            await asset.favorite(true);
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_09 pass');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_09 fail');
                expect(false).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 001_09 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_01', 0, async function (done) {
        try {
            ...
            if (isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_01 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_01 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_01 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_01 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_02', 0, async function (done) {
        try {
            ...
            if (!isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (!isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_02 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (!isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_02 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_02 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_02 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_03', 0, async function (done) {
        try {
            ...
            const asset = dataList[2];
            await asset.favorite('true');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_03 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_03 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_04', 0, async function (done) {
        try {
            ...
            const asset = dataList[3];
            await asset.favorite('false');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_04 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_04 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_05', 0, async function (done) {
        try {
            ...
            const asset = dataList[4];
            await asset.favorite('fav');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_05 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_05 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_06', 0, async function (done) {
        try {
            ...
            const asset = dataList[5];
            await asset.favorite(666);
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_06 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_06 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_07', 0, async function (done) {
        try {
            ...
            const asset = dataList[6];
            await asset.favorite();
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_07 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_07 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_08', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_08 fail');
                expect(false).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_08 pass');
                expect(true).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_08 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_002_09', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_09 pass');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_09 fail');
                expect(false).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 002_09 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_01', 0, async function (done) {
        try {
            ...
            if (isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_01 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_01 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_01 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_01 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_02', 0, async function (done) {
        try {
            ...
            if (!isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (!isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_02 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (!isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_02 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_02 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_02 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_03', 0, async function (done) {
        try {
            ...
            const asset = dataList[2];
            await asset.favorite('true');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_03 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_03 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_04', 0, async function (done) {
        try {
            ...
            const asset = dataList[3];
            await asset.favorite('false');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_04 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_04 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_05', 0, async function (done) {
        try {
            ...
            const asset = dataList[4];
            await asset.favorite('fav');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_05 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_05 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_06', 0, async function (done) {
        try {
            ...
            const asset = dataList[5];
            await asset.favorite(666);
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_06 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_06 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_07', 0, async function (done) {
        try {
            ...
            const asset = dataList[6];
            await asset.favorite();
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_07 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_07 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_08', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_08 fail');
                expect(false).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_08 pass');
                expect(true).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_08 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_003_09', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_09 pass');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_09 fail');
                expect(false).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 003_09 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_01', 0, async function (done) {
        try {
            ...
            if (isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_01 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_01 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_01 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_01 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_02', 0, async function (done) {
        try {
            ...
            if (!isFavorite) {
                ...
                isFavorite = await asset.isFavorite();
                if (!isFavorite) {
                    console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_02 fail');
                    expect(false).assertTrue();
                    done();
                }
            }
            ...
            isFavorite = await asset.isFavorite();
            if (!isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_02 success');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_02 fail');
            ...
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_02 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_03', 0, async function (done) {
        try {
            ...
            const asset = dataList[2];
            await asset.favorite('true');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_03 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_03 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_04', 0, async function (done) {
        try {
            ...
            const asset = dataList[3];
            await asset.favorite('false');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_04 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_04 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_05', 0, async function (done) {
        try {
            ...
            const asset = dataList[4];
            await asset.favorite('fav');
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_05 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_05 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_06', 0, async function (done) {
        try {
            ...
            const asset = dataList[5];
            await asset.favorite(666);
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_06 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_06 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_07', 0, async function (done) {
        try {
            ...
            const asset = dataList[6];
            await asset.favorite();
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_07 fail');
            expect(false).assertTrue();
            done();
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_07 fail, message = ' + error);
            expect(true).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_08', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_08 fail');
                expect(false).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_08 pass');
                expect(true).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_08 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
    ...
    it('SUB_MEDIA_MEDIALIBRARY_FAV_ASSET_PROMISE_004_09', 0, async function (done) {
        try {
            ...
            let isFavorite = await asset.isFavorite();
            if (isFavorite) {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_09 pass');
                expect(true).assertTrue();
                done();
            } else {
                console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_09 fail');
                expect(false).assertTrue();
                done();
            }
        } catch (error) {
            console.info('MediaLibraryTest : FAV_ASSET_PROMISE 004_09 fail, message = ' + error);
            expect(false).assertTrue();
            done();
        }
    });
