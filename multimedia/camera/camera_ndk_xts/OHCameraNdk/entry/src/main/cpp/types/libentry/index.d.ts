...
export const OHCaptureSessionCanPreconfig: (a: number,index:number) => number;
export const OHCaptureSessionCanPreconfigWithRatio: (a: number,b: number,index:number) => number;
...
export const oHCameraManagerGetSupportedSceneModes: (index:number) => number;
...
export const oHCaptureSessionCanAddInput: (index:number) => number;
export const oHCaptureSessionCanAddPreviewOutput: (index:number) => number;
export const oHCaptureSessionCanAddPhotoOutput: (index:number) => number;
export const oHCaptureSessionCanAddVideoOutput: (index:number) => number;
