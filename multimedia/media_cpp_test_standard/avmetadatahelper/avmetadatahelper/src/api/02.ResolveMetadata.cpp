...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0100, Function | MediumTest | Level0)
{
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0300, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0400, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0500, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0600, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0700, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_ResolveMetadata_0800, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
