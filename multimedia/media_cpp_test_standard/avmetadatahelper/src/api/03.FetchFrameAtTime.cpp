...
#include "HitsAVMetadataAPITest.h"
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0100, Function | MediumTest | Level0)
{
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0300, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0400, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0500, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0600, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0700, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0800, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_0900, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1000, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1100, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1300, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1400, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1500, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1600, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1700, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1800, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_1900, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2000, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2100, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2300, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2400, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2500, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2700, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.name      : 28.FetchFrameAtTime AVMetadataQueryOption AV_META_QUERY_CLOSEST_SYNC
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_FetchFrameAtTime_2800, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
