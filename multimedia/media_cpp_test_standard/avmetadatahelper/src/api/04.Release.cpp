...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_Release_0000, Function | MediumTest | Level0)
{
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_Release_0100, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_Release_0200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
