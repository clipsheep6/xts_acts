...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0100, Function | MediumTest | Level0)
{
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0200, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0300, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0400, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0500, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0550, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    ...
    * @tc.desc      : 
*/
HWTEST_F(HitsAVMetadataAPITest, SUB_MEDIA_AVMETADATAHELPER_API_SetSource_0600, Function | MediumTest | Level0)
{
    std::shared_ptr<TestAVMetadataHelper> helper = std::make_shared<TestAVMetadataHelper>();
    ASSERT_NE(nullptr, helper);
    ASSERT_EQ(true, helper->CreateAVMetadataHelper());
