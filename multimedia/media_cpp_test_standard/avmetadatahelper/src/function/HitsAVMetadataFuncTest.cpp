...
/**
    ...
    * @tc.name      : GET metadata FROM AAC_48000_32_1.acc FORMAT 
    * @tc.desc      : GET metadata FROM AAC_48000_32_1.acc FORMAT 
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0100, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, ""
...
/**
    ...
    * @tc.name      : GET metadata FROM MP3_48000_32_1.mp3 FORMAT 
    * @tc.desc      : GET metadata FROM MP3_48000_32_1.mp3 FORMAT
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0200, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, "media"},
...
/**
    ...
    * @tc.name      : GET metadata FROM OGG_48000_1.ogg FORMAT 
    * @tc.desc      : GET metadata FROM OGG_48000_1.ogg FORMAT 
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0300, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, "media"},
...
/**
    ...
    * @tc.name      : GET metadata FROM vorbis_48000_32_1.wav FORMAT 
    * @tc.desc      : GET metadata FROM vorbis_48000_32_1.wav FORMAT 
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0400, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, "media"},
...
/**
    ...
    * @tc.name      : GET metadata FROM h264_aac_1080p_60r.ts FORMAT 
    * @tc.desc      : GET metadata FROM h264_aac_1080p_60r.ts FORMAT
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0500, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, ""
...
/**
    ...
    * @tc.name      : GET metadata FROM vp8_vorbis_720p_30r.webm FORMAT  
    * @tc.desc      : GET metadata FROM vp8_vorbis_720p_30r.webm FORMAT  
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0600, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, "media"},
...
/**
    ...
    * @tc.name      : GET metadata FROM mpeg4_aac_720p_30r.mkv FORMAT   
    * @tc.desc      : GET metadata FROM mpeg4_aac_720p_30r.mkv FORMAT 
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0700, Function | MediumTest | Level0)
{
std::unordered_map < int32_t, std::string> expectMeta = {
{
AV_KEY_ALBUM, "media"},
...
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0800, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0900
    * @tc.name      : GET AV_KEY_VIDEO_ORIENTATION FROM MP4_ROTATE_180.mp4
    * @tc.desc      : GET AV_KEY_VIDEO_ORIENTATION FROM MP4_ROTATE_180.mp4
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_0900, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1000
    * @tc.name      : GET AV_KEY_VIDEO_ORIENTATION FROM MP4_ROTATE_270.mp4
    * @tc.desc      : GET AV_KEY_VIDEO_ORIENTATION FROM MP4_ROTATE_270.mp4
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1000, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1100
    * @tc.name      : Get SURFACE from MP3_SURFACE.mp3
    * @tc.desc      : Get SURFACE from MP3_SURFACE.mp3
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1100, Function | MediumTest | Level0)
{
std::string uri = TestParamsConfig::GetInstance().GetMountPath() +
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1200
    * @tc.name      : Get SURFACE from OGG_SURFACE.ogg
    * @tc.desc      : Get SURFACE from OGG_SURFACE.ogg
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1200, Function | MediumTest | Level0)
{
std::string uri = TestParamsConfig::GetInstance().GetMountPath() +
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1300
    * @tc.name      : Get SURFACE from MP4_SURFACE.mp4
    * @tc.desc      : Get SURFACE from MP4_SURFACE.mp4
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1300, Function | MediumTest | Level0)
{
std::string uri = TestParamsConfig::GetInstance().GetMountPath() +
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1400
    * @tc.name      : Fetch Frame queryOption is AV_META_QUERY_NEXT_SYNC
    * @tc.desc      : Fetch Frame queryOption is AV_META_QUERY_NEXT_SYNC
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1400, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
struct PixelMapParams param = {
- 1, 316, PixelFormat::RGB_565
};
int64_t timeUs = 0;
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1500
...
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1500, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1600
...
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1600, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1700
    * @tc.name      : Fetch Frame queryOption is AV_META_QUERY_CLOSEST
    * @tc.desc      : Fetch Frame queryOption is AV_META_QUERY_CLOSEST
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1700, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1800
    * @tc.name      : Set the Key value to -1 to get metadata
    * @tc.desc      : Set the Key value to -1 to get metadata
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1800, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
...
std::string("/MP3_48000_32_1.mp3");
ASSERT_EQ(RET_OK, helper->SetSource(uri, AVMetadataUsage::AV_META_USAGE_META_ONLY));
std::string metadata = helper->ResolveMetadata(- 1);
ASSERT_EQ("", metadata);
helper->Release();
}

/**
    * @tc.number    : SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1900
    * @tc.name      : Set the Key value to 99999 to get metadata
    * @tc.desc      : Set the Key value to 99999 to get metadata
*/
HWTEST_F(HitsAVMetadataFuncTest, SUB_MEDIA_AVMETADATAHELPER_API_RESOLVEMETADATA_1900, Function | MediumTest | Level0)
{
std::shared_ptr < TestAVMetadataHelper > helper = std::make_shared < TestAVMetadataHelper >();
ASSERT_NE(nullptr, helper);
ASSERT_EQ(true, helper->CreateAVMetadataHelper());
