...
describe('ActsRpcJsTest', function(){
    ...
    it("SUB_Softbus_IPC_MessageParcel_1100", 0, function(){
        ...
        try{
            var data = rpc.MessageParcel.create();
            console.log("SUB_Softbus_IPC_MessageParcel_1100: create object successfully.");

            var result1 = data.getWritableBytes();
            console.log("SUB_Softbus_IPC_MessageParcel_1100: run getWritableBytes is success, result is " + result1);
            expect(result1 == 0).assertTrue();
            var result2 = data.getReadableBytes();
            console.log("SUB_Softbus_IPC_MessageParcel_1100: run getReadableBytes is success, result is " + result2);
            expect(result2 == 0).assertTrue();
            var result3 = data.getReadPosition();
            console.log("SUB_Softbus_IPC_MessageParcel_1100: run getReadPosition is success, result is " + result3);
            expect(result3 == 0).assertTrue();
            var result4 = data.getWritePosition();
            console.log("SUB_Softbus_IPC_MessageParcel_1100: run getWritePosition is success, result is " + result4);
            expect(result4 == 0).assertTrue();
