...
describe('ActsBundleMgrMultipleInstallTest', function () {
     ...
     it('BMS_Multiple_Hap_Install_1100', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT, PATH + SECOND_BACKUP_RIGHT], {
            ...
            installData.uninstall(NAME, {
                ...
                console.info('======BMS_Multiple_Hap_Install_1100.Message3=====' + JSON.stringify(data1.statusMessage));
                expect(data1.statusMessage).assertEqual('SUCCESS');
                done();
            })
        });
     ...
     it('BMS_Multiple_Hap_Install_1200', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT, PATH + SECOND_RIGHT], {
            ...
            installData.uninstall(NAME, {
                ...
                console.info('======BMS_Multiple_Hap_Install_1200.Message3=====' + JSON.stringify(data1.statusMessage));
                expect(data1.statusMessage).assertEqual('SUCCESS');
                done();
            })
        });
     ...
     it('BMS_Multiple_Hap_Install_1300', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT, PATH + TWELFTH_RIGHT], {
            ...
            installData.uninstall(NAME, {
                ...
                console.info('======BMS_Multiple_Hap_Install_1300.Message3=====' + JSON.stringify(data1.statusMessage));
                expect(data1.statusMessage).assertEqual('SUCCESS');
                done();
            })
        });
     ...
     */
     it('BMS_Multiple_Hap_Update_0100', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0100.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + SECOND_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0100.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0100.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
    ...
    it('BMS_Multiple_Hap_Update_0200', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0200.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            installData.install([PATH + FOURTH_RIGHT], {
                ...
                expect(err.code).assertEqual(ERR_CODE);
                expect(data.status).assertEqual(STATUS_INSTALL_FAILURE_CONFLICT);
                console.info('======BMS_Multiple_Hap_Update_0200.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('STATUS_INSTALL_FAILURE_CONFLICT');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0200.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0300', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0300.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            installData.install([PATH + THIRTEENTH_RIGHT], {
                ...
                console.info('======BMS_Multiple_Hap_Update_0300.statusMessage2=====' + JSON.stringify(data.statusMessage));
                ...
                installData.uninstall(NAME, {
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0300.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0400', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0400.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FIRST_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0400.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0400.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0500', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0500.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FOURTEENTH_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0500.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0500.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0600', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0600.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FIRST_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0600.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0600.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0700', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0700.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FOURTEENTH_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0700.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0700.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0800', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0800.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + SECOND_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0800.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0800.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_0900', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_0900.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FOURTH_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_0900.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_0900.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_1000', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_1000.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            installData.install([PATH + THIRTEENTH_RIGHT], {
                userId: 0,
                installFlag: 1,
                ...
                expect(err.code).assertEqual(ERR_CODE);
                expect(data.status).assertEqual(STATUS_INSTALL_FAILURE_INCOMPATIBLE);
                console.info('======BMS_Multiple_Hap_Update_1000.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('STATUS_INSTALL_FAILURE_INCOMPATIBLE');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_1000.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_1100', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_1100.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + TWELFTH_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_1100.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_1100.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_1200', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_1200.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + SIXTEENTH_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_1200.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_1200.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_1300', 0, async function (done) {
        ...
        installData.install([PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_1300.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            installData.install([PATH + THIRTEENTH_RIGHT], {
                userId: 0,
                installFlag: 1,
                ...
                expect(err.code).assertEqual(ERR_CODE);
                expect(data.status).assertEqual(STATUS_INSTALL_FAILURE_INCOMPATIBLE);
                console.info('======BMS_Multiple_Hap_Update_1300.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('STATUS_INSTALL_FAILURE_INCOMPATIBLE');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_1300.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
     ...
     */
     it('BMS_Multiple_Hap_Update_1500', 0, async function (done) {
        ...
        installData.install([PATH + FIRST_RIGHT, PATH + SECOND_RIGHT], {
            ...
            expect(err.code).assertEqual(0);
            expect(data.status).assertEqual(0);
            console.info('======BMS_Multiple_Hap_Update_1500.statusMessage1=====' + JSON.stringify(data.statusMessage));
            expect(data.statusMessage).assertEqual('SUCCESS');
            ...
            installData.install([PATH + FIRST_RIGHT, PATH + SECOND_RIGHT], {
                ...
                expect(err.code).assertEqual(0);
                expect(data.status).assertEqual(0);
                console.info('======BMS_Multiple_Hap_Update_1500.statusMessage2=====' + JSON.stringify(data.statusMessage));
                expect(data.statusMessage).assertEqual('SUCCESS');
                installData.uninstall(NAME, {
                    userId: 0,
                    installFlag: 1,
                    ...
                    console.info('======BMS_Multiple_Hap_Update_1500.statusMessage3=====' + JSON.stringify(data.statusMessage));
                    expect(data.statusMessage).assertEqual('SUCCESS');
                    done();
                })
            })
