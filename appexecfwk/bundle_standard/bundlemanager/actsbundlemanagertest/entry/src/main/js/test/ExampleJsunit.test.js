...
describe('ActsBundleManagerTest', function () {
    ...
    it('install_0200', 0, async function (done) {
        demo.getBundleInstaller().then(async (data) => {
            await data.install([PATH + BMSJSTEST2], {
                param: {
                    userId: 0,
                    isKeepData: false
                }
            ...
            await data.install([PATH + BMSJSTEST3], {
                param: {
                    userId: 0,
                    isKeepData: false
                }
    ...
    it('install_0300', 0, async function (done) {
        demo.getBundleInstaller().then(async (data) => {
            await data.install([PATH + BMSJSTEST4], {
                param: {
                    userId: 0,
                    isKeepData: false
                }
            ...
            await data.install([PATH + BMSJSTEST5], {
                param: {
                    userId: 0,
                    isKeepData: false
                }
            ...
            await data.install([PATH + BMSJSTEST6], {
                param: {
                    userId: 0,
                    isKeepData: false
                }
