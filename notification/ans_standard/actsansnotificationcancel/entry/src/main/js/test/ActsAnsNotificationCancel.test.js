...
describe('ActsAnsNotificationCancel', function () {
  console.info(
    "===========ActsAnsNotificationCancel start====================>"
  );
  let timesOfOnConsume;
  function onConsumeCancelAll(data) {
    console.info(
      "================ANS_Cancel_0100 onConsume start=======================>"
    );
    console.info(
      "================ANS_Cancel_0100 onConsume data:=================>" +
        JSON.stringify(data)
    );
    ...
    if (timesOfOnConsume == 2) {
      ...
      console.info(
        "================ANS_Cancel_0100 onConsume cancelAll=======================>"
      );
    }
    console.info(
      "================ANS_Cancel_0100 onConsume end=======================>"
    );
  }
  let timesOfOnCancel;
  function onCancelCancelAll(data) {
    console.info(
      "================ANS_Cancel_0100 onCancel start===============>"
    );
    console.info(
      "================ANS_Cancel_0100 onCancel data:===============>" +
        JSON.stringify(data)
    );
    ...
    console.info(
      "================ANS_Cancel_0100 onCancel end=======================>"
    );
  }
  function cancelAllCallBack(err, data) {
    console.info(
      "========ANS_Cancel_0100 cancelAllCallBack start==============>"
    );
    console.info(
      "========ANS_Cancel_0100 cancelAllCallBack data===============>" +
        JSON.stringify(data)
    );
    console.info(
      "========ANS_Cancel_0100 cancelAllCallBack err================>" +
        JSON.stringify(err)
    );
    console.info(
      "========ANS_Cancel_0100 cancelAllCallBack end================>"
    );
  }
  ...
  function onConsumeCancelAllPromise(data) {
    ...
    console.info(
      "================ANS_Cancel_0200 onConsume data:============>" +
        JSON.stringify(data)
    );
    if (timesOfOnConsume == 2) {
      notify.cancelAll();
      console.info(
        "==========ANS_Cancel_0200 onConsume cancelAll promise==========>"
      );
    }
    console.info(
      "================ANS_Cancel_0200 onConsume end===============>"
    );
  }
  ...
  function onConsumeCancelAllNoNotify(data) {
    ...
    console.info(
      "================ANS_Cancel_0300 onConsume data:========>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "================ANS_Cancel_0300 onConsume end=======================>"
    );
  }
  function onCancelCancelAllNoNotify(data) {
    console.info(
      "=================ANS_Cancel_0300 onCancel start=============>"
    );
    expect().assertFail();
    console.info(
      "================ANS_Cancel_0300 onCancel data:==============>" +
        JSON.stringify(data)
    );
    console.info(
      "================ANS_Cancel_0300 onCancel end================>"
    );
  }
  function cancelAllCallBackNoNotify(err, data) {
    ...
    console.info(
      "==========ANS_Cancel_0300 cancelAllCallBack data:=============>" +
        JSON.stringify(data)
    );
    console.info(
      "==========ANS_Cancel_0300 cancelAllCallBack  err:=============>" +
        JSON.stringify(err)
    );
    console.info(
  ...
  function onConsumeCancelAllNoNotifyPromise(data) {
    ...
    console.info(
      "================ANS_Cancel_0400 onConsume data:===========>" +
        JSON.stringify(data)
    );
    expect().assertFail();
  ...
  function onConsumeCancelAll2Times(data) {
    ...
    console.info(
      "==========ANS_Cancel_0500 onConsume data:==============>" +
        JSON.stringify(data)
    );
    notify.cancelAll(cancelAllCallBack2Times1);
    console.info(
      "==========ANS_Cancel_0500 onConsume cancelAll=================>"
    );
    console.info(
      "==========ANS_Cancel_0500 onConsume end=======================>"
    );
  }
  ...
  function cancelAllCallBack2Times1(err) {
    console.info(
      "==========ANS_Cancel_0500 cancelAllCallBack1 start==========>"
    );
    console.info(
      "==========ANS_Cancel_0500 cancelAllCallBack1 err:===========>" +
        JSON.stringify(err)
    );
    notify.cancelAll(cancelAllCallBack2Times2);
    console.info(
      "==========ANS_Cancel_0500 cancelAllCallBack1 cancelAll======>"
    );
    console.info(
  ...
  function cancelAllCallBack2Times2(err) {
    console.info(
      "==========ANS_Cancel_0500 cancelAllCallBack2 start=============>"
    );
    console.info(
      "==========ANS_Cancel_0500 cancelAllCallBack2 err:==============>" +
        JSON.stringify(err)
    );
    console.info(
  ...
  function onConsumeCancelAll2TimesPromise(data) {
    ...
    console.info(
      "==========ANS_Cancel_0600 onConsume data=============>" +
        JSON.stringify(data)
    );
    notify.cancelAll();
    console.info(
      "==========ANS_Cancel_0600 onConsume cancelAll 2times1 end======>"
    );
    notify.cancelAll();
    console.info(
      "==========ANS_Cancel_0600 onConsume cancelAll 2times2 end======>"
    );
  ...
  function onConsumeCancelAllIsUnremovable(data) {
    ...
    console.info(
      "========ANS_Cancel_0700 onConsume data: ===========>" +
        JSON.stringify(data)
    );
  ...
  function onCancelCancelAllIsUnremovable(data) {
    console.info(
      "================ANS_Cancel_0700 onCancel start=======================>"
    );
    console.info(
      "================ANS_Cancel_0700 onCancel data:====================>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(7);
    console.info(
      "================ANS_Cancel_0700 onCancel end=======================>"
    );
  }
  function cancelAllCallBackIsUnremovable(err, data) {
    console.info(
      "===========ANS_Cancel_0700 cancelAllCallBack start==========>"
    );
    console.info(
      "===========ANS_Cancel_0700 cancelAllCallBack err:===========>" +
        JSON.stringify(err)
    );
    console.info(
      "===========ANS_Cancel_0700 cancelAllCallBack data:==========>" +
        JSON.stringify(data)
    );
    console.info(
      "===========ANS_Cancel_0700 cancelAllCallBack end=======================>"
    );
  }
  ...
  function onConsumeCancelAllIsUnremovablPromise(data) {
    console.info(
      "================ANS_Cancel_0800 onConsume start=============>"
    );
    console.info(
      "================ANS_Cancel_0800 onConsume data:=============>" +
        JSON.stringify(data)
    );
    notify.cancelAll();
    console.info("================ANS_Cancel_0800 cancelAll==========>");
    console.info(
      "================ANS_Cancel_0800 onConsume end===============>"
    );
  }
  function onCancelCancelAllIsUnremovablePromise(data) {
    console.info(
      "================ANS_Cancel_0800 onCancel start================>"
    );
    console.info(
      "================ANS_Cancel_0800 onCancel data :===============>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(8);
    console.info(
      "================ANS_Cancel_0800 onCancel end================>"
    );
  }
  ...
  function onConsumeCancel(data) {
    ...
    console.info(
      "=========ANS_Cancel_0900 onConsume data:================>" +
        JSON.stringify(data)
    );
  ...
  function cancelCallBackCancel(err) {
    console.info(
      "===========ANS_Cancel_0900 cancelCallBack start================>"
    );
    console.info(
      "===========ANS_Cancel_0900 cancelCallBack err:=================>" +
        JSON.stringify(err)
    );
    console.info(
      "===========ANS_Cancel_0900 cancelCallBack end==================>"
    );
  }
  ...
  function onConsumeCancelWrongId(data) {
    ...
    console.info(
      "========ANS_Cancel_1000 onConsume data:==============>" +
        JSON.stringify(data)
    );
    console.info(
      "========ANS_Cancel_1000 onConsume label:=============>" +
        data.request.label
    );
    console.info(
      "========ANS_Cancel_1000 onConsume id:================>" + data.request.id
    );
  ...
  function onCancelCancelWrongId(data) {
    console.info(
      "================ANS_Cancel_1000 onCancel start=============>"
    );
    console.info(
      "================ANS_Cancel_1000 onCancel data:=============>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "================ANS_Cancel_1000 onCancel end===============>"
    );
  }
  function cancelCallBackCancelWrongId(err) {
    console.info(
      "==============ANS_Cancel_1000 cancelCallBack start===============>"
    );
    console.info(
      "==============ANS_Cancel_1000 cancelCallBack err:================>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "==============ANS_Cancel_1000 cancelCallBack end=================>"
    );
  }
  ...
  function onConsumeCancelIsUnremovable(data) {
    ...
    console.info(
      "============ANS_Cancel_1100 onConsume data:===============>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_1100 onConsume label:==============>" +
        data.request.label
    );
    console.info(
    ...
    console.info(
      "============ANS_Cancel_1100 onConsume cancel=======================>"
    );
    console.info(
      "============ANS_Cancel_1100 onConsume end=======================>"
    );
  }
  function onCancelCancelIsUnremovable(data) {
    console.info("============ANS_Cancel_1100 onCancel start================>");
    console.info(
      "============ANS_Cancel_1100 onCancel data:================>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_1100 onCancel id:================>" +
        data.request.id
    );
    expect(data.request.id).assertEqual(11);
    console.info(
      "============ANS_Cancel_1100 onCancel end=======================>"
    );
  }
  function cancelCallBackCancelIsUnremovable(err) {
    console.info(
      "============ANS_Cancel_1100 cancelCallBack start=================>"
    );
    console.info(
      "============ANS_Cancel_1100 cancelCallBack err:==================>" +
        JSON.stringify(err)
    );
    console.info(
      "============ANS_Cancel_1100 cancelCallBack end===================>"
    );
  }
  ...
  function onConsumeCancel2Times(data) {
    console.info(
      "=========ANS_Cancel_1200 onConsume start=====================>"
    );
    console.info(
      "=========ANS_Cancel_1200 onConsume data:=====================>" +
        JSON.stringify(data)
    );
    console.info(
      "=========ANS_Cancel_1200 onConsume label:====================>" +
        data.request.label
    );
    console.info(
    ...
    console.info(
      "=========ANS_Cancel_1200 onConsume cancel====================>"
    );
    console.info(
      "=========ANS_Cancel_1200 onConsume end=======================>"
    );
  }
  function onCancelCancel2Times(data) {
    timesOfOnCancel = timesOfOnCancel + 1;
    console.info(
      "=========ANS_Cancel_1200 onCancel start======================>"
    );
    console.info(
      "=========ANS_Cancel_1200 onCancel data:===========>" +
        JSON.stringify(data)
    );
    console.info(
      "=========ANS_Cancel_1200 onCancel timesOfOnCancel========>" +
        timesOfOnCancel
    );
    if (timesOfOnCancel == 1) {
      expect(data.request.id).assertEqual(12);
      console.info(
        "=========ANS_Cancel_1200 onCancel id:======================>" +
          data.request.id
      );
      notify.cancel(id1200, cancelCallBackCancel2Times2);
      console.info(
        "=========ANS_Cancel_1200 onCancel cancelCallBack_cancel 2Times2===========>"
      );
    } else if (timesOfOnCancel == 2) {
      expect().assertFail();
    }
    console.info(
      "=========ANS_Cancel_1200 onCancel end=======================>"
    );
  }
  function cancelCallBackCancel2Times1(err) {
    console.info(
      "===========ANS_Cancel_1200 cancelCallBack1 start================>"
    );
    console.info(
      "===========ANS_Cancel_1200 cancelCallBack1 err:=================>" +
        JSON.stringify(err)
    );
    console.info(
      "===========ANS_Cancel_1200 cancelCallBack1 end=======================>"
    );
  }

  function cancelCallBackCancel2Times2(err) {
    console.info(
      "===========ANS_Cancel_1200 cancelCallBack2 start===========>"
    );
    console.info(
      "===========ANS_Cancel_1200 cancelCallBack2 err:============>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
  ...
  function onConsumeCancelLabel(data) {
    ...
    console.info(
      "============ANS_Cancel_1300 onConsume data:=============>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_1300 onConsume label: ===========>" +
        data.request.label
    );
    console.info(
  ...
  function onCancelCancelLabel(data) {
    ...
    console.info(
      "=========ANS_Cancel_1300 onCancel data:============>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(13);
    console.info(
      "=========ANS_Cancel_1300 onCancel id:============>" + data.request.id
    );
    expect(data.request.label).assertEqual("1300");
    console.info(
      "=========ANS_Cancel_1300 onCancel label:============>" +
        data.request.label
    );
  ...
  function cancelCallBackCancelLabel(err) {
    console.info(
      "=========ANS_Cancel_1300 cancelCallBack start====================>"
    );
    console.info(
      "=========ANS_Cancel_1300 cancelCallBack err:=====================>" +
        JSON.stringify(err)
    );
    console.info(
      "=========ANS_Cancel_1300 cancelCallBack end=====================>"
    );
  }
  ...
  function onConsumeCancelLabelPromise(data) {
    ...
    console.info(
      "==========ANS_Cancel_1400 onConsume data:=================>" +
        JSON.stringify(data)
    );
    console.info(
      "==========ANS_Cancel_1400 onConsume label:================>" +
        data.request.label
    );
    console.info(
  ...
  function onCancelCancelLabelPromise(data) {
    ...
    console.info(
      "==========ANS_Cancel_1400 onCancel data:============>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(14);
    console.info(
      "==========ANS_Cancel_1400 onCancel id:================>" +
        data.request.id
    );
    expect(data.request.label).assertEqual("1400");
    console.info(
      "==========ANS_Cancel_1400 onCancel label:================>" +
        data.request.label
    );
  ...
  function onConsumeCancelLabelIsUnremoveable(data) {
    console.info(
      "========ANS_Cancel_1500 onConsume start=====================>"
    );
    console.info(
      "========ANS_Cancel_1500 onConsume data:=====================>" +
        JSON.stringify(data)
    );
    console.info(
      "========ANS_Cancel_1500 onConsume label:====================>" +
        data.request.label
    );
    console.info(
    ...
    notify.cancel(
      data.request.id,
      data.request.label,
      cancelCallBackCancelLabelIsUnremoveable
    );
    console.info(
      "========ANS_Cancel_1500 onConsume cancel====================>"
    );
    console.info(
      "========ANS_Cancel_1500 onConsume end=======================>"
    );
  }
  function onCancelCancelLabelIsUnremoveable(data) {
    console.info(
      "========ANS_Cancel_1500 onCancel start=======================>"
    );
    console.info(
      "========ANS_Cancel_1500 onCancel data : =======================>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(15);
    console.info(
      "========ANS_Cancel_1500 onCancel id : =======================>" +
        data.request.id
    );
    expect(data.request.label).assertEqual("1500");
    console.info(
      "========ANS_Cancel_1500 onCancel label : =======================>" +
        data.request.label
    );
    console.info(
      "========ANS_Cancel_1500 onCancel end=======================>"
    );
  }
  function cancelCallBackCancelLabelIsUnremoveable(err) {
    console.info("========ANS_Cancel_1500 cancelCallBack start=========>");
    console.info(
      "========ANS_Cancel_1500 cancelCallBack err:==========>" +
        JSON.stringify(err)
    );
  ...
  function onConsumeCancelLabelIsUnremoveablePromise(data) {
    console.info(
      "============ANS_Cancel_1600 onConsume start==================>"
    );
    console.info(
      "============ANS_Cancel_1600 onConsume data:==================>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_1600 onConsume label:=================>" +
        data.request.label
    );
    console.info(
      "============ANS_Cancel_1600 onConsume id:====================>" +
        data.request.id
    );
    notify.cancel(data.request.id, data.request.label);
    console.info("============ANS_Cancel_1600 onConsume cancel end==========>");
    console.info(
      "============ANS_Cancel_1600 onConsume end====================>"
    );
  }
  function onCancelCancelLabelIsUnremoveablePromise(data) {
    console.info(
      "============ANS_Cancel_1600 onCancel start=================>"
    );
    console.info(
      "============ANS_Cancel_1600 onCancel data:=================>" +
        JSON.stringify(data)
    );
    expect(data.request.id).assertEqual(16);
    console.info(
      "============ANS_Cancel_1600 onCancel id : =======================>" +
        data.request.id
    );
    expect(data.request.label).assertEqual("1600");
    console.info(
      "============ANS_Cancel_1600 onCancel label : =======================>" +
        data.request.label
    );
    console.info(
      "============ANS_Cancel_1600 onCancel end===================>"
    );
  }
  ...
  function onConsumeCancelWrongLabel(data) {
    console.info(
      "================ANS_Cancel_1700 onConsume start===============>"
    );
    console.info(
      "================ANS_Cancel_1700 onConsume data:===============>" +
        JSON.stringify(data)
    );
    console.info(
      "================ANS_Cancel_1700 onConsume label:==============>" +
        data.request.label
    );
    console.info(
      "================ANS_Cancel_1700 onConsume id:=================>" +
        data.request.id
    );
    notify.cancel(data.request.id, "9999", cancelCallBackCancelWrongLabel);
    console.info(
      "================ANS_Cancel_1700 onConsume cancel=======================>"
    );
    console.info(
      "================ANS_Cancel_1700 onConsume end=======================>"
    );
  }
  function onCancelCancelWrongLabel(data) {
    console.info(
      "================ANS_Cancel_1700 onCancel start===============>"
    );
    console.info(
      "================ANS_Cancel_1700 onCancel data:===============>" +
        JSON.stringify(data)
    );
    expect().assertFail(0);
    console.info(
      "================ANS_Cancel_1700 onCancel end=================>"
    );
  }
  function cancelCallBackCancelWrongLabel(err) {
    console.info(
      "================ANS_Cancel_1700 cancelCallBack start=================>"
    );
    console.info(
      "================ANS_Cancel_1700 cancelCallBack err:==================>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "================ANS_Cancel_1700 cancelCallBack end===================>"
    );
  }
  ...
  function onConsumeCancelWrongLabelPromise(data) {
    ...
    console.info(
      "=========ANS_Cancel_1800 onConsume data:================>" +
        JSON.stringify(data)
    );
    console.info(
      "=========ANS_Cancel_1800 onConsume label:===============>" +
        data.request.label
    );
    console.info(
    ...
    notify
      .cancel(data.request.id, "9999")
      .then(() => {
        console.info("=========ANS_Cancel_1800 onConsume cancel then======>");
      })
      .catch((err) => {
        console.info(
          "=========ANS_Cancel_1800 onConsume cancel catch err======>" +
            JSON.stringify(err)
        );
        expect(err.code != 0).assertEqual(true);
      });
    console.info(
      "=========ANS_Cancel_1800 onConsume end=======================>"
    );
  }
  function onCancelCancelWrongLabelPromise(data) {
    console.info(
      "=========ANS_Cancel_1800 onCancel start=======================>"
    );
    console.info(
      "=========ANS_Cancel_1800 onCancel data : =======================>" +
        JSON.stringify(data)
    );
    expect().assertFail(0);
    console.info(
      "=========ANS_Cancel_1800 onCancel end=======================>"
    );
  }
  ...
  function onConsumeCancelLabelNullCharacter(data) {
    console.info(
      "===========ANS_Cancel_1900 onConsume start==================>"
    );
    console.info(
      "===========ANS_Cancel_1900 onConsume data:==================>" +
        JSON.stringify(data)
    );
    console.info(
      "===========ANS_Cancel_1900 onConsume label:=================>" +
        data.request.label
    );
    console.info(
    ...
    console.info(
      "===========ANS_Cancel_1900 onConsume cancel=======================>"
    );
    console.info(
      "===========ANS_Cancel_1900 onConsume end=======================>"
    );
  }
  function onCancelCancelLabelNullCharacter(data) {
    console.info("===========ANS_Cancel_1900 onCancel start================>");
    console.info(
      "===========ANS_Cancel_1900 onCancel data:================>" +
        JSON.stringify(data)
    );
    expect().assertFail(0);
    console.info(
      "===========ANS_Cancel_1900 onCancel end=======================>"
    );
  }
  function cancelCallBackCancelNullCharacter(err) {
    console.info(
      "===========ANS_Cancel_1900 cancelCallBack start=================>"
    );
    console.info(
      "===========ANS_Cancel_1900 cancelCallBack err:==================>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "===========ANS_Cancel_1900 cancelCallBack end===================>"
    );
  }
  ...
  function onConsumeCancelNullCharacter(data) {
    ...
    console.info(
      "==========ANS_Cancel_2000 onConsume data:=================>" +
        JSON.stringify(data)
    );
    console.info(
      "==========ANS_Cancel_2000 onConsume label:================>" +
        data.request.label
    );
    console.info(
    ...
    notify
      .cancel(data.request.id, "")
      .then(() => {
        console.info("=========ANS_Cancel_2000 onConsume cancel then======>");
      })
      .catch((err) => {
        console.info(
          "=========ANS_Cancel_2000 onConsume cancel catch err======>" +
            JSON.stringify(err)
        );
        expect(err.code != 0).assertEqual(true);
      });
  ...
  function onCancelCancelNullCharacter(data) {
    console.info(
      "==========ANS_Cancel_2000 onCancel start====================>"
    );
    console.info(
      "==========ANS_Cancel_2000 onCancel data:======================>" +
        JSON.stringify(data)
    );
    expect().assertFail(0);
    console.info(
      "==========ANS_Cancel_2000 onCancel end=======================>"
    );
  }
  ...
  function onConsumeCancelLabel2Times(data) {
    ...
    console.info(
      "=========ANS_Cancel_2100 onConsume data:==================>" +
        JSON.stringify(data)
    );
    console.info(
      "=========ANS_Cancel_2100 onConsume label:=================>" +
        data.request.label
    );
    console.info(
      "=========ANS_Cancel_2100 onConsume id:====================>" +
        data.request.id
    );
    ...
    console.info(
      "=========ANS_Cancel_2100 onConsume cancel=======================>"
    );
    console.info(
      "=========ANS_Cancel_2100 onConsume end=======================>"
    );
  }
  ...
  function cancelCallBackCancelLabel2Times1(err) {
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times1 start============>"
    );
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times1 err==============>" +
        JSON.stringify(err)
    );
    expect(err.code).assertEqual(0);
    notify.cancel(id2100, label2100, cancelCallBackCancelLabel2Times2);
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times1 cancel =======================>"
    );
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times1 end=======================>"
    );
  }
  function cancelCallBackCancelLabel2Times2(err) {
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times2 start================>"
    );
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times2 err:=================>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "=========ANS_Cancel_2100 cancelCallBack 2Times2 end==================>"
    );
  }
  ...
  function onConsumeCancelLabelPromise2Times(data) {
    console.info(
      "===========ANS_Cancel_2200 onConsume start=======================>"
    );
    console.info(
      "===========ANS_Cancel_2200 onConsume data:=========>" +
        JSON.stringify(data)
    );
    console.info(
      "===========ANS_Cancel_2200 onConsume label:========>" +
        data.request.label
    );
    console.info(
      "===========ANS_Cancel_2200 onConsume id:===========>" + data.request.id
    );
    ...
    notify
      .cancel(id2200, label2200)
      .then(() => {
        console.info("=========ANS_Cancel_2200 onConsume cancel2 then======>");
      })
      .catch((err) => {
        console.info(
          "=========ANS_Cancel_2200 onConsume cancel2 catch err======>" +
            JSON.stringify(err)
        );
        expect(err.code != 0).assertEqual(true);
      });
  ...
  function onCancelCancelLabelPromise2Times(data) {
    console.info(
      "===========ANS_Cancel_2200 onCancel start===================>"
    );
    console.info(
      "===========ANS_Cancel_2200 onCancel data:===================>" +
        JSON.stringify(data)
    );
    timesOfOnCancel = timesOfOnCancel + 1;
    if (timesOfOnCancel == 1) {
  ...
  function onConsumeCancelRightLabelWrongId(data) {
    console.info(
      "============ANS_Cancel_2300 onConsume start=======================>"
    );
    console.info(
      "============ANS_Cancel_2300 onConsume data: =======================>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_2300 onConsume label: =======================>" +
        data.request.label
    );
    console.info(
    ...
    notify.cancel(
      11111,
      data.request.label,
      cancelCallBackCancelRightLabelWrongId
    );
    console.info(
      "============ANS_Cancel_2300 onConsume cancel=======================>"
    );
    console.info(
      "============ANS_Cancel_2300 onConsume end=======================>"
    );
  }
  function onCancelCancelRightLabelWrongId(data) {
    console.info(
      "============ANS_Cancel_2300 onCancel start=======================>"
    );
    console.info(
      "============ANS_Cancel_2300 onCancel data:=======================>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "============ANS_Cancel_2300 onCancel end=======================>"
    );
  }
  function cancelCallBackCancelRightLabelWrongId(err) {
    console.info(
      "============ANS_Cancel_2300 cancelCallBack start=======================>"
    );
    console.info(
      "============ANS_Cancel_2300 cancelCallBack err:===============>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "============ANS_Cancel_2300 cancelCallBack end===================>"
    );
  }
  ...
  function onConsumeCancelRightLabelWrongIdPromise(data) {
    ...
    console.info(
      "============ANS_Cancel_2400 onConsume data:==============>" +
        JSON.stringify(data)
    );
    console.info(
      "============ANS_Cancel_2400 onConsume label:=============>" +
        data.request.label
    );
    console.info(
    ...
    notify
      .cancel(11111, data.request.label)
      .then(() => {
        console.info("=========ANS_Cancel_2400 onConsume cancel then======>");
      })
      .catch((err) => {
        console.info(
          "=========ANS_Cancel_2400 onConsume cancel catch err======>" +
            JSON.stringify(err)
        );
        expect(err.code != 0).assertEqual(true);
      });
  ...
  function onCancelCancelRightLabelWrongIdPromise(data) {
    ...
    console.info(
      "============ANS_Cancel_2400 onCancel data:===============>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "============ANS_Cancel_2400 onCancel end=======================>"
    );
  }
  ...
  function onConsumeCancelWrongLabelWrongId(data) {
    console.info(
      "==========ANS_Cancel_2500 onConsume start=======================>"
    );
    console.info(
      "==========ANS_Cancel_2500 onConsume data:=======================>" +
        JSON.stringify(data)
    );
    console.info(
      "==========ANS_Cancel_2500 onConsume label:======================>" +
        data.request.label
    );
    console.info(
      "==========ANS_Cancel_2500 onConsume id==========================>" +
        data.request.id
    );
    notify.cancel(6666, "6666", cancelCallBackCancelWrongLabelWrongId);
    console.info(
      "==========ANS_Cancel_2500 onConsume cancel====================>"
    );
    console.info(
      "==========ANS_Cancel_2500 onConsume end=======================>"
    );
  }
  function onCancelCancelWrongLabelWrongId(data) {
    console.info(
      "==========ANS_Cancel_2500 onCancel start====================>"
    );
    console.info(
      "==========ANS_Cancel_2500 onCancel data:====================>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "==========ANS_Cancel_2500 onCancel end======================>"
    );
  }
  function cancelCallBackCancelWrongLabelWrongId(err) {
    console.info(
      "==========ANS_Cancel_2500 cancelCallBack start=======================>"
    );
    console.info(
      "==========ANS_Cancel_2500 cancelCallBack err:================>" +
        JSON.stringify(err)
    );
    expect(err.code != 0).assertEqual(true);
    console.info(
      "==========ANS_Cancel_2500 cancelCallBack end=======================>"
    );
  }
  ...
  function onConsumeCancelWrongLabelWrongIdPromise(data) {
    ...
    console.info(
      "========ANS_Cancel_2600 onConsume data:==============>" +
        JSON.stringify(data)
    );
    console.info(
      "========ANS_Cancel_2600 onConsume label:=============>" +
        data.request.label
    );
    console.info(
      "========ANS_Cancel_2600 onConsume id:================>" + data.request.id
    );
    notify
      .cancel(6666, "6666")
      .then(() => {
      ...
      .catch((err) => {
        console.info(
          "=========ANS_Cancel_2600 onConsume cancel catch err======>" +
            JSON.stringify(err)
        );
        expect(err.code != 0).assertEqual(true);
      });
  ...
  function onCancelCancelWrongLabelWrongIdPromise(data) {
    console.info(
      "========ANS_Cancel_2600 onCancel start=======================>"
    );
    console.info(
      "========ANS_Cancel_2600 onCancel data:=======================>" +
        JSON.stringify(data)
    );
    expect().assertFail();
    console.info(
      "========ANS_Cancel_2600 onCancel end=======================>"
    );
  }
  ...
  it("ANS_Cancel_2700", 0, async function (done) {
    ...
    it("ANS_Cancel_2800", 0, async function (done) {
      ...
      await notify.subscribe(subscriber);
      console.info(
        "===============ANS_Cancel_2800 subscribe promise==================>"
      );
      ...
      await notify.publish(notificationRequest);
      console.info(
        "===============ANS_Cancel_2800 publish promise==================>"
      );
      setTimeout(async function () {
        await notify.unsubscribe(subscriber);
        console.info(
          "======ANS_Cancel_2800 setTimeout unsubscribe end==================>"
        );
        done();
      }, timeout);
    });
