 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0010, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0020, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0030, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0040, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0050, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0060, Function | MediumTest | Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(ProfilerServiceTest, DFX_DFR_Hiprofiler_0070, Function | MediumTest | Level1)
{
    std::string cmd = "cp /system/lib/libcpudataplugin.z.so /data/local/tmp";
    system(cmd.c_str());
